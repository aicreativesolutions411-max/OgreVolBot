...
`);return s?Promise.resolve(window.prompt(c||e,s.value||"")):Promise.resolve(window.confirm(c||e))}return new Promise(c=>{const l=document.createElement("div");l.className="slime-confirm-overlay",l.innerHTML=`
  ...
  `}function da({returnPath:e="/terminal"}={}){n.walletConnectMenuOpen=!0,n.walletConnectReturnPath=e||"/terminal",n.walletConnectStatus=n.user?.connectedWallet?`Connected ${w(n.user.connectedWallet.publicKey)}. Pick a provider to reconnect or switch.`:"Pick a wallet. Your extension will ask you to approve.",h({force:!0})}function rg(e={}){return da(e)}window.openWalletConnectModal=rg;function og(e){n.walletFastApprovalsEnabled=!!e;try{localStorage.setItem("walletFastApprovalsEnabled",n.walletFastApprovalsEnabled?"on":"off")}catch{}}function sg(){const e=m("[data-wallet-connect-modal]");if(!e)return;if(!n.walletConnectMenuOpen){e.hidden=!0,e.innerHTML="",e.__lastDrawerHtml="";return}const t=n.user?.connectedWallet||n.connectedWalletBalance;e.hidden=!1,fr(e,`
  ...
  `,".wallet-connect-dialog")}function ig(){const e=n.quickBuyModal||{},t=Bo()?.tokenMint===e.tokenMint?Bo():ge(e.tokenMint,{source:e.source||"quick-buy-modal"}),a=/validating|submitting|opening wallet/i.test(String(e.status||"")),r=yi(e.error||e.status||""),o=a||!!r,s=ce(e.walletIndex||"");return`
  ...
  `}function ug(){const e=n.user?.referralCode||"",t=`${Ct.replace(/\/+$/,"")}/r/`,a=n.user?.referralLink||(e?`${Ct.replace(/\/+$/,"")}/r/${encodeURIComponent(e)}`:""),r=n.user?.referralStats||{},o=Array.isArray(r.referrals)?r.referrals:[];return`
    ...
    <section class="trade-layout ogre-ai-terminal">
      <article class="trade-card">
        ...
        <div class="ogre-cat-field" data-preserve-focus>
          ...
          ${eb(o)}
          <small class="ogre-cat-hint">${i(Uu(o))}</small>
        </div>
        ...
        <small data-ogre-ai-status>${i(n.ogreAiStatus||Uu(o))}</small>
      </article>
  ...
  `}function vt(e,t=null){const a=e==="trade-plan"?1:6,r=Array.isArray(t)?new Set(t.map(String)):null;return xi().map((o,s)=>`
  ...
  `}function ob(e=""){return n.wallets.length?n.wallets.map((t,a)=>{const r=String(t.index??a+1),o=`${r}. ${t.label||"Wallet"} ${t.shortPublicKey||w(t.publicKey||"")}`;return`<option value="${i(r)}" ${String(e)===r?"selected":""}>${i(o)}</option>`}).join(""):'<option value="">No managed wallets loaded</option>'}function x(e,t,a=""){const r=m(e)?.value||a;if(r!=="custom")return r;const o=m(t)?.value?.trim();if(!o)throw new Error("Enter the custom value first.");return o}function st(e,t=""){const a=n.presets?.[e]||[],r=!t||t==="none"||t==="manual",o=e==="bundle"?"Create / edit bundle preset":"Create / edit trade preset";return a.length?`
  ...
  `}function Xe(e,t,a="off"){return _t({selectAttr:`${t}`,customAttr:`${t}-custom`,customFor:e,options:sb,selected:a,customPlaceholder:"Custom: 45s, 20, 2h"})}function eo(e,t,a="0"){return _t({selectAttr:`${t}`,customAttr:`${t}-custom`,customFor:e,options:ib,selected:a,customPlaceholder:"Custom: 30s, 20, 2h"})}function Mi(e="scanner"){return`
  ...
  `}function Vu(e){const t=e==="trade"?n.editingTradePresetId:n.editingBundlePresetId;return t?oe(e,t):null}function to(e,t){e==="trade"&&(n.editingTradePresetId=t||""),e==="bundle"&&(n.editingBundlePresetId=t||"")}function lb(){const e=Vu("trade"),t=!!e?.readonly,a=e?t?"Save Edited Copy":"Update Trade Preset":"Save Trade Preset";return`
  ...
  `}function ub(e){return Number(e?.sellDelaySeconds||0)>0?`${e?.sellPercent||100}%`:"Off"}function ao(e){return`
  ...
  `:""}function ro(e){n.distributeStatus=String(e||"");const t=m("[data-distribute-status]");t&&(t.textContent=n.distributeStatus)}function mb(){const e=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!e?.publicKey)return"";const t=n.wallets.filter(r=>r.sessionWallet),a=t.length?t:n.wallets;return a.length?`
  ...
  `:""}function Qn(e){n.returnFundsStatus=String(e||"");const t=m("[data-return-funds-status]");t&&(t.textContent=n.returnFundsStatus)}async function Gu(e="leaving"){try{const t=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!t?.publicKey)return;const a=n.wallets.filter(s=>s.sessionWallet);if(!a.length)return;const r=a.map(s=>String(s.index));if(!await Le({title:"Return Session Funds",lines:[`Before ${e}, return tokens + SOL from your ${r.length} session wallet(s)`,`back to your connected wallet ${w(t.publicKey)}?`],confirmLabel:"Return Funds",cancelLabel:"Skip"}))return;await k("/api/web/wallets/return-to-connected",{method:"POST",body:JSON.stringify({destination:t.publicKey,walletIndexes:r}),dedupe:!1,timeoutMs:te})}catch(t){try{window.alert(`Could not return funds automatically: ${t.message}. Use the Return Funds button to retry.`)}catch{}}}async function fb(){if(n.returnFundsBusy)return;const e=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!e?.publicKey){Qn("Connect a wallet first.");return}const t=n.wallets.filter(s=>s.sessionWallet),r=(t.length?t:n.wallets).map(s=>String(s.index));if(!r.length){Qn("No managed wallets to return from.");return}if(await Le({title:"Return Funds",lines:[`Sell all tokens to SOL and send everything from ${r.length} wallet(s)`,`back to your connected wallet ${w(e.publicKey)}?`],confirmLabel:"Sell & Return",danger:!0})){n.returnFundsBusy=!0,Qn("Selling tokens and returning SOL..."),h();try{const s=await k("/api/web/wallets/return-to-connected",{method:"POST",body:JSON.stringify({destination:e.publicKey,walletIndexes:r}),dedupe:!1,timeoutMs:te});n.returnFundsBusy=!1,Qn(s.summary||"Funds returned to your connected wallet."),await De({force:!0,deep:!1,reason:"return-funds"}).catch(()=>{}),h()}catch(s){n.returnFundsBusy=!1,Qn(s.message),h()}}}async function hb(){if(n.distributeBusy)return;const e=m("[data-distribute-count]")?.value||"5",t=m("[data-distribute-amount]")?.value||"",a=m("[data-distribute-source]")?.value||"1",r=m("[data-distribute-label]")?.value?.trim()||"Fresh";if(!t||Number(t)<=0){ro("Enter SOL per wallet greater than zero.");return}const o=(Number(t)||0)*(Number(e)||0);if(await Le({title:"Create & Fund Wallets",lines:[`Create ${e} fresh wallet(s) and fund each with ${t} SOL?`,`That sends about ${o.toFixed(3)} SOL total from the source wallet (real SOL).`,"Backup/recovery files for the new wallets will download."],confirmLabel:"Create & Fund"})){n.distributeBusy=!0,ro("Creating and funding wallets..."),h();try{await Y(m("[data-distribute-status]"),"Creating secure web profile for wallet backups...");const c=await k("/api/web/wallets/distribute",{method:"POST",body:JSON.stringify({count:e,amountSol:t,sourceWalletIndex:a,label:r}),dedupe:!1,timeoutMs:te});c.downloads?.encryptedBackup?.text&&fe(c.downloads.encryptedBackup.filename,c.downloads.encryptedBackup.text),c.downloads?.recoveryKeys?.text&&fe(c.downloads.recoveryKeys.filename,c.downloads.recoveryKeys.text),n.distributeBusy=!1,ro(c.summary||"Fresh wallets created and funded. Backups downloaded."),await De({force:!0,deep:!1,reason:"distribute-fresh-wallets"}).catch(()=>{}),h()}catch(c){n.distributeBusy=!1,ro(c.message),h()}}}function gb(e){return e.status==="completed"?"Finished":e.stage==="sweeping"?"Sweeping back":e.stage==="running"?"Running":e.stage||"Armed"}function bb(){const e=Du().length;return e?`
    ...
    </article>`:""}function yb(){const e=Array.isArray(n.volumeBots)?n.volumeBots:[],t=bb();return e.length?t+e.map(a=>{const r=a.stats||{},o=a.status!=="completed",s=(a.log||[]).slice(0,6);return`
    ...
    `}).join(""):`${t}<article class="volume-bot-status"><p class="muted">No SlimeBots running yet. Configure one above and press Start SlimeBot.</p></article>`}function Bi(e,t,a){return`<div class="vbot-segment" role="group">${a.map(([r,o])=>`<button type="button" data-vbot-set-${e}="${i(r)}" data-active="${t===r}">${i(o)}</button>`).join("")}</div>`}function vb(){const t=(Array.isArray(n.volumeBots)?n.volumeBots:[]).filter(c=>c.status!=="completed"),a=t.filter(c=>c.rolling),r=t.filter(c=>!c.rolling),o=c=>c.reduce((l,u)=>l+Math.max(0,Number(u.cycles||0)-Number(u.currentCycle||0)),0),s=(c,l,u,d,p)=>`
          ...
          <div class="volume-grid">
            ...
            <label>
              ...
              <select data-launch-coin-dev-wallet>
                ${ob(e.devWalletIndex||(e.walletIndexes||[])[0]||"")}
              </select>
            </label>
            <label>
  ...
  `}async function Oi(e={}){if(!_("kolDumpDetectorEnabled",!0))return null;const t=!!e.force;if(!t&&n.kolDumpStatsLoadedAt&&Date.now()-Number(n.kolDumpStatsLoadedAt||0)<900*1e3)return n.kolDumpStats;if(n.kolDumpStatsLoading)return null;n.kolDumpStatsLoading=!0;try{const a=new URLSearchParams({mode:n.kolMode||"hot"});n.kolWallet&&a.set("wallet",n.kolWallet),t&&a.set("force","true");const r=await k(`/api/web/kols/dump-stats?${a.toString()}`,{timeoutMs:t?5e3:3e3,preserveSafeError:!0});return n.kolDumpStats=r,n.kolDumpStatsLoadedAt=Date.now(),ne(r.cacheHit?"kolStatsCacheHit":"kolStatsCacheMiss"),r}catch{return n.kolDumpStats=n.kolDumpStats||{stats:[],message:"KOL dump stats unavailable. Showing local low-data fallback."},n.kolDumpStatsLoadedAt=Date.now(),null}finally{n.kolDumpStatsLoading=!1,n.kolDumpDetails?.open?po():n.activeTab==="kol"&&h({force:!0})}}function Xb(e=""){const t=String(e||"").trim();!t||!_("kolDumpDetectorEnabled",!0)||(n.kolDumpDetails={open:!0,kolId:t},_a(),po(),Oi({force:!0}))}function Ei(){n.kolDumpDetails={open:!1,kolId:""},po(),Er()}function po(){let e=document.querySelector("[data-kol-dump-drawer-root]");e||(e=document.createElement("div"),e.dataset.kolDumpDrawerRoot="true",document.body.appendChild(e));const t=n.kolDumpDetails||{},a=!!(t.open&&t.kolId);if(document.body.classList.toggle("kol-dump-drawer-open",a),!a||!_("kolDumpDetectorEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=uo().find(d=>String(d.kolId)===String(t.kolId))||jb(t.kolId),o=!!n.kolDumpStatsLoading,s=Array.isArray(r.walletAddresses)?r.walletAddresses.filter(Boolean).slice(0,4):[],c=Array.isArray(r.externalLinks)?r.externalLinks.filter(d=>/^https?:\/\//i.test(String(d?.url||""))).slice(0,4):[],l=r.lastTokenMint?`${r.lastTokenSymbol?`${r.lastTokenSymbol} `:""}${w(r.lastTokenMint)}`:"n/a",u=`
  ...
  `;fr(e,u,".kol-dump-drawer")}function Jb(){const e=n.kolScan?.configured!==!1,t=n.kolLoading?"disabled":"",a=String(n.kolMode||"hot"),r=!!n.kolScan,o=!!n.kolScan?.kols?.length,s=o&&a!=="hot",c=!r&&!o;return`
  ...
  `}function Yb(){const e=n.kolScan||null,t=tr(n.kolMode),a=n.kolLoading?`Scanning ${t}`:e?`${t} loaded`:`Pick ${t} or tap Refresh`,r=Number(e?.kolCount||e?.kols?.length||0),o=Number(e?.rows?.length||0),s=n.kolLastUpdatedAt?we(n.kolLastUpdatedAt):"Not run";return`
...
`)}async function by(e){const t=m("[data-wallet-sweep-status]");n.walletSweepStatus="Running wallet action...",v(t,n.walletSweepStatus),$("");try{await Y(t,"Opening secure web profile...");const r={"sweep-sol":"/api/web/wallets/sweep-sol","sweep-tokens":"/api/web/wallets/sweep-tokens","sell-all":"/api/web/wallets/sell-all-tokens","sell-all-sweep":"/api/web/wallets/sell-all-tokens","send-sol-many":"/api/web/wallets/send-sol"}[e];if(!r)throw new Error("Unknown wallet action.");const o=e==="send-sol-many"?hy():fy();if(e==="sell-all"&&(o.destination=""),e==="sell-all-sweep"&&!o.destination)throw new Error("Enter a destination wallet for Sell Tokens + Send SOL.");const s=await k(r,{method:"POST",body:JSON.stringify(o),timeoutMs:te});n.walletSweepStatus=gy(s.sweep),v(t,n.walletSweepStatus),await De({force:!0,deep:!0}),n.activeTab="wallets",h()}catch(a){n.walletSweepStatus=a.message,v(t,a.message),$(a.message)}}async function yy(e){const t=m("[data-restore-status]"),a=m("[data-restore-text]"),r=e?.files?.[0];if(!(!r||!a)){v(t,"Reading backup file...");try{a.value=await r.text(),v(t,"Backup loaded. Tap Restore Wallets.")}catch(o){v(t,`Could not read file: ${o.message}`)}}}function fe(e,t){const a=new Blob([t],{type:"text/plain"}),r=URL.createObjectURL(a),o=document.createElement("a");o.href=r,o.download=e,document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1e4)}async function vy(){const e=m("[data-x-handle]"),t=m("[data-x-status]"),a=Je(e?.value||"");if(!a){v(t,"Enter a valid X handle first.");return}const r=window.open(Ti(a),"_blank","noopener,noreferrer");try{v(t,r?`Opening X and saving @${a}...`:`Saving @${a}. Allow popups if X did not open.`),await Y(t,"Creating secure web profile for X sharing...");const o=await k("/api/web/profile/x",{method:"POST",body:JSON.stringify({xHandle:a})});pe(o.user||{...n.user,xHandle:o.profile?.xHandle||a}),Kl(n.xHandle),v(t,`Connected @${n.xHandle}. Share buttons now open X posts with SlimeWire tagged.`),h()}catch(o){v(t,o.message),$(o.message)}}function wy(){const e=m("[data-x-status]"),t=Je(m("[data-x-handle]")?.value||n.xHandle||""),a=Ti(t||n.xHandle);window.open(a,"_blank","noopener,noreferrer"),v(e,t?`Opened X for @${t}. Tap Connect X after checking the handle.`:"Opened X login. Add your handle here after signing in.")}async function Sy(){const e=m("[data-x-status]"),t=m("[data-x-handle]");try{if(!n.user||!n.token){n.xHandle="",t&&(t.value=""),Ss(),v(e,"X unlinked. Enter a new handle any time and tap Save X Handle."),h();return}const a=await k("/api/web/profile/x",{method:"POST",body:JSON.stringify({clear:!0})});pe(a.user||{...n.user,xHandle:""}),n.xHandle="",t&&(t.value=""),Ss(),v(e,"X unlinked. Enter a new handle any time and tap Save X Handle."),h()}catch(a){v(e,a.message),$(a.message)}}async function go(e,t="Saving PFP..."){const a=m("[data-avatar-status]");v(a,t);try{await Y(a,"Creating secure web profile for PFP...");const r=await k("/api/web/profile/avatar",{method:"POST",body:JSON.stringify(e)});pe(r.user||{...n.user,avatar:r.profile?.avatarDataUrl||r.profile?.avatarUrl||"",avatarSource:r.profile?.avatarSource||"",avatarUpdatedAt:r.profile?.avatarUpdatedAt||""}),v(a,n.user.avatar?"PFP saved.":"PFP removed."),h()}catch(r){v(a,r.message),$(r.message)}}async function ky(e){const t=m("[data-avatar-status]"),a=e?.files?.[0];if(a){if(!/^image\/(png|jpe?g|webp)$/i.test(a.type)){v(t,"Use a PNG, JPG, or WebP image.");return}if(a.size>5*1024*1024){v(t,"Use an image under 5 MB.");return}try{v(t,"Compressing PFP...");const r=await pd(a);await go({avatarDataUrl:r},"Saving compressed PFP...")}catch(r){v(t,r.message),$(r.message)}finally{e.value=""}}}function pd(e){return new Promise((t,a)=>{const r=new FileReader;r.onerror=()=>a(new Error("Could not read that image.")),r.onload=()=>{const o=new Image;o.onerror=()=>a(new Error("Could not load that image.")),o.onload=()=>{const c=document.createElement("canvas");c.width=256,c.height=256;const l=c.getContext("2d");if(!l){a(new Error("This browser cannot resize images."));return}const u=Math.max(256/o.width,256/o.height),d=Math.round(o.width*u),p=Math.round(o.height*u),f=Math.round((256-d)/2),y=Math.round((256-p)/2);l.clearRect(0,0,256,256),l.drawImage(o,f,y,d,p);const g=c.toDataURL("image/jpeg",.84);if(g.length>22e4){a(new Error("Compressed PFP is still too large. Try a simpler image."));return}t(g)},o.src=String(r.result||"")},r.readAsDataURL(e)})}async function $y(e){const t=document.querySelector('script[src*="app.js"]')?.src||document.baseURI||window.location.href,a=new URL(String(e||""),t).toString(),r=await fetch(a,{cache:"force-cache"});if(!r.ok)throw new Error("Could not load that preset PFP.");const o=await r.blob();return pd(o)}async function Ty(){const e=$i(n.xHandle);if(!e){const t=m("[data-avatar-status]");v(t,"Connect an X handle first.");return}await go({avatarUrl:e,avatarSource:"x"},"Saving X PFP...")}async function md(e,t={}){const a=In(),r=me(e);if(!r){if(await kc(e,t)||$c(e))return;const o=dc(e);re(o),Rt(e,new Error(o),{action:"provider_missing",platform:Ve()?"mobile":"desktop"});return}try{const o=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(o){if(!(t.confirmSwitch===!1?!0:await Le({title:"Reconnect or Switch Wallet",lines:[`Current wallet: ${w(o)}`,"Your wallet extension will open so you can approve the wallet to use on Live Terminal."],confirmLabel:"Open Wallet"}))){re("Wallet connection unchanged."),$e("/terminal","terminal");return}try{await Promise.resolve(r.disconnect?.())}catch{}}re(`Opening ${Ee(e,r)}...`);const c=(await r.connect?.({onlyIfTrusted:!1}))?.publicKey||r.publicKey,l=c?.toBase58?.()||c?.toString?.()||"";if(!l)throw new Error("Wallet connected, but no public address was returned.");await Y(a,"Creating secure web profile for connected wallet...");const u=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({publicKey:l,provider:Ee(e,r)})});pe(u.user||{...n.user,connectedWallet:u.profile?.connectedWallet||null}),n.connectedWalletBalance={publicKey:l,shortPublicKey:w(l),provider:Ee(e,r),tokens:[]},pi(`connected:${l}`),n.walletConnectMenuOpen=!1,re(`Connected ${w(l)}. Opening Live Terminal...`),$e(t.returnPath||n.walletConnectReturnPath||"/terminal","terminal"),h({force:!0}),uu("browser-wallet-connect"),Ur("browser-wallet-connect")}catch(o){const s=o.message||"Wallet connection was cancelled.";re(s),Rt(e,o,{action:"connect_failed"})}}async function fd(){await Gu("disconnecting");const e=In(),t=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(!n.user||!n.token){n.connectedWalletBalance=null,pi(t?`connected:${t}`:""),re("Connected wallet disconnected."),h({force:!0});return}try{const a=n.user?.connectedWallet?.provider||"";await(a.toLowerCase().includes("phantom")?me("phantom"):a.toLowerCase().includes("solflare")?me("solflare"):a.toLowerCase().includes("backpack")?me("backpack"):me("solana"))?.disconnect?.()}catch{}try{const a=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({clear:!0})});pe(a.user||{...n.user,connectedWallet:null}),n.connectedWalletBalance=null,pi(t?`connected:${t}`:""),re("Connected wallet disconnected."),h({force:!0})}catch(a){re(a.message),$(a.message)}}async function Ay(){const e=m("[data-profile-username]"),t=m("[data-profile-password]"),a=m("[data-login-security-status]"),r=String(e?.value||"").trim(),o=String(t?.value||"");if(!r||!o){v(a,"Enter a username and password first.");return}try{await Y(a,"Creating secure web profile..."),v(a,"Saving login...");const s=await k("/api/web/profile/credentials",{method:"POST",body:JSON.stringify({username:r,password:o})});pe(s.user||{...n.user,username:r,hasPasswordLogin:!0}),t&&(t.value=""),v(a,"Saved. You can now log back in with this username and password."),h()}catch(s){v(a,s.message),$(s.message)}}function Je(e){return String(e||"").trim().replace(/^@+/,"").replace(/[^a-z0-9_]/gi,"").slice(0,15)}function Di(e){const t=vi(e),a=String(n.user?.referralLink||"").trim(),r=a&&!t.includes("/r/")?a:Ct,o=`https://twitter.com/intent/tweet?text=${encodeURIComponent(t)}&url=${encodeURIComponent(r)}`;window.open(o,"_blank","noopener,noreferrer")}function hd(e){const t=e==="kol",a=m(t?"[data-share-watch-kol]":"[data-share-watch-token]"),r=m("[data-share-watch-status]"),o=a?.value?.trim()||"";if(!o){v(r,t?"Enter a KOL handle or wallet first.":"Enter a coin, ticker, or CA first.");return}Di(t?Pu(o):wi(o)),v(r,t?"KOL watch post opened in X.":"Coin watch post opened in X.")}async function gd(e){const t={};n.token&&(t.Authorization=`Bearer ${n.token}`);const a=await Mn(Ka(`/api/web/pnl/card?tokenMint=${encodeURIComponent(e)}`),{headers:t,cache:"no-store"},3e4);if(!a.ok){const r=await uc(a);throw new Error(r.message||r.error||`Could not build PnL card (${a.status}).`)}return{blob:await a.blob(),filename:a.headers.get("x-ogre-filename")||`pnl-card-${w(e)}.png`}}async function bd(e){const{blob:t,filename:a}=await gd(e),r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=a,document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1e4)}async function Py(e,t){try{const{blob:a,filename:r}=await gd(e),o=new File([a],r,{type:"image/png"});if(navigator.canShare?.({files:[o]})){await navigator.share({title:"SlimeWire PnL Card",text:vi(t),url:Ct,files:[o]});return}await bd(e),Di(`${t} PnL card downloaded and ready to attach.`)}catch(a){$(a.message)}}function yd(e="buy"){const t=m("[data-trade-wallet]")?.value||"",a=dh(e)||m("[data-trade-token]")?.value?.trim()||"",r=x("[data-trade-slippage]","[data-trade-slippage-custom]","400");if(!t)throw new Error("Choose a wallet first.");if(!a)throw new Error("Paste a token CA first.");return n.tradeToken=a,e==="sell"?(n.tradeSwapFrom=a,n.tradeSwapTo="SOL"):(n.tradeSwapFrom="SOL",n.tradeSwapTo=a),{walletIndex:t,tokenMint:a,slippageBps:r}}function ce(e=""){return String(e||"").trim().toLowerCase()==="connected"}function Cy(e={}){if(!e?.sessionWallet||e.sessionStatus!=="funded")return!1;const t=Date.parse(e.sessionExpiresAt||"");return!Number.isFinite(t)||t>Date.now()}function vd(){const e=Array.isArray(n.wallets)?n.wallets:[];for(let t=e.length-1;t>=0;t-=1)if(Cy(e[t]))return e[t];return null}function wd(e=le()){if(!e?.publicKey)return!1;const t=ar(e),a=me(t)||me("solana");return!!(a&&typeof a.signTransaction=="function")}function bo(e=le()){const t=e?.provider||Ee(ar(e));return`${t} is connected, but this mobile browser cannot sign trades after the wallet-app handoff. Open SlimeWire inside the ${t} in-app browser, or fund a Session Wallet once so buys, sells, TP/SL, and Ogre A.I. can run without reconnect loops.`}function yo(e={},{side:t="trade",statusWriter:a=he,allowSessionFallback:r=!0}={}){if(!ce(e.walletIndex))return{form:e,sessionWallet:null};if(wd())return{form:e,sessionWallet:null};const o=r?vd():null;if(o?.index){const s=`Using Session Wallet ${o.index} for ${t}; mobile wallet signing is not available in this browser.`;return typeof a=="function"&&a(s),{form:{...e,walletIndex:String(o.index)},sessionWallet:o}}throw new Error(bo())}function Sd(e){const t=[];for(let r=0;r<e.length;r+=32768)t.push(String.fromCharCode(...e.subarray(r,r+32768)));return btoa(t.join(""))}function kd(e=""){const t=atob(String(e||"")),a=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)a[r]=t.charCodeAt(r);return a}function ar(e=le()){const t=String(e?.provider||"").trim().toLowerCase();return t.includes("phantom")?"phantom":t.includes("solflare")?"solflare":t.includes("backpack")?"backpack":"solana"}async function Ly(e=le(),{returnPath:t=za()||"/terminal/trade"}={}){const a=ar(e),r=e?.provider||Ee(a);if(da({returnPath:t}),Ve()&&e?.publicKey&&!me(a)){const s=bo(e);return re(s),s}if(Sc(a)){const s=`${r} needs to reconnect before it can sign here. Opening ${r} mobile connect now.`;if(re(s),await kc(a,{returnPath:t}).catch(()=>!1))return s}if($c(a))return`Opening ${r}. Use the wallet browser to reconnect and approve the trade.`;const o=dc(a);return re(o),o}async function $d(){const e=le();if(!e?.publicKey)throw new Error("Connect Phantom, Solflare, or another wallet before trading.");const t=ar(e),a=me(t)||me("solana");if(!a){if(Ve()&&e?.publicKey)throw new Error(bo(e));const s=await Ly(e,{returnPath:za()||"/terminal/trade"});throw new Error(s)}if(typeof a.signTransaction!="function")throw Ve()&&e?.publicKey?new Error(bo(e)):new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const r=()=>a.publicKey?.toBase58?.()||a.publicKey?.toString?.()||"";let o=r();if(o!==e.publicKey)try{const s=await a.connect?.({onlyIfTrusted:!0});o=s?.publicKey?.toBase58?.()||s?.publicKey?.toString?.()||r()}catch{}if(o!==e.publicKey){const s=await a.connect?.({onlyIfTrusted:!1}),c=s?.publicKey?.toBase58?.()||s?.publicKey?.toString?.()||r();if(c!==e.publicKey)throw new Error(`Wallet mismatch. SlimeWire has ${w(e.publicKey)} connected, but the browser returned ${w(c)}. Reconnect the wallet you want to trade with.`)}return{provider:a,connected:e}}async function xy(){try{if(Ve())return;const e=le();if(!e?.publicKey)return;const t=ar(e),a=me(t)||me("solana");if(!a||typeof a.connect!="function"||(a.publicKey?.toBase58?.()||a.publicKey?.toString?.()||"")===e.publicKey)return;await a.connect({onlyIfTrusted:!0}).catch(()=>{})}catch{}}const My=6e4;async function Td(e,t,a=My){let r=0;const o=new Promise((s,c)=>{r=window.setTimeout(()=>{c(new Error("Wallet approval timed out. Reopen your wallet and try the trade again."))},a)});try{return await Promise.race([Promise.resolve(e.signTransaction(t)),o])}finally{window.clearTimeout(r)}}async function By(e,t){if(!e||typeof e!="string")throw new Error("SlimeWire could not build a wallet approval transaction. Try again or choose another token.");if(!window.solanaWeb3?.VersionedTransaction)throw new Error("Solana wallet signing library did not load. Refresh the page and try again.");if(typeof t.signTransaction!="function")throw new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const a=window.solanaWeb3.VersionedTransaction.deserialize(kd(e)),r=await Td(t,a);return Sd(r.serialize())}async function Ry(e,t){if(!e||typeof e!="string")throw new Error("SlimeWire could not build a wallet approval transaction. Try again.");if(!window.solanaWeb3?.Transaction)throw new Error("Solana wallet signing library did not load. Refresh the page and try again.");if(typeof t.signTransaction!="function")throw new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const a=window.solanaWeb3.Transaction.from(kd(e)),r=await Td(t,a);return Sd(r.serialize())}function Iy({side:e,connected:t,form:a={},actionDetail:r="",amountSol:o="",amountMode:s="",percent:c=""}={}){const l=e==="sell"?"Sell":"Buy",u=`${t?.provider||"Connected wallet"} ${t?.publicKey?w(t.publicKey):""}`.trim(),d=e==="sell"?`${c||r||"100"}%`:s==="max"?"Max SOL":`${o||r||"custom"} SOL`;return Le({title:`Confirm ${l}`,lines:[`${l} with ${u}?`,`Token: ${a.tokenMint||""}`,`Amount: ${d}`,"Next step: approve the transaction in your wallet."],confirmLabel:l})}async function nr({side:e,form:t,actionDetail:a,amountSol:r="",amountMode:o="",percent:s="",attemptId:c,statusWriter:l=he}){const u=typeof l=="function"?l:he,{provider:d,connected:p}=await $d();if(!n.walletFastApprovalsEnabled&&!await Iy({side:e,connected:p,form:t,actionDetail:a,amountSol:r,amountMode:o,percent:s}))throw new Error("Connected-wallet trade cancelled.");lm(`${e==="buy"?"Buy":"Sell"} ${w(t.tokenMint||"")}`),Be("submitted","pending"),u(n.walletFastApprovalsEnabled?`Building ${e} approval for ${p.provider||"your wallet"}...`:`Preparing ${e} approval...`);const f=await k("/api/web/browser-trade/order",{method:"POST",body:JSON.stringify({side:e,tokenMint:t.tokenMint,walletPublicKey:p.publicKey,slippageBps:t.slippageBps,amountSol:r,amountMode:o,percent:s,tradeAttemptId:c}),dedupe:!1,timeoutMs:te});Be("submitted","ok"),Be("approved","pending",`Approve in ${p.provider||"your wallet"}`),u(`Approve ${e} in ${p.provider||"your wallet"}...`);let y;try{y=await By(f.order?.transaction,d)}catch(S){throw Be("approved","fail",D(S?.message||"Wallet approval was declined.")),S}Be("approved","ok"),Be("sent","pending"),u("Submitting signed trade...");let g;try{g=await k("/api/web/browser-trade/execute",{method:"POST",body:JSON.stringify({browserTradeAttemptId:f.order?.browserTradeAttemptId,signedTransaction:y}),dedupe:!1,timeoutMs:te})}catch(S){throw V(e==="buy"?"trade-buy":"trade-sell",t.tokenMint,a,{state:"error",error:D(S?.message||"Trade submit failed.")}),K("",`browser-${e}-error`,{tradeAttemptId:c}),Be("sent","fail",D(S?.message||"Submit failed - it may still have landed; positions are being re-checked.")),u(`${e==="buy"?"Buy":"Sell"} submit failed or timed out - re-checking your wallet in case the trade landed...`),S}return Be("sent","ok"),Be("confirmed",g.trade?.signature?"ok":"pending",g.trade?.signature?`tx ${String(g.trade.signature).slice(0,8)}...`:""),n.tradeResult=g.trade,u(g.trade?.message||`${e==="buy"?"Buy":"Sell"} submitted from connected wallet.`),V(e==="buy"?"trade-buy":"trade-sell",t.tokenMint,a,{state:"submitted",signature:g.trade?.signature||""}),K(g.trade?.signature,`browser-${e}`,{tradeAttemptId:c}),g.trade}function Ue(e){const t=String(e||"").trim().toLowerCase();return!!t&&!["0","off","none","no","disabled"].includes(t)}function sn(e,t){const a=String(t||"").trim().toLowerCase();return["0","off","none","no","disabled"].includes(a)?{sellDelay:"off",sellPercent:"100"}:{sellDelay:e,sellPercent:t}}function Oy(){const e=x("[data-trade-auto-tp]","[data-trade-auto-tp-custom]","25"),t=x("[data-trade-auto-sl]","[data-trade-auto-sl-custom]","8");let a=x("[data-trade-auto-delay]","[data-trade-auto-delay-custom]","off"),r=x("[data-trade-auto-sell-percent]","[data-trade-auto-sell-percent-custom]","100");return{sellDelay:a,sellPercent:r}=sn(a,r),{enabled:Ue(e)||Ue(t)||Ue(a),takeProfitPct:e,stopLossPct:t,sellDelay:a,sellPercent:r}}function Ad(){const e=x("[data-chart-buy-tp]","[data-chart-buy-tp-custom]","25"),t=x("[data-chart-buy-sl]","[data-chart-buy-sl-custom]","8");let a=x("[data-chart-buy-delay]","[data-chart-buy-delay-custom]","off"),r=x("[data-chart-buy-sell-percent]","[data-chart-buy-sell-percent-custom]","100");return{sellDelay:a,sellPercent:r}=sn(a,r),{enabled:Ue(e)||Ue(t)||Ue(a),takeProfitPct:e,stopLossPct:t,sellDelay:a,sellPercent:r}}function he(e){const t=m("[data-trade-status]");v(t,e)}function Fe(e=""){n.chartTradeStatus=String(e||""),v(m("[data-chart-trade-status]"),n.chartTradeStatus)}function _i(e="",t=""){n.quickBuyModal={...n.quickBuyModal,status:String(e||""),error:String(t||"")};const a=m("[data-quick-buy-modal-status]"),r=m("[data-quick-buy-modal-error]");v(a,n.quickBuyModal.status),v(r,n.quickBuyModal.error),a&&(a.hidden=!n.quickBuyModal.status),r&&(r.hidden=!n.quickBuyModal.error)}async function vo(e,t="fixed"){const a=L();let r=t==="max"?"max":String(e||"custom"),o="";try{let s=yd("buy");r=t==="max"?"max":String(e||"custom");const c=at("trade-buy",s.tokenMint,r);if(c){ne("buttonDoubleClickPrevented"),W({component:"post-trade",action:"trade-action-dedupe",durationMs:L()-a,cacheHit:!0,requestId:c.tradeAttemptId||"",details:`trade-buy:${w(s.tokenMint)}:${r}`});return}o=gt("trade-buy");const l={tokenMint:s.tokenMint,walletIndex:s.walletIndex,slippageBps:s.slippageBps,tradeAttemptId:o},u=Id();if((Ue(u.takeProfitPct)||Ue(u.stopLossPct)||Ue(u.sellDelay))&&Object.assign(l,{autoExit:!0,...u}),t==="max")l.amountMode="max";else{const S=Number(e);if(!Number.isFinite(S)||S<=0)throw new Error("Enter a buy amount greater than zero.");l.amountSol=String(S)}if(s=yo(s,{side:"buy",statusWriter:he}).form,l.walletIndex=s.walletIndex,ce(s.walletIndex)){V("trade-buy",s.tokenMint,r,{state:"clicked",tradeAttemptId:o,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"browser-trade-click-to-ui",durationMs:L()-a,requestId:o,details:`browser-buy:${w(s.tokenMint)}:${r}`}),he("Building wallet-approved buy..."),ie(),await nr({side:"buy",form:s,actionDetail:r,amountSol:l.amountSol||"",amountMode:l.amountMode||"fixed",attemptId:o}),n.activeTab="trade",h({preserveSmartChartFrame:n.activeTab==="smartChart"}),Pe("trade-buy",s.tokenMint,r,3e3);return}const f=Oy();f.enabled&&Object.assign(l,{autoExit:!0,takeProfitPct:f.takeProfitPct,stopLossPct:f.stopLossPct,sellDelay:f.sellDelay,sellPercent:f.sellPercent}),V("trade-buy",s.tokenMint,r,{state:"clicked",tradeAttemptId:o,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"trade-click-to-ui",durationMs:L()-a,requestId:o,details:`trade-buy:${w(s.tokenMint)}:${r}`}),h(),he(f.enabled?"Sending buy and arming auto-exit...":"Sending buy..."),await Ce(20);const y=L();V("trade-buy",s.tokenMint,r,{state:"submitting"});const g=await k("/api/web/trade/buy",{method:"POST",body:JSON.stringify({...l,clientClickToUiMs:Math.round(y-a)}),dedupe:!1});W({component:"post-trade",action:"trade-backend-ack",durationMs:L()-y,requestId:o,resultCount:g.trade?.signature?1:0,details:"trade-buy"}),n.tradeResult=g.trade,lm(`Buy ${w(s.tokenMint||"")}`),Be("submitted","ok"),Be("sent","ok"),Be("confirmed",g.trade?.signature?"ok":"pending",g.trade?.signature?`tx ${String(g.trade.signature).slice(0,8)}...`:""),g.trade?.autoExitPlan?(Be("armed","ok"),n.tradePlanResult=g.trade.autoExitPlan,he(g.trade.autoExitPlan.shortMessage||"Buy landed and auto-exit is armed."),ho()):g.trade?.autoExitRequested&&(Be("armed","fail","Auto-exit was NOT armed - exit manually or create a managed plan."),he("Buy landed, but auto-exit was not armed. Use Positions to exit manually or create a managed plan.")),V("trade-buy",s.tokenMint,r,{state:"submitted",signature:g.trade?.signature||""}),K(g.trade?.signature,"trade-buy",{tradeAttemptId:o}),n.activeTab="trade",h(),Pe("trade-buy",s.tokenMint,r,3e3)}catch(s){o&&(V("trade-buy",n.tradeToken||m("[data-trade-token]")?.value||"",r,{state:"error",error:D(s.message||"Buy failed")}),Pe("trade-buy",n.tradeToken||m("[data-trade-token]")?.value||"",r,4e3)),W({component:"post-trade",action:"trade-action-error",durationMs:L()-a,requestId:o,errorCode:s?.code||s?.name||"TRADE_BUY_FAILED",details:D(s.message||"Buy failed")}),he(s.message)}}async function Ui(e){const t=L(),a=gt("manual-sell");let r=null,o=String(e||"custom");try{r=yd("sell");const s=Number.parseInt(e,10);if(o=String(s||o),!Number.isInteger(s)||s<1||s>100)throw new Error("Sell percent must be from 1 to 100.");const c=at("trade-sell",r.tokenMint,o);if(c){ne("buttonDoubleClickPrevented"),W({component:"manual-sell",action:"manual-sell-dedupe",durationMs:L()-t,cacheHit:!0,requestId:c.tradeAttemptId||"",details:`${w(r.tokenMint)}:${s}`});return}if(V("trade-sell",r.tokenMint,o,{state:"clicked",tradeAttemptId:a,clickedAt:new Date().toISOString()}),he("Sending sell..."),W({component:"manual-sell",action:"manual-sell-click-to-ui",durationMs:L()-t,requestId:a,details:`${w(r.tokenMint)}:${s}`}),r=yo(r,{side:"sell",statusWriter:he}).form,ce(r.walletIndex)){ie();const p=L();V("trade-sell",r.tokenMint,o,{state:"submitting"}),await nr({side:"sell",form:r,actionDetail:o,percent:String(s),attemptId:a}),W({component:"manual-sell",action:"browser-sell-request",durationMs:L()-p,requestId:a,resultCount:n.tradeResult?.signature?1:0,details:"browser-wallet"}),n.activeTab="trade",h({preserveSmartChartFrame:n.activeTab==="smartChart"}),Pe("trade-sell",r.tokenMint,o,3e3);return}h(),await Ce(20);const u=L();V("trade-sell",r.tokenMint,o,{state:"submitting"});const d=await k("/api/web/trade/sell",{method:"POST",body:JSON.stringify({tokenMint:r.tokenMint,walletIndex:r.walletIndex,slippageBps:r.slippageBps,percent:s,manualSellAttemptId:a,clientClickToUiMs:Math.round(u-t)}),timeoutMs:te,dedupe:!1});W({component:"manual-sell",action:"manual-sell-request",durationMs:L()-u,requestId:a,resultCount:d.trade?.signature?1:0,details:"single-wallet"}),n.tradeResult=d.trade,he(d.trade?.signature?"Submitted. Refreshing position in the background...":"Sell submitted. Refreshing position in the background..."),V("trade-sell",r.tokenMint,o,{state:"submitted",signature:d.trade?.signature||""}),K(d.trade?.signature||xe(d.trade),"manual-sell-trade"),n.activeTab="trade",h(),Pe("trade-sell",r.tokenMint,o,3e3)}catch(s){r?.tokenMint&&(V("trade-sell",r.tokenMint,o,{state:"error",error:D(s.message||"Sell failed")}),Pe("trade-sell",r.tokenMint,o,4e3)),W({component:"manual-sell",action:"manual-sell-error",durationMs:L()-t,requestId:a,errorCode:s?.code||s?.name||"MANUAL_SELL_FAILED",details:D(s.message||"Sell failed")}),he(s.message)}}function Ey(){const e=qe("trade-plan"),t=m("[data-trade-plan-group]")?.value?.trim()||"",a=m("[data-trade-token]")?.value?.trim()||"",r=x("[data-trade-plan-amount]","[data-trade-plan-amount-custom]","0.1"),o=x("[data-trade-plan-tp]","[data-trade-plan-tp-custom]","25"),s=x("[data-trade-plan-sl]","[data-trade-plan-sl-custom]","8");let c=x("[data-trade-plan-delay]","[data-trade-plan-delay-custom]","5"),l=x("[data-trade-plan-sell-percent]","[data-trade-plan-sell-percent-custom]","100");({sellDelay:c,sellPercent:l}=sn(c,l));const u=x("[data-trade-plan-slippage]","[data-trade-plan-slippage-custom]","400");if(!e.length&&!t)throw new Error("Choose at least one wallet or enter a group label.");if(!a)throw new Error("Paste a token CA first.");return n.tradeToken=a,n.volumeToken=a,n.bundleToken=a,{walletIndexes:e,walletGroup:t,tokenMint:a,amountSol:r,sellDelay:c,takeProfitPct:o,stopLossPct:s,sellPercent:l,loopCount:"1",loopDelay:"0",slippageBps:u,...ma("trade-plan")}}async function Fy(){try{const e=Ey();he("Buying and arming managed exit...");const t=await k("/api/web/trade/plan",{method:"POST",body:JSON.stringify(e)});n.tradePlanResult=t.plan,n.tradeResult=null,K(t.trade?.signature,"trade-plan"),n.activeTab="trade",h()}catch(e){he(e.message)}}function Wy(){const e=qe("volume"),t=m("[data-volume-group]")?.value?.trim()||"",a=m("[data-volume-token]")?.value?.trim()||"",r=m("[data-volume-amount]")?.value||"";let o=x("[data-volume-delay]","[data-volume-delay-custom]","5");const s=x("[data-volume-tp]","[data-volume-tp-custom]","25"),c=x("[data-volume-sl]","[data-volume-sl-custom]","8"),l=x("[data-volume-loop]","[data-volume-loop-custom]","1"),u=x("[data-volume-loop-delay]","[data-volume-loop-delay-custom]","0");let d=x("[data-volume-sell-percent]","[data-volume-sell-percent-custom]","100");({sellDelay:o,sellPercent:d}=sn(o,d));const p=x("[data-volume-slippage]","[data-volume-slippage-custom]","400");if(!e.length&&!t)throw new Error("Choose at least one wallet or enter a group label.");if(!a)throw new Error("Paste a token CA first.");return n.volumeToken=a,{walletIndexes:e,walletGroup:t,tokenMint:a,amountSol:r,sellDelay:o,takeProfitPct:s,stopLossPct:c,loopCount:l,loopDelay:u,sellPercent:d,slippageBps:p,...ma("volume")}}function Pd(e){const t=m("[data-volume-status]");v(t,e)}async function Ny(){try{const e=Wy();Pd("Buying and arming plan...");const t=await k("/api/web/volume/plan",{method:"POST",body:JSON.stringify(e)});n.volumeResult=t.plan,K(xe(t.plan),"volume-plan"),n.activeTab="volume",h()}catch(e){Pd(e.message)}}function Dy(e){const t=qe("sniper"),a=m("[data-sniper-group]")?.value?.trim()||"",r=m("[data-sniper-amount]")?.value||"",o=x("[data-sniper-delay]","[data-sniper-delay-custom]",n.scanMode==="pumpsnipe"?"3":"5"),s=x("[data-sniper-tp]","[data-sniper-tp-custom]",n.scanMode==="pumpsnipe"?"40":"25"),c=x("[data-sniper-sl]","[data-sniper-sl-custom]","8"),l=x("[data-sniper-loop]","[data-sniper-loop-custom]","1"),u=x("[data-sniper-loop-delay]","[data-sniper-loop-delay-custom]","0"),d=x("[data-sniper-slippage]","[data-sniper-slippage-custom]",n.scanMode==="pumpsnipe"?"300":"400");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!e)throw new Error("Pick a token first.");return n.tradeToken=e,n.volumeToken=e,n.bundleToken=e,{mode:n.scanMode,tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:o,takeProfitPct:s,stopLossPct:c,slippageBps:d,loopCount:l,loopDelay:u,...ma("sniper")}}function Cd(e){const t=m("[data-sniper-status]");v(t,e)}async function _y(e){try{const t=Dy(e);Cd("Buying and arming exits...");const a=await k("/api/web/sniper/entry",{method:"POST",body:JSON.stringify(t)});n.sniperResult=a.plan,K(xe(a.plan),"sniper-entry"),n.activeTab="sniper",h()}catch(t){Cd(t.message)}}function Uy(){const e=qe("ogre-ai"),t=m("[data-ogre-ai-group]")?.value?.trim()||"",a=m("[data-ogre-ai-amount]")?.value?.trim()||"",r=Zr(),o=m("[data-ogre-ai-runs]")?.value||"1",s=m("[data-ogre-ai-tp]")?.value||"25",c=m("[data-ogre-ai-tp-custom]")?.value?.trim()||"",l=m("[data-ogre-ai-sl]")?.value||"8",u=m("[data-ogre-ai-sl-custom]")?.value?.trim()||"",d=m("[data-ogre-ai-delay]")?.value||"5",p=m("[data-ogre-ai-delay-custom]")?.value?.trim()||"",f=m("[data-ogre-ai-slippage]")?.value||"400",y=m("[data-ogre-ai-slippage-custom]")?.value?.trim()||"";Xm({amountSol:a,runCount:o,category:r,takeProfitSelect:s,takeProfitCustom:c,stopLossSelect:l,stopLossCustom:u,delaySelect:d,delayCustom:p,slippageSelect:f,slippageCustom:y,walletGroup:t});const g=x("[data-ogre-ai-delay]","[data-ogre-ai-delay-custom]","60"),S=x("[data-ogre-ai-tp]","[data-ogre-ai-tp-custom]","100"),A=x("[data-ogre-ai-sl]","[data-ogre-ai-sl-custom]","40"),T=x("[data-ogre-ai-slippage]","[data-ogre-ai-slippage-custom]","400"),b="";if(!e.length&&!t)throw new Error("Choose at least one managed wallet or enter a group label.");if(!a)throw new Error("Enter SOL per wallet for Ogre A.I.");return{walletIndexes:e,walletGroup:t,category:r,mode:r,amountSol:a,runCount:o,sellDelay:g,takeProfitPct:S,stopLossPct:A,sellPercent:"100",slippageBps:T,minScore:b,recentMints:Vl()}}function wo(e){n.ogreAiStatus=e||"";const t=m("[data-ogre-ai-status]");v(t,n.ogreAiStatus)}async function qy(){if(Rr){Wa=!0,wo("Stopping the hunt after this scan...");return}const e=Symbol("ogre-ai-run");Wa=!1;try{const t=Uy();n.ogreAiLoading=!0,Rr=e;const a=Array.isArray(t.recentMints)?[...t.recentMints]:[];let r=null,o=!1,s=0;const c=120;for(;!o&&!Wa&&s<c&&(s+=1,wo(s===1?"Scanning fresh low-MC pairs and arming managed exits...":`Hunting fresh pairs... (scan ${s}) - tap Scan again to stop.`),h(),r=await k("/api/web/ogre-ai/start",{method:"POST",body:JSON.stringify({...t,recentMints:a}),timeoutMs:te}),o=Number(r.ogreAi?.armedCount||0)>0||(r.ogreAi?.plans?.length||0)>0,!o);){for(const l of r.ogreAi?.errors||[])l?.tokenMint&&!a.includes(l.tokenMint)&&a.push(l.tokenMint);for(const l of r.ogreAi?.attemptedPicks||[])l?.tokenMint&&!a.includes(l.tokenMint)&&a.push(l.tokenMint);if(Wa)break;await Ce(5e3)}n.ogreAiResult=r?.ogreAi,Gm(r?.ogreAi),n.tradePlanResult=r?.ogreAi?.plans?.[0]||n.tradePlanResult,wo(o?r?.ogreAi?.message||"Ogre A.I. run armed.":Wa?"Hunt stopped. Tap Scan to hunt again.":"Still hunting - no clean fresh pair armed yet. Tap Scan to keep going."),o&&K(xe(r?.ogreAi?.plans?.[0]),"ogre-ai-run"),n.activeTab="ogreAi",h()}catch(t){wo(t.message),$(t.message)}finally{n.ogreAiLoading=!1,Wa=!1,Rr===e&&(Rr=null),h()}}function rr(e){const t=m("[data-autopilot-status]");t&&(t.textContent=String(e||""))}async function Hy({silent:e=!0}={}){try{const t=await k("/api/web/ogre-ai/autopilot");n.ogreAutopilot=t.autopilot||null,n.activeTab==="ogreAi"&&h()}catch(t){e||rr(t.message)}}function Ky(){return{enabled:!!m("[data-autopilot-enabled]")?.checked,category:Zr(),amountSol:m("[data-ogre-ai-amount]")?.value?.trim()||(n.ogreAutopilot?.amountSol??"0.05"),takeProfitPct:x("[data-ogre-ai-tp]","[data-ogre-ai-tp-custom]","25"),stopLossPct:x("[data-ogre-ai-sl]","[data-ogre-ai-sl-custom]","8"),sellDelay:x("[data-ogre-ai-delay]","[data-ogre-ai-delay-custom]","5"),slippageBps:x("[data-ogre-ai-slippage]","[data-ogre-ai-slippage-custom]","400"),walletIndexes:qe("ogre-ai"),walletGroup:m("[data-ogre-ai-group]")?.value?.trim()||"",maxSpendPerHourSol:m("[data-autopilot-maxspend]")?.value?.trim()||"0.3",maxConcurrent:m("[data-autopilot-maxconcurrent]")?.value?.trim()||"2",minScore:m("[data-autopilot-minscore]")?.value?.trim()||"62",intervalMinutes:m("[data-autopilot-interval]")?.value?.trim()||"10"}}async function Vy(){if(n.ogreAutopilotBusy)return;const e=Ky();if(e.enabled&&!e.walletIndexes.length&&!e.walletGroup){rr("Pick at least one managed wallet (or a wallet group) above before enabling autopilot.");return}if(!(e.enabled&&!await Le({title:"Enable Ogre A.I. Autopilot",lines:["This will spend REAL SOL automatically.",`Category: ${qu(e.category)}`,`Up to ${e.amountSol} SOL per wallet, max ${e.maxSpendPerHourSol} SOL/hour, every ${e.intervalMinutes} min.`,`Only buys picks scoring >= ${e.minScore}, max ${e.maxConcurrent} live plans.`,"You can turn it off any time."],confirmLabel:"Enable Autopilot"}))){n.ogreAutopilotBusy=!0,rr(e.enabled?"Arming autopilot...":"Saving..."),h();try{const t=await k("/api/web/ogre-ai/autopilot",{method:"POST",body:JSON.stringify(e)});n.ogreAutopilot=t.autopilot||null,rr(n.ogreAutopilot?.lastStatus||"Saved.")}catch(t){rr(t.message),$(t.message)}finally{n.ogreAutopilotBusy=!1,h()}}}function Ut(e){const t=m("[data-kol-status]");v(t,e)}function zy(e){const t=qe("kol"),a=m("[data-kol-group]")?.value?.trim()||"",r=m("[data-kol-amount]")?.value||"",o=x("[data-kol-delay]","[data-kol-delay-custom]","5"),s=x("[data-kol-tp]","[data-kol-tp-custom]","25"),c=x("[data-kol-sl]","[data-kol-sl-custom]","8"),l=x("[data-kol-loop]","[data-kol-loop-custom]","1"),u=x("[data-kol-loop-delay]","[data-kol-loop-delay-custom]","0"),d=x("[data-kol-slippage]","[data-kol-slippage-custom]","400");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!e)throw new Error("Pick a KOL signal first.");return n.tradeToken=e,n.volumeToken=e,n.bundleToken=e,{tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:o,takeProfitPct:s,stopLossPct:c,loopCount:l,loopDelay:u,sellPercent:"100",slippageBps:d,...ma("kol")}}function jy(e){const t=qe("kol"),a=m("[data-kol-group]")?.value?.trim()||"",r=m("[data-kol-amount]")?.value||"",o=x("[data-kol-delay]","[data-kol-delay-custom]","5"),s=x("[data-kol-tp]","[data-kol-tp-custom]","25"),c=x("[data-kol-sl]","[data-kol-sl-custom]","8"),l=x("[data-kol-loop]","[data-kol-loop-custom]","1"),u=x("[data-kol-loop-delay]","[data-kol-loop-delay-custom]","0"),d=x("[data-kol-slippage]","[data-kol-slippage-custom]","400"),p=String(e||n.kolWallet||m("[data-kol-wallet]")?.value||"").trim();if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!p)throw new Error("Paste or choose a KOL wallet first.");if(!Wt(p))throw new Error("That KOL entry does not have a verified Solana wallet yet.");return{copyWallet:p,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:o,takeProfitPct:s,stopLossPct:c,loopCount:l,loopDelay:u,sellPercent:"100",slippageBps:d,...ma("kol")}}async function Gy(e){try{const t=zy(e);Ut("Buying and arming KOL copy plan...");const a=await k("/api/web/kol/entry",{method:"POST",body:JSON.stringify(t)});n.kolResult=a.plan,K(xe(a.plan),"kol-copy-plan"),n.activeTab="kol",h()}catch(t){Ut(t.message)}}async function Xy(e){try{const t=jy(e);Ut("Arming Copy Wallet watch...");const a=await k("/api/web/kol/copy-wallet",{method:"POST",body:JSON.stringify(t)});n.kolResult=a.plan,n.kolWallet=t.copyWallet,n.activeTab="kol",h()}catch(t){Ut(t.message)}}function qe(e){return[...document.querySelectorAll(`[data-${e}-wallet]:checked`)].map(t=>t.value)}function So(e){const t=m("[data-bundle-status]");v(t,e)}function Ld(){const e=m("[data-bundle-token]")?.value?.trim()||"",t=qe("bundle"),a=m("[data-bundle-group]")?.value?.trim()||"",r=m("[data-bundle-amount]")?.value||"",o=x("[data-bundle-percent]","[data-bundle-percent-custom]","100"),s=x("[data-bundle-slippage]","[data-bundle-slippage-custom]","400");if(!e)throw new Error("Paste a token CA first.");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");return n.bundleToken=e,{tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,percent:o,slippageBps:s}}function Jy(){const e=Ld();let t=x("[data-bundle-plan-delay]","[data-bundle-plan-delay-custom]","5"),a=x("[data-bundle-plan-sell-percent]","[data-bundle-plan-sell-percent-custom]","100");return{sellDelay:t,sellPercent:a}=sn(t,a),{...e,sellDelay:t,takeProfitPct:x("[data-bundle-plan-tp]","[data-bundle-plan-tp-custom]","60"),stopLossPct:x("[data-bundle-plan-sl]","[data-bundle-plan-sl-custom]","10"),loopCount:x("[data-bundle-plan-loop]","[data-bundle-plan-loop-custom]","1"),loopDelay:x("[data-bundle-plan-loop-delay]","[data-bundle-plan-loop-delay-custom]","0"),sellPercent:a,...ma("bundle-plan")}}async function xd(e){const t=L();let a=null,r="";const o=e==="buy"?"bundle-buy":"bundle-sell";try{a=Ld();const s=at(o,a.tokenMint,"bundle");if(s){ne("buttonDoubleClickPrevented"),W({component:"post-trade",action:"trade-action-dedupe",durationMs:L()-t,cacheHit:!0,requestId:s.tradeAttemptId||"",details:`${o}:${w(a.tokenMint)}`});return}r=gt(o),V(o,a.tokenMint,"bundle",{state:"clicked",tradeAttemptId:r,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"trade-click-to-ui",durationMs:L()-t,requestId:r,details:`${o}:${w(a.tokenMint)}`}),h(),So(e==="buy"?"Sending bundle buy...":"Sending bundle sell..."),await Ce(20);const c=L();V(o,a.tokenMint,"bundle",{state:"submitting"});const l=await k(`/api/web/bundle/${e}`,{method:"POST",body:JSON.stringify({...a,tradeAttemptId:r,clientClickToUiMs:Math.round(c-t)}),dedupe:!1});W({component:"post-trade",action:"trade-backend-ack",durationMs:L()-c,requestId:r,resultCount:l.bundle?.successCount||0,details:o}),n.bundleResult=l.bundle,V(o,a.tokenMint,"bundle",{state:"submitted",signature:xe(l.bundle)}),K(xe(l.bundle),`bundle-${e}`,{tradeAttemptId:r}),n.activeTab="bundle",h(),Pe(o,a.tokenMint,"bundle",3e3)}catch(s){a?.tokenMint&&(V(o,a.tokenMint,"bundle",{state:"error",error:D(s.message||"Bundle trade failed")}),Pe(o,a.tokenMint,"bundle",4e3)),W({component:"post-trade",action:"trade-action-error",durationMs:L()-t,requestId:r,errorCode:s?.code||s?.name||"BUNDLE_TRADE_FAILED",details:D(s.message||"Bundle trade failed")}),So(s.message)}}async function Yy(){try{const e=Jy();So("Buying and arming bundle exits...");const t=await k("/api/web/bundle/plan",{method:"POST",body:JSON.stringify(e)});n.bundleResult=t.plan,K(xe(t.plan),"bundle-plan"),n.activeTab="bundle",h()}catch(e){So(e.message)}}function oe(e,t){return(n.presets?.[e]||[]).find(a=>a.id===t)||null}function Md(){(n.selectedTradePresetId==="custom"||n.selectedTradePresetId&&!oe("trade",n.selectedTradePresetId))&&(n.selectedTradePresetId=""),(n.selectedBundlePresetId==="custom"||n.selectedBundlePresetId&&!oe("bundle",n.selectedBundlePresetId))&&(n.selectedBundlePresetId=""),n.editingTradePresetId&&!oe("trade",n.editingTradePresetId)&&(n.editingTradePresetId=""),n.editingBundlePresetId&&!oe("bundle",n.editingBundlePresetId)&&(n.editingBundlePresetId="")}function Bd(e,t="trade",a=""){t==="bundle"?n.bundleToken=e:n.tradeToken=e,n.activeTab=t,a&&$(a),window.history.pushState({},"","/terminal"),h({force:!0})}async function Rd(e=""){const t=String(e||"").trim();if(!t)return;const a=t.replace(/^\$+/,"").trim(),r=/^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(a),o=(s,c={})=>wt(ge(s,{source:"global-search",...c}),{defaultTab:"buy",view:"chartTxns",focusAmountInput:!0,source:"global-search"});if(r){o(a);return}try{const c=((await k(`/api/web/token-search?q=${encodeURIComponent(t)}`)).matches||[])[0];if(!c?.tokenMint){$(`No coin found for "${t}". Try the exact ticker or paste the contract address.`);return}o(c.tokenMint,{symbol:c.symbol,name:c.name})}catch(s){$(s.message||"Token search failed.")}}function ge(e="",t={}){const a=String(e||"").trim(),r=a?or().find(o=>String(o?.tokenMint||"")===a):null;return{chain:"solana",tokenMint:a,tokenAddress:a,mint:a,pairAddress:r?.pairAddress||r?.pairId||t.pairAddress||"",symbol:r?.symbol||t.symbol||w(a),name:r?.name||t.name||"Token",imageUri:r?.imageUrl||t.imageUri||"",source:t.source||r?.source||r?.category||"",dex:r?.dexId||t.dex||"",pool:r?.pool||t.pool||"",pumpUrl:r?.pumpUrl||t.pumpUrl||"",isPump:!!(r?.isPump||t.isPump||a.toLowerCase().endsWith("pump")),graduated:!!(r?.graduated||r?.isGraduated||r?.bonded||r?.isBonded||t.graduated||t.isGraduated||t.bonded||t.isBonded),isGraduated:!!(r?.isGraduated||r?.graduated||r?.bonded||r?.isBonded||t.isGraduated||t.graduated||t.bonded||t.isBonded),bonded:!!(r?.bonded||r?.isBonded||r?.graduated||r?.isGraduated||t.bonded||t.isBonded||t.graduated||t.isGraduated),isBonded:!!(r?.isBonded||r?.bonded||r?.graduated||r?.isGraduated||t.isBonded||t.bonded||t.graduated||t.isGraduated)}}function Hk(e={},t={}){return ge(e?.tokenMint||e?.mint||e?.tokenAddress||"",{...t,pairAddress:e?.pairAddress||e?.pairId||t.pairAddress||"",symbol:e?.symbol||t.symbol||"",name:e?.name||t.name||"",imageUri:e?.imageUrl||e?.imageUri||t.imageUri||"",source:t.source||e?.source||e?.category||"",dex:e?.dexId||t.dex||"",pool:e?.pool||t.pool||"",pumpUrl:e?.pumpUrl||t.pumpUrl||"",isPump:e?.isPump||t.isPump,graduated:e?.graduated||e?.isGraduated||e?.bonded||e?.isBonded||t.graduated||t.isGraduated||t.bonded||t.isBonded,isGraduated:e?.isGraduated||e?.graduated||e?.bonded||e?.isBonded||t.isGraduated||t.graduated||t.bonded||t.isBonded,bonded:e?.bonded||e?.isBonded||e?.graduated||e?.isGraduated||t.bonded||t.isBonded||t.graduated||t.isGraduated,isBonded:e?.isBonded||e?.bonded||e?.graduated||e?.isGraduated||t.isBonded||t.bonded||t.graduated||t.isGraduated})}function ko(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim();return t?(n.smartChartTokenRef={...e,tokenMint:t,tokenAddress:t,mint:t},Ro(n.smartChartTokenRef),n.terminalToken=t,n.terminalAutoToken=t,n.tradeToken=t,n.bundleToken=t,n.volumeToken=t,n.smartChartToken=t,t):""}function Qy(e,t={}){const a=new URLSearchParams;a.set("token",e);const r=t.defaultTab==="sell"?"sell":t.defaultTab==="chart"?"chart":"buy";return a.set("tab",r),["chart","chartTxns","txns","info"].includes(t.view)&&a.set("view",t.view),t.focusAmountInput&&a.set("focusAmount","1"),t.source&&a.set("source",String(t.source).slice(0,40)),t.returnTo&&a.set("returnTo",t.returnTo),`/terminal/chart?${a.toString()}`}function qi(e={}){const t=String(e?.tokenMint||e?.mint||e?.tokenAddress||"").trim(),a=`${e?.source||""} ${e?.category||""} ${e?.dex||""} ${e?.pool||""}`.toLowerCase(),r=!!(e?.isPump||e?.pumpUrl||t.toLowerCase().endsWith("pump")||a.includes("pump")),o=!!(e?.graduated||e?.isGraduated||e?.bonded||e?.isBonded||e?.complete||e?.completed||e?.bondingComplete||e?.raydiumPool||e?.poolAddress);return!!(r&&!o)}function Zy(e={},t={}){return["chart","chartTxns","txns","info"].includes(t.view)?t.view:"chartTxns"}const $o=new Map;function Hi(e){const t=String(e||"").trim();if(!t)return;const a=$o.get(t)||0;Date.now()-a<3e4||($o.set(t,Date.now()),$o.size>200&&$o.clear(),k(`/api/web/prebuy-warm?mint=${encodeURIComponent(t)}`,{method:"GET"}).catch(()=>{}))}function wt(e={},t={}){ra("chartRouteStart");const a=L(),r=ko(e);if(!r){$("Select a token before opening the chart.");return}Yi(e,{source:t.source||"token-entry"}),Hi(r),n.chartTradeTab=t.defaultTab==="sell"?"sell":(t.defaultTab==="chart","buy"),n.smartChartView=Zy(n.smartChartTokenRef||e,t),n.chartFocusAmountInput=!!t.focusAmountInput,n.chartScrollIntoView=!0,n.activeTab="smartChart",n.route="terminal",n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},n.chartTradeStatus="",n.chartBuyWalletIndex="";const o=Qy(r,{defaultTab:t.defaultTab||"buy",view:n.smartChartView,focusAmountInput:t.focusAmountInput,source:t.source||"token-entry",returnTo:t.returnTo||za()});window.history.pushState({},"",o),h({force:!0}),H("chart-route-open",a,{component:"smartChart",cacheHit:!!(Ye(r)?.cacheHit||lr(r)?.pairAddress),details:`${r}:${t.source||"token-entry"}`})}function Ki(){if(!window.location.pathname.includes("/terminal/chart"))return;ra("chartRouteStart");const e=L(),t=new URLSearchParams(window.location.search||""),a=String(t.get("token")||t.get("mint")||"").trim(),r=String(n.smartChartToken||"").trim();if(a){const o=ge(a,{source:t.get("source")||"route"});ko(o),Yi(o,{source:t.get("source")||"route"}),t.get("buy")==="1"&&window.setTimeout(()=>{try{ln(o,{forceModal:!0,source:"deep-link"})}catch{}},900),a!==r&&(n.chartTradeStatus="",n.chartBuyWalletIndex="")}n.chartTradeTab=t.get("tab")==="sell"?"sell":"buy",n.smartChartView=["chart","chartTxns","txns","info"].includes(t.get("view"))?t.get("view"):"chartTxns",n.chartFocusAmountInput=t.get("focusAmount")==="1",n.chartScrollIntoView=!0,n.route="terminal",n.activeTab="smartChart",H("chart-route-apply",e,{component:"smartChart",cacheHit:!!(Ye(a)?.cacheHit||lr(a)?.pairAddress),details:a})}function ln(e={},t={}){const a=ko(e);if(!a){$("Select a token before quick buying.");return}const r=cn(a);if(r&&Mo(r)){$("Safety block: this token has mintable/freezable/honeypot-style risk signals and cannot be quick bought.");return}const o=t.preset||lt(),s=o&&!t.forceModal?He(o):"",c=o?.walletIndex||(o?.walletIndexes||[])[0]||(n.wallets[0]?.index?String(n.wallets[0].index):"");if(o&&s&&c&&!t.forceModal){Po(a,{...o,walletIndex:c,walletIndexes:[c]});return}const l=le();n.quickBuyModal={open:!0,tokenMint:a,amountSol:s||n.quickBuyAmountOverride||"",walletIndex:l?.publicKey?"connected":n.wallets[0]?.index?String(n.wallets[0].index):"",slippageBps:"400",status:s?`Preset ${s} SOL loaded. Confirm when ready.`:o?"Your selected preset has no SOL amount - set one here (or edit the preset in the Trade tab) and Buy becomes one-click.":"Enter a SOL amount to quick buy - or save a Trade preset and Buy becomes one-click.",source:t.source||"quick-buy",error:"",tradeAttemptId:""},Hi(a),h({force:!0}),requestAnimationFrame(()=>m("[data-quick-buy-modal-amount]")?.focus())}function Vi(){n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},h({force:!0})}function ev(e={},t={}){if(!_("protectedBuyEnabled",!0))return;const a=ko(e);if(!a){$("Select a token before opening Protected Buy.");return}const r=cn(a);if(r&&Mo(r)){$("Safety block: this token has mintable/freezable/honeypot-style risk signals and cannot be bought from quick actions.");return}const o=wa(a)||{tokenMint:a},s=Qe(o),c=t.presetId||s.protectedBuyPreset||tl(s.verdict),l=Number(X(t.amountSol||n.quickBuyAmountOverride||He()||"0.1")),u=c==="conservative"&&Number.isFinite(l)&&l>.25?"0.25":dr(l||.1),d=le();Hi(a),n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},n.protectedBuyModal={open:!0,tokenMint:a,presetId:c,amountSol:u,walletIndex:t.walletIndex||(d?.publicKey?"connected":n.wallets[0]?.index?String(n.wallets[0].index):""),slippageBps:String(t.slippageBps||"400"),riskAccepted:!1,status:s.verdict==="AVOID"?"Avoid recommended. Check the risk box if you still want to continue.":"Review this plan before wallet confirmation.",error:"",source:t.source||"protected-buy"},h({force:!0}),requestAnimationFrame(()=>m("[data-protected-buy-amount]")?.focus())}function To(){n.protectedBuyModal={...n.protectedBuyModal,open:!1,status:"",error:"",riskAccepted:!1},h({force:!0})}function tv(){const e=n.protectedBuyModal||{},t=String(e.tokenMint||"").trim(),a=String(m("[data-protected-buy-preset]")?.value||e.presetId||"conservative").trim(),r=String(m("[data-protected-buy-wallet]")?.value||e.walletIndex||"").trim(),o=X(m("[data-protected-buy-amount]")?.value||e.amountSol||""),s=String(m("[data-protected-buy-slippage]")?.value||e.slippageBps||"400").trim(),c=!!(m("[data-protected-buy-risk-accept]")?.checked||e.riskAccepted);if(!t)throw new Error("Select a token before Protected Buy.");if(!r)throw new Error("Choose a wallet before Protected Buy.");if(!o)throw new Error("Enter a SOL amount greater than zero.");return{tokenMint:t,presetId:a,walletIndex:r,amountSol:o,slippageBps:s,riskAccepted:c}}function av(){const e=n.protectedBuyModal||{};if(!e.open)return"";const t=wa(e.tokenMint)||{tokenMint:e.tokenMint},a=Qe(t),r=Fo(e.presetId),o=ce(e.walletIndex),s=a.verdict==="AVOID"&&!e.riskAccepted,c=/submitting|opening wallet/i.test(String(e.status||""));return`
  ...
  `},{key:"fund",label:"Fund / Sweep",hint:"Move SOL",html:`${mb()}${bv()}${pb()}${gv()}`},{key:"create",label:"Create",hint:"New wallets",html:Za()},{key:"import",label:"Import",hint:"Add keys",html:ku()},{key:"backup",label:"Backup",hint:"Save / restore",html:Su()},{key:"downloads",label:"Downloads",hint:"Exports",html:$u()}];if(!n.wallets.length){const r=a.filter(o=>o.key!=="balances"&&o.key!=="fund");return`
      ${e}
  ...
  `}function $v(e){const t=n.balances.find(s=>Number(s.index)===Number(e.index));if(!t)return"<span>Balance: loading</span>";if(t.error)return`<span>Balance check failed: ${i(t.error)}</span>`;const a=Number.isFinite(Number(t.sol))?`${Number(t.sol).toFixed(4)} SOL`:"SOL unavailable",r=Number(t.tokens?.length||0)===1?"1 token":`${Number(t.tokens?.length||0)} tokens`,o=t.warnings?.length?` | ${t.warnings.length} warning(s)`:"";return`<span>Balance: ${i(a)} | ${i(r)}${i(o)}</span>`}function Tv(){const e=rt(),t=`
    <section class="account-check-card">
      <div>
  ...
  `}function Qi(e={},t="chart"){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=t==="chartTxns"||t==="txns",o=t==="info",s=Vd(e)||Wv(e),c=o?`DexScreener info for ${e.symbol||w(a)}`:r?`DexScreener chart and transactions for ${e.symbol||w(a)}`:`DexScreener chart for ${e.symbol||w(a)}`,l=["smart-chart-frame","smart-chart-dex-frame",r?"smart-chart-transactions-frame":"",t==="chartTxns"?"smart-chart-combined-frame":"",o?"smart-chart-info-frame":""].filter(Boolean).join(" "),d=s?"Loading DEX chart while resolving fastest pair...":o?"Loading token info...":r?"Loading DEX transactions...":"Loading DEX chart...",p=Gd(e,t);return`
  ...
  `}function zv(e={}){if(!_("slimeShieldEnabled",!0)){const o=Number(e.bestPickScore||e.score||0);return`<em class="mobile-score-mini" title="${i(Zi(e))}">${i(o?`${o}`:"n/a")} score</em>`}const t=Qe(e),a=String(e.tokenMint||t.mint||"").trim(),r=t.verdict||"CAUTION";return`<button type="button" class="mobile-score-mini slimeshield-mini slimeshield-${i(un(r))}" data-slimeshield-details="${i(a)}" title="${i(t.summary||"Open SlimeShield details")}">Details</button>`}function Gk(e={}){if(!_("slimeShieldEnabled",!0)){const o=Number(e.bestPickScore||e.score||0),s=o?`${o}`:"n/a";return`
  ...
  `}function rp(e,{source:t,actionLabel:a="Trade",isKolContext:r=!1}={}){const o=Xo(e.tokenMint);return`
    ...
    ${Zd(e,{compact:!0})}
  `}function Qv(e,t={}){const a=t.limit||6,r=t.actionLabel||"Trade",o=t.emptyTitle||"No signals loaded",s=t.emptyMessage||"Refresh the feed to load current signals.",c=ya(e||[],a,t.rotateKey||"",t.stickyCount||0),l=t.context==="kol",u=t.cooksStyle?" is-cooks":"";return c.length?`
  ...
  `:O(o,s)}function St(e,t={}){if(t.layout==="terminal")return Qv(e,t);const a=t.limit||6,r=t.actionLabel||"Trade",o=t.emptyTitle||"No signals loaded",s=t.emptyMessage||"Refresh the feed to load current signals.",c=ya(e||[],a,t.rotateKey||"",t.stickyCount||0),l=t.context==="kol";return c.length?`
  ...
  `:O(o,s)}function pn(e){const t=oe(e,e==="trade"?n.selectedTradePresetId:n.selectedBundlePresetId);if(!t)return"Custom / manual";const a=[t.name,`${t.amountSol} SOL`,`TP ${t.takeProfitPct}`,`SL ${t.stopLossPct}`];return t.sellDelay&&t.sellDelay!=="off"&&a.push(`Timer ${t.sellDelay}`),a.join(" | ")}function Jk(){return`
  ...
  `}function sp(){Or&&window.clearTimeout(Or),Or=window.setTimeout(()=>{Or=null,Z("live"),Z("launch"),Z("sniper"),h()},180)}function Do(e={}){const t=Number(e.pairCreatedAt||e.createdAt||0);if(t>0){const o=t<1e10?t*1e3:t;return Math.max(0,Math.round((Date.now()-o)/1e3))}const a=["source-age","trusted-source-age"].includes(String(e.pairAgeSource||"").toLowerCase()),r=Number(e.pairAgeSeconds);return a&&Number.isFinite(r)&&r>=0?r:Number.POSITIVE_INFINITY}const iw=100,lw=7200,cw=75e4,uw=86400,dw=2e6,pw=28e3,ip=18e4,mw=16e4;function lp(){const e=Xd();return be([...n.livePairs?.rows||[],...n.livePairsByBucket.live?.rows||[],...n.livePairsByBucket.under1h?.rows||[],...n.livePairsByBucket.under3h?.rows||[],...n.livePairsByBucket.under1d?.rows||[],...n.scan?.rows||[],...n.kolScan?.rows||[]]).map(t=>Yd(t,e.get(String(t?.tokenMint||"")))).filter(t=>t?.tokenMint&&!ir(t))}function hn(e={}){return E(e.marketCap,e.fdv)}function cp(e={}){return E(e.liquidityUsd)}function up(e={}){return E(e.volumeM5,e.volume5m,e.volumeM15,e.volumeM30,e.volumeH1,e.volumeH24,e.volumeUsd)}function rl(e={}){if(gn(e))return!1;const t=Do(e);return!Number.isFinite(t)||t<0||t>lw||hn(e)>cw?!1:qt(e)<70}function _o(e={}){if(gn(e))return!1;const t=qt(e),a=hn(e),r=a>=pw&&a<=ip;return t>=55&&(!a||a<=ip)||r}function dp(e={}){if(rl(e)||_o(e)||gn(e))return!1;const t=Do(e);return Number.isFinite(t)&&(t<0||t>uw)||hn(e)>dw?!1:cp(e)>0||up(e)>0||Number(e.bestPickScore||e.score||0)>0||Array.isArray(e.reasons)&&e.reasons.length>0}function pp(e={}){return[e.tokenMint,e.symbol,e.name,e.source,e.category,e.dexId,e.dexName,e.poolType,e.platform,e.raydiumPool,e.pairUrl,...e.riskFlags||[],...e.reasons||[]].filter(Boolean).join(" ").toLowerCase()}function qt(e={}){const t=E(e.bondingProgressPct,e.bondingProgress,e.bonding_curve_progress,e.bondingCurveProgress,e.pumpProgress,e.graduationProgress,e.completion,e.completePct);if(t>0)return t<=1?t*100:t;const a=hn(e),r=pp(e);return(!!e.isPump||r.includes("pump")||String(e.tokenMint||"").toLowerCase().endsWith("pump"))&&a>0?Math.max(1,Math.min(99,a/69e3*100)):0}function gn(e={}){if(e.isGraduated||e.graduated||e.bonded||e.isBonded||e.complete||e.completed||e.bondingComplete||e.raydiumPool||e.raydium_pool||e.poolAddress)return!0;const t=pp(e);if(/\b(graduated|bonded|bonding complete|complete)\b/.test(t))return!0;const a=!!e.isPump||t.includes("pump")||String(e.tokenMint||"").toLowerCase().endsWith("pump"),r=hn(e);return a&&r>=mw?!0:!!(a&&/\b(raydium|meteora|orca)\b/.test(t))}function Uo(e={}){if(gn(e))return"graduated";const t=String(e.slimeScopeCategory||"").trim().toLowerCase();return t==="graduated"?"graduated":_o(e)||t==="graduating"?"graduating":rl(e)?"new":(t==="steady"||t==="unknown"||dp(e),"steady")}function mp(e={}){const t=Number(e.bestPickScore||e.score||0),a=up(e),r=cp(e),o=hn(e),s=Do(e),c=Number.isFinite(s)?Math.max(0,86400-s)/86400:0;return t*1e3+Math.log10(a+1)*160+Math.log10(r+1)*120+Math.log10(o+1)*80+c*100}function fp(e=[]){return[...e].sort((t,a)=>mp(a)-mp(t)||Ze(t,a))}function fw(e=[],t=[],a=iw){const r=new Set,o=[];for(const s of[...e,...t]){const c=String(s?.tokenMint||"");if(!(!c||r.has(c))&&(r.add(c),o.push(s),o.length>=a))break}return o}function hp(e=n.slimeScopeMode){const t=lp(),a=e==="graduated"?"graduated":e==="graduating"?"graduating":e==="steady"?"steady":"new",r=t.filter(l=>Uo(l)===a),o=t.filter(l=>{const u=Uo(l);return a==="graduated"?u==="graduated"||gn(l):a==="graduating"?u==="graduating"||_o(l):a==="steady"?u==="steady"||dp(l):u==="new"||rl(l)}),s=a==="new"?[...r].sort(Ze):fp(r),c=a==="new"?be(o).sort(Ze):fp(o);return fw(s,c)}function hw(e=[],t="new"){const a=nt(`slimeScope:${t}`,e).slice(0,12);return a.length?a.map((r,o)=>{const s=r.pairAgeLabel||Kt(r)||"age ?",c=N(r.marketCapLabel,r.fdvLabel,B(ut(r)),"checking"),l=N(r.liquidityLabel,B(dt(r)),"checking"),u=N(r.volumeM15Label,B(bl(r)),"checking");return`
    ...
    <div class="slime-scope-web-columns" aria-label="Slime Scope desktop columns">
      ${[["new","New","Fresh launches"],["graduating","Graduating","Near migration"],["graduated","Graduated","Moved to market"]].map(([t,a,r])=>{const o=hp(t);return`
  ...
  `}function bw(){const e=Fp(),[,,t]=e,a=_c(n.slimeScopeMode),o=!!(z("slimeScope").inFlight||n.livePairsLoadingByBucket?.[a]),s=n.livePairsRefreshErrorByBucket?.[a],c=be(Wp(lp(),e[0])),l=nt("slimeScope",c),u=l.length?Xn()?ct(l,{context:"live",shareBuilder:Ta,hideToolbar:!0}):St(l,{layout:"terminal",limit:Math.max(1,l.length),actionLabel:"Trade"}):s?O("Unable to load pairs. Try refreshing.","Cook Spot hit a snag — it keeps retrying, or tap Refresh Scope."):o?O("Loading Cook Spot…","Scanning DEX, boosted, and pump pairs for this category."):O("No pairs found for this filter yet","Try another category — Cook Spot keeps scanning in the background.");return`
      ...
      <main class="command-workspace">
        ...
        <section class="command-grid">
          ...
          <article class="terminal-panel kol-panel">
            ...
            ${A.length?St(A,{layout:"terminal",cooksStyle:!0,limit:12,actionLabel:P,emptyTitle:"No KOL signals loaded",emptyMessage:"Refresh KOL Tracker to load signals."}):u?pr(o,"KOL signals"):St(A,{layout:"terminal",cooksStyle:!0,limit:12,actionLabel:P,emptyTitle:"No KOL signals loaded",emptyMessage:"Refresh KOL Tracker to load signals."})}
          </article>
        </section>
  ...
  `}function bp(e=[],t="risk",a="No strong signal cached yet."){const r=(Array.isArray(e)?e:[]).filter(o=>t==="positive"?o.severity==="positive":o.severity!=="positive").slice(0,5);return r.length?`
    <ul class="slimeshield-factor-list">
      ${r.map(o=>`
        <li>
    ...
    <aside class="dev-info-drawer" role="dialog" aria-modal="true" aria-label="Dev Info details">
      ...
      <section>
        ...
        <dl class="kol-dump-metrics">
          ...
          <div><dt>Liquidity</dt><dd>${i(jo(P,B))}</dd></div>
  ...
  `}async function ll(e="",t={}){const a=String(e||"").trim();if(!a||!_("replayBeforeBuyEnabled",!0))return null;if(!t.force&&n.replayResults?.[a])return n.replayResults[a];if(n.replayLoading?.[a])return null;n.replayLoading={...n.replayLoading||{},[a]:!0},hr(),ka();try{const r=new URLSearchParams({mint:a});t.force&&r.set("force","true");const s=(await k(`/api/web/replay-before-buy?${r.toString()}`,{timeoutMs:t.force?4500:3e3,preserveSafeError:!0}))?.replay||null;return s&&(n.replayResults={...n.replayResults||{},[a]:s},ne(s.cacheHit?"replayCacheHit":"replayCacheMiss")),s}catch{return n.replayResults={...n.replayResults||{},[a]:$p(a)},null}finally{const r={...n.replayLoading||{}};delete r[a],n.replayLoading=r,hr(),ka()}}function Pw(e=""){const t=String(e||"").trim();!t||!_("replayBeforeBuyEnabled",!0)||(n.replayDetails={open:!0,tokenMint:t},_a(),hr(),ll(t))}function cl(){n.replayDetails={open:!1,tokenMint:""},hr(),Er()}function hr(){let e=document.querySelector("[data-replay-drawer-root]");e||(e=document.createElement("div"),e.dataset.replayDrawerRoot="true",document.body.appendChild(e));const t=n.replayDetails||{},a=!!(t.open&&t.tokenMint);if(document.body.classList.toggle("replay-drawer-open",a),!a||!_("replayBeforeBuyEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=String(t.tokenMint||"").trim(),o=il(r),s=!!n.replayLoading?.[r],c=`
    ...
    <aside class="slimeshield-drawer" role="dialog" aria-modal="true" aria-label="SlimeShield details">
      ...
      <section>
        ...
        <dl class="kol-dump-metrics">
          ...
          <div><dt>Age</dt><dd>${i(Number.isFinite(A)?Ko(A):zo(o.pairAgeLabel||Kt(o),"Not cached yet"))}</dd></div>
      ...
      <section class="slimeshield-action-note">
        <h4>Suggested Action</h4>
        <p>${i(yw(s.suggestedAction))}</p>
        <small>Protected Buy preset suggestion: ${i(vw(s.protectedBuyPreset))}</small>
      </section>
      ${Aw(r)}
      <div class="slimeshield-drawer-actions">
        ${_("protectedBuyEnabled",!0)?`<button type="button" class="primary" data-protected-buy-open="${i(r)}" data-protected-buy-preset="${i(s.protectedBuyPreset||tl(c))}" data-protected-buy-source="slimeshield-drawer">Protected Buy</button>`:""}
  ...
  `}function Cw(e=""){const t=String(e||"").trim();return t?(n.pnl?.trades||[]).filter(a=>String(a?.tokenMint||a?.mint||"").trim()===t):[]}function t0(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=Cw(a),o=!!(dn(e)&&qi(e)),s=o?dn(e):e.dexUrl||Q(Ud(e)||a),c=o?"Pump":"DEX";return`
  ...
  `}function Mw(){try{return Bw()}catch(e){console.error("Smart Chart render failed:",e);const t=String(n.smartChartToken||n.tradeToken||n.terminalToken||"").trim(),a=t?w(t):"No token selected",r=t?`https://dexscreener.com/solana/${encodeURIComponent(t)}?embed=1&theme=dark&trades=1&info=0`:"";return`
    ...
    `}}function Bw(){const e=Bo(),t=String(e?.tokenMint||"").trim(),a=t?rt().find(s=>String(s.tokenMint)===t):null,r=t?be([e,...or().filter(s=>String(s.tokenMint||"")===t)]).filter(Boolean).slice(0,5):ya(cr(),5,ba("smart-chart-suggest"),1);if(!t)return`
    ...
    <section class="smart-chart-terminal smart-chart-clean-terminal">
      ...
      <div class="smart-chart-grid smart-chart-clean-grid">
        <article class="terminal-panel smart-chart-main smart-chart-clean-main">
          ${(()=>{Rw(t);const s=Tp(t);return s?`<div class="coin-banner-hero" style="background-image:url('${s}')" role="img" aria-label="Coin banner"></div>`:""})()}
      ...
      ${a.length?`
        <div class="table-list compact-table">
          ${a.map(o=>`
            <article class="row-card">
              <div class="row-main">
                <strong>${i(Iw(o.side))} <span class="muted-text">by ${i(o.handle)}</span>
...
`)||"No logs returned.")}</pre>
  ...
  `}function Kw(e=[]){const t=[...e].sort((a,r)=>Number(r.bestPickScore||r.score||0)-Number(a.bestPickScore||a.score||0)||Ze(a,r));return ya(t,5,ba("cooks-best"),1)}function Te(e){const t=Number(e);return Number.isFinite(t)?t:0}function Ip(){const e=n.liveFeedCategory||"best";return Ws.find(([t])=>t===e)||Ws[0]}function $a(e={}){return Yo(e)||_p(e)||bl(e)||0}function ml(e={}){return Te(e.buys5m)+Te(e.buysH1)+Te(e.sells5m)+Te(e.sellsH1)}function Op(e={}){const t=Te(e.buys5m)+Te(e.buysH1),a=Te(e.sells5m)+Te(e.sellsH1),r=t+a;return r>0?t/r:.5}function gr(e={}){return Math.max(Te(e.m5),Te(e.h1),Te(e.h24))}function Go(e={}){return Math.max(Te(e.m5),Te(e.h1))}function Ht(e={}){return Go(e)*Math.log10(10+$a(e))*(.5+Op(e))}function fl(e={}){return e.boosted||e.isBoosted||e.boost||e.boosts?!0:`${e.source||""} ${e.category||""} ${e.liveLabel||""} ${e.sourceLabel||""}`.toLowerCase().includes("boost")}function Vw(e=[],t="best"){const a=[...e];switch(t){case"volume":return a.sort((r,o)=>$a(o)-$a(r));case"liquidity":return a.sort((r,o)=>dt(o)-dt(r));case"marketcap":return a.sort((r,o)=>ut(o)-ut(r));case"active":return a.sort((r,o)=>ml(o)-ml(r));case"fresh":return a.sort(Ze);case"gainers":return a.sort((r,o)=>gr(o)-gr(r));default:return a.sort((r,o)=>Te(o.bestPickScore||o.score)-Te(r.bestPickScore||r.score)||Ze(r,o))}}function zw(){const e=n.liveTerminalCategory||"dexTrending";return qa.find(([t])=>t===e)||qa[0]}function jw(e,t,a,r){return`
    ...
    </label>`}function Gw(){if(n.activeTab==="terminal"){const t=zw();return{categories:qa,activeId:t[0],sub:t[2],attr:"data-live-terminal-category",cap:"Discover",rank:a=>Wp(a,t[0]),hasBest:!1}}const e=Ip();return{categories:Ws,activeId:e[0],sub:e[2],attr:"data-live-feed-category",cap:"Feed",rank:t=>Vw(t,e[0]),hasBest:e[0]==="best"}}function Xw(e={}){if(fl(e))return{cls:"boost",text:"⚡ Boosted"};const t=gr(e);if(t>=40)return{cls:"gain",text:`▲ ${Math.round(t)}%`};const a=Number(e.pairAgeMinutes);return Number.isFinite(a)&&a>=0&&a<=10?{cls:"fresh",text:"✨ Fresh"}:Go(e)>=25?{cls:"hot",text:"🔥 Hot"}:Op(e)>=.7&&ml(e)>=24?{cls:"active",text:"● Active"}:null}function hl(e={}){const t=Xw(e);return t?`<span class="signal-badge signal-badge-${t.cls}">${i(t.text)}</span>`:""}function Ep(e={}){return e.isPump||e.pump||e.pumpFun||e.pumpUrl?!0:`${e.source||""} ${e.category||""} ${e.dexId||""} ${e.dexName||""}`.toLowerCase().includes("pump")}function Jw(e={}){const t=`${e.name||""} ${e.symbol||""} ${e.category||""}`.toLowerCase();return Ep(e)||/meme|dog|cat|pepe|wif|inu|elon|moon|bonk|frog|chad/.test(t)}function Fp(){const e=n.cookSpotCategory||"dexTrending";return qa.find(([t])=>t===e)||qa[0]}function Wp(e=[],t="dexTrending"){const a=[...e];switch(t){case"fresh":return a.sort(Ze);case"dexBoosted":{const r=a.filter(fl).sort((s,c)=>$a(c)-$a(s)),o=a.filter(s=>!fl(s)).sort((s,c)=>Ht(c)-Ht(s));return[...r,...o]}case"pumpTrending":{const r=a.filter(Ep);return(r.length?r:a).sort((o,s)=>Ht(s)-Ht(o))}case"memeMovers":{const r=a.filter(Jw);return(r.length?r:a).sort((o,s)=>gr(s)-gr(o))}case"earlyMomentum":{const r=a.filter(o=>{const s=Number(o.pairAgeMinutes);return!Number.isFinite(s)||s<=180});return(r.length?r:a).sort((o,s)=>Go(s)-Go(o))}case"graduating":{const r=a.filter(o=>_o(o)||Uo(o)==="graduating");return(r.length?r:a).sort((o,s)=>Ht(s)-Ht(o))}case"graduated":{const r=a.filter(o=>gn(o)||Uo(o)==="graduated");return(r.length?r:a).sort((o,s)=>$a(s)-$a(o))}default:return a.sort((r,o)=>Ht(o)-Ht(r))}}function Yw(e=Fp()){const[t]=e;return`
  ...
  `}function o0(e){return ct(e,{context:"live",shareBuilder:Ta})}function ct(e,t={}){const a=t.shareBuilder||Ta,r=be(e),o=`signal-list ${t.context==="kol"?"signal-list-kol":""}`.trim();return r.length?`
    ...
    <div class="${i(o)}">
      ...
      ${r.map((s,c)=>Zw(s,c,{...t,shareText:a(s),priority:c<12})).join("")}
    </div>
  `:`
      ${t.hideToolbar?"":Mi(t.context||"scanner")}
  ...
  `}function Xo(e){const t=String(e||"");return!!(n.watchlist?.rows||[]).some(a=>String(a.tokenMint)===t)}function Kt(e){const t=Do(e);if(Number.isFinite(t))return t<60?`${Math.max(1,Math.floor(t))}s`:t<3600?`${Math.floor(t/60)}m`:`${Math.floor(t/3600)}h`;const r=["source-age","trusted-source-age"].includes(String(e.pairAgeSource||"").toLowerCase())?Number(e.pairAgeMinutes):Number.NaN;return Number.isFinite(r)?`${Math.max(0,Math.round(r))}m`:""}function eS(e){const t=Number(e||0);if(!Number.isFinite(t)||t===0)return"trend n/a";const a=t>0?"+":"";return`<span class="${t>=0?"positive":"negative"}">${a}${t.toFixed(Math.abs(t)>=10?0:1)}%</span>`}function Jo(e={}){const t=e.metadata||e.tokenMetadata||{},a=e.dex||e.dexScreener||e.pair||e.dexPair||{},r=e.pump||e.pumpFun||e.pumpfun||{},o=e.baseToken||e.base||{},s=e.info||e.profile||{},c=[e.imageUrl,e.avatarUrl,e.avatar_url,e.imageUri,e.image,e.iconUrl,e.icon,e.logoURI,e.logo,e.logoUrl,e.tokenImageUrl,e.token_image_url,e.pfp,e.avatar,r.imageUrl,r.imageUri,r.image_uri,r.image,r.logoURI,a.imageUrl,a.image,a.logoURI,a.logo,a.iconUrl,a.info?.imageUrl,a.baseToken?.imageUrl,a.baseToken?.logoURI,o.imageUrl,o.image,o.logoURI,o.logo,s.imageUrl,s.image,t.imageUrl,t.imageUri,t.image_uri,t.image,t.logoURI,t.logo,t.iconUrl];for(const l of c){const u=ot(l);if(u)return u}return""}function ut(e={}){const t=e.metadata||e.tokenMetadata||{},a=e.dex||e.dexScreener||e.pair||e.dexPair||{},r=e.pump||e.pumpFun||e.pumpfun||{},o=e.baseToken||e.base||{};return E(e.marketCap,e.marketCapUsd,e.market_cap,e.usdMarketCap,e.usd_market_cap,e.mcap,e.mc,e.fdv,e.fdvUsd,a.marketCap,a.marketCapUsd,a.market_cap,a.fdv,a.fdvUsd,a.baseToken?.marketCap,a.baseToken?.fdv,r.marketCap,r.marketCapUsd,r.usdMarketCap,r.usd_market_cap,r.market_cap,r.fdv,o.marketCap,o.fdv,t.marketCap,t.marketCapUsd,t.usdMarketCap,t.fdv)}function dt(e={}){const t=e.metadata||e.tokenMetadata||{},a=e.dex||e.dexScreener||e.pair||e.dexPair||{},r=e.pump||e.pumpFun||e.pumpfun||{},o=e.liquidity||{};return E(e.liquidityUsd,e.liquidity_usd,e.currentLiquidityUsd,o.usd,o.quote,a.liquidityUsd,a.liquidity_usd,a.liquidity?.usd,a.liquidity?.quote,r.liquidityUsd,r.liquidity_usd,r.liquidity?.usd,t.liquidityUsd,t.liquidity_usd,t.liquidity?.usd)}function bl(e={}){const t=e.metadata||e.tokenMetadata||{},a=e.dex||e.dexScreener||e.pair||e.dexPair||{},r=e.pump||e.pumpFun||e.pumpfun||{},o=e.volume||{};return E(e.volumeM15,e.volume15m,e.volume5m,e.volumeM5,e.volumeUsd,o.m15,o.m15m,o.m5,o.h1,a.volume?.m15,a.volume?.m5,a.volume?.h1,r.volumeM15,r.volume15m,r.volume5m,t.volume?.m15,t.volume?.m5,t.volumeM15,t.volume5m)}function Yo(e={}){const t=e.metadata||e.tokenMetadata||{},a=e.dex||e.dexScreener||e.pair||e.dexPair||{},r=e.pump||e.pumpFun||e.pumpfun||{},o=e.volume||{};return E(e.volumeH1,e.volume1h,e.volume_h1,e.volumeUsd,o.h1,o.m30,o.m15,a.volume?.h1,a.volume?.m30,a.volume?.m15,r.volumeH1,r.volume1h,t.volume?.h1,t.volumeH1)}function _p(e={}){const t=e.metadata||e.tokenMetadata||{},a=e.dex||e.dexScreener||e.pair||e.dexPair||{},r=e.pump||e.pumpFun||e.pumpfun||{},o=e.volume||{};return E(e.volumeH24,e.volume24h,e.volume_h24,o.h24,o.d1,a.volume?.h24,a.volume?.d1,r.volumeH24,r.volume24h,t.volume?.h24,t.volume?.d1,t.volumeH24)}function pt(e,t={}){const a=String(e.symbol||e.name||e.shortMint||"?").trim().slice(0,2).toUpperCase()||"?",r=Jo(e),o=String(e.tokenMint||e.mint||e.tokenAddress||e.address||"").trim(),s=`token:${String(o||e.symbol||a).trim().toLowerCase()}`,c=_("tokenAvatarFixEnabled",!0),l=String(e.avatarState||"").trim().toLowerCase(),u=l==="missing"||l==="failed",d=!!e.avatarUrl&&(!l||l==="ready"),p=o&&!u?ot(Tg(e)):"",f=c?ki(s,d?e.avatarUrl:"",p,u?"":r):ki(s,p,r),y=c&&!u?p&&f!==p?p:r&&r!==f?r:"":"",g=!!t.priority,S=g?"eager":"lazy",A=g?"high":"low",T=l||(f?"ready":"missing");if(f){const b=y?` data-backup-src="${i(y)}"`:"";return`<div class="live-pair-avatar" data-avatar-state="${i(T)}"><img src="${i(f)}"${b} data-avatar-src="${i(f)}" data-avatar-key="${i(s)}" alt="${i(e.symbol||e.name||"Token")}" loading="${S}" decoding="sync" fetchpriority="${A}" width="42" height="42" referrerpolicy="no-referrer" onload="window.__slimeRememberAvatar&&window.__slimeRememberAvatar(this.dataset.avatarKey,this.currentSrc||this.src);" onerror="window.__slimeAvatarLoadFailed&&window.__slimeAvatarLoadFailed(this);"><span>${i(a)}</span></div>`}return`<div class="live-pair-avatar fallback" data-avatar-state="${i(T)}"><span>${i(a)}</span></div>`}function tS(e=""){const t=String(e||"");let a=0;for(let r=0;r<t.length;r+=1)a+=t.charCodeAt(r);return a%5+1}function yl(e=""){return`./assets/slimewire/png/token-mascots/token-mascot-${tS(e)}.png`}function Ta(e){return`Live pair ${e.symbol||w(e.tokenMint)} spotted on SlimeWire: MC ${e.marketCapLabel||"n/a"}, liq ${e.liquidityLabel||"n/a"}, age ${e.pairAgeLabel||Kt(e)||"age unknown"}.`}function aS(){const e=[["safe","Safe Picks"],["smart","Smart Accumulation"],["fast","Fast Movers"],["pumpsnipe","PumpSnipe"],["moonshot","Low MC"],["meme","Narratives"],["long","Long Term"]],t=e.find(([a])=>a===n.scanMode)?.[1]||"Picks";return`
    <section class="terminal-layout sniper-terminal">
      <main class="terminal-main">
        ...
        ${n.scan?sS():O("No scan loaded","Pick a mode or tap Refresh Picks.")}
      </main>
      <aside class="trade-side order-ticket-stack">
        ${rS()}
      </aside>
  ...
  `}function oS(){const e=n.sniperResult;return e?.results?.length?`<div class="mini-results">${e.results.map(t=>`<span data-ok="${t.ok?"true":"false"}">${i(t.message||t)}</span>`).join("")}</div>`:""}function sS(){const e=n.scan.rows||[],t=nt("sniper",e);return e.length?`
  ...
  `:O("No usable picks","Refresh again or choose a different mode.")}function Qo(){return n.user?.connectedWallet?.publicKey||""}function Up(){return n.ogreTek.markets.find(e=>e.symbol===n.ogreTek.selectedMarket)||n.ogreTek.markets[0]||null}function iS(){return{marketSymbol:n.ogreTek.selectedMarket,direction:n.ogreTek.direction,orderType:n.ogreTek.orderType,collateralUsd:n.ogreTek.collateralUsd,leverage:n.ogreTek.leverage,slippagePct:n.ogreTek.slippagePct,priorityFeeLamports:n.ogreTek.priorityFeeLamports,limitPrice:n.ogreTek.limitPrice,stopPrice:n.ogreTek.stopPrice}}function qp(){return Tm(iS(),Up(),n.ogreTek.account,ke)}function ve(e,t=2){const a=Number(e);return Number.isFinite(a)?Math.abs(a)>=1e9?`$${(a/1e9).toFixed(2)}B`:Math.abs(a)>=1e6?`$${(a/1e6).toFixed(2)}M`:Math.abs(a)>=1e3?`$${(a/1e3).toFixed(1)}K`:`$${a.toFixed(t)}`:"n/a"}function mt(e){const t=Number(e);return Number.isFinite(t)?t>=1e3?`$${t.toLocaleString(void 0,{maximumFractionDigits:2})}`:`$${t.toFixed(t>=10?2:4)}`:"n/a"}function Zo(e,t=3){const a=Number(e);return Number.isFinite(a)?`${a>=0?"+":""}${a.toFixed(t)}%`:"n/a"}function Hp(e){const t=Date.parse(e||"");if(!t)return"not loaded";const a=Math.max(0,Math.round((Date.now()-t)/1e3));return a<60?`${a}s ago`:`${Math.round(a/60)}m ago`}function es(){document.querySelectorAll("[data-ogre-tek-field]").forEach(e=>{const t=e.dataset.ogreTekField;!t||!(t in n.ogreTek)||(e.type==="checkbox"?n.ogreTek[t]=!!e.checked:n.ogreTek[t]=e.value)})}async function lS(){!ke.enabled||n.ogreTek.loading||n.ogreTek.markets.length||n.ogreTek.error||await br({silent:!0}).catch(e=>{n.ogreTek.error=D(e.message),h({force:!0})})}async function br({force:e=!1,silent:t=!1}={}){if(ke.enabled&&!(n.ogreTek.loading&&!e)){n.ogreTek.loading=!0,n.ogreTek.error="",t||h({force:!0});try{const a=Qo(),[r,o,s,c]=await Promise.all([wr.getMarkets(),wr.getAccount(a),wr.getPositions(a),wr.getOpenOrders(a)]);n.ogreTek.markets=r||[],n.ogreTek.account=o||null,n.ogreTek.positions=s||[],n.ogreTek.orders=c||[],n.ogreTek.markets.some(l=>l.symbol===n.ogreTek.selectedMarket)||(n.ogreTek.selectedMarket=n.ogreTek.markets[0]?.symbol||"SOL-PERP"),n.ogreTek.status=`Updated ${new Date().toLocaleTimeString()}`}catch(a){n.ogreTek.error=D(a.message)}finally{n.ogreTek.loading=!1,h({force:!0})}}}function cS(){return`
  ...
  `}function uS(){if(Sm(ke)!=="enabled")return cS();const e=!!Qo(),t=Up(),a=qp(),r=a.quote,o=n.ogreTek.account,s=a.ok&&!n.ogreTek.loading,c=n.ogreTek.error?"Provider Error":n.ogreTek.loading?"Loading":"Ready",l=ke.demoMode?"Review Demo Trade":"Review Trade",u=ke.demoMode?"Confirm Demo Review":"Confirm Order",d=ke.demoMode?!n.ogreTek.riskAccepted||!a.ok:!vm({validation:a,riskAccepted:n.ogreTek.riskAccepted,demoMode:ke.demoMode});return`
    <section class="ogre-tek-page">
  ...
  `}function mS(){return Qo()?n.ogreTek.positions.length?`
  ...
  `:O("No open positions","Mock positions will appear here when the provider reports them."):O("Wallet disconnected","Connect Phantom, Solflare, Backpack, or another detected Solana wallet to view perps account data.")}function fS(){return Qo()?n.ogreTek.orders.length?`
  ...
  `:"<p>Connect a wallet to load collateral, health, positions, and margin risk.</p>"}function gS({validation:e,quote:t,market:a,confirmButtonText:r,confirmDisabled:o}){const s=e.order||{};return`
  ...
  `}function Vp(){return{role:"assistant",text:"Ogre Agent ready. Ask naturally: check this CA, show links, does it look risky, buy 0.1 SOL from wallet 1, sell half, refresh positions, find best picks, or ask where anything is on web or mobile.",actions:[{label:"Show Positions",type:"open_tab",tab:"positions"},{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Fast Mode",type:"toggle_agent_fast_mode"},{label:"Auto-Trade On",type:"approve_agent_auto_trade"},{label:"Best Picks",type:"open_tab",tab:"ogreAi"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}const vl="slimewire:ogreAgentMessages:v1",wl="slimewire:ogreAgentLastToken:v1";function bS(){try{const e=JSON.parse(localStorage.getItem(vl)||"[]");return Array.isArray(e)?e.filter(t=>t&&typeof t=="object"&&String(t.text||"").trim()).slice(-50).map(t=>({role:t.role==="user"?"user":"assistant",text:String(t.text||"").slice(0,1200),actions:Array.isArray(t.actions)?t.actions.slice(0,4):[],retryText:String(t.retryText||"").slice(0,1200)})):[]}catch{return[]}}function yS(){try{localStorage.setItem(vl,JSON.stringify(yn().slice(-50)))}catch{}}function Vt(){if(n.ogreAgentLastTokenMint)return String(n.ogreAgentLastTokenMint);try{n.ogreAgentLastTokenMint=String(localStorage.getItem(wl)||"").trim()}catch{n.ogreAgentLastTokenMint=""}return n.ogreAgentLastTokenMint||""}function ts(e=""){const t=String(e||"").trim();if(!t)return"";n.ogreAgentLastTokenMint=t;try{localStorage.setItem(wl,t)}catch{}return t}function yn(){if(!Array.isArray(n.ogreAgentMessages)||!n.ogreAgentMessages.length){const e=bS();n.ogreAgentMessages=e.length?e:[Vp()]}return n.ogreAgentMessages}function vS(){const e=String(n.smartChartToken||n.tradeToken||Vt()||"").trim(),t=e?wa(e):null,a=t?.tokenMint?Qe(t):null,r=e?vp(e):null,o=e?il(e):null,s=uo().slice(0,3),c=e?rt().find(l=>String(l.tokenMint||"")===e):null;return{route:n.route,activeTab:n.activeTab,agentFastMode:n.ogreAgentFastMode,agentAutoTradeApproved:os(),lastTokenMint:Vt(),recentAgentMessages:yn().slice(-8).map(l=>({role:l.role==="user"?"user":"assistant",text:String(l.text||"").slice(0,600)})),smartChartToken:n.smartChartToken||"",tradeToken:n.tradeToken||"",livePairBucket:n.livePairBucket||"",slimeScopeMode:n.slimeScopeMode||"",walletConnected:!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey),walletCount:oi(),positionCount:rt().length,totalSol:Et().toFixed(4),selectedTradePreset:pn("trade"),selectedBundlePreset:pn("bundle"),quickBuyAmount:String(Tl()||""),currentToken:e?{tokenMint:e,symbol:t?.symbol||"",name:t?.name||"",watched:Xo(e)}:null,slimeShield:a?{verdict:a.verdict,summary:a.summary,confidence:a.confidence,suggestedAction:a.suggestedAction,topFactors:(a.factors||[]).slice(0,4).map(l=>l.message||l.label||l.key)}:null,devInfoSummary:r?{status:r.status,confidence:r.confidence,summary:r.summary,likelyDevWalletShort:r.likelyDevWallet?w(r.likelyDevWallet):"",currentPositionStatus:r.currentPosition?.positionStatus||"unknown",launchesTracked:r.historicalStats?.launchesTracked||0}:null,kolDumpDetector:s.length?s.map(l=>({displayName:l.displayName,riskLabel:l.riskLabel,dumpRiskPercent:l.lowData?null:l.dumpRiskPercent,lowData:!!l.lowData,summary:er(l)})):[],replayBeforeBuy:o?{sampleSize:o.sampleSize,confidence:o.confidence,winRatePercent:o.winRatePercent,medianMaxDrawdownPercent:o.medianMaxDrawdownPercent,summary:o.summary}:null,pnlSummary:{realized:si(),positions:rt().length,totalSol:Et().toFixed(4)},profile:{hasReferralCode:!!n.user?.referralCode,referralCode:n.user?.referralCode||"",hasReferralPayoutWallet:!!n.user?.referralPayoutWallet,hasXHandle:!!(n.xHandle||n.user?.xHandle),traderBoardEnabled:n.user?.traderBoardVisible!==!1},selectedPosition:c?{tokenMint:c.tokenMint,uiAmount:c.uiAmount,estimatedValueSol:c.estimatedValueSol,openPnlSol:c.openPnlSol||c.realizedSol||""}:null,walletPublicKey:String(n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"").slice(0,80),recentPairs:zp()}}function zp(){const e=[],t=new Set,a=(r,o="feed")=>{if(!r)return;if(Array.isArray(r)){r.forEach(l=>a(l,o));return}if(Array.isArray(r.rows)){r.rows.forEach(l=>a(l,o));return}if(r.data&&Array.isArray(r.data.rows)){r.data.rows.forEach(l=>a(l,o));return}if(typeof r!="object")return;const s=String(r.tokenMint||r.mint||r.baseMint||r.tokenAddress||r.pairAddress||"").trim();if(!s)return;const c=s.toLowerCase();t.has(c)||(t.add(c),e.push({tokenMint:s,pairAddress:String(r.pairAddress||r.pair||"").trim(),symbol:String(r.symbol||r.baseSymbol||r.ticker||"").trim().slice(0,24),name:String(r.name||r.baseName||r.label||"").trim().slice(0,48),ageMinutes:Number(r.ageMinutes??r.pairAgeMinutes??r.ageMins??NaN),marketCap:Number(r.marketCap??r.marketCapUsd??r.fdv??NaN),liquidityUsd:Number(r.liquidityUsd??r.liquidity?.usd??NaN),volume5m:Number(r.volume5m??r.volume?.m5??NaN),volume1h:Number(r.volume1h??r.volumeH1??r.volume?.h1??NaN),buys5m:Number(r.buys5m??r.txns?.m5?.buys??NaN),sells5m:Number(r.sells5m??r.txns?.m5?.sells??NaN),score:Number(r.score??r.ogreScore??r.sniperScore??NaN),riskFlags:Array.isArray(r.riskFlags)?r.riskFlags.slice(0,6).map(String):[],riskLevel:String(r.riskLevel||r.risk||r.safetyNote||"").slice(0,40),twitterUrl:String(r.twitterUrl||r.xUrl||r.links?.twitter||r.links?.x||"").trim(),telegramUrl:String(r.telegramUrl||r.links?.telegram||"").trim(),websiteUrl:String(r.websiteUrl||r.website||r.links?.website||"").trim(),source:o}))};return a(n.livePairRows,"live-pairs"),a(n.slimeScopeRows,"slime-scope"),a(n.livePairs,"live-pairs"),Object.values(n.livePairsByBucket||{}).forEach(r=>a(r,"bucket")),Object.values(n.terminalFeeds||{}).forEach(r=>a(r,"terminal-feed")),e.sort((r,o)=>jp(o)-jp(r)).slice(0,24)}function jp(e={}){const t=T=>Number.isFinite(Number(T))?Number(T):0,a=t(e.ageMinutes),r=t(e.marketCap),o=t(e.liquidityUsd),s=t(e.volume5m),c=t(e.volume1h),l=Math.max(s,c*.18),u=a>0?Math.max(0,90-Math.min(a,360))/2.5:12,d=a>120?Math.min(42,(a-120)/4):0,p=r>0&&r<=125e3?22:r>0&&r<=25e4?11:r>65e4?-18:0,f=r>0?l/r:0,y=f>=.08?24:f>=.04?16:f>=.018?8:l>0?2:-18,g=Math.max(0,t(e.buys5m)-t(e.sells5m))*2.6,S=e.twitterUrl||e.telegramUrl||e.websiteUrl?10:0,A=Array.isArray(e.riskFlags)&&e.riskFlags.length?Math.min(16,e.riskFlags.length*3):0;return t(e.score)+u+p+y+Math.log10(1+s+c)*7+Math.log10(1+o)*3+g+S-A-d}function wS(e={}){return String(e.label||e.type||"Run").slice(0,40)}function SS(e={},t=0){const a=Array.isArray(e.actions)?e.actions.slice(0,4):[],r=e.role!=="user";return`
    <div class="ogre-agent-message ${e.role==="user"?"user":"assistant"}">
      ...
      ${a.length?`<div class="ogre-agent-actions">${a.map((o,s)=>`<button type="button" data-ogre-agent-action="${t}:${s}">${i(wS(o))}</button>`).join("")}</div>`:""}
    </div>
  ...
  `}function $S(){const e=!!n.ogreAgentOpen,t=yn(),a=n.ogreAgentVoiceEnabled?"Voice On":"Voice Off",r=Yp(),o=n.ogreAgentListening?"Stop":"Mic";return`
...
`),actions:[o?.tokenMint?{label:"Open Top Chart",type:"open_chart",tokenMint:o.tokenMint}:null,{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}].filter(Boolean)}}const KS=[["terminal",["terminal","command center","cooks","main feed","live feed","home"]],["live",["live pairs","fresh pairs","new pairs","pairs"]],["slimeScope",["slime scope","scope","scanner","cook spot"]],["smartChart",["smart chart","chart page","charting"]],["trade",["trade desk","trade page","swap page","slime swap","manual trade"]],["bundle",["bundle","bundle buy","multi wallet buy"]],["volume",["volume","slimebot","slime bot","volume bot"]],["sniper",["sniper","ogre sniper","snipe picks","picks"]],["launchCoin",["pump launch","launch a coin","launch coin","create coin","create a token","make a coin","launcher"]],["launch",["launch watch","launch watches","watch launches","snipe launches"]],["kol",["kol","kols","kol tracker","copy trading","copy wallet"]],["ogreAi",["ogre ai","ogre a.i","autopilot","auto pilot","ai buyer"]],["wallets",["wallets","wallet page","balances","my wallets","fund","sweep"]],["positions",["positions","open positions","bags","holdings","my coins"]],["pnl",["pnl","profit","results","p&l","pnl card","share card"]],["txAudit",["tx audit","stop loss audit","audit","armed plans","my plans","tp sl status"]],["profile",["profile","account","referral","referrals","badges","pfp","alerts","push alerts","notifications"]],["tek",["ogre tek","tek hub","tools","tool hub","automation deck","shield receipts","receipts"]],["ogreTek",["perps","perp","perp mode","leverage"]],["watchlist",["watchlist","watch list","saved coins","saved tokens"]],["liveTrades",["live trades","recent trades","trade history"]]],VS=/\b(open|go to|goto|show me|show|take me|bring up|pull up|switch to|navigate|where is|where's|wheres|where are|where do i|how do i (?:get to|open|find)|find)\b/i;function zS(e){const t=String(e||"").toLowerCase().replace(/[?!.]+$/g,"").trim();if(!t||t.length>120||Al(e)||Tt(e))return null;const a=/(?:set\s+)?quick\s*buy(?:\s+amount)?\s*(?:to|at|=)?\s*([0-9]*\.?[0-9]+)\s*(?:sol)?$/i.exec(t);if(a){const o=dr(a[1]);if(o)return n.quickBuyAmountOverride=o,Xr({quickBuy:o}),qo(),{text:`Quick buy set to ${o} SOL - every Buy button across the site now fires with that amount.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}if(/\b(i (?:like|prefer|want|am)|keep (?:it|them)|show me|give me)\b/.test(t)){if(/\b(risky|degen|moonshots?|early|low\s*mc|gambl)/.test(t))return Xr({risk:"degen"}),{text:"Noted - early risky plays it is. The fresh low-MC line in the brief is yours, and I'll keep that preference next visit too.",actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Sniper",type:"open_tab",tab:"sniper"}]};if(/\b(safe|careful|low risk|clean|less risky)\b/.test(t))return Xr({risk:"careful"}),{text:"Noted - shield-clean setups first. I'll remember that next visit. SlimeShield verdicts are on every pair and /t page.",actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}if(/\brefresh\b.*\b(feed|pairs|scan)/.test(t)||t==="refresh feeds")return{text:"Refreshing the live feeds now.",run:{type:"refresh_feeds"},actions:[]};if(/\brefresh\b/.test(t)||/\bsync\b.*\b(wallet|balance|position)/.test(t))return{text:"Refreshing wallets, balances, and positions now.",run:{type:"refresh_wallet"},actions:[]};if(/\b(connect|link|hook up)\b.*\bwallet\b/.test(t))return{text:"Opening the wallet connect chooser.",run:{type:"open_wallet_connect"},actions:[]};if(/what can you do|what do you do|help me|how do you work|what are you/.test(t))return{text:`I can take you anywhere on the site (just say "open positions" or "where is the sniper"), check any coin (paste a CA), run buys and sells ("buy 0.1 of <CA>"), set your quick-buy amount, refresh wallets and feeds, and read risk with SlimeShield. Ask in your own words - I'll keep up.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Positions",type:"open_tab",tab:"positions"},{label:"Ogre Tek",type:"open_tab",tab:"tek"}]};const r=VS.test(t);for(const[o,s]of KS)for(const c of s){if(!(t===c||t===`the ${c}`||t===`my ${c}`)&&!(r&&t.includes(c)))continue;return{text:`Opening ${jS(o)} now.${o==="profile"&&/alert|push|notification/.test(t)?" Push alerts live under Profile > Alerts.":""}`,run:{type:"open_tab",tab:o},actions:[{label:"Back to Terminal",type:"open_tab",tab:"terminal"}]}}return null}function jS(e){return{terminal:"the Live Terminal",live:"Live Pairs",slimeScope:"Slime Scope",smartChart:"Smart Chart",trade:"the Trade Desk",bundle:"Bundle",volume:"SlimeBot Volume",sniper:"OgreSniper",launchCoin:"Pump Launch",launch:"Launch Watch",kol:"the KOL Tracker",ogreAi:"Ogre A.I.",wallets:"Wallets",positions:"Positions",pnl:"PnL",txAudit:"the TP/SL Audit",profile:"your Profile",tek:"the Ogre Tek hub",ogreTek:"Perp Mode",watchlist:"your Watchlist",liveTrades:"Live Trades"}[e]||e}const GS={submitted:"Order submitted",approved:"Wallet approved",sent:"Transaction sent",confirmed:"Confirmed on-chain",armed:"TP/SL armed"};function lm(e){n.tradeTrace={title:String(e||"Trade"),steps:[],startedAt:Date.now(),done:!1},is()}function Be(e,t="ok",a=""){if(!n.tradeTrace||n.tradeTrace.done&&t==="pending")return;const r=n.tradeTrace.steps,o=r.find(l=>l.key===e),s=o||{key:e,label:GS[e]||e};if(s.status=t,s.detail=String(a||"").slice(0,140),o||r.push(s),t==="fail"&&(n.tradeTrace.done=!0),is(),t==="fail")return;r.length>=3&&r.every(l=>l.status==="ok")&&(n.tradeTrace.done=!0,window.setTimeout(()=>{n.tradeTrace?.done&&!n.tradeTrace.steps.some(l=>l.status==="fail")&&(n.tradeTrace=null,is())},8e3))}function is(){let e=document.querySelector("[data-trade-trace-mount]");e||(e=document.createElement("div"),e.dataset.tradeTraceMount="true",document.body.appendChild(e));const t=n.tradeTrace;if(!t){e.innerHTML="",e.__lastDrawerHtml="";return}const a=r=>r==="ok"?"✅":r==="fail"?"❌":"⏳";e.innerHTML=`
  ...
  `,document.head.appendChild(e)}function ds(){if(R.root)return R.root;$k();const e=document.createElement("div");return e.setAttribute("data-trailer-overlay",""),e.style.cssText="position:fixed;inset:0;z-index:99999;pointer-events:none;font-family:Inter,system-ui,sans-serif;",e.innerHTML=`
  ...
  `,o.querySelector("[data-trailer-close]").addEventListener("click",()=>{o.remove(),setTimeout(()=>URL.revokeObjectURL(r),5e3)}),o.querySelector("[data-trailer-share]").addEventListener("click",async()=>{try{const s=new File([e],a,{type:R.mime.split(";")[0]});if(navigator.canShare?.({files:[s]})){await navigator.share({files:[s],title:"SlimeWire",text:"SlimeWire - verify before you ape. slimewire.org"});return}}catch{}o.querySelector("a[download]")?.click()}),document.body.appendChild(o)}function Ck(){const e=R.recorder;if(!e)return;const t=()=>{try{const a=new Blob(R.chunks,{type:R.mime.split(";")[0]});a.size>0&&Pk(a)}catch{}};if(e.state!=="inactive"){e.addEventListener("stop",t,{once:!0});try{e.stop()}catch{t()}}else t();R.stream?.getTracks().forEach(a=>{try{a.stop()}catch{}}),R.recorder=null,R.stream=null}function Ml(e="done"){if(R.running){R.running=!1,R.timers.forEach(t=>clearTimeout(t)),R.timers=[],Ck();try{R.audio?.ctx?.close()}catch{}R.audio=null,R.root?.remove(),R.root=null}}function Lk(){const e=n.livePairsByBucket?.live?.rows||n.livePairs?.rows||n.livePairRows||[];return[...e].filter(a=>a?.tokenMint).sort((a,r)=>(Number(r.volume5m)||0)-(Number(a.volume5m)||0)||(Number(r.bestPickScore||r.score)||0)-(Number(a.bestPickScore||a.score)||0))[0]||e[0]||null}async function xk(e=9e3){const t=Date.now();for(;Date.now()-t<e;){const a=Lk();if(a)return a;if(!R.running)return null;await La(500)}try{return((await k("/api/web/live-pairs?bucket=live&sort=fresh"))?.livePairs?.rows||[]).find(o=>o?.tokenMint)||null}catch{return null}}async function Mk(e,t=4e3){const a=Date.now();for(;Date.now()-a<t;){if(document.querySelector(e))return!0;if(!R.running)return!1;await La(250)}return!1}function Bk(){return new Promise(e=>{vr(`
    ...
    `),R.root.querySelector("[data-trailer-go]")?.addEventListener("click",()=>e(!0),{once:!0})})}async function Rk(){if(R.running)return;R.running=!0,ds(),vk();const e=await Ak(),t=yk();if(!e&&(await Bk(),!R.running))return;$e("/terminal/live-pairs"),vr('<div style="color:#72ff23;font-weight:900;font-size:clamp(18px,5vw,24px);animation:twPulse 1.2s infinite;">locking onto live pairs...</div>');const a=await xk(9e3);if(!R.running)return;const r=3,o=6.5,s=9,c=6.5,l=4.6,u=[r,r+o,r+o+s,r+o+s+c],d=r+o+s+c+l;kk(u,d);const f=(R.audio?.ctx?.currentTime||0)+.05;for(let g=0;g<r;g+=1)Sk(f+g,600+g*90);for(let g=r;g>=1;g-=1){if(!R.running)return;vr(`<div style="color:#72ff23;font-size:clamp(64px,22vw,110px);font-weight:900;text-shadow:0 0 30px rgba(114,255,35,0.75);animation:twPulse 1s infinite;">${g}</div>`),await La(1e3)}if(vr(""),!R.running)return;ps(),ms("FRESH PAIRS. SECONDS OLD.","every pump.fun launch lands here instantly"),await La(o*1e3);const y=a?.symbol?`$${String(a.symbol).slice(0,12)}`:"live pair";if(R.running&&a?.tokenMint){ps(),$e(`/terminal/chart?token=${encodeURIComponent(a.tokenMint)}`);const g=await Mk("iframe[src*='dexscreener'], .smart-chart-terminal iframe, [data-chart] canvas",4500);if(!R.running||(ms("CHARTS WITH A BRAIN",`${y} - live candles, live flow, shield verdict on top`),await La((g?s:4)*1e3),!R.running))return;ps(),yp(a.tokenMint),ms("TRIPLE-ENGINE RUG CHECK","SlimeShield x Rugcheck x GoPlus - dodge the rug BEFORE you ape"),await La(c*1e3),ol()}R.running&&(ms(""),ps(),vr(`
