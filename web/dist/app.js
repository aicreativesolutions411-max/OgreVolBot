...
`)}function he(e){e&&(n.user=e,Object.prototype.hasOwnProperty.call(e,"xHandle")?(n.xHandle=et(e.xHandle),n.xHandle?tc(n.xHandle):Wo()):n.xHandle||(n.xHandle=ec()))}function Xr(e){for(const t of e){const a=Dn(t);if(a&&!a.closest("[hidden]"))return String(a.value||"")}for(const t of e){const a=m(t);if(a)return String(a.value||"")}return""}function Nn(){const e=m("[data-connect-status]");return e&&!e.closest("[hidden]")?e:Dn("[data-login-status]")||e}function Dn(e){const t=[...document.querySelectorAll(e)];return t.find(a=>!a.closest("[hidden]")&&a.offsetParent!==null)||t.find(a=>!a.closest("[hidden]"))||t[0]||null}function Un(){return Dn("[data-wallet-connect-modal] [data-wallet-connect-status]")||Dn("[data-wallet-connect-status]")}function oe(e=""){n.walletConnectStatus=String(e||""),S(Un(),n.walletConnectStatus)}function $c(e="solana"){const t=_e(e);return Ge()?Hn(e)?`${t} is not injected in this browser. Tap Open ${t} to use the mobile wallet connect flow, or choose another wallet option.`:Mc(e)?`${t} is not injected in this browser. Use Open ${t} to continue in the wallet app, or choose another wallet option.`:`${t} is not available in this browser. Install or open the wallet app, or choose another wallet option.`:`${t} extension not found. Install or unlock ${t}, or choose another wallet.`}function Wt(e="solana",t=null,a={}){const r=ge(e),s={walletName:_e(e,r),userId:n.user?.id||"",route:n.route,adapterReadyState:r?"detected":"not_detected",errorName:t?.name||"",errorMessage:String(t?.message||t||"").slice(0,240),...a};try{console.warn("[slimewire_wallet_connect]",s)}catch{}}function Tc(e=n.route==="connect"){window.setTimeout(()=>{const t=n.loginModalOpen?`[data-login-modal-${n.loginModalTab==="create"?"create":"login"}-section] [data-login-username], [data-login-modal-${n.loginModalTab==="create"?"create":"login"}-section] [data-login-password]`:e?"[data-connect-login-username], [data-connect-login-password]":"[data-login-username], [data-login-password]";Dn(t)?.focus?.()},0)}function Df(){const e=document.activeElement;e instanceof HTMLElement&&!e.closest("[data-login-modal]")&&(_o=e)}function Uf(){const e=_o;_o=null,window.setTimeout(()=>{e?.isConnected&&typeof e.focus=="function"&&e.focus({preventScroll:!0})},0)}function Ac({restoreFocus:e=!0}={}){const t=!!n.loginModalOpen;n.loginCollapsed=!0,n.loginModalOpen=!1,h({force:!0}),t&&e&&Uf()}function qf(){return!Ce||Ce.hidden||!n.loginModalOpen?[]:[...Ce.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')].filter(e=>!e.closest("[hidden]")&&e.offsetParent!==null)}function Hf(e){if(!n.loginModalOpen||e.key!=="Tab"||!Ce||Ce.hidden)return!1;const t=qf();if(!t.length)return!1;const a=t[0],r=t[t.length-1];return e.shiftKey&&document.activeElement===a?(e.preventDefault(),r.focus({preventScroll:!0}),!0):!e.shiftKey&&document.activeElement===r?(e.preventDefault(),a.focus({preventScroll:!0}),!0):!1}function Ja(){try{return`${window.location.pathname||"/terminal"}${window.location.search||""}${window.location.hash||""}`}catch{return"/terminal"}}function Kf(e=Ja()){return`/login?returnTo=${encodeURIComponent(e||"/terminal")}`}function Pc(e="",t=80){return String(e||"").replace(/[\r\n\t]+/g," ").replace(/[^\w .:/?&=#@-]/g,"").trim().slice(0,t)}function Vf(e="unknown"){const t=Date.now();if(t-Number(n.lastLockInClickAt||0)<300)return;n.lastLockInClickAt=t;const a={route:Pc(n.route||ja(),40),viewport:Math.round(window.innerWidth||0),source:Pc(e,60),at:new Date(t).toISOString()};try{const r=JSON.parse(window.localStorage?.getItem("slimewireLockInClicks")||"[]");r.push(a),window.localStorage?.setItem("slimewireLockInClicks",JSON.stringify(r.slice(-10)))}catch{}try{console.info("LOCK_IN_CLICKED",a)}catch{}try{k("/api/web/lock-in-clicked",{method:"POST",timeoutMs:3e3,body:JSON.stringify(a)}).catch(()=>{})}catch{}}function Cc({defaultTab:e="login",returnTo:t=Ja(),source:a="unknown",connectPanel:r=n.route==="connect"}={}){if(Df(),Vf(a),n.loginModalOpen=!0,n.loginModalTab=e==="create"?"create":"login",n.loginReturnTo=t||Ja(),n.loginCollapsed=!1,n.walletConnectMenuOpen=!1,!Ce&&!Jo){window.location.assign(Kf(n.loginReturnTo));return}h({force:!0}),Tc(r)}function Lc(e={}){Cc(e)}function Ge(){return/Android|iPhone|iPad|iPod/i.test(navigator.userAgent||"")}function xc(){try{const e=new URL(window.location.href);return e.hash="",e.toString()}catch{return window.location.href}}function zf(){try{return new URL(window.location.href).origin}catch{return"https://slimewire.org"}}function Mc(e=""){if(!Ge())return"";const t=encodeURIComponent(xc()),a=encodeURIComponent(zf());return e==="phantom"?`https://phantom.app/ul/browse/${t}?ref=${a}`:e==="solflare"?`https://solflare.com/ul/v1/browse/${t}?ref=${a}`:""}function li(e=""){return e==="phantom"?"https://phantom.app/download":e==="solflare"?"https://solflare.com/download":e==="backpack"?"https://backpack.app/download":""}function Ya(e=""){return e==="phantom"?"./assets/slimewire/clean-ui/wallet_icons/default/phantom.png":e==="solflare"?"./assets/slimewire/clean-ui/wallet_icons/default/solflare.png":"./assets/slimewire/svg/icons/wallet.svg"}function ci(e){const t=e instanceof Uint8Array?e:new Uint8Array(e||[]);if(!t.length)return"";let a=0n;for(const s of t)a=(a<<8n)+BigInt(s);let r="";for(;a>0n;){const s=Number(a%58n);r=Zl[s]+r,a/=58n}for(const s of t){if(s!==0)break;r="1"+r}return r||"1"}function Jr(e=""){const t=String(e||"").trim();if(!t)return new Uint8Array;let a=0n;for(const s of t){const o=sf.get(s);if(o===void 0)throw new Error("Invalid wallet callback encoding.");a=a*58n+BigInt(o)}const r=[];for(;a>0n;)r.unshift(Number(a&255n)),a>>=8n;for(const s of t){if(s!=="1")break;r.unshift(0)}return new Uint8Array(r)}function jf(e="phantom",t="",a=n.walletConnectReturnPath||"/terminal",r=""){const s=new URL(a||window.location.pathname||"/terminal",window.location.origin);return s.searchParams.delete("sw_wallet"),s.searchParams.delete("sw_wallet_state"),s.searchParams.delete("sw_wallet_pending"),s.searchParams.delete("phantom_encryption_public_key"),s.searchParams.delete("solflare_encryption_public_key"),s.searchParams.delete("nonce"),s.searchParams.delete("data"),s.searchParams.delete("errorCode"),s.searchParams.delete("errorMessage"),s.searchParams.set("sw_wallet",e),s.searchParams.set("sw_wallet_state",t),r&&s.searchParams.set("sw_wallet_pending",r),s.toString()}function qn(){try{const e=new URL(window.location.href);["sw_wallet","sw_wallet_state","sw_wallet_pending","phantom_encryption_public_key","solflare_encryption_public_key","nonce","data","errorCode","errorMessage"].forEach(t=>e.searchParams.delete(t)),window.history.replaceState({},"",`${e.pathname}${e.search}${e.hash}`)}catch{}}function Bc(){try{const e=window.sessionStorage?.getItem(Oo)||window.localStorage?.getItem(Eo)||"{}",t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function Gf(e){try{window.sessionStorage?.setItem(Oo,JSON.stringify(e))}catch{}try{window.localStorage?.setItem(Eo,JSON.stringify(e))}catch{}}function di(){try{window.sessionStorage?.removeItem(Oo)}catch{}try{window.localStorage?.removeItem(Eo)}catch{}}function Rc(e=""){return e==="solflare"?"solflare_encryption_public_key":"phantom_encryption_public_key"}function Hn(e=""){return e==="phantom"?"https://phantom.app/ul/v1/connect":e==="solflare"?"https://solflare.com/ul/v1/connect":""}function Xf(e="",t={}){const a=Hn(e);if(!a)return"";const r=new URL(a);return r.searchParams.set("app_url",xc()),r.searchParams.set("redirect_link",jf(e,t.stateId,t.returnPath,t.pendingConnectId)),r.searchParams.set("dapp_encryption_public_key",t.dappEncryptionPublicKey),r.searchParams.set("cluster","mainnet-beta"),r.toString()}function la(){return/Android/i.test(navigator.userAgent||"")?"android":/iPhone|iPad|iPod/i.test(navigator.userAgent||"")?"ios":Ge()?"mobile":"desktop"}function Ic(e=""){return Ge()&&!!Hn(e)}function Jf(){const e=navigator.userAgent||"";return/CriOS|Chrome/i.test(e)?"chrome":/Safari/i.test(e)&&!/Chrome|CriOS/i.test(e)?"safari":/Firefox|FxiOS/i.test(e)?"firefox":"mobile-browser"}async function Yf(e="",t="/terminal"){try{const a=await k("/api/web/mobile-wallet/start",{method:"POST",timeoutMs:Ln,body:JSON.stringify({provider:e,intendedRoute:t,platform:la(),browser:Jf()})});return!a.pendingConnectId||!a.stateId||!a.dappEncryptionPublicKey?null:{providerId:e,pendingConnectId:a.pendingConnectId,stateId:a.stateId,returnPath:a.intendedRoute||t,dappEncryptionPublicKey:a.dappEncryptionPublicKey,createdAt:Date.now(),expiresAt:a.expiresAt||"",serverManaged:!0}}catch(a){return Wt(e,a,{action:"mobile_connect_pending_start_failed",connectionFlow:"deeplink_connect",platform:la()}),null}}function Qf(e="",t="/terminal"){if(!window.nacl?.box?.keyPair||!window.crypto?.getRandomValues)return null;const a=window.nacl.box.keyPair(),r=new Uint8Array(16);return window.crypto.getRandomValues(r),{providerId:e,stateId:ci(r),returnPath:t,dappEncryptionPublicKey:ci(a.publicKey),dappEncryptionSecretKey:ci(a.secretKey),createdAt:Date.now(),serverManaged:!1}}async function Oc(e="",{returnPath:t=n.walletConnectReturnPath||"/terminal"}={}){if(!Ic(e))return!1;const a=await Yf(e,t)||Qf(e,t);if(!a)return!1;Gf(a);const r=Xf(e,a);if(!r)return!1;const s=_e(e);return oe(`Opening ${s} mobile connect. Approve in the wallet app, then return to SlimeWire.`),Wt(e,null,{action:"mobile_connect_redirect",adapterReadyState:"mobile_redirect",connectionFlow:"deeplink_connect",platform:la()}),window.location.assign(r),!0}function Ec(e=""){const t=_e(e),a=Mc(e);return a?(oe(`Opening ${t}. If mobile connect is unavailable, use the wallet browser and return to SlimeWire.`),Wt(e,null,{action:"mobile_browse_redirect",adapterReadyState:"mobile_browse",connectionFlow:"browse_fallback",platform:la()}),window.location.href=a,!0):!1}function Fc({requirePassword:e=!1}={}){const t=Xr(["[data-connect-login-username]","[data-login-username]"]).trim(),a=Xr(["[data-connect-login-password]","[data-login-password]"]);if(!t&&!a&&!e)return{};if(!t)throw new Error("Enter your username.");if(!a)throw new Error("Enter your password.");return{username:t,password:a}}function Zf(e=""){n.token="",n.user=null,n.loading=!1,Fo(),h(),T(e||"Your web session expired. Log in, or tap Create Account to start a fresh session.")}async function J(e=null,t="Creating secure web profile..."){if(n.user&&n.token)return n.user;S(e,t);const a=await k("/api/web/signup",{method:"POST",body:JSON.stringify({referralCode:rc()})});return n.token=a.token,he(a.user),Bn(n.token),n.user}function T(e=""){[Sf,kf].forEach(t=>{t&&(t.hidden=!e,S(t,e))})}function Q(e){const t=String(e||"").trim();return t?`https://dexscreener.com/solana/${encodeURIComponent(t)}`:"#"}function eh(e){const t=String(e||"").trim();return t?`https://pump.fun/coin/${encodeURIComponent(t)}`:"#"}function Wc(e){const t=String(e||"").trim();return t?`https://kolscan.io/account/${encodeURIComponent(t)}`:"https://kolscan.io"}async function ui(){T("");const e=Nn();try{const t=Fc();S(e,t.username?"Creating saved login...":"Creating account...");const a=await k("/api/web/signup",{method:"POST",body:JSON.stringify({...t,referralCode:rc()})});n.token=a.token,he(a.user),Bn(n.token),n.loginCollapsed=!0,n.loginModalOpen=!1,n.activeTab="dashboard",S(e,t.username?"Account created. Login saved.":"Quick web account created."),V(a.trade?.signature,"account-create")}catch(t){S(e,t.message),T(t.message)}}async function _c(){T("");const e=Nn();try{const t=Fc({requirePassword:!0});S(e,"Logging in...");const a=await k("/api/web/password-login",{method:"POST",body:JSON.stringify(t)});n.token=a.token,he(a.user),Bn(n.token),n.loginCollapsed=!0,n.loginModalOpen=!1,n.activeTab="dashboard",S(e,"Logged in."),V(a.trade?.signature,"password-login")}catch(t){S(e,t.message),T(t.message)}}function Nc(){return Xr(["[data-connect-login-email]","[data-login-email]"]).trim()}function th(){return Xr(["[data-connect-login-code]","[data-login-code]"]).trim()}function Dc(e=""){const t=String(e||"").trim();if(!t)throw new Error("Enter the email saved on your web account.");if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t))throw new Error("Enter a valid email address.");return t}async function ah(){T("");const e=Nn();try{const t=Dc(Nc());S(e,"Sending login code...");const a=await k("/api/web/email-code",{method:"POST",body:JSON.stringify({email:t})});S(e,a.emailSent?"Code sent. Check your email, then enter it here.":"Code requested. Check your email if delivery is configured.")}catch(t){S(e,t.message),T(t.message)}}async function nh(){T("");const e=Nn();try{const t=Dc(Nc()),a=th();if(!a)throw new Error("Enter the login code from your email.");S(e,"Checking login code...");const r=await k("/api/web/login",{method:"POST",body:JSON.stringify({email:t,code:a})});n.token=r.token,he(r.user),Bn(n.token),n.loginCollapsed=!0,n.loginModalOpen=!1,n.activeTab="dashboard",S(e,"Logged in."),V(r.trade?.signature,"email-code-login")}catch(t){S(e,t.message),T(t.message)}}function Uc(e="",t=new URLSearchParams){const a=Bc(),r=t.get("sw_wallet_state")||"";if(!a.stateId||a.stateId!==r||a.providerId!==e)throw new Error("Wallet callback did not match the pending SlimeWire connection.");if(Date.now()-Number(a.createdAt||0)>1200*1e3)throw new Error("Wallet connection expired. Open Connect Wallet and try again.");const s=t.get(Rc(e))||"",o=t.get("nonce")||"",c=t.get("data")||"";if(!s||!o||!c)throw new Error("Wallet approval did not return the expected connection data.");const l=window.nacl;if(!l?.box?.before||!l.box.open?.after)throw new Error("Mobile wallet connection helper did not load. Refresh and try again.");const d=l.box.before(Jr(s),Jr(a.dappEncryptionSecretKey)),u=l.box.open.after(Jr(c),Jr(o),d);if(!u)throw new Error("Unable to verify the wallet approval response.");const p=JSON.parse(new TextDecoder().decode(u)),f=String(p.public_key||p.publicKey||"").trim();if(!f)throw new Error("Wallet approved, but no public address was returned.");return{publicKey:f,session:String(p.session||""),walletEncryptionPublicKey:s,dappEncryptionPublicKey:a.dappEncryptionPublicKey,returnPath:a.returnPath||"/terminal"}}async function qc(e="",t={}){const a=Un();await J(a,"Creating secure web profile for connected wallet...");const r=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({publicKey:t.publicKey,provider:_e(e)})});he(r.user||{...n.user,connectedWallet:r.profile?.connectedWallet||null}),n.connectedWalletBalance={publicKey:t.publicKey,shortPublicKey:w(t.publicKey),provider:_e(e),tokens:[]};try{window.sessionStorage?.setItem(`${jm}${e}`,JSON.stringify({providerId:e,publicKey:t.publicKey,session:t.session,walletEncryptionPublicKey:t.walletEncryptionPublicKey,dappEncryptionPublicKey:t.dappEncryptionPublicKey,connectedAt:new Date().toISOString()}))}catch{}di(),qn(),n.walletConnectMenuOpen=!1,oe(`Connected ${w(t.publicKey)}. Opening Live Terminal...`),Pe(t.returnPath||n.walletConnectReturnPath||"/terminal","terminal"),h({force:!0}),Qr("mobile-wallet-connect")}function rh(e="",t=new URLSearchParams){return{provider:e,pendingConnectId:t.get("sw_wallet_pending")||Bc().pendingConnectId||"",stateId:t.get("sw_wallet_state")||"",queryKeys:[...t.keys()].filter(a=>a!=="data"&&a!=="nonce"),walletEncryptionPublicKey:t.get(Rc(e))||"",nonce:t.get("nonce")||"",data:t.get("data")||"",errorCode:t.get("errorCode")||"",errorMessage:t.get("errorMessage")||""}}async function sh(e="",t={}){t.token&&(n.token=t.token,Bn(n.token)),he(t.user||{...n.user,connectedWallet:t.connectedWallet||t.profile?.connectedWallet||null});const a=t.publicKey||t.connectedWallet?.publicKey||t.profile?.connectedWallet?.publicKey||"";a&&(n.connectedWalletBalance={publicKey:a,shortPublicKey:w(a),provider:t.provider||_e(e),tokens:[]}),di(),qn(),n.walletConnectMenuOpen=!1,oe(a?`Connected ${w(a)}. Opening Live Terminal...`:"Wallet connected. Opening Live Terminal..."),Pe(t.finalRedirectRoute||n.walletConnectReturnPath||"/terminal","terminal"),h({force:!0}),Qr("mobile-wallet-callback")}async function Hc(e="",t=new URLSearchParams){const a=await k("/api/web/mobile-wallet/callback",{method:"POST",timeoutMs:Ln,body:JSON.stringify(rh(e,t))});return await sh(e,a),!0}async function oh(){const e=new URLSearchParams(window.location.search||""),t=e.get("sw_wallet")||"";if(!["phantom","solflare"].includes(t))return!1;n.walletConnectMenuOpen=!0;const a=_e(t),r=e.get("sw_wallet_pending")||"",s=e.get("errorCode")||"",o=e.get("errorMessage")||"";if(s||o)return r&&await Hc(t,e).catch(()=>{}),di(),qn(),oe(`${a} did not connect: ${o||s||"request cancelled"}. Choose another wallet or try again.`),Wt(t,new Error(o||s||"Wallet connect cancelled"),{action:"mobile_connect_cancelled",connectionFlow:"deeplink_connect",platform:la()}),h({force:!0}),!0;try{if(oe(`Finishing ${a} mobile connection...`),r)await Hc(t,e);else{const c=Uc(t,e);await qc(t,c)}}catch(c){if(r)try{const l=Uc(t,e);await qc(t,l)}catch{oe(`${a} mobile connection could not finish: ${c.message}`),Wt(t,c,{action:"mobile_connect_callback_failed",connectionFlow:"deeplink_connect",platform:la()}),qn(),h({force:!0})}else oe(`${a} mobile connection could not finish: ${c.message}`),Wt(t,c,{action:"mobile_connect_callback_failed",connectionFlow:"deeplink_connect",platform:la()}),qn(),h({force:!0})}return!0}async function ih(){T("");const e=Un()||Nn();try{S(e,"Choose a wallet provider to connect."),ma({returnPath:"/terminal"})}catch(t){S(e,t.message),T(t.message)}}async function lh(){n.user||await ui(),n.user&&(n.walletConnectMenuOpen=!1,n.route="terminal",n.activeTab="wallets",n.toolSections={...n.toolSections||{},wallets:n.wallets.length?"balances":"create"},window.history.pushState({},"","/terminal"),h(),n.wallets.length||await Cu())}async function ch(){if(n.logoutPending)return;if(!n.user){n.loginCollapsed=!1,h(),Fn?.scrollIntoView?.({behavior:"smooth",block:"start"});return}await du("logging out");const e=String(n.token||"");n.logoutPending=!0;const t=m("[data-logout]");t&&(t.disabled=!0,S(t,"Logging out...")),n.token="",n.user=null,n.wallets=[],n.balances=[],n.positions=[],n.pnl=null,n.connectedWalletBalance=null,n.walletRefreshing=!1,n.walletRefreshStatus="idle",n.walletRefreshError="",n.positionRefreshAction={state:"idle",startedAt:0,minUntil:0,error:""},n.manualSellActions={},n.tradeActionLocks={},n.ogreAgentStatus="",El(),Fo(),h({force:!0});try{e&&await k("/api/web/logout",{method:"POST",headers:{Authorization:`Bearer ${e}`},timeoutMs:4e3,dedupe:!1})}catch{}finally{n.logoutPending=!1}}async function dh(){if(!n.token){h();return}try{const e=await k("/api/web/me");he(e.user),h({preserveSmartChartFrame:n.activeTab==="smartChart"}),He({force:!1,deep:!1,reason:"session-load"}).catch(t=>{n.walletRefreshError=t.message||"Wallet refresh failed.",h({preserveSmartChartFrame:n.activeTab==="smartChart"})})}catch{n.token="",Fo(),h()}}async function ca(e={}){const t=L();if(!n.user||!n.token){n.wallets=[],n.balances=[],n.positions=[],n.pnl=null,n.connectedWalletBalance=null,n.launchWatches=[],n.presets={trade:[],bundle:[]},n.tradePlans=[],n.watchlist={rows:[],count:0},h();return}const a=!e.silent;a&&(n.loading=!0,h());try{const r=e.force?"?force=true":"";if(e.skipCore){const[y,b,v,P,A]=await Promise.all([k("/api/web/pnl"),k("/api/web/launch/watches"),k("/api/web/presets"),k("/api/web/watchlist"),k("/api/web/trade/plans")]);n.pnl=y.pnl||null,n.launchWatches=b.watches||[],n.presets=v.presets||{trade:[],bundle:[]},zu(),n.watchlist=P.watchlist||{rows:[],count:0},n.tradePlans=A.plans||[],Cs();return}const[s,o,c,l,d,u,p,f]=await Promise.all([k("/api/web/wallets"),k(`/api/web/balances${r}`),k(`/api/web/positions${r}`),k("/api/web/pnl"),k("/api/web/launch/watches"),k("/api/web/presets"),k("/api/web/watchlist"),k("/api/web/trade/plans")]);n.wallets=s.wallets||[],n.balances=o.balances||[],n.connectedWalletBalance=o.connectedWallet||c.connectedWallet||null,n.positions=c.positions||[],n.pnl=l.pnl||null,n.launchWatches=d.watches||[],n.presets=u.presets||{trade:[],bundle:[]},zu(),n.watchlist=p.watchlist||{rows:[],count:0},n.tradePlans=f.plans||[],Cs(),e.force&&(n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshError="")}finally{K("load-all",t,{component:"wallet",resultCount:(n.balances?.length||0)+(n.positions?.length||0),details:e.skipCore?"skip-core":"core"}),a&&(n.loading=!1),h()}}async function pi(e={}){if(!n.user||!n.token)return;const t=L(),a=e.requestId||0,r=()=>a&&n.walletRefreshRequestId!==a,s=e.force?"?force=true":"",o=e.force||e.deep?"?force=true":"",c=e.timeoutMs||Ln,l=k("/api/web/wallets",{timeoutMs:c}),d=k(`/api/web/balances${s}`,{timeoutMs:c}),u=k("/api/web/trade/plans",{timeoutMs:c}),p=await d;if(r())return;n.balances=p.balances||[],n.connectedWalletBalance=p.connectedWallet||null,n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshError="",K("wallet-refresh",t,{component:"wallet",resultCount:n.balances.length,cacheHit:!!p.cacheHit,details:`wallets=${n.wallets.length};connected=${!!n.connectedWalletBalance}`}),e.progress!==!1&&h({preserveSmartChartFrame:!!e.preserveSmartChartFrame});const[f,y]=await Promise.all([l.then(b=>({ok:!0,wallets:b})).catch(b=>({ok:!1,error:b})),u.then(b=>({ok:!0,tradePlans:b})).catch(b=>({ok:!1,error:b}))]);if(!r()&&(f.ok&&(n.wallets=f.wallets.wallets||n.wallets||[]),y.ok&&(n.tradePlans=y.tradePlans.plans||n.tradePlans||[],Cs()),e.progress!==!1&&(f.ok||y.ok)&&h({preserveSmartChartFrame:!!e.preserveSmartChartFrame}),e.deep)){const b=L(),v=k(`/api/web/positions${o}`,{timeoutMs:c}).catch(P=>({__error:P}));try{const P=await v;if(P?.__error)throw P.__error;if(r())return;n.connectedWalletBalance=P.connectedWallet||n.connectedWalletBalance||null,n.positions=P.positions||[],n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshError="",K("positions-refresh",b,{component:"positions",resultCount:n.positions.length,cacheHit:!!P.cacheHit,details:`open=${n.positions.length}`})}catch(P){n.walletRefreshError=P.message||"Position refresh failed.",K("positions-refresh",b,{errorCode:P?.code||P?.name||"POSITIONS_REFRESH_FAILED",component:"positions",details:N(P?.message||"Position refresh failed.")})}}}function Kc(e=n.positions){return(Array.isArray(e)?e:[]).some(t=>{const a=t?.estimatedValueSol!==null&&t?.estimatedValueSol!==void 0&&t?.estimatedValueSol!=="";return!!(t?.valuePending||!a&&/refreshing|updating|background/i.test(t?.valueError||""))})}function Vc(e=120,t="positions-value-followup"){!n.user||!n.token||(qr&&window.clearTimeout(qr),qr=window.setTimeout(()=>{qr=null,St({force:!0,fast:!1,silent:!0,followUpValues:!1,reason:t,timeoutMs:Qt}).then(a=>{a?(n.lastWalletRefreshAt=new Date().toISOString(),h({preserveSmartChartFrame:n.activeTab==="smartChart"})):Yr(`${t}-failed`)}).catch(()=>Yr(`${t}-failed`))},Math.max(0,Number(e)||0)))}function uh(e=[],t=[],a={}){const r=new Map((Array.isArray(t)?t:[]).map(s=>[String(s?.tokenMint||""),s]));return(Array.isArray(e)?e:[]).map(s=>{const o=r.get(String(s?.tokenMint||""));if(!o||a.fast===!1)return s;const c=!!(s?.valuePending||/refreshing|updating|background/i.test(s?.valueError||"")),l=o.estimatedValueSol!==null&&o.estimatedValueSol!==void 0&&o.estimatedValueSol!=="";return!c||!l?s:{...s,estimatedValueSol:o.estimatedValueSol,openPnlSol:o.openPnlSol,openPnlPercent:o.openPnlPercent,valuePending:!1,valueError:""}})}function Yr(e="positions-value-refresh-delayed"){let t=!1;return n.positions=(Array.isArray(n.positions)?n.positions:[]).map(a=>{const r=a?.estimatedValueSol!==null&&a?.estimatedValueSol!==void 0&&a?.estimatedValueSol!=="";return!(a?.valuePending||/refreshing|updating|background/i.test(a?.valueError||""))?a:(t=!0,{...a,valuePending:!1,valueError:r?"":"Price refresh delayed; tap Refresh."})}),t?(K("positions-value-refresh-cleanup",L(),{component:"positions",details:e}),h({preserveSmartChartFrame:n.activeTab==="smartChart"}),!0):!1}function zc(e="portfolio-supplemental"){if(!n.user||!n.token)return;const t=L();Promise.allSettled([k("/api/web/balances?force=true",{timeoutMs:Qt}),k("/api/web/pnl?force=true",{timeoutMs:Qt,dedupe:!1})]).then(([a,r])=>{a.status==="fulfilled"&&(n.balances=a.value.balances||n.balances||[],n.connectedWalletBalance=a.value.connectedWallet||n.connectedWalletBalance||null),r.status==="fulfilled"&&(n.pnl=r.value.pnl||n.pnl||null),n.lastWalletRefreshAt=new Date().toISOString(),K("portfolio-supplemental-refresh",t,{component:"wallet",resultCount:(n.balances?.length||0)+(n.positions?.length||0),details:e}),h({preserveSmartChartFrame:n.activeTab==="smartChart"})}).catch(()=>{})}async function St(e={}){if(!n.user||!n.token)return;const t=L(),a=new URLSearchParams;e.force&&a.set("force","true"),e.fast!==!1&&a.set("fast","true");const r=a.toString()?`?${a.toString()}`:"",s=r||"full";if(On&&No===s)return On;const o=++Do;return No=s,On=(async()=>{try{const c=await k(`/api/web/positions${r}`,{timeoutMs:e.timeoutMs||(e.fast===!1?Qt:Ro)});return Do!==o?!1:(n.connectedWalletBalance=c.connectedWallet||n.connectedWalletBalance||null,n.positions=uh(c.positions||n.positions||[],n.positions||[],e),n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshError="",K("positions-refresh",t,{component:"positions",resultCount:n.positions.length,cacheHit:!!c.cacheHit,details:`${e.reason||(e.silent?"silent":"refresh")};fast=${e.fast!==!1}`}),e.followUpValues&&e.fast!==!1&&Kc(n.positions)&&Vc(120,`${e.reason||"positions"}-values`),e.syncPnl&&zc(`${e.reason||"positions"}-sync-pnl`),!0)}catch(c){return e.silent||(n.walletRefreshError=c.message||"Position refresh failed."),K("positions-refresh",t,{errorCode:c?.code||c?.name||"POSITIONS_REFRESH_FAILED",component:"positions",details:N(c?.message||"Position refresh failed.")}),!1}finally{Do===o&&(On=null,No="")}})(),On}async function ph(e={}){if(!n.user||!n.token){T("Connect your wallet before refreshing positions."),je("error",{error:"Wallet not connected"});return}const t=L();Xa("refreshing",{startedAt:n.positionRefreshAction?.startedAt||t}),n.walletRefreshError="",Ee("[data-sync-health]",ss()),de(),await xe(20);try{if(!await St({force:!!e.force,fast:!1,silent:!1,followUpValues:!1,reason:e.reason||"positions-only",timeoutMs:Qt}))throw new Error(n.walletRefreshError||"Position refresh failed.");n.lastWalletRefreshAt=new Date().toISOString(),je("success",{error:""}),zc(`${e.reason||"positions-only"}-balances-pnl`),Kc(n.positions)&&Vc(120,`${e.reason||"positions-only"}-full-values`),K("positions-only-refresh",t,{component:"positions",resultCount:n.positions.length,details:e.reason||"positions-only"})}catch(a){const r=a?.message||"Position refresh failed.";n.walletRefreshError=r,je("error",{error:N(r)}),T(r),K("positions-only-refresh",t,{errorCode:a?.code||a?.name||"POSITIONS_REFRESH_FAILED",component:"positions",details:N(r)})}finally{h()}}function Kn(){return String(n.smartChartToken||n.tradeToken||n.bundleToken||n.volumeToken||n.terminalToken||"").trim()}function Xe(e=n.activeTab){return Lf[e]||null}function Qa(e=Xe()){return String(e?.cacheKey||e?.tabKey||"terminal:unknown").replace("{bucket}",tn(n.livePairBucket)).replace("{sort}",String(n.terminalSort||"best")).replace("{scopeMode}",String(n.slimeScopeMode||"new")).replace("{kolMode}",String(n.kolMode||"hot")).replace("{kolWallet}",n.kolWallet?w(n.kolWallet):"global").replace("{scanMode}",String(n.scanMode||"safe")).replace("{tokenMint}",Kn()?w(Kn()):"none")}function jc(e=n.activeTab,t="pageSize",a=25){const r=Xe(e),s=Number(r?.[t]);return Number.isFinite(s)&&s>0?s:a}function Za(e=n.activeTab){return jc(e,"pageSize",25)}function mi(e=n.activeTab){return Math.max(Za(e),jc(e,"maxPageSize",Za(e)))}function Gc(e=n.activeTab){return!!Xe(e)?.supportsPagination}function fi(e=n.activeTab){const t=Xe(e)||{tabKey:e};return`${e}:${Qa(t)}`}function Vn(e=n.activeTab,t=0){const a=fi(e),r=Za(e),s=mi(e),o=Number(n.terminalFeedVisibleLimits?.[a]||0),c=Number.isFinite(o)&&o>0?o:r,l=Number(t||0),d=Math.min(Math.max(r,c),s);return l>0?Math.min(d,l):d}function Z(e=n.activeTab){const t=fi(e);if(!n.terminalFeedVisibleLimits?.[t])return;const a={...n.terminalFeedVisibleLimits||{}};delete a[t],n.terminalFeedVisibleLimits=a}function mh(e=n.activeTab,t=0){const a=fi(e),r=Vn(e,t),s=Za(e),o=mi(e),c=Number(t||0),l=Math.min(o,c>0?c:o,r+s);return n.terminalFeedVisibleLimits={...n.terminalFeedVisibleLimits||{},[a]:l},l}function it(e=n.activeTab,t=[]){const a=Array.isArray(t)?t:[];return a.slice(0,Vn(e,a.length))}function fh(e=n.activeTab,t=[]){const a=Array.isArray(t)?t:[];return Gc(e)&&a.length>Vn(e,a.length)}function da(e=n.activeTab,t=[],a="rows"){const r=Array.isArray(t)?t:[];if(!fh(e,r))return"";const s=Vn(e,r.length);return`
  ...
  `}function j(e=n.activeTab){return n.terminalFeeds[e]||{}}function Xc(e=n.activeTab){return e==="live"||e==="terminal"||e==="slimeScope"?ua():e==="kol"?n.kolLastUpdatedAt||"":e==="watchlist"?j("watchlist").lastFetchAt||"":["wallets","positions","trade","bundle","volume","smartChart"].includes(e)?n.lastWalletRefreshAt||j(e).lastFetchAt||"":j(e).lastFetchAt||""}function _t(e=n.activeTab){return e==="terminal"?Number(qe()?.rows?.length||0)+Number(n.kolScan?.rows?.length||0):e==="live"?Number(qe()?.rows?.length||0):e==="liveTrades"?Number(n.pnl?.trades?.length||0):e==="slimeScope"?Number(Rp?.(n.slimeScopeMode)?.length||0):e==="kol"?Number(n.kolScan?.rows?.length||0):e==="watchlist"?Number(n.watchlist?.rows?.length||0):e==="smartChart"?Kn()?1:Number(br?.()?.length||0):e==="trade"||e==="bundle"||e==="volume"?Kn()?1:0:e==="sniper"?Number(n.scan?.rows?.length||0):e==="launch"||e==="launchCoin"?Number(n.launchWatches?.length||0):e==="wallets"?Number(n.wallets?.length||0)+Number(n.balances?.length||0):e==="positions"?Number(n.positions?.length||0):e==="pnl"?Number(n.pnl?.trades?.length||0):e==="ogreAi"?n.ogreAiResult?1:0:e==="ogreTek"?Number(n.ogreTek?.markets?.length||0)+Number(n.ogreTek?.positions?.length||0):0}function zn(e=n.activeTab){const t=_t(e);return["live","liveTrades","slimeScope","kol","watchlist","sniper"].includes(e)?Math.min(t,Vn(e,t)):t}function jn(e=n.activeTab){const t=Xe(e);if(!t)return!1;const a=Date.parse(Xc(e)||"");return Number.isFinite(a)?Date.now()-a>Number(t.staleMs||3e4):!0}function Jc(e=n.activeTab){return _t(e)>0||!!Xc(e)}function hh(e=n.activeTab,t={}){const a=Xe(e)||{};return{tabKey:e,label:a.label||e,category:a.category||"unknown",endpoint:a.endpoint||"",cacheKey:Qa(a),requestId:t.requestId||"",status:t.status||"unknown",reason:t.reason||"",resultCount:Number(t.resultCount||0),renderedCount:Number(t.renderedCount??zn(e)??0),pageSize:Za(e),maxPageSize:mi(e),supportsPagination:Gc(e),hasMore:!!(t.hasMore??_t(e)>zn(e)),nextCursor:String(t.nextCursor||"").slice(0,80),stale:!!t.stale,errorCode:String(t.errorCode||"").slice(0,80),errorMessage:String(t.errorMessage||"").slice(0,160),at:new Date().toISOString()}}function Yc(e=n.activeTab,t={}){const a=hh(e,t);if(n.terminalFeedLog=[...n.terminalFeedLog||[],a].slice(-20),ni(Gm,()=>n.terminalFeedLog,"feed"),a.status==="error"||a.status==="timeout"||/manual|post-trade|visibility|resume/i.test(a.reason||"")||!!(a.stale&&a.resultCount===0))try{k("/api/web/terminal-feed-event",{method:"POST",timeoutMs:2500,body:JSON.stringify(a)}).catch(()=>{})}catch{}return a}function gh(e=n.activeTab,t={}){const a=Xe(e);if(!a)return"";const r=globalThis.crypto?.randomUUID?.()||`feed-${Date.now()}-${Math.random().toString(36).slice(2,8)}`;return n.terminalFeeds={...n.terminalFeeds,[e]:{...j(e),label:a.label,category:a.category,endpoint:a.endpoint,cacheKey:Qa(a),refreshMs:a.refreshMs,staleMs:a.staleMs,pageSize:a.pageSize,maxPageSize:a.maxPageSize,supportsPagination:!!a.supportsPagination,inFlight:!0,lastRequestId:r,lastReason:t.reason||"refresh",lastStartedAt:new Date().toISOString()}},r}function hi(e=n.activeTab,t="",a="success",r={}){const s=Xe(e);if(!s)return;const o=_t(e),c=zn(e),l={...j(e),label:s.label,category:s.category,endpoint:s.endpoint,cacheKey:Qa(s),refreshMs:s.refreshMs,staleMs:s.staleMs,pageSize:s.pageSize,maxPageSize:s.maxPageSize,supportsPagination:!!s.supportsPagination,inFlight:!1,lastRequestId:t,lastStatus:a,lastFetchAt:new Date().toISOString(),resultCount:o,renderedCount:c,hasMore:o>c,stale:a!=="success"||jn(e),errorCode:r.errorCode||"",errorMessage:r.errorMessage||""};n.terminalFeeds={...n.terminalFeeds,[e]:l},Yc(e,{requestId:t,status:a,reason:l.lastReason,resultCount:o,renderedCount:c,hasMore:l.hasMore,stale:l.stale,errorCode:l.errorCode,errorMessage:l.errorMessage})}function bh(e=n.activeTab){return["watchlist","wallets","positions","pnl","liveTrades","trade","bundle","volume","smartChart","launch","launchCoin"].includes(e)}function yh(e={}){const t=String(e.reason||"").toLowerCase();return!!e.userInitiated||t.includes("manual")||t.includes("button")||t.includes("bucket-switch")||t.includes("mode-switch")}async function te(e=n.activeTab,t={}){const a=L(),r=Xe(e);if(!r)return null;if(t.ifStale&&Jc(e)&&!jn(e))return j(e);if(j(e).inFlight){const d=Number(Io.get(e)||0);if(!d||Date.now()-d<15e3)return j(e);n.terminalFeeds={...n.terminalFeeds,[e]:{...j(e),inFlight:!1}}}const s=yh(t),o=Date.now(),c=Number(Io.get(e)||0);if(!s&&c&&o-c<xn)return j(e);if(bh(e)&&!n.user&&!["smartChart","trade","bundle","volume","launchCoin"].includes(e))return hi(e,"","skipped",{errorCode:"ACCOUNT_REQUIRED",errorMessage:"Account or wallet required."}),j(e);Io.set(e,o);const l=gh(e,t);if(s&&t.renderStart!==!1){const d=n.activeTab==="smartChart"&&["smartChart"].includes(e);h({force:!0,preserveSmartChartFrame:d})}try{if(e==="terminal"){const d=[an({silent:!0,force:!!t.force})];n.kolWallet||d.push(rs(n.kolMode,"",{silent:!0})),await Promise.race([Promise.allSettled(d),new Promise(u=>setTimeout(u,13e3))])}else if(e==="live")await es({silent:t.silent!==!1,bucket:n.livePairBucket,force:!!t.force});else if(e==="liveTrades")n.user&&n.token&&await ca({silent:!0,skipCore:!0,force:!!t.force});else if(e==="slimeScope"){const d=[an({silent:!0,force:!!t.force}),Xn(n.scanMode,{silent:!0,force:!!t.force}).catch(()=>{})];n.kolScan||d.push(rs(n.kolMode,n.kolWallet,{silent:!0}).catch(()=>{})),await Promise.allSettled(d)}else if(e==="kol")await rs(n.kolMode,n.kolWallet,{silent:t.silent!==!1});else if(e==="watchlist")await ed({silent:t.silent!==!1});else if(e==="sniper")await Xn(n.scanMode,{silent:t.silent!==!1});else if(e==="positions")n.user&&n.token&&await St({force:!!t.force,fast:!0,silent:!0,reason:t.reason||"positions-feed-refresh",followUpValues:!0,syncPnl:!!t.force,timeoutMs:Ro});else if(["wallets","pnl"].includes(e))n.user&&n.token&&await He({force:!!t.force,deep:!1});else if(e==="smartChart")n.user&&n.token&&await He({force:!!t.force,deep:!1});else if(["trade","bundle","volume"].includes(e)){const d=[an({silent:!0,force:!!t.force})];n.user&&n.token&&d.push(ca({silent:!0,skipCore:!0,force:!!t.force})),await Promise.allSettled(d)}else if(e==="launch"||e==="launchCoin"){const d=[an({silent:!0,force:!!t.force})];n.scan||d.push(Xn(n.scanMode,{silent:!0,force:!!t.force}).catch(()=>{})),n.user&&n.token&&d.push(ca({silent:!0,skipCore:!0,force:!!t.force})),await Promise.allSettled(d)}else e==="ogreTek"&&await Lr({silent:!0}).catch(d=>{n.ogreTek.error=d.message});return hi(e,l,"success"),j(e)}catch(d){if(hi(e,l,"error",{errorCode:d?.code||d?.name||"REFRESH_FAILED",errorMessage:N(d?.message||"Feed refresh failed.")}),t.throwOnError)throw d;return j(e)}finally{K("feed-refresh",a,{component:r.component||e,resultCount:_t(e),cacheHit:!!j(e).cacheHit,stale:jn(e),requestId:j(e).lastRequestId||"",errorCode:j(e).errorCode||"",details:`${e}:${Qa(r)}`}),t.render!==!1&&(!s&&Si()?od():h({force:!0,preserveSmartChartFrame:n.activeTab==="smartChart"&&e==="smartChart"}))}}async function en(e={}){const t=n.activeTab||"terminal",a=[te(t,{...e,reason:e.reason||"visible-refresh"})];return await Promise.allSettled(a)}function Qr(e="terminal-entry"){n.route==="terminal"&&(en({silent:!0,ifStale:!0,reason:e}).catch(t=>T(t.message)),n.user&&n.token&&He({force:!0,deep:!1,reason:e}).catch(t=>{n.walletRefreshError=t.message||"Wallet refresh failed.",h({preserveSmartChartFrame:n.activeTab==="smartChart"})}))}function gi(){const e=()=>{Da&&clearTimeout(Da),Da=null,Nr=""};if(n.route!=="terminal"||document.hidden){e();return}const t=Xe(n.activeTab);if(!t||["terminal","live","slimeScope","kol","watchlist","sniper","launchCoin"].includes(n.activeTab)){e();return}const a=Math.max(5e3,Number(t.refreshMs||3e4)),r=`${n.activeTab}:${Qa(t)}:${a}`;Da&&Nr===r||(e(),Nr=r,Da=setTimeout(async()=>{Da=null,Nr="",!(n.route!=="terminal"||document.hidden)&&(await te(n.activeTab,{silent:!0,force:!0,ifStale:!0,reason:"active-tab-auto"}).catch(s=>T(s.message)),gi())},a))}function tn(e){const t=String(e||"live");return Et.some(([a])=>a===t)?t:"live"}function Qc(e=n.slimeScopeMode){const t=String(e||"new");return t==="steady"?"under1h":t==="graduating"?"under3h":t==="graduated"?"under1d":"live"}function Zr(e=n.activeTab){return e==="slimeScope"?Qc(n.slimeScopeMode):tn(n.livePairBucket)}function qe(e=Zr()){const t=tn(e);return n.livePairsByBucket[t]||(t===n.livePairBucket?n.livePairs:null)||null}function ua(e=Zr()){const t=tn(e);return n.livePairsLastUpdatedByBucket[t]||(t===n.livePairBucket?n.livePairsLastUpdatedAt:"")||""}function Zc(e=[]){return Array.isArray(e)&&e.length>0}function Fe(e={},t={},a=[]){for(const r of a){const s=e?.[r];if(s!=null&&s!=="")return s}for(const r of a){const s=t?.[r];if(s!=null&&s!=="")return s}return""}function vh(e=[],t=[]){const a=new Map((Array.isArray(e)?e:[]).map(r=>[va(r),r]).filter(([r])=>r));return(Array.isArray(t)?t:[]).map(r=>{const s=a.get(va(r));return s?{...s,...r,tokenMint:Fe(r,s,["tokenMint","mint","tokenAddress","address"]),mint:Fe(r,s,["mint","tokenMint","tokenAddress","address"]),symbol:Fe(r,s,["symbol","ticker","shortMint"]),name:Fe(r,s,["name","tokenName","category"]),imageUrl:Fe(r,s,["imageUrl","image","icon","logoURI","logoUrl"]),image:Fe(r,s,["image","imageUrl","icon","logoURI","logoUrl"]),avatarUrl:Fe(r,s,["avatarUrl","avatar_url","avatar"]),avatarState:Fe(r,s,["avatarState"]),dexUrl:Fe(r,s,["dexUrl","url"]),pumpUrl:Fe(r,s,["pumpUrl","pumpFunUrl","pumpfunUrl"]),websiteUrl:Fe(r,s,["websiteUrl","website"]),twitterUrl:Fe(r,s,["twitterUrl","xUrl"]),telegramUrl:Fe(r,s,["telegramUrl"]),metadata:r?.metadata||s?.metadata||r?.tokenMetadata||s?.tokenMetadata||null,tokenMetadata:r?.tokenMetadata||s?.tokenMetadata||r?.metadata||s?.metadata||null,dex:r?.dex||s?.dex||r?.dexScreener||s?.dexScreener||null,pump:r?.pump||s?.pump||r?.pumpFun||s?.pumpFun||null}:r})}async function es({silent:e=!1,bucket:t=n.livePairBucket,renderOnComplete:a=!0,force:r=!1}={}){const s=L(),o=tn(t),c=o===n.livePairBucket,l=n.terminalSort||"best",d=n.terminalCat||"",u=`${o}:${l}:${d}`,p=na.get(u);if(p?.promise){n.livePairsLoadingByBucket={...n.livePairsLoadingByBucket,[o]:p.requestId},n.livePairsLoading=!!n.livePairsLoadingByBucket[n.livePairBucket],!e&&c&&(n.loading=!0);const A=n.livePairsByBucket?.[o]?.rows||(c?n.livePairs?.rows:[]);return!e&&!Zc(A)&&Va(Yl),p.promise}const f=`${Date.now()}:${Math.random().toString(16).slice(2)}`,y=(En[o]||0)+1;En[o]=y;const b=()=>En[o]===y;n.livePairsLoadingByBucket={...n.livePairsLoadingByBucket,[o]:f},n.livePairsLoading=!!n.livePairsLoadingByBucket[n.livePairBucket],!e&&c&&(n.loading=!0);const v=n.livePairsByBucket?.[o]?.rows||(c?n.livePairs?.rows:[]);!e&&!Zc(v)&&Va(Yl);const P=(async()=>{try{const A=r?"&force=true":"",g=d?`&cat=${encodeURIComponent(d)}`:"",$=`/api/web/live-pairs?bucket=${encodeURIComponent(o)}&sort=${encodeURIComponent(l)}${g}${A}`,C=await Promise.race([k($),new Promise((X,Ue)=>window.setTimeout(()=>Ue(new Error("Live feed refresh timed out.")),12e3))]),B=Et.find(([X])=>X===o)?.[1]||"Live",U=n.livePairsByBucket[o]||(c?n.livePairs:null);let H=C.livePairs||{bucket:o,rows:[],refreshedAt:new Date().toISOString(),refreshSeconds:5,message:`${B} feed returned no rows yet. Retrying automatically.`};const Se=Array.isArray(H?.rows)?H.rows:[],De=Array.isArray(U?.rows)?U.rows:[];if(Se.length===0&&De.length>0?H={...U,...H,rows:U.rows,stale:!0,emptyRefresh:!0,message:`${B} is scanning for fresh rows. Showing the last good feed until the next qualifying refresh.`}:Se.length>0&&De.length>0&&(H={...H,rows:vh(De,Se)}),!b())return H;const q=H?.refreshedAt||new Date().toISOString(),Oe={...n.livePairsRefreshErrorByBucket||{}};return delete Oe[o],n.livePairsRefreshErrorByBucket=Oe,n.livePairsByBucket={...n.livePairsByBucket,[o]:H},n.livePairsLastUpdatedByBucket={...n.livePairsLastUpdatedByBucket,[o]:q},c&&(n.livePairs=H,n.livePairsLastUpdatedAt=q),H}catch(A){const g=N(A?.message||"Live feed refresh failed."),$=Et.find(([U])=>U===o)?.[1]||"Live",C=n.livePairsByBucket[o]||(c?n.livePairs:null),B=C?{...C,stale:!0,refreshError:g,message:`Showing last good ${$} feed. Refresh failed, retrying automatically.`}:{bucket:o,rows:[],refreshedAt:new Date().toISOString(),refreshSeconds:5,stale:!0,refreshError:g,message:`${$} refresh failed. Retrying automatically.`};return b()&&(n.livePairsRefreshErrorByBucket={...n.livePairsRefreshErrorByBucket||{},[o]:g},n.livePairsByBucket={...n.livePairsByBucket,[o]:B},n.livePairsLastUpdatedByBucket={...n.livePairsLastUpdatedByBucket,[o]:B.refreshedAt},c&&(n.livePairs=B,n.livePairsLastUpdatedAt=B.refreshedAt)),B}finally{if(!b())return;const A=n.livePairsByBucket?.[o]?.rows||[];K("live-pairs-refresh",s,{component:"livePairs",resultCount:Array.isArray(A)?A.length:0,stale:!!n.livePairsByBucket?.[o]?.stale,errorCode:n.livePairsRefreshErrorByBucket?.[o]?"LIVE_PAIRS_REFRESH_FAILED":"",details:`${o}:${l}`});const g={...n.livePairsLoadingByBucket};(g[o]===f||g[o]===!0)&&(delete g[o],n.livePairsLoadingByBucket=g),n.livePairsLoading=!!g[n.livePairBucket],!e&&c&&(n.loading=!1),a&&(c&&["terminal","live","slimeScope"].includes(n.activeTab)?Va("load-live-pairs-complete"):h())}})();return na.set(u,{requestId:f,requestVersion:y,safeBucket:o,promise:P}),P.finally(()=>{na.get(u)?.requestId===f&&na.delete(u)}),P}async function an({silent:e=!1,force:t=!1,warmAll:a=!1}={}){if(await es({silent:e,bucket:n.livePairBucket,force:t}),a){const r=Et.map(([s])=>s).filter(s=>s!==n.livePairBucket);await Promise.allSettled(r.map(s=>es({silent:!0,bucket:s,renderOnComplete:!1,force:t})))}(n.activeTab==="live"||n.activeTab==="terminal"||n.activeTab==="slimeScope")&&Va(a?"live-pair-buckets-warm-all":"live-pair-active-bucket")}function ts(e){const t=tn(n.livePairBucket);for(const a of[...na.keys()])a.startsWith(`${t}:`)&&na.delete(a);En[t]=(En[t]||0)+1,h(),typeof e=="function"?e():an({silent:!0,force:!0})}function pa(){if(Yn()||document.hidden||Ha()||n.activeTab!=="live"&&n.activeTab!=="terminal"&&n.activeTab!=="slimeScope"){Ka();return}const e=Zr(n.activeTab),a=(n.activeTab==="slimeScope"?12:8)*1e3,r=`${n.activeTab}:${e}:${n.terminalSort}:${a}`;Ea&&Or===r||(Ka(),Or=r,Ea=setTimeout(async()=>{if(Ea=null,Or="",document.hidden||Ha()){pa();return}if(n.activeTab==="live"||n.activeTab==="terminal"||n.activeTab==="slimeScope"){if(n.livePairsLoadingByBucket?.[e]){pa();return}try{n.activeTab==="slimeScope"?await te("slimeScope",{silent:!0,render:!1,force:!1,reason:"slime-scope-auto-refresh"}):await es({silent:!0,bucket:n.livePairBucket,force:!1})}catch{}finally{pa()}}},a))}function wh({force:e=!1}={}){if(Yn()||!(n.activeTab==="live"||n.activeTab==="terminal"||n.activeTab==="slimeScope"))return;const a=Zr(n.activeTab),r=`${a}:${n.terminalSort||"best"}`;Er.has(r)||n.livePairsLoadingByBucket[a]||!e&&n.livePairsByBucket[a]||(Er.add(r),window.setTimeout(()=>{const s=n.activeTab==="slimeScope"?te("slimeScope",{silent:!0,render:!1,force:!0,reason:"slime-scope-warmup"}):an({silent:!0,force:!0,warmAll:!1});Promise.resolve(s).catch(o=>T(o.message)).finally(()=>{Er.delete(r),pa()})},900))}function as(){const e=()=>{Fa&&clearTimeout(Fa),Fa=null,Fr=""};if(document.hidden||n.activeTab!=="sniper"){e();return}const t=`${n.activeTab}:${n.scanMode}`;Fa&&Fr===t||(e(),Fr=t,Fa=setTimeout(async()=>{if(Fa=null,Fr="",document.hidden){as();return}if(n.activeTab==="sniper"){if(n.loading){as();return}try{await Xn(n.scanMode,{silent:!0})}catch(a){T(a.message)}finally{as()}}},2e4))}function Gn(){const e=()=>{Wa&&clearTimeout(Wa),Wa=null,Wr=""};if(Yn()||document.hidden||n.activeTab!=="kol"&&n.activeTab!=="terminal"||n.kolWallet){e();return}const t=String(n.kolMode||"hot"),s=t==="hot"||t==="fresh"?1e4:3e4,o=`${n.activeTab}:${n.kolMode}:${s}`;Wa&&Wr===o||(e(),Wr=o,Wa=setTimeout(async()=>{if(Wa=null,Wr="",document.hidden){Gn();return}if(!(n.activeTab!=="kol"&&n.activeTab!=="terminal"||n.kolWallet)){if(n.kolLoading){Gn();return}try{await rs(n.kolMode,"",{silent:!0})}catch(c){T(c.message)}finally{Gn()}}},s))}function ns(){const e=()=>{Na&&clearTimeout(Na),Na=null,_r=""};if(Yn()||document.hidden||n.activeTab!=="watchlist"&&n.activeTab!=="terminal"||!n.user||!n.token){e();return}const t=`${n.activeTab}:${n.user?.id||"guest"}`;Na&&_r===t||(e(),_r=t,Na=setTimeout(async()=>{if(Na=null,_r="",document.hidden){ns();return}if(!(n.activeTab!=="watchlist"&&n.activeTab!=="terminal"))try{await ed({silent:!0})}catch(a){T(a.message)}finally{ns()}},3e4))}async function Xn(e=n.scanMode,t={}){const a=L(),r=!!t.silent;n.scanMode=e,r||(n.loading=!0,h());try{const s=await k(`/api/web/sniper/scan?mode=${encodeURIComponent(e)}`);n.scan=s.scan}finally{K("scanner-refresh",a,{component:"sniper",resultCount:Array.isArray(n.scan?.candidates)?n.scan.candidates.length:0,details:e}),r||(n.loading=!1),h()}}async function rs(e=n.kolMode,t=n.kolWallet,a={}){const r=L(),s=!!a.silent;n.kolMode=e,n.kolWallet=String(t||"").trim();let o="";n.kolWallet&&!Ut(n.kolWallet)&&(n.kolWallet="",o="Skipped invalid KOL wallet. Paste a verified Solana public wallet to scan positions."),!s&&!n.kolScan&&(n.loading=!0),n.kolLoading=!0,n.kolStatus=o||(n.kolWallet?"Scanning custom KOL wallet...":`Loading ${lr(n.kolMode)}...`),T(""),s||h();try{const c=new URLSearchParams({mode:e});n.kolWallet&&c.set("wallet",n.kolWallet);const l=await k(`/api/web/kol/scan?${c.toString()}`);n.kolScan=l.scan,n.kolLastUpdatedAt=new Date().toISOString(),n.kolStatus=l.scan?.message||`${lr(n.kolMode)} loaded.`,n.kolDumpStatsLoadedAt=0}catch(c){throw n.kolStatus=c.message||"KOL scan failed.",c}finally{K("kol-refresh",r,{component:"kol",resultCount:Array.isArray(n.kolScan?.rows)?n.kolScan.rows.length:Array.isArray(n.kolScan?.signals)?n.kolScan.signals.length:0,errorCode:n.kolStatus&&/failed/i.test(n.kolStatus)?"KOL_REFRESH_FAILED":"",details:n.kolWallet?"wallet":e}),s||(n.loading=!1),n.kolLoading=!1,h()}}async function ed(e={}){if(!n.user||!n.token)return;const t=L(),a=!!e.silent;n.watchlistLoading=!0,a||h();try{const r=await k("/api/web/watchlist");n.watchlist=r.watchlist||{rows:[],count:0}}finally{K("watchlist-refresh",t,{component:"watchlist",resultCount:n.watchlist?.count||n.watchlist?.rows?.length||0}),n.watchlistLoading=!1,h()}}function Sh(){return n.balances.reduce((e,t)=>e+Number(t.sol||0),0)}function kh(){const e=Number(n.connectedWalletBalance?.sol);return Number.isFinite(e)&&e>0?e:0}function Nt(){return Sh()+kh()}const $h=[{symbol:"SOL",name:"Solana",mint:"SOL",kind:"native"},{symbol:"USDC",name:"USD Coin",mint:"EPjFWdd5AufqSSqeM2qer6k8zQfM3qNw6ddnCGWRPpC",kind:"popular"},{symbol:"USDT",name:"Tether USD",mint:"Es9vMFrzaCERmJfrF4H2FYD4KCoE5gXn4wYwG9ksz4T8Js3",kind:"popular"},{symbol:"JUP",name:"Jupiter",mint:"JUPyiwrYJFskUPiHa7hkeR8VUtAeFoSYbKedZNsDvCN",kind:"popular"},{symbol:"RAY",name:"Raydium",mint:"4k3Dyjzvzp8eCTuFJYgmGnN95VhWPuTsf1KfzYEU7K1k",kind:"popular"},{symbol:"BONK",name:"Bonk",mint:"DezXAZ8z7PnrnRJjz3uq8NgV8Q9ddCzB9Ckr7JpPvvR",kind:"popular"},{symbol:"WIF",name:"dogwifhat",mint:"EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLQBkRzUPzWf",kind:"popular"}];function We(e=""){const t=String(e||"").trim();return!t||t.toLowerCase()==="custom"?"":t.toUpperCase()==="SOL"?"SOL":t}function Th(){const e=new Map,t=(a={})=>{const r=We(a.mint||a.tokenMint||"");if(!r||e.has(r))return;const s=a.balance??a.uiAmount??a.amount??a.uiBalance??"";e.set(r,{mint:r,symbol:String(a.symbol||a.shortMint||(r==="SOL"?"SOL":w(r))||"").trim(),name:String(a.name||a.label||"").trim(),balance:s,kind:"wallet"})};return t({mint:"SOL",symbol:"SOL",name:"Solana",balance:`${Nt().toFixed(4)} SOL`}),lt().forEach(a=>t({mint:a.tokenMint||a.mint,symbol:a.symbol||a.shortMint,name:a.name||"",balance:a.uiAmount||a.amountToken||"",kind:"wallet"})),(n.balances||[]).forEach(a=>{(a.tokens||[]).forEach(r=>t({mint:r.tokenMint||r.mint,symbol:r.symbol||r.shortMint,name:r.name||"",balance:r.uiAmount||r.amount||r.balance||"",kind:"wallet"}))}),[...e.values()]}function bi(e={}){const t=new Map,a=(s={})=>{const o=We(s.mint||s.tokenMint||"");!o||t.has(o)||t.set(o,{mint:o,symbol:String(s.symbol||s.shortMint||(o==="SOL"?"SOL":w(o))||"").trim(),name:String(s.name||s.label||"").trim(),balance:s.balance??s.uiAmount??s.amount??"",kind:s.kind||s.source||"held"})};return Th().forEach(a),e.walletOnly||$h.forEach(s=>{s.mint!=="SOL"&&a(s)}),[...t.values()]}function td(e=""){const t=We(e);return bi().find(a=>a.mint===t)||null}function ad(e="",t={}){const a=We(e),r=t.includeCustom!==!1,s=bi({walletOnly:!!t.walletOnly}),o=s.some(d=>d.mint===a);return`${s.map(d=>{const u=d.mint==="SOL"?`SOL${d.balance?` - ${d.balance}`:""}`:`${d.symbol||w(d.mint)}${d.kind==="wallet"?` - ${d.balance?`${d.balance} `:""}in wallet`:d.name?` - ${d.name}`:""}`;return`<option value="${i(d.mint)}" ${a===d.mint?"selected":""}>${i(u)}</option>`}).join("")}${r?`<option value="custom" ${r&&(!a||!o)?"selected":""}>Custom CA</option>`:""}`}function yi(){const e=We(n.tradeSwapFrom||"SOL")||"SOL";return bi({walletOnly:!0}).some(t=>t.mint===e)?e:"SOL"}function nd(){const e=yi(),t=We(n.tradeSwapTo||""),a=We(n.tradeToken||"");return t&&t!==e?t:a&&a!==e||e==="SOL"?a:"SOL"}function Ah(){const e=yi(),t=nd();return e!=="SOL"&&t&&t!=="SOL"&&e!==t?"two-step":t&&t!=="SOL"||We(n.tradeToken||"")?n.swapDirection==="sell"?"sell":"buy":"select"}function Ph(e="buy"){const t=We(m("[data-swap-from]")?.value||n.tradeSwapFrom||""),a=We(m("[data-swap-to]")?.value||n.tradeSwapTo||""),r=String(m("[data-trade-token]")?.value||n.tradeToken||"").trim();return e==="sell"&&t&&t!=="SOL"?t:a&&a!=="SOL"?a:r}function rd(){return(n.connectedWalletBalance||n.user?.connectedWallet||null)?.publicKey?(n.connectedWalletBalance?.tokens||[]).filter(t=>t?.mint||t?.tokenMint).map(t=>{const a=String(t.mint||t.tokenMint||"").trim();return{tokenMint:a,shortMint:t.shortMint||w(a),symbol:t.symbol||t.shortMint||w(a),name:t.name||"",imageUrl:t.imageUrl||t.imageUri||"",imageUri:t.imageUri||t.imageUrl||"",dexUrl:t.dexUrl||Q(a),pumpUrl:eh(a),uiAmount:t.uiAmount??"held",walletCount:1,buys:0,sells:0,spentSol:"0",receivedSol:"0",realizedSol:"+0",estimatedValueSol:null,openPnlSol:null,openPnlPercent:null,valuePending:!1,valueError:"",viewOnly:!0,source:"connected-wallet"}}):[]}function lt(){const e=new Set,t=[];for(const a of[...n.positions||[],...rd()]){const r=String(a?.tokenMint||a?.mint||"").trim();!r||e.has(r)||(e.add(r),t.push(a))}return t}function vi(){const e=n.connectedWalletBalance?.publicKey||n.user?.connectedWallet?.publicKey||"";return n.wallets.length+(e?1:0)}function wi(){return n.pnl?.totals?.realizedSol||"+0 SOL"}function nn(e){const t=Date.parse(e||"");return Number.isFinite(t)?Math.max(0,Math.floor((Date.now()-t)/1e3)):null}function Jn(e){return Number.isFinite(e)?e<5?"just now":e<60?`${e}s ago`:e<3600?`${Math.floor(e/60)}m ago`:`${Math.floor(e/3600)}h ago`:"never"}function ss(){if(n.walletRefreshing||n.walletRefreshStatus==="refreshing")return"Syncing";if(n.walletRefreshStatus==="timeout")return"Delayed";if(n.walletRefreshError||n.walletRefreshStatus==="error")return"Retry";const e=nn(n.lastWalletRefreshAt);return e===null?"Idle":e>45?"Stale":"Synced"}function Ch(){const e=le("trade",n.selectedTradePresetId),t=le("bundle",n.selectedBundlePresetId),a=e?`${e.name||"Trade"} ${e.amountSol||""} SOL`.trim():"Manual",r=t?t.name||"Bundle":"No bundle";return`Preset ${a} | ${r}`}async function sd(){if(!n.user||!n.token)return;const e=L();try{const[t,a]=await Promise.allSettled([k("/api/web/pnl?force=true",{dedupe:!1}),k("/api/web/trade/plans")]);t.status==="fulfilled"&&(n.pnl=t.value.pnl||n.pnl||null),a.status==="fulfilled"&&(n.tradePlans=a.value.plans||n.tradePlans||[],Cs()),K("post-trade-supplemental-refresh",e,{component:"post-trade",resultCount:(n.tradePlans?.length||0)+(n.pnl?1:0),details:"pnl,trade-plans"})}catch(t){K("post-trade-supplemental-refresh",e,{component:"post-trade",errorCode:t?.code||t?.name||"POST_TRADE_SUPPLEMENTAL_FAILED",details:N(t?.message||"Post-trade supplemental refresh failed.")})}}function Lh(e=350,t={}){Dr&&window.clearTimeout(Dr),Dr=window.setTimeout(async()=>{if(Dr=null,!(!n.user||!n.token))try{t.reason==="post-trade"?await Promise.all([sd(),St({force:!0,fast:!1,silent:!0,syncPnl:!0,reason:"post-trade-background-values"})]):await Promise.all([ca({force:!1,skipCore:!0,silent:!0}),St({force:!1,fast:!1,silent:!0,reason:"background-values"})])}catch(a){n.walletRefreshError=a.message||"Background refresh failed.",h()}},e)}async function He({force:e=!1,deep:t=!1,reason:a="manual"}={}){if(!n.user||!n.token)return n.walletRefreshing=!1,n.walletRefreshStatus="idle",n.walletRefreshError="Wallet not connected",Ee("[data-sync-health]","Wallet not connected"),je("error",{error:"Wallet not connected"}),h({preserveSmartChartFrame:n.activeTab==="smartChart"}),{ok:!1,data:null,error:"Wallet not connected",durationMs:0,fromCache:!1,degraded:!0};const r=String(a||"").toLowerCase(),s=r==="manual_header_click",o=r.includes("post-trade");if(e&&!t&&!o&&!s&&Date.now()-ic<Ym?(e=!1,W({component:"wallet",action:"wallet-refresh-force-throttled",durationMs:0,cacheHit:!0,details:r||"manual"})):e&&!t&&!o&&(ic=Date.now()),ta)return W({component:"wallet",action:"wallet-refresh-dedupe",durationMs:0,cacheHit:!0,details:e?"force-shared":"shared"}),n.positionRefreshAction?.state==="clicked"&&Xa("refreshing",{startedAt:n.positionRefreshAction.startedAt||L()}),ta.finally(()=>{if(["clicked","refreshing"].includes(n.positionRefreshAction?.state)){const d=n.walletRefreshStatus==="error"||n.walletRefreshStatus==="timeout";je(d?"error":"success",{error:d?N(n.walletRefreshError||"Refresh delayed"):""})}});const c=L(),l=++bf;return n.walletRefreshRequestId=l,ta=(async()=>{let d={ok:!1,data:null,error:"",durationMs:0,fromCache:!1,degraded:!1};n.positionRefreshAction?.state==="clicked"&&Xa("refreshing",{startedAt:n.positionRefreshAction.startedAt||c}),n.walletRefreshing=!0,n.walletRefreshStatus="refreshing",n.walletRefreshError="",Ee("[data-sync-health]",ss()),Ot("[data-refresh-spinner]",!1),de(),aa&&window.clearTimeout(aa),aa=window.setTimeout(()=>{aa=null,!(n.walletRefreshRequestId!==l||!n.walletRefreshing)&&(n.walletRefreshing=!1,n.walletRefreshStatus==="refreshing"&&(n.walletRefreshStatus="timeout"),ta=null,je("error",{error:"Refresh delayed; retrying..."}),h({preserveSmartChartFrame:n.activeTab==="smartChart"}))},Bo+6e3),await xe(20);try{if(await Promise.race([pi({force:e,deep:t,preserveSmartChartFrame:n.activeTab==="smartChart",requestId:l,timeoutMs:Bo}),new Promise((u,p)=>window.setTimeout(()=>p(Object.assign(new Error("Wallet refresh timed out."),{code:"TIMEOUT"})),Bo))]),n.walletRefreshRequestId!==l)return d={ok:!1,data:null,error:"Stale wallet refresh ignored.",durationMs:L()-c,fromCache:!1,degraded:!0},d;n.walletRefreshRequestId===l&&(n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshStatus="success"),t?await ca({force:e,skipCore:!0,silent:!0}):((s||o)&&St({force:!0,fast:!1,silent:!0,followUpValues:!1,syncPnl:!0,reason:`${a}-positions-values`,timeoutMs:Qt}).then(u=>{u?h({preserveSmartChartFrame:n.activeTab==="smartChart"}):Yr(`${a}-positions-values-failed`)}).catch(()=>Yr(`${a}-positions-values-failed`)),Lh(o?200:350,{reason:a})),K("wallet-refresh-total",c,{component:"wallet",resultCount:(n.balances?.length||0)+(n.positions?.length||0),details:t?"deep":`core-plus-background:${a}`}),je("success",{error:""}),d={ok:!0,data:{balances:n.balances,positions:n.positions,pnl:n.pnl},error:"",durationMs:L()-c,fromCache:!1,degraded:!1}}catch(u){const p=u?.code==="TIMEOUT"||/timed out|timeout|blocked or could not open/i.test(String(u?.message||""));n.walletRefreshRequestId===l&&(n.walletRefreshStatus=p?"timeout":"error",n.walletRefreshError=u.message||"Refresh failed."),p&&!r.includes("auto-retry")&&n.user&&n.token&&window.setTimeout(()=>{n.user&&n.token&&n.walletRefreshStatus!=="success"&&He({force:!1,deep:!1,reason:"auto-retry-timeout"}).catch(()=>{})},4e3),K("wallet-refresh-total",c,{component:"wallet",errorCode:u?.code||u?.name||"WALLET_REFRESH_FAILED",details:N(n.walletRefreshError)}),je("error",{error:N(n.walletRefreshError)}),T(n.walletRefreshError),d={ok:!1,data:{balances:n.balances,positions:n.positions,pnl:n.pnl},error:N(n.walletRefreshError),durationMs:L()-c,fromCache:!1,degraded:!0}}finally{aa&&(window.clearTimeout(aa),aa=null),n.walletRefreshRequestId===l&&(n.walletRefreshing=!1),ta=null,h({preserveSmartChartFrame:n.activeTab==="smartChart"})}return d})(),ta}async function kt({force:e=!0,reason:t="manual_header_click",deep:a=!1}={}){return He({force:e,reason:t,deep:a})}function Yn(){return!!n.postTradeRefresh?.active&&Number(n.postTradeRefresh?.activeUntil||0)>Date.now()}async function m0(e="",t="legacy-post-trade"){V(e,t)}function V(e="",t="post-trade",a={}){e&&(n.lastTradeSignature=e),It.length&&(It.forEach(o=>window.clearTimeout(o)),It=[]);const r=a.tradeAttemptId||wt("post-trade"),s=Array.isArray(a.affectedKeys)&&a.affectedKeys.length?a.affectedKeys.slice(0,12).map(o=>ke(o,48)):rf;n.postTradeRefresh={active:!0,attemptId:r,action:ke(t,70),signaturePresent:!!e,invalidatedKeys:s,refreshedKeys:[],requestCount:0,errors:[],startedAt:new Date().toISOString(),activeUntil:Date.now()+12e3},W({component:"post-trade",action:"post-trade-invalidation-start",durationMs:0,requestId:r,resultCount:s.length,details:s.join(",")}),Zm.forEach(o=>{const c=window.setTimeout(()=>{It=It.filter(p=>p!==c);const l=Number(n.postTradeRefresh?.requestCount||0)+1;n.postTradeRefresh={...n.postTradeRefresh||{},requestCount:l},W({component:"post-trade",action:"post-trade-refresh-start",durationMs:0,requestId:r,resultCount:n.postTradeRefresh.requestCount,details:t});const d=L();(l<=1?He({force:!0,deep:!1,reason:"post-trade"}):Promise.all([St({force:!0,fast:!1,silent:!0,followUpValues:!1,syncPnl:!0,reason:"post-trade-values",timeoutMs:Qt}),sd()])).catch(p=>{n.walletRefreshError=p.message||"Post-trade refresh failed.",n.postTradeRefresh={...n.postTradeRefresh||{},errors:[...n.postTradeRefresh?.errors||[],N(p.message||"Post-trade refresh failed.")].slice(-5)},W({component:"post-trade",action:"position-refresh-post-trade-error",durationMs:L()-d,requestId:r,errorCode:p?.code||p?.name||"POST_TRADE_REFRESH_FAILED",details:t}),h()}).finally(()=>{n.postTradeRefresh={...n.postTradeRefresh||{},refreshedKeys:[...new Set([...n.postTradeRefresh?.refreshedKeys||[],"wallet-summary","positions","pnl"])],active:It.length>0,activeUntil:It.length>0?Date.now()+8e3:Date.now()},W({component:"post-trade",action:"post-trade-refresh-end",durationMs:L()-d,requestId:r,resultCount:(n.balances?.length||0)+(n.positions?.length||0),details:n.postTradeRefresh.refreshedKeys.join(",")}),h({preserveSmartChartFrame:n.activeTab==="smartChart"})})},o);It.push(c)}),de()}function Me({title:e="Confirm",lines:t=[],confirmLabel:a="Confirm",cancelLabel:r="Cancel",danger:s=!1,input:o=null}={}){if(!document?.body){const c=[].concat(t).filter(Boolean).join(`
`);return o?Promise.resolve(window.prompt(c||e,o.value||"")):Promise.resolve(window.confirm(c||e))}return new Promise(c=>{const l=document.createElement("div");l.className="slime-confirm-overlay",l.innerHTML=`
    ...
    `;const d=document.activeElement,u=l.querySelector(".slime-confirm-input"),p=v=>{l.remove(),document.removeEventListener("keydown",b,!0);try{d?.focus?.({preventScroll:!0})}catch{}c(v)},f=()=>p(o?u?.value??"":!0),y=()=>p(o?null:!1),b=v=>{v.key==="Escape"?(v.preventDefault(),y()):v.key==="Enter"&&(!o||v.target===u)&&(v.preventDefault(),f())};l.addEventListener("pointerdown",v=>{v.target===l&&y()}),l.querySelector(".slime-confirm-accept").addEventListener("click",f),l.querySelector(".slime-confirm-cancel").addEventListener("click",y),document.addEventListener("keydown",b,!0),document.body.appendChild(l),(u||l.querySelector(".slime-confirm-accept"))?.focus({preventScroll:!0}),u&&u.select()})}function Si(){if(document.hidden&&n.route==="terminal")return!0;const e=document.activeElement;if(!e||n.route!=="terminal")return!1;const t=String(e.tagName||"").toLowerCase();return e.isContentEditable||["input","textarea","select"].includes(t)?!!e.closest(".fast-preset-builder, .preset-toolbar, .terminal-quick-buy-bar, .command-controls, .live-control-strip, .terminal-preset-strip, .preset-card, .order-ticket, .order-ticket-stack, .terminal-dock, .trade-side, .volume-grid, .sniper-setup, .wallet-exit-grid, .pump-launch-form, .launch-coin-form, .profile-grid, .preset-manager, .trade-panel, .terminal-side-panel, [data-preserve-focus]"):!1}function od(){n.pendingRender=!0}function id(){!n.pendingRender||Si()||(n.pendingRender=!1,h({force:!0}))}function ki(e,t){e&&(e.hidden=t,e.dataset.routeViewHidden=t?"true":"false",e.setAttribute("aria-hidden",t?"true":"false"))}function rn(){if(!ce||!Fn||!re)return;const e=!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey||n.wallets.length);ce.dataset.loading=n.loading?"true":"false",ce.dataset.route=n.route,ce.dataset.walletConnected=e?"true":"false",e&&ck("shell-wallet-context"),e?kd("shell-wallet-context"):El(),e||(n.tpslAutoEnableInFlight=!1,n.tpslAutoEnableScheduledAt=0),ki(Fn,!["intro","login"].includes(n.route)),ki(dc,n.route!=="connect"),ki(re,n.route!=="terminal"),Ot("[data-terminal-global-search]",n.route!=="terminal"),Ot("[data-top-sync-strip]",n.route!=="terminal")}function Qn(){const e=!!(Ce&&n.loginModalOpen),t=!!n.quickBuyModal?.open;document.body.classList.toggle("login-modal-open",e),document.body.classList.toggle("quick-buy-modal-open",t),!e&&!t&&(document.body.style.overflow="",document.documentElement.style.overflow="");const a=m("[data-wallet-connect-modal]");a&&(a.style.pointerEvents=a.hidden?"none":"");const r=m("[data-quick-buy-modal-root]");r&&(r.style.pointerEvents=r.hidden?"none":"")}function $i(e,t=48){if(!e||document.hidden)return!1;try{const a=e.getBoundingClientRect();return a.width<24||a.height<t}catch{return!1}}function ld(e="resume"){if(!ce||document.hidden)return;rn(),Qn();const t=`${Date.now()}:${e}`,a=ce.style.transform;ce.dataset.resumePaint=t,ce.style.transform=a?`${a} translateZ(0)`:"translateZ(0)",ce.offsetHeight,window.requestAnimationFrame(()=>{!ce||ce.dataset.resumePaint!==t||(ce.style.transform=a,delete ce.dataset.resumePaint)})}function xh(){if(!ce)return!1;if(ce.dataset.route!==n.route)return!0;const e=document.body.classList.contains("login-modal-open")&&(!Ce||Ce.hidden||!n.loginModalOpen),t=document.body.classList.contains("quick-buy-modal-open")&&!n.quickBuyModal?.open;if(e||t||$i(ce,80))return!0;if(n.route!=="terminal")return!1;const a=m("[data-panel]");return re?.hidden||$i(re,80)||a&&$i(a,32)||a&&!a.children.length&&!String(a.textContent||"").trim()?!0:![Fn,dc,re].some(s=>s&&!s.hidden)}function Mh(e="watchdog"){const t=n.positionRefreshAction||{},a=t.startedAt?Math.max(0,L()-Number(t.startedAt||0)):0;(t.state==="clicked"||t.state==="refreshing")&&a>nf&&(je("error",{error:"Refresh delayed"}),W({component:"positions",action:"stale-position-refresh-lock-cleared",durationMs:a,details:e})),n.walletRefreshing&&!ta&&(n.walletRefreshing=!1,n.walletRefreshStatus=n.walletRefreshStatus==="refreshing"?"timeout":n.walletRefreshStatus,Ot("[data-refresh-spinner]",!0)),Qn(),de()}function cd(e="watchdog",t={}){return Mh(e),xh()?(W({component:"app-shell",action:"recover-blank-shell",durationMs:Math.max(0,Date.now()-lc),details:`${e}:${n.route}:${n.activeTab||""}`}),ti({keepLogin:n.route==="login"}),rn(),ld(e),h({force:!0,preserveSmartChartFrame:n.activeTab==="smartChart"}),!0):(t.forcePaint&&ld(e),!1)}function dd(){return!!(navigator.mediaDevices?.getDisplayMedia&&window.MediaRecorder)}function ud(){try{return document.createElement("canvas")}catch{return null}}function pd(){const e=ud();return!!(e&&(typeof e.toBlob=="function"||(e.captureStream||e.mozCaptureStream)&&window.MediaRecorder))}function Bh(){return dd()||pd()}function Ti(){const e=Ge()?"This mobile browser blocked both screen recording and SlimeWire clip fallback. Use your phone screen recorder, then share the saved clip.":"This browser cannot start screen recording. Use desktop Chrome/Edge or your device recorder.";Dt(e),typeof window.alert=="function"&&window.alert(e)}function md(){return["video/mp4;codecs=avc1.42E01E,mp4a.40.2","video/mp4;codecs=h264,aac","video/mp4","video/webm;codecs=vp9,opus","video/webm;codecs=vp8,opus","video/webm"].find(t=>{try{return MediaRecorder.isTypeSupported(t)}catch{return!1}})||""}function Zn(e=""){return/^image\/png/i.test(String(e||""))?"png":/^video\/mp4/i.test(String(e||""))?"mp4":"webm"}function fd(){const e=n.clipFarm?.fileExtension||Zn(n.clipFarm?.mimeType||n.clipFarm?.blob?.type||"");return`slimewire-clip-${Date.now()}.${e}`}function er(){try{n.clipFarm?.stream?.getTracks?.().forEach(e=>e.stop())}catch{}n.clipFarm?.fallbackFrameTimer&&clearInterval(n.clipFarm.fallbackFrameTimer),n.clipFarm?.fallbackStopTimer&&clearTimeout(n.clipFarm.fallbackStopTimer)}function Dt(e=""){n.clipFarm={...n.clipFarm,status:String(e||"")},Je()}function Ai(){if(n.clipFarm?.videoUrl)try{URL.revokeObjectURL(n.clipFarm.videoUrl)}catch{}n.clipFarm={...n.clipFarm,blob:null,videoUrl:"",mimeType:"",fileExtension:"",status:n.clipFarm?.recording?"Recording...":""},Je()}function Je(){const e=document.querySelector("[data-clip-farm]");if(!e)return;const t=n.clipFarm||{},a=Bh(),r=!!t.recording,s=!!(t.blob&&t.videoUrl),o=t.status||(r?"Recording":s?"Clip ready":"Clip farm");e.innerHTML=`
  ...
  `}function hd(){const e=we([...qe()?.rows||[],...typeof br=="function"?br():[],...n.slimeScopeRows||[],...n.livePairRows||[],...Object.values(n.livePairsByBucket||{}).flatMap(t=>t?.rows||[])]).filter(t=>t?.tokenMint).slice(0,4);return e.length?e:[{tokenMint:n.smartChartToken||n.tradeToken||"",symbol:"SlimeWire",name:"Live Terminal",marketCapLabel:"checking",liquidityLabel:"checking",volumeH1Label:"live"}]}function gd(e,t={}){const a=e?.getContext?.("2d");if(!a)return;const r=Math.max(1,Math.min(3,window.devicePixelRatio||1)),s=720,o=1280;(e.width!==s*r||e.height!==o*r)&&(e.width=s*r,e.height=o*r,e.style.width=`${s}px`,e.style.height=`${o}px`),a.setTransform(r,0,0,r,0,0);const c=Math.max(0,Math.min(1,Number(t.progress||0))),l=t.rows||hd(),d=new Date;a.fillStyle="#020803",a.fillRect(0,0,s,o);const u=a.createRadialGradient(s*.2,o*.12,20,s*.2,o*.12,460);u.addColorStop(0,"rgba(118,255,45,0.35)"),u.addColorStop(1,"rgba(118,255,45,0)"),a.fillStyle=u,a.fillRect(0,0,s,o),a.strokeStyle="rgba(118,255,45,0.38)",a.lineWidth=2,a.strokeRect(24,24,s-48,o-48),a.fillStyle="#baff4d",a.font="900 34px Arial, sans-serif",a.fillText("SlimeWire REC",48,88),a.fillStyle="#f4fff0",a.font="800 54px Arial, sans-serif",a.fillText("Fresh Live Picks",48,154),a.fillStyle="rgba(226,255,215,0.78)",a.font="700 22px Arial, sans-serif",a.fillText(`Mobile in-site clip - ${d.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}`,48,196);const p=s-96;a.fillStyle="rgba(118,255,45,0.12)",a.fillRect(48,226,p,12),a.fillStyle="#78ff2d",a.fillRect(48,226,Math.max(24,p*c),12),l.forEach((f,y)=>{const b=292+y*188,v=String(f.symbol||f.baseSymbol||w(f.tokenMint||"")||"Token").slice(0,18),P=String(f.name||f.category||"fresh pair").slice(0,34),A=_(f.marketCapLabel,f.fdvLabel,M(ft(f)),"checking"),g=_(f.liquidityLabel,M(ht(f)),"checking"),$=_(f.volumeH1Label,f.volumeLabel,M(f.volumeH1),"checking"),C=String(f.pairAgeLabel||zt(f)||"live").slice(0,18);a.fillStyle="rgba(4,24,8,0.92)",a.strokeStyle="rgba(118,255,45,0.34)",a.lineWidth=2,a.beginPath(),typeof a.roundRect=="function"?a.roundRect(48,b,s-96,156,18):a.rect(48,b,s-96,156),a.fill(),a.stroke(),a.fillStyle="#f4fff0",a.font="900 32px Arial, sans-serif",a.fillText(v,76,b+48),a.fillStyle="rgba(226,255,215,0.72)",a.font="700 18px Arial, sans-serif",a.fillText(P,76,b+78),[["MC",A],["LIQ",g],["VOL",$],["AGE",C]].forEach(([B,U],H)=>{const Se=76+H*140;a.fillStyle="#aaff8f",a.font="800 15px Arial, sans-serif",a.fillText(B,Se,b+114),a.fillStyle="#ffffff",a.font="900 23px Arial, sans-serif",a.fillText(String(U).slice(0,10),Se,b+142)})}),a.fillStyle="rgba(226,255,215,0.72)",a.font="700 20px Arial, sans-serif",a.fillText("Generated by SlimeWire Clip Farm when mobile screen capture is blocked.",48,o-78),a.fillStyle="#78ff2d",a.font="900 24px Arial, sans-serif",a.fillText("slimewire.org",48,o-44)}async function Rh(e){gd(e,{progress:1});const t=await new Promise(r=>{try{e.toBlob(s=>r(s),"image/png",.92)}catch{r(null)}});if(!t){Ti();return}const a=URL.createObjectURL(t);n.clipFarm={...n.clipFarm,recording:!1,recorder:null,stream:null,chunks:[],fallbackFrameTimer:null,fallbackStopTimer:null,blob:t,videoUrl:a,mimeType:"image/png",fileExtension:"png",status:"Mobile clip ready (.png)."},Je()}async function Ih(){const e=ud();if(!e){Ti();return}const t=e.captureStream||e.mozCaptureStream;if(!t||!window.MediaRecorder){await Rh(e);return}Ai();const a=hd(),r=Date.now(),s=t.call(e,12),o=md(),c=[],l=new MediaRecorder(s,o?{mimeType:o}:void 0),d=()=>gd(e,{rows:a,progress:(Date.now()-r)/4200});d();const u=setInterval(d,1e3/12);l.addEventListener("dataavailable",f=>{f.data?.size>0&&c.push(f.data)}),l.addEventListener("stop",()=>{er();const f=o||"video/webm",y=new Blob(c,{type:f}),b=y.size>0?URL.createObjectURL(y):"",v=Zn(y.type||f);n.clipFarm={...n.clipFarm,recording:!1,recorder:null,stream:null,chunks:[],fallbackFrameTimer:null,fallbackStopTimer:null,blob:y.size>0?y:null,videoUrl:b,mimeType:y.type||f,fileExtension:v,status:y.size>0?`Mobile clip ready (.${v}).`:"No mobile clip captured."},Je()},{once:!0}),l.start(500);const p=setTimeout(()=>{n.clipFarm?.recording&&tr()},4300);n.clipFarm={recording:!0,status:"Recording mobile clip...",blob:null,videoUrl:"",mimeType:o,fileExtension:Zn(o),recorder:l,stream:s,chunks:c,fallbackFrameTimer:u,fallbackStopTimer:p},Je()}async function bd(){if(!dd()){if(pd()){await Ih();return}Ti();return}if(n.clipFarm?.recording){tr();return}Ai();try{const e=await navigator.mediaDevices.getDisplayMedia({video:{frameRate:{ideal:30,max:30},width:{ideal:1280},height:{ideal:720}},audio:!0}),t=md(),a=[],r=new MediaRecorder(e,t?{mimeType:t}:void 0);r.addEventListener("dataavailable",s=>{s.data?.size>0&&a.push(s.data)}),r.addEventListener("stop",()=>{er();const s=t||"video/webm",o=new Blob(a,{type:s}),c=o.size>0?URL.createObjectURL(o):"",l=Zn(o.type||s);n.clipFarm={...n.clipFarm,recording:!1,recorder:null,stream:null,chunks:[],blob:o.size>0?o:null,videoUrl:c,mimeType:o.type||s,fileExtension:l,status:o.size>0?`Clip ready (.${l}).`:"No clip captured."},Je()},{once:!0}),e.getVideoTracks?.()[0]?.addEventListener?.("ended",()=>tr(),{once:!0}),r.start(1e3),n.clipFarm={recording:!0,status:"Recording...",blob:null,videoUrl:"",mimeType:t,fileExtension:Zn(t),recorder:r,stream:e,chunks:a},Je()}catch(e){er(),n.clipFarm={...n.clipFarm,recording:!1,recorder:null,stream:null,chunks:[],status:e?.name==="NotAllowedError"?"Recording cancelled.":"Recording could not start."},Je()}}function tr(){const e=n.clipFarm?.recorder;if(!e){er(),n.clipFarm={...n.clipFarm,recording:!1,stream:null,recorder:null,chunks:[],fallbackFrameTimer:null,fallbackStopTimer:null},Je();return}try{if(e.state!=="inactive"){Dt("Saving clip..."),e.stop();return}}catch{}er(),n.clipFarm={...n.clipFarm,recording:!1,stream:null,recorder:null,chunks:[],fallbackFrameTimer:null,fallbackStopTimer:null},Je()}async function Oh(){const e=n.clipFarm?.blob;if(!e){Dt("Record a clip first.");return}const t=new File([e],fd(),{type:e.type||n.clipFarm?.mimeType||"video/webm"});try{if(navigator.canShare?.({files:[t]})&&navigator.share){await navigator.share({title:"SlimeWire clip",text:"SlimeWire clip farm",files:[t]}),Dt("Shared.");return}}catch(a){if(a?.name==="AbortError"){Dt("Share cancelled.");return}}Dt("Use Save, then attach the clip to X or Telegram.")}function Eh(){const e=n.clipFarm?.videoUrl;if(!e){Dt("Record a clip first.");return}const t=document.createElement("a");t.href=e,t.download=fd(),document.body.appendChild(t),t.click(),t.remove(),Dt("Saved.")}function Fh(e=null,t="chartTxns"){const a=e||Vs(),r=String(a?.tokenMint||n.smartChartToken||"").trim();return r?{mint:r,mode:t,src:dp(a,t)}:null}function Wh(e={}){if(e.refreshSmartChartFrame||n.route!=="terminal"||n.activeTab!=="smartChart")return null;const t=document.querySelector("[data-panel] .smart-chart-frame[data-chart-mint][data-chart-mode]"),a=t?.querySelector("iframe");if(!t||!a)return null;const r=String(t.dataset.chartMode||"chartTxns"),s=Fh(null,r);if(!s||t.dataset.chartMint!==s.mint||t.dataset.chartMode!==s.mode)return null;const o=String(t.dataset.chartSrc||a.getAttribute("src")||""),c=t.dataset.loaded==="true",l=o!==s.src;return t.dataset.preserving="true",{frame:t,mint:s.mint,mode:s.mode,src:l?o:s.src,loaded:c,keepByMint:l}}function _h(e=null){if(!e?.frame||!e.frame.querySelector?.("iframe"))return!1;const t=String(e.mint||"").replace(/["\\]/g,"\\$&"),a=String(e.mode||"").replace(/["\\]/g,"\\$&"),r=document.querySelector(`[data-panel] .smart-chart-frame[data-chart-mint="${t}"][data-chart-mode="${a}"]`),s=r?.dataset?.chartSrc||r?.querySelector?.("iframe")?.getAttribute("src")||"";return!r||r===e.frame||s!==e.src&&!e.keepByMint?(e.frame.removeAttribute("data-preserving"),!1):(e.frame.removeAttribute("data-preserving"),e.loaded&&(e.frame.dataset.loaded="true"),r.replaceWith(e.frame),!0)}function h(e={}){if(!ce||!Fn||!re)return;if(rn(),!e.force&&Si()){od();return}const t=L(),a=`${n.route}:${n.activeTab||"none"}`;try{n.perfRenderCounts={...n.perfRenderCounts||{},[a]:(n.perfRenderCounts?.[a]||0)+1},n.pendingRender=!1;const r=!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey||n.wallets.length);rn(),ce.dataset.activeTab=n.activeTab||"";const o=!!((e.preserveSmartChartFrame||n.activeTab==="smartChart")&&n.route==="terminal"&&n.activeTab==="smartChart"&&document.querySelector("[data-panel] .smart-chart-frame iframe"))?Wh(e):null,c=!!Ce,l=!!(c&&n.loginModalOpen);Jo&&(Jo.hidden=c||!!n.user||n.loginCollapsed),Ot("[data-connect-login-panel]",c||!!n.user||n.loginCollapsed),Ce?(Ce.hidden=!l,Ce.setAttribute("aria-hidden",l?"false":"true"),Ce.toggleAttribute("inert",!l),document.body.classList.toggle("login-modal-open",l),document.querySelectorAll("[data-login-tab]").forEach(v=>{const P=v.dataset.loginTab===n.loginModalTab;v.dataset.active=P?"true":"false",v.setAttribute("aria-selected",P?"true":"false")}),Ot("[data-login-modal-login-section]",n.loginModalTab!=="login"),Ot("[data-login-modal-create-section]",n.loginModalTab!=="create")):document.body.classList.remove("login-modal-open"),uc&&(uc.hidden=!1),pc&&(pc.hidden=!!n.user),mc&&(mc.hidden=!n.user),rn(),Ee("[data-user-id]",n.user?.id||"guest"),Ee("[data-wallet-count]",vi()),Ee("[data-total-sol]",Nt().toFixed(4));const d=lt();Ee("[data-position-count]",d.length),Ee("[data-realized]",wi());try{const v=m("[data-realized]");if(v){const P=/-/.test(String(wi()||""));v.classList.toggle("metric-neg",P),v.classList.toggle("metric-pos",!P)}}catch{}Ee("[data-top-sol]",`${Nt().toFixed(4)} SOL`),Ee("[data-top-portfolio]",`${d.length} position${d.length===1?"":"s"}`),Ee("[data-sync-health]",r?ss():"Sync idle"),Ee("[data-active-preset-label]",Ch()),Ci(),Uh(),Ot("[data-refresh-spinner]",!n.walletRefreshing),document.querySelectorAll('[data-feature="ogre-tek"]').forEach(v=>{v.hidden=!Hm||!_m(Ae)});const u=m("[data-user-avatar]");u&&(u.innerHTML=sn("SW"));const p=m("[data-top-avatar]");p&&(p.innerHTML=sn("SW"));const f=n.user?.connectedWallet||null;Ee("[data-connected-wallet-summary]",f?`${f.provider||"Browser wallet"} connected: ${w(f.publicKey)}`:n.user?"No browser wallet connected.":"Browse scans now. Create or connect only when you are ready.");const y=m("[data-logout]");y&&(y.hidden=!n.user,y.disabled=!!n.logoutPending,S(y,n.logoutPending?"Logging out...":"Log Out")),n.route==="terminal"&&Jh(),_h(o),Sg(),$g(),sl(),Ta(),Aa(),Ps(),$r(),rt(),Sn(),Sl(),n.route==="terminal"&&n.user&&!n.returnSummaryFetched&&(n.returnSummaryFetched=!0,Uw()),Je(),E(),eS("render"),Qn(),de();const b=L()-t;(b>=16||n.perfRenderCounts[a]%20===0)&&W({component:"render",action:"render",durationMs:b,resultCount:n.perfRenderCounts[a],details:a}),lc=Date.now()}catch(r){rn(),Qn(),ri({component:"render-boundary",errorCode:r?.name||"RENDER_FAILED",message:r?.message||"Render failed",caughtByBoundary:!0});const s=m("[data-panel]");n.route==="terminal"&&s?(re.hidden=!1,s.innerHTML=`
      ...
      `),T("Display refresh failed. Your trade was not resubmitted. Tap Retry Refresh.")}}function yd(e=""){const t=String(e||"").trim();if(t)return t.toLowerCase();const a=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(a)return`connected:${String(a).toLowerCase()}`;const r=Array.isArray(n.wallets)&&n.wallets.length?n.wallets.map(s=>s.publicKey||s.address||s.label||"").filter(Boolean).join("|"):"";return r?`managed:${r.toLowerCase().slice(0,240)}`:"wallet-session"}function Nh(e=""){try{return sessionStorage.getItem(`tpslAutoRevoked:${yd(e)}`)==="yes"}catch{return!1}}function vd(e,t=""){try{const a=`tpslAutoRevoked:${yd(t)}`;e?sessionStorage.setItem(a,"yes"):sessionStorage.removeItem(a)}catch{}}function Pi(e=""){vd(!1,e)}function wd(){return!!(Array.isArray(n.wallets)&&n.wallets.length||n.user?.connectedWallet||n.connectedWalletBalance?.publicKey)}function Sd(){const e=n.user?.automationPermission||{},t=Date.parse(e.expiresAt||""),a=!!e.enabled&&Number.isFinite(t)&&t<=Date.now();return!!n.user?.automationPermissionActive&&!a&&!e.revokedAt}function Dh(){return!(!wd()||Nh()||Sd()||n.tpslAutoEnableInFlight)}function kd(e="wallet-session"){if(!Dh())return;const t=L();n.tpslAutoEnableScheduledAt&&t-n.tpslAutoEnableScheduledAt<2e3||(n.tpslAutoEnableScheduledAt=t,n.tpslAutoEnableInFlight=!0,setTimeout(()=>{Xi("enable",{auto:!0,reason:e}).catch(a=>{n.automationDelegationStatus=a?.message||"TP/SL auto-enable failed.",T(n.automationDelegationStatus)}).finally(()=>{n.tpslAutoEnableInFlight=!1,Ci()})},50))}function Ci(){const e=m("[data-tpsl-status-button]");if(!e)return;const t=m("[data-tpsl-status-label]"),a=n.user?.automationPermission||{},r=!!n.user?.automationPermissionActive,s=!!a.revokedAt,o=Date.parse(a.expiresAt||""),c=!!a.enabled&&Number.isFinite(o)&&o<=Date.now(),l=r?"enabled":s||c?"invalid":"disabled";e.dataset.tpslState=l;const d=l==="enabled"?"TP/SL Enabled":l==="invalid"?"Re-enable TP/SL":"Enable TP/SL";S(t,d),e.setAttribute("aria-label",`${d}. Stop loss and take profit require wallet auto-sell approval.`),e.title=l==="enabled"?`Server exits enabled${a.expiresAt?` until ${Te(a.expiresAt)}`:""}.`:"Stop loss and take profit require wallet auto-sell approval."}function Uh(){const e=n.user?.connectedWallet||n.connectedWalletBalance||null,t=String(e?.publicKey||"").trim(),a=Array.isArray(n.wallets)?n.wallets.length:0,r=!!(t||a),s=r?"Connected":"Connect",o=t?"Wallet: Connected":a?`Wallets: ${a}`:"Wallet: Connect",c=t?`${e.provider||"Browser wallet"} connected: ${w(t)}`:a?`${a} SlimeWire wallet${a===1?"":"s"} available.`:"Connect a browser wallet.";document.querySelectorAll("[data-top-wallet-connect]").forEach(l=>{l.dataset.walletState=r?"connected":"disconnected",l.title=c,l.setAttribute("aria-label",r?`${c} Open wallets.`:"Connect wallet");const d=l.querySelector("[data-top-wallet-connect-label]")||l;S(d,s)}),document.querySelectorAll("[data-top-wallet-status]").forEach(l=>{l.dataset.walletState=t?"browser-connected":r?"managed-connected":"disconnected",l.title=t?`${c} Click to disconnect.`:r?`${c} Click to open wallets.`:"Click to connect a wallet.",l.setAttribute("aria-label",t?`${c}. Disconnect wallet.`:r?`${c} Open wallets.`:"Wallet not connected. Connect wallet."),S(l,o)})}async function qh(){const e=n.user?.connectedWallet||n.connectedWalletBalance||null,t=String(e?.publicKey||"").trim(),a=Array.isArray(n.wallets)?n.wallets.length:0;if(t){await Me({title:"Disconnect Wallet",lines:[`Disconnect ${e.provider||"wallet"} ${w(t)}?`],confirmLabel:"Disconnect",danger:!0})&&await Mu();return}if(a>0){Pe("/terminal","wallets");return}ma({returnPath:"/terminal"})}function Hh(e=document){const t=()=>{const a=e.querySelector?.(".smart-chart-terminal")||document.querySelector(".smart-chart-terminal");if(!a)return;const r=Math.max(0,a.getBoundingClientRect().top+window.scrollY);window.scrollTo({top:r,behavior:"auto"})};requestAnimationFrame(()=>{t(),window.setTimeout(t,80),window.setTimeout(t,280),window.setTimeout(t,800)})}const $d=new Set(["terminal","live","slimeScope","kol","watchlist","liveTrades","sniper"]),Kh=[".signal-row[data-token-chart]",".terminal-token-row[data-token-chart]",".compact-signal-row[data-token-chart]","[data-token-chart][data-token-chart-source]"].join(",");function Vh(e=""){return String(e).replace(/\\/g,"\\\\").replace(/"/g,'\\"')}function ar(){return!!(window.matchMedia?.("(max-width: 760px)")?.matches||(window.innerWidth||0)<=760)}function Li(e=m("[data-panel]")){if(!e||n.route!=="terminal"||!$d.has(n.activeTab))return null;const t=e.dataset.renderedTab,a=document.scrollingElement||document.documentElement,r={tab:n.activeTab,windowY:window.scrollY||0,documentY:a?.scrollTop||0,panelScrollTop:e.scrollTop||0,dashboardScrollTop:re?.scrollTop||0,anchorKey:"",anchorTop:0},s=Array.from(e.querySelectorAll(Kh));if(t&&t!==n.activeTab&&!s.length||!s.length)return r;const o=s.find(l=>{const d=l.getBoundingClientRect(),u=ar()?42:72;return d.bottom>u&&d.top<Math.min(window.innerHeight||720,720)})||s[0],c=o?.dataset?.tokenChart||o?.dataset?.tokenMint||"";return{...r,anchorKey:c,anchorTop:o?o.getBoundingClientRect().top:0}}function xi(e,t=m("[data-panel]")){if(!e||n.route!=="terminal"||e.tab!==n.activeTab)return;const a=(o,c)=>{if(!o||!Number.isFinite(Number(c))||o.scrollHeight<=o.clientHeight+2)return;const l=Math.max(0,Math.min(Number(c),o.scrollHeight-o.clientHeight));Math.abs((o.scrollTop||0)-l)>4&&(o.scrollTop=l)},r=o=>{const c=document.scrollingElement||document.documentElement;a(re,e.dashboardScrollTop),a(o,e.panelScrollTop),a(c,e.documentY),Math.abs((window.scrollY||0)-Number(e.windowY||0))>8&&window.scrollTo(0,Math.max(0,Number(e.windowY||0)))},s=()=>{const o=t?.isConnected?t:m("[data-panel]");let c=!1;if(e.anchorKey&&o){const l=Vh(e.anchorKey),d=o.querySelector(`[data-token-chart="${l}"], [data-token-mint="${l}"]`);if(d){const p=d.getBoundingClientRect().top-Number(e.anchorTop||0);Number.isFinite(p)&&Math.abs(p)>1&&window.scrollTo(0,Math.max(0,(window.scrollY||0)+p)),c=!0}}c||r(o)};s(),requestAnimationFrame(()=>{s(),window.setTimeout(s,90),window.setTimeout(s,240),ar()&&window.setTimeout(s,520)})}function Td(e,t){const a=Object.keys(e.dataset||{}).filter(o=>o!=="customFor"&&o!=="customSelect").sort().map(o=>`${o}=${e.dataset[o]}`).join("|"),r=e.type==="checkbox"||e.type==="radio"?`:${e.value}`:"",s=`${e.tagName}:${e.type||""}:${e.name||""}:${a}${r}`;return a?s:`${s}:idx${t}`}function Ad(e){const t=Array.from(e.options||[]),a=t.find(r=>r.defaultSelected);return a?a.value:t[0]?.value??""}function zh(e){if(!e||e.dataset.renderedTab!==n.activeTab)return null;const t=new Map;let a="",r=null,s=null;return Array.from(e.querySelectorAll("input, textarea, select")).forEach((o,c)=>{const l=Td(o,c);if(t.has(l))return;const d=o.type==="checkbox"||o.type==="radio",u=o.tagName==="SELECT",p=d?String(o.defaultChecked):u?Ad(o):o.defaultValue,f=d?String(o.checked):o.value;if(f!==p&&(t.set(l,{value:f,defaultValue:p,isToggle:d,isSelect:u}),document.activeElement===o)){a=l;try{r=o.selectionStart,s=o.selectionEnd}catch{}}}),t.size?{tab:n.activeTab,fields:t,focusedKey:a,selectionStart:r,selectionEnd:s}:null}function jh(e,t){if(!e||!t||e.tab!==n.activeTab)return;const a=Array.from(t.querySelectorAll("input, textarea, select")),r=s=>{a.forEach((o,c)=>{const l=o.tagName==="SELECT";if(s!==l)return;const d=Td(o,c),u=e.fields.get(d);if(!u)return;const p=o.type==="checkbox"||o.type==="radio";if((p?String(o.defaultChecked):l?Ad(o):o.defaultValue)===u.defaultValue&&(p?o.checked=u.value==="true":o.value=u.value,d===e.focusedKey&&document.activeElement!==o))try{o.focus({preventScroll:!0}),Number.isFinite(e.selectionStart)&&Number.isFinite(e.selectionEnd)&&o.setSelectionRange(e.selectionStart,e.selectionEnd)}catch{}})};r(!0),r(!1)}function Gh(e){return!e||n.route!=="terminal"||n.activeTab==="terminal"||$d.has(n.activeTab)||e.dataset.renderedTab!==n.activeTab||n.activeTab==="smartChart"&&n.chartScrollIntoView?null:{tab:n.activeTab,windowY:window.scrollY||0,panelScrollTop:e.scrollTop||0,dashboardScrollTop:re?.scrollTop||0}}function Xh(e,t){if(!e||e.tab!==n.activeTab)return;const a=()=>{const r=t?.isConnected?t:m("[data-panel]");r&&r.scrollHeight>r.clientHeight+2&&(r.scrollTop=Math.min(e.panelScrollTop,r.scrollHeight-r.clientHeight)),re&&re.scrollHeight>re.clientHeight+2&&(re.scrollTop=Math.min(e.dashboardScrollTop,re.scrollHeight-re.clientHeight)),Math.abs((window.scrollY||0)-e.windowY)>8&&window.scrollTo(0,Math.max(0,e.windowY))};a(),requestAnimationFrame(a)}function Jh(){const e=m("[data-panel]");if(!e)return;const t=Li(e),a=zh(e),r=Gh(e),s=n.activeTab==="terminal"&&e.querySelector(".terminal-dock")?.scrollTop||0,o=n.activeTab==="terminal"?window.scrollY:0;document.querySelectorAll("[data-tab]").forEach(c=>{!c.closest(".tabs")&&!c.closest("[data-nav-drop]")&&c.removeAttribute("data-active")}),Ok();try{document.body.classList.toggle("launch-focus",window.location.pathname.includes("/launch-coin")&&n.activeTab==="launchCoin")}catch{}if(document.querySelectorAll(".tabs [data-tab]").forEach(c=>{c.dataset.active=c.dataset.tab===n.activeTab?"true":"false"}),document.querySelectorAll(".tabs .nav-tool-group").forEach(c=>{const l=!!c.querySelector('[data-active="true"]'),d=typeof window<"u"&&window.matchMedia?.("(min-width: 761px)")?.matches;c.open=!!d||!!n.navTekOpen||!ff()&&l}),n.activeTab==="terminal"&&(e.innerHTML=tm()),n.activeTab==="tek"&&(e.innerHTML=Qh()),n.activeTab==="dashboard"&&(e.innerHTML=sg()),n.activeTab==="profile"&&(e.innerHTML=og()),n.activeTab==="trade"&&(e.innerHTML=pb()),n.activeTab==="bundle"&&(e.innerHTML=vb()),n.activeTab==="volume"&&(e.innerHTML=Db()),n.activeTab==="live"&&(e.innerHTML=tm()),n.activeTab==="liveTrades"&&(e.innerHTML=yS()),n.activeTab==="slimeScope"&&(e.innerHTML=Ow()),n.activeTab==="watchlist"&&(e.innerHTML=MS()),n.activeTab==="smartChart"&&(e.innerHTML=iS()),n.activeTab==="launchCoin"&&(e.innerHTML=Xb()),n.activeTab==="launch"&&(e.innerHTML=Ub()),n.activeTab==="kol"&&(e.innerHTML=py()),n.activeTab==="ogreAi"&&(e.innerHTML=yb()),n.activeTab==="wallets"&&(e.innerHTML=Ev()),n.activeTab==="positions"&&(e.innerHTML=Dv()),n.activeTab==="pnl"&&(e.innerHTML=Vv()),n.activeTab==="txAudit"&&(e.innerHTML=Jp()),n.activeTab==="sniper"&&(e.innerHTML=OS()),e.dataset.renderedTab=n.activeTab||"",n.activeTab==="ogreTek"&&(e.innerHTML=qS(),e.dataset.renderedTab=n.activeTab||"",DS()),jh(a,e),ys(e),Xh(r,e),["trade","volume","launchCoin","sniper","ogreAi","bundle","positions","pnl"].includes(n.activeTab))try{fa[n.activeTab]&&!e.querySelector("[data-ogre-stage]")&&e.insertAdjacentHTML("afterbegin",lb(n.activeTab)),ib(e)}catch{}if(["terminal","live","kol","slimeScope","watchlist","smartChart"].includes(n.activeTab))try{ab(e,n.activeTab)}catch{}try{eb()}catch{}if(n.activeTab==="smartChart"&&n.chartFocusAmountInput&&requestAnimationFrame(()=>{const c=m("[data-chart-buy-amount]");c&&c.focus(),n.chartFocusAmountInput=!1}),n.activeTab==="smartChart"&&n.chartScrollIntoView&&(Hh(e),n.chartScrollIntoView=!1),n.activeTab==="terminal"){const c=e.querySelector(".terminal-dock");c&&(c.scrollTop=s),requestAnimationFrame(()=>{Math.abs(window.scrollY-o)>8&&window.scrollTo(0,o);const d=e.querySelector(".terminal-dock");d&&(d.scrollTop=s)})}xi(t,e),wh(),pa(),as(),Gn(),ns(),gi(),n.activeTab==="kol"&&ji()}function Yh(){const e=n.pnl?.totals?.realizedSol||"+0 SOL";return`
  ...
  `}const Pd="slimewire-ogre-memory";function os(){try{return JSON.parse(localStorage.getItem(Pd)||"{}")||{}}catch{return{}}}function is(e={}){const t={...os(),...e};try{localStorage.setItem(Pd,JSON.stringify(t))}catch{}return t}function Zh(e,t=""){if(!e)return;const r=(os().recentTokens||[]).filter(s=>s.mint!==e);r.unshift({mint:e,symbol:String(t||"").slice(0,14),at:Date.now()}),is({recentTokens:r.slice(0,5)})}(function(){const t=os();t.quickBuy&&!n.quickBuyAmountOverride&&(n.quickBuyAmountOverride=t.quickBuy)})();function Cd(){const t=mr().filter(l=>{const d=Number(l.marketCapUsd??l.marketCap)||0;return d>0&&d<8e3}).length,r=(Array.isArray(n.tradePlans)?n.tradePlans:[]).filter(l=>["watching","active"].includes(String(l.status||"").toLowerCase())),s=r.filter(l=>{const d=Number(l.lastMovePct??l.wallets?.[0]?.lastMovePct),u=Number(l.takeProfitPct);return Number.isFinite(d)&&Number.isFinite(u)&&u>0&&d>u*.7}).length,o=Number(n.shieldReceipts?.stats?.watching||0),c=Number(n.proofStats?.wins||0);return[c?`✅ ${c} tracked call(s) hit 2x - the proof wall has receipts`:"",t?`🐣 ${t} fresh under 8k MC on the feed`:"",r.length?`🛡 ${r.length} plan(s) armed${s?` - ${s} near take-profit`:""}`:"",o?`🔎 ${o} flagged token(s) being tracked to outcome`:""].filter(Boolean)}let Ld=!1;function eg(){if(Ld||Tn().length)return;Ld=!0;const e=Cd(),t=os(),a=[t.quickBuy?`your quick buy is still ${t.quickBuy} SOL`:"",t.risk==="degen"?"serving the early risky ones first, like you asked":t.risk==="careful"?"keeping it shield-clean first, like you asked":"",t.recentTokens?.[0]?.symbol?`last visit you were on $${t.recentTokens[0].symbol}`:""].filter(Boolean),r=a.length?` I remember: ${a.join(", ")}.`:"";fe({role:"assistant",text:e.length?`Welcome back. Right now: ${e.join(". ")}.${r} Ask me anything or say "open positions".`:`Welcome to SlimeWire. I can navigate anywhere, check any CA, set your quick buy, and run trades from chat.${r} Try "whats cooking" or paste a token address.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Positions",type:"open_tab",tab:"positions"}]})}function tg(){return`
    <section class="trade-card ogre-brief-card">
      ...
      <ul class="ogre-brief-list">
        ${[...Cd(),"🧾 Proof wall is public - slimewire.org/proof"].map(t=>`<li>${i(t)}</li>`).join("")}
      </ul>
    </section>
  `}function ag(){rg();const e=n.shieldReceipts;if(!e)return`
          ...
          ${t.map(r=>`
            <article class="row-card">
              <div class="row-main">
                ...
                <span>Flagged ${i(r.verdict)} (score ${i(String(r.score))}) ${r.confirmedAfterMinutes?`- confirmed dead within ${i(ng(r.confirmedAfterMinutes))}`:""}</span>
  ...
  `}function ng(e){const t=Number(e)||0;return t<90?`${t} min`:t<2880?`${Math.round(t/60)}h`:`${Math.round(t/1440)}d`}let xd=0;function rg(){Date.now()-xd<300*1e3||(xd=Date.now(),k("/api/web/shield/receipts").then(e=>{n.shieldReceipts=e,n.activeTab==="tek"&&h()}).catch(()=>{}),k("/api/web/proof").then(e=>{n.proofStats=e?.alpha||null}).catch(()=>{}))}function sg(){return`
    ${gg()}
    ${ls()}
  ...
  `}function og(){if(!Mi())return`
    ...
    `;const t=[{key:"account",label:"Account",hint:"Profile & name",html:fg()},{key:"login",label:"Login",hint:"Security",html:hg()},{key:"pfp",label:"PFP",hint:"Avatar",html:bg()},{key:"x",label:"X",hint:"Connect X",html:Tg()},{key:"alerts",label:"Alerts",hint:"Push to phone",html:ig()},{key:"badges",label:"Badges",hint:"Earned",html:Rd()},{key:"referral",label:"Referral",hint:"Invite & earn",html:Ag()},{key:"board",label:"Board",hint:"Top traders",html:Cg()}];return`
  ...
  `}function ig(){const e="serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window,t=e?Notification.permission:"unsupported",a=n.pushAlertsEnabled===!0;return`
  ...
  `}function fg(){const e=n.user?.connectedWallet;return`
  ...
  `}function hg(){const e=n.user?.username||"";return`
  ...
  `}function bg(){const e=!!n.user?.avatar,t=n.xHandle?`@${n.xHandle}`:"";return`
  ...
  `}function ls(){const e=n.user?.connectedWallet,t=!!n.user?.avatar,a=n.xHandle?`@${n.xHandle}`:"";return`
  ...
  `}function f0(){const e=n.user?.connectedWallet;return`
  ...
  `}function ma({returnPath:e="/terminal"}={}){n.walletConnectMenuOpen=!0,n.walletConnectReturnPath=e||"/terminal",n.walletConnectStatus=n.user?.connectedWallet?`Connected ${w(n.user.connectedWallet.publicKey)}. Pick a provider to reconnect or switch.`:"Pick a wallet. Your extension will ask you to approve.",h({force:!0})}function vg(e={}){return ma(e)}window.openWalletConnectModal=vg;function wg(e){n.walletFastApprovalsEnabled=!!e;try{localStorage.setItem("walletFastApprovalsEnabled",n.walletFastApprovalsEnabled?"on":"off")}catch{}}function Sg(){const e=m("[data-wallet-connect-modal]");if(!e)return;if(!n.walletConnectMenuOpen){e.hidden=!0,e.innerHTML="",e.__lastDrawerHtml="";return}const t=n.user?.connectedWallet||n.connectedWalletBalance;e.hidden=!1,kn(e,`
  ...
  `,".wallet-connect-dialog")}function kg(){const e=n.quickBuyModal||{},t=Vs()?.tokenMint===e.tokenMint?Vs():ve(e.tokenMint,{source:e.source||"quick-buy-modal"}),a=/validating|submitting|opening wallet/i.test(String(e.status||"")),r=Ri(e.error||e.status||""),s=a||!!r,o=pe(e.walletIndex||"");return`
  ...
  `}function Ag(){const e=n.user?.referralCode||"",t=`${Rt.replace(/\/+$/,"")}/r/`,a=n.user?.referralLink||(e?`${Rt.replace(/\/+$/,"")}/r/${encodeURIComponent(e)}`:""),r=n.user?.referralStats||{},s=Array.isArray(r.referrals)?r.referrals:[];return`
  ...
  `}function Pg(e=""){const t=String(e||"").trim();if(!t)return"";try{const r=new URL(t,Rt).pathname.split("/").map(o=>o.trim()).filter(Boolean),s=r.findIndex(o=>o.toLowerCase()==="r");if(s>=0&&r[s+1])return decodeURIComponent(r[s+1]);if(r.length)return decodeURIComponent(r[r.length-1])}catch{}return t.replace(/^https?:\/\/[^/]+\/?/i,"").replace(/^r\//i,"").replace(/^\/+|\/+$/g,"")}function Cg(){const e=n.user?.traderBoardWalletMode||"all",t=Array.isArray(n.user?.traderBoardWalletIndexes)?n.user.traderBoardWalletIndexes:n.wallets.map(a=>String(a.index));return`
  ...
  `:""}function Ye(e,t="Share X"){return`<button type="button" data-share-x data-share-text="${i(e)}">${i(t)}</button>`}function Fd(e,t="TG"){const a=Ii(e),r=`https://t.me/share/url?url=${encodeURIComponent(Rt)}&text=${encodeURIComponent(a)}`;return`<a href="${i(r)}" target="_blank" rel="noreferrer">${i(t)}</a>`}function Ii(e){const t=String(e||"").replace(/\s+/g," ").trim();return`${t.length>210?`${t.slice(0,207).trim()}...`:t} ${Rt}`}function Lg(e){const t=e.type==="buy",a=t?`${e.spentSol} SOL`:`${e.netSol} SOL`;return`${t?"Bought":"Sold"} ${e.shortMint||w(e.tokenMint)} for ${a}. Chart ${Q(e.tokenMint)}`}function h0(e){return`${e.type==="bundle_sell"?"Bundle sold":e.source==="web_bundle_plan"?"Armed bundle auto-exit":"Bundle bought"} ${e.shortMint||w(e.tokenMint)} across ${e.successCount||0}/${e.walletCount||0} wallet(s).`}function xg(e,t="Armed timed trade"){return`${t} on ${e.shortMint||w(e.tokenMint)} with ${e.successCount||0}/${e.walletCount||0} wallet(s), TP ${e.takeProfitSummary||`+${e.takeProfitPct}%`}, SL ${e.stopLossSummary||`-${e.stopLossPct}%`}.`}function Wd(e){return`PnL on ${e.shortMint||w(e.tokenMint)}: ${e.realizedSol} realized, ${e.buys} buy(s), ${e.sells} sell(s).`}function Mg(e){return`Watching ${e.shortMint||w(e.tokenMint)}: ${e.uiAmount} tokens across ${e.walletCount} wallet(s), PnL ${e.openPnlSol||e.realizedSol||"tracking"}.`}function Bg(e){return`Watching ${e.symbol||w(e.tokenMint)}: score ${e.score}/100, MC ${e.marketCapLabel}, liq ${e.liquidityLabel}. Chart ${Q(e.tokenMint)}`}function Rg(e){return`KOL signal ${e.symbol||w(e.tokenMint)}: score ${e.score||0}/100, value ${e.valueLabel||"$0"}, signal ${e.winRateLabel||"n/a"}. Chart ${Q(e.tokenMint)}`}function Ig(e){return`Watching KOL ${e.twitter?`@${e.twitter}`:e.name||e.shortWallet||w(e.wallet)}: realized ${e.realizedLabel||"n/a"}, ROI ${e.roiLabel||"n/a"}, trades ${e.trades??"n/a"}.`}function Og(e){return`Watching $${e.ticker} with Launch Snipe: ${e.walletCount} wallet(s), ${e.amountSol} SOL each, TP ${e.takeProfitSummary||`+${e.takeProfitPct}%`}, SL ${e.stopLossSummary||`-${e.stopLossPct}%`}.`}function Oi(e){const t=String(e||"").trim(),a=t.startsWith("$")?t:t.length>30?w(t):`$${t.replace(/^\$+/,"")}`,r=t.length>30?` Chart ${Q(t)}`:"";return`Watching ${a}.${r}`}function _d(e){const t=String(e||"").trim();return`Watching KOL ${t.startsWith("@")?t:t.length>30?w(t):`@${t.replace(/^@+/,"")}`}.`}const Eg=[{tier:"hot",pinned:!0,rank:1,name:"Idontpaytaxes",twitter:"Idontpaytaxes",wallet:"",kolscanUrl:"https://kolscan.io/account/2T5NgDDidkvhJQg8AHDI74uCFwgp25pYFMRZXBaCUNBH",tag:"External KOLscan profile",note:"External public/KOLscan stats only. These are not SlimeWire trades and do not create SlimeWire fees unless copied through your SlimeWire wallets. Add a verified Solana wallet before scan/copy.",winRateLabel:"36.8%",realizedLabel:"-$28.1",roiLabel:"Watch",trades:"24 ext",volumeLabel:"$6.58K volume",lastTradeAt:new Date(Date.now()-1020*60*1e3).toISOString()},{tier:"slimewire",pinned:!0,rank:1,name:"MoonPieJoe",twitter:"moonpiejoe",tag:"SlimeWire KOL",note:"Supporter profile. Add wallet later to enable scan/copy trade.",winRateLabel:"Supporter",realizedLabel:"n/a",roiLabel:"Social",trades:"Add wallet"},{tier:"slimewire",pinned:!0,rank:2,name:"Rezzy",twitter:"zero_taxes",tag:"SlimeWire KOL",note:"Supporter profile. Add wallet later to enable scan/copy trade.",winRateLabel:"Supporter",realizedLabel:"n/a",roiLabel:"Social",trades:"Add wallet"}];function Ei(e=""){const t=String(e||"").trim().toLowerCase();return Eg.filter(a=>!t||String(a.tier||"").toLowerCase()===t).sort((a,r)=>+!!r.pinned-+!!a.pinned||Number(a.rank||999)-Number(r.rank||999))}function Ut(e=""){return/^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(String(e||"").trim())}function Nd(e=""){const t=String(e||"").trim();return Ut(t)?t:""}function Fg(e={}){const t=String(e.wallet||"").trim(),a=Nd(t),r=et(e.twitter||e.x||e.username||"");return{x:r?_i(r):"",wallet:a?`https://solscan.io/account/${encodeURIComponent(a)}`:"",kolscan:e.kolscanUrl||e.externalProfileUrl||(a?Wc(a):"")}}function Wg(e={}){const t=String(e.wallet||"").trim(),a=Nd(t),r=Fg(e);return`
  ...
  `}function Dd(e={},t={}){const a=!!t.compact,r=String(e.wallet||"").trim();return`
  ...
  `}function _g(){const e=Ei("hot"),t=Ei("slimewire");return`
      ...
      <div class="curated-kol-layout">
        <article class="curated-kol-main">
          ...
          <div class="curated-kol-list">
            ${e.length?e.map(a=>Dd(a)).join(""):F("No curated hot wallets yet","Add wallets to the curated database to pin them here.")}
          </div>
        </article>
        <aside class="curated-kol-side">
          ...
          <div class="curated-kol-list">
            ${t.length?t.map(a=>Dd(a,{compact:!0})).join(""):F("No SlimeWire KOLs yet","Add official supporters here.")}
          </div>
        </aside>
      </div>
    </section>
  `}function sn(e="SW"){const t=Qe(n.user?.avatar||"");if(Ud(t))return`<img src="${i(t)}" alt="" referrerpolicy="no-referrer" onerror="this.onerror=null;this.src='${Bl("ogre")}';">`;const a=Bl("ogre");if(e==="SW"||e==="OG")return`<img src="${a}" alt="">`;const r=String(e||"SW").trim().slice(0,2).toUpperCase()||"SW";return`<span>${i(r)}</span>`}function Ud(e){const t=String(e||"").trim();return/^data:image\/(png|jpe?g|webp|gif);base64,/i.test(t)||/^https?:\/\/[^\s"'<>]+$/i.test(t)}function Qe(e){const t=String(e||"").trim();if(!t)return"";if(/^\/api\/web\/token-image\?/i.test(t))return t;if(/^ipfs:\/\//i.test(t)){const a=t.replace(/^ipfs:\/\//i,"").replace(/^ipfs\//i,"");return a?`https://ipfs.io/ipfs/${encodeURIComponent(a).replace(/%2F/g,"/")}`:""}return/^\/\//.test(t)?`https:${t}`:/^https?:\/\/[^\s"'<>]+$/i.test(t)||/^data:image\/(png|jpe?g|webp|gif);base64,/i.test(t)?t:""}function Ng(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||e.address||"").trim();return t?`/api/web/token-image?mint=${encodeURIComponent(t)}`:""}function Dg(e="",t=""){const a=String(e||"").trim(),r=Qe(t);if(!a||!r||cs(a,r))return"";if(vt.set(a,r),se("avatarCacheHit"),vt.size>900){for(const s of vt.keys())if(vt.delete(s),vt.size<=720)break}return r}function qd(e="",t=""){return`${String(e||"").trim()}|${Qe(t)}`}function Ug(e=""){return/^\/api\/web\/token-image\?/i.test(String(e||""))?45e3:1800*1e3}function cs(e="",t=""){const a=qd(e,t);if(!Zt.has(a))return!1;const r=Number(Ir.get(a)||0);return r&&Date.now()-r>Ug(t)?(Zt.delete(a),Ir.delete(a),!1):!0}function qg(e="",t=""){const a=String(e||"").trim(),r=Qe(t);if(!a||!r)return;const s=qd(a,r);if(Zt.add(s),Ir.set(s,Date.now()),Zt.size>1200){for(const o of Zt)if(Zt.delete(o),Ir.delete(o),Zt.size<=900)break}vt.get(a)===r&&vt.delete(a),se("avatarFetchFailed")}function Fi(e="",...t){const a=String(e||"").trim(),r=a?vt.get(a):"";if(r&&!cs(a,r))return se("avatarCacheHit"),r;r&&vt.delete(a);for(const s of t){const o=Qe(s);if(o&&!cs(a,o))return se("avatarCacheMiss"),o}return se("avatarFallbackShown"),""}window.__slimeRememberAvatar=Dg,window.__slimeAvatarLoadFailed=function(t){const a=t?.dataset?.avatarKey||"",r=t?.currentSrc||t?.src||t?.dataset?.avatarSrc||"";qg(a,r);const s=Qe(t?.dataset?.backupSrc||"");if(s&&!cs(a,s)){t.dataset.backupSrc="",t.dataset.avatarSrc=s,t.src=s;return}const o=Qe(t?.dataset?.proxySrc||""),c=Number(t?.dataset?.avatarRetries||0);if(o&&c<3){t.dataset.avatarRetries=String(c+1),t.hidden=!0,setTimeout(()=>{try{if(!t.isConnected)return;t.hidden=!1,t.src=o+(o.indexOf("?")>=0?"&":"?")+"rt="+(c+1)}catch{}},2600);return}t&&(t.hidden=!0,t.removeAttribute("src"))};function Wi(e){const t=et(e);return t?`https://unavatar.io/twitter/${encodeURIComponent(t)}`:""}function _i(e=n.xHandle){const t=et(e);return t?`https://x.com/${encodeURIComponent(t)}`:"https://x.com/i/flow/login"}function Hg(e={}){const t=Qe(e.avatar||e.image||"");if(Ud(t))return t;const a=et(e.twitter||e.x||e.username||"");if(a)return Wi(a);const r=et(e.name||e.kolName||"");return r&&r.length>=2?Wi(r):""}function Kg(e={}){return String(e.twitter||e.name||e.kolName||e.shortWallet||e.wallet||"KO").trim().replace(/^@+/,"").slice(0,2).toUpperCase()||"KO"}function Hd(e={},t="kol-avatar"){const a=`kol:${String(e.wallet||e.address||e.twitter||e.x||e.username||e.name||e.kolName||"").trim().toLowerCase()}`,r=Fi(a,Hg(e)),s=Kg(e);return r?`<img class="${i(t)}" src="${i(r)}" data-avatar-key="${i(a)}" data-avatar-fallback="${i(s)}" alt="" loading="eager" decoding="async" referrerpolicy="no-referrer" onload="window.__slimeRememberAvatar&&window.__slimeRememberAvatar(this.dataset.avatarKey,this.currentSrc||this.src);" onerror="var d=document.createElement('div');d.className=this.className+' kol-avatar-fallback';d.setAttribute('aria-hidden','true');d.textContent=this.dataset.avatarFallback||'KO';this.replaceWith(d);">`:`<div class="${i(t)} kol-avatar-fallback" aria-hidden="true">${i(s)}</div>`}function ds(){const e=Ge();return[{id:"phantom",label:"Phantom",detected:!!ge("phantom"),mobileRedirect:e&&!!Hn("phantom"),installUrl:li("phantom"),icon:Ya("phantom")},{id:"solflare",label:"Solflare",detected:!!ge("solflare"),mobileRedirect:e&&!!Hn("solflare"),installUrl:li("solflare"),icon:Ya("solflare")},{id:"backpack",label:"Backpack",detected:!!ge("backpack"),mobileRedirect:!1,installUrl:li("backpack"),icon:Ya("backpack")},{id:"solana",label:"Detected Wallet",detected:!!ge("solana"),mobileRedirect:!1,installUrl:"",icon:Ya("solana")}]}function ge(e){return e==="phantom"?window.phantom?.solana||(window.solana?.isPhantom?window.solana:null):e==="solflare"?window.solflare||(window.solana?.isSolflare?window.solana:null):e==="backpack"?window.backpack?.solana||null:e==="solana"&&(window.solana||window.solflare||window.phantom?.solana||window.backpack?.solana)||null}function _e(e,t){return e==="phantom"?"Phantom":e==="solflare"?"Solflare":e==="backpack"?"Backpack":t?.isPhantom?"Phantom":t?.isSolflare?"Solflare":t?.isBackpack?"Backpack":"Solana Wallet"}function ue(){return n.user?.connectedWallet||n.connectedWalletBalance||null}function Vg(e=""){const t=ue();if(!t?.publicKey)return"";const a=String(e||"")==="connected"||!e&&!n.wallets.length,r=t.provider||"Browser Wallet";return`<option value="connected" ${a?"selected":""}>${i(r)} - ${i(w(t.publicKey))}</option>`}function w(e){const t=String(e||"");return t.length>10?`${t.slice(0,4)}...${t.slice(-4)}`:t||"token"}const Ni="/assets/slimewire/swap/states/",ct="/assets/slimewire/swap/sfx/",Kd="/assets/slimewire/volume/states/",us="/assets/slimewire/volume/sfx/",zg="/assets/slimewire/ui/tick.mp3",jg="/assets/slimewire/ui/flip.mp3",Gg={swap:new Set(["idle","appraise","buy","sell","banking","win","loss"]),volume:new Set(["idle","running","sweep","stop"]),sniper:new Set(["idle","fire","lock"]),ogreAi:new Set(["idle","speak","think"]),bundle:new Set(["idle","volley","sell"]),launchCoin:new Set(["idle","launch","forge"]),positions:new Set(["idle","win","survey"]),pnl:new Set(["idle","win","survey"])},Xg={swap:{appraise:[ct+"appraise.mp3",.7],buy:[ct+"buy.mp3",.85],sell:[ct+"sell.mp3",.85],win:[ct+"win.mp3",.85],loss:[ct+"loss.mp3",.6],banking:[ct+"bank.mp3",.8]},volume:{running:[us+"start.mp3",.7],sweep:[us+"sweep.mp3",.8],stop:[us+"stop.mp3",.8]},sniper:{fire:["/assets/slimewire/auto/sfx/shockwave.mp3",.8],lock:["/assets/slimewire/sniper/sfx/lock.mp3",.7]},ogreAi:{think:["/assets/slimewire/ogreai/sfx/think.mp3",.6],speak:[ct+"appraise.mp3",.6]},bundle:{volley:["/assets/slimewire/auto/sfx/shockwave.mp3",.8],sell:["/assets/slimewire/bundle/sfx/sell.mp3",.8]},launchCoin:{forge:["/assets/slimewire/launch/sfx/forge.mp3",.85],launch:[ct+"win.mp3",.8]},positions:{survey:["/assets/slimewire/positions/sfx/survey.mp3",.7],win:["/assets/slimewire/auto/sfx/victory.mp3",.85]},pnl:{survey:["/assets/slimewire/positions/sfx/survey.mp3",.7],win:["/assets/slimewire/auto/sfx/victory.mp3",.85]}},Jg={sniper:[["[data-sniper-arm]","lock"],["__text:snipe|ape|fire","fire"]],ogreAi:[["[data-ogre-ai-start]","think"]],bundle:[["[data-bundle-buy]","volley"],["[data-bundle-sell]","sell"]],launchCoin:[["[data-launch-coin-submit]","forge"],["__text:launch","forge"]],positions:[["[data-refresh-all],[data-refresh],[data-refresh-positions]","survey"]],pnl:[["[data-refresh-all],[data-refresh]","survey"]]},Vd={},fa={launchCoin:{base:"/assets/slimewire/launch/states/",poster:"/assets/slimewire/launch/hero.png",tier:"OGRE FORGE",cap:["Pump Launcher","Forge it · birth it · send it."],accent:"launch",idle:"idle",event:"launch",sfx:[ct+"win.mp3",.8]},sniper:{base:"/assets/slimewire/sniper/states/",poster:"/assets/slimewire/sniper/hero.png",tier:"OGRESNIPER",cap:["OgreSniper","Lock on · strike first."],accent:"sniper",idle:"idle",event:"fire",sfx:["/assets/slimewire/auto/sfx/shockwave.mp3",.8]},ogreAi:{base:"/assets/slimewire/ogreai/states/",poster:"/assets/slimewire/ogreai/hero.png",tier:"OGRE A.I.",cap:["Ogre A.I.","Ask the swamp oracle."],accent:"ogreai",idle:"idle",event:"speak",sfx:[ct+"appraise.mp3",.6]},bundle:{base:"/assets/slimewire/bundle/states/",poster:"/assets/slimewire/bundle/hero.png",tier:"OGRE BUNDLE",cap:["Bundle","Many wallets · one volley."],accent:"bundle",idle:"idle",event:"volley",sfx:["/assets/slimewire/auto/sfx/shockwave.mp3",.8]},positions:{base:"/assets/slimewire/positions/states/",poster:"/assets/slimewire/positions/hero.png",tier:"POSITIONS",cap:["Open Positions","Your swamp, live."],accent:"positions",idle:"idle",event:"win",sfx:["/assets/slimewire/auto/sfx/victory.mp3",.85]},pnl:{base:"/assets/slimewire/positions/states/",poster:"/assets/slimewire/positions/hero.png",tier:"PROFIT & LOSS",cap:["PnL","Count the winnings."],accent:"positions",idle:"idle",event:"win",sfx:["/assets/slimewire/auto/sfx/victory.mp3",.85]}};function zd(){const e=R.kind;return e==="swap"?Ni:e==="volume"?Kd:fa[e]?fa[e].base:Ni}const g0={launchCoin:"[data-launch-coin-submit]",ogreAi:"[data-ogre-ai-start]",bundle:"[data-bundle-buy]"};let jd=!1;function Yg(){jd||(jd=!0,document.addEventListener("click",e=>{try{const t=e.target.closest("[data-ogre-card]");if(t){e.preventDefault(),e.stopPropagation(),Zg(t.getAttribute("data-ogre-card"));return}const a=R.kind;if(!a)return;const r=document.querySelector(`[data-ogre-stage="${a}"]`);if(!r)return;const s=e.target.closest("button, a[role='button'], [data-swap-reverse], select, input[type='range'], label.oss-pill, [role='button']");if(!s||s.closest("[data-ogre-snd],[data-ogre-card]"))return;const o=r.closest("[data-rendered-tab]")||r.parentElement||document;if(o.contains&&!o.contains(s))return;const c=()=>ms(zg,.5);if(fa[a]){const l=Jg[a]||[],d=(s.textContent||"").toLowerCase();for(const[u,p]of l)if(u.startsWith("__text:")){if(new RegExp(u.slice(7)).test(d)){ie(r,p,!0);return}}else if(s.closest(u)){ie(r,p,!0);return}c();return}if(a==="swap"){s.closest("[data-swap-use-custom-amount]")?ie(r,n.swapDirection==="sell"?"sell":"buy",!0):s.closest("[data-swap-reverse]")?(ie(r,"appraise",!0),ms(jg,.6)):s.closest("[data-swap-to],[data-swap-from],[data-trade-token]")?ie(r,"appraise",!0):c();return}if(a==="volume"){s.closest("[data-vbot-start]")?ie(r,"running",!0):s.closest("[data-vbot-stop]")?ie(r,"stop",!0):s.closest("[data-vbot-set-mode],[data-vbot-set-aggr],[data-vbot-set-stagger],[data-vbot-source]")?ie(r,"sweep",!0):c();return}}catch{}},!0))}function Qg(e,t){try{const a=document.createElement("a");a.href=t,a.download=e,document.body.appendChild(a),a.click(),a.remove()}catch{}}async function Zg(e){const t=r=>{const s=Number(r);return Number.isFinite(s)?s.toFixed(4):"0"};let a=null;if(e==="swap"){const r=n.tradeResult||{};a={theme:"swap",receipt:!0,loss:!1,headline:"SWAPPED",mint:r.tokenMint||n.tradeToken||"",symbol:String(r.symbol||r.shortMint||"TOKEN"),name:"OgreSwap",lines:[r.type==="sell"?`Received ${t(r.netSol)} SOL`:r.type==="buy"?`Aped ${t(r.spentSol)} SOL`:"Swapped on SlimeWire","OgreSwap · on-chain","slimewire.org"]}}else if(e==="volume"){const r=Array.isArray(n.volumeBots)?n.volumeBots:[],s=r.find(d=>d&&d.status!=="completed")||r[r.length-1]||{},o=s.stats||{},c=Number(s.buyAmountSol||0),l=(Number(o.buys||0)+Number(o.sells||0))*c;a={theme:"volume",receipt:!0,loss:!1,headline:"VOLUME RUN",mint:s.tokenMint||"",symbol:String(s.shortMint||"SLIMEBOT"),name:"SlimeBot",lines:[`${l.toFixed(2)} SOL volume`,`${Number(s.walletCount||0)} wallets · ${Number(s.currentCycle||s.cycles||0)} rounds`,"SlimeBot · slimewire.org"]}}else return;try{const r=await k("/api/web/card",{method:"POST",body:JSON.stringify(a)});r&&r.ok&&r.png&&Qg(`slimewire-${e}-card.png`,r.png)}catch{}}let Gd=!1;function eb(){Gd||(Gd=!0,document.addEventListener("click",e=>{try{const t=e.target.closest("button");if(!t||!(t.matches("[data-top-refresh-wallet],[data-refresh-all],[data-refresh-live-pairs],[data-refresh-scanner],[data-refresh],[data-refresh-watchlist],[data-refresh-kol]")||/(^|\s)(refresh|reload)(\b|$)/i.test((t.textContent||"").trim())))return;t.classList.remove("ogre-refreshing"),t.offsetWidth,t.classList.add("ogre-refreshing"),setTimeout(()=>t.classList.remove("ogre-refreshing"),900)}catch{}},!0))}function ps(e,t){return`<video class="${e}" autoplay muted loop playsinline preload="auto" src="/assets/slimewire/ui/${t}.mp4"></video>`}function tb(e){try{const t=e.querySelector(".trade-head h3")||e.querySelector(".pump-live-head h3")||e.querySelector(".pump-live-head")||e.querySelector(".trade-head");t&&!t.querySelector(".ogre-spy")&&t.insertAdjacentHTML("afterbegin",`<span class="ogre-spy" title="Intel watch">${ps("spy-vid","eye")}<i></i></span>`)}catch{}}let Di=0;function ab(e,t){try{if(t==="terminal"||t==="live"){if(!e.querySelector(".ogre-radar-bar")){const a=e.querySelector(".cooks-category-label")?.parentElement||e.querySelector(".terminal-main")||e.querySelector(".terminal-layout")||e,r=e.querySelectorAll(".signal-row, [data-token-mint]").length,s=document.createElement("div");if(s.className="ogre-radar-wrap",s.innerHTML='<span class="ogre-radar-bar">'+ps("rbar-bg","conduit")+`<span class="orb-scope">${ps("orb-vid","scope")}<span class="ring"></span><span class="ring r2"></span><span class="sweep"></span><span class="blip b1"></span><span class="blip b2"></span><span class="blip b3"></span></span><span class="orb-read"><span class="t">SWAMP RADAR</span><span class="s"><b>${r}</b> live pairs · scanning the swamp</span></span><span class="ogre-spy radar-eye" title="Intel watch">${ps("spy-vid","eye")}<i></i></span><span class="orb-heat">LIVE</span></span>`,a.insertBefore(s,a.firstChild),r>Di&&Di>0){const o=s.querySelector(".ogre-radar-bar");o.classList.add("hit"),setTimeout(()=>o.classList.remove("hit"),800)}Di=r}return}if(tb(e),t==="smartChart"){const a=e.querySelector(".trade-head");a&&!a.querySelector(".ogre-chartwatch")&&a.insertAdjacentHTML("beforeend",'<span class="ogre-chartwatch"><span class="ce"></span>WATCHING</span>')}}catch{}}let ha=!0;try{ha=localStorage.getItem("ogreStageSound")!=="off"}catch{}const Xd={};function ms(e,t){if(ha)try{let a=Xd[e];a||(a=new Audio(e),a.preload="auto",Xd[e]=a),a.volume=t??.7,a.currentTime=0,a.play().catch(()=>{})}catch{}}const R={kind:null,clip:"",eventUntil:0,prev:{},feed:[],feedIdx:0,tkTimer:0};function nb(e){return e=String(e||""),e.length>9?`${e.slice(0,4)}…${e.slice(-4)}`:e||"coin"}function Ui(e){return e&&e.symbol?`$${e.symbol}`:e&&e.shortMint?`$${e.shortMint}`:"the coin"}function Jd(e){return`<video class="ogre-bg" data-ogre-bg autoplay muted loop playsinline preload="auto" poster="${e==="swap"?"/assets/slimewire/swap/hero.png":"/assets/slimewire/volume/hero.png"}" src="${e==="swap"?Ni:Kd}idle.mp4"></video>`}function rb(){return`
    ...
    `;const a=yi(),r=nd(),s=td(a)||{symbol:a==="SOL"?"SOL":w(a),name:a==="SOL"?"Solana":""},o=td(r)||{symbol:r?w(r):"Custom",name:r?"Selected token":"Paste CA below"},c=Ah(),l=n.swapDirection==="sell",d=c==="two-step"?"Token-to-token uses a sell-to-SOL then buy route until direct routing is enabled.":l?"Sell: swap the pair back to SOL. Set the percent, then hit SWAP.":"Buy: swap SOL into the pair. Set the SOL amount, then hit SWAP.",u=l?a:r,p=u&&u!=="SOL"?u:n.tradeToken,f=`
  ...
  `}function qi(){return(Array.isArray(n.wallets)?n.wallets:[]).filter(e=>!e?.volumeBot)}function eu(){return(Array.isArray(n.wallets)?n.wallets:[]).filter(e=>!!e?.volumeBot)}function ln(e=""){const t=Vg(e),a=qi().map(r=>{const s=n.balances.find(l=>Number(l.index)===Number(r.index)),o=s?.sol!==null&&s?.sol!==void 0?`${Number(s.sol).toFixed(4)} SOL`:"balance loading",c=r.sessionWallet?" Session":"";return`<option value="${r.index}" ${String(r.index)===String(e||"")?"selected":""}>${r.index}. ${i(r.label)}${c} - ${o}</option>`}).join("");return t||a?`${t}${a}`:'<option value="">No wallet connected</option>'}function mb(){if(!n.tradeResult)return`
      <article>
        <h3>Latest Result</h3>
  ...
  `}function fb(){if(!n.tradePlanResult)return`
      <article>
        <h3>Managed Exit</h3>
  ...
  `}const rr=[["strong","Strong 🔥","Highest win-rate mode. Waits for survivors (1.5–12 min old) with proven net-buying, real holders and healthy liquidity, then targets a 2x — entering before the breakout, not after. Built to win more than it loses."],["super_fresh","Super-fresh","Brand-new sub-$8K launches (under ~2 min) with starting flow — fastest, highest risk. Blocks mint/freeze/honeypot/drained-liquidity before buys."],["volume","Volume","Active runners with real momentum ($8K–$350K MC), heavy early volume and live trades."],["safe","Safe","Established small caps ($50K–$1.2M MC) with deeper liquidity and a higher score bar; tighter slippage."],["long_term","Long-term","Larger, deeper pairs ($150K–$5M MC) for a longer horizon; strictest score + liquidity, lowest slippage."]];function fs(){const e=a=>rr.some(([r])=>r===a);if(n.ogreAiCategory&&e(n.ogreAiCategory))return n.ogreAiCategory;const t=nc().category;return e(t)?t:"strong"}function au(e){const t=rr.find(([a])=>a===e);return t?t[2]:rr[0][2]}function gb(e){return`<div class="ogre-cat-segment" role="group">${rr.map(([t,a])=>`<button type="button" data-ogre-cat="${i(t)}" data-active="${e===t}">${i(a)}</button>`).join("")}</div>`}function bb(){const e=n.ogreAutopilot||{},t=!!e.enabled,a=nu(e.category||fs()),r=(c,l)=>c==null||c===""?l:c,s=e.lastStatus||(t?"Autopilot armed. Waiting for the next qualified pick.":"Off. Autopilot auto-apes the best pick in your category using the presets above, inside hard spend guards."),o=t?`Spent this hour: ${Number(e.spentLastHourSol||0).toFixed(4)} / ${r(e.maxSpendPerHourSol,"0.3")} SOL`:"";return`
  ...
  `}function nu(e){const t=rr.find(([a])=>a===e);return t?t[1]:"Super-fresh"}function yb(){if(!n.wallets.length)return`${ls()}${F("No managed wallets loaded","Ogre A.I. needs managed/imported SlimeWire wallets so the server can submit TP/SL and timer exits after it buys.")}`;const e=nc(),t=e.amountSol||"0.1",a=e.runCount||"1",r=(o,c,l)=>{const d=String(o||l||"");return d==="custom"?String(c||"custom"):d},s=fs();return`
    <section class="trade-layout ogre-ai-terminal">
      <article class="trade-card">
        ...
        <div class="ogre-cat-field" data-preserve-focus>
          ...
          ${gb(s)}
          <small class="ogre-cat-hint">${i(au(s))}</small>
        </div>
        ...
        <small data-ogre-ai-status>${i(n.ogreAiStatus||au(s))}</small>
      </article>
  ...
  `}function ru(e,t){return`
    ...
    </section>`}function vb(){return n.wallets.length?`
    <section class="trade-layout">
      <article class="trade-card">
        <div class="trade-head">
          <div>
        ...
        <p class="trade-status" data-bundle-status>${n.bundleResult?i(n.bundleResult.message||"Bundle complete."):"Ready."}</p>`},{key:"autoexit",label:"Auto Exit",hint:"TP / SL plan",html:`
          ...
          <div class="volume-grid">
            ...
            <label>
              Repeat Wait
              ${hs("bundle-plan-loop-delay","data-bundle-plan-loop-delay","0")}
            </label>
            <label>
              Exit Size
  ...
  `:ru("Bundle","Bundle fires many managed wallets in one shot, so it needs at least one SlimeWire wallet. Tap to create one — your backup downloads instantly.")}function wb(){if(!n.bundleResult)return`
      <article>
        <h3>Latest Bundle</h3>
  ...
  `}function Sb(e=""){return n.wallets.length?n.wallets.map((t,a)=>{const r=String(t.index??a+1),s=`${r}. ${t.label||"Wallet"} ${t.shortPublicKey||w(t.publicKey||"")}`;return`<option value="${i(r)}" ${String(e)===r?"selected":""}>${i(s)}</option>`}).join(""):'<option value="">No managed wallets loaded</option>'}function x(e,t,a=""){const r=m(e)?.value||a;if(r!=="custom")return r;const s=m(t)?.value?.trim();if(!s)throw new Error("Enter the custom value first.");return s}function dt(e,t=""){const a=n.presets?.[e]||[],r=!t||t==="none"||t==="manual",s=e==="bundle"?"Create / edit bundle preset":"Create / edit trade preset";return a.length?`
  ...
  `:`
      <option value="" ${r?"selected":""}>No preset / manual</option>
      <option value="custom" ${t==="custom"?"selected":""}>${s}</option>
    `}function su(){return`<input data-quick-buy-amount type="text" inputmode="decimal" autocomplete="off" placeholder="${i(ze()||"0.10")}" value="${i(n.quickBuyAmountOverride)}">`}function ou(e="scanner"){return`
  ...
  `}function Ze(e,t,a="off"){return Ht({selectAttr:`${t}`,customAttr:`${t}-custom`,customFor:e,options:kb,selected:a,customPlaceholder:"Custom: 45s, 20, 2h"})}function hs(e,t,a="0"){return Ht({selectAttr:`${t}`,customAttr:`${t}-custom`,customFor:e,options:$b,selected:a,customPlaceholder:"Custom: 30s, 20, 2h"})}function Hi(e="scanner"){return`
  ...
  `}function y0(){const e=n.fastTradePresetStatus||(n.wallets.length?"Save this once, then tap Trade on any row.":"Load or connect a wallet before live trading.");return`
  ...
  `}function v0(){const e=n.fastBundlePresetStatus||(n.wallets.length?"Save this once, then tap Bundle on any row.":"Load wallets before live bundle trading.");return`
  ...
  `}function iu(e){const t=e==="trade"?n.editingTradePresetId:n.editingBundlePresetId;return t?le(e,t):null}function gs(e,t){e==="trade"&&(n.editingTradePresetId=t||""),e==="bundle"&&(n.editingBundlePresetId=t||"")}function Tb(){const e=iu("trade"),t=!!e?.readonly,a=e?t?"Save Edited Copy":"Update Trade Preset":"Save Trade Preset";return`
  ...
  `}function Ab(){const e=iu("bundle"),t=!!e?.readonly,a=e?t?"Save Edited Copy":"Update Bundle Preset":"Save Bundle Preset";return`
  ...
  `}function Pb(e){return Number(e?.sellDelaySeconds||0)>0?`${e?.sellPercent||100}%`:"Off"}function bs(e){return`
  ...
  `}function ga(e){return{walletTakeProfitTargets:x(`[data-${e}-wallet-tp]`,`[data-${e}-wallet-tp-custom]`,""),walletStopLossTargets:x(`[data-${e}-wallet-sl]`,`[data-${e}-wallet-sl-custom]`,"")}}function ys(e=document){e.querySelectorAll("[data-custom-for]").forEach(t=>{const r=[...document.querySelectorAll("[data-custom-select]")].find(s=>s.dataset.customSelect===t.dataset.customFor)?.value==="custom";t.hidden=!r,r||(t.value="")})}function Cb(e){if(!e?.dataset?.customSelect?.endsWith("-sell-percent")||e.value!=="off")return;const t=e.dataset.customSelect.replace(/-sell-percent$/,"-delay"),a=document.querySelector(`[data-custom-select="${t}"]`);a&&(a.value="off"),ys()}function cu(){return n.wallets.map(e=>`<option value="${i(e.index)}">${i(e.index)}. ${i(e.label||"Wallet")}${e.sessionWallet?" (session)":""}</option>`).join("")}function Lb(){return n.wallets.length?`
  ...
  `:""}function vs(e){n.distributeStatus=String(e||"");const t=m("[data-distribute-status]");t&&(t.textContent=n.distributeStatus)}function xb(){const e=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!e?.publicKey)return"";const t=n.wallets.filter(r=>r.sessionWallet),a=t.length?t:n.wallets;return a.length?`
  ...
  `:""}function sr(e){n.returnFundsStatus=String(e||"");const t=m("[data-return-funds-status]");t&&(t.textContent=n.returnFundsStatus)}async function du(e="leaving"){try{const t=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!t?.publicKey)return;const a=n.wallets.filter(o=>o.sessionWallet);if(!a.length)return;const r=a.map(o=>String(o.index));if(!await Me({title:"Return Session Funds",lines:[`Before ${e}, return tokens + SOL from your ${r.length} session wallet(s)`,`back to your connected wallet ${w(t.publicKey)}?`],confirmLabel:"Return Funds",cancelLabel:"Skip"}))return;await k("/api/web/wallets/return-to-connected",{method:"POST",body:JSON.stringify({destination:t.publicKey,walletIndexes:r}),dedupe:!1,timeoutMs:ae})}catch(t){try{window.alert(`Could not return funds automatically: ${t.message}. Use the Return Funds button to retry.`)}catch{}}}async function Mb(){if(n.returnFundsBusy)return;const e=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!e?.publicKey){sr("Connect a wallet first.");return}const t=n.wallets.filter(o=>o.sessionWallet),r=(t.length?t:n.wallets).map(o=>String(o.index));if(!r.length){sr("No managed wallets to return from.");return}if(await Me({title:"Return Funds",lines:[`Sell all tokens to SOL and send everything from ${r.length} wallet(s)`,`back to your connected wallet ${w(e.publicKey)}?`],confirmLabel:"Sell & Return",danger:!0})){n.returnFundsBusy=!0,sr("Selling tokens and returning SOL..."),h();try{const o=await k("/api/web/wallets/return-to-connected",{method:"POST",body:JSON.stringify({destination:e.publicKey,walletIndexes:r}),dedupe:!1,timeoutMs:ae});n.returnFundsBusy=!1,sr(o.summary||"Funds returned to your connected wallet."),await He({force:!0,deep:!1,reason:"return-funds"}).catch(()=>{}),h()}catch(o){n.returnFundsBusy=!1,sr(o.message),h()}}}async function Bb(){if(n.distributeBusy)return;const e=m("[data-distribute-count]")?.value||"5",t=m("[data-distribute-amount]")?.value||"",a=m("[data-distribute-source]")?.value||"1",r=m("[data-distribute-label]")?.value?.trim()||"Fresh";if(!t||Number(t)<=0){vs("Enter SOL per wallet greater than zero.");return}const s=(Number(t)||0)*(Number(e)||0);if(await Me({title:"Create & Fund Wallets",lines:[`Create ${e} fresh wallet(s) and fund each with ${t} SOL?`,`That sends about ${s.toFixed(3)} SOL total from the source wallet (real SOL).`,"Backup/recovery files for the new wallets will download."],confirmLabel:"Create & Fund"})){n.distributeBusy=!0,vs("Creating and funding wallets..."),h();try{await J(m("[data-distribute-status]"),"Creating secure web profile for wallet backups...");const c=await k("/api/web/wallets/distribute",{method:"POST",body:JSON.stringify({count:e,amountSol:t,sourceWalletIndex:a,label:r}),dedupe:!1,timeoutMs:ae});c.downloads?.encryptedBackup?.text&&be(c.downloads.encryptedBackup.filename,c.downloads.encryptedBackup.text),c.downloads?.recoveryKeys?.text&&be(c.downloads.recoveryKeys.filename,c.downloads.recoveryKeys.text),n.distributeBusy=!1,vs(c.summary||"Fresh wallets created and funded. Backups downloaded."),await He({force:!0,deep:!1,reason:"distribute-fresh-wallets"}).catch(()=>{}),h()}catch(c){n.distributeBusy=!1,vs(c.message),h()}}}function Rb(e){return e.status==="completed"?"Finished":e.stage==="sweeping"?"Sweeping back":e.stage==="running"?"Running":e.stage||"Armed"}function Ib(){const e=eu().length;return e?`
    ...
    </article>`:""}function Ob(){const e=Array.isArray(n.volumeBots)?n.volumeBots:[],t=Ib();return e.length?t+e.map(a=>{const r=a.stats||{},s=a.status!=="completed",o=(a.log||[]).slice(0,6);return`
      <article class="volume-bot-status">
        <header class="volume-bot-status-head">
          <div>
            <strong>${i(a.shortMint||a.tokenMint||"Token")}</strong>
            <span class="volume-bot-stage" data-stage="${i(a.stage||"")}">${i(Rb(a))}</span>
          </div>
  ...
  `}function Wb(){const e=n.slimeBotMode==="spam"?"spam":"smart",t=["low","med","high"].includes(n.slimeBotAggr)?n.slimeBotAggr:"med",a=Math.max(.05,Math.min(50,Number(m("[data-vbot-invest-num]")?.value||m("[data-vbot-invest]")?.value||"1"))),r=Math.max(20,Math.min(360,Number(m("[data-vbot-duration]")?.value||"60"))),o={low:{delaySecs:30,buyBias:55,walletCount:4},med:{delaySecs:12,buyBias:60,walletCount:6},high:{delaySecs:5,buyBias:70,walletCount:10}}[t],c=e==="smart",l=o.delaySecs*(c?4:1);let d=Math.round(r*60/l);d=Math.max(1,Math.min(250,d,Math.floor(a/.01)));const u=Math.max(.005,Math.min(.5,a/d));return{tokenMint:m("[data-vbot-token]")?.value?.trim()||"",sourceWalletIndex:m("[data-vbot-source]")?.value||"1",rollingWallets:c,autoCreateWallets:!c,walletCount:String(o.walletCount),fundPerWalletSol:c?"":(u+.02).toFixed(4),buyAmountSol:u.toFixed(4),sellPercent:"100",buyBias:String(o.buyBias),cycles:String(d),maxRounds:String(d),delaySecs:String(o.delaySecs),slippageBps:"400",sweepBack:!0,walletIndexes:[],walletGroup:"",keepDust:!!m("[data-vbot-keepdust]")?.checked,offsetSell:!!m("[data-vbot-offset]")?.checked,staggerPattern:["steady","waves","organic","ladder"].includes(n.slimeBotStagger)?n.slimeBotStagger:"steady",investment:a,durationMin:r,mode:e,aggr:t}}function ba(e){n.volumeBotStatus=String(e||"");const t=m("[data-vbot-status]");t&&(t.textContent=n.volumeBotStatus)}async function ws({silent:e=!0}={}){try{const t=await k("/api/web/volume-bot");n.volumeBots=Array.isArray(t.bots)?t.bots:[],n.activeTab==="volume"&&h()}catch(t){e||T(t.message)}}async function _b(){if(n.volumeBotBusy)return;const e=Wb();if(!e.tokenMint){ba("Paste a token CA first.");return}const t=e.durationMin>=60?`${(e.durationMin/60).toFixed(e.durationMin%60?1:0)}h`:`${e.durationMin}m`;if(await Me({title:"Start SlimeBot",lines:["This spends REAL SOL.",`Token: ${e.tokenMint}`,`${e.mode==="smart"?"Smart":"Spam"} mode, ${e.aggr.toUpperCase()} aggressiveness.`,`Deploys up to ~${e.investment} SOL over ${t} from your source wallet,`,`as ${e.cycles} round(s) of randomized ~${e.buyAmountSol} SOL buys / sells.`,"Sweeps funds back to the source wallet when done."],confirmLabel:"Start SlimeBot"})){n.volumeBotBusy=!0,ba("Funding wallets and starting bot..."),h();try{const r=await k("/api/web/volume-bot/start",{method:"POST",body:JSON.stringify(e),dedupe:!1,timeoutMs:ae});n.volumeBotBusy=!1,r.bot&&(n.volumeBots=[r.bot,...n.volumeBots.filter(s=>s.id!==r.bot.id)]),ba(r.bot?.message||"SlimeBot started."),h(),ws()}catch(r){n.volumeBotBusy=!1,ba(r.message),h()}}}async function Nb(e){if(e)try{ba("Stopping bot...");const t=await k("/api/web/volume-bot/stop",{method:"POST",body:JSON.stringify({planId:e}),dedupe:!1,timeoutMs:ae});t.bot&&(n.volumeBots=n.volumeBots.map(a=>a.id===t.bot.id?t.bot:a)),ba(t.bot?.message||"Stop requested."),h(),ws()}catch(t){ba(t.message)}}function Db(){return n.wallets.length?Fb():ru("SlimeBot","SlimeBot funds and trades from a managed SlimeWire wallet, so it needs at least one saved. Tap to create one — your backup downloads instantly.")}function Ub(){const e=we([...n.livePairsByBucket.live?.rows||[],...n.livePairsByBucket.under1h?.rows||[],...qe()?.rows||[],...n.scan?.rows||[]]).sort(nt),t=vn(e),a=it("launch",t),r=yn(),s=Pt(Re().keywords)[0]||"";return`
    <section class="trade-layout">
      <article class="trade-card">
        ...
        ${gl("launch",{rawCount:e.length,visibleCount:t.length})}
        ${hl(e,t)}
        ${a.length?mt(a,{context:"launch-snipe",hideToolbar:!0,primaryAction:"snipe",primaryActionLabel:"Snipe",shareBuilder:Pa}):r?wr(e,"launch candidates"):F("No launch filter set","Enter a ticker keyword like cook or broscook to watch fresh live pairs before they launch.")}
      ...
      <aside class="trade-side">
        ...
        <div class="volume-grid">
          ...
          <label>
            Repeat Wait
            ${hs("launch-loop-delay","data-launch-loop-delay","0")}
          </label>
          <label>
            Slippage
        ...
        <article>
          <h3>How It Works</h3>
          <p>It scans live launch/profile feeds about every ${i(oy())} seconds while the bot is online.</p>
        </article>
        <article>
    ...
    <section class="launch-coin-card pump-live-panel" data-pump-live-panel>
      ...
      <div class="pump-live-grid">
        ...
        <div class="pump-live-stack">
          <div class="pump-live-stat"><span>Launch CA</span><strong>${i(Kb(t))}</strong></div>
          <div class="pump-live-stat"><span>Provider</span><strong>${i(qb())}</strong></div>
          <div class="pump-live-stat"><span>Chart mode</span><strong>Pump chart + txns</strong></div>
          <div class="pump-live-stat"><span>Stream route</span><strong>${i(pu(t))}</strong></div>
        </div>
      </div>
  ...
  `}function jb(e={}){mu();const t=n.hypePages||[],r=new Date(Date.now()+600*1e3-new Date().getTimezoneOffset()*60*1e3).toISOString().slice(0,16);return`
    <div class="volume-grid">
      ...
      ${t.length?`
        <div class="full-span">
          ...
          </div>`},{key:"hype",label:"Hype",hint:"Pre-launch page",title:"Pre-Launch Hype Page",html:jb(e)},{key:"live",label:"Live",hint:"Status feed",title:"Live Launch Status",html:Vb(e)}];return`
  ...
  `}async function ji(e={}){if(!D("kolDumpDetectorEnabled",!0))return null;const t=!!e.force;if(!t&&n.kolDumpStatsLoadedAt&&Date.now()-Number(n.kolDumpStatsLoadedAt||0)<900*1e3)return n.kolDumpStats;if(n.kolDumpStatsLoading)return null;n.kolDumpStatsLoading=!0;try{const a=new URLSearchParams({mode:n.kolMode||"hot"});n.kolWallet&&a.set("wallet",n.kolWallet),t&&a.set("force","true");const r=await k(`/api/web/kols/dump-stats?${a.toString()}`,{timeoutMs:t?5e3:3e3,preserveSafeError:!0});return n.kolDumpStats=r,n.kolDumpStatsLoadedAt=Date.now(),se(r.cacheHit?"kolStatsCacheHit":"kolStatsCacheMiss"),r}catch{return n.kolDumpStats=n.kolDumpStats||{stats:[],message:"KOL dump stats unavailable. Showing local low-data fallback."},n.kolDumpStatsLoadedAt=Date.now(),null}finally{n.kolDumpStatsLoading=!1,n.kolDumpDetails?.open?Ps():n.activeTab==="kol"&&h({force:!0})}}function uy(e=""){const t=String(e||"").trim();!t||!D("kolDumpDetectorEnabled",!0)||(n.kolDumpDetails={open:!0,kolId:t},Ka(),Ps(),ji({force:!0}))}function Gi(){n.kolDumpDetails={open:!1,kolId:""},Ps(),zr()}function Ps(){let e=document.querySelector("[data-kol-dump-drawer-root]");e||(e=document.createElement("div"),e.dataset.kolDumpDrawerRoot="true",document.body.appendChild(e));const t=n.kolDumpDetails||{},a=!!(t.open&&t.kolId);if(document.body.classList.toggle("kol-dump-drawer-open",a),!a||!D("kolDumpDetectorEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=As().find(u=>String(u.kolId)===String(t.kolId))||cy(t.kolId),s=!!n.kolDumpStatsLoading,o=Array.isArray(r.walletAddresses)?r.walletAddresses.filter(Boolean).slice(0,4):[],c=Array.isArray(r.externalLinks)?r.externalLinks.filter(u=>/^https?:\/\//i.test(String(u?.url||""))).slice(0,4):[],l=r.lastTokenMint?`${r.lastTokenSymbol?`${r.lastTokenSymbol} `:""}${w(r.lastTokenMint)}`:"n/a",d=`
  ...
  `;kn(e,d,".kol-dump-drawer")}function py(){const e=n.kolScan?.configured!==!1,t=n.kolLoading?"disabled":"",a=String(n.kolMode||"hot"),r=!!n.kolScan,s=!!n.kolScan?.kols?.length,o=s&&a!=="hot",c=!r&&!s;return`
    ...
    <p class="scan-meta">${i(fy(n.kolMode))}</p>
    ${my()}
    ${o?gy():c?_g():""}
    ${n.kolMode==="slimewire"&&n.kolScan?n.kolScan.kols?.length?"":F("No SlimeWire traders yet","Traders appear here only after they opt in from Profile and have site trade history."):n.kolScan?by():F("No KOL scan loaded","Pick a KOL mode or tap Refresh.")}
    <details class="kol-management-settings" data-kol-management-settings>
      ...
      <article class="trade-card">
        ...
        <div class="volume-grid">
          ...
          <label>
            Repeat Wait
            ${hs("kol-loop-delay","data-kol-loop-delay","0")}
          </label>
          <label>
            Slippage
  ...
  `}function my(){const e=n.kolScan||null,t=lr(n.kolMode),a=n.kolLoading?`Scanning ${t}`:e?`${t} loaded`:`Pick ${t} or tap Refresh`,r=Number(e?.kolCount||e?.kols?.length||0),s=Number(e?.rows?.length||0),o=n.kolLastUpdatedAt?Te(n.kolLastUpdatedAt):"Not run";return`
  ...
  `}function lr(e){const t={hot:"Hot Buys",top:"Top KOLs",consistent:"Consistent",fresh:"Fresh",slimewire:"Top SlimeWire Traders"};return t[e]||t.hot}function fy(e){const t={hot:"Top coins KOL wallets are calling now. Hot Buys refreshes around every 10 seconds while the tab is open.",top:"Best ranked KOL wallets by realized performance, then their highest-value current token positions.",consistent:"KOLs ranked by consistency/win rate from the available leaderboard, then filtered into cleaner copyable positions.",fresh:"KOL wallets with the newest activity first, useful when you want faster signal flow.",slimewire:"Opt-in SlimeWire users ranked by closed trades and recent activity."};return t[e]||t.hot}function hy(){const e=n.kolResult;return e?.results?.length?`<div class="mini-results">${e.results.map(t=>`<span data-ok="${t.ok?"true":"false"}">${i(t.message||t)}</span>`).join("")}</div>`:""}function gy(){const e=n.kolScan||{},t=(e.kols||[]).filter(a=>a.wallet||a.twitter);return!t.length||e.configured===!1?"":`
    <section class="kol-dashboard">
      <div class="trade-head">
        <div>
          <h3>${i(e.label||"KOL Tracker")}</h3>
          <p>${i(`${lr(n.kolMode)} with ${Number(e.rows?.length||0)} current token signal(s).`)}</p>
        </div>
        ...
        ${t.slice(0,12).map((a,r)=>`
          <article class="kol-profile">
            ...
            <div class="card-actions kol-profile-actions">
              ...
              ${a.kolscanUrl||a.wallet?`<a href="${i(a.kolscanUrl||Wc(a.wallet))}" target="_blank" rel="noreferrer">Trader Profile</a>`:""}
              ${zi(a)}
              ${Ye(Ig(a),"Share Watch")}
...
`)}async function Iy(e){const t=m("[data-wallet-sweep-status]");n.walletSweepStatus="Running wallet action...",S(t,n.walletSweepStatus),T("");try{await J(t,"Opening secure web profile...");const r={"sweep-sol":"/api/web/wallets/sweep-sol","sweep-tokens":"/api/web/wallets/sweep-tokens","sell-all":"/api/web/wallets/sell-all-tokens","sell-all-sweep":"/api/web/wallets/sell-all-tokens","send-sol-many":"/api/web/wallets/send-sol"}[e];if(!r)throw new Error("Unknown wallet action.");const s=e==="send-sol-many"?By():My();if(e==="sell-all"&&(s.destination=""),e==="sell-all-sweep"&&!s.destination)throw new Error("Enter a destination wallet for Sell Tokens + Send SOL.");const o=await k(r,{method:"POST",body:JSON.stringify(s),timeoutMs:ae});n.walletSweepStatus=Ry(o.sweep),S(t,n.walletSweepStatus),await He({force:!0,deep:!0}),n.activeTab="wallets",h()}catch(a){n.walletSweepStatus=a.message,S(t,a.message),T(a.message)}}async function Oy(e){const t=m("[data-restore-status]"),a=m("[data-restore-text]"),r=e?.files?.[0];if(!(!r||!a)){S(t,"Reading backup file...");try{a.value=await r.text(),S(t,"Backup loaded. Tap Restore Wallets.")}catch(s){S(t,`Could not read file: ${s.message}`)}}}function be(e,t){const a=new Blob([t],{type:"text/plain"}),r=URL.createObjectURL(a),s=document.createElement("a");s.href=r,s.download=e,document.body.appendChild(s),s.click(),s.remove(),setTimeout(()=>URL.revokeObjectURL(r),1e4)}async function Ey(){const e=m("[data-x-handle]"),t=m("[data-x-status]"),a=et(e?.value||"");if(!a){S(t,"Enter a valid X handle first.");return}const r=window.open(_i(a),"_blank","noopener,noreferrer");try{S(t,r?`Opening X and saving @${a}...`:`Saving @${a}. Allow popups if X did not open.`),await J(t,"Creating secure web profile for X sharing...");const s=await k("/api/web/profile/x",{method:"POST",body:JSON.stringify({xHandle:a})});he(s.user||{...n.user,xHandle:s.profile?.xHandle||a}),tc(n.xHandle),S(t,`Connected @${n.xHandle}. Share buttons now open X posts with SlimeWire tagged.`),h()}catch(s){S(t,s.message),T(s.message)}}function Fy(){const e=m("[data-x-status]"),t=et(m("[data-x-handle]")?.value||n.xHandle||""),a=_i(t||n.xHandle);window.open(a,"_blank","noopener,noreferrer"),S(e,t?`Opened X for @${t}. Tap Connect X after checking the handle.`:"Opened X login. Add your handle here after signing in.")}async function Wy(){const e=m("[data-x-status]"),t=m("[data-x-handle]");try{if(!n.user||!n.token){n.xHandle="",t&&(t.value=""),Wo(),S(e,"X unlinked. Enter a new handle any time and tap Save X Handle."),h();return}const a=await k("/api/web/profile/x",{method:"POST",body:JSON.stringify({clear:!0})});he(a.user||{...n.user,xHandle:""}),n.xHandle="",t&&(t.value=""),Wo(),S(e,"X unlinked. Enter a new handle any time and tap Save X Handle."),h()}catch(a){S(e,a.message),T(a.message)}}async function Ms(e,t="Saving PFP..."){const a=m("[data-avatar-status]");S(a,t);try{await J(a,"Creating secure web profile for PFP...");const r=await k("/api/web/profile/avatar",{method:"POST",body:JSON.stringify(e)});he(r.user||{...n.user,avatar:r.profile?.avatarDataUrl||r.profile?.avatarUrl||"",avatarSource:r.profile?.avatarSource||"",avatarUpdatedAt:r.profile?.avatarUpdatedAt||""}),S(a,n.user.avatar?"PFP saved.":"PFP removed."),h()}catch(r){S(a,r.message),T(r.message)}}async function _y(e){const t=m("[data-avatar-status]"),a=e?.files?.[0];if(a){if(!/^image\/(png|jpe?g|webp)$/i.test(a.type)){S(t,"Use a PNG, JPG, or WebP image.");return}if(a.size>5*1024*1024){S(t,"Use an image under 5 MB.");return}try{S(t,"Compressing PFP...");const r=await Lu(a);await Ms({avatarDataUrl:r},"Saving compressed PFP...")}catch(r){S(t,r.message),T(r.message)}finally{e.value=""}}}function Lu(e){return new Promise((t,a)=>{const r=new FileReader;r.onerror=()=>a(new Error("Could not read that image.")),r.onload=()=>{const s=new Image;s.onerror=()=>a(new Error("Could not load that image.")),s.onload=()=>{const c=document.createElement("canvas");c.width=256,c.height=256;const l=c.getContext("2d");if(!l){a(new Error("This browser cannot resize images."));return}const d=Math.max(256/s.width,256/s.height),u=Math.round(s.width*d),p=Math.round(s.height*d),f=Math.round((256-u)/2),y=Math.round((256-p)/2);l.clearRect(0,0,256,256),l.drawImage(s,f,y,u,p);const b=c.toDataURL("image/jpeg",.84);if(b.length>22e4){a(new Error("Compressed PFP is still too large. Try a simpler image."));return}t(b)},s.src=String(r.result||"")},r.readAsDataURL(e)})}async function Ny(e){const t=document.querySelector('script[src*="app.js"]')?.src||document.baseURI||window.location.href,a=new URL(String(e||""),t).toString(),r=await fetch(a,{cache:"force-cache"});if(!r.ok)throw new Error("Could not load that preset PFP.");const s=await r.blob();return Lu(s)}async function Dy(){const e=Wi(n.xHandle);if(!e){const t=m("[data-avatar-status]");S(t,"Connect an X handle first.");return}await Ms({avatarUrl:e,avatarSource:"x"},"Saving X PFP...")}async function xu(e,t={}){const a=Un(),r=ge(e);if(!r){if(await Oc(e,t)||Ec(e))return;const s=$c(e);oe(s),Wt(e,new Error(s),{action:"provider_missing",platform:Ge()?"mobile":"desktop"});return}try{const s=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(s){if(!(t.confirmSwitch===!1?!0:await Me({title:"Reconnect or Switch Wallet",lines:[`Current wallet: ${w(s)}`,"Your wallet extension will open so you can approve the wallet to use on Live Terminal."],confirmLabel:"Open Wallet"}))){oe("Wallet connection unchanged."),Pe("/terminal","terminal");return}try{await Promise.resolve(r.disconnect?.())}catch{}}oe(`Opening ${_e(e,r)}...`);const c=(await r.connect?.({onlyIfTrusted:!1}))?.publicKey||r.publicKey,l=c?.toBase58?.()||c?.toString?.()||"";if(!l)throw new Error("Wallet connected, but no public address was returned.");await J(a,"Creating secure web profile for connected wallet...");const d=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({publicKey:l,provider:_e(e,r)})});he(d.user||{...n.user,connectedWallet:d.profile?.connectedWallet||null}),n.connectedWalletBalance={publicKey:l,shortPublicKey:w(l),provider:_e(e,r),tokens:[]},Pi(`connected:${l}`),n.walletConnectMenuOpen=!1,oe(`Connected ${w(l)}. Opening Live Terminal...`),Pe(t.returnPath||n.walletConnectReturnPath||"/terminal","terminal"),h({force:!0}),kd("browser-wallet-connect"),Qr("browser-wallet-connect")}catch(s){const o=s.message||"Wallet connection was cancelled.";oe(o),Wt(e,s,{action:"connect_failed"})}}async function Mu(){await du("disconnecting");const e=Un(),t=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(!n.user||!n.token){n.connectedWalletBalance=null,Pi(t?`connected:${t}`:""),oe("Connected wallet disconnected."),h({force:!0});return}try{const a=n.user?.connectedWallet?.provider||"";await(a.toLowerCase().includes("phantom")?ge("phantom"):a.toLowerCase().includes("solflare")?ge("solflare"):a.toLowerCase().includes("backpack")?ge("backpack"):ge("solana"))?.disconnect?.()}catch{}try{const a=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({clear:!0})});he(a.user||{...n.user,connectedWallet:null}),n.connectedWalletBalance=null,Pi(t?`connected:${t}`:""),oe("Connected wallet disconnected."),h({force:!0})}catch(a){oe(a.message),T(a.message)}}async function Uy(){const e=m("[data-profile-username]"),t=m("[data-profile-password]"),a=m("[data-login-security-status]"),r=String(e?.value||"").trim(),s=String(t?.value||"");if(!r||!s){S(a,"Enter a username and password first.");return}try{await J(a,"Creating secure web profile..."),S(a,"Saving login...");const o=await k("/api/web/profile/credentials",{method:"POST",body:JSON.stringify({username:r,password:s})});he(o.user||{...n.user,username:r,hasPasswordLogin:!0}),t&&(t.value=""),S(a,"Saved. You can now log back in with this username and password."),h()}catch(o){S(a,o.message),T(o.message)}}function et(e){return String(e||"").trim().replace(/^@+/,"").replace(/[^a-z0-9_]/gi,"").slice(0,15)}function Qi(e){const t=Ii(e),a=String(n.user?.referralLink||"").trim(),r=a&&!t.includes("/r/")?a:Rt,s=`https://twitter.com/intent/tweet?text=${encodeURIComponent(t)}&url=${encodeURIComponent(r)}`;window.open(s,"_blank","noopener,noreferrer")}function Bu(e){const t=e==="kol",a=m(t?"[data-share-watch-kol]":"[data-share-watch-token]"),r=m("[data-share-watch-status]"),s=a?.value?.trim()||"";if(!s){S(r,t?"Enter a KOL handle or wallet first.":"Enter a coin, ticker, or CA first.");return}Qi(t?_d(s):Oi(s)),S(r,t?"KOL watch post opened in X.":"Coin watch post opened in X.")}async function Ru(e){const t={};n.token&&(t.Authorization=`Bearer ${n.token}`);const a=await _n(Ga(`/api/web/pnl/card?tokenMint=${encodeURIComponent(e)}`),{headers:t,cache:"no-store"},3e4);if(!a.ok){const r=await kc(a);throw new Error(r.message||r.error||`Could not build PnL card (${a.status}).`)}return{blob:await a.blob(),filename:a.headers.get("x-ogre-filename")||`pnl-card-${w(e)}.png`}}async function Iu(e){const{blob:t,filename:a}=await Ru(e),r=URL.createObjectURL(t),s=document.createElement("a");s.href=r,s.download=a,document.body.appendChild(s),s.click(),s.remove(),setTimeout(()=>URL.revokeObjectURL(r),1e4)}async function qy(e,t){try{const{blob:a,filename:r}=await Ru(e),s=new File([a],r,{type:"image/png"});if(navigator.canShare?.({files:[s]})){await navigator.share({title:"SlimeWire PnL Card",text:Ii(t),url:Rt,files:[s]});return}await Iu(e),Qi(`${t} PnL card downloaded and ready to attach.`)}catch(a){T(a.message)}}function Ou(e="buy"){const t=m("[data-trade-wallet]")?.value||"",a=Ph(e)||m("[data-trade-token]")?.value?.trim()||"",r=x("[data-trade-slippage]","[data-trade-slippage-custom]","400");if(!t)throw new Error("Choose a wallet first.");if(!a)throw new Error("Paste a token CA first.");return n.tradeToken=a,e==="sell"?(n.tradeSwapFrom=a,n.tradeSwapTo="SOL"):(n.tradeSwapFrom="SOL",n.tradeSwapTo=a),{walletIndex:t,tokenMint:a,slippageBps:r}}function pe(e=""){return String(e||"").trim().toLowerCase()==="connected"}function Hy(e={}){if(!e?.sessionWallet||e.sessionStatus!=="funded")return!1;const t=Date.parse(e.sessionExpiresAt||"");return!Number.isFinite(t)||t>Date.now()}function Eu(){const e=Array.isArray(n.wallets)?n.wallets:[];for(let t=e.length-1;t>=0;t-=1)if(Hy(e[t]))return e[t];return null}function Fu(e=ue()){if(!e?.publicKey)return!1;const t=cr(e),a=ge(t)||ge("solana");return!!(a&&typeof a.signTransaction=="function")}function Bs(e=ue()){const t=e?.provider||_e(cr(e));return`${t} is connected, but this mobile browser cannot sign trades after the wallet-app handoff. Open SlimeWire inside the ${t} in-app browser, or fund a Session Wallet once so buys, sells, TP/SL, and Ogre A.I. can run without reconnect loops.`}function Rs(e={},{side:t="trade",statusWriter:a=ye,allowSessionFallback:r=!0}={}){if(!pe(e.walletIndex))return{form:e,sessionWallet:null};if(Fu())return{form:e,sessionWallet:null};const s=r?Eu():null;if(s?.index){const o=`Using Session Wallet ${s.index} for ${t}; mobile wallet signing is not available in this browser.`;return typeof a=="function"&&a(o),{form:{...e,walletIndex:String(s.index)},sessionWallet:s}}throw new Error(Bs())}function Wu(e){const t=[];for(let r=0;r<e.length;r+=32768)t.push(String.fromCharCode(...e.subarray(r,r+32768)));return btoa(t.join(""))}function _u(e=""){const t=atob(String(e||"")),a=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)a[r]=t.charCodeAt(r);return a}function cr(e=ue()){const t=String(e?.provider||"").trim().toLowerCase();return t.includes("phantom")?"phantom":t.includes("solflare")?"solflare":t.includes("backpack")?"backpack":"solana"}async function Ky(e=ue(),{returnPath:t=Ja()||"/terminal/trade"}={}){const a=cr(e),r=e?.provider||_e(a);if(ma({returnPath:t}),Ge()&&e?.publicKey&&!ge(a)){const o=Bs(e);return oe(o),o}if(Ic(a)){const o=`${r} needs to reconnect before it can sign here. Opening ${r} mobile connect now.`;if(oe(o),await Oc(a,{returnPath:t}).catch(()=>!1))return o}if(Ec(a))return`Opening ${r}. Use the wallet browser to reconnect and approve the trade.`;const s=$c(a);return oe(s),s}async function Nu(){const e=ue();if(!e?.publicKey)throw new Error("Connect Phantom, Solflare, or another wallet before trading.");const t=cr(e),a=ge(t)||ge("solana");if(!a){if(Ge()&&e?.publicKey)throw new Error(Bs(e));const o=await Ky(e,{returnPath:Ja()||"/terminal/trade"});throw new Error(o)}if(typeof a.signTransaction!="function")throw Ge()&&e?.publicKey?new Error(Bs(e)):new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const r=()=>a.publicKey?.toBase58?.()||a.publicKey?.toString?.()||"";let s=r();if(s!==e.publicKey)try{const o=await a.connect?.({onlyIfTrusted:!0});s=o?.publicKey?.toBase58?.()||o?.publicKey?.toString?.()||r()}catch{}if(s!==e.publicKey){const o=await a.connect?.({onlyIfTrusted:!1}),c=o?.publicKey?.toBase58?.()||o?.publicKey?.toString?.()||r();if(c!==e.publicKey)throw new Error(`Wallet mismatch. SlimeWire has ${w(e.publicKey)} connected, but the browser returned ${w(c)}. Reconnect the wallet you want to trade with.`)}return{provider:a,connected:e}}async function Vy(){try{if(Ge())return;const e=ue();if(!e?.publicKey)return;const t=cr(e),a=ge(t)||ge("solana");if(!a||typeof a.connect!="function"||(a.publicKey?.toBase58?.()||a.publicKey?.toString?.()||"")===e.publicKey)return;await a.connect({onlyIfTrusted:!0}).catch(()=>{})}catch{}}const zy=6e4;async function Du(e,t,a=zy){let r=0;const s=new Promise((o,c)=>{r=window.setTimeout(()=>{c(new Error("Wallet approval timed out. Reopen your wallet and try the trade again."))},a)});try{return await Promise.race([Promise.resolve(e.signTransaction(t)),s])}finally{window.clearTimeout(r)}}async function jy(e,t){if(!e||typeof e!="string")throw new Error("SlimeWire could not build a wallet approval transaction. Try again or choose another token.");if(!window.solanaWeb3?.VersionedTransaction)throw new Error("Solana wallet signing library did not load. Refresh the page and try again.");if(typeof t.signTransaction!="function")throw new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const a=window.solanaWeb3.VersionedTransaction.deserialize(_u(e)),r=await Du(t,a);return Wu(r.serialize())}async function Gy(e,t){if(!e||typeof e!="string")throw new Error("SlimeWire could not build a wallet approval transaction. Try again.");if(!window.solanaWeb3?.Transaction)throw new Error("Solana wallet signing library did not load. Refresh the page and try again.");if(typeof t.signTransaction!="function")throw new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const a=window.solanaWeb3.Transaction.from(_u(e)),r=await Du(t,a);return Wu(r.serialize())}function Xy({side:e,connected:t,form:a={},actionDetail:r="",amountSol:s="",amountMode:o="",percent:c=""}={}){const l=e==="sell"?"Sell":"Buy",d=`${t?.provider||"Connected wallet"} ${t?.publicKey?w(t.publicKey):""}`.trim(),u=e==="sell"?`${c||r||"100"}%`:o==="max"?"Max SOL":`${s||r||"custom"} SOL`;return Me({title:`Confirm ${l}`,lines:[`${l} with ${d}?`,`Token: ${a.tokenMint||""}`,`Amount: ${u}`,"Next step: approve the transaction in your wallet."],confirmLabel:l})}async function dr({side:e,form:t,actionDetail:a,amountSol:r="",amountMode:s="",percent:o="",attemptId:c,statusWriter:l=ye}){const d=typeof l=="function"?l:ye,{provider:u,connected:p}=await Nu();if(!n.walletFastApprovalsEnabled&&!await Xy({side:e,connected:p,form:t,actionDetail:a,amountSol:r,amountMode:s,percent:o}))throw new Error("Connected-wallet trade cancelled.");Tm(`${e==="buy"?"Buy":"Sell"} ${w(t.tokenMint||"")}`),Ie("submitted","pending"),d(n.walletFastApprovalsEnabled?`Building ${e} approval for ${p.provider||"your wallet"}...`:`Preparing ${e} approval...`);const f=await k("/api/web/browser-trade/order",{method:"POST",body:JSON.stringify({side:e,tokenMint:t.tokenMint,walletPublicKey:p.publicKey,slippageBps:t.slippageBps,amountSol:r,amountMode:s,percent:o,tradeAttemptId:c}),dedupe:!1,timeoutMs:ae});Ie("submitted","ok"),Ie("approved","pending",`Approve in ${p.provider||"your wallet"}`),d(`Approve ${e} in ${p.provider||"your wallet"}...`);let y;try{y=await jy(f.order?.transaction,u)}catch(v){throw Ie("approved","fail",N(v?.message||"Wallet approval was declined.")),v}Ie("approved","ok"),Ie("sent","pending"),d("Submitting signed trade...");let b;try{b=await k("/api/web/browser-trade/execute",{method:"POST",body:JSON.stringify({browserTradeAttemptId:f.order?.browserTradeAttemptId,signedTransaction:y}),dedupe:!1,timeoutMs:ae})}catch(v){throw z(e==="buy"?"trade-buy":"trade-sell",t.tokenMint,a,{state:"error",error:N(v?.message||"Trade submit failed.")}),V("",`browser-${e}-error`,{tradeAttemptId:c}),Ie("sent","fail",N(v?.message||"Submit failed - it may still have landed; positions are being re-checked.")),d(`${e==="buy"?"Buy":"Sell"} submit failed or timed out - re-checking your wallet in case the trade landed...`),v}return Ie("sent","ok"),Ie("confirmed",b.trade?.signature?"ok":"pending",b.trade?.signature?`tx ${String(b.trade.signature).slice(0,8)}...`:""),n.tradeResult=b.trade,d(b.trade?.message||`${e==="buy"?"Buy":"Sell"} submitted from connected wallet.`),z(e==="buy"?"trade-buy":"trade-sell",t.tokenMint,a,{state:"submitted",signature:b.trade?.signature||""}),V(b.trade?.signature,`browser-${e}`,{tradeAttemptId:c}),b.trade}function Ke(e){const t=String(e||"").trim().toLowerCase();return!!t&&!["0","off","none","no","disabled"].includes(t)}function pn(e,t){const a=String(t||"").trim().toLowerCase();return["0","off","none","no","disabled"].includes(a)?{sellDelay:"off",sellPercent:"100"}:{sellDelay:e,sellPercent:t}}function Jy(){const e=x("[data-trade-auto-tp]","[data-trade-auto-tp-custom]","25"),t=x("[data-trade-auto-sl]","[data-trade-auto-sl-custom]","8");let a=x("[data-trade-auto-delay]","[data-trade-auto-delay-custom]","off"),r=x("[data-trade-auto-sell-percent]","[data-trade-auto-sell-percent-custom]","100");return{sellDelay:a,sellPercent:r}=pn(a,r),{enabled:Ke(e)||Ke(t)||Ke(a),takeProfitPct:e,stopLossPct:t,sellDelay:a,sellPercent:r}}function Uu(){const e=x("[data-chart-buy-tp]","[data-chart-buy-tp-custom]","25"),t=x("[data-chart-buy-sl]","[data-chart-buy-sl-custom]","8");let a=x("[data-chart-buy-delay]","[data-chart-buy-delay-custom]","off"),r=x("[data-chart-buy-sell-percent]","[data-chart-buy-sell-percent-custom]","100");return{sellDelay:a,sellPercent:r}=pn(a,r),{enabled:Ke(e)||Ke(t)||Ke(a),takeProfitPct:e,stopLossPct:t,sellDelay:a,sellPercent:r}}function ye(e){const t=m("[data-trade-status]");S(t,e)}function Ne(e=""){n.chartTradeStatus=String(e||""),S(m("[data-chart-trade-status]"),n.chartTradeStatus)}function Zi(e="",t=""){n.quickBuyModal={...n.quickBuyModal,status:String(e||""),error:String(t||"")};const a=m("[data-quick-buy-modal-status]"),r=m("[data-quick-buy-modal-error]");S(a,n.quickBuyModal.status),S(r,n.quickBuyModal.error),a&&(a.hidden=!n.quickBuyModal.status),r&&(r.hidden=!n.quickBuyModal.error)}async function Is(e,t="fixed"){const a=L();let r=t==="max"?"max":String(e||"custom"),s="";try{let o=Ou("buy");r=t==="max"?"max":String(e||"custom");const c=ot("trade-buy",o.tokenMint,r);if(c){se("buttonDoubleClickPrevented"),W({component:"post-trade",action:"trade-action-dedupe",durationMs:L()-a,cacheHit:!0,requestId:c.tradeAttemptId||"",details:`trade-buy:${w(o.tokenMint)}:${r}`});return}s=wt("trade-buy");const l={tokenMint:o.tokenMint,walletIndex:o.walletIndex,slippageBps:o.slippageBps,tradeAttemptId:s},d=Xu();if((Ke(d.takeProfitPct)||Ke(d.stopLossPct)||Ke(d.sellDelay))&&Object.assign(l,{autoExit:!0,...d}),t==="max")l.amountMode="max";else{const v=Number(e);if(!Number.isFinite(v)||v<=0)throw new Error("Enter a buy amount greater than zero.");l.amountSol=String(v)}if(o=Rs(o,{side:"buy",statusWriter:ye}).form,l.walletIndex=o.walletIndex,pe(o.walletIndex)){z("trade-buy",o.tokenMint,r,{state:"clicked",tradeAttemptId:s,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"browser-trade-click-to-ui",durationMs:L()-a,requestId:s,details:`browser-buy:${w(o.tokenMint)}:${r}`}),ye("Building wallet-approved buy..."),de(),await dr({side:"buy",form:o,actionDetail:r,amountSol:l.amountSol||"",amountMode:l.amountMode||"fixed",attemptId:s}),n.activeTab="trade",h({preserveSmartChartFrame:n.activeTab==="smartChart"}),Le("trade-buy",o.tokenMint,r,3e3);return}const f=Jy();f.enabled&&Object.assign(l,{autoExit:!0,takeProfitPct:f.takeProfitPct,stopLossPct:f.stopLossPct,sellDelay:f.sellDelay,sellPercent:f.sellPercent}),z("trade-buy",o.tokenMint,r,{state:"clicked",tradeAttemptId:s,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"trade-click-to-ui",durationMs:L()-a,requestId:s,details:`trade-buy:${w(o.tokenMint)}:${r}`}),h(),ye(f.enabled?"Sending buy and arming auto-exit...":"Sending buy..."),await xe(20);const y=L();z("trade-buy",o.tokenMint,r,{state:"submitting"});const b=await k("/api/web/trade/buy",{method:"POST",body:JSON.stringify({...l,clientClickToUiMs:Math.round(y-a)}),dedupe:!1});W({component:"post-trade",action:"trade-backend-ack",durationMs:L()-y,requestId:s,resultCount:b.trade?.signature?1:0,details:"trade-buy"}),n.tradeResult=b.trade,Tm(`Buy ${w(o.tokenMint||"")}`),Ie("submitted","ok"),Ie("sent","ok"),Ie("confirmed",b.trade?.signature?"ok":"pending",b.trade?.signature?`tx ${String(b.trade.signature).slice(0,8)}...`:""),b.trade?.autoExitPlan?(Ie("armed","ok"),n.tradePlanResult=b.trade.autoExitPlan,ye(b.trade.autoExitPlan.shortMessage||"Buy landed and auto-exit is armed."),xs()):b.trade?.autoExitRequested&&(Ie("armed","fail","Auto-exit was NOT armed - exit manually or create a managed plan."),ye("Buy landed, but auto-exit was not armed. Use Positions to exit manually or create a managed plan.")),z("trade-buy",o.tokenMint,r,{state:"submitted",signature:b.trade?.signature||""}),V(b.trade?.signature,"trade-buy",{tradeAttemptId:s}),n.activeTab="trade",h(),Le("trade-buy",o.tokenMint,r,3e3)}catch(o){s&&(z("trade-buy",n.tradeToken||m("[data-trade-token]")?.value||"",r,{state:"error",error:N(o.message||"Buy failed")}),Le("trade-buy",n.tradeToken||m("[data-trade-token]")?.value||"",r,4e3)),W({component:"post-trade",action:"trade-action-error",durationMs:L()-a,requestId:s,errorCode:o?.code||o?.name||"TRADE_BUY_FAILED",details:N(o.message||"Buy failed")}),ye(o.message)}}async function el(e){const t=L(),a=wt("manual-sell");let r=null,s=String(e||"custom");try{r=Ou("sell");const o=Number.parseInt(e,10);if(s=String(o||s),!Number.isInteger(o)||o<1||o>100)throw new Error("Sell percent must be from 1 to 100.");const c=ot("trade-sell",r.tokenMint,s);if(c){se("buttonDoubleClickPrevented"),W({component:"manual-sell",action:"manual-sell-dedupe",durationMs:L()-t,cacheHit:!0,requestId:c.tradeAttemptId||"",details:`${w(r.tokenMint)}:${o}`});return}if(z("trade-sell",r.tokenMint,s,{state:"clicked",tradeAttemptId:a,clickedAt:new Date().toISOString()}),ye("Sending sell..."),W({component:"manual-sell",action:"manual-sell-click-to-ui",durationMs:L()-t,requestId:a,details:`${w(r.tokenMint)}:${o}`}),r=Rs(r,{side:"sell",statusWriter:ye}).form,pe(r.walletIndex)){de();const p=L();z("trade-sell",r.tokenMint,s,{state:"submitting"}),await dr({side:"sell",form:r,actionDetail:s,percent:String(o),attemptId:a}),W({component:"manual-sell",action:"browser-sell-request",durationMs:L()-p,requestId:a,resultCount:n.tradeResult?.signature?1:0,details:"browser-wallet"}),n.activeTab="trade",h({preserveSmartChartFrame:n.activeTab==="smartChart"}),Le("trade-sell",r.tokenMint,s,3e3);return}h(),await xe(20);const d=L();z("trade-sell",r.tokenMint,s,{state:"submitting"});const u=await k("/api/web/trade/sell",{method:"POST",body:JSON.stringify({tokenMint:r.tokenMint,walletIndex:r.walletIndex,slippageBps:r.slippageBps,percent:o,manualSellAttemptId:a,clientClickToUiMs:Math.round(d-t)}),timeoutMs:ae,dedupe:!1});W({component:"manual-sell",action:"manual-sell-request",durationMs:L()-d,requestId:a,resultCount:u.trade?.signature?1:0,details:"single-wallet"}),n.tradeResult=u.trade,ye(u.trade?.signature?"Submitted. Refreshing position in the background...":"Sell submitted. Refreshing position in the background..."),z("trade-sell",r.tokenMint,s,{state:"submitted",signature:u.trade?.signature||""}),V(u.trade?.signature||Be(u.trade),"manual-sell-trade"),n.activeTab="trade",h(),Le("trade-sell",r.tokenMint,s,3e3)}catch(o){r?.tokenMint&&(z("trade-sell",r.tokenMint,s,{state:"error",error:N(o.message||"Sell failed")}),Le("trade-sell",r.tokenMint,s,4e3)),W({component:"manual-sell",action:"manual-sell-error",durationMs:L()-t,requestId:a,errorCode:o?.code||o?.name||"MANUAL_SELL_FAILED",details:N(o.message||"Sell failed")}),ye(o.message)}}function Yy(){const e=Ve("trade-plan"),t=m("[data-trade-plan-group]")?.value?.trim()||"",a=m("[data-trade-token]")?.value?.trim()||"",r=x("[data-trade-plan-amount]","[data-trade-plan-amount-custom]","0.1"),s=x("[data-trade-plan-tp]","[data-trade-plan-tp-custom]","25"),o=x("[data-trade-plan-sl]","[data-trade-plan-sl-custom]","8");let c=x("[data-trade-plan-delay]","[data-trade-plan-delay-custom]","5"),l=x("[data-trade-plan-sell-percent]","[data-trade-plan-sell-percent-custom]","100");({sellDelay:c,sellPercent:l}=pn(c,l));const d=x("[data-trade-plan-slippage]","[data-trade-plan-slippage-custom]","400");if(!e.length&&!t)throw new Error("Choose at least one wallet or enter a group label.");if(!a)throw new Error("Paste a token CA first.");return n.tradeToken=a,n.volumeToken=a,n.bundleToken=a,{walletIndexes:e,walletGroup:t,tokenMint:a,amountSol:r,sellDelay:c,takeProfitPct:s,stopLossPct:o,sellPercent:l,loopCount:"1",loopDelay:"0",slippageBps:d,...ga("trade-plan")}}async function Qy(){try{const e=Yy();ye("Buying and arming managed exit...");const t=await k("/api/web/trade/plan",{method:"POST",body:JSON.stringify(e)});n.tradePlanResult=t.plan,n.tradeResult=null,V(t.trade?.signature,"trade-plan"),n.activeTab="trade",h()}catch(e){ye(e.message)}}function Zy(){const e=Ve("volume"),t=m("[data-volume-group]")?.value?.trim()||"",a=m("[data-volume-token]")?.value?.trim()||"",r=m("[data-volume-amount]")?.value||"";let s=x("[data-volume-delay]","[data-volume-delay-custom]","5");const o=x("[data-volume-tp]","[data-volume-tp-custom]","25"),c=x("[data-volume-sl]","[data-volume-sl-custom]","8"),l=x("[data-volume-loop]","[data-volume-loop-custom]","1"),d=x("[data-volume-loop-delay]","[data-volume-loop-delay-custom]","0");let u=x("[data-volume-sell-percent]","[data-volume-sell-percent-custom]","100");({sellDelay:s,sellPercent:u}=pn(s,u));const p=x("[data-volume-slippage]","[data-volume-slippage-custom]","400");if(!e.length&&!t)throw new Error("Choose at least one wallet or enter a group label.");if(!a)throw new Error("Paste a token CA first.");return n.volumeToken=a,{walletIndexes:e,walletGroup:t,tokenMint:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,loopCount:l,loopDelay:d,sellPercent:u,slippageBps:p,...ga("volume")}}function qu(e){const t=m("[data-volume-status]");S(t,e)}async function ev(){try{const e=Zy();qu("Buying and arming plan...");const t=await k("/api/web/volume/plan",{method:"POST",body:JSON.stringify(e)});n.volumeResult=t.plan,V(Be(t.plan),"volume-plan"),n.activeTab="volume",h()}catch(e){qu(e.message)}}function tv(e){const t=Ve("sniper"),a=m("[data-sniper-group]")?.value?.trim()||"",r=m("[data-sniper-amount]")?.value||"",s=x("[data-sniper-delay]","[data-sniper-delay-custom]",n.scanMode==="pumpsnipe"?"3":"5"),o=x("[data-sniper-tp]","[data-sniper-tp-custom]",n.scanMode==="pumpsnipe"?"40":"25"),c=x("[data-sniper-sl]","[data-sniper-sl-custom]","8"),l=x("[data-sniper-loop]","[data-sniper-loop-custom]","1"),d=x("[data-sniper-loop-delay]","[data-sniper-loop-delay-custom]","0"),u=x("[data-sniper-slippage]","[data-sniper-slippage-custom]",n.scanMode==="pumpsnipe"?"300":"400");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!e)throw new Error("Pick a token first.");return n.tradeToken=e,n.volumeToken=e,n.bundleToken=e,{mode:n.scanMode,tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,slippageBps:u,loopCount:l,loopDelay:d,...ga("sniper")}}function Hu(e){const t=m("[data-sniper-status]");S(t,e)}async function av(e){try{const t=tv(e);Hu("Buying and arming exits...");const a=await k("/api/web/sniper/entry",{method:"POST",body:JSON.stringify(t)});n.sniperResult=a.plan,V(Be(a.plan),"sniper-entry"),n.activeTab="sniper",h()}catch(t){Hu(t.message)}}function nv(){const e=Ve("ogre-ai"),t=m("[data-ogre-ai-group]")?.value?.trim()||"",a=m("[data-ogre-ai-amount]")?.value?.trim()||"",r=fs(),s=m("[data-ogre-ai-runs]")?.value||"1",o=m("[data-ogre-ai-tp]")?.value||"25",c=m("[data-ogre-ai-tp-custom]")?.value?.trim()||"",l=m("[data-ogre-ai-sl]")?.value||"8",d=m("[data-ogre-ai-sl-custom]")?.value?.trim()||"",u=m("[data-ogre-ai-delay]")?.value||"5",p=m("[data-ogre-ai-delay-custom]")?.value?.trim()||"",f=m("[data-ogre-ai-slippage]")?.value||"400",y=m("[data-ogre-ai-slippage-custom]")?.value?.trim()||"";uf({amountSol:a,runCount:s,category:r,takeProfitSelect:o,takeProfitCustom:c,stopLossSelect:l,stopLossCustom:d,delaySelect:u,delayCustom:p,slippageSelect:f,slippageCustom:y,walletGroup:t});const b=x("[data-ogre-ai-delay]","[data-ogre-ai-delay-custom]","60"),v=x("[data-ogre-ai-tp]","[data-ogre-ai-tp-custom]","100"),P=x("[data-ogre-ai-sl]","[data-ogre-ai-sl-custom]","40"),A=x("[data-ogre-ai-slippage]","[data-ogre-ai-slippage-custom]","400"),g="";if(!e.length&&!t)throw new Error("Choose at least one managed wallet or enter a group label.");if(!a)throw new Error("Enter SOL per wallet for Ogre A.I.");return{walletIndexes:e,walletGroup:t,category:r,mode:r,amountSol:a,runCount:s,sellDelay:b,takeProfitPct:v,stopLossPct:P,sellPercent:"100",slippageBps:A,minScore:g,recentMints:ac()}}function Os(e){n.ogreAiStatus=e||"";const t=m("[data-ogre-ai-status]");S(t,n.ogreAiStatus)}async function rv(){if(Kr){Ua=!0,Os("Stopping the hunt after this scan...");return}const e=Symbol("ogre-ai-run");Ua=!1;try{const t=nv();n.ogreAiLoading=!0,Kr=e;const a=Array.isArray(t.recentMints)?[...t.recentMints]:[];let r=null,s=!1,o=0;const c=120;for(;!s&&!Ua&&o<c&&(o+=1,Os(o===1?"Scanning fresh low-MC pairs and arming managed exits...":`Hunting fresh pairs... (scan ${o}) - tap Scan again to stop.`),h(),r=await k("/api/web/ogre-ai/start",{method:"POST",body:JSON.stringify({...t,recentMints:a}),timeoutMs:ae}),s=Number(r.ogreAi?.armedCount||0)>0||(r.ogreAi?.plans?.length||0)>0,!s);){for(const l of r.ogreAi?.errors||[])l?.tokenMint&&!a.includes(l.tokenMint)&&a.push(l.tokenMint);for(const l of r.ogreAi?.attemptedPicks||[])l?.tokenMint&&!a.includes(l.tokenMint)&&a.push(l.tokenMint);if(Ua)break;await xe(5e3)}n.ogreAiResult=r?.ogreAi,df(r?.ogreAi),n.tradePlanResult=r?.ogreAi?.plans?.[0]||n.tradePlanResult,Os(s?r?.ogreAi?.message||"Ogre A.I. run armed.":Ua?"Hunt stopped. Tap Scan to hunt again.":"Still hunting - no clean fresh pair armed yet. Tap Scan to keep going."),s&&V(Be(r?.ogreAi?.plans?.[0]),"ogre-ai-run"),n.activeTab="ogreAi",h()}catch(t){Os(t.message),T(t.message)}finally{n.ogreAiLoading=!1,Ua=!1,Kr===e&&(Kr=null),h()}}function ur(e){const t=m("[data-autopilot-status]");t&&(t.textContent=String(e||""))}async function sv({silent:e=!0}={}){try{const t=await k("/api/web/ogre-ai/autopilot");n.ogreAutopilot=t.autopilot||null,n.activeTab==="ogreAi"&&h()}catch(t){e||ur(t.message)}}function ov(){return{enabled:!!m("[data-autopilot-enabled]")?.checked,category:fs(),amountSol:m("[data-ogre-ai-amount]")?.value?.trim()||(n.ogreAutopilot?.amountSol??"0.05"),takeProfitPct:x("[data-ogre-ai-tp]","[data-ogre-ai-tp-custom]","25"),stopLossPct:x("[data-ogre-ai-sl]","[data-ogre-ai-sl-custom]","8"),sellDelay:x("[data-ogre-ai-delay]","[data-ogre-ai-delay-custom]","5"),slippageBps:x("[data-ogre-ai-slippage]","[data-ogre-ai-slippage-custom]","400"),walletIndexes:Ve("ogre-ai"),walletGroup:m("[data-ogre-ai-group]")?.value?.trim()||"",maxSpendPerHourSol:m("[data-autopilot-maxspend]")?.value?.trim()||"0.3",maxConcurrent:m("[data-autopilot-maxconcurrent]")?.value?.trim()||"2",minScore:m("[data-autopilot-minscore]")?.value?.trim()||"62",intervalMinutes:m("[data-autopilot-interval]")?.value?.trim()||"10"}}async function iv(){if(n.ogreAutopilotBusy)return;const e=ov();if(e.enabled&&!e.walletIndexes.length&&!e.walletGroup){ur("Pick at least one managed wallet (or a wallet group) above before enabling autopilot.");return}if(!(e.enabled&&!await Me({title:"Enable Ogre A.I. Autopilot",lines:["This will spend REAL SOL automatically.",`Category: ${nu(e.category)}`,`Up to ${e.amountSol} SOL per wallet, max ${e.maxSpendPerHourSol} SOL/hour, every ${e.intervalMinutes} min.`,`Only buys picks scoring >= ${e.minScore}, max ${e.maxConcurrent} live plans.`,"You can turn it off any time."],confirmLabel:"Enable Autopilot"}))){n.ogreAutopilotBusy=!0,ur(e.enabled?"Arming autopilot...":"Saving..."),h();try{const t=await k("/api/web/ogre-ai/autopilot",{method:"POST",body:JSON.stringify(e)});n.ogreAutopilot=t.autopilot||null,ur(n.ogreAutopilot?.lastStatus||"Saved.")}catch(t){ur(t.message),T(t.message)}finally{n.ogreAutopilotBusy=!1,h()}}}function Kt(e){const t=m("[data-kol-status]");S(t,e)}function lv(e){const t=Ve("kol"),a=m("[data-kol-group]")?.value?.trim()||"",r=m("[data-kol-amount]")?.value||"",s=x("[data-kol-delay]","[data-kol-delay-custom]","5"),o=x("[data-kol-tp]","[data-kol-tp-custom]","25"),c=x("[data-kol-sl]","[data-kol-sl-custom]","8"),l=x("[data-kol-loop]","[data-kol-loop-custom]","1"),d=x("[data-kol-loop-delay]","[data-kol-loop-delay-custom]","0"),u=x("[data-kol-slippage]","[data-kol-slippage-custom]","400");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!e)throw new Error("Pick a KOL signal first.");return n.tradeToken=e,n.volumeToken=e,n.bundleToken=e,{tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,loopCount:l,loopDelay:d,sellPercent:"100",slippageBps:u,...ga("kol")}}function cv(e){const t=Ve("kol"),a=m("[data-kol-group]")?.value?.trim()||"",r=m("[data-kol-amount]")?.value||"",s=x("[data-kol-delay]","[data-kol-delay-custom]","5"),o=x("[data-kol-tp]","[data-kol-tp-custom]","25"),c=x("[data-kol-sl]","[data-kol-sl-custom]","8"),l=x("[data-kol-loop]","[data-kol-loop-custom]","1"),d=x("[data-kol-loop-delay]","[data-kol-loop-delay-custom]","0"),u=x("[data-kol-slippage]","[data-kol-slippage-custom]","400"),p=String(e||n.kolWallet||m("[data-kol-wallet]")?.value||"").trim();if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!p)throw new Error("Paste or choose a KOL wallet first.");if(!Ut(p))throw new Error("That KOL entry does not have a verified Solana wallet yet.");return{copyWallet:p,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,loopCount:l,loopDelay:d,sellPercent:"100",slippageBps:u,...ga("kol")}}async function dv(e){try{const t=lv(e);Kt("Buying and arming KOL copy plan...");const a=await k("/api/web/kol/entry",{method:"POST",body:JSON.stringify(t)});n.kolResult=a.plan,V(Be(a.plan),"kol-copy-plan"),n.activeTab="kol",h()}catch(t){Kt(t.message)}}async function uv(e){try{const t=cv(e);Kt("Arming Copy Wallet watch...");const a=await k("/api/web/kol/copy-wallet",{method:"POST",body:JSON.stringify(t)});n.kolResult=a.plan,n.kolWallet=t.copyWallet,n.activeTab="kol",h()}catch(t){Kt(t.message)}}function Ve(e){return[...document.querySelectorAll(`[data-${e}-wallet]:checked`)].map(t=>t.value)}function Es(e){const t=m("[data-bundle-status]");S(t,e)}function Ku(){const e=m("[data-bundle-token]")?.value?.trim()||"",t=Ve("bundle"),a=m("[data-bundle-group]")?.value?.trim()||"",r=m("[data-bundle-amount]")?.value||"",s=x("[data-bundle-percent]","[data-bundle-percent-custom]","100"),o=x("[data-bundle-slippage]","[data-bundle-slippage-custom]","400");if(!e)throw new Error("Paste a token CA first.");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");return n.bundleToken=e,{tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,percent:s,slippageBps:o}}function pv(){const e=Ku();let t=x("[data-bundle-plan-delay]","[data-bundle-plan-delay-custom]","5"),a=x("[data-bundle-plan-sell-percent]","[data-bundle-plan-sell-percent-custom]","100");return{sellDelay:t,sellPercent:a}=pn(t,a),{...e,sellDelay:t,takeProfitPct:x("[data-bundle-plan-tp]","[data-bundle-plan-tp-custom]","60"),stopLossPct:x("[data-bundle-plan-sl]","[data-bundle-plan-sl-custom]","10"),loopCount:x("[data-bundle-plan-loop]","[data-bundle-plan-loop-custom]","1"),loopDelay:x("[data-bundle-plan-loop-delay]","[data-bundle-plan-loop-delay-custom]","0"),sellPercent:a,...ga("bundle-plan")}}async function Vu(e){const t=L();let a=null,r="";const s=e==="buy"?"bundle-buy":"bundle-sell";try{a=Ku();const o=ot(s,a.tokenMint,"bundle");if(o){se("buttonDoubleClickPrevented"),W({component:"post-trade",action:"trade-action-dedupe",durationMs:L()-t,cacheHit:!0,requestId:o.tradeAttemptId||"",details:`${s}:${w(a.tokenMint)}`});return}r=wt(s),z(s,a.tokenMint,"bundle",{state:"clicked",tradeAttemptId:r,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"trade-click-to-ui",durationMs:L()-t,requestId:r,details:`${s}:${w(a.tokenMint)}`}),h(),Es(e==="buy"?"Sending bundle buy...":"Sending bundle sell..."),await xe(20);const c=L();z(s,a.tokenMint,"bundle",{state:"submitting"});const l=await k(`/api/web/bundle/${e}`,{method:"POST",body:JSON.stringify({...a,tradeAttemptId:r,clientClickToUiMs:Math.round(c-t)}),dedupe:!1});W({component:"post-trade",action:"trade-backend-ack",durationMs:L()-c,requestId:r,resultCount:l.bundle?.successCount||0,details:s}),n.bundleResult=l.bundle,z(s,a.tokenMint,"bundle",{state:"submitted",signature:Be(l.bundle)}),V(Be(l.bundle),`bundle-${e}`,{tradeAttemptId:r}),n.activeTab="bundle",h(),Le(s,a.tokenMint,"bundle",3e3)}catch(o){a?.tokenMint&&(z(s,a.tokenMint,"bundle",{state:"error",error:N(o.message||"Bundle trade failed")}),Le(s,a.tokenMint,"bundle",4e3)),W({component:"post-trade",action:"trade-action-error",durationMs:L()-t,requestId:r,errorCode:o?.code||o?.name||"BUNDLE_TRADE_FAILED",details:N(o.message||"Bundle trade failed")}),Es(o.message)}}async function mv(){try{const e=pv();Es("Buying and arming bundle exits...");const t=await k("/api/web/bundle/plan",{method:"POST",body:JSON.stringify(e)});n.bundleResult=t.plan,V(Be(t.plan),"bundle-plan"),n.activeTab="bundle",h()}catch(e){Es(e.message)}}function le(e,t){return(n.presets?.[e]||[]).find(a=>a.id===t)||null}function zu(){(n.selectedTradePresetId==="custom"||n.selectedTradePresetId&&!le("trade",n.selectedTradePresetId))&&(n.selectedTradePresetId=""),(n.selectedBundlePresetId==="custom"||n.selectedBundlePresetId&&!le("bundle",n.selectedBundlePresetId))&&(n.selectedBundlePresetId=""),n.editingTradePresetId&&!le("trade",n.editingTradePresetId)&&(n.editingTradePresetId=""),n.editingBundlePresetId&&!le("bundle",n.editingBundlePresetId)&&(n.editingBundlePresetId="")}function ju(e,t="trade",a=""){t==="bundle"?n.bundleToken=e:n.tradeToken=e,n.activeTab=t,a&&T(a),window.history.pushState({},"","/terminal"),h({force:!0})}async function Gu(e=""){const t=String(e||"").trim();if(!t)return;const a=t.replace(/^\$+/,"").trim(),r=/^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(a),s=(o,c={})=>Tt(ve(o,{source:"global-search",...c}),{defaultTab:"buy",view:"chartTxns",focusAmountInput:!0,source:"global-search"});if(r){s(a);return}try{const c=((await k(`/api/web/token-search?q=${encodeURIComponent(t)}`)).matches||[])[0];if(!c?.tokenMint){T(`No coin found for "${t}". Try the exact ticker or paste the contract address.`);return}s(c.tokenMint,{symbol:c.symbol,name:c.name})}catch(o){T(o.message||"Token search failed.")}}function ve(e="",t={}){const a=String(e||"").trim(),r=a?pr().find(s=>String(s?.tokenMint||"")===a):null;return{chain:"solana",tokenMint:a,tokenAddress:a,mint:a,pairAddress:r?.pairAddress||r?.pairId||t.pairAddress||"",symbol:r?.symbol||t.symbol||w(a),name:r?.name||t.name||"Token",imageUri:r?.imageUrl||t.imageUri||"",source:t.source||r?.source||r?.category||"",dex:r?.dexId||t.dex||"",pool:r?.pool||t.pool||"",pumpUrl:r?.pumpUrl||t.pumpUrl||"",isPump:!!(r?.isPump||t.isPump||a.toLowerCase().endsWith("pump")),graduated:!!(r?.graduated||r?.isGraduated||r?.bonded||r?.isBonded||t.graduated||t.isGraduated||t.bonded||t.isBonded),isGraduated:!!(r?.isGraduated||r?.graduated||r?.bonded||r?.isBonded||t.isGraduated||t.graduated||t.bonded||t.isBonded),bonded:!!(r?.bonded||r?.isBonded||r?.graduated||r?.isGraduated||t.bonded||t.isBonded||t.graduated||t.isGraduated),isBonded:!!(r?.isBonded||r?.bonded||r?.graduated||r?.isGraduated||t.isBonded||t.bonded||t.graduated||t.isGraduated)}}function S0(e={},t={}){return ve(e?.tokenMint||e?.mint||e?.tokenAddress||"",{...t,pairAddress:e?.pairAddress||e?.pairId||t.pairAddress||"",symbol:e?.symbol||t.symbol||"",name:e?.name||t.name||"",imageUri:e?.imageUrl||e?.imageUri||t.imageUri||"",source:t.source||e?.source||e?.category||"",dex:e?.dexId||t.dex||"",pool:e?.pool||t.pool||"",pumpUrl:e?.pumpUrl||t.pumpUrl||"",isPump:e?.isPump||t.isPump,graduated:e?.graduated||e?.isGraduated||e?.bonded||e?.isBonded||t.graduated||t.isGraduated||t.bonded||t.isBonded,isGraduated:e?.isGraduated||e?.graduated||e?.bonded||e?.isBonded||t.isGraduated||t.graduated||t.bonded||t.isBonded,bonded:e?.bonded||e?.isBonded||e?.graduated||e?.isGraduated||t.bonded||t.isBonded||t.graduated||t.isGraduated,isBonded:e?.isBonded||e?.bonded||e?.graduated||e?.isGraduated||t.isBonded||t.bonded||t.graduated||t.isGraduated})}function Fs(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim();return t?(n.smartChartTokenRef={...e,tokenMint:t,tokenAddress:t,mint:t},zs(n.smartChartTokenRef),n.terminalToken=t,n.terminalAutoToken=t,n.tradeToken=t,n.bundleToken=t,n.volumeToken=t,n.smartChartToken=t,t):""}function fv(e,t={}){const a=new URLSearchParams;a.set("token",e);const r=t.defaultTab==="sell"?"sell":t.defaultTab==="chart"?"chart":"buy";return a.set("tab",r),["chart","chartTxns","txns","info"].includes(t.view)&&a.set("view",t.view),t.focusAmountInput&&a.set("focusAmount","1"),t.source&&a.set("source",String(t.source).slice(0,40)),t.returnTo&&a.set("returnTo",t.returnTo),`/terminal/chart?${a.toString()}`}function tl(e={}){const t=String(e?.tokenMint||e?.mint||e?.tokenAddress||"").trim(),a=`${e?.source||""} ${e?.category||""} ${e?.dex||""} ${e?.pool||""}`.toLowerCase(),r=!!(e?.isPump||e?.pumpUrl||t.toLowerCase().endsWith("pump")||a.includes("pump")),s=!!(e?.graduated||e?.isGraduated||e?.bonded||e?.isBonded||e?.complete||e?.completed||e?.bondingComplete||e?.raydiumPool||e?.poolAddress);return!!(r&&!s)}function hv(e={},t={}){return["chart","chartTxns","txns","info"].includes(t.view)?t.view:"chartTxns"}const Ws=new Map;function al(e){const t=String(e||"").trim();if(!t)return;const a=Ws.get(t)||0;Date.now()-a<3e4||(Ws.set(t,Date.now()),Ws.size>200&&Ws.clear(),k(`/api/web/prebuy-warm?mint=${encodeURIComponent(t)}`,{method:"GET"}).catch(()=>{}))}function Tt(e={},t={}){oa("chartRouteStart");const a=L(),r=Fs(e);if(!r){T("Select a token before opening the chart.");return}dl(e,{source:t.source||"token-entry"}),al(r),n.chartTradeTab=t.defaultTab==="sell"?"sell":(t.defaultTab==="chart","buy"),n.smartChartView=hv(n.smartChartTokenRef||e,t),n.chartFocusAmountInput=!!t.focusAmountInput,n.chartScrollIntoView=!0,n.activeTab="smartChart",n.route="terminal",n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},n.chartTradeStatus="",n.chartBuyWalletIndex="";const s=fv(r,{defaultTab:t.defaultTab||"buy",view:n.smartChartView,focusAmountInput:t.focusAmountInput,source:t.source||"token-entry",returnTo:t.returnTo||Ja()});window.history.pushState({},"",s),h({force:!0}),K("chart-route-open",a,{component:"smartChart",cacheHit:!!(tt(r)?.cacheHit||hr(r)?.pairAddress),details:`${r}:${t.source||"token-entry"}`})}function nl(){if(!window.location.pathname.includes("/terminal/chart"))return;oa("chartRouteStart");const e=L(),t=new URLSearchParams(window.location.search||""),a=String(t.get("token")||t.get("mint")||"").trim(),r=String(n.smartChartToken||"").trim();if(a){const s=ve(a,{source:t.get("source")||"route"});Fs(s),dl(s,{source:t.get("source")||"route"}),t.get("buy")==="1"&&window.setTimeout(()=>{try{mn(s,{forceModal:!0,source:"deep-link"})}catch{}},900),a!==r&&(n.chartTradeStatus="",n.chartBuyWalletIndex="")}n.chartTradeTab=t.get("tab")==="sell"?"sell":"buy",n.smartChartView=["chart","chartTxns","txns","info"].includes(t.get("view"))?t.get("view"):"chartTxns",n.chartFocusAmountInput=t.get("focusAmount")==="1",n.chartScrollIntoView=!0,n.route="terminal",n.activeTab="smartChart",K("chart-route-apply",e,{component:"smartChart",cacheHit:!!(tt(a)?.cacheHit||hr(a)?.pairAddress),details:a})}function mn(e={},t={}){const a=Fs(e);if(!a){T("Select a token before quick buying.");return}const r=fn(a);if(r&&Ks(r)){T("Safety block: this token has mintable/freezable/honeypot-style risk signals and cannot be quick bought.");return}const s=t.preset||pt(),o=s&&!t.forceModal?ze(s):"",c=s?.walletIndex||(s?.walletIndexes||[])[0]||(n.wallets[0]?.index?String(n.wallets[0].index):"");if(s&&o&&c&&!t.forceModal){Ds(a,{...s,walletIndex:c,walletIndexes:[c]});return}const l=ue();n.quickBuyModal={open:!0,tokenMint:a,amountSol:o||n.quickBuyAmountOverride||"",walletIndex:l?.publicKey?"connected":n.wallets[0]?.index?String(n.wallets[0].index):"",slippageBps:"400",status:o?`Preset ${o} SOL loaded. Confirm when ready.`:s?"Your selected preset has no SOL amount - set one here (or edit the preset in the Trade tab) and Buy becomes one-click.":"Enter a SOL amount to quick buy - or save a Trade preset and Buy becomes one-click.",source:t.source||"quick-buy",error:"",tradeAttemptId:""},al(a),h({force:!0}),requestAnimationFrame(()=>m("[data-quick-buy-modal-amount]")?.focus())}function rl(){n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},h({force:!0})}function gv(e={},t={}){if(!D("protectedBuyEnabled",!0))return;const a=Fs(e);if(!a){T("Select a token before opening Protected Buy.");return}const r=fn(a);if(r&&Ks(r)){T("Safety block: this token has mintable/freezable/honeypot-style risk signals and cannot be bought from quick actions.");return}const s=$a(a)||{tokenMint:a},o=at(s),c=t.presetId||o.protectedBuyPreset||fl(o.verdict),l=Number(Y(t.amountSol||n.quickBuyAmountOverride||ze()||"0.1")),d=c==="conservative"&&Number.isFinite(l)&&l>.25?"0.25":vr(l||.1),u=ue();al(a),n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},n.protectedBuyModal={open:!0,tokenMint:a,presetId:c,amountSol:d,walletIndex:t.walletIndex||(u?.publicKey?"connected":n.wallets[0]?.index?String(n.wallets[0].index):""),slippageBps:String(t.slippageBps||"400"),riskAccepted:!1,status:o.verdict==="AVOID"?"Avoid recommended. Check the risk box if you still want to continue.":"Review this plan before wallet confirmation.",error:"",source:t.source||"protected-buy"},h({force:!0}),requestAnimationFrame(()=>m("[data-protected-buy-amount]")?.focus())}function _s(){n.protectedBuyModal={...n.protectedBuyModal,open:!1,status:"",error:"",riskAccepted:!1},h({force:!0})}function bv(){const e=n.protectedBuyModal||{},t=String(e.tokenMint||"").trim(),a=String(m("[data-protected-buy-preset]")?.value||e.presetId||"conservative").trim(),r=String(m("[data-protected-buy-wallet]")?.value||e.walletIndex||"").trim(),s=Y(m("[data-protected-buy-amount]")?.value||e.amountSol||""),o=String(m("[data-protected-buy-slippage]")?.value||e.slippageBps||"400").trim(),c=!!(m("[data-protected-buy-risk-accept]")?.checked||e.riskAccepted);if(!t)throw new Error("Select a token before Protected Buy.");if(!r)throw new Error("Choose a wallet before Protected Buy.");if(!s)throw new Error("Enter a SOL amount greater than zero.");return{tokenMint:t,presetId:a,walletIndex:r,amountSol:s,slippageBps:o,riskAccepted:c}}function yv(){const e=n.protectedBuyModal||{};if(!e.open)return"";const t=$a(e.tokenMint)||{tokenMint:e.tokenMint},a=at(t),r=Js(e.presetId),s=pe(e.walletIndex),o=a.verdict==="AVOID"&&!e.riskAccepted,c=/submitting|opening wallet/i.test(String(e.status||""));return`
    ...
    <section class="protected-buy-modal" role="dialog" aria-modal="true" aria-label="Protected Buy preview">
      ...
      <div class="protected-buy-grid">
        ...
        <label>
          ...
          <select data-protected-buy-preset>
            ${ml.map(l=>`<option value="${l.id}" ${l.id===r.id?"selected":""}>${i(l.label)}</option>`).join("")}
          </select>
        </label>
        <label>
          Slippage
      ...
      <article class="protected-buy-preview">
        ...
        <small>${i(yw(r))}</small>
        <small>Wallet: ${i(ww(e.walletIndex))}</small>
  ...
  `}function Iv(){const e=eu();if(!e.length)return"";const t=e.length;return`
  ...
  `},{key:"fund",label:"Fund / Sweep",hint:"Move SOL",html:`${xb()}${Iv()}${Lb()}${Rv()}`},{key:"create",label:"Create",hint:"New wallets",html:ls()},{key:"import",label:"Import",hint:"Add keys",html:Od()},{key:"backup",label:"Backup",hint:"Save / restore",html:Id()},{key:"downloads",label:"Downloads",hint:"Exports",html:Ed()}];if(!n.wallets.length){const r=a.filter(s=>s.key!=="balances"&&s.key!=="fund");return`
      ${e}
  ...
  `}function Fv(){return(Array.isArray(n.wallets)?n.wallets:[]).find(t=>t?.sessionWallet&&t?.sessionStatus==="funded")||null}function Wv(){if(!(n.connectedWalletBalance||n.user?.connectedWallet||null)?.publicKey)return"";const t=Fv();return t?`
  ...
  `}function tp(){const e=n.balances.reduce((a,r)=>a+Number(r.tokens?.length||0),0)+rd().length,t=n.balances.filter(a=>a.error).length;return`
  ...
  `}function Nv(e){const t=n.balances.find(o=>Number(o.index)===Number(e.index));if(!t)return"<span>Balance: loading</span>";if(t.error)return`<span>Balance check failed: ${i(t.error)}</span>`;const a=Number.isFinite(Number(t.sol))?`${Number(t.sol).toFixed(4)} SOL`:"SOL unavailable",r=Number(t.tokens?.length||0)===1?"1 token":`${Number(t.tokens?.length||0)} tokens`,s=t.warnings?.length?` | ${t.warnings.length} warning(s)`:"";return`<span>Balance: ${i(a)} | ${i(r)}${i(s)}</span>`}function Dv(){const e=lt(),t=`
    <section class="account-check-card">
      <div>
  ...
  `}async function qv(e){const t=String(e||"").trim();if(!t)return;n.devWatch||(n.devWatch={});const a=!n.devWatch[t];try{const r=await k("/api/web/dev-watch",{method:"POST",body:JSON.stringify({wallet:t,watch:a}),timeoutMs:15e3});n.devWatch[t]=!!r.watching}catch(r){T(r?.message||"Could not update dev watch.")}Ta()}async function Hv(e,t=null){const a=String(e||"").trim();if(!a)return;const r=pt();t&&(t.disabled=!0,t.textContent="Arming...");try{const s=await k("/api/web/positions/arm-exits",{method:"POST",body:JSON.stringify({tokenMint:a,takeProfitPct:r?.takeProfitPct||"40",stopLossPct:r?.stopLossPct||"8",sellDelay:r?.sellDelay||"off",sellPercent:r?.sellPercent||"100",slippageBps:r?.slippageBps||"1000"}),timeoutMs:2e4});Su(a),n.walletRemoveStatus=s.message||"Exits armed.",t&&(t.textContent="✅ Armed"),ku().then(()=>h())}catch(s){T(s?.message||"Could not arm exits."),t&&(t.disabled=!1,t.textContent="Arm Exits")}}async function Kv(){n.bagScan={status:"loading"},h();try{const e=await k("/api/web/shield/scan-bags",{timeoutMs:3e4});n.bagScan={status:"done",bags:e.bags||[]}}catch(e){n.bagScan={status:"error",message:e?.message||""}}h()}function Vv(){const e=`
    <section class="account-check-card">
      <div>
        <h3>PnL / Results</h3>
      ...
      ${n.pnl.tokens.map(t=>`
        <article class="pnl-portfolio-row with-avatar">
          ...
          <div class="card-actions compact">
            ...
            <button data-share-pnl-card="${i(t.tokenMint)}" data-share-text="${i(Wd(t))}">Post</button>
            <a href="${t.dexUrl}" target="_blank" rel="noreferrer">Dex</a>
          </div>
        </article>
      `).join("")}
    </div>
  `:`${e}${F("No PnL yet","Trades made through the bot will show here.")}`}function pr(){return zv(mr())}function mr(){const e=Object.values(n.livePairsByBucket||{}).flatMap(s=>s?.rows||[]),t=n.scan?.rows||[],a=n.kolScan?.rows||[],r=n.watchlist?.rows||[];return[...e,...t,...a,...r]}function fn(e=""){const t=String(e||"");return t&&mr().find(a=>String(a?.tokenMint||"")===t)||null}function k0(e=""){const t=fn(e);return!t||!Ks(t)?!1:(T("Safety block: this feed token has mintable/freezable/honeypot-style risk signals."),!0)}function zv(e=[]){const t=new Map;for(const a of e||[]){if(fr(a))continue;const r=String(a?.tokenMint||"");r&&!t.has(r)&&t.set(r,a)}return[...t.values()]}function we(e=[]){const t=new Map;for(const a of e||[]){if(fr(a))continue;const r=String(a?.tokenMint||"");if(!r)continue;const s=t.get(r);(!s||Hs(a)>Hs(s))&&t.set(r,a)}return[...t.values()]}function Hs(e={}){return aw(e)+Math.min(2,Number(e.bestPickScore||e.score||0)/50)+(O(e.volumeM15,e.volumeM30,e.volumeH1,e.volume5m,e.volumeH24)>0?1:0)}function jv(e={}){const t=[e?.tokenMint,e?.symbol,e?.name,e?.source,e?.category,e?.platform,e?.market,e?.dexId,e?.profileSource,e?.profile?.source,e?.profile?.market,e?.profile?.mode,e?.metadata?.source,e?.metadata?.market,e?.metadata?.mode,e?.dexPair?.dexId,e?.dexPair?.labels,e?.labels,e?.riskFlags].flat().filter(Boolean).join(" ").toLowerCase();return/\bmayhem\b/.test(t)||t.includes("pump mayhem")||t.includes("mayhem mode")}function Ks(e={}){if(jv(e))return!0;const t=[e?.tokenMint,e?.symbol,e?.name,e?.source,e?.category,e?.platform,e?.market,e?.dexId,e?.profileSource,e?.labels,e?.riskFlags,e?.bestPickWarnings,e?.scoreWarnings,e?.safetyNote,e?.tokenProgram,e?.mintAuthority?"mint authority":"",e?.freezeAuthority?"freeze authority":""].flat().filter(Boolean).join(" ").toLowerCase();if(/\b(honeypot|honey\s*pot|mintable|mint authority|freeze authority|freezable|freezeable|blacklist|cannot sell|can't sell|sell disabled|sell blocked|trading disabled|no sell|no route|rug|scam|liquidity pulled|liquidity removed|liquidity drained|lp pulled|lp removed|lp drained|pool drained|no liquidity|liquidity drain|drained liquidity)\b/i.test(t))return!0;const a=O(e.marketCap,e.fdv),r=O(e.liquidityUsd);return a>=1e8&&(!r||r/a<.01)}function fr(e={}){const t=[e?.tokenMint,e?.symbol,e?.name,e?.source,e?.category,e?.platform,e?.market,e?.dexId,e?.profileSource,e?.labels,e?.riskFlags,e?.bestPickWarnings,e?.scoreWarnings,e?.safetyNote].flat().filter(Boolean).join(" ").toLowerCase();if(/\b(honeypot|honey\s*pot|blacklist|rug|scam|mayhem|liquidity pulled|liquidity removed|liquidity drained|lp pulled|lp removed|lp drained|pool drained|liquidity drain|drained liquidity)\b/i.test(t))return!0;const a=O(e.marketCap,e.fdv),r=O(e.liquidityUsd);return a>=1e8&&(!r||r/a<.01)}function ap(){const e=pr(),t=o=>e.find(c=>String(c.tokenMint)===o)||{tokenMint:o,shortMint:w(o),symbol:w(o),dexUrl:Q(o)},a=String(n.terminalToken||n.tradeToken||"").trim();if(a)return t(a);const r=String(n.terminalAutoToken||"").trim();if(r)return t(r);const s=(qe()?.rows||[])[0]||e[0]||null;return s?.tokenMint&&(n.terminalAutoToken=String(s.tokenMint)),s}function Vs(){const e=pr(),t=n.smartChartTokenRef||null,a=s=>e.find(o=>String(o.tokenMint||"")===s)||{...String(t?.tokenMint||"")===s?t:{},tokenMint:s,shortMint:w(s),symbol:t?.symbol||w(s),name:t?.name||"Custom Token",imageUrl:t?.imageUrl||t?.imageUri||"",pairAddress:t?.pairAddress||t?.pairId||"",dexUrl:t?.dexUrl||Q(t?.pairAddress||s),pumpUrl:s.toLowerCase().endsWith("pump")?`https://pump.fun/coin/${encodeURIComponent(s)}`:""},r=String(n.smartChartToken||n.terminalToken||n.tradeToken||"").trim();return op(r?a(r):ap())}function np(e={}){return typeof e=="string"?String(e||"").trim():String(e?.pairAddress||e?.pairId||e?.dexPair?.pairAddress||e?.dexPair?.pairId||e?.tokenMint||e?.mint||"").trim()}const Gv=300*1e3,rp=45*1e3,sp=600*1e3,Xv=700,Jv=6e3,Yv=4,Qv=3e4;function tt(e=""){const t=String(e||"").trim();if(!t)return null;const a=n.smartChartBootstrap?.[t]||null;if(!a)return null;const r=Date.now()-Number(a.loadedAt||a.resolvedAt||0);return a.status==="failed"?r<rp?a:null:r<sp?a:null}function hr(e=""){const t=String(e||"").trim(),a=t?n.smartChartDexResolution?.[t]||tt(t):null;if(!a)return null;const r=Date.now()-Number(a.resolvedAt||0);return a.status==="failed"?r<rp?a:null:r<Gv?a:null}function op(e=null){if(!e)return e;const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim(),a=hr(t);return!a||a.status==="failed"?e:{...e,pairAddress:e.pairAddress||a.pairAddress||"",pairId:e.pairId||a.pairAddress||"",dexUrl:e.dexUrl||a.dexUrl||a.pairUrl||"",dexId:e.dexId||a.dexId||"",dexName:e.dexName||a.dexName||a.dexId||"",symbol:e.symbol||a.symbol||w(t),name:e.name||a.name||"Token",imageUrl:e.imageUrl||a.imageUrl||"",marketCap:e.marketCap||a.marketCap||0,marketCapUsd:e.marketCapUsd||a.marketCap||0,fdv:e.fdv||a.fdv||0,liquidityUsd:e.liquidityUsd||a.liquidityUsd||0,volumeH24:e.volumeH24||a.volumeH24||0,volumeH1:e.volumeH1||a.volumeH1||0,priceUsd:e.priceUsd||a.priceUsd||0,h1:e.h1||a.h1||0,volume:e.volume||a.volume||null,txns:e.txns||a.txns||null}}function ll(e={}){const t=String(e.tokenMint||e.tokenAddress||e.mint||"").trim();if(!t)return;const a=Date.now(),r={...e,tokenMint:t,tokenAddress:t,status:e.errorCode?"failed":"resolved",loadedAt:a,resolvedAt:a};n.smartChartBootstrap={...n.smartChartBootstrap||{},[t]:r},(r.pairAddress||r.dexUrl||r.symbol||r.name)&&zs({...r,mint:t,imageUri:r.imageUrl||r.imageUri||"",dex:r.dexId||r.dexName||""})}function zs(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim(),a=String(e.pairAddress||e.pairId||"").trim();!t||!a&&!e.dexUrl&&!e.symbol&&!e.name||(n.smartChartDexResolution={...n.smartChartDexResolution||{},[t]:{...n.smartChartDexResolution?.[t]||{},tokenMint:t,pairAddress:a,dexUrl:e.dexUrl||Q(a||t),dexId:e.dex||e.dexId||"",symbol:e.symbol||"",name:e.name||"",imageUrl:e.imageUri||e.imageUrl||"",marketCap:Number(e.marketCap??e.marketCapUsd)||n.smartChartDexResolution?.[t]?.marketCap||0,fdv:Number(e.fdv)||n.smartChartDexResolution?.[t]?.fdv||0,liquidityUsd:Number(e.liquidityUsd??e.liquidity?.usd)||n.smartChartDexResolution?.[t]?.liquidityUsd||0,volumeH24:Number(e.volumeH24)||n.smartChartDexResolution?.[t]?.volumeH24||0,volumeH1:Number(e.volumeH1)||n.smartChartDexResolution?.[t]?.volumeH1||0,priceUsd:Number(e.priceUsd)||n.smartChartDexResolution?.[t]?.priceUsd||0,h1:Number(e.h1)||n.smartChartDexResolution?.[t]?.h1||0,status:"resolved",resolvedAt:Date.now()}})}function Zv(e={}){const t=String(e?.tokenMint||n.smartChartToken||"").trim();if(!t)return!1;const a=String(e?.pairAddress||e?.pairId||"").trim();if(a)return zs({...e,tokenMint:t,pairAddress:a}),!1;if(tt(t)?.pairAddress)return!1;const r=hr(t);return r?.pairAddress||r?.status==="failed"?!1:(n.smartChartDexResolving?.[t]||(n.smartChartDexResolving={...n.smartChartDexResolving||{},[t]:!0},window.setTimeout(()=>{cp(t).catch(()=>{})},0)),!0)}function ip(e={},t={}){const a=String(e?.tokenMint||e?.mint||e?.tokenAddress||n.smartChartToken||"").trim();return!a||!t.force&&tt(a)?.status==="resolved"?!1:(n.smartChartBootstrapLoading?.[a]||(n.smartChartBootstrapLoading={...n.smartChartBootstrapLoading||{},[a]:!0},window.setTimeout(()=>{cp(a,{source:t.source||"chart-bootstrap"}).catch(()=>{})},0)),!0)}const cl=new Map;async function lp(e){const t=String(e||"").trim();if(!t)return;const a=cl.get(t)||0;if(Date.now()-a<3e4)return;cl.set(t,Date.now());const r=async()=>{const d=((await(await fetch(`https://api.dexscreener.com/latest/dex/tokens/${encodeURIComponent(t)}`,{cache:"no-store"})).json())?.pairs||[]).filter(u=>u?.chainId==="solana").sort((u,p)=>(Number(p?.liquidity?.usd)||0)-(Number(u?.liquidity?.usd)||0))[0];if(!d)throw new Error("no pair");return d},s=async()=>{const o=await k(`/api/web/pair-lite?mint=${encodeURIComponent(t)}`,{timeoutMs:5e3});if(!o?.pair)throw new Error("no pair");return o.pair};try{const o=await Promise.any([r(),s()]);ll({tokenMint:t,symbol:o.baseToken?.symbol||"",name:o.baseToken?.name||"",priceUsd:o.priceUsd,marketCap:o.marketCap||o.fdv||null,marketCapUsd:o.marketCap||o.fdv||null,fdv:o.fdv||null,liquidityUsd:Number(o.liquidity?.usd)||null,liquidity:{usd:Number(o.liquidity?.usd)||null},volumeH24:Number(o.volume?.h24)||null,volumeH1:Number(o.volume?.h1)||null,h1:Number(o.priceChange?.h1)||null,imageUrl:o.info?.imageUrl||"",dexUrl:o.url||"",pairAddress:o.pairAddress||"",dexId:o.dexId||"",pumpCurve:!!o.pumpCurve,bondingProgressPct:o.bondingProgressPct??null,source:o.pumpCurve?"pump-curve":"direct-dexscreener"}),n.activeTab==="smartChart"&&h({preserveSmartChartFrame:!0})}catch{cl.delete(t)}}function dl(e={},t={}){const a=String(e?.tokenMint||e?.mint||e?.tokenAddress||"").trim();return a?(zs(e),Zh(a,e.symbol||e.name||""),lp(a),ip(e,{source:t.source||"prefetch"}),n.smartChartPrefetchLog=[...n.smartChartPrefetchLog||[],{at:new Date().toISOString(),tokenMint:a,source:t.source||"prefetch",routeChunkPrefetched:!0,metadataPrefetched:!!(e.symbol||e.name||e.imageUri||e.imageUrl),candlesPrefetched:!1,dedupeHit:!!(n.smartChartBootstrapLoading?.[a]||tt(a)),cacheTtlMs:sp}].slice(-20),!0):!1}async function cp(e=""){const t=String(e||"").trim();if(!t)return null;try{const a=L(),r=await k(`/api/web/chart/bootstrap?token=${encodeURIComponent(t)}`,{timeoutMs:4500}),s=r.chart||r.dexToken||{};return ll(s),K("chart-bootstrap",a,{component:"smartChart",cacheHit:!!s.cacheHit,stale:!!s.stale,details:`${t}:${s.chartProvider||"dexscreener-embed"}`}),n.route==="terminal"&&n.activeTab==="smartChart"&&String(n.smartChartToken||"")===t&&h({force:!0}),s}catch(a){return n.smartChartDexResolution={...n.smartChartDexResolution||{},[t]:{tokenMint:t,status:"failed",error:N(a?.message||"DEX pair lookup failed."),resolvedAt:Date.now()}},n.route==="terminal"&&n.activeTab==="smartChart"&&String(n.smartChartToken||"")===t&&h({force:!0}),null}finally{const a={...n.smartChartDexResolving||{}};delete a[t],n.smartChartDexResolving=a;const r={...n.smartChartBootstrapLoading||{}};delete r[t],n.smartChartBootstrapLoading=r}}function ew(e,t={}){const a=np(e),r=new URLSearchParams({embed:"1",theme:"dark",trades:t.trades?"1":"0",info:t.info?"1":"0"});return`https://dexscreener.com/solana/${encodeURIComponent(a)}?${r.toString()}`}let gr=null;function tw(){if(gr!=null)return gr;try{gr=((document.querySelector('script[src*="app.js?v="]')?.getAttribute("src")||"").match(/app\.js\?v=([\w-]+)/)||[])[1]||""}catch{gr=""}return gr}function dp(e={},t="chart"){const a=String(e?.tokenMint||n.smartChartToken||"").trim();if(a){const s=String(e.symbol||"").slice(0,12),o=tw(),c=Ia?`&api=${encodeURIComponent(Ia)}`:"";return`/chart-lab?ca=${encodeURIComponent(a)}&embed=1${s?`&sym=${encodeURIComponent(s)}`:""}${c}${o?`&v=${encodeURIComponent(o)}`:""}`}const r=tt(a);return t==="info"&&r?.infoUrl?r.infoUrl:(t==="chartTxns"||t==="txns")&&(r?.chartTxnsUrl||r?.txnsUrl)?r.chartTxnsUrl||r.txnsUrl:r?.chartUrl?r.chartUrl:ew(e,{trades:t==="chartTxns"||t==="txns",info:t==="info"})}function $0(e={}){const t=String(e?.tokenMint||e?.mint||n.smartChartToken||""),a=bp(t||e?.symbol||"pump"),r=Math.max(1,O(e.marketCap,e.fdv,e.liquidityUsd,1e4)),s=O(e.m5,e.h1,e.priceChange?.m5,e.priceChange?.h1,e.priceChange5m,e.priceChange1h,0),o=Math.max(4,Math.min(96,Vt(e)||O(e.bondingProgressPct,e.pumpProgress,12))),c=Math.max(2,Math.min(22,Math.abs(s)||O(e.volume5m,e.volumeM15,e.volumeH1,0)/Math.max(1,r)*100));return Array.from({length:22},(l,d)=>{const u=Math.sin((d+a%11)/2.2)*c,p=(d/21-.5)*(s||o/3),f=((a>>d%8&7)-3)*.7;return Math.max(1,r*(1+(u+p+f)/100))})}function T0(e={},...t){for(const a of t){const r=Number(e?.[a]);if(Number.isFinite(r)&&r>0)return r;const s=a.split(".").reduce((c,l)=>c?.[l],e),o=Number(s);if(Number.isFinite(o)&&o>0)return o}return 0}function A0(e={},t="chart"){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=t==="txns",s=Math.max(0,Math.min(100,Vt(e)||O(e.bondingProgressPct,e.pumpProgress,0))),o=_(e.marketCapLabel,e.fdvLabel,M(e.marketCap),M(e.fdv)),c=_(e.liquidityLabel,M(e.liquidityUsd)),l=_(e.volumeM15Label,e.volume5mLabel,e.volumeLabel,M(e.volumeM15),M(e.volume5m),M(e.volumeH1));return`
  ...
  `}function cw(e={}){if(!D("slimeShieldEnabled",!0)){const s=Number(e.bestPickScore||e.score||0);return`<em class="mobile-score-mini" title="${i(pl(e))}">${i(s?`${s}`:"n/a")} score</em>`}const t=at(e),a=String(e.tokenMint||t.mint||"").trim(),r=t.verdict||"CAUTION";return`<button type="button" class="mobile-score-mini slimeshield-mini slimeshield-${i(hn(r))}" data-slimeshield-details="${i(a)}" title="${i(t.summary||"Open SlimeShield details")}">Details</button>`}function P0(e={}){if(!D("slimeShieldEnabled",!0)){const s=Number(e.bestPickScore||e.score||0),o=s?`${s}`:"n/a";return`
      <span class="terminal-score-chip" title="${i(pl(e))}">
        <strong>${i(o)}</strong>
        <small>score</small>
      </span>
  ...
  `}function dw(e={}){return D("slimeShieldEnabled",!0)?`SlimeShield ${at(e).verdict||"CAUTION"}`:e.bestPickScore?`Score ${e.bestPickScore}/100`:e.valueLabel||e.smartMoney||""}function uw(e={}){const t=Number(e.bestPickScore||e.score||0),a=e.scoreWarnings||e.bestPickWarnings||[],r=t?`${t}/100`:"n/a";return`
    <span class="score-badge" title="${i(pl(e))}">
      <strong>${i(r)}</strong>
      <small>${a.length?"warnings":"best pick"}</small>
    </span>
  `}function pw(e={}){return lw(e,{compact:!0})}function pl(e={}){const t=e.scoreBreakdown||e.bestPickInputs||{},a=Object.entries(t).map(([s,o])=>`${s}: ${o}`),r=e.scoreWarnings||e.bestPickWarnings||[];return[...a,...r.map(s=>`warning: ${s}`)].join(" | ")||"Score uses available liquidity, volume, age, momentum, buys/sells, KOL, and risk signals."}function mw(e={}){return""}function M(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"n/a":t>=1e6?`$${(t/1e6).toFixed(t>=1e7?0:1)}M`:t>=1e3?`$${(t/1e3).toFixed(t>=1e5?0:1)}K`:`$${Math.round(t)}`}function _(...e){for(const t of e){const a=String(t??"").trim();if(a&&a!=="$0"&&!/^(n\/a|checking|warming|loading|pending|tracking)\.{0,3}$/i.test(a))return a}return"n/a"}function gp(e={}){return[["15m",_(e.volumeM15Label,M(e.volumeM15))],["30m",_(e.volumeM30Label,M(e.volumeM30))],["1h",_(e.volumeH1Label,e.volumeLabel,M(e.volumeH1))],["24h",_(e.volumeH24Label,M(e.volumeH24))]]}function C0(e={}){const t=ft(e),a=ht(e),r=_(e.marketCapLabel,e.fdvLabel,t>0?M(t):"","checking"),s=_(e.liquidityLabel,a>0?M(a):"","checking"),o=gp(e);return`
    <div class="compact-stat-grid">
      <span>MC <b>${i(r)}</b></span>
      <span>Liq <b>${i(s)}</b></span>
      ${o.map(([c,l])=>`<span>${i(c)} <b>${i(l)}</b></span>`).join("")}
    </div>
  `}function fw(e={}){const t=ft(e),a=ht(e),r=_(e.marketCapLabel,e.fdvLabel,t>0?M(t):"","checking"),s=_(e.liquidityLabel,a>0?M(a):"","checking"),o=_(e.volumeM15Label,M(e.volumeM15)),c=_(e.volumeH1Label,e.volumeLabel,M(e.volumeH1));return`
  ...
  `}function wp(e,{source:t,actionLabel:a="Trade",isKolContext:r=!1}={}){const s=uo(e.tokenMint);return`
    ...
    ${r?Pu(e):""}
    <button type="button" class="watch-action" data-watched="${s}" title="${s?"Saved to watchlist":"Watch / save coin"}" data-watch-token="${i(e.tokenMint)}" data-watch-symbol="${i(e.symbol||"")}" data-watch-name="${i(e.name||"")}" data-watch-image="${i(po(e)||"")}">${s?"Saved":"Watch"}</button>
    ${hp(e,{compact:!0})}
  `}function hw(e,t={}){const a=t.limit||6,r=t.actionLabel||"Trade",s=t.emptyTitle||"No signals loaded",o=t.emptyMessage||"Refresh the feed to load current signals.",c=Sa(e||[],a,t.rotateKey||"",t.stickyCount||0),l=t.context==="kol",d=t.cooksStyle?" is-cooks":"";return c.length?`
      ...
      ${c.map((u,p)=>{const f=u.scalpSetup||u.momentum||u.category||"live";return`
          <article class="terminal-token-row${d} ${l?"is-kol-signal":""}" data-token-chart="${i(u.tokenMint)}" data-token-chart-source="terminal-row">
            ...
            <div class="terminal-token-actions has-dev-info">
              ${wp(u,{source:"terminal-row",actionLabel:r,isKolContext:l})}
            </div>
          </article>
        `}).join("")}
    </div>
  `:F(s,o)}function At(e,t={}){if(t.layout==="terminal")return hw(e,t);const a=t.limit||6,r=t.actionLabel||"Trade",s=t.emptyTitle||"No signals loaded",o=t.emptyMessage||"Refresh the feed to load current signals.",c=Sa(e||[],a,t.rotateKey||"",t.stickyCount||0),l=t.context==="kol";return c.length?`
      ...
      ${c.map((d,u)=>`
        <article class="compact-signal-row ${l?"is-kol-signal":""}" data-token-chart="${i(d.tokenMint)}" data-token-chart-source="compact-row">
          ...
          <div class="compact-row-actions has-dev-info">
            ${wp(d,{source:"compact-row",actionLabel:r,isKolContext:l})}
          </div>
        </article>
      `).join("")}
    </div>
  `:F(s,o)}function bn(e){const t=le(e,e==="trade"?n.selectedTradePresetId:n.selectedBundlePresetId);if(!t)return"Custom / manual";const a=[t.name,`${t.amountSol} SOL`,`TP ${t.takeProfitPct}`,`SL ${t.stopLossPct}`];return t.sellDelay&&t.sellDelay!=="off"&&a.push(`Timer ${t.sellDelay}`),a.join(" | ")}function L0(){return`
  ...
  `}function vr(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"":t>=1?t.toFixed(2).replace(/\.?0+$/,""):t.toFixed(3).replace(/0+$/,"").replace(/\.$/,"")}function Y(e=n.quickBuyAmountOverride){let t=String(e||"").replace(/[^0-9.]/g,"");const a=t.indexOf(".");if(a!==-1&&(t=t.slice(0,a+1)+t.slice(a+1).replace(/\./g,"")),!t||t===".")return"";const r=Number(t);return!Number.isFinite(r)||r<=0?"":vr(r)}function pt(){return le("trade",n.selectedTradePresetId)}function gw(){return le("bundle",n.selectedBundlePresetId)}function ze(e=pt()){return Y()||vr(e?.amountSol)}function bw(e=gw()){return Y()||vr(e?.amountSol)||"0.1"}const ml=Object.freeze([{id:"conservative",label:"Conservative",description:"Smaller entry with a simple 2x partial take-profit and wider stop.",takeProfit:[{percentGain:100,sellPercent:50}],stopLoss:{percentLoss:25},sellPercent:"50"},{id:"scalp",label:"Scalp",description:"Fast setup for smaller moves with a tighter stop.",takeProfit:[{percentGain:35,sellPercent:100}],stopLoss:{percentLoss:12},sellPercent:"100"},{id:"degen",label:"Degen",description:"Normal size with a partial 2x exit. Highest variance.",takeProfit:[{percentGain:100,sellPercent:30}],stopLoss:{percentLoss:0},sellPercent:"30"}]);function Js(e=""){return ml.find(t=>t.id===e)||ml[0]}function fl(e=""){return String(e||"").toUpperCase()==="BUY"?"scalp":"conservative"}function yw(e=Js()){const t=Array.isArray(e.takeProfit)?e.takeProfit[0]:null,a=t?`TP +${t.percentGain}% / sell ${t.sellPercent}%`:"TP off",r=e.stopLoss?.percentLoss?`SL -${e.stopLoss.percentLoss}%`:"SL off";return`${a} | ${r}`}function vw(e={},t=Js()){const a=Array.isArray(t.takeProfit)?t.takeProfit[0]:null;return{id:`protected-${t.id}`,name:`Protected ${t.label}`,amountSol:e.amountSol,walletIndex:e.walletIndex,walletIndexes:[e.walletIndex],slippageBps:e.slippageBps||"400",takeProfitPct:a?.percentGain?String(a.percentGain):"0",stopLossPct:t.stopLoss?.percentLoss?String(t.stopLoss.percentLoss):"0",sellDelay:"off",sellPercent:a?.sellPercent?String(a.sellPercent):t.sellPercent||"100"}}function ww(e=""){if(pe(e)){const a=ue();return`${a?.provider||"Browser wallet"} ${a?.publicKey?w(a.publicKey):""}`.trim()}const t=n.wallets.find(a=>String(a.index)===String(e));return t?`${t.index}. ${t.label||"Managed wallet"}`:"No wallet selected"}function Re(){return(!n.terminalLaunchFilters||typeof n.terminalLaunchFilters!="object")&&(n.terminalLaunchFilters={}),n.terminalLaunchFilters.socials=n.terminalLaunchFilters.socials||{},n.terminalLaunchFilters.quotes=n.terminalLaunchFilters.quotes||{},n.terminalLaunchFilters.audits=n.terminalLaunchFilters.audits||{},n.terminalLaunchFilters}function Pt(e=""){const t=new Set;return String(e||"").split(/[\n,]+/).flatMap(a=>String(a||"").trim().split(/\s+/)).map(a=>a.trim().toLowerCase()).filter(a=>!a||t.has(a)?!1:(t.add(a),!0)).slice(0,3)}function Sp(e=Re()){const t=Object.keys(e.socials||{}).filter(s=>e.socials[s]).sort().join(","),a=Object.keys(e.quotes||{}).filter(s=>e.quotes[s]).sort().join(","),r=Object.keys(e.audits||{}).filter(s=>e.audits[s]).sort().join(",");return[Pt(e.keywords).join(","),Pt(e.excludeKeywords).join(","),t,a,r].join("|")}function yn(e=Re()){return!!Sp(e).replace(/\|/g,"")}function Ys(e={}){return[e.tokenMint,e.mint,e.address,e.pairAddress,e.baseMint,e.symbol,e.baseSymbol,e.name,e.tokenName,e.category,e.signalType,e.source,e.dexId,e.dexName,e.platform,e.quoteSymbol,e.quoteMintSymbol,e.quoteToken,e.twitterUrl,e.xUrl,e.telegramUrl,e.websiteUrl,e.youtubeUrl,e.tiktokUrl,e.instagramUrl,e.pairUrl,e.pumpUrl,e.socials,e.links,...e.riskFlags||[],...e.reasons||[],...e.auditFlags||[]].filter(Boolean).join(" ").toLowerCase()}function Sw(e={},t=""){const a=Ys(e),r=!!(e.twitterUrl||e.xUrl||e.telegramUrl||e.websiteUrl||e.youtubeUrl||e.tiktokUrl||e.instagramUrl||/twitter|x\.com|telegram|t\.me|website|youtube|youtu\.be|tiktok|instagram/.test(a));return t==="twitter"?!!(e.twitterUrl||e.xUrl||/twitter|x\.com/.test(a)):t==="website"?!!(e.websiteUrl||/\bwebsite\b|https?:\/\/(?!x\.com|twitter\.com|t\.me|telegram\.org)/.test(a)):t==="telegram"?!!(e.telegramUrl||/telegram|t\.me/.test(a)):t==="youtube"?!!(e.youtubeUrl||/youtube|youtu\.be/.test(a)):t==="tiktok"?!!(e.tiktokUrl||/tiktok/.test(a)):t==="instagram"?!!(e.instagramUrl||/instagram/.test(a)):t==="dexPaid"?!!(e.dexPaid||e.isDexPaid||/dex paid|paid dex|dexpaid/.test(a)):t==="pumpLive"?!!(e.pumpLivestream||e.pumpLive||e.liveStreamUrl||/pump livestream|pump live|livestream/.test(a)):t==="minSocial"?r:!0}function kw(e={}){const t=String(e.quoteSymbol||e.quoteMintSymbol||e.quoteToken||e.quoteTicker||"").trim().toUpperCase();if(t)return t;const a=Ys(e).toUpperCase();return a.includes("USDC")?"USDC":a.includes("USD1")?"USD1":a.includes("WSOL")||a.includes("SOL")?"WSOL":""}function Qs(e={},t=[]){const a=Ys(e);return t.some(r=>r.test(a))}function $w(e={},t=""){if(t==="showHidden")return!0;if(t==="mintAuth")return e.mintAuthorityActive===!0||e.isMintable===!0?!1:!Qs(e,[/mintauthorityactive/i,/mint authority active/i,/\bmintable\b/i,/mint auth enabled/i]);if(t==="freezeAuth")return e.freezeAuthorityActive===!0||e.isFreezeable===!0||e.isFreezable===!0?!1:!Qs(e,[/freezeauthorityactive/i,/freeze authority active/i,/freezable/i,/freezeable/i,/freeze auth enabled/i]);if(t==="lpBurned")return e.lpBurned===!0||e.liquidityBurned===!0?!0:Qs(e,[/lp burned/i,/liquidity burned/i,/burned lp/i]);if(t==="top10Hold"){const a=O(e.topHoldersPct,e.top10HoldersPct,e.topTenHoldersPct);return a>0?a<=30:!Qs(e,[/high holder concentration/i,/top holders high/i,/top 10 high/i])}return!0}function vn(e=[],t=Re()){const a=we(e||[]);if(!yn(t))return a;const r=Pt(t.keywords),s=Pt(t.excludeKeywords),o=Object.keys(t.socials||{}).filter(d=>t.socials[d]),c=Object.keys(t.quotes||{}).filter(d=>t.quotes[d]).map(d=>d.toUpperCase()),l=Object.keys(t.audits||{}).filter(d=>t.audits[d]);return a.filter(d=>{const u=Ys(d);return!(r.length&&!r.some(p=>u.includes(p))||s.length&&s.some(p=>u.includes(p))||o.some(p=>!Sw(d,p))||c.length&&!c.includes(kw(d))||l.some(p=>!$w(d,p)))})}function hl(e=[],t=[]){const a=Re();if(!yn(a))return"";const r=Pt(a.keywords),s=Pt(a.excludeKeywords),o=[];r.length&&o.push(`watching ${r.map(l=>`"${l}"`).join(", ")}`),s.length&&o.push(`excluding ${s.map(l=>`"${l}"`).join(", ")}`);const c=Math.max(0,we(e).length-we(t).length);return`<div class="terminal-launch-filter-summary">${i(o.join(" | ")||"filters active")} - ${i(t.length)}/${i(we(e).length)} visible${c?`, ${i(c)} hidden`:""}</div>`}function wr(e=[],t="pairs"){const a=Re(),r=Pt(a.keywords),s=r.length?r.map(c=>`"${c}"`).join(", "):"your launch filters",o=we(e).length;return F("Watching fresh launches",o?`No ${t} match ${s} yet. ${o} fresh rows were checked; keep this open and the live refresh will surface it when it launches.`:`No fresh rows are loaded yet. Keep this open or tap Refresh Feeds while watching ${s}.`)}function gl(e="terminal",t={}){const a=Re(),r=yn(a),s=!!(a.open||r),o=Number.isFinite(Number(t.rawCount))?Number(t.rawCount):0,c=Number.isFinite(Number(t.visibleCount))?Number(t.visibleCount):o;return`
  ...
  `}function kp(){Vr&&window.clearTimeout(Vr),Vr=window.setTimeout(()=>{Vr=null,Z("live"),Z("launch"),Z("sniper"),h()},180)}function Zs(e={}){const t=Number(e.pairCreatedAt||e.createdAt||0);if(t>0){const s=t<1e10?t*1e3:t;return Math.max(0,Math.round((Date.now()-s)/1e3))}const a=["source-age","trusted-source-age"].includes(String(e.pairAgeSource||"").toLowerCase()),r=Number(e.pairAgeSeconds);return a&&Number.isFinite(r)&&r>=0?r:Number.POSITIVE_INFINITY}const Tw=100,Aw=7200,Pw=75e4,Cw=86400,Lw=2e6,xw=28e3,$p=18e4,Mw=16e4;function Tp(){const e=up();return we([...n.livePairs?.rows||[],...n.livePairsByBucket.live?.rows||[],...n.livePairsByBucket.under1h?.rows||[],...n.livePairsByBucket.under3h?.rows||[],...n.livePairsByBucket.under1d?.rows||[],...n.scan?.rows||[],...n.kolScan?.rows||[]]).map(t=>mp(t,e.get(String(t?.tokenMint||"")))).filter(t=>t?.tokenMint&&!fr(t))}function wn(e={}){return O(e.marketCap,e.fdv)}function Ap(e={}){return O(e.liquidityUsd)}function Pp(e={}){return O(e.volumeM5,e.volume5m,e.volumeM15,e.volumeM30,e.volumeH1,e.volumeH24,e.volumeUsd)}function bl(e={}){if(Sr(e))return!1;const t=Zs(e);return!Number.isFinite(t)||t<0||t>Aw||wn(e)>Pw?!1:Vt(e)<70}function yl(e={}){if(Sr(e))return!1;const t=Vt(e),a=wn(e),r=a>=xw&&a<=$p;return t>=55&&(!a||a<=$p)||r}function Cp(e={}){if(bl(e)||yl(e)||Sr(e))return!1;const t=Zs(e);return Number.isFinite(t)&&(t<0||t>Cw)||wn(e)>Lw?!1:Ap(e)>0||Pp(e)>0||Number(e.bestPickScore||e.score||0)>0||Array.isArray(e.reasons)&&e.reasons.length>0}function Lp(e={}){return[e.tokenMint,e.symbol,e.name,e.source,e.category,e.dexId,e.dexName,e.poolType,e.platform,e.raydiumPool,e.pairUrl,...e.riskFlags||[],...e.reasons||[]].filter(Boolean).join(" ").toLowerCase()}function Vt(e={}){const t=O(e.bondingProgressPct,e.bondingProgress,e.bonding_curve_progress,e.bondingCurveProgress,e.pumpProgress,e.graduationProgress,e.completion,e.completePct);if(t>0)return t<=1?t*100:t;const a=wn(e),r=Lp(e);return(!!e.isPump||r.includes("pump")||String(e.tokenMint||"").toLowerCase().endsWith("pump"))&&a>0?Math.max(1,Math.min(99,a/69e3*100)):0}function Sr(e={}){if(e.isGraduated||e.graduated||e.bonded||e.isBonded||e.complete||e.completed||e.bondingComplete||e.raydiumPool||e.raydium_pool||e.poolAddress)return!0;const t=Lp(e);if(/\b(graduated|bonded|bonding complete|complete)\b/.test(t))return!0;const a=!!e.isPump||t.includes("pump")||String(e.tokenMint||"").toLowerCase().endsWith("pump"),r=wn(e);return a&&r>=Mw?!0:!!(a&&/\b(raydium|meteora|orca)\b/.test(t))}function xp(e={}){if(Sr(e))return"graduated";const t=String(e.slimeScopeCategory||"").trim().toLowerCase();return t==="graduated"?"graduated":yl(e)||t==="graduating"?"graduating":bl(e)?"new":(t==="steady"||t==="unknown"||Cp(e),"steady")}function Mp(e={}){const t=Number(e.bestPickScore||e.score||0),a=Pp(e),r=Ap(e),s=wn(e),o=Zs(e),c=Number.isFinite(o)?Math.max(0,86400-o)/86400:0;return t*1e3+Math.log10(a+1)*160+Math.log10(r+1)*120+Math.log10(s+1)*80+c*100}function Bp(e=[]){return[...e].sort((t,a)=>Mp(a)-Mp(t)||nt(t,a))}function Bw(e=[],t=[],a=Tw){const r=new Set,s=[];for(const o of[...e,...t]){const c=String(o?.tokenMint||"");if(!(!c||r.has(c))&&(r.add(c),s.push(o),s.length>=a))break}return s}function Rp(e=n.slimeScopeMode){const t=Tp(),a=e==="graduated"?"graduated":e==="graduating"?"graduating":e==="steady"?"steady":"new",r=t.filter(l=>xp(l)===a),s=t.filter(l=>{const d=xp(l);return a==="graduated"?d==="graduated"||Sr(l):a==="graduating"?d==="graduating"||yl(l):a==="steady"?d==="steady"||Cp(l):d==="new"||bl(l)}),o=a==="new"?[...r].sort(nt):Bp(r),c=a==="new"?we(s).sort(nt):Bp(s);return Bw(o,c)}function Rw(e=[],t="new"){const a=it(`slimeScope:${t}`,e).slice(0,12);return a.length?a.map((r,s)=>{const o=r.pairAgeLabel||zt(r)||"age ?",c=_(r.marketCapLabel,r.fdvLabel,M(ft(r)),"checking"),l=_(r.liquidityLabel,M(ht(r)),"checking"),d=_(r.volumeM15Label,M(mo(r)),"checking");return`
    ...
    `}).join(""):`<div class="slime-scope-column-empty">Warming up ${i(t)} pairs.</div>`}function Iw(){return`
    <div class="slime-scope-web-columns" aria-label="Slime Scope desktop columns">
      ${[["new","New","Fresh launches"],["graduating","Graduating","Near migration"],["graduated","Graduated","Moved to market"]].map(([t,a,r])=>{const s=Rp(t);return`
  ...
  `}function Ow(){const e=Pr(),[,,t]=e,a=Qc(n.slimeScopeMode),s=!!(j("slimeScope").inFlight||n.livePairsLoadingByBucket?.[a]),o=n.livePairsRefreshErrorByBucket?.[a],c=we(Zp(Tp(),e[0])),l=it("slimeScope",c),d=l.length?ar()?mt(l,{context:"live",shareBuilder:Pa,hideToolbar:!0}):At(l,{layout:"terminal",limit:Math.max(1,l.length),actionLabel:"Trade"}):o?F("Unable to load pairs. Try refreshing.","Cook Spot hit a snag — it keeps retrying, or tap Refresh Scope."):s?F("Loading Cook Spot…","Scanning DEX, boosted, and pump pairs for this category."):F("No pairs found for this filter yet","Try another category — Cook Spot keeps scanning in the background.");return`
    <section class="slime-scope-page">
      <div class="command-controls slime-scope-controls">
        <div class="cooks-category-label cook-spot-head">${xS(e)}<span>${i(t)}</span></div>
        ${em(c.length,ua())}
        ${ou("slime-scope")}
  ...
  `}function x0(){const e=qe(),t=we(e?.rows||[]),a=vn(t),r=[...a].sort(nt),s=pp(n.kolScan?.rows||[]).filter(C=>!fr(C)),o=vn(s),c=br(t,s),l=vn(c),d=yn(),u=Sa(l,8,wa("best-picks"),2),p=new Set(u.map(va).filter(Boolean)),f=yp(r,p),y=Sa(f.length?f:r,12,wa("live-pairs"),0),b=new Set([...p,...y.map(va).filter(Boolean)]),v=yp(o,b),P=Sa(v.length?v:o,12,wa("kol-signals"),1),A=!!n.livePairsLoadingByBucket[n.livePairBucket],g=ua(),$="Trade";return`
    <section class="command-terminal no-live-ticket">
      <main class="command-workspace">
        <div class="terminal-title-row command-title">
          ...
          <span>${A?"Refreshing":"Live"}${g?` | ${i(Jn(nn(g)||0))}`:""}</span>
        </div>
        ...
        <div class="command-controls">
          ...
          <label>
            ...
            <select data-terminal-sort>
              ${$f.map(([C,B])=>`<option value="${C}" ${n.terminalSort===C?"selected":""}>${B}</option>`).join("")}
            </select>
          </label>
          ${ou("terminal-top")}
        ...
        ${gl("terminal",{rawCount:t.length,visibleCount:a.length})}
        ${hl(t,a)}

        <section class="command-grid">
          <article class="terminal-panel best-picks-panel">
            <header><h4>Best Picks</h4><span>Score + reasons</span></header>
            ${u.length?At(u,{layout:"terminal",cooksStyle:!0,limit:8,actionLabel:$,emptyTitle:"No Best Picks yet",emptyMessage:"Refresh Live Pairs to score current pairs."}):d?wr(c,"best picks"):At(u,{layout:"terminal",cooksStyle:!0,limit:8,actionLabel:$,emptyTitle:"No Best Picks yet",emptyMessage:"Refresh Live Pairs to score current pairs."})}
          </article>
          <article class="terminal-panel live-pairs-panel">
            <header><h4>Cooks</h4><button data-tab="live">Open</button></header>
            ${y.length?At(y,{layout:"terminal",cooksStyle:!0,limit:12,actionLabel:$}):d?wr(t,"live pairs"):At(y,{layout:"terminal",cooksStyle:!0,limit:12,actionLabel:$})}
          </article>
          <article class="terminal-panel kol-panel">
            ...
            ${P.length?At(P,{layout:"terminal",cooksStyle:!0,limit:12,actionLabel:$,emptyTitle:"No KOL signals loaded",emptyMessage:"Refresh KOL Tracker to load signals."}):d?wr(s,"KOL signals"):At(P,{layout:"terminal",cooksStyle:!0,limit:12,actionLabel:$,emptyTitle:"No KOL signals loaded",emptyMessage:"Refresh KOL Tracker to load signals."})}
          </article>
        </section>
  ...
  `}function M0(){const e=pt();if(!e)return"Trade";const t=ze(e);return t?`Buy ${t} SOL`:Um(e,"Trade")}function ka(){const e=pt(),t=ze(e);return t?`Buy ${t} SOL`:"Quick Buy"}function eo(){const e=ka();document.querySelectorAll("[data-quick-buy-token]").forEach(t=>{S(t,e)})}function $a(e=""){const t=String(e||"").trim();if(!t)return null;const a=mr().find(s=>String(s?.tokenMint||s?.mint||s?.tokenAddress||"").trim()===t);if(a)return a;const r=n.smartChartTokenRef||{};return String(r.tokenMint||r.mint||"").trim()===t?r:{tokenMint:t,shortMint:w(t),symbol:w(t),dexUrl:Q(t)}}function Ew(e=""){return{normal_buy:"Normal buy size can be considered",small_buy:"Trade small or use protection",watch_only:"Watch-only unless you accept high risk",avoid:"Avoid recommended"}[e]||"Review risk before buying"}function Fw(e=""){return{conservative:"Conservative",scalp:"Scalp",degen:"Degen"}[e]||"Conservative"}function Ip(e={}){if(!D("slimeShieldEnabled",!0))return"";const t=at(e),a=String(e.tokenMint||t.mint||"").trim(),r=t.verdict||"CAUTION";return`
    <article class="slimeshield-card slimeshield-${i(hn(r))}">
      ...
      <div class="slimeshield-actions">
        ...
        ${D("protectedBuyEnabled",!0)?`<button type="button" class="primary" data-protected-buy-open="${i(a)}" data-protected-buy-preset="${i(t.protectedBuyPreset||fl(r))}" data-protected-buy-source="slimeshield-card">Protected Buy</button>`:""}
      </div>
    </article>
  `}function Op(e=[],t="risk",a="No strong signal cached yet."){const r=(Array.isArray(e)?e:[]).filter(s=>t==="positive"?s.severity==="positive":s.severity!=="positive").slice(0,5);return r.length?`
    <ul class="slimeshield-factor-list">
      ${r.map(s=>`
        <li>
  ...
  `:`<p class="slimeshield-muted">${i(a)}</p>`}function Ep(e=""){const t=String(e||n.smartChartToken||n.tradeToken||"").trim();!t||!D("slimeShieldEnabled",!0)||(n.slimeShieldDetails={open:!0,tokenMint:t},n.slimeShieldStatus="",Ka(),Aa(),to(t,{force:!0}),D("replayBeforeBuyEnabled",!0)&&$l(t,{force:!0}))}function vl(){n.slimeShieldDetails={open:!1,tokenMint:""},n.slimeShieldStatus="",Aa(),zr()}async function to(e="",t={}){const a=String(e||"").trim();if(!a||!D("slimeShieldEnabled",!0))return null;if(!t.force&&n.slimeShieldResults?.[a])return n.slimeShieldResults[a];if(n.slimeShieldLoading?.[a])return null;n.slimeShieldLoading={...n.slimeShieldLoading||{},[a]:!0},Aa();try{const r=new URLSearchParams({mint:a});t.force&&r.set("force","true");const o=(await k(`/api/web/slimeshield?${r.toString()}`,{timeoutMs:t.force?6500:2500,preserveSafeError:!0}))?.slimeshield||null;return o&&(n.slimeShieldResults={...n.slimeShieldResults||{},[a]:o},se(o.cacheHit?"slimeshieldCacheHit":"slimeshieldCacheMiss"),n.slimeShieldStatus=o.cacheHit?"Loaded from cache.":"Updated from local data."),o}catch(r){return n.slimeShieldStatus=r?.message||"SlimeShield details are temporarily unavailable.",null}finally{const r={...n.slimeShieldLoading||{}};delete r[a],n.slimeShieldLoading=r,Aa()}}function Ww(e=""){const t=$a(e)||fn(e)||{tokenMint:e},a=yr(t),r=a.likelyDevWallet||t.creatorWallet||t.deployerWallet||t.poolCreator||"",s=[...Array.isArray(a.externalLinks)?a.externalLinks:[],{label:"Solscan Token",url:e?`https://solscan.io/token/${encodeURIComponent(e)}`:""},{label:"Dex",url:t.dexUrl||Q(e)},{label:"Solscan Wallet",url:r?`https://solscan.io/account/${encodeURIComponent(r)}`:""},{label:"KOLscan Wallet",url:r?`https://kolscan.io/account/${encodeURIComponent(r)}`:""},{label:"Bubblemap",url:e?`https://app.bubblemaps.io/sol/token/${encodeURIComponent(e)}`:""},{label:"X",url:t.twitterUrl||t.xUrl},{label:"TG",url:t.telegramUrl},{label:"Website",url:t.websiteUrl}].filter((o,c,l)=>/^https?:\/\//i.test(String(o.url||""))&&l.findIndex(d=>String(d.url||"")===String(o.url||""))===c).slice(0,8);return{mint:e,pairAddress:t.pairAddress||"",likelyDevWallet:a.likelyDevWallet||null,confidence:a.confidence||"unknown",status:ya(a.status),label:a.label||Gs(a.status),score:50,summary:a.summary||"Not enough dev-wallet history yet.",currentPosition:null,historicalStats:{likelyDevWallet:a.likelyDevWallet||null,launchesTracked:0,recentLaunches:[]},linkedWalletSignals:{notes:[]},riskReasons:a.likelyDevWallet?[]:["No reliable creator wallet detected yet."],positiveReasons:[],suggestedAction:"Check SlimeShield and liquidity before buying.",updatedAt:a.updatedAt||new Date().toISOString(),externalLinks:s,dataSource:"ui-fallback"}}function Fp(e=""){const t=String(e||"").trim();return n.devInfoResults?.[t]||Ww(t)}function kr(e,t=""){const a=Number(e);return Number.isFinite(a)?`${Math.round(a*10)/10}${t}`:"n/a"}function Wp(e=""){const t=String(e||"unknown").trim().toLowerCase();return t==="high"?"High confidence":t==="medium"?"Medium confidence":t==="low"?"Low confidence":"Unknown"}function ao(e){const t=Number(e);return Number.isFinite(t)?t<60?`${Math.max(0,Math.round(t))}m`:`${Math.round(t/60*10)/10}h`:"n/a"}function _w(e=""){const t=String(e||"").trim();return t?w(t):"Unknown"}async function _p(e="",t={}){const a=String(e||"").trim();if(!a||!D("devInfoEnabled",!0))return null;if(!t.force&&n.devInfoSummaries?.[a])return n.devInfoSummaries[a];const r=`summary:${a}`;if(n.devInfoLoading?.[r])return null;n.devInfoLoading={...n.devInfoLoading||{},[r]:!0};try{const s=t.force?"?force=true":"",c=(await k(`/api/web/dev-info/summary/${encodeURIComponent(a)}${s}`,{timeoutMs:t.force?4500:2500,preserveSafeError:!0}))?.devInfoSummary||null;return c&&(n.devInfoSummaries={...n.devInfoSummaries||{},[a]:c},se(c.cacheHit?"devInfoCacheHit":"devInfoCacheMiss")),c}catch{return null}finally{const s={...n.devInfoLoading||{}};delete s[r],n.devInfoLoading=s,t.silent||Ta()}}async function Np(e="",t={}){const a=String(e||"").trim();if(!a||!D("devInfoEnabled",!0))return null;if(!t.force&&n.devInfoResults?.[a])return n.devInfoResults[a];const r=`details:${a}`;if(n.devInfoLoading?.[r])return null;n.devInfoLoading={...n.devInfoLoading||{},[r]:!0},Ta();try{const s=t.force?"?force=true":"",c=(await k(`/api/web/dev-info/${encodeURIComponent(a)}${s}`,{timeoutMs:t.force?7e3:3e3,preserveSafeError:!0}))?.devInfo||null;return c&&(n.devInfoResults={...n.devInfoResults||{},[a]:c},n.devInfoSummaries={...n.devInfoSummaries||{},[a]:{mint:a,status:c.status||"unknown",label:c.label||Gs(c.status),confidence:c.confidence||"unknown",summary:c.summary||"",likelyDevWallet:c.likelyDevWallet||null,currentPositionStatus:c.currentPosition?.positionStatus||"unknown",launchesTracked:c.historicalStats?.launchesTracked||0,externalLinks:Array.isArray(c.externalLinks)?c.externalLinks.slice(0,8):[],updatedAt:c.updatedAt||""}},n.devInfoStatus=c.cacheHit?"Loaded from cache.":"Updated from public sources and local history.",se(c.cacheHit?"devInfoCacheHit":"devInfoCacheMiss")),c}catch(s){return n.devInfoStatus=s?.message||"Dev Info is temporarily unavailable.",null}finally{const s={...n.devInfoLoading||{}};delete s[r],n.devInfoLoading=s,Ta()}}function Nw(e=""){const t=String(e||"").trim();!t||!D("devInfoEnabled",!0)||(n.devInfoDetails={open:!0,tokenMint:t},n.devInfoStatus="",Ka(),Ta(),_p(t,{force:!0,silent:!0}),Np(t,{force:!0}))}function wl(){n.devInfoDetails={open:!1,tokenMint:""},n.devInfoStatus="",Ta(),zr()}function Dw(e){return e==="radar"?"📡":e==="move"?"📈":"•"}async function Uw(){try{const e=await k("/api/web/return-summary");n.returnSummary={loaded:!0,events:Array.isArray(e.events)?e.events:[]}}catch{n.returnSummary={loaded:!0,events:[]}}Sl()}async function qw(){n.returnSummaryDismissed=!0,Sl();try{await k("/api/web/return-summary",{method:"POST",body:JSON.stringify({action:"seen"})})}catch{}}function Sl(){let e=document.querySelector("[data-return-summary-root]");e||(e=document.createElement("div"),e.dataset.returnSummaryRoot="true",document.body.appendChild(e));const t=n.returnSummary,a=t&&Array.isArray(t.events)?t.events:[];if(!!!(t&&t.loaded&&a.length&&!n.returnSummaryDismissed&&n.route==="terminal")){e.__lastReturn!==""&&(e.innerHTML="",e.__lastReturn="");return}const o=`
    ...
    <li><button type="button" class="return-summary-item" data-token-chart="${i(c.tokenMint||"")}" data-token-chart-source="return-summary"><span>${Dw(c.kind)}</span> ${i(c.title||"Update")}</button></li>`).join("")}</ul>
      ${a.length>6?`<small>+${a.length-6} more</small>`:""}
    </div>`;e.__lastReturn!==o&&(e.__lastReturn=o,e.innerHTML=o)}function Hw(e){return e==="tp"?"🎯":e==="sl"?"🛑":e==="mc_above"?"📈":e==="mc_below"?"📉":e==="dump"?"🩸":"📡"}function Kw(e){const t=Number(e.value)||0;return e.type==="tp"?`Take-profit · +${Math.round(t)}%`:e.type==="sl"?`Stop-loss · −${Math.round(t)}%`:e.type==="mc_above"?`Market cap crosses above ${M(t)}`:e.type==="mc_below"?`Market cap falls below ${M(t)}`:e.type==="dump"?`Dump alert · down ${Math.round(t)}% in 1h`:String(e.type||"")}function Vw(e="",t=""){n.radarDrawer={open:!0,tokenMint:String(e||"").trim(),symbol:String(t||"").trim(),scope:"token"},n.radarStatus="",rt(),jw(),n.watchlist?.rows?.length||k("/api/web/watchlist").then(a=>{a?.watchlist&&(n.watchlist=a.watchlist,rt())}).catch(()=>{})}function zw(){n.radarDrawer={open:!1,tokenMint:"",symbol:""},rt()}async function jw(){try{const e=await k("/api/web/radar");n.radarRules=Array.isArray(e.rules)?e.rules:[]}catch(e){n.radarStatus=e.message||"Could not load Radar."}rt()}async function Gw(){const e=document.querySelector("[data-radar-drawer-root]"),t=n.radarDrawer||{};if(!e)return;const a=t.scope||(t.tokenMint?"token":"tag"),r=e.querySelector("[data-radar-type]")?.value||(a==="tag"?"mc_above":"tp"),s=Number(e.querySelector("[data-radar-value]")?.value||0);if(!(s>0)){n.radarStatus="Enter a number greater than 0.",rt();return}const o={push:e.querySelector("[data-radar-ch-push]")?.checked!==!1,telegram:!!e.querySelector("[data-radar-ch-tg]")?.checked};let c;if(a==="tag"){const l=e.querySelector("[data-radar-tag]")?.value||"";if(!l){n.radarStatus="Pick a list (tag) first — tag coins in your Watchlist.",rt();return}c={tag:l,type:r,value:s,channels:o}}else{if(!t.tokenMint)return;c={tokenMint:t.tokenMint,symbol:t.symbol,type:r,value:s,channels:o}}try{n.radarStatus="Setting alert…",rt(),await J(null,"Opening your SlimeWire profile for Radar…");const l=await k("/api/web/radar",{method:"POST",body:JSON.stringify({action:"add",rule:c})});n.radarRules=Array.isArray(l.rules)?l.rules:n.radarRules,n.radarStatus="✅ Alert set — SlimeWire is watching it for you."}catch(l){n.radarStatus=l.message||"Could not set the alert."}rt()}async function Dp(e,t){try{const a=await k("/api/web/radar",{method:"POST",body:JSON.stringify({action:e,id:t})});n.radarRules=Array.isArray(a.rules)?a.rules:n.radarRules}catch(a){n.radarStatus=a.message||"Could not update the alert."}rt()}function rt(){let e=document.querySelector("[data-radar-drawer-root]");e||(e=document.createElement("div"),e.dataset.radarDrawerRoot="true",document.body.appendChild(e));const t=n.radarDrawer||{};if(!t.open){e.innerHTML="",e.__lastDrawerHtml="";return}const a=Array.isArray(n.radarRules)?n.radarRules:[],r=t.symbol||(t.tokenMint?w(t.tokenMint):""),s=[...new Set((n.watchlist?.rows||[]).flatMap(f=>Array.isArray(f.tags)?f.tags:[]))].slice(0,24),o=t.scope||(t.tokenMint?"token":"tag"),c=`
          <option value="mc_above">📈 Market cap above ($)</option>
          <option value="mc_below">📉 Market cap below ($)</option>
          <option value="dump">🩸 Dump / rug alert (down % in 1h)</option>`,l=`
          <option value="tp">🎯 Take-profit (+%)</option>
          <option value="sl">🛑 Stop-loss (−%)</option>${c}`,d=t.tokenMint||s.length?`
    <section data-radar-add>
      <h4>New alert</h4>
      <div class="radar-scope">
        ${t.tokenMint?`<button type="button" data-radar-scope="token" data-active="${o==="token"}">${i(r||"This coin")}</button>`:""}
      ...
      <div class="radar-form">
        ${o==="tag"?`<select data-radar-tag aria-label="List (tag)">${s.length?s.map(f=>`<option value="${i(f)}">${i(f)}</option>`).join(""):'<option value="">No tags yet</option>'}</select>`:""}
        <select data-radar-type aria-label="Alert type">${o==="tag"?c:l}</select>
    ...
    <ul class="radar-rule-list">
      ${a.map(f=>`
        <li class="radar-rule ${f.enabled===!1?"is-off":""}">
          <span class="radar-rule-icon">${Hw(f.type)}</span>
          <div class="radar-rule-body">
            <strong>${f.scope==="tag"?`📋 ${i(f.tag||f.symbol||"list")}`:i(f.symbol||w(f.tokenMint))}</strong>
            <small>${i(Kw(f))}</small>
          </div>
          <button type="button" class="radar-rule-toggle" data-radar-toggle="${i(f.id)}" title="${f.enabled===!1?"Enable":"Pause"}">${f.enabled===!1?"Off":"On"}</button>
          <button type="button" class="radar-rule-remove" data-radar-remove="${i(f.id)}" title="Remove alert" aria-label="Remove alert">×</button>
        </li>`).join("")}
    ...
    <aside class="slimeshield-drawer radar-drawer" role="dialog" aria-modal="true" aria-label="Edit watchlist note and tags">
      <header>
        <div><span>📝 Note &amp; Tags</span><h3>${i(t.symbol||w(t.tokenMint))}</h3></div>
        <button type="button" aria-label="Close" data-watchlist-edit-close>Close</button>
      </header>
      <section>
        <h4>Note</h4>
        <textarea data-wl-note class="wl-edit-note" rows="3" maxlength="280" placeholder="e.g. waiting for a dip under 30k, dev looks solid">${i(t.note||"")}</textarea>
        <h4>Tags <span class="slimeshield-muted" style="font-weight:400">· comma-separated, double as lists</span></h4>
        <input data-wl-tags class="wl-edit-tags" type="text" maxlength="160" placeholder="Holding, Watching, High risk" value="${i(t.tags||"")}" />
  ...
  `:`<p class="slimeshield-muted">${i(t)}</p>`}function ro(e,t="Not cached yet"){const a=String(e||"").trim();return!a||a.toLowerCase()==="warming"||a.toLowerCase()==="checking"?t:a}function so(e,t=r=>String(r),a="Not cached yet"){return Number.isFinite(e)&&e>0?t(e):a}function kn(e,t,a=""){if(e.__lastDrawerHtml===t)return!1;const r=a?e.querySelector(a):null,s=r?r.scrollTop:0;if(e.innerHTML=t,e.__lastDrawerHtml=t,a&&s){const o=e.querySelector(a);o&&(o.scrollTop=s)}return!0}function Ta(){let e=document.querySelector("[data-dev-info-drawer-root]");e||(e=document.createElement("div"),e.dataset.devInfoDrawerRoot="true",document.body.appendChild(e));const t=n.devInfoDetails||{},a=!!(t.open&&t.tokenMint);if(document.body.classList.toggle("dev-info-drawer-open",a),!a||!D("devInfoEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=String(t.tokenMint||"").trim(),s=$a(r)||fn(r)||{tokenMint:r},o=Fp(r),c=n.devInfoSummaries?.[r]||yr(s),l=ya(o.status||c.status),d=o.confidence||c.confidence||"unknown",u=!!n.devInfoLoading?.[`details:${r}`],p=o.likelyDevWallet||c.likelyDevWallet||"",f=o.currentPosition||null,y=o.historicalStats||{},b=o.linkedWalletSignals||{},v=o.marketContext||{},P=o.sourceHydration||{},A=Array.isArray(o.sourceEvidence)?o.sourceEvidence.slice(0,8):[],g=O(v.marketCap,s.marketCap,s.fdv),$=O(v.liquidityUsd,s.liquidityUsd),C=O(v.volume5m,s.volume5m,s.volumeM5),B=O(v.volumeH1,s.volumeH1,s.volume1h),U=O(v.pairAgeMinutes,s.pairAgeMinutes,Number(s.pairAgeSeconds)/60),H=v.metadataAuthority||s.metadataAuthority||s.updateAuthority||"",Se=v.mintAuthority||s.mintAuthority||"",De=v.freezeAuthority||s.freezeAuthority||"",q=!!(v.heliusDasIndexedAt||v.heliusDasSource||s.heliusDasSource||H||Se||De),Oe=[...Array.isArray(o.externalLinks)?o.externalLinks:[],...Array.isArray(c.externalLinks)?c.externalLinks:[],{label:"Solscan Token",url:r?`https://solscan.io/token/${encodeURIComponent(r)}`:""},{label:"Dex",url:s.dexUrl||Q(r)},{label:"Solscan Wallet",url:p?`https://solscan.io/account/${encodeURIComponent(p)}`:""},{label:"KOLscan Wallet",url:p?`https://kolscan.io/account/${encodeURIComponent(p)}`:""},{label:"Bubblemap",url:r?`https://app.bubblemaps.io/sol/token/${encodeURIComponent(r)}`:""},{label:"X",url:s.twitterUrl||s.xUrl},{label:"TG",url:s.telegramUrl},{label:"Website",url:s.websiteUrl}].filter((ee,Cn,Mo)=>/^https?:\/\//i.test(String(ee.url||""))&&Mo.findIndex(Kl=>String(Kl.url||"")===String(ee.url||""))===Cn).slice(0,8),X=Array.isArray(y.recentLaunches)?y.recentLaunches.slice(0,5):[],Ue=!!v.solanaTrackerLoaded,Mt=!!f||Number(y.launchesTracked)>0||X.length>0,Pn=A.length>0||Array.isArray(o.riskReasons)&&o.riskReasons.length>0||Array.isArray(o.positiveReasons)&&o.positiveReasons.length>0||!!b.linkedWalletCount||Array.isArray(b.notes)&&b.notes.length>0,Bt=[["overview","Overview"]];Ue&&Bt.push(["holders","Holders"]),Mt&&Bt.push(["history","History"]),Pn&&Bt.push(["signals","Signals"]);const Ba=Bt.some(([ee])=>ee===n.devInfoTab)?n.devInfoTab:"overview",Br=`
    ...
    <aside class="dev-info-drawer dossier-drawer" data-active-pane="${i(Ba)}" role="dialog" aria-modal="true" aria-label="Dev Info details">
      ...
      ${Bt.length>1?`<div class="dossier-tabs" role="tablist" aria-label="Dev Info sections">
        ${Bt.map(([ee,Cn])=>`<button type="button" role="tab" data-dev-info-tab="${ee}" data-active="${Ba===ee}">${i(Cn)}</button>`).join("")}
      </div>`:""}
      ...
      <section data-pane="overview">
        ...
        <dl class="kol-dump-metrics">
          <div><dt>Wallet</dt><dd>${i(_w(p))}</dd></div>
          <div><dt>Confidence</dt><dd>${i(Wp(d))}</dd></div>
      ...
      <section data-pane="overview">
        ...
        <dl class="kol-dump-metrics">
          <div><dt>Market cap</dt><dd>${i(so(g,M))}</dd></div>
          <div><dt>Liquidity</dt><dd>${i(so($,M))}</dd></div>
          <div><dt>5m volume</dt><dd>${i(so(C,M))}</dd></div>
          <div><dt>1h volume</dt><dd>${i(so(B,M))}</dd></div>
          <div><dt>Pair age</dt><dd>${i(Number.isFinite(U)?ao(U):"Not cached yet")}</dd></div>
      ...
      <section data-pane="history">
        <h4>Current Token Position</h4>
          <dl class="kol-dump-metrics">
            <div><dt>Started</dt><dd>${i(kr(f.initialSupplyPercent,"%"))}</dd></div>
            <div><dt>Current</dt><dd>${i(kr(f.currentSupplyPercent,"%"))}</dd></div>
            <div><dt>Sold</dt><dd>${i(kr(f.estimatedSoldPercent,"%"))}</dd></div>
            <div><dt>Status</dt><dd>${i(String(f.positionStatus||"unknown").replace(/_/g," "))}</dd></div>
            <div><dt>First sell</dt><dd>${i(ao(f.firstMajorSellMinutesAfterLaunch))}</dd></div>
      ...
      <section data-pane="history">
        ...
        <dl class="kol-dump-metrics">
          ...
          <div><dt>Median first sell</dt><dd>${i(ao(y.medianFirstSellMinutes))}</dd></div>
          <div><dt>&gt;50% sold 15m</dt><dd>${i(kr(y.soldMoreThan50Within15mPercent,"%"))}</dd></div>
          <div><dt>Held past 24h</dt><dd>${i(kr(y.heldPast24hPercent,"%"))}</dd></div>
        </dl>
        ${X.length?`
      ...
      <div class="slimeshield-drawer-actions">
        <button type="button" data-watch-token="${i(r)}" data-watch-symbol="${i(s.symbol||"")}" data-watch-name="${i(s.name||"")}" data-watch-image="${i(po(s)||"")}">${uo(r)?"Saved":"Add Watch"}</button>
  ...
  `;kn(e,Br,".dev-info-drawer")}function Up(e=""){return{mint:e,sampleSize:0,confidence:"low",matchedTraits:[],winRatePercent:null,medianMaxUpsidePercent:null,medianMaxDrawdownPercent:null,failRatePercent:null,bestExitPattern:"",summary:"Not enough local history yet. Replay improves as SlimeWire tracks more launches.",updatedAt:new Date().toISOString()}}function kl(e=""){const t=String(e||"").trim();return n.replayResults?.[t]||Up(t)}function $n(e,t="%"){return Number.isFinite(Number(e))?`${Math.round(Number(e))}${t}`:"n/a"}function aS(e=""){if(!D("replayBeforeBuyEnabled",!0))return"";const t=String(e||"").trim();if(!t)return"";const a=kl(t);return`
    <section class="replay-before-buy-card">
      ...
      <dl>
        ...
        <div><dt>Win rate</dt><dd>${i($n(a.winRatePercent))}</dd></div>
        <div><dt>Median drawdown</dt><dd>${i($n(a.medianMaxDrawdownPercent))}</dd></div>
      </dl>
      <p>${i(a.summary||"Not enough local history yet.")}</p>
    </section>
  `}async function $l(e="",t={}){const a=String(e||"").trim();if(!a||!D("replayBeforeBuyEnabled",!0))return null;if(!t.force&&n.replayResults?.[a])return n.replayResults[a];if(n.replayLoading?.[a])return null;n.replayLoading={...n.replayLoading||{},[a]:!0},$r(),Aa();try{const r=new URLSearchParams({mint:a});t.force&&r.set("force","true");const o=(await k(`/api/web/replay-before-buy?${r.toString()}`,{timeoutMs:t.force?4500:3e3,preserveSafeError:!0}))?.replay||null;return o&&(n.replayResults={...n.replayResults||{},[a]:o},se(o.cacheHit?"replayCacheHit":"replayCacheMiss")),o}catch{return n.replayResults={...n.replayResults||{},[a]:Up(a)},null}finally{const r={...n.replayLoading||{}};delete r[a],n.replayLoading=r,$r(),Aa()}}function nS(e=""){const t=String(e||"").trim();!t||!D("replayBeforeBuyEnabled",!0)||(n.replayDetails={open:!0,tokenMint:t},Ka(),$r(),$l(t))}function Tl(){n.replayDetails={open:!1,tokenMint:""},$r(),zr()}function $r(){let e=document.querySelector("[data-replay-drawer-root]");e||(e=document.createElement("div"),e.dataset.replayDrawerRoot="true",document.body.appendChild(e));const t=n.replayDetails||{},a=!!(t.open&&t.tokenMint);if(document.body.classList.toggle("replay-drawer-open",a),!a||!D("replayBeforeBuyEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=String(t.tokenMint||"").trim(),s=kl(r),o=!!n.replayLoading?.[r],c=`
    ...
    <aside class="replay-before-buy-drawer" role="dialog" aria-modal="true" aria-label="Replay Before You Buy details">
      ...
      <dl class="kol-dump-metrics">
        ...
        <div><dt>Win rate</dt><dd>${i($n(s.winRatePercent))}</dd></div>
        <div><dt>Median upside</dt><dd>${i($n(s.medianMaxUpsidePercent))}</dd></div>
        <div><dt>Median drawdown</dt><dd>${i($n(s.medianMaxDrawdownPercent))}</dd></div>
        <div><dt>Fail rate</dt><dd>${i($n(s.failRatePercent))}</dd></div>
    ...
    <aside class="slimeshield-drawer dossier-drawer" data-active-pane="${i(q)}" role="dialog" aria-modal="true" aria-label="SlimeShield details">
      ...
      <section data-pane="verdict">
        ...
        <dl class="kol-dump-metrics">
          ...
          <div><dt>Age</dt><dd>${i(Number.isFinite(P)?ao(P):ro(s.pairAgeLabel||zt(s),"Not cached yet"))}</dd></div>
          <div><dt>Liquidity</dt><dd>${i(Number.isFinite(b)&&b>0?M(b):ro(s.liquidityLabel,"Not cached yet"))}</dd></div>
          <div><dt>MC / FDV</dt><dd>${i(Number.isFinite(y)&&y>0?M(y):ro(s.marketCapLabel,"Not cached yet"))}</dd></div>
          <div><dt>Volume</dt><dd>${i(Number.isFinite(v)&&v>0?M(v):ro(s.volumeH1Label||s.volumeLabel,"Not cached yet"))}</dd></div>
          <div><dt>Dev Info</dt><dd>${i(Gs(U))} · ${i(B.confidence||"unknown")}</dd></div>
      ...
      <section data-pane="risks">
        ...
        ${Op(f,"risk","No major cached risk reason yet. Missing data lowers confidence.")}
      </section>
      <section data-pane="risks">
        <h4>Positive Signals</h4>
        ${Op(f,"positive","No positive signal is strong enough to highlight yet.")}
      </section>
      <section class="slimeshield-action-note" data-pane="verdict">
        <h4>Suggested Action</h4>
        <p>${i(Ew(o.suggestedAction))}</p>
        <small>Protected Buy preset suggestion: ${i(Fw(o.protectedBuyPreset))}</small>
      </section>
      ${aS(r)}
      <div class="slimeshield-drawer-actions">
        ${D("protectedBuyEnabled",!0)?`<button type="button" class="primary" data-protected-buy-open="${i(r)}" data-protected-buy-preset="${i(o.protectedBuyPreset||fl(c))}" data-protected-buy-source="slimeshield-drawer">Protected Buy</button>`:""}
  ...
  `}function rS(e=""){const t=String(e||"").trim();return t?(n.pnl?.trades||[]).filter(a=>String(a?.tokenMint||a?.mint||"").trim()===t):[]}function I0(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=rS(a),s=!!(gn(e)&&tl(e)),o=s?gn(e):e.dexUrl||Q(np(e)||a),c=s?"Pump":"DEX";return`
  ...
  `}function O0(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=Dm(e||{});return`
  ...
  `}function sS(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=n.chartTradeTab==="sell"?"sell":"buy",s=ue(),o=n.wallets?.length?String(n.wallets[0]?.index||""):"",c=Eu(),l=pt(),d=l?.walletIndex||(l?.walletIndexes||[])[0]||"",u=s?.publicKey&&Fu(s)?"connected":"",p=n.chartBuyWalletIndex||u||(c?.index?String(c.index):"")||d||o||(s?.publicKey?"connected":""),f=pe(p),y=n.quickBuyAmountOverride||ze(l)||"",b=l?bn("trade"):"No preset / manual",v=String(l?.slippageBps||"400"),P=String(l?.takeProfitPct||"25"),A=String(l?.stopLossPct||"8"),g=String(l?.sellDelay||"off"),$=String(l?.sellPercent||"100"),C=new Set(["300","400","500"]),B=Number.isFinite(Number(v))?`${Number(v)/100}%`:v,U=t?`${i(t.uiAmount||"Position")} tokens | ${i(t.estimatedValueSol||"value n/a")} SOL`:"No SlimeWire position tracked for this token.";return`
      ...
      ${r==="buy"?`
        <div class="chart-trade-form" data-chart-trade-panel="buy">
          ...
          <div class="chart-auto-exit-grid" aria-label="Chart buy exit settings">
            ...
            <label>
              Exit Size
              ${Ht({selectAttr:"data-chart-buy-sell-percent",customAttr:'data-chart-buy-sell-percent-custom min="1" max="100" step="1"',customFor:"chart-buy-sell-percent",options:[["off","Off"],["50","50%"],["80","80%"],["100","100%"],["custom","Custom"]],selected:$,customType:"number",customPlaceholder:"Custom %"})}
            </label>
          </div>
  ...
  `}function iS(){try{return lS()}catch(e){console.error("Smart Chart render failed:",e);const t=String(n.smartChartToken||n.tradeToken||n.terminalToken||"").trim(),a=t?w(t):"No token selected",r=t?`https://dexscreener.com/solana/${encodeURIComponent(t)}?embed=1&theme=dark&trades=1&info=0`:"";return`
    ...
    `}}function lS(){const e=Vs(),t=String(e?.tokenMint||"").trim(),a=t?lt().find(o=>String(o.tokenMint)===t):null,r=t?we([e,...pr().filter(o=>String(o.tokenMint||"")===t)]).filter(Boolean).slice(0,5):Sa(br(),5,wa("smart-chart-suggest"),1);if(!t)return`
    ...
    `;oa("tokenHeaderRendered"),oa("chartSkeletonRendered"),oa("buyPanelReady"),W({component:"smartChart",action:"chart-shell-rendered",durationMs:0,cacheHit:!!(tt(t)?.cacheHit||hr(t)?.pairAddress),stale:!!tt(t)?.stale,details:t});const s=e.symbol||e.shortMint||w(t);return`
    <section class="smart-chart-terminal smart-chart-clean-terminal">
      ...
      <div class="smart-chart-grid smart-chart-clean-grid">
        <article class="terminal-panel smart-chart-main smart-chart-clean-main">
          ${(()=>{cS(t);const o=qp(t);return o?`<div class="coin-banner-hero" style="background-image:url('${o}')" role="img" aria-label="Coin banner"></div>`:""})()}
          <div class="smart-chart-token-header smart-chart-clean-token-header${qp(t)?" has-banner":""}">
            ${gt(e)}
            <div>
              <strong>${i(s)}</strong>
              <small>${i(e.name||e.category||"Token")}</small>
  ...
  `}function qp(e){const t=String(e||"").trim();return n.coinBanners&&n.coinBanners[t]||""}let Hp="";function cS(e){const t=String(e||"").trim();!t||Hp===t||(Hp=t,k(`/api/web/coin-banner?mint=${encodeURIComponent(t)}`).then(a=>{const r=String(a?.bannerUri||"");r&&(n.coinBanners=n.coinBanners||{},n.coinBanners[t]=Qe(r),n.activeTab==="smartChart"&&h({preserveSmartChartFrame:!0}))}).catch(()=>{}))}let Pl="",Kp=0;function Vp(e){e&&(Pl===e&&Date.now()-Kp<3e4||(Pl=e,Kp=Date.now(),k(`/api/web/calls?mint=${encodeURIComponent(e)}`).then(t=>{n.chartCalls={mint:e,...t},n.activeTab==="smartChart"&&h({preserveSmartChartFrame:!0})}).catch(()=>{})))}function dS(e){const t={bullish:["🟢","BULLISH"],bearish:["🔴","BEARISH"],warning:["⚠️","WARNING"],question:["❓","QUESTION"]},[a,r]=t[e]||["⚪",String(e||"").toUpperCase()];return`${a} ${r}`}function uS(e){Vp(e);const t=n.chartCalls?.mint===e?n.chartCalls:null,a=t?.calls||[],r=!!(n.token&&n.user);return`
      ...
      ${a.length?`
        <div class="table-list compact-table">
          ${a.map(s=>`
            <article class="row-card">
              <div class="row-main">
                <strong>${i(dS(s.side))} <span class="muted-text">by ${i(s.handle)}</span>
  ...
  `}async function pS(e){const t=m("[data-call-status]");try{const a=m("[data-call-side]")?.value||"bullish",r=m("[data-call-target]")?.value||"",s=m("[data-call-note]")?.value||"";S(t,"Posting call..."),await k("/api/web/calls",{method:"POST",body:JSON.stringify({tokenMint:e,side:a,targetX:r,note:s,source:"site"})}),S(t,"Call posted - it is now being tracked."),Pl="",Vp(e)}catch(a){S(t,N(a?.message||"Could not post call."))}}function mS(e,t=!1){const a=e?.tokenMint?n.positions.find(o=>String(o.tokenMint)===String(e.tokenMint)):null,r=bn("trade"),s=bn("bundle");return t?`
  ...
  `}function hS(){if(n.terminalSubtab==="orders")return Gp();if(n.terminalSubtab==="history")return Cl(12);if(n.terminalSubtab==="wallets")return tp();if(n.terminalSubtab==="kol"){const e=pp(n.kolScan?.rows||[]).filter(t=>!fr(t));return At(e,{layout:"terminal",cooksStyle:!0,limit:12,rotateKey:wa("bottom-kol"),stickyCount:1})}return n.terminalSubtab==="sniper"?n.scan?mt(n.scan.rows||[],{context:"sniper",primaryAction:"snipe",primaryActionLabel:"Snipe",hideToolbar:!0}):F("No sniper scan loaded","Open Sniper or refresh a scan mode."):n.terminalSubtab==="tx"?Jp(!0):n.terminalSubtab==="reconcile"?Xp():gS(6)}function gS(e=25){const t=lt();return t.length?`
    <div class="table-list compact-table">
      ${t.slice(0,e).map(jp).join("")}
    </div>
  `:F("No open positions","Open token holdings will show here after refresh.")}const zp=new Map;function bS(e){const t=String(e.tokenMint||"");if(!t)return"";const a=(n.pnl?.tokens||[]).find(u=>String(u.tokenMint)===t),r=mr().find(u=>String(u?.tokenMint||"")===t),s=(Array.isArray(n.tradePlans)?n.tradePlans:[]).find(u=>String(u.tokenMint)===t&&["watching","active","armed","pending"].includes(String(u.status||"").toLowerCase())),o=[];a?.spentSol&&o.push(`Entry ${a.spentSol} SOL`),r?.marketCapLabel&&o.push(`MC ${r.marketCapLabel}`),o.push(s?`TP ${s.takeProfitSummary||s.takeProfitPct||"off"} / SL ${s.stopLossSummary||s.stopLossPct||"off"} armed`:"no auto-exit armed");const c=Number(e.estimatedValueSol);let l="";if(Number.isFinite(c)){const u=zp.get(t);if(u&&Number.isFinite(u.value)&&Math.abs(c-u.value)>5e-4){const p=c-u.value;l=`${p>0?"▲ +":"▼ "}${p.toFixed(4)} SOL since last refresh`}zp.set(t,{value:c,at:Date.now()})}let d="";if(s){const u=Number(s.lastMovePct??s.wallets?.[0]?.lastMovePct),p=Number(s.takeProfitPct),f=Number(s.stopLossPct),y=Date.parse(s.sellAfterAt||s.wallets?.[0]?.sellAfterAt||""),b=Number.isFinite(y)?Math.round((y-Date.now())/6e4):null;Number.isFinite(u)&&Number.isFinite(p)&&p>0&&u>=p*.75?d=`Up ${u.toFixed(1)}% - take-profit at +${p}% is close`:Number.isFinite(u)&&Number.isFinite(f)&&f>0&&u<=-(f*.6)?d=`Down ${Math.abs(u).toFixed(1)}% - stop-loss at -${f}% is near`:b!==null&&b>0&&b<=10?d=`Timer exit in ~${b} min`:Number.isFinite(u)&&(d=`${u>=0?"Up":"Down"} ${Math.abs(u).toFixed(1)}% - exits watching`)}else ny(t)||e.source==="launch-optimistic"?d="⏳ Exits arming from your launch - TP/SL/timer registering...":d="No auto-exit on this bag - Arm Exits if you are stepping away";return`
  ...
  `}function Cl(e=10,t=null){const a=Array.isArray(t)?t:n.pnl?.trades||[];return a.length?`
  ...
  `:F("No live trade history yet","Submitted web trades will appear here after refresh.")}function yS(){const e=n.pnl?.trades||[],t=it("liveTrades",e);return`
  ...
  `}function Gp(){const e=Array.isArray(n.tradePlans)?n.tradePlans:[],t=[n.tradePlanResult,n.bundleResult,n.volumeResult,n.sniperResult,n.kolResult,n.launchResult].filter(Boolean).map(r=>({...r,localOnly:!0})),a=e.length?e:t;return a.length?`
    <div class="table-list compact-table">
      ${a.map(r=>`
        <article class="row-card stop-loss-audit-card">
          <div class="row-main">
            ...
            ${r.wallets?.length?`<div class="audit-wallet-list">${r.wallets.map(vS).join("")}</div>`:""}
          </div>
          <div class="card-actions compact">
  ...
  `:F("No active audit item loaded","Managed exits show status here after you create a trade, bundle, volume, sniper, KOL, or launch plan. Server-side TP/SL only auto-executes from managed automation wallets. Phantom and Solflare browser wallets require manual approval unless a future audited delegation/session feature is enabled.")}function vS(e={}){const t=e.lastTriggerCheckAt||e.lastCheckedAt||"",a=e.triggerStatus||e.exitStatus||e.status||"watching",r=e.lastMovePct??e.lastGrossMovePct,s=Number.isFinite(Number(r))?`${Number(r).toFixed(2)}%`:"not checked",o=Number.isFinite(Number(e.lastNetMovePct))?` net ${Number(e.lastNetMovePct).toFixed(2)}%`:"",c=e.retryAfterAt?` | retry ${Jn(nn(e.retryAfterAt))}`:"",l=e.lastError||e.lastPriceEstimateError||"",d=Number.isFinite(Number(e.lastStopLossPct))?`SL ${Number(e.lastStopLossPct).toFixed(2).replace(/\.00$/,"")}% triggers at -${Number(e.lastStopLossTriggerPct||e.lastStopLossPct).toFixed(2).replace(/\.00$/,"")}%`:"SL off",u=Number.isFinite(Number(e.lastTakeProfitPct))?`TP +${Number(e.lastTakeProfitPct).toFixed(2).replace(/\.00$/,"")}%`:"TP off",p=`should SL: ${e.lastShouldTriggerStopLoss===!0?"yes":"no"} | should TP: ${e.lastShouldTriggerTakeProfit===!0?"yes":"no"}`;return`
    <div class="audit-wallet-row">
      ...
      <div>
        ...
        <small>Move ${i(s)}${i(o)} | checked ${i(Jn(nn(t)))}${i(c)}</small>
  ...
  `}function Xp(){const e=n.balances.filter(a=>a.error),t=n.balances.reduce((a,r)=>a+Number(r.warnings?.length||0),0);return`
    <section class="account-check-card reconciliation-card">
      <div>
        ...
        <small>Last updated: ${i(Jn(nn(n.lastWalletRefreshAt)))} | Warnings: ${t} | Errors: ${e.length}</small>
      </div>
  ...
  `}function Jp(e=!1){const t=n.terminalTxAudit;return`
    <section class="${e?"tx-audit compact":"terminal-layout tx-audit"}">
      <main class="terminal-main">
        ...
        ${t?wS(t):F("No transaction loaded","Use this when a wallet balance looks stale or a trade needs accounting review.")}
      </main>
      ${e?"":`<aside class="trade-side order-ticket-stack">${Gp()}${Xp()}</aside>`}
    </section>
  `}function wS(e){return e.error?`<article class="row-card"><strong>Audit failed</strong><span>${i(e.error)}</span></article>`:`
...
`)||"No logs returned.")}</pre>
  ...
  `}function SS(e=[]){const t=[...e].sort((a,r)=>Number(r.bestPickScore||r.score||0)-Number(a.bestPickScore||a.score||0)||nt(a,r));return Sa(t,5,wa("cooks-best"),1)}function me(e){const t=Number(e);return Number.isFinite(t)?t:0}function oo(){const e=n.liveFeedCategory||"best";return Yo.find(([t])=>t===e)||Yo[0]}function Tr(e={}){return Cr(e)||am(e)||mo(e)||0}function io(e={}){return me(e.buys5m)+me(e.buysH1)+me(e.sells5m)+me(e.sellsH1)}function Ll(e={}){const t=me(e.buys5m)+me(e.buysH1),a=me(e.sells5m)+me(e.sellsH1),r=t+a;return r>0?t/r:.5}function Ar(e={}){return Math.max(me(e.m5),me(e.h1),me(e.h24))}function lo(e={}){return Math.max(me(e.m5),me(e.h1))}function Yp(e={}){return lo(e)*Math.log10(10+Tr(e))*(.5+Ll(e))}function Qp(e={}){return e.boosted||e.isBoosted||e.boost||e.boosts?!0:`${e.source||""} ${e.category||""} ${e.liveLabel||""} ${e.sourceLabel||""}`.toLowerCase().includes("boost")}function kS(e=[],t="best"){const a=[...e];switch(t){case"volume":return a.sort((r,s)=>Tr(s)-Tr(r));case"liquidity":return a.sort((r,s)=>ht(s)-ht(r));case"marketcap":return a.sort((r,s)=>ft(s)-ft(r));case"active":return a.sort((r,s)=>io(s)-io(r));case"fresh":return a.sort(nt);case"gainers":return a.sort((r,s)=>Ar(s)-Ar(r));default:return a.sort((r,s)=>me(s.bestPickScore||s.score)-me(r.bestPickScore||r.score)||nt(r,s))}}function co(){const e=n.liveTerminalCategory||"dexTrending";return za.find(([t])=>t===e)||za[0]}function $S(e,t,a,r){return`
    ...
    </label>`}function TS(){if(n.activeTab==="terminal"){const t=co();return{categories:za,activeId:t[0],sub:t[2],attr:"data-live-terminal-category",cap:"Discover",rank:a=>Zp(a,t[0]),hasBest:!1}}const e=oo();return{categories:Yo,activeId:e[0],sub:e[2],attr:"data-live-feed-category",cap:"Feed",rank:t=>kS(t,e[0]),hasBest:e[0]==="best"}}function AS(e={}){if(Qp(e))return{cls:"boost",text:"⚡ Boosted"};const t=Ar(e);if(t>=40)return{cls:"gain",text:`▲ ${Math.round(t)}%`};const a=Number(e.pairAgeMinutes);return Number.isFinite(a)&&a>=0&&a<=10?{cls:"fresh",text:"✨ Fresh"}:lo(e)>=25?{cls:"hot",text:"🔥 Hot"}:Ll(e)>=.7&&io(e)>=24?{cls:"active",text:"● Active"}:null}function xl(e={}){const t=AS(e);return t?`<span class="signal-badge signal-badge-${t.cls}">${i(t.text)}</span>`:""}function PS(e={}){const t=[];Qp(e)&&t.push("⚡ boosted");const a=[["5m",me(e.m5)],["1h",me(e.h1)],["24h",me(e.h24)]];a.sort((c,l)=>l[1]-c[1]),a[0][1]>=12&&t.push(`▲${Math.round(a[0][1])}% ${a[0][0]}`);const r=io(e),s=Ll(e);r>=12&&s>=.62&&t.push(`${Math.round(s*100)}% buys`),e.smartMoney&&t.push("smart money in");const o=Cr(e)||mo(e);return o>=2e3&&t.length<3&&t.push(`${M(o)} vol`),r>=30&&t.length<3&&t.push(`${r} trades`),Number(e.sniperCount||0)===0&&a[0][1]>=12&&t.length<3&&t.push("no snipers"),t.slice(0,3)}function CS(e={}){const t=PS(e);return t.length?`<div class="signal-why" title="Why it's moving"><small><span class="signal-why-tag">Why</span> ${i(t.join(" · "))}</small></div>`:""}function LS(e={}){return e.isPump||e.pump||e.pumpFun||e.pumpUrl?!0:`${e.source||""} ${e.category||""} ${e.dexId||""} ${e.dexName||""}`.toLowerCase().includes("pump")}function F0(e={}){const t=`${e.name||""} ${e.symbol||""} ${e.category||""}`.toLowerCase();return LS(e)||/meme|dog|cat|pepe|wif|inu|elon|moon|bonk|frog|chad/.test(t)}function Pr(){const e=n.cookSpotCategory||"dexTrending";return za.find(([t])=>t===e)||za[0]}function Zp(e=[],t="dexTrending"){const a=[...e];switch(t){case"fresh":return a.sort(nt);case"dexBoosted":case"graduated":return a.sort((r,s)=>Tr(s)-Tr(r));case"memeMovers":return a.sort((r,s)=>Ar(s)-Ar(r));case"earlyMomentum":return a.sort((r,s)=>lo(s)-lo(r));default:return a.sort((r,s)=>Yp(s)-Yp(r))}}function xS(e=Pr()){const[t]=e;return`
    ...
    </label>`}function em(e=0,t=""){const a=nn(t),r=a===null?"live":Jn(a);return`<div class="cooks-meta" data-cooks-meta><span><b>${e}</b> ${e===1?"pair":"pairs"}</span><span aria-hidden="true">·</span><span>updated ${i(r)}</span></div>`}function Ml(e=[]){const t=TS(),a=$S(t.categories,t.activeId,t.attr,t.cap),r='<button type="button" class="cooks-inline-refresh" data-refresh-live-pairs title="Refresh feed">↻ Refresh</button>',s=em(e.length,ua()),o={context:"live",shareBuilder:Pa,hideToolbar:!0};if(t.hasBest){const l=SS(e),d=new Set(l.map(va).filter(Boolean)),u=[...e].sort(nt).filter(f=>!d.has(va(f))),p=it("live",u);return`
    <div class="cooks-feed">
      ...
      <div class="cooks-section" data-cooks-best>
        ...
        ${l.length?mt(l,o):F("No pairs found for this filter yet","Keep this tab open or tap Refresh — picks fill in as pairs qualify.")}
      </div>
    ...
    </div>`}function tm(){const e=qe(),t=we(e?.rows||[]),a=vn(t),r=it("live",a),s=Et.find(([f])=>f===n.livePairBucket)?.[1]||"Live",o=ua(),c=!!n.livePairsLoadingByBucket[n.livePairBucket],l=yn(),d=n.livePairsRefreshErrorByBucket?.[n.livePairBucket],u=c?"Scanning live pairs...":e?.message||"Cooks refreshes while this tab is open.",p=a.length?Ml(a):l?wr(t,`${s.toLowerCase()} pairs`):d?F("Unable to load pairs. Try refreshing.","The live feed hit a snag — it keeps retrying automatically, or tap ↻ Refresh."):c?F("Loading live pairs…","Scanning fresh pairs for this time window."):F("No pairs found for this filter yet","Keep this tab open or tap Refresh Live. Trade safety checks run before any buy.");return`
    <section class="terminal-layout live-terminal">
      <main class="terminal-main">
        ...
        ${gl("live",{rawCount:t.length,visibleCount:a.length})}
        ${hl(t,a)}
        ${Hi("live")}
        ${p}
        ${da("live",a,`${s} pairs`)}
  ...
  `}function W0(e){const t={live:"Brand-new launches under an hour old. Best Picks rotates the strongest; Newest streams them as they appear.",under1h:"Pairs aged about 1 to 2 hours - past the first-minute chaos, early momentum still forming.",under3h:"Pairs aged about 3 to 6 hours - established enough to show a real volume and liquidity trend.",under1d:"Pairs aged about 24 to 48 hours - day-old survivors ranked by liquidity, volume, momentum, and risk."};return t[e]||t.live}function MS(){if(!n.user||!n.token)return`${ls()}${F("Create or log in to save a watchlist","You can browse scanners as a guest. Tap Watch after creating an account to save coins here.")}`;const e=n.watchlist?.rows||[],t=n.watchlistTagFilter||"",a=[...new Set(e.flatMap(l=>Array.isArray(l.tags)?l.tags:[]))].slice(0,20),r=t&&!a.some(l=>l.toLowerCase()===t.toLowerCase())?"":t,s=r?e.filter(l=>Array.isArray(l.tags)&&l.tags.some(d=>String(d).toLowerCase()===r.toLowerCase())):e,o=it("watchlist",s),c=a.length?`
    ...
    <section class="terminal-layout watchlist-terminal">
      <main class="terminal-main">
        ...
        ${o.length?mt(o,{context:"watchlist",shareBuilder:l=>Oi(l.tokenMint)}):F("No watched coins yet","Tap Watch on Cooks, Sniper, or KOL signals to save coins here.")}
  ...
  `}function _0(e){return mt(e,{context:"live",shareBuilder:Pa})}function mt(e,t={}){const a=t.shareBuilder||Pa,r=we(e),s=`signal-list ${t.context==="kol"?"signal-list-kol":""}`.trim();return r.length?`
    ...
    <div class="${i(s)}">
      ...
      ${r.map((o,c)=>BS(o,c,{...t,shareText:a(o),priority:c<12})).join("")}
    </div>
  `:`
      ${t.hideToolbar?"":Hi(t.context||"scanner")}
    ...
    <article class="signal-row ${l?"is-kol-signal":""}" data-token-chart="${i(e.tokenMint)}" data-token-chart-source="${i(a.context||"signal-row")}">
      ...
      <div class="signal-cell" data-cell="Liq"><span>${i(_(e.liquidityLabel,ht(e)>0?M(ht(e)):"","checking"))}</span><small>${RS(e.h1)}</small></div>
      <div class="signal-cell" data-cell="MC"><span>${i(_(e.marketCapLabel,ft(e)>0?M(ft(e)):"","checking"))}</span><small>${i(e.category||e.signalType||"signal")}</small></div>
      <div class="signal-cell" data-cell="Txns"><span>${i(e.txnsLabel||e.winRateLabel||"n/a")}</span><small>${i(dw(e))}</small></div>
      <div class="signal-cell volume-windows" data-cell="Vol">
        <span>${i(_(e.volumeH1Label,e.volumeLabel,Cr(e)>0?M(Cr(e)):"","checking"))}</span>
        <small>${gp(e).map(([u,p])=>`${u} ${p}`).join(" | ")}</small>
      </div>
  ...
  `}function ES(e){const t={safe:"Safer-looking picks with stronger liquidity, cleaner trend, lower risk flags, and no obvious dump/sell-pressure pattern.",smart:"Accumulation-style picks: buyer pressure, steady volume, and cleaner momentum without obvious sell pressure.",fast:"Fast movers with volume picking up and a cleaner short-term trend for quicker in-and-out trades.",pumpsnipe:"Very early pump-style launches, usually lower market cap, with enough volume/liquidity to attempt a quick trade.",moonshot:"Low market-cap picks targeting the 4k-40k range, with fallback up to 60k only when the cleaner low-cap pool is thin.",meme:"Narrative picks based on token metadata/keywords plus volume and trend checks. Add a social feed later for true social velocity.",long:"Longer-hold candidates with steadier accumulation signals and less short-term dump pressure."};return t[e]||t.safe}function FS(){if(!n.wallets.length)return F("Create wallets to snipe","Sniper can scan without wallets, but buying needs at least one managed wallet.");const e=n.scanMode==="pumpsnipe",t=[{key:"wallets",label:"Wallets",hint:"Who buys",html:`
      ...
      `},{key:"repeat",label:"Repeat & Slip",hint:"Cycles, slippage",html:`
        <div class="volume-grid">
          ...
          <label>
            Repeat Wait
            ${hs("sniper-loop-delay","data-sniper-loop-delay","0")}
          </label>
          <label>
            Slippage
      ...
      `},{key:"targets",label:"Per-Wallet",hint:"Exit targets",html:bs("sniper")||'<p class="trade-status">No per-wallet exit targets yet.</p>'}];return`
  ...
  `}function WS(){const e=n.sniperResult;return e?.results?.length?`<div class="mini-results">${e.results.map(t=>`<span data-ok="${t.ok?"true":"false"}">${i(t.message||t)}</span>`).join("")}</div>`:""}function _S(){const e=n.scan.rows||[],t=it("sniper",e);return e.length?`
    ...
    ${mt(t,{context:"sniper",primaryAction:"snipe",primaryActionLabel:"Snipe",shareBuilder:Bg})}
    ${da("sniper",e,"snipe candidates")}
  `:F("No usable picks","Refresh again or choose a different mode.")}function fo(){return n.user?.connectedWallet?.publicKey||""}function nm(){return n.ogreTek.markets.find(e=>e.symbol===n.ogreTek.selectedMarket)||n.ogreTek.markets[0]||null}function NS(){return{marketSymbol:n.ogreTek.selectedMarket,direction:n.ogreTek.direction,orderType:n.ogreTek.orderType,collateralUsd:n.ogreTek.collateralUsd,leverage:n.ogreTek.leverage,slippagePct:n.ogreTek.slippagePct,priorityFeeLamports:n.ogreTek.priorityFeeLamports,limitPrice:n.ogreTek.limitPrice,stopPrice:n.ogreTek.stopPrice}}function rm(){return Nm(NS(),nm(),n.ogreTek.account,Ae)}function $e(e,t=2){const a=Number(e);return Number.isFinite(a)?Math.abs(a)>=1e9?`$${(a/1e9).toFixed(2)}B`:Math.abs(a)>=1e6?`$${(a/1e6).toFixed(2)}M`:Math.abs(a)>=1e3?`$${(a/1e3).toFixed(1)}K`:`$${a.toFixed(t)}`:"n/a"}function bt(e){const t=Number(e);return Number.isFinite(t)?t>=1e3?`$${t.toLocaleString(void 0,{maximumFractionDigits:2})}`:`$${t.toFixed(t>=10?2:4)}`:"n/a"}function ho(e,t=3){const a=Number(e);return Number.isFinite(a)?`${a>=0?"+":""}${a.toFixed(t)}%`:"n/a"}function sm(e){const t=Date.parse(e||"");if(!t)return"not loaded";const a=Math.max(0,Math.round((Date.now()-t)/1e3));return a<60?`${a}s ago`:`${Math.round(a/60)}m ago`}function go(){document.querySelectorAll("[data-ogre-tek-field]").forEach(e=>{const t=e.dataset.ogreTekField;!t||!(t in n.ogreTek)||(e.type==="checkbox"?n.ogreTek[t]=!!e.checked:n.ogreTek[t]=e.value)})}async function DS(){!Ae.enabled||n.ogreTek.loading||n.ogreTek.markets.length||n.ogreTek.error||await Lr({silent:!0}).catch(e=>{n.ogreTek.error=N(e.message),h({force:!0})})}async function Lr({force:e=!1,silent:t=!1}={}){if(Ae.enabled&&!(n.ogreTek.loading&&!e)){n.ogreTek.loading=!0,n.ogreTek.error="",t||h({force:!0});try{const a=fo(),[r,s,o,c]=await Promise.all([Rr.getMarkets(),Rr.getAccount(a),Rr.getPositions(a),Rr.getOpenOrders(a)]);n.ogreTek.markets=r||[],n.ogreTek.account=s||null,n.ogreTek.positions=o||[],n.ogreTek.orders=c||[],n.ogreTek.markets.some(l=>l.symbol===n.ogreTek.selectedMarket)||(n.ogreTek.selectedMarket=n.ogreTek.markets[0]?.symbol||"SOL-PERP"),n.ogreTek.status=`Updated ${new Date().toLocaleTimeString()}`}catch(a){n.ogreTek.error=N(a.message)}finally{n.ogreTek.loading=!1,h({force:!0})}}}function US(){return`
  ...
  `}function qS(){if(Fm(Ae)!=="enabled")return US();const e=!!fo(),t=nm(),a=rm(),r=a.quote,s=n.ogreTek.account,o=a.ok&&!n.ogreTek.loading,c=n.ogreTek.error?"Provider Error":n.ogreTek.loading?"Loading":"Ready",l=Ae.demoMode?"Review Demo Trade":"Review Trade",d=Ae.demoMode?"Confirm Demo Review":"Confirm Order",u=Ae.demoMode?!n.ogreTek.riskAccepted||!a.ok:!Om({validation:a,riskAccepted:n.ogreTek.riskAccepted,demoMode:Ae.demoMode});return`
    <section class="ogre-tek-page">
      ...
      ${n.ogreTek.reviewOpen?GS({validation:a,quote:r,market:t,confirmButtonText:d,confirmDisabled:u}):""}
    </section>
  `}function HS(){return n.ogreTek.loading&&!n.ogreTek.markets.length?F("Loading markets","Ogre Tek is loading demo perps markets."):n.ogreTek.markets.length?`
    <div class="ogre-market-grid">
      ${n.ogreTek.markets.map(e=>`
        <button type="button" class="ogre-market-card" data-ogre-tek-market="${i(e.symbol)}" data-active="${e.symbol===n.ogreTek.selectedMarket}">
          ...
          <small>Oracle ${bt(e.oraclePrice)} | 24h ${ho(e.change24hPct,2)}</small>
          <small>Funding ${ho(e.fundingRatePct,3)} | OI ${$e(e.openInterestUsd,0)}</small>
          <small>Fresh ${i(sm(e.updatedAt))}</small>
        </button>
      `).join("")}
    </div>
  ...
  `}function om(e){const t=e.errors||[],a=e.warnings||[];return!t.length&&!a.length?'<p class="trade-status" data-ok="true">Ogre Guardrails passed for demo review.</p>':`
    <div class="ogre-risk-list">
      ${t.map(r=>`<p data-kind="error">${i(r)}</p>`).join("")}
      ${a.map(r=>`<p data-kind="warning">${i(r)}</p>`).join("")}
    </div>
  `}function VS(){return fo()?n.ogreTek.positions.length?`
    <div class="ogre-tek-table">
      ...
      ${n.ogreTek.positions.map(e=>`
        <div class="ogre-table-row">
          <span><strong>${i(e.marketSymbol)}</strong><small>${i(e.side)} | margin ${ho(e.marginRatioPct,1)}</small></span>
  ...
  `:F("No open positions","Mock positions will appear here when the provider reports them."):F("Wallet disconnected","Connect Phantom, Solflare, Backpack, or another detected Solana wallet to view perps account data.")}function zS(){return fo()?n.ogreTek.orders.length?`
  ...
  `:F("No orders","Open, trigger, and history orders will list here when a real adapter is configured."):F("Wallet disconnected","Connect a wallet to load open and trigger orders.")}function jS(e){return e?.connected?`
    <div class="ogre-account-grid">
      ...
      <span><small>Account Freshness</small><strong>${i(sm(e.updatedAt))}</strong></span>
    </div>
    ...
    <div class="ogre-tek-modal-backdrop" role="presentation">
      <article class="ogre-tek-modal" role="dialog" aria-modal="true" aria-label="Ogre Tek risk confirmation">
        ...
        <div class="ogre-review-grid">
          ...
          <span><small>Funding Rate</small><strong>${ho(a?.fundingRatePct,3)}</strong></span>
  ...
  `}function im(){return{role:"assistant",text:"Ogre Agent ready. Ask naturally: check this CA, show links, does it look risky, buy 0.1 SOL from wallet 1, sell half, refresh positions, find best picks, or ask where anything is on web or mobile.",actions:[{label:"Show Positions",type:"open_tab",tab:"positions"},{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Fast Mode",type:"toggle_agent_fast_mode"},{label:"Auto-Trade On",type:"approve_agent_auto_trade"},{label:"Best Picks",type:"open_tab",tab:"ogreAi"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}const Rl="slimewire:ogreAgentMessages:v1",Il="slimewire:ogreAgentLastToken:v1";function XS(){try{const e=JSON.parse(localStorage.getItem(Rl)||"[]");return Array.isArray(e)?e.filter(t=>t&&typeof t=="object"&&String(t.text||"").trim()).slice(-50).map(t=>({role:t.role==="user"?"user":"assistant",text:String(t.text||"").slice(0,1200),actions:Array.isArray(t.actions)?t.actions.slice(0,4):[],retryText:String(t.retryText||"").slice(0,1200)})):[]}catch{return[]}}function JS(){try{localStorage.setItem(Rl,JSON.stringify(Tn().slice(-50)))}catch{}}function jt(){if(n.ogreAgentLastTokenMint)return String(n.ogreAgentLastTokenMint);try{n.ogreAgentLastTokenMint=String(localStorage.getItem(Il)||"").trim()}catch{n.ogreAgentLastTokenMint=""}return n.ogreAgentLastTokenMint||""}function bo(e=""){const t=String(e||"").trim();if(!t)return"";n.ogreAgentLastTokenMint=t;try{localStorage.setItem(Il,t)}catch{}return t}function Tn(){if(!Array.isArray(n.ogreAgentMessages)||!n.ogreAgentMessages.length){const e=XS();n.ogreAgentMessages=e.length?e:[im()]}return n.ogreAgentMessages}function YS(){const e=String(n.smartChartToken||n.tradeToken||jt()||"").trim(),t=e?$a(e):null,a=t?.tokenMint?at(t):null,r=e?Fp(e):null,s=e?kl(e):null,o=As().slice(0,3),c=e?lt().find(l=>String(l.tokenMint||"")===e):null;return{route:n.route,activeTab:n.activeTab,agentFastMode:n.ogreAgentFastMode,agentAutoTradeApproved:So(),lastTokenMint:jt(),recentAgentMessages:Tn().slice(-8).map(l=>({role:l.role==="user"?"user":"assistant",text:String(l.text||"").slice(0,600)})),smartChartToken:n.smartChartToken||"",tradeToken:n.tradeToken||"",livePairBucket:n.livePairBucket||"",slimeScopeMode:n.slimeScopeMode||"",walletConnected:!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey),walletCount:vi(),positionCount:lt().length,totalSol:Nt().toFixed(4),selectedTradePreset:bn("trade"),selectedBundlePreset:bn("bundle"),quickBuyAmount:String(Wl()||""),currentToken:e?{tokenMint:e,symbol:t?.symbol||"",name:t?.name||"",watched:uo(e)}:null,slimeShield:a?{verdict:a.verdict,summary:a.summary,confidence:a.confidence,suggestedAction:a.suggestedAction,topFactors:(a.factors||[]).slice(0,4).map(l=>l.message||l.label||l.key)}:null,devInfoSummary:r?{status:r.status,confidence:r.confidence,summary:r.summary,likelyDevWalletShort:r.likelyDevWallet?w(r.likelyDevWallet):"",currentPositionStatus:r.currentPosition?.positionStatus||"unknown",launchesTracked:r.historicalStats?.launchesTracked||0}:null,kolDumpDetector:o.length?o.map(l=>({displayName:l.displayName,riskLabel:l.riskLabel,dumpRiskPercent:l.lowData?null:l.dumpRiskPercent,lowData:!!l.lowData,summary:ir(l)})):[],replayBeforeBuy:s?{sampleSize:s.sampleSize,confidence:s.confidence,winRatePercent:s.winRatePercent,medianMaxDrawdownPercent:s.medianMaxDrawdownPercent,summary:s.summary}:null,pnlSummary:{realized:wi(),positions:lt().length,totalSol:Nt().toFixed(4)},profile:{hasReferralCode:!!n.user?.referralCode,referralCode:n.user?.referralCode||"",hasReferralPayoutWallet:!!n.user?.referralPayoutWallet,hasXHandle:!!(n.xHandle||n.user?.xHandle),traderBoardEnabled:n.user?.traderBoardVisible!==!1},selectedPosition:c?{tokenMint:c.tokenMint,uiAmount:c.uiAmount,estimatedValueSol:c.estimatedValueSol,openPnlSol:c.openPnlSol||c.realizedSol||""}:null,walletPublicKey:String(n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"").slice(0,80),recentPairs:lm()}}function lm(){const e=[],t=new Set,a=(r,s="feed")=>{if(!r)return;if(Array.isArray(r)){r.forEach(l=>a(l,s));return}if(Array.isArray(r.rows)){r.rows.forEach(l=>a(l,s));return}if(r.data&&Array.isArray(r.data.rows)){r.data.rows.forEach(l=>a(l,s));return}if(typeof r!="object")return;const o=String(r.tokenMint||r.mint||r.baseMint||r.tokenAddress||r.pairAddress||"").trim();if(!o)return;const c=o.toLowerCase();t.has(c)||(t.add(c),e.push({tokenMint:o,pairAddress:String(r.pairAddress||r.pair||"").trim(),symbol:String(r.symbol||r.baseSymbol||r.ticker||"").trim().slice(0,24),name:String(r.name||r.baseName||r.label||"").trim().slice(0,48),ageMinutes:Number(r.ageMinutes??r.pairAgeMinutes??r.ageMins??NaN),marketCap:Number(r.marketCap??r.marketCapUsd??r.fdv??NaN),liquidityUsd:Number(r.liquidityUsd??r.liquidity?.usd??NaN),volume5m:Number(r.volume5m??r.volume?.m5??NaN),volume1h:Number(r.volume1h??r.volumeH1??r.volume?.h1??NaN),buys5m:Number(r.buys5m??r.txns?.m5?.buys??NaN),sells5m:Number(r.sells5m??r.txns?.m5?.sells??NaN),score:Number(r.score??r.ogreScore??r.sniperScore??NaN),riskFlags:Array.isArray(r.riskFlags)?r.riskFlags.slice(0,6).map(String):[],riskLevel:String(r.riskLevel||r.risk||r.safetyNote||"").slice(0,40),twitterUrl:String(r.twitterUrl||r.xUrl||r.links?.twitter||r.links?.x||"").trim(),telegramUrl:String(r.telegramUrl||r.links?.telegram||"").trim(),websiteUrl:String(r.websiteUrl||r.website||r.links?.website||"").trim(),source:s}))};return a(n.livePairRows,"live-pairs"),a(n.slimeScopeRows,"slime-scope"),a(n.livePairs,"live-pairs"),Object.values(n.livePairsByBucket||{}).forEach(r=>a(r,"bucket")),Object.values(n.terminalFeeds||{}).forEach(r=>a(r,"terminal-feed")),e.sort((r,s)=>cm(s)-cm(r)).slice(0,24)}function cm(e={}){const t=A=>Number.isFinite(Number(A))?Number(A):0,a=t(e.ageMinutes),r=t(e.marketCap),s=t(e.liquidityUsd),o=t(e.volume5m),c=t(e.volume1h),l=Math.max(o,c*.18),d=a>0?Math.max(0,90-Math.min(a,360))/2.5:12,u=a>120?Math.min(42,(a-120)/4):0,p=r>0&&r<=125e3?22:r>0&&r<=25e4?11:r>65e4?-18:0,f=r>0?l/r:0,y=f>=.08?24:f>=.04?16:f>=.018?8:l>0?2:-18,b=Math.max(0,t(e.buys5m)-t(e.sells5m))*2.6,v=e.twitterUrl||e.telegramUrl||e.websiteUrl?10:0,P=Array.isArray(e.riskFlags)&&e.riskFlags.length?Math.min(16,e.riskFlags.length*3):0;return t(e.score)+d+p+y+Math.log10(1+o+c)*7+Math.log10(1+s)*3+b+v-P-u}function QS(e={}){return String(e.label||e.type||"Run").slice(0,40)}function ZS(e={},t=0){const a=Array.isArray(e.actions)?e.actions.slice(0,4):[],r=e.role!=="user";return`
    <div class="ogre-agent-message ${e.role==="user"?"user":"assistant"}">
      ...
      ${a.length?`<div class="ogre-agent-actions">${a.map((s,o)=>`<button type="button" data-ogre-agent-action="${t}:${o}">${i(QS(s))}</button>`).join("")}</div>`:""}
    </div>
  `}function ek(){const e=!!(n.ogreAgentLoading||n.ogreAgentSpeaking),t=!!n.ogreAgentListening,a=!!n.ogreAgentVoiceEnabled;return`
  ...
  `}function tk(){const e=!!n.ogreAgentOpen,t=Tn(),a=n.ogreAgentVoiceEnabled?"Voice On":"Voice Off",r=mm(),s=n.ogreAgentListening?"Stop":"Mic";return`
  ...
  `}function E({force:e=!1}={}){let t=document.querySelector("[data-ogre-agent-mount]");t||(t=document.createElement("div"),t.dataset.ogreAgentMount="true",document.body.appendChild(t));const a=t.querySelector("[data-ogre-agent-input]"),r=!!(a&&document.activeElement===a),s=r?a.selectionStart:null,o=r?a.selectionEnd:null,c=t.querySelector("[data-ogre-agent-feed]"),l=c?c.scrollTop:0,d=c?c.scrollHeight-c.scrollTop-c.clientHeight<64:!0;a&&(n.ogreAgentDraft=a.value);const u=Array.isArray(n.ogreAgentMessages)?n.ogreAgentMessages:[],p=u[u.length-1]||{},f=[n.ogreAgentOpen?"open":"closed",n.ogreAgentLoading?"loading":"idle",n.ogreAgentStatus||"",u.length,p.role||"",p.text||"",Array.isArray(p.actions)?p.actions.length:0,n.ogreAgentVoiceEnabled?"voice-on":"voice-off",n.ogreAgentSpeaking?"speaking":"silent",n.ogreAgentListening?"listening":"not-listening"].join("|");if(!e&&r&&t.dataset.ogreAgentSignature===f)return;t.innerHTML=tk(),t.dataset.ogreAgentSignature=f,t.querySelector("[data-ogre-agent-close]")?.addEventListener("click",v=>{v.preventDefault(),v.stopPropagation(),wo()});const y=t.querySelector("[data-ogre-agent-input]");y&&(y.value=n.ogreAgentDraft||"",r&&(y.focus({preventScroll:!0}),s!==null&&o!==null&&y.setSelectionRange(s,o),setTimeout(()=>y.scrollIntoView({block:"nearest",behavior:"smooth"}),90)));const b=t.querySelector("[data-ogre-agent-feed]");b&&(e||d||n.ogreAgentLoading?b.scrollTop=b.scrollHeight:b.scrollTop=Math.min(l,Math.max(0,b.scrollHeight-b.clientHeight)))}document.addEventListener("focusin",e=>{const t=e.target?.matches?.("[data-ogre-agent-input]")?e.target:null;t&&setTimeout(()=>t.scrollIntoView({block:"nearest",behavior:"smooth"}),160)},{passive:!0});function fe(e={}){const t={role:e.role==="user"?"user":"assistant",text:String(e.text||"").slice(0,1800),actions:Array.isArray(e.actions)?e.actions.slice(0,4):[],retryText:String(e.retryText||"").slice(0,1200)};n.ogreAgentMessages=[...Tn(),t].slice(-50),JS(),t.role==="assistant"&&um(t.text||"")}function Ol(){return typeof window<"u"&&"speechSynthesis"in window&&"SpeechSynthesisUtterance"in window}function ak(){if(!Ol())return null;const e=window.speechSynthesis.getVoices?.()||[];if(!e.length)return null;const t=a=>{const r=`${a.name||""} ${a.voiceURI||""}`.toLowerCase(),s=String(a.lang||"").toLowerCase();let o=0;return(/^en[-_]/.test(s)||s==="en")&&(o+=18),/google|microsoft|natural|premium|enhanced|neural|online|siri|alex|daniel|guy|david|mark|george|james|fred/i.test(r)&&(o+=18),/google us english|microsoft guy|microsoft david|google uk english male|daniel|alex|george|james|mark/i.test(r)&&(o+=14),/female|zira|samantha|victoria|karen|moira|susan/i.test(r)&&(o-=2),/compact|eloquence|robot|novelty|whisper|bells|bubbles|organ|zarvox/i.test(r)&&(o-=25),a.localService&&(o+=3),o};return e.slice().sort((a,r)=>t(r)-t(a))[0]||e[0]||null}let An=null;function nk(){if(typeof window>"u")return null;const e=window.AudioContext||window.webkitAudioContext;if(!e)return null;try{return(!An||An.state==="closed")&&(An=new e),An.state==="suspended"&&An.resume(),An}catch{return null}}function dm(e="reply"){if(!n.ogreAgentVoiceEnabled||!n.ogreAgentOpen)return;const t=nk();if(t)try{const a=t.currentTime,r=e==="online"?.22:.34,s=t.createGain(),o=t.createBiquadFilter(),c=t.createOscillator(),l=t.createOscillator(),d=t.createGain();s.gain.setValueAtTime(1e-4,a),s.gain.exponentialRampToValueAtTime(e==="online"?.08:.105,a+.035),s.gain.exponentialRampToValueAtTime(1e-4,a+r),o.type="lowpass",o.frequency.setValueAtTime(210,a),o.frequency.exponentialRampToValueAtTime(92,a+r),o.Q.setValueAtTime(5.2,a),c.type="sawtooth",c.frequency.setValueAtTime(e==="online"?92:68,a),c.frequency.exponentialRampToValueAtTime(e==="online"?64:49,a+r),l.type="sine",l.frequency.setValueAtTime(e==="online"?45:38,a),l.frequency.exponentialRampToValueAtTime(e==="online"?35:31,a+r),d.gain.setValueAtTime(.18,a),d.gain.exponentialRampToValueAtTime(1e-4,a+r),c.connect(o),o.connect(s),l.connect(d),d.connect(s),s.connect(t.destination),c.start(a),l.start(a),c.stop(a+r+.02),l.stop(a+r+.02)}catch{}}function Ct(e=!1){n.ogreAgentSpeaking=!!e,n.ogreAgentOpen&&E({force:!0})}function yo(){if(!Ol()){Ct(!1);return}try{window.speechSynthesis.cancel()}catch{}Ct(!1)}function rk(e=""){return String(e||"").replace(/https?:\/\/\S+/gi," link available ").replace(/[•*_`#>~|]+/g," ").replace(/\b[A-HJ-NP-Za-km-z1-9]{32,44}\b/g," token address ").split(/\n+/).map(r=>r.replace(/^\d+\.\s*/,"").trim()).filter(r=>r&&!/^(open|refresh|show|check|buy|sell|dex|pump|telegram|website|x search|kol tracker)\b/i.test(r)).join(". ").replace(/\s+/g," ").split(/(?<=[.!?])\s+/).map(r=>r.trim()).filter(Boolean).slice(0,3).join(" ").trim().slice(0,360)}function um(e=""){if(!n.ogreAgentVoiceEnabled||!n.ogreAgentOpen||!Ol()){Ct(!1);return}const t=rk(e);if(!t){Ct(!1);return}try{window.speechSynthesis.cancel();const a=new window.SpeechSynthesisUtterance(t),r=ak();r&&(a.voice=r),a.pitch=.72,a.rate=.86,a.volume=1,a.onstart=()=>Ct(!0),a.onend=()=>Ct(!1),a.onerror=()=>Ct(!1),Ct(!0),dm("reply"),window.speechSynthesis.speak(a)}catch{Ct(!1)}}function sk(e){n.ogreAgentVoiceEnabled=!!e;try{localStorage.setItem("ogreAgentVoiceEnabled",n.ogreAgentVoiceEnabled?"on":"off")}catch{}n.ogreAgentVoiceEnabled?(n.ogreAgentStatus="Ogre voice on.",dm("online"),um("Ogre voice online.")):(yo(),n.ogreAgentStatus="Ogre voice muted."),E({force:!0})}function pm(){return typeof window>"u"?null:window.SpeechRecognition||window.webkitSpeechRecognition||null}function mm(){return!!pm()}async function fm(){if(typeof navigator>"u"||!navigator.mediaDevices?.getUserMedia)return"unavailable";try{return(await navigator.mediaDevices.getUserMedia({audio:!0}))?.getTracks?.().forEach(t=>{try{t.stop()}catch{}}),"granted"}catch(e){const t=String(e?.name||e?.message||"").toLowerCase();return/notallowed|permission|denied/.test(t)?"denied":/notfound|notreadable|overconstrained/.test(t)?"unavailable":"failed"}}function hm(e=""){const t=String(e||"").replace(/\s+/g," ").trimStart();n.ogreAgentDraft=t;const a=document.querySelector("[data-ogre-agent-input]");if(a){a.value=t;try{a.focus({preventScroll:!0}),a.setSelectionRange(t.length,t.length)}catch{}}}function vo(){ea&&(clearTimeout(ea),ea=null),_a&&(clearTimeout(_a),_a=null)}function gm(e,t=n.ogreAgentSpeechRecognizer){_a&&clearTimeout(_a),_a=setTimeout(()=>{e!==st||n.ogreAgentSpeechRecognizer!==t||Gt("Mic timed out instead of staying open. Tap Mic again or type the command.")},af)}function Gt(e=""){st+=1,vo();const t=n.ogreAgentSpeechRecognizer;if(n.ogreAgentSpeechRecognizer=null,n.ogreAgentListening=!1,n.ogreAgentSpeechFinal="",t){t.onstart=null,t.onresult=null,t.onerror=null,t.onend=null;try{t.abort?.()}catch{}try{t.stop?.()}catch{}}e&&(n.ogreAgentStatus=e),n.ogreAgentOpen&&E({force:!0})}async function ok(){if(!mm()){const o=await fm();n.ogreAgentStatus=o==="denied"?"Mic permission was denied. Allow microphone access, then use Chrome or Edge speech input.":"This browser does not expose speech-to-text to SlimeWire. Typing and device keyboard dictation still work.",E({force:!0});return}n.ogreAgentLoading&&(n.ogreAgentRequestId="",n.ogreAgentLoading=!1,n.ogreAgentStatus="Cleared the stuck reply. Mic is opening..."),yo(),Gt();const e=st;n.ogreAgentStatus="Checking microphone permission...",E({force:!0});const t=await fm();if(e!==st||!n.ogreAgentOpen)return;if(t==="denied"){n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentSpeechFinal="",n.ogreAgentStatus="Mic permission denied. Allow microphone access to talk to Ogre.",E({force:!0});return}if(t==="unavailable"){n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentSpeechFinal="",n.ogreAgentStatus="No microphone is available to this browser. Typing still works.",E({force:!0});return}const a=pm(),r=new a,s=++st;n.ogreAgentSpeechRecognizer=r,n.ogreAgentListening=!0,n.ogreAgentSpeechBaseDraft=String(document.querySelector("[data-ogre-agent-input]")?.value||n.ogreAgentDraft||"").trim(),n.ogreAgentSpeechFinal="",n.ogreAgentStatus="Opening microphone...",E({force:!0}),r.continuous=!1,r.interimResults=!0,r.maxAlternatives=1,r.lang=/^en/i.test(navigator.language||"")?navigator.language:"en-US",ea=setTimeout(()=>{s!==st||n.ogreAgentSpeechRecognizer!==r||Gt("Mic did not start. Check browser permission, then tap Mic again.")},tf),r.onstart=()=>{s!==st||n.ogreAgentSpeechRecognizer!==r||(ea&&(clearTimeout(ea),ea=null),n.ogreAgentListening=!0,n.ogreAgentStatus="Listening... speak your Ogre command.",gm(s,r),E({force:!0}))},r.onresult=o=>{if(s!==st||n.ogreAgentSpeechRecognizer!==r)return;gm(s,r);let c="",l="";for(let u=o.resultIndex||0;u<o.results.length;u+=1){const p=String(o.results[u]?.[0]?.transcript||"");o.results[u]?.isFinal?l+=` ${p}`:c+=` ${p}`}l.trim()&&(n.ogreAgentSpeechFinal=`${n.ogreAgentSpeechFinal||""} ${l}`.replace(/\s+/g," ").trim());const d=[n.ogreAgentSpeechBaseDraft,n.ogreAgentSpeechFinal,c.trim()].filter(Boolean).join(" ").replace(/\s+/g," ").trim();hm(d)},r.onerror=o=>{if(s!==st||n.ogreAgentSpeechRecognizer!==r)return;vo();const c=String(o?.error||"");n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentSpeechFinal="",n.ogreAgentStatus=c==="not-allowed"?"Mic permission denied. Allow microphone access to talk to Ogre.":c==="no-speech"?"No voice heard. Tap Mic and try again.":c==="aborted"?"Voice input stopped.":"Voice input stopped. Typing still works.",E({force:!0})},r.onend=()=>{if(s!==st||n.ogreAgentSpeechRecognizer!==r)return;vo();const o=String(n.ogreAgentDraft||"").trim(),c=!!(o&&n.ogreAgentSpeechFinal&&!n.ogreAgentLoading);n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentStatus=c?"Voice command captured.":"Voice input stopped.",E({force:!0}),c&&setTimeout(()=>{hm(o),yt()},100)};try{r.start()}catch{vo(),n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentSpeechFinal="",n.ogreAgentStatus="Mic could not start. Typing still works.",E({force:!0})}}function ik(){n.ogreAgentListening||n.ogreAgentSpeechRecognizer?Gt("Voice input stopped."):ok()}function wo(){n.ogreAgentOpen=!1,n.ogreAgentStatus="",n.ogreAgentLoading=!1,n.ogreAgentRequestId="",Gt(),yo(),E({force:!0})}function lk(e=""){const[t,a]=String(e).split(":");return Tn()[Number(t)]?.actions?.[Number(a)]||null}function bm(){return Array.isArray(n.wallets)&&n.wallets.length>0}function ym(){return!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey||n.walletPublicKey||n.connectedWalletPublicKey)}function So(){return!!(!vm()&&(n.ogreAgentAutoTradeApproved||bm()||ym()))}function ck(e="wallet-sync"){return vm()?!1:bm()||ym()?(Fl(!0),!0):(El(),!1)}function vm(){try{return sessionStorage.getItem("ogreAgentAutoTradeRevoked")==="yes"}catch{return!1}}function El(){n.ogreAgentAutoTradeApproved=!1;try{sessionStorage.removeItem("ogreAgentAutoTradeApproved"),sessionStorage.removeItem("ogreAgentAutoTradeRevoked"),localStorage.removeItem("ogreAgentAutoTradeApproved")}catch{}}function Fl(e,t={}){n.ogreAgentAutoTradeApproved=!!e;try{localStorage.removeItem("ogreAgentAutoTradeApproved"),n.ogreAgentAutoTradeApproved?(sessionStorage.setItem("ogreAgentAutoTradeApproved","yes"),sessionStorage.removeItem("ogreAgentAutoTradeRevoked")):(sessionStorage.removeItem("ogreAgentAutoTradeApproved"),t.revoked&&sessionStorage.setItem("ogreAgentAutoTradeRevoked","yes"))}catch{}}function wm(e){n.ogreAgentFastMode=!!e;try{localStorage.setItem("ogreAgentFastMode",n.ogreAgentFastMode?"on":"off")}catch{}}function Lt(e=""){const t=String(e||"").toLowerCase(),a=/\b(buy|ape|enter|grab|snipe|purchase|get in|go in|long|take entry)\b/.test(t),r=/\b(sell|exit|close|dump|cash out)\b/.test(t),s=/\b(take profit|tp)\b/.test(t)&&!/\b(set|with|stop loss|sl|target|preset)\b/.test(t);return a?"buy":r||s?"sell":""}function dk(e=""){const t=String(e||"").toLowerCase(),a=Lt(t);if(!a||/\b(if|only if|unless|after you check|check first|looks good|seems good|safe enough|popular enough|passes|good choice|good pick)\b/.test(t))return!1;const r=/\b(will you|would you|can you|could you|are you able|do i have to|will it|you will be able)\b/.test(t),s=a==="buy"?/\b(buy|ape|enter|grab|snipe|purchase|get in|go in|long|take entry)\b/.test(t):/\b(sell|exit|close|dump|cash out)\b/.test(t),o=!!(jt()||n.smartChartToken||n.tradeToken),c=/\b(now|please|with|for|from|wallet|sol|%|all|half|quarter|this|it)\b/.test(t)||/\b[A-HJ-NP-Za-km-z1-9]{32,48}\b/.test(e)||a==="buy"&&o&&/\b(just\s+)?buy\b/.test(t);return!!(s&&c&&!r)}function uk(e=""){const t=String(e||"").toLowerCase(),a=(t.match(/(?:buy|ape|enter|grab|snipe|purchase|get in|go in|long|take entry).*?(?:with|for|using)\s*(\d+(?:\.\d+)?)\s*sol\b/)||t.match(/(\d+(?:\.\d+)?)\s*sol\b/)||[])[1];return a?Number(a):0}function Wl(){const e=typeof pt=="function"?pt():null,t=Number(n.quickBuyAmountOverride||(typeof ze=="function"?ze(e):"")||e?.amountSol||"0");return Number.isFinite(t)&&t>0?t:0}function pk(e=""){const t=String(e||"").toLowerCase(),a=(t.match(/(?:take\s*profit|profit\s*take|tp|target|profit)[^0-9]*(\d{1,4}(?:\.\d+)?)\s*%?/)||[])[1]||"",r=(t.match(/(?:stop\s*loss|stoploss|sl)[^0-9]*(\d{1,3}(?:\.\d+)?)\s*%?/)||[])[1]||"",s=(t.match(/(?:slippage|slip)[^0-9]*(\d{1,3}(?:\.\d+)?)\s*%?/)||[])[1]||"",o=s?Math.round(Number(s)*100):0,c=[];return a&&c.push(`TP +${a}%`),r&&c.push(`SL -${r}%`),s&&c.push(`slippage ${s}%`),{takeProfitPct:a,stopLossPct:r,slippagePct:s,slippageBps:Number.isFinite(o)&&o>0?o:0,summary:c.join(" / ")}}function mk(e=""){const t=String(e||"").toLowerCase(),a=(t.match(/(\d{1,3})\s*%/)||[])[1];return a||(/\bhalf\b/.test(t)?"50":/\bquarter\b/.test(t)?"25":(/\ball\b|\bfull\b|100/.test(t),"100"))}function fk(e=""){const t=(String(e||"").toLowerCase().match(/(?:wallet|from)\s*#?\s*(\d{1,2})/)||[])[1];return t?Math.max(0,Number(t)-1):void 0}function hk(){const e=[],t=(r={})=>{const s=String(r.tokenMint||r.mint||r.tokenAddress||r.baseMint||r.pairAddress||"").trim();s&&e.push({tokenMint:s,symbol:String(r.symbol||r.baseSymbol||r.ticker||"").trim(),name:String(r.name||r.baseName||r.label||"").trim()})};n.smartChartToken&&t({tokenMint:n.smartChartToken,symbol:n.smartChartTokenSymbol}),n.tradeToken&&t({tokenMint:n.tradeToken,symbol:n.tradeTokenSymbol}),[n.livePairRows,n.slimeScopeRows,n.watchlist,n.positions,n.portfolioRows,n.ogreAiResult?.candidates].filter(Array.isArray).forEach(r=>r.forEach(t));const a=new Set;return e.filter(r=>{const s=r.tokenMint.toLowerCase();return a.has(s)?!1:(a.add(s),!0)})}function gk(e=""){const t=String(e||"").trim(),a=(t.match(/\b[A-HJ-NP-Za-km-z1-9]{32,48}\b/)||[])[0];if(a)return a;const r=t.toLowerCase();return hk().map(o=>{const c=o.symbol.toLowerCase(),l=o.name.toLowerCase();let d=0;return c&&new RegExp(`(^|[^a-z0-9])${c.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}([^a-z0-9]|$)`,"i").test(r)&&(d+=12+c.length),l&&r.includes(l)&&(d+=8+Math.min(16,l.length)),{...o,score:d}}).filter(o=>o.score>0).sort((o,c)=>c.score-o.score)[0]?.tokenMint||""}function ko(e={},t=""){const a={...e},r=Lt(t);if(!a.tokenMint&&!a.mint&&!a.ca){const s=gk(t)||jt()||n.smartChartToken||n.tradeToken;s&&(a.tokenMint=s)}if(a.type==="confirm_buy"||r==="buy"){if(a.type=a.type||"confirm_buy",!a.amountSol){const o=uk(t)||Wl();o>0&&(a.amountSol=o)}const s=pk(t);if(s.takeProfitPct&&!a.takeProfitPct&&(a.takeProfitPct=s.takeProfitPct),s.stopLossPct&&!a.stopLossPct&&(a.stopLossPct=s.stopLossPct),s.slippageBps&&!a.slippageBps&&(a.slippageBps=s.slippageBps),a.walletIndex===void 0){const o=fk(t);o!==void 0&&(a.walletIndex=o)}}return(a.type==="confirm_sell"||r==="sell")&&(a.type=a.type||"confirm_sell",a.percent=a.percent||mk(t)),a}function Sm(e={}){const t=[];return e.takeProfitPct&&t.push(`TP +${e.takeProfitPct}%`),e.stopLossPct&&t.push(`SL -${e.stopLossPct}%`),t.length?` Targets noted: ${t.join(" / ")}.`:""}function km(e={},t=""){if(!n.ogreAgentFastMode||!So()||e.requiresReview||e.conditional)return!1;const a=Lt(t);return a?a==="buy"?e.type==="confirm_buy"&&!!(e.tokenMint||e.mint||e.ca)&&Number(e.amountSol||e.sol||e.amount||0)>0:a==="sell"?e.type==="confirm_sell"&&!!(e.tokenMint||e.mint||e.ca):!1:!1}async function Xt(e={}){const t=String(e.type||""),a=String(e.tokenMint||e.mint||e.ca||n.smartChartToken||n.tradeToken||jt()||"").trim();if(t==="toggle_agent_fast_mode"){wm(!n.ogreAgentFastMode),n.ogreAgentStatus=n.ogreAgentFastMode?"Fast Mode ON: clear trade requests run directly.":"Fast Mode OFF: Ogre will stage actions first.",fe({role:"assistant",text:n.ogreAgentStatus,actions:[{label:n.ogreAgentFastMode?"Turn Fast Mode Off":"Turn Fast Mode On",type:"toggle_agent_fast_mode"}]}),E();return}if(t==="approve_agent_auto_trade"){Fl(!0),wm(!0),n.ogreAgentStatus="Agent Auto-Trade is enabled for this session. SlimeWire managed/session wallets run directly through the saved trade flow; connected wallets still approve direct wallet trades.",fe({role:"assistant",text:`${n.ogreAgentStatus}
External wallet apps may still require their own signature prompts. Managed wallets can run through the saved SlimeWire flow.`,actions:[{label:"Revoke Auto-Trade",type:"revoke_agent_auto_trade"},{label:"Show Positions",type:"open_tab",tab:"positions"},{label:"Best Picks",type:"open_tab",tab:"ogreAi"}]}),E();return}if(t==="revoke_agent_auto_trade"){Fl(!1,{revoked:!0}),n.ogreAgentStatus="Agent Auto-Trade revoked. Ogre will still help, but direct trade requests need approval again.",fe({role:"assistant",text:n.ogreAgentStatus,actions:[{label:"Auto-Trade On",type:"approve_agent_auto_trade"}]}),E();return}if(t==="open_tab"){n.route="terminal",n.activeTab=e.tab||"terminal",window.history.pushState({},"",e.path||"/terminal"),h({force:!0});return}if(t==="open_chart"||t==="prepare_buy"){if(!a){n.ogreAgentStatus="Paste a token CA in the message first.",E();return}Tt(ve(a,{source:"ogre-agent"}),{defaultTab:t==="prepare_buy"?"buy":"chart",focusAmountInput:t==="prepare_buy",source:"ogre-agent"});return}if(t==="prepare_sell"){n.route="terminal",n.activeTab="positions",window.history.pushState({},"","/terminal"),n.ogreAgentStatus=e.percent?`Sell ${e.percent}% staged. Use the position card confirm buttons.`:"Open Positions and use the sell confirm buttons.",h({force:!0});return}if(t==="refresh_wallet"){ne(()=>kt({force:!0,reason:"ogre_agent"})),n.ogreAgentStatus="Wallet refresh started.",E();return}if(t==="refresh_feeds"){ne(()=>en({force:!0,reason:"ogre_agent"})),n.ogreAgentStatus="Feed refresh started.",E();return}if(t==="open_wallet_connect"){ma({returnPath:"/terminal"}),n.ogreAgentStatus="Wallet connect opened.",E();return}if(t==="start_clip_recording"){bd(),n.ogreAgentStatus="REC started from Ogre Agent.",E();return}if(e.type==="open_quick_buy"){const r=String(e.tokenMint||e.mint||n.selectedToken?.mint||n.selectedToken?.pairAddress||"").trim();if(!r){n.ogreAgentStatus="Send me a token address first, then I can open the buy panel.",E();return}Number(e.amountSol||e.sol||e.amount||0)>0&&(n.quickBuyAmountOverride=String(e.amountSol||e.sol||e.amount||"")),mn(ve(r,{source:"ogre-agent-open-buy"}),{source:"ogre-agent-open-buy",forceModal:!0}),n.ogreAgentStatus="Buy panel opened. Review it and confirm with your wallet.",E();return}if(e.type==="confirm_buy"){const r=String(e.tokenMint||e.mint||e.ca||n.selectedToken?.mint||n.selectedToken?.pairAddress||n.smartChartToken||n.tradeToken||jt()||"").trim(),s=Number(e.amountSol||e.sol||e.amount||Wl()||0);if(!r||!Number.isFinite(s)||s<=0){r&&mn(ve(r,{source:"ogre-agent-buy-missing-amount"}),{source:"ogre-agent-buy-missing-amount",forceModal:!0}),n.ogreAgentStatus=r?"Buy panel opened. Pick the SOL amount and confirm with your wallet.":"Tell me the token address and amount, like: buy 0.1 SOL of CA.",E();return}const o=e.walletIndex!==void 0?e.walletIndex:ue()?.publicKey?"connected":n.wallets[0]?.index??0,c=Number.isFinite(Number(e.slippageBps))?Number(e.slippageBps):void 0;n.ogreAgentLoading=!0,n.ogreAgentStatus=`Sending ${s} SOL buy request...`,E();try{const l=await Ns({tokenMint:r,walletIndex:o,amountSol:s,slippageBps:c,takeProfitPct:e.takeProfitPct||"",stopLossPct:e.stopLossPct||"",source:"ogre-agent-confirm-buy"});n.ogreAgentStatus=l?.ok===!1?l.error||l.message||"Buy failed. Check wallet/RPC status and retry.":`Buy submitted. Refreshing wallet and positions in the background.${Sm(e)}`,typeof kt=="function"&&kt({force:!0,reason:"ogre_agent_buy"}),typeof refreshPositionsNow=="function"&&refreshPositionsNow({force:!0,reason:"ogre_agent_buy"})}catch(l){n.ogreAgentStatus=l?.message||"Buy failed. Check wallet/RPC status and retry."}finally{n.ogreAgentLoading=!1,E()}return}if(e.type==="confirm_sell"){const r=String(e.tokenMint||e.mint||e.ca||n.selectedToken?.mint||n.selectedToken?.pairAddress||"").trim(),s=String(e.percent||e.percentText||"100").replace(/[^0-9.]/g,"")||"100";if(!r){n.activeTab="positions",n.ogreAgentStatus="I opened Positions. Pick a token or tell me the CA to sell.",h();return}n.ogreAgentLoading=!0,n.ogreAgentStatus=`Preparing sell ${s}%...`,E();try{await Us(r,s,{skipConfirm:!0,source:"ogre-agent-confirm-sell"}),n.ogreAgentStatus=`Sell ${s}% submitted. Refreshing wallet and positions in the background.`,typeof kt=="function"&&kt({force:!0,reason:"ogre_agent_sell"}),typeof refreshPositionsNow=="function"&&refreshPositionsNow({force:!0,reason:"ogre_agent_sell"})}catch(o){n.ogreAgentStatus=o?.message||"Sell failed. Check wallet/RPC status and retry."}finally{n.ogreAgentLoading=!1,E()}return}if(e.type==="open_external"){const r=String(e.url||e.href||"").trim();if(!/^https?:\/\//i.test(r)){n.ogreAgentStatus="That link is not available yet. Send the token CA and ask for links.",E();return}window.open(r,"_blank","noopener,noreferrer"),n.ogreAgentStatus="Opened trusted coin link.",E();return}if(e.type==="coin_breakdown"||e.type==="analyze_coin"){const r=bo(String(e.tokenMint||e.mint||e.ca||n.smartChartToken||n.tradeToken||jt()||"").trim());if(!r){n.ogreAgentStatus="Paste a token CA and ask me to check it.",E();return}const s=o=>{const c=Number(o);return!Number.isFinite(c)||c<=0?"n/a":c>=1e9?`$${(c/1e9).toFixed(2)}B`:c>=1e6?`$${(c/1e6).toFixed(2)}M`:c>=1e3?`$${(c/1e3).toFixed(1)}K`:`$${c.toFixed(c>=1?2:6)}`};n.ogreAgentLoading=!0,n.ogreAgentStatus="Checking coin details...",E();try{const c=(await k(`/api/web/dex-token?token=${encodeURIComponent(r)}`,{timeoutMs:8e3,dedupe:!1,preserveSafeError:!0}))?.dexToken||{},l=c.symbol||c.baseSymbol||w(r),d=c.name||c.baseName||"Token",u=c.dexUrl||c.pairUrl||`https://dexscreener.com/solana/${r}`,p=c.pumpUrl||(String(r).toLowerCase().endsWith("pump")?`https://pump.fun/coin/${r}`:""),f=c.websiteUrl||c.website||c.links?.website||"",y=c.twitterUrl||c.xUrl||c.links?.twitter||c.links?.x||"",b=c.telegramUrl||c.links?.telegram||"",v=s(c.liquidityUsd||c.liquidity?.usd),P=s(c.marketCap||c.fdv||c.marketCapUsd),A=s(c.volume24h||c.volume?.h24||c.volume?.m5),g=[`${l} breakdown`,`${d} | ${w(r)}`,`MC/FDV: ${P} | Liquidity: ${v} | Volume: ${A}`,`Socials: X ${y?"found":"not returned"} | Telegram ${b?"found":"not returned"} | Website ${f?"found":"not returned"}`,"Read: look for live buys vs sells, liquidity depth, holder/risk badges, socials, and whether the chart is building higher lows.","Risk note: fresh Solana launches can still rug even with good socials. Size smaller until liquidity, volume, and holder distribution prove out."],$=[{label:"Open Chart",type:"open_chart",tokenMint:r},{label:"Dex",type:"open_external",url:u}];p&&$.push({label:"Pump",type:"open_external",url:p}),f&&$.push({label:"Website",type:"open_external",url:f}),y&&$.push({label:"X",type:"open_external",url:y}),b&&$.push({label:"Telegram",type:"open_external",url:b}),fe({role:"assistant",text:g.join(`
`),actions:$}),n.ogreAgentStatus="Coin breakdown ready."}catch(o){fe({role:"assistant",text:`I could not pull live metadata for ${w(r)} yet, but I can still open chart, Dex, Pump, or help inspect risk badges.`,actions:[{label:"Open Chart",type:"open_chart",tokenMint:r},{label:"Dex",type:"open_external",url:`https://dexscreener.com/solana/${r}`},{label:"Pump",type:"open_external",url:`https://pump.fun/coin/${r}`}]}),n.ogreAgentStatus=o?.message||"Coin check delayed."}finally{n.ogreAgentLoading=!1,E()}return}n.ogreAgentStatus="Action noted. Ask Ogre to open a panel, chart, refresh, trade, or check a coin.",E()}function bk(e=""){return/\b(check|analy[sz]e|rug|honeypot|community|social|website|telegram|twitter|x\b|links?|good choice|good pick|good buy|bullish|bearish|safe|risky|risk|will it do well|looks good|breakdown|details?)\b/i.test(String(e||""))}function _l(e=""){return(String(e||"").match(/\b[A-HJ-NP-Za-km-z1-9]{32,48}\b/)||[])[0]||""}function $m(e=""){return/\b(x|twitter|tweet|tweets|post|posts|posting|mentions?|popular|viral|trending|trend|kols?|influencers?|callers?|community|socials?)\b/i.test(String(e||""))}function yk(e="",t=[]){const a=[String(e||"").trim(),...Array.isArray(t)?t:[t]].map(s=>String(s||"").trim()).filter((s,o,c)=>s&&c.findIndex(l=>l.toLowerCase()===s.toLowerCase())===o).slice(0,4),r=a.length?a.map(s=>`"${s.replace(/"/g,"")}"`).join(" OR "):`"${String(e||"").trim()}"`;return`https://x.com/search?q=${encodeURIComponent(r)}&src=typed_query&f=live`}function vk(e=""){if(!$m(e))return null;const t=bo(_l(e)||jt()||n.smartChartToken||n.tradeToken||"");return t?{text:[`${w(t)} X/KOL check`,"I kept this token active in the conversation. Server social scan is still warming, so I can use SlimeWire-visible rows and open live X search without inventing callers.","If no verified posts or KOL rows return, treat the social side as unconfirmed and check chart, liquidity, buys/sells, and risk badges before sizing."].join(`
`),actions:[{label:"Open X Search",type:"open_external",url:yk(t)},{label:"Open Chart",type:"open_chart",tokenMint:t},{label:"KOL Tracker",type:"open_tab",tab:"kol"},{label:"Refresh Feeds",type:"refresh_feeds"}]}:null}function wk(e=""){const t=String(e||"").toLowerCase();return/\b(top|best|hot|trending|trend|viral|runner|moving|today|now|low mc|low mcap|fresh|climbing|x2|2x)\b/.test(t)&&/\b(meme|memecoin|coin|token|pair|launch|x|twitter|volume|market cap|mc)\b/.test(t)}function Sk(e=""){if(!wk(e))return null;const t=lm().slice(0,4),a=o=>{const c=Number(o);return!Number.isFinite(c)||c<=0?"n/a":c>=1e6?`$${(c/1e6).toFixed(2)}M`:c>=1e3?`$${(c/1e3).toFixed(1)}K`:`$${c.toFixed(c>=1?2:6)}`};if(!t.length)return{text:["Fast scan is ready, but I do not have fresh rows loaded in this screen yet.","Tap Refresh Feeds, then ask again. If a broad X result is not returned, I will rank SlimeWire-visible live candidates and exact live-search links instead of faking callers."].join(`
...
`),actions:[s?.tokenMint?{label:"Open Top Chart",type:"open_chart",tokenMint:s.tokenMint}:null,{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}].filter(Boolean)}}const kk=[["terminal",["terminal","command center","cooks","main feed","live feed","home"]],["live",["live pairs","fresh pairs","new pairs","pairs"]],["slimeScope",["slime scope","scope","scanner","cook spot"]],["smartChart",["smart chart","chart page","charting"]],["trade",["trade desk","trade page","swap page","slime swap","manual trade"]],["bundle",["bundle","bundle buy","multi wallet buy"]],["volume",["volume","slimebot","slime bot","volume bot"]],["sniper",["sniper","ogre sniper","snipe picks","picks"]],["launchCoin",["pump launch","launch a coin","launch coin","create coin","create a token","make a coin","launcher"]],["launch",["launch watch","launch watches","watch launches","snipe launches"]],["kol",["kol","kols","kol tracker","copy trading","copy wallet"]],["ogreAi",["ogre ai","ogre a.i","autopilot","auto pilot","ai buyer"]],["wallets",["wallets","wallet page","balances","my wallets","fund","sweep"]],["positions",["positions","open positions","bags","holdings","my coins"]],["pnl",["pnl","profit","results","p&l","pnl card","share card"]],["txAudit",["tx audit","stop loss audit","audit","armed plans","my plans","tp sl status"]],["profile",["profile","account","referral","referrals","badges","pfp","alerts","push alerts","notifications"]],["tek",["ogre tek","tek hub","tools","tool hub","automation deck","shield receipts","receipts"]],["ogreTek",["perps","perp","perp mode","leverage"]],["watchlist",["watchlist","watch list","saved coins","saved tokens"]],["liveTrades",["live trades","recent trades","trade history"]]],$k=/\b(open|go to|goto|show me|show|take me|bring up|pull up|switch to|navigate|where is|where's|wheres|where are|where do i|how do i (?:get to|open|find)|find)\b/i;function Tk(e){const t=String(e||"").toLowerCase().replace(/[?!.]+$/g,"").trim();if(!t||t.length>120||_l(e)||Lt(e))return null;const a=/(?:set\s+)?quick\s*buy(?:\s+amount)?\s*(?:to|at|=)?\s*([0-9]*\.?[0-9]+)\s*(?:sol)?$/i.exec(t);if(a){const s=vr(a[1]);if(s)return n.quickBuyAmountOverride=s,is({quickBuy:s}),eo(),{text:`Quick buy set to ${s} SOL - every Buy button across the site now fires with that amount.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}if(/\b(i (?:like|prefer|want|am)|keep (?:it|them)|show me|give me)\b/.test(t)){if(/\b(risky|degen|moonshots?|early|low\s*mc|gambl)/.test(t))return is({risk:"degen"}),{text:"Noted - early risky plays it is. The fresh low-MC line in the brief is yours, and I'll keep that preference next visit too.",actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Sniper",type:"open_tab",tab:"sniper"}]};if(/\b(safe|careful|low risk|clean|less risky)\b/.test(t))return is({risk:"careful"}),{text:"Noted - shield-clean setups first. I'll remember that next visit. SlimeShield verdicts are on every pair and /t page.",actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}if(/\brefresh\b.*\b(feed|pairs|scan)/.test(t)||t==="refresh feeds")return{text:"Refreshing the live feeds now.",run:{type:"refresh_feeds"},actions:[]};if(/\brefresh\b/.test(t)||/\bsync\b.*\b(wallet|balance|position)/.test(t))return{text:"Refreshing wallets, balances, and positions now.",run:{type:"refresh_wallet"},actions:[]};if(/\b(connect|link|hook up)\b.*\bwallet\b/.test(t))return{text:"Opening the wallet connect chooser.",run:{type:"open_wallet_connect"},actions:[]};if(/what can you do|what do you do|help me|how do you work|what are you/.test(t))return{text:`I can take you anywhere on the site (just say "open positions" or "where is the sniper"), check any coin (paste a CA), run buys and sells ("buy 0.1 of <CA>"), set your quick-buy amount, refresh wallets and feeds, and read risk with SlimeShield. Ask in your own words - I'll keep up.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Positions",type:"open_tab",tab:"positions"},{label:"Ogre Tek",type:"open_tab",tab:"tek"}]};const r=$k.test(t);for(const[s,o]of kk)for(const c of o){if(!(t===c||t===`the ${c}`||t===`my ${c}`)&&!(r&&t.includes(c)))continue;return{text:`Opening ${Ak(s)} now.${s==="profile"&&/alert|push|notification/.test(t)?" Push alerts live under Profile > Alerts.":""}`,run:{type:"open_tab",tab:s},actions:[{label:"Back to Terminal",type:"open_tab",tab:"terminal"}]}}return null}function Ak(e){return{terminal:"the Live Terminal",live:"Live Pairs",slimeScope:"Slime Scope",smartChart:"Smart Chart",trade:"the Trade Desk",bundle:"Bundle",volume:"SlimeBot Volume",sniper:"OgreSniper",launchCoin:"Pump Launch",launch:"Launch Watch",kol:"the KOL Tracker",ogreAi:"Ogre A.I.",wallets:"Wallets",positions:"Positions",pnl:"PnL",txAudit:"the TP/SL Audit",profile:"your Profile",tek:"the Ogre Tek hub",ogreTek:"Perp Mode",watchlist:"your Watchlist",liveTrades:"Live Trades"}[e]||e}const Pk={submitted:"Order submitted",approved:"Wallet approved",sent:"Transaction sent",confirmed:"Confirmed on-chain",armed:"TP/SL armed"};function Tm(e){n.tradeTrace={title:String(e||"Trade"),steps:[],startedAt:Date.now(),done:!1},$o()}function Ie(e,t="ok",a=""){if(!n.tradeTrace||n.tradeTrace.done&&t==="pending")return;const r=n.tradeTrace.steps,s=r.find(l=>l.key===e),o=s||{key:e,label:Pk[e]||e};if(o.status=t,o.detail=String(a||"").slice(0,140),s||r.push(o),t==="fail"&&(n.tradeTrace.done=!0),$o(),t==="fail")return;r.length>=3&&r.every(l=>l.status==="ok")&&(n.tradeTrace.done=!0,window.setTimeout(()=>{n.tradeTrace?.done&&!n.tradeTrace.steps.some(l=>l.status==="fail")&&(n.tradeTrace=null,$o())},8e3))}function $o(){let e=document.querySelector("[data-trade-trace-mount]");e||(e=document.createElement("div"),e.dataset.tradeTraceMount="true",document.body.appendChild(e));const t=n.tradeTrace;if(!t){e.innerHTML="",e.__lastDrawerHtml="";return}const a=r=>r==="ok"?"✅":r==="fail"?"❌":"⏳";e.innerHTML=`
  ...
  `}async function yt(e=""){const t=document.querySelector("[data-ogre-agent-input]"),a=String(e||t?.value||"").trim();if(!a||n.ogreAgentLoading)return;const r=_l(a);if(r&&bo(r),t&&(t.value=""),n.ogreAgentDraft="",fe({role:"user",text:a,actions:[]}),dk(a)){const l=Lt(a),d=ko({type:l==="buy"?"confirm_buy":"confirm_sell"},a),u=String(d.tokenMint||d.mint||d.ca||"").trim(),p=Number(d.amountSol||d.sol||d.amount||0);if(!u){fe({role:"assistant",text:'Send the token CA first, then say the buy/sell command. I will keep that CA active for follow-up commands like "buy it" or "sell half".',actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}),n.ogreAgentStatus="Need token CA.",E({force:!0});return}if(l==="buy"&&(!Number.isFinite(p)||p<=0)){fe({role:"assistant",text:"I have the token, but I need a SOL amount or a saved quick-buy amount. Example: buy it with 0.1 SOL.",actions:[{label:"Open Buy Panel",type:"open_quick_buy",tokenMint:u},{label:"Trade Panel",type:"open_tab",tab:"trade"}]}),n.ogreAgentStatus="Need buy amount.",E({force:!0});return}if(!So()){fe({role:"assistant",text:"Connect or create a wallet and Auto-Trade becomes ready for this session. SlimeWire managed/session wallets can run through the saved flow; external wallet apps may still show their own signature prompt.",actions:[{label:"Auto-Trade On",type:"approve_agent_auto_trade"},{label:"Open Wallets",type:"open_tab",tab:"wallets"}]}),n.ogreAgentStatus="Wallet session needed.",E({force:!0});return}fe({role:"assistant",text:l==="buy"?`Sending ${p} SOL buy for ${w(u)}.${Sm(d)}`:`Sending sell request for ${w(u)}${d.percent?` at ${d.percent}%`:""}.`,actions:[{label:"Show Positions",type:"open_tab",tab:"positions"},{label:"Open Chart",type:"open_chart",tokenMint:u}]}),n.ogreAgentStatus="Fast Mode: sending trade request...",E({force:!0}),await Xt(d);return}const s=Tk(a);if(s){fe({role:"assistant",text:s.text,actions:s.actions||[]}),n.ogreAgentStatus="Instant local reply.",E({force:!0}),s.run&&await Xt(s.run);return}n.ogreAgentLoading=!0,n.ogreAgentStatus="",se("chatRequestStarted");const o=`${Date.now()}:${Math.random().toString(16).slice(2)}`;n.ogreAgentRequestId=o;const c=setTimeout(()=>{n.ogreAgentRequestId!==o||!n.ogreAgentLoading||(n.ogreAgentRequestId="",n.ogreAgentLoading=!1,n.ogreAgentStatus="Agent reply timed out.",se("chatRequestTimedOut"),fe({role:"assistant",text:"I timed out instead of staying stuck. I can still open panels, refresh feeds, check a coin, show positions, or open chart from here.",retryText:a,actions:[{label:"Show Positions",type:"open_tab",tab:"positions"},{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Live Terminal",type:"open_tab",tab:"terminal"}]}),E({force:!0}))},7500);E();try{const l=await k("/api/web/ogre-agent/chat",{method:"POST",body:JSON.stringify({message:a,context:YS()}),timeoutMs:7e3,dedupe:!1,preserveSafeError:!0});if(n.ogreAgentRequestId!==o)return;const d=(l?.agent?.actions||[]).map(v=>ko(v,a));l?.agent?.tokenMint&&bo(l.agent.tokenMint),fe({role:"assistant",text:l?.agent?.reply||"I can help with panel functions, charts, positions, presets, coin checks, links, risk reads, and fast trade requests.",actions:d}),se("chatRequestSucceeded");const u=!!(l?.agent?.coinEnriched||l?.agent?.tokenMint||l?.agent?.socialLinks||l?.agent?.socialScan),f=!$m(a)&&!u&&!Lt(a)&&bk(a)?d.find(v=>v.type==="coin_breakdown"||v.type==="analyze_coin")||ko({type:"coin_breakdown"},a):null;if(f?.tokenMint||f?.mint||f?.ca){n.ogreAgentStatus="Checking coin now...",await Xt(f);return}const y=ko({type:Lt(a)==="buy"?"confirm_buy":Lt(a)==="sell"?"confirm_sell":""},a);if(Lt(a)&&n.ogreAgentFastMode&&!So()){fe({role:"assistant",text:"Agent Auto-Trade turns on automatically for this session when a wallet is connected or created. If an external wallet still asks for a signature, that is the wallet provider layer.",actions:[{label:"Auto-Trade On",type:"approve_agent_auto_trade"},{label:"Fast Mode Off",type:"toggle_agent_fast_mode"}]}),n.ogreAgentStatus="Auto-Trade approval needed once.";return}const b=d.find(v=>km(v,a))||(km(y,a)?y:null);if(b){n.ogreAgentStatus="Fast Mode: sending trade request...",await Xt(b);return}n.ogreAgentStatus=l?.agent?.modelPowered?"AI reply":"Fast local Ogre reply"}catch(l){if(n.ogreAgentRequestId!==o)return;const d=vk(a);if(d){fe({role:"assistant",text:d.text,actions:d.actions}),n.ogreAgentStatus="Fast local X/KOL fallback.";return}const u=Sk(a);if(u){fe({role:"assistant",text:u.text,actions:u.actions}),n.ogreAgentStatus="Fast local trend scan.";return}fe({role:"assistant",text:"Ogre Agent is still here, but the server reply timed out. I can still open panels, refresh feeds, check coins, open links, and route trade actions.",retryText:a,actions:[{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Positions",type:"open_tab",tab:"positions"},{label:"Live Terminal",type:"open_tab",tab:"terminal"}]}),se("chatRequestFailed"),n.ogreAgentStatus=l?.message||"Agent reply failed."}finally{clearTimeout(c),n.ogreAgentRequestId===o&&(n.ogreAgentRequestId="",n.ogreAgentLoading=!1,E())}}function F(e,t){return`<article class="empty"><h3>${i(e)}</h3><p>${i(t)}</p></article>`}function i(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Te(e){const t=new Date(e||"");return Number.isNaN(t.getTime())?"unknown":t.toLocaleString()}function Ck(e){try{e.dataset.lockInPointerHandledAt=String(Date.now())}catch{}}function Am(e){const t=Number(e?.dataset?.lockInPointerHandledAt||0);return Number.isFinite(t)&&Date.now()-t<900}document.addEventListener("pointerup",e=>{const a=(e.target instanceof Element?e.target:e.target?.parentElement)?.closest?.("[data-open-login], [data-connect-login-toggle]");a&&(e.preventDefault(),Ck(a),Cc({connectPanel:a.matches("[data-connect-login-toggle]")||n.route==="connect",source:a.matches("[data-connect-login-toggle]")?"connect-lock-in":"top-lock-in"}))},{capture:!0}),document.addEventListener("keydown",e=>{if(Hf(e))return;if(e.target?.closest?.("[data-ogre-agent-input]")&&e.key==="Enter"&&!e.shiftKey){e.preventDefault(),yt();return}const a=e.target?.closest?.("[data-global-token-search]");if(a&&e.key==="Enter"){e.preventDefault(),Gu(a.value||"");return}if(e.key==="Escape"){if(n.ogreAgentOpen){wo();return}if(n.slimeShieldDetails?.open){vl();return}if(n.kolDumpDetails?.open){Gi();return}if(n.replayDetails?.open){Tl();return}if(n.protectedBuyModal?.open){_s();return}if(!(!n.loginModalOpen&&!n.quickBuyModal?.open)){if(n.quickBuyModal?.open){rl();return}Ac()}}});function Nl(e=null,t="interaction"){const a=e?.closest?.("[data-token-trade], [data-token-chart], [data-preview-token]");if(!a)return!1;const r=a.dataset.tokenTrade||a.dataset.tokenChart||a.dataset.previewToken||"";if(!r)return!1;if(String(t||"").includes("prefetch")){const c=Date.now(),l=Number(n.smartChartInteractionPrefetchAt||0),d=n.smartChartInteractionPrefetchSeen||{};if(l&&c-l<Xv||Number(d[r]||0)&&c-Number(d[r])<Qv)return!1;const u=(n.smartChartInteractionPrefetchRecent||[]).filter(p=>c-Number(p||0)<Jv);if(u.length>=Yv)return n.smartChartInteractionPrefetchRecent=u,!1;n.smartChartInteractionPrefetchAt=c,n.smartChartInteractionPrefetchRecent=[...u,c],n.smartChartInteractionPrefetchSeen={...d,[r]:c}}return dl(ve(r,{source:a.dataset.tokenTradeSource||a.dataset.tokenChartSource||t}),{source:a.dataset.tokenTradeSource||a.dataset.tokenChartSource||t})}document.addEventListener("pointerenter",e=>{Nl(e.target instanceof Element?e.target:null,"pointer-prefetch")},!0),document.addEventListener("touchstart",e=>{Nl(e.target instanceof Element?e.target:null,"touch-prefetch")},{capture:!0,passive:!0}),document.addEventListener("focusin",e=>{Nl(e.target instanceof Element?e.target:null,"focus-prefetch")},!0);const Pm=new WeakMap;function Lk(e){let t=Pm.get(e);if(!t){const a=window.getComputedStyle(e);t={scrollable:["auto","scroll","overlay"].includes(a.overflowY),contained:/contain|none/.test(a.overscrollBehaviorY)},Pm.set(e,t)}return t}document.addEventListener("wheel",e=>{if(e.defaultPrevented||e.ctrlKey||e.deltaY===0||n.route!=="terminal"||ar())return;let t=e.target instanceof Element?e.target:null;if(t&&t.tagName==="IFRAME")return;const a=e.deltaY>0?1:-1;for(;t&&t!==document.body&&t!==document.documentElement;){const o=Lk(t);if(o.scrollable&&t.scrollHeight>t.clientHeight+1){const c=t.scrollTop<=0,l=t.scrollTop+t.clientHeight>=t.scrollHeight-1;if(!(a<0&&c||a>0&&l)||o.contained)return}t=t.parentElement}const r=document.scrollingElement||document.documentElement;if(!r||r.scrollHeight<=r.clientHeight+1)return;let s=e.deltaY;e.deltaMode===1?s*=40:e.deltaMode===2&&(s*=r.clientHeight),r.scrollTop+=s,e.preventDefault()},{passive:!1}),document.addEventListener("click",async e=>{const t=e.target instanceof Element?e.target:e.target?.parentElement;if(t?.closest?.("[data-slimeshield-close]")){e.preventDefault(),vl();return}if(t?.closest?.("[data-protected-buy-close]")){e.preventDefault(),_s();return}if(t?.closest?.("[data-kol-dump-close]")){e.preventDefault(),Gi();return}if(t?.closest?.("[data-replay-close]")){e.preventDefault(),Tl();return}const c=t?.closest?.(".tabs .nav-tool-group summary");if(c){e.preventDefault();const g=c.closest(".nav-tool-group");n.navTekOpen=!g?.open,hf(n.navTekOpen),g&&(g.open=n.navTekOpen);return}const l=t?.closest?.("button, a, [data-preview-token], [data-token-chart], [data-token-trade], [data-quick-buy-token], [data-quick-trade-token], [data-dev-info], [data-quick-bundle-token], [data-watch-token], [data-unwatch-token], [data-share-x]");if(!l)return;if(l.tagName==="A"){const g=l.getAttribute("href")||"",$=/^https?:\/\//i.test(g)&&!g.startsWith(window.location.origin),C=!!(window.matchMedia?.("(display-mode: standalone)")?.matches||window.navigator?.standalone);if($&&(l.getAttribute("target")==="_blank"||C)){e.preventDefault();try{window.open(g,"_blank","noopener,noreferrer")}catch{window.location.href=g}return}}if(l.matches("[data-tool-section]")){e.preventDefault();const g=l.dataset.toolSection,[$]=g.split(":"),C=g.slice($.length+1);n.toolSections={...n.toolSections||{},[$]:C};const B=l.closest("[data-tool-panels]");B&&(B.querySelectorAll(`[data-tool-section^="${$}:"]`).forEach(U=>{U.dataset.active=U.dataset.toolSection===g?"true":"false"}),B.querySelectorAll(`[data-tool-panel^="${$}:"]`).forEach(U=>{U.hidden=U.dataset.toolPanel!==g}),ys(B));return}if(l.matches("[data-clip-record]")){e.preventDefault(),n.clipFarm?.recording?tr():bd();return}if(l.matches("[data-clip-share]")){e.preventDefault(),Oh();return}if(l.matches("[data-clip-download]")){e.preventDefault(),Eh();return}if(l.matches("[data-clip-clear]")){e.preventDefault(),Ai();return}if(l.matches("[data-slimeshield-tab]")){e.preventDefault();const g=l.dataset.slimeshieldTab||"verdict";n.slimeShieldTab=g;const $=l.closest(".dossier-drawer");$&&($.setAttribute("data-active-pane",g),$.querySelectorAll("[data-slimeshield-tab]").forEach(C=>{C.dataset.active=C.dataset.slimeshieldTab===g?"true":"false"}));return}if(l.matches("[data-slimeshield-details]")){e.preventDefault(),l.closest("[data-dev-info-drawer-root]")&&wl(),Ep(l.dataset.slimeshieldDetails||"");return}if(l.matches("[data-slimeshield-refresh]")){e.preventDefault(),to(l.dataset.slimeshieldRefresh||"",{force:!0});return}if(l.matches("[data-kol-dump-details]")){e.preventDefault(),uy(l.dataset.kolDumpDetails||"");return}if(l.matches("[data-kol-dump-refresh]")){e.preventDefault(),ji({force:!0});return}if(l.matches("[data-replay-open]")){e.preventDefault(),nS(l.dataset.replayOpen||"");return}if(l.matches("[data-replay-refresh]")){e.preventDefault(),$l(l.dataset.replayRefresh||"",{force:!0});return}if(l.matches("[data-ogre-agent-toggle]")){n.ogreAgentOpen?wo():(n.ogreAgentOpen=!0,eg(),E({force:!0}));return}if(l.matches("[data-ogre-agent-close]")){wo();return}if(l.matches("[data-ogre-agent-voice]")){sk(!n.ogreAgentVoiceEnabled);return}if(l.matches("[data-ogre-agent-send]")){Gt(),yt();return}if(l.matches("[data-ogre-agent-mic]")){ik();return}if(l.matches("[data-ogre-agent-quick]")){const g=l.dataset.ogreAgentQuick||"";if(g==="positions"&&Xt({type:"open_tab",tab:"positions"}),g==="whats_cooking"&&yt("whats cooking"),g==="my_bags"&&yt("how are my bags"),g==="refresh_feeds"&&Xt({type:"refresh_feeds"}),g==="risk"&&yt("Why is this token risky?"),g==="dev_info"&&yt("Explain Dev Info for this token."),g==="protected_buy"&&yt("Should I use Protected Buy?"),g==="replay"&&yt("Replay similar launches for this token."),g==="auto_trade"&&Xt({type:"approve_agent_auto_trade"}),g==="clear_chat"){Gt(),yo(),n.ogreAgentMessages=[im()],n.ogreAgentStatus="Chat cleared.",n.ogreAgentDraft="",n.ogreAgentLastTokenMint="";try{localStorage.removeItem(Rl),localStorage.removeItem(Il)}catch{}E({force:!0})}return}if(l.matches("[data-ogre-agent-retry]")){const g=Number(l.dataset.ogreAgentRetry),$=String(n.ogreAgentMessages?.[g]?.retryText||"").trim();$&&yt($);return}if(l.matches("[data-ogre-agent-action]")){const g=l.dataset.ogreAgentAction,C=lk(g)||(n.ogreAgentMessages||[]).flatMap(B=>Array.isArray(B.actions)?B.actions:[]).find(B=>B.key===g||B.label===g||B.type===g);Xt(C||{type:g});return}if(l.matches("[data-nav-route]")){e.preventDefault(),Pe(l.dataset.navRoute||"/terminal",l.dataset.tab||null);return}if(l.matches("[data-policy]")){e.preventDefault(),window.alert(Nf(l.dataset.policy==="privacy"?"privacy":"terms"));return}if(l.matches("[data-top-wallet-connect]")){e.preventDefault(),l.dataset.walletState==="connected"||!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey||n.wallets.length)?Pe("/terminal","wallets"):ma({returnPath:"/terminal"});return}if(l.matches("[data-top-wallet-status]")){e.preventDefault(),await qh();return}if(l.matches("[data-top-refresh-wallet]")){const g=L();Xa("clicked",{startedAt:g}),W({component:"ui-action",action:"position-refresh-click-to-state",durationMs:L()-g,details:"top-refresh-wallet"}),kt({force:!0,deep:!1,reason:"manual_header_click"}).then(()=>{$y()&&ne(()=>Ji())}).catch($=>T($.message));return}if(l.matches("[data-ogre-tek-refresh]")){await Lr({force:!0}).catch(g=>T(g.message));return}if(l.matches("[data-ogre-ai-start]")){ne(()=>rv());return}const d=l.closest?.("[data-ogre-cat]");if(d){e.preventDefault(),n.ogreAiCategory=d.dataset.ogreCat||"strong",h({force:!0});return}if(l.closest?.("[data-autopilot-save]")){e.preventDefault(),ne(()=>iv());return}if(l.matches("[data-ogre-tek-market]")){n.ogreTek.selectedMarket=l.dataset.ogreTekMarket||n.ogreTek.selectedMarket,n.ogreTek.reviewOpen=!1,h({force:!0});return}if(l.matches("[data-ogre-tek-side]")){n.ogreTek.direction=l.dataset.ogreTekSide==="short"?"short":"long",n.ogreTek.reviewOpen=!1,h({force:!0});return}if(l.matches("[data-ogre-tek-review]")){go(),n.ogreTek.reviewOpen=!0,n.ogreTek.riskAccepted=!1,h({force:!0});return}if(l.matches("[data-ogre-tek-close-review]")){n.ogreTek.reviewOpen=!1,n.ogreTek.riskAccepted=!1,h({force:!0});return}if(l.matches("[data-ogre-tek-confirm-review]")){go();const g=rm();!n.ogreTek.riskAccepted||!g.ok?n.ogreTek.status="Risk confirmation is incomplete.":Ae.demoMode?(n.ogreTek.status="Demo review confirmed. No live transaction was submitted.",n.ogreTek.reviewOpen=!1,n.ogreTek.riskAccepted=!1):(n.ogreTek.status="Live perps adapter is not wired in this build.",n.ogreTek.reviewOpen=!1,n.ogreTek.riskAccepted=!1),h({force:!0});return}if(l.matches("[data-ogre-tek-demo-action]")){const g=l.dataset.ogreTekDemoAction||"action";n.ogreTek.status=`Demo mode: ${g.replace(/-/g," ")} is staged for the real provider adapter. No transaction was submitted.`,h({force:!0});return}if(l.matches("[data-toggle-terminal-ticket]")){n.terminalTradeCollapsed=!n.terminalTradeCollapsed,h({force:!0});return}if(l.matches("[data-global-token-open]")){const g=m("[data-global-token-search]")?.value?.trim()||"";g&&Gu(g);return}if(l.matches("[data-token-chart]")){e.preventDefault();const g=l.dataset.tokenChart||l.dataset.previewToken||"";Tt(ve(l.dataset.tokenChart||l.dataset.previewToken||"",{source:l.dataset.tokenChartSource||"token-card"}),{defaultTab:l.dataset.tokenChartTab||"buy",view:"chartTxns",focusAmountInput:!!l.closest?.(".live-pair-avatar"),source:l.dataset.tokenChartSource||"token-card"});return}if(l.matches("[data-token-trade]")){e.preventDefault(),e.stopPropagation();const g=l.dataset.tokenTrade||"",$=fn(g);$&&Ks($)&&T("Risk flagged. Opening chart review first; fast buy safety checks still apply before any wallet prompt."),Tt(ve(l.dataset.tokenTrade||"",{source:l.dataset.tokenTradeSource||"trade-button"}),{defaultTab:"buy",view:"chartTxns",focusAmountInput:!0,source:l.dataset.tokenTradeSource||"trade-button"});return}if(l.matches("[data-quick-buy-token]")){e.preventDefault(),e.stopPropagation(),mn(ve(l.dataset.quickBuyToken||"",{source:l.dataset.quickBuySource||"quick-buy-button"}),{source:l.dataset.quickBuySource||"quick-buy-button"});return}if(l.matches("[data-protected-buy-open]")){e.preventDefault(),e.stopPropagation(),l.closest("[data-dev-info-drawer-root]")&&wl();const g=l.dataset.protectedBuySource||"protected-buy",$=!!l.closest("[data-quick-buy-modal-root]"),C=!!l.closest(".chart-trade-panel"),B=l.dataset.protectedBuyOpen||n.quickBuyModal?.tokenMint||n.smartChartToken||n.tradeToken||"";gv(ve(B,{source:g}),{source:g,presetId:l.dataset.protectedBuyPreset||"",amountSol:$?m("[data-quick-buy-modal-amount]")?.value||n.quickBuyModal?.amountSol||"":C&&m("[data-chart-buy-amount]")?.value||"",walletIndex:$?m("[data-quick-buy-modal-wallet]")?.value||n.quickBuyModal?.walletIndex||"":C&&m("[data-chart-buy-wallet]")?.value||"",slippageBps:$?m("[data-quick-buy-modal-slippage]")?.value||n.quickBuyModal?.slippageBps||"400":C&&m("[data-chart-buy-slippage]")?.value||"400"});return}if(l.matches("[data-quick-buy-close]")){e.preventDefault(),rl();return}if(l.matches("[data-protected-buy-close]")){e.preventDefault(),_s();return}if(l.matches("[data-protected-buy-confirm]")){e.preventDefault(),ne(()=>vv());return}if(l.matches("[data-quick-buy-modal-preset]")){e.preventDefault(),n.quickBuyModal={...n.quickBuyModal,amountSol:l.dataset.quickBuyModalPreset||"",status:`${l.dataset.quickBuyModalPreset||""} SOL selected.`,error:""},h({force:!0});return}if(l.matches("[data-quick-buy-confirm]")){e.preventDefault(),ne(()=>kv());return}if(l.matches("[data-preview-token]")){const g=l.dataset.previewToken||"";g&&Tt(ve(g,{source:"preview-card"}),{defaultTab:"chart",source:"preview-card"});return}if(l.matches("[data-terminal-subtab]")){n.terminalSubtab=l.dataset.terminalSubtab||"positions",h();return}if(l.matches("[data-position-sell]")){e.preventDefault(),e.stopPropagation(),await Us(l.dataset.positionSell||"",l.dataset.positionSellPercent||"100",{slippageBps:n.activeTab==="smartChart"&&m("[data-chart-buy-slippage]")?.value||"400"});return}if(l.matches("[data-position-sell-custom]")){e.preventDefault(),e.stopPropagation();const g=await Me({title:"Custom Sell",input:{label:"Sell what percent of this position?",value:"100",type:"text",inputmode:"numeric"},confirmLabel:"Sell"});g&&await Us(l.dataset.positionSellCustom||"",g,{slippageBps:n.activeTab==="smartChart"&&m("[data-chart-buy-slippage]")?.value||"400"});return}if(l.matches("[data-run-tx-audit]")){e.preventDefault(),ne(()=>$v());return}if(l.matches("[data-connect-login-toggle]")){Am(l)||Lc({connectPanel:!0,source:"connect-lock-in"});return}if(l.matches("[data-login-tab]")){n.loginModalTab=l.dataset.loginTab==="create"?"create":"login",h({force:!0}),Tc(!1);return}if(l.matches("[data-connect-password-login]")){await _c();return}if(l.matches("[data-send-email-code]")){await ah();return}if(l.matches("[data-web-code-login]")){await nh();return}if(l.matches("[data-connect-create-account]")){await ui();return}if(l.matches("[data-connect-create-wallet]")){await lh();return}if(l.matches("[data-web-signup]")&&await ui(),l.matches("[data-web-password-login]")&&await _c(),l.matches("[data-close-login]")){Ac();return}if(l.matches("[data-web-signup-connect]")){await ih();return}if(l.matches("[data-open-login]")){Am(l)||Lc({connectPanel:n.route==="connect",source:"top-lock-in"});return}if(l.matches("[data-browse-guest]")){n.loginCollapsed=!0,n.route="terminal",n.activeTab="terminal",window.history.pushState({},"","/terminal"),h(),Qr("browse-terminal");return}if(l.matches("[data-logout]")&&await ch(),l.matches("[data-connect-x]")&&await Ey(),l.matches("[data-open-x-login]")&&Fy(),l.matches("[data-clear-x]")&&await Wy(),l.matches("[data-save-login-credentials]")&&await Uy(),l.matches("[data-save-referral]")&&await Zu(),l.matches("[data-generate-referral-code]")&&await Zu({generate:!0}),l.matches("[data-save-trader-board]")&&await Lv(),l.matches("[data-use-x-avatar]")&&await Dy(),l.matches("[data-clear-avatar]")&&await Ms({clear:!0},"Removing PFP..."),l.matches("[data-preset-avatar]")){const g=m("[data-avatar-status]");S(g,"Loading preset PFP...");try{const $=await Ny(l.dataset.presetAvatar);await Ms({avatarDataUrl:$,avatarSource:l.dataset.avatarLabel||"preset"},"Saving preset PFP...")}catch($){S(g,$.message),T($.message)}}if(l.matches("[data-launch-coin-save]")){or();return}if(l.matches("[data-launch-coin-submit]")){await sy();return}if(l.matches("[data-launch-coin-use-ca]")){await ty();return}if(l.matches("[data-connect-wallet]")){const g=l.dataset.connectWallet||"solana";if(g&&g!=="solana"){await xu(g,{returnPath:"/terminal"});return}ma({returnPath:"/terminal"});return}if(l.matches("[data-connect-wallet-provider]")){await xu(l.dataset.connectWalletProvider||"solana",{returnPath:"/terminal"});return}if(l.matches("[data-wallet-connect-close]")){n.walletConnectMenuOpen=!1,h({force:!0});return}if(l.matches("[data-wallet-fast-approvals-toggle]")){wg(!n.walletFastApprovalsEnabled),T(n.walletFastApprovalsEnabled?"Fast approvals on. SlimeWire will open wallet prompts immediately, but Phantom/Solflare still require approval.":"Fast approvals off. Browser wallet trades still require wallet approval."),h({force:!0});return}if(l.matches("[data-disconnect-wallet]")){await Mu();return}if(l.matches("[data-share-x]")&&Qi(l.dataset.shareText||""),l.matches("[data-share-watch-token-btn]")&&Bu("token"),l.matches("[data-share-watch-kol-btn]")&&Bu("kol"),l.matches("[data-save-preset]")){await Yu(l.dataset.savePreset);return}if(l.matches("[data-save-fast-preset]")){await Yu(l.dataset.saveFastPreset,"fast");return}if(l.matches("[data-use-preset]")){Pv(l.dataset.usePreset,l.dataset.presetId||"");return}if(l.matches("[data-edit-preset]")){Qu(l.dataset.editPreset,l.dataset.presetId||"");return}if(l.matches("[data-edit-selected-preset]")){const g=l.dataset.editSelectedPreset==="bundle"?"bundle":"trade",$=g==="bundle"?n.selectedBundlePresetId:n.selectedTradePresetId;$&&$!=="custom"?Qu(g,$):Al(g);return}if(l.matches("[data-cancel-preset-edit]")){gs(l.dataset.cancelPresetEdit,""),h();return}if(l.matches("[data-delete-preset]")){await Cv(l.dataset.deletePreset,l.dataset.presetId||"");return}if(l.matches("[data-quick-trade-token]")){e.preventDefault(),e.stopPropagation(),mn(ve(l.dataset.quickTradeToken||"",{source:"legacy-quick-trade"}),{source:"legacy-quick-trade"});return}if(l.matches("[data-quick-bundle-token]")){e.preventDefault(),e.stopPropagation(),ne(()=>Ju(l.dataset.quickBundleToken||""));return}if(l.matches("[data-smart-chart-token]")){Tt(ve(l.dataset.smartChartToken||"",{source:"chart-button"}),{defaultTab:"chart",source:"chart-button"});return}if(l.matches("[data-smart-chart-view]")){const g=l.dataset.smartChartView||"chart";n.smartChartView=["chart","chartTxns","txns","info"].includes(g)?g:"chart",h();return}if(l.matches("[data-chart-trade-tab]")){n.chartTradeTab=l.dataset.chartTradeTab==="sell"?"sell":"buy",h({force:!0,preserveSmartChartFrame:!0}),n.chartTradeTab==="buy"&&requestAnimationFrame(()=>m("[data-chart-buy-amount]")?.focus());return}if(l.matches("[data-chart-buy-preset]")){const g=m("[data-chart-buy-amount]");g&&(g.value=l.dataset.chartBuyPreset||""),n.quickBuyAmountOverride=Y(l.dataset.chartBuyPreset||""),eo();return}if(l.matches("[data-chart-confirm-buy]")){const g=l.dataset.chartConfirmBuy||n.smartChartToken||"";e.preventDefault(),e.stopPropagation();const $=m("[data-chart-buy-wallet]")?.value||"";if(pe($)){try{l.dataset.actionState="clicked",l.disabled=!0,await Sv(g)}catch(C){const B=N(C.message||"Chart buy failed."),U=Y(m("[data-chart-buy-amount]")?.value||"")||"custom";z("trade-buy",g,String(U),{state:"error",error:B}),Le("trade-buy",g,String(U),4e3),Ne(B),T(B),de()}return}Ne("Buy queued. Opening wallet approval..."),l.dataset.actionState="clicked",l.disabled=!0,ne(async()=>{try{const C=Uu();await Ns({tokenMint:g,walletIndex:$,amountSol:Y(m("[data-chart-buy-amount]")?.value||""),slippageBps:m("[data-chart-buy-slippage]")?.value||"400",takeProfitPct:C.takeProfitPct,stopLossPct:C.stopLossPct,sellDelay:C.sellDelay,sellPercent:C.sellPercent,source:"chart-buy-panel"}),n.chartTradeTab="buy",Ne("Buy submitted. Refreshing position..."),h({force:!0,preserveSmartChartFrame:!0})}catch(C){const B=N(C.message||"Chart buy failed.");Ne(B),T(B),h({force:!0,preserveSmartChartFrame:!0})}});return}if(l.matches("[data-chart-confirm-sell]")){e.preventDefault(),e.stopPropagation();const g=m("[data-chart-sell-percent]")?.value||"";if(g)try{await Us(l.dataset.chartConfirmSell||"",g,{slippageBps:m("[data-chart-buy-slippage]")?.value||"400"})}catch($){const C=N($.message||"Chart sell failed.");Ne(C),T(C)}return}if(l.matches("[data-smart-chart-open]")){const g=String(m("[data-smart-chart-input]")?.value||"").trim();if(!g){T("Paste a token CA first.");return}Tt(ve(g,{source:"smart-chart-search"}),{defaultTab:"buy",focusAmountInput:!0,source:"smart-chart-search"});return}if(l.matches("[data-refresh-feeds]")){ne(()=>en({force:!0,reason:"manual-refresh-feeds"}));return}if(l.matches("[data-terminal-load-more]")){const g=l.dataset.terminalLoadMore||n.activeTab;mh(g,_t(g)),Yc(g,{requestId:j(g).lastRequestId||"",status:j(g).lastStatus||"render",reason:"load-more",resultCount:_t(g),renderedCount:zn(g),hasMore:_t(g)>zn(g),stale:jn(g),errorCode:j(g).errorCode||"",errorMessage:j(g).errorMessage||""}),h({force:!0});return}if(l.matches("[data-dev-info]")){e.preventDefault(),e.stopPropagation(),Nw(l.dataset.devInfo||"");return}if(l.matches("[data-return-dismiss]")){e.preventDefault(),qw();return}if(l.matches("[data-watchlist-tag]")){e.preventDefault(),n.watchlistTagFilter=l.dataset.watchlistTag||"",h();return}if(l.matches("[data-watchlist-edit]")){e.preventDefault(),Yw(l.dataset.watchlistEdit||"",l.dataset.watchlistSymbol||"");return}if(l.matches("[data-watchlist-edit-close]")){e.preventDefault(),Qw();return}if(l.matches("[data-watchlist-meta-save]")){e.preventDefault(),Zw();return}if(l.matches("[data-radar-open]")){e.preventDefault(),Vw(l.dataset.radarOpen||"",l.dataset.radarSymbol||"");return}if(l.matches("[data-radar-close]")){zw();return}if(l.matches("[data-radar-scope]")){e.preventDefault(),n.radarDrawer={...n.radarDrawer||{},scope:l.dataset.radarScope||"token"},rt();return}if(l.matches("[data-radar-submit]")){e.preventDefault(),Gw();return}if(l.matches("[data-radar-toggle]")){e.preventDefault(),Dp("toggle",l.dataset.radarToggle||"");return}if(l.matches("[data-radar-remove]")){e.preventDefault(),Dp("remove",l.dataset.radarRemove||"");return}if(l.matches("[data-dev-info-tab]")){e.preventDefault();const g=l.dataset.devInfoTab||"overview";n.devInfoTab=g;const $=l.closest(".dossier-drawer");$&&($.setAttribute("data-active-pane",g),$.querySelectorAll("[data-dev-info-tab]").forEach(C=>{C.dataset.active=C.dataset.devInfoTab===g?"true":"false"}));return}if(l.matches("[data-dev-info-close]")){wl();return}if(l.matches("[data-dev-info-refresh]")){const g=l.dataset.devInfoRefresh||n.devInfoDetails?.tokenMint||"";await Np(g,{force:!0});return}if(l.matches("[data-watch-token]")&&await ep("add",l),l.matches("[data-unwatch-token]")&&await ep("remove",l),l.matches("[data-pnl-card]"))try{await Iu(l.dataset.pnlCard)}catch(g){T(g.message)}if(l.matches("[data-share-pnl-card]")&&await qy(l.dataset.sharePnlCard,l.dataset.shareText||""),l.matches("[data-scan-bags]")){await Kv();return}if(l.matches("[data-arm-exits]")){await Hv(l.dataset.armExits,l);return}if(l.matches("[data-dev-watch]")){await qv(l.dataset.devWatch);return}if(l.matches("[data-hype-create]")){await Gb();return}if(l.matches("[data-push-enable]")){await dg();return}if(l.matches("[data-push-disable]")){await ug();return}if(l.matches("[data-call-post]")){await pS(l.dataset.callPost);return}if(l.matches("[data-telegram-link]")){await lg();return}if(l.matches("[data-trade-trace-close]")){n.tradeTrace=null,$o();return}if(l.matches("[data-launch-kit-close]")){n.launchShareKit=null,h();return}if(l.matches("[data-create-wallets]")&&await Cu(),l.matches("[data-distribute-fresh]")){await Bb();return}if(l.matches("[data-return-funds]")){await Mb();return}if(l.matches("[data-sweep-background-wallets]")){await Ov();return}if(l.matches("[data-create-automation-wallet]")&&await yy(),l.matches("[data-create-session-wallet]")){e.preventDefault(),e.stopPropagation(),await Sy(l);return}if(l.matches("[data-tpsl-status-button]")){l.dataset.tpslState==="enabled"?(n.activeTab="profile",Pe("/terminal","profile"),n.automationDelegationStatus=n.automationDelegationStatus||"Server exits are enabled for managed wallets.",h({force:!0})):await Xi("enable");return}if(l.matches("[data-automation-permission]")&&await Xi(l.dataset.automationPermission||"enable"),l.matches("[data-run-trade-plans]")&&await Ji(),l.matches("[data-restore-backup]")&&await Py(),l.matches("[data-export-backup]")&&await Cy(),l.matches("[data-import-wallet]")&&await Ly(),l.matches("[data-remove-wallet]")&&await xy(l.dataset.removeWallet||"",l.dataset.walletLabel||"",l.dataset.removeWalletKey||""),l.matches("[data-wallet-sweep-action]")&&await Iy(l.dataset.walletSweepAction||""),l.matches("[data-download]")){const g=n.downloads?.[l.dataset.download];g&&be(g.filename,g.text)}if(l.matches("[data-trade-buy-quick]")&&await Is(l.dataset.tradeBuyQuick),l.closest?.("[data-swap-reverse]")){n.swapDirection=n.swapDirection==="sell"?"buy":"sell",h({force:!0});return}if(l.matches("[data-swap-use-custom-amount]")){const g=String(m("[data-swap-amount]")?.value||"").trim();n.swapDirection==="sell"?await el(g||"100"):await Is(g);return}l.matches("[data-trade-buy-max]")&&await Is(null,"max"),l.matches("[data-trade-buy-custom]")&&await Is(m("[data-buy-custom]")?.value||m("[data-swap-amount]")?.value),l.matches("[data-trade-sell-quick]")&&await el(l.dataset.tradeSellQuick),l.matches("[data-trade-sell-custom]")&&await el(m("[data-sell-custom]")?.value||m("[data-swap-amount]")?.value),l.matches("[data-trade-plan-start]")&&await Qy(),l.matches("[data-volume-start]")&&await ev();const u=l.closest?.("[data-vbot-set-mode]");if(u){e.preventDefault(),n.slimeBotMode=u.dataset.vbotSetMode||"smart",u.parentElement?.querySelectorAll("[data-vbot-set-mode]").forEach(g=>{g.dataset.active=String(g===u)});return}const p=l.closest?.("[data-vbot-set-aggr]");if(p){e.preventDefault(),n.slimeBotAggr=p.dataset.vbotSetAggr||"med",p.parentElement?.querySelectorAll("[data-vbot-set-aggr]").forEach(g=>{g.dataset.active=String(g===p)});return}const f=l.closest?.("[data-vbot-set-stagger]");if(f){e.preventDefault(),n.slimeBotStagger=f.dataset.vbotSetStagger||"steady",f.parentElement?.querySelectorAll("[data-vbot-set-stagger]").forEach(g=>{g.dataset.active=String(g===f)});return}if(l.matches("[data-vbot-start]")){e.preventDefault(),await _b();return}const y=l.closest?.("[data-vbot-stop]");if(y){e.preventDefault(),await Nb(y.dataset.vbotStop||"");return}if(l.matches("[data-sniper-buy]")&&await av(l.dataset.sniperBuy),l.matches("[data-kol-mode]")){n.kolWallet="",n.kolMode=l.dataset.kolMode||n.kolMode,Z("kol"),await te("kol",{force:!0,reason:"kol-mode-switch"}).catch(g=>T(g.message));return}if(l.matches("[data-kol-refresh]")){await te("kol",{force:!0,reason:"manual-kol-refresh"}).catch(g=>T(g.message));return}if(l.matches("[data-kol-wallet-scan]")){if(n.kolWallet=String(m("[data-kol-wallet]")?.value||"").trim(),n.kolWallet&&!Ut(n.kolWallet)){Kt("That is not a valid Solana public wallet. Paste a real wallet address before scanning."),n.kolWallet="";return}Z("kol"),await te("kol",{force:!0,reason:"kol-wallet-scan"}).catch(g=>T(g.message));return}if(l.matches("[data-kol-scan-wallet]")){if(n.kolWallet=String(l.dataset.kolScanWallet||"").trim(),n.kolWallet&&!Ut(n.kolWallet)){Kt("This curated KOL profile does not have a verified Solana wallet yet, so Scan is locked."),n.kolWallet="";return}Z("kol"),await te("kol",{force:!0,reason:"kol-signal-wallet-scan"}).catch(g=>T(g.message));return}if(l.matches("[data-kol-copy-setup]")){const g=String(l.dataset.kolCopySetup||"").trim();if(g&&!Ut(g)){Kt("This curated KOL profile does not have a verified Solana wallet yet, so Copy Setup is locked.");return}g&&(n.kolWallet=g),n.activeTab="kol",h(),setTimeout(()=>{const $=document.querySelector("[data-kol-management-settings]");$&&($.open=!0,$.scrollIntoView({behavior:"smooth",block:"start"}));const C=m("[data-kol-wallet]");C&&g&&(C.value=g);const B=m("[data-kol-status]");B&&S(B,`Copy setup loaded for ${w(g)}. Choose presets, then tap Copy Wallet Next Buy.`),m("[data-kol-amount]")?.focus?.({preventScroll:!0})},40);return}if(l.matches("[data-kol-copy]")){await dv(l.dataset.kolCopy);return}if(l.matches("[data-kol-copy-wallet]")){const g=String(l.dataset.kolCopyWallet||"").trim();if(g&&!Ut(g)){Kt("That KOL entry does not have a verified Solana wallet yet.");return}await uv(l.dataset.kolCopyWallet||"");return}if(l.matches("[data-kol-trade]")){n.tradeToken=l.dataset.kolTrade||"",n.activeTab="trade",h();return}if(l.matches("[data-kol-bundle]")){n.bundleToken=l.dataset.kolBundle||"",n.activeTab="bundle",h();return}if(l.matches("[data-bundle-buy]")&&await Vu("buy"),l.matches("[data-bundle-sell]")&&await Vu("sell"),l.matches("[data-bundle-plan]")&&await mv(),l.matches("[data-launch-start]")&&await Mv(),l.matches("[data-launch-cancel]")&&await Bv(l.dataset.launchCancel),l.matches("[data-use-token]")&&(n.tradeToken=l.dataset.useToken||"",n.volumeToken=l.dataset.useToken||"",n.bundleToken=l.dataset.useToken||"",n.activeTab="trade",h()),l.matches("[data-use-token-bundle]")&&(n.bundleToken=l.dataset.useTokenBundle||"",n.tradeToken=n.bundleToken,n.volumeToken=n.bundleToken,n.activeTab="bundle",h()),l.matches("[data-use-token-volume]")&&(n.volumeToken=l.dataset.useTokenVolume||"",n.tradeToken=n.volumeToken,n.bundleToken=n.volumeToken,n.activeTab="volume",h()),l.matches("[data-refresh-all]")){const g=L();if(Xa("clicked",{startedAt:g}),W({component:"ui-action",action:"position-refresh-click-to-state",durationMs:L()-g,details:n.activeTab||"terminal"}),!n.user||!n.token)Xe(n.activeTab)?await te(n.activeTab,{force:!0,reason:"manual-refresh-all"}).catch($=>T($.message)):T("Browsing is open. Create or connect a profile when you want saved wallets, balances, or trades."),je("success");else{const $=L();n.activeTab==="positions"?ph({force:!0,reason:"manual-positions-refresh"}).catch(C=>{je("error",{error:N(C?.message||"Position refresh failed")}),T(C.message),h()}):(kt({force:!0,deep:!1,reason:"manual_refresh_all"}).catch(C=>T(C.message)),te(n.activeTab,{force:!0,reason:"manual-refresh-all"}).catch(C=>T(C.message))),K("position-refresh-request-start",$,{component:"positions",cacheHit:!1,details:n.activeTab||"terminal"})}}if(l.matches("[data-tab]")){const g=L();if(n.activeTab=l.dataset.tab,n.activeTab==="volume"&&ws(),n.activeTab==="ogreAi"&&sv(),n.activeTab==="ogreTek"){n.route="terminal",window.history.pushState({},"","/ogre-tek"),await Lr({silent:!0}).catch(B=>T(B.message)),h();return}n.route!=="terminal"&&(n.route="terminal",window.history.pushState({},"","/terminal")),n.activeTab==="smartChart"?window.history.pushState({},"","/terminal/chart"):n.activeTab==="slimeScope"?window.history.pushState({},"","/terminal/slime-scope"):(window.location.pathname.includes("/terminal/chart")||window.location.pathname.includes("/terminal/slime-scope"))&&window.history.pushState({},"","/terminal");const $=Jc(n.activeTab);h();const C=te(n.activeTab,{silent:!0,ifStale:!0,force:!$,reason:"tab-switch"}).catch(B=>T(B.message));$||await C,K("tab-switch",g,{component:"terminal",cacheHit:$,details:n.activeTab})}if(l.matches("[data-refresh-scan]")&&ne(()=>te("sniper",{force:!0,reason:"manual-sniper-refresh"})),l.closest?.("[data-refresh-live-pairs]")){const g=n.activeTab==="slimeScope"?"slimeScope":n.activeTab==="terminal"?"terminal":n.activeTab==="launch"||n.activeTab==="launchCoin"?"launch":"live",C=n.activeTab==="live"||n.activeTab==="terminal"?null:Li();ne(async()=>{await te(g,{force:!0,reason:"manual-live-refresh",renderStart:!1,userInitiated:!0}),C&&xi(C)})}if(l.closest?.("[data-terminal-filter-toggle]")){const g=Re();g.open=!g.open,h();return}if(l.closest?.("[data-terminal-filter-clear]")){n.terminalLaunchFilters={open:!0,keywords:"",excludeKeywords:"",socials:{},quotes:{},audits:{}},Z("live"),Z("launch"),Z("sniper"),h();return}l.matches("[data-refresh-watchlist]")&&ne(()=>te("watchlist",{force:!0,reason:"manual-watchlist-refresh"}));const v=l.closest?.("[data-live-pair-bucket]");v&&(n.livePairBucket=v.dataset.livePairBucket||"live",n.livePairs=qe(),n.livePairsLastUpdatedAt=ua(),Z("live"),Z("slimeScope"),h(),ne(()=>te(n.activeTab==="terminal"?"terminal":"live",{force:!0,reason:"live-bucket-switch"})));const P=l.closest?.("[data-slime-scope-mode]");P&&(n.slimeScopeMode=P.dataset.slimeScopeMode||"new",n.activeTab="slimeScope",Z("slimeScope"),h(),ne(()=>te("slimeScope",{force:!0,reason:"slime-scope-mode-switch"}))),l.matches("[data-scan-mode]")&&(Z("sniper"),n.scanMode=l.dataset.scanMode||n.scanMode,h(),ne(()=>Xn(n.scanMode)));const A=l.getAttribute("data-copy");if(A){const g=l.getAttribute("data-copy-label")||l.textContent||"Copy";await navigator.clipboard.writeText(A),S(l,"Copied"),setTimeout(()=>{S(l,g)},1e3)}}),document.addEventListener("keydown",e=>{if(e.key==="Escape"){if(n.replayDetails?.open){Tl();return}if(n.kolDumpDetails?.open){Gi();return}if(n.protectedBuyModal?.open){_s();return}if(n.quickBuyModal?.open){rl();return}if(n.walletConnectMenuOpen){n.walletConnectMenuOpen=!1,h({force:!0});return}n.loginCollapsed||(n.loginCollapsed=!0,h({force:!0}))}}),document.addEventListener("change",async e=>{const t=e.target;if(t?.matches?.("[data-vbot-autocreate]")){const a=document.querySelector("[data-vbot-manual-wallets]");a&&(a.hidden=!!t.checked)}if(t?.matches?.("[data-vbot-keepdust]")&&(n.slimeBotKeepDust=!!t.checked),t?.matches?.("[data-vbot-offset]")&&(n.slimeBotOffset=!!t.checked),t?.matches?.("[data-vbot-rolling]")){const a=!!t.checked;document.querySelectorAll("[data-vbot-pool-only]").forEach(s=>{s.style.display=a?"none":""});const r=document.querySelector("[data-vbot-manual-wallets]");r&&(r.hidden=a||!!document.querySelector("[data-vbot-autocreate]")?.checked)}if(t?.matches?.("[data-custom-select]")&&(ys(),Cb(t)),t?.matches?.("[data-swap-from]")){const a=We(t.value||"SOL")||"SOL";n.tradeSwapFrom=a,a!=="SOL"?(n.tradeToken=a,n.tradeSwapTo="SOL"):We(n.tradeSwapTo||n.tradeToken||"")||(n.tradeSwapTo=""),h({force:!0});return}if(t?.matches?.("[data-swap-to]")){const a=We(t.value||"");if(n.tradeSwapTo=a,a&&a!=="SOL"){n.tradeToken=a,n.swapDirection="buy";const r=m("[data-trade-token]");r&&(r.value=a)}a||m("[data-trade-token]")?.focus?.({preventScroll:!0}),h({force:!0});return}if(t?.matches?.("[data-chart-buy-wallet]")){n.chartBuyWalletIndex=String(t.value||"");return}if(t?.matches?.("[data-fast-trade-preset]")){const a=t.value||"";if(a==="custom"){Al("trade");return}if(n.selectedTradePresetId=a,n.fastTradePresetStatus=n.selectedTradePresetId?"Trade preset selected. Tap Trade or Buy on a token row to use it.":"No fast trade preset selected. Token rows open the manual Trade form.",(t.dataset.fastTradePreset||"")==="chart-panel"){const r=le("trade",n.selectedTradePresetId);n.chartBuyWalletIndex="",r?.amountSol&&(n.quickBuyAmountOverride=Y(r.amountSol)),n.chartTradeStatus=r?`${r.name||"Preset"} loaded.`:"",h({force:!0,preserveSmartChartFrame:!0});return}h()}if(t?.matches?.("[data-quick-buy-amount]")&&(n.quickBuyAmountOverride=Y(t.value),t.value=n.quickBuyAmountOverride,eo()),t?.matches?.("[data-protected-buy-preset], [data-protected-buy-wallet], [data-protected-buy-slippage], [data-protected-buy-risk-accept], [data-protected-buy-amount]")&&(n.protectedBuyModal={...n.protectedBuyModal||{},presetId:m("[data-protected-buy-preset]")?.value||n.protectedBuyModal?.presetId||"conservative",walletIndex:m("[data-protected-buy-wallet]")?.value||n.protectedBuyModal?.walletIndex||"",amountSol:Y(m("[data-protected-buy-amount]")?.value||n.protectedBuyModal?.amountSol||""),slippageBps:m("[data-protected-buy-slippage]")?.value||n.protectedBuyModal?.slippageBps||"400",riskAccepted:!!m("[data-protected-buy-risk-accept]")?.checked},sl()),t?.matches?.("[data-fast-bundle-preset]")){const a=t.value||"";if(a==="custom"){Al("bundle");return}n.selectedBundlePresetId=a,n.fastBundlePresetStatus=n.selectedBundlePresetId?"Bundle preset selected. It will not buy until you tap a Bundle button.":"No fast bundle preset selected. Bundle rows open the manual Bundle form.",h()}if(t?.matches?.("[data-terminal-sort]")&&(n.terminalSort=t.value||"best",n.terminalCat="",Z("live"),Z("slimeScope"),ts()),t?.matches?.("[data-live-feed-category]")){n.liveFeedCategory=t.value||"best";try{localStorage.setItem("liveFeedCategory",n.liveFeedCategory)}catch{}n.terminalSort=oo()[3]||"best",n.terminalCat=oo()[0]||"",Z("live"),ts()}if(t?.matches?.("[data-live-terminal-category]")){n.liveTerminalCategory=t.value||"dexTrending";try{localStorage.setItem("liveTerminalCategory",n.liveTerminalCategory)}catch{}n.terminalSort=co()[3]||"volume",n.terminalCat=co()[0]||"",Z("live"),ts()}if(t?.matches?.("[data-cook-spot-category]")){n.cookSpotCategory=t.value||"dexTrending";try{localStorage.setItem("cookSpotCategory",n.cookSpotCategory)}catch{}n.terminalSort=Pr()[3]||"volume",n.terminalCat=Pr()[0]||"",Z("slimeScope"),ts(()=>te("slimeScope",{force:!0,reason:"cook-spot-category"}))}if(t?.matches?.("[data-launch-coin-image]")){const a=t.files?.[0],r=m("[data-launch-image-preview-wrap]"),s=m("[data-launch-image-preview]"),o=m("[data-launch-image-preview-meta]");if(!a){r&&(r.hidden=!0);return}const c=Math.round(a.size/1024);o&&(o.textContent=`${a.name} · ${c>=1024?`${(c/1024).toFixed(1)} MB`:`${c} KB`} · saved with the sheet`);try{const l=URL.createObjectURL(a);s&&(s.onload=()=>URL.revokeObjectURL(l),s.src=l),r&&(r.hidden=!1)}catch{r&&(r.hidden=!0)}gu(a).then(l=>{if(n.launchCoinDraft={...n.launchCoinDraft||{},imageDataUrl:l,imageName:a.name,imageType:un(l,a.type||"application/octet-stream")},String(l).length<15e5)try{Oa(n.launchCoinDraft)}catch{}}).catch(()=>{});return}if(t?.matches?.("[data-launch-coin-banner]")){const a=t.files?.[0],r=m("[data-launch-banner-preview-wrap]"),s=m("[data-launch-banner-preview]"),o=m("[data-launch-banner-preview-meta]");if(!a){r&&(r.hidden=!0);return}const c=Math.round(a.size/1024);o&&(o.textContent=`${a.name} · ${c>=1024?`${(c/1024).toFixed(1)} MB`:`${c} KB`} · saved with the sheet`);try{const l=URL.createObjectURL(a);s&&(s.onload=()=>URL.revokeObjectURL(l),s.src=l),r&&(r.hidden=!1)}catch{r&&(r.hidden=!0)}bu(a).then(l=>{if(n.launchCoinDraft={...n.launchCoinDraft||{},bannerDataUrl:l,bannerName:a.name,bannerType:un(l,a.type||"image/jpeg")},String(l).length<15e5)try{Oa(n.launchCoinDraft)}catch{}}).catch(l=>{const d=m("[data-launch-coin-status]");d&&S(d,l?.message||"Could not read that banner.")});return}if(t?.matches?.("[data-terminal-filter-social], [data-terminal-filter-quote], [data-terminal-filter-audit]")){const a=Re(),r=t.getAttribute("data-terminal-filter-social"),s=t.getAttribute("data-terminal-filter-quote"),o=t.getAttribute("data-terminal-filter-audit");r&&(a.socials[r]=!!t.checked),s&&(a.quotes[s]=!!t.checked),o&&(a.audits[o]=!!t.checked),a.open=!0,Z("live"),Z("launch"),Z("sniper"),h()}t?.matches?.("[data-ogre-tek-field]")&&(go(),n.ogreTek.reviewOpen=!1,h({force:!0})),t?.matches?.("[data-ogre-tek-risk-accepted]")&&(n.ogreTek.riskAccepted=!!t.checked,h({force:!0})),t?.matches?.("[data-restore-file]")&&await Oy(t),t?.matches?.("[data-avatar-file]")&&await _y(t)}),document.addEventListener("focusout",()=>{setTimeout(id,50)});let Ca=null;const Cm=e=>{if(e.target?.closest?.(".launch-coin-card")&&String(e.target?.tagName||"").match(/INPUT|TEXTAREA|SELECT/)&&!e.target.matches("[data-launch-coin-image]")&&!e.target.matches("[data-launch-coin-banner]")){if(e.target.matches("[data-launch-coin-amount], [data-launch-coin-dev-buy-sol]")){const a=String(e.target.value||"");let r=a.replace(/[^0-9.]/g,"");const s=r.indexOf(".");if(s!==-1&&(r=r.slice(0,s+1)+r.slice(s+1).replace(/\./g,"")),r!==a){const o=e.target.selectionStart;e.target.value=r;try{e.target.setSelectionRange(o-(a.length-r.length),o-(a.length-r.length))}catch{}}}Ca&&clearTimeout(Ca),Ca=setTimeout(()=>{Ca=null,or({silent:!0})},350)}};document.addEventListener("input",Cm),document.addEventListener("change",Cm),document.addEventListener("click",()=>{Ca&&(clearTimeout(Ca),Ca=null,or({silent:!0}))},!0),document.addEventListener("input",e=>{const t=e.target;if(t?.matches?.("[data-quick-buy-amount]")){n.quickBuyAmountOverride=String(t.value||"").replace(/[^0-9.]/g,"").slice(0,12),eo();return}if(t?.matches?.("[data-trade-token]")){const a=String(t.value||"").trim();n.tradeToken=a,n.tradeSwapTo=a;return}if(t?.matches?.("[data-terminal-filter-field]")){const a=t.getAttribute("data-terminal-filter-field"),r=Re();(a==="keywords"||a==="excludeKeywords")&&(r[a]=String(t.value||""),r.open=!0,kp());return}if(t?.matches?.("[data-launch-ticker]")){const a=Re();a.keywords=String(t.value||""),a.open=!0,kp();return}if(t?.matches?.("[data-smart-chart-zoom]")){n.smartChartZoom=Math.min(115,Math.max(60,Number(t.value)||72));const a=t.closest(".smart-chart-zoom")?.querySelector("strong");a&&S(a,`${n.smartChartZoom}%`);const r=t.closest(".smart-chart-main")?.querySelector(".smart-chart-frame");r&&r.style.setProperty("--smart-chart-scale",String(n.smartChartZoom/100));return}t?.matches?.("[data-ogre-tek-field]")&&(go(),t.type==="range"&&h({force:!0}))});function xr(e=null){if(document.hidden)return;const t=e?.persisted?"pageshow-bfcache":"visibility-return",a=cd(t,{forcePaint:!0});id(),!a&&e?.persisted&&n.route==="terminal"&&h({force:!0,preserveSmartChartFrame:n.activeTab==="smartChart"}),sa&&window.clearTimeout(sa),sa=window.setTimeout(()=>{if(sa=null,!(document.hidden||n.route!=="terminal")){if(Yn()){W({component:"post-trade",action:"hidden-feed-refresh-skipped",durationMs:0,requestId:n.postTradeRefresh?.attemptId||"",details:n.activeTab||"terminal"});return}te(n.activeTab,{silent:!0,ifStale:!0,force:!1,reason:"visibility-focus-return"}).catch(r=>T(r.message)),n.user&&n.token&&jn("positions")&&St({force:!1,fast:!0,silent:!0,followUpValues:!0,reason:"visibility-position-resume",timeoutMs:Ro}).catch(()=>{}),pa(),Gn(),ns(),gi()}},Ql)}document.addEventListener("visibilitychange",()=>{if(document.hidden){(n.ogreAgentListening||n.ogreAgentSpeechRecognizer)&&Gt("Voice input paused while tab was hidden.");return}const e=!!document.activeElement?.matches?.("[data-ogre-agent-input]");if(n.ogreAgentOpen&&(n.ogreAgentListening||n.ogreAgentLoading||e)){clearTimeout(appResumeTimer),appResumeTimer=setTimeout(()=>{!document.hidden&&!n.ogreAgentListening&&!n.ogreAgentLoading&&!document.activeElement?.matches?.("[data-ogre-agent-input]")&&xr()},Ql+900);return}xr()}),window.addEventListener("focus",xr),window.addEventListener("pageshow",xr),window.addEventListener("online",xr),window.addEventListener("pagehide",()=>{sa&&(window.clearTimeout(sa),sa=null),n.clipFarm?.recording&&tr()});function xk(){Go&&window.clearInterval(Go),Go=window.setInterval(()=>{document.hidden||cd("watchdog")},ef)}const Mk=[{key:"live",label:"Live",items:[["terminal","Live Terminal"],["live","Cooks"],["liveTrades","Live Trades"]]},{key:"chart",label:"Swap & Chart",items:[["trade","Slime Swap"],["smartChart","Smart Chart"]]},{key:"intel",label:"Intel",items:[["slimeScope","Slime Scope"],["watchlist","Watchlist"],["kol","KOL Tracker"],["sniper","OgreSniper"],["txAudit","TP/SL Audit"]]},{key:"tools",label:"Ogre Tek",items:[["tek","Tek Hub"],["ogreAi","Ogre A.I."],["launchCoin","Pump Launch"],["bundle","Bundle"],["volume","SlimeBot"],["launch","Launch Watch"]]},{key:"portfolio",label:"Portfolio",items:[["wallets","Wallets"],["positions","Positions"],["pnl","PnL"],["raids","Raid Board","/raids"]]},{key:"profile",label:"Profile",items:[["profile","Home / Profile"]]}];function La(e,t){return t=t||"#8dff45",`<svg class="swampi" viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="1.5" y="1.5" width="21" height="21" rx="6.5" fill="${t}" fill-opacity="0.2" stroke="${t}" stroke-opacity="0.5" stroke-width="1.1"/><g stroke="${t}" stroke-width="1.95">${e}</g></svg>`}const Bk={terminal:"#46e8ff",live:"#8dff45",liveTrades:"#ffd24a",smartChart:"#72ff23",trade:"#3fe0d0",slimeScope:"#5ab0ff",watchlist:"#ffd24a",kol:"#ffcf5a",sniper:"#ff6b6b",txAudit:"#bbff63",tek:"#9fb6c2",ogreAi:"#b06bff",launchCoin:"#ff8a5a",bundle:"#ffa64d",volume:"#46e8ff",launch:"#9bff9b",wallets:"#ffd24a",positions:"#5ab0ff",pnl:"#72ff23",profile:"#8dff45"},xa={terminal:'<rect x="3" y="4" width="18" height="16" rx="2.5"/><path d="M7 9l3 3-3 3"/><path d="M13 15h4"/>',live:'<path d="M4 11h16"/><path d="M5 11a7 7 0 0 0 14 0"/><path d="M7 18l-1 2"/><path d="M17 18l1 2"/><path d="M10 7c0-1.3 1-1.3 1-2.5"/><path d="M14 8c0-1.3 1-1.3 1-2.5"/>',liveTrades:'<path d="M13 3L6 13h5l-1 8 8-11h-5z"/>',smartChart:'<path d="M3 17l5-5 4 3 8-9"/><path d="M16 6h4v4"/>',trade:'<path d="M4 8h13l-3-3"/><path d="M20 16H7l3 3"/>',slimeScope:'<circle cx="11" cy="11" r="6"/><path d="M11 5v2.5"/><path d="M11 14.5V17"/><path d="M5 11h2.5"/><path d="M14.5 11H17"/><circle cx="11" cy="11" r="1.2"/><path d="M15.5 15.5L20 20"/>',watchlist:'<path d="M12 4l2.3 4.7 5.2.8-3.8 3.6.9 5.1-4.6-2.4-4.6 2.4.9-5.1L4.3 9.5l5.2-.8z"/>',kol:'<path d="M4 8l3 9h10l3-9-5 4-3-6-3 6z"/><path d="M7 17h10"/>',sniper:'<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3.3"/><path d="M12 2v3"/><path d="M12 19v3"/><path d="M2 12h3"/><path d="M19 12h3"/>',txAudit:'<path d="M6 3h12v18l-3-2-3 2-3-2-3 2z"/><path d="M9 8h6"/><path d="M9 12h6"/>',tek:'<path d="M15 5a4 4 0 0 1-5.2 5L5 14.8 9.2 19l4.8-4.8a4 4 0 0 1 5-5.2l-2.7 2.7-2.3-.5-.5-2.3z"/>',ogreAi:'<path d="M5 10a7 5 0 0 1 14 0v3a5 5 0 0 1-5 5h-4a5 5 0 0 1-5-5z"/><path d="M4 8L2.5 6"/><path d="M20 8l1.5-2"/><circle cx="9.5" cy="11" r="1"/><circle cx="14.5" cy="11" r="1"/><path d="M9.5 15l-.7 2.5"/><path d="M14.5 15l.7 2.5"/>',launchCoin:'<path d="M12 3c3 2 5 6 5 10l-3 3h-4l-3-3c0-4 2-8 5-10z"/><circle cx="12" cy="10" r="1.6"/><path d="M9 17l-2 4"/><path d="M15 17l2 4"/>',bundle:'<path d="M12 3l8 4-8 4-8-4z"/><path d="M4 7v6l8 4 8-4V7"/><path d="M12 11v6"/>',volume:'<path d="M4 13v4"/><path d="M8 9v8"/><path d="M12 5v12"/><path d="M16 10v7"/><path d="M20 13v4"/>',launch:'<path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/>',wallets:'<rect x="3" y="6" width="18" height="13" rx="2.5"/><path d="M3 10h18"/><circle cx="17" cy="14" r="1.3"/>',positions:'<rect x="3" y="8" width="18" height="11" rx="2"/><path d="M8 8V6a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M3 13h18"/>',pnl:'<path d="M4 20V11"/><path d="M10 20V4"/><path d="M16 20v-7"/><path d="M21 20H3"/>',profile:'<path d="M5 12a7 6 0 0 1 14 0v2a5 5 0 0 1-5 5h-4a5 5 0 0 1-5-5z"/><circle cx="8" cy="8" r="2.2"/><circle cx="16" cy="8" r="2.2"/><path d="M9 14.5c1.2 1.4 4.8 1.4 6 0"/>',prelaunch:'<path d="M4 11h16"/><path d="M5 11a7 7 0 0 0 14 0"/><path d="M7 18l-1 2"/><path d="M17 18l1 2"/><path d="M10 7c0-1.3 1-1.3 1-2.5"/><path d="M14 8c0-1.3 1-1.3 1-2.5"/>',raids:'<path d="M5 4l9 9"/><path d="M19 4l-9 9"/><path d="M11 13l-4 7"/><path d="M13 13l4 7"/>'},Lm=Object.fromEntries(Object.entries(xa).map(([e,t])=>[e,La(t,Bk[e])])),Rk={live:La(xa.live,"#8dff45"),chart:La(xa.trade,"#3fe0d0"),intel:La(xa.slimeScope,"#5ab0ff"),tools:La(xa.tek,"#9fb6c2"),portfolio:La(xa.positions,"#5ab0ff"),profile:La(xa.profile,"#8dff45")};function Ik(){const e=document.querySelector(".tabs");if(!e||document.querySelector("[data-nav-drop]"))return;const t=document.createElement("nav");t.className="nav-drop-bar",t.setAttribute("data-nav-drop",""),t.setAttribute("aria-label","Portal areas");const a=`<a class="nav-drop-pro" href="/autopilot-pro" title="SlimeWire Auto — Pro autopilot" aria-label="Pro autopilot">
      <span class="nav-drop-pro-emblem" aria-hidden="true"></span>
    </a>`,r=([s,o,c])=>c?`<a href="${i(c)}" title="${i(o)}" class="nav-side-link">
         <span class="nav-side-icon" aria-hidden="true">${Lm[s]||"•"}</span>
         <span class="nav-side-label">${i(o)}</span>
       </a>`:`<button type="button" data-tab="${i(s)}" title="${i(o)}">
         <span class="nav-side-icon" aria-hidden="true">${Lm[s]||"•"}</span>
         <span class="nav-side-label">${i(o)}</span>
       </button>`;t.innerHTML=a+Mk.map(s=>`
    <div class="nav-drop-group" data-nav-drop-group="${i(s.key)}">
      <button type="button" class="nav-side-group-toggle" aria-expanded="false">
        <span class="nav-side-icon" aria-hidden="true">${Rk[s.key]||"•"}</span>
  ...
  `).join(""),e.parentElement.insertBefore(t,e),t.addEventListener("click",s=>{const o=s.target.closest(".nav-side-group-toggle");if(o){const c=o.parentElement,l=c.classList.contains("is-open");t.querySelectorAll(".nav-drop-group.is-open").forEach(d=>d.classList.remove("is-open")),t.querySelectorAll(".nav-side-group-toggle").forEach(d=>d.setAttribute("aria-expanded","false")),l||(c.classList.add("is-open"),o.setAttribute("aria-expanded","true"));return}s.target.closest("[data-tab]")&&t.querySelectorAll(".nav-drop-group.is-open").forEach(c=>c.classList.remove("is-open"))}),document.addEventListener("click",s=>{s.target.closest("[data-nav-drop]")||t.querySelectorAll(".nav-drop-group.is-open").forEach(o=>o.classList.remove("is-open"))})}function Ok(){const e=document.querySelector("[data-nav-drop]");if(!e)return;let t=!1;e.querySelectorAll(".nav-drop-group").forEach(a=>{const r=!!a.querySelector(`[data-tab="${n.activeTab}"]`);a.querySelector(".nav-side-group-toggle")?.toggleAttribute("data-active",r),a.classList.contains("is-open")&&(t=!0)}),e.querySelectorAll("[data-tab]").forEach(a=>{a.dataset.active=a.dataset.tab===n.activeTab?"true":"false"})}function Ek(){const e=document.querySelector('script[src*="app.js?v="]')?.getAttribute("src")||"";if(!e)return;setInterval(async()=>{if(!document.hidden)try{const s=((await fetch("/?build-check=1",{cache:"no-store"}).then(o=>o.text())).match(/app\.js\?v=[\w-]+/)||[])[0]||"";s&&!e.includes(s)&&Fk()}catch{}},300*1e3).unref?.()}function Fk(){if(document.querySelector("[data-build-update]"))return;const e=document.createElement("button");e.type="button",e.setAttribute("data-build-update",""),e.className="build-update-pill",e.textContent="🐸 SlimeWire updated - tap to refresh",e.addEventListener("click",()=>window.location.reload()),document.body.appendChild(e)}async function Wk(){Ik(),Ek(),Rf(),_f(),Wf(),Qo(),Ff(),n.route==="intro"?Of():Rn({reset:!0}),pg(),xk(),Zo(),nl(),await oh(),h(),await dh(),Vy(),n.route==="terminal"&&(en({silent:!0,ifStale:!0,reason:"site-load"}).catch(e=>T(e.message)),n.activeTab==="ogreTek"&&await Lr({silent:!0}).catch(e=>T(e.message)),h({preserveSmartChartFrame:n.activeTab==="smartChart"}))}Wk();function xt(e){n.pumpLiveStatus=e,n.pumpLiveLastActionAt=Date.now(),h()}function _k(){const e=typeof collectLaunchCoinDraft=="function"?collectLaunchCoinDraft():n.launchCoinDraft||{},t=uu(e);return{tokenMint:t,mint:t,address:t,name:e.name||e.tokenName||"Pump launch",symbol:e.symbol||e.ticker||"PUMP",dexId:"pumpfun",source:"pump-live",bonded:!1,isBonded:!1,bondingStatus:"pump"}}function Nk(e){const t=e.target.closest("[data-pump-live-action]");if(!t)return;e.preventDefault();const a=t.getAttribute("data-pump-live-action"),r=_k(),s=r.tokenMint;if(!s){xt("Paste or launch a CA first, then Pump Live can attach to it.");return}if(a==="chart"){typeof Tt=="function"?(Tt(r,{defaultTab:"chart",view:"chartTxns",source:"pump-live"}),xt("Opened Pump chart with transactions inside Slime.")):xt("Chart panel is still loading. Try again in a moment.");return}if(a==="copy"){const o=pu(s);navigator.clipboard?.writeText(o).then(()=>xt("Copied Pump Live stream route ID."),()=>xt("Stream route ID ready: "+o));return}if(a==="obs"){const o=Vi()?"Use the configured provider ingest URL for OBS or mobile live setup.":"Set PUMP_LIVE_PROVIDER plus ingest/playback envs before real video goes live.";xt(o);return}if(a==="end"){xt("Pump Live ended for this launch. Chart and transactions stay available.");return}if(a==="go"){if(!Vi()){xt("Pump Live UI is ready. Configure provider envs to enable real video without loading Render.");return}xt("Pump Live staged. Start the stream from your provider, OBS, or mobile app.")}}document.addEventListener("click",Nk);function Jt(e){const t=String(e??"");return typeof i=="function"?i(t):t.replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a])}function Dl(e){return e&&typeof e=="object"?e.token||e.pair||e.item||e:n.smartChartToken||{}}function Ul(e){return String(e.tokenMint||e.mint||e.address||e.pairAddress||e.poolAddress||e.baseMint||e.ca||"").trim()}function Dk(e){const t=String(e||"");return t.length>14?`${t.slice(0,6)}...${t.slice(-6)}`:t}function To(e){if(typeof e=="number")return Number.isFinite(e)?e:NaN;if(e==null||e==="")return NaN;const t=Number(String(e).replace(/[$,%\s,]/g,""));return Number.isFinite(t)?t:NaN}function xm(e){const t=[e.priceUsd,e.priceUSD,e.usdPrice,e.tokenPriceUsd,e.price,e.close,e.c,e.marketCap,e.mc,e.fdv,e.liquidityUsd];for(const a of t){const r=To(a);if(Number.isFinite(r)&&r>0)return r}return NaN}function Uk(e){const t=e.time||e.timestamp||e.blockTime||e.createdAt||e.updatedAt||e.date;if(!t)return Date.now();if(typeof t=="number")return t<1e11?t*1e3:t;const a=Number(t);if(Number.isFinite(a))return a<1e11?a*1e3:a;const r=Date.parse(t);return Number.isFinite(r)?r:Date.now()}function qk(e){return Array.isArray(e)?e:!e||typeof e!="object"?[]:e.items||e.rows||e.data||e.trades||e.transactions||[]}function Hk(e,t,a){if(!a.length)return!1;const r=[e.tokenMint,e.mint,e.address,e.pairAddress,e.poolAddress,e.baseMint,e.ca,e.symbol,e.baseSymbol,e.tokenSymbol,e.name,e.tokenName].map(s=>String(s||"").toLowerCase()).join(" ");return a.some(s=>r.includes(s))}function Kk(e=""){return String(e||"").split("").reduce((t,a)=>t*31+a.charCodeAt(0)>>>0,17)}function Vk(e={}){const t=[e.priceUsd,e.priceUSD,e.usdPrice,e.tokenPriceUsd,e.price,e.marketCap,e.marketCapUsd,e.mc,e.fdv,e.fdvUsd,e.liquidityUsd,e.liquidity?.usd,e.volume5m,e.volumeM15,e.volumeH1,e.volumeH24,e.volume?.m5,e.volume?.h1,e.volume?.h24].map(To).filter(s=>Number.isFinite(s)&&s>0);if(t.length)return t[0];const a=typeof Vt=="function"?Number(Vt(e)):NaN;if(Number.isFinite(a)&&a>0)return Math.max(1,a*1e3);const r=Number(e.ageMinutes||e.pairAgeMinutes||e.launchAgeMinutes||0);return Math.max(1,r||1)}function N0(e){const t=Dl(e),a=Ul(t)||t.symbol||t.name||"slime",r=Vk(t),s=Kk(a),o=Math.max(1,To(t.liquidityUsd||t.liquidity?.usd)||r),c=Math.max(0,To(t.volume5m||t.volumeM15||t.volumeH1||t.volume?.m5||t.volume?.h1)||0),l=typeof Vt=="function"?Math.max(0,Math.min(100,Number(Vt(t))||0)):0,d=Math.max(-8,Math.min(18,c/o*18+l/12)),u=Date.now();return Array.from({length:34},(p,f)=>{const y=(f+s%13)/4.2,b=Math.sin(y)*(3.5+s%7*.28),v=(f/33-.5)*d,P=((s>>f%11&7)-3)*.32,A=Math.max(1e-7,r*(1+(b+v+P)/100));return{row:{...t,snapshotFallback:!0},value:A,time:u-(33-f)*15e3,side:"snapshot"}})}function Mm(e){const t=Dl(e),a=[Ul(t),t.symbol,t.baseSymbol,t.name].map(c=>String(c||"").trim().toLowerCase()).filter((c,l,d)=>c.length>=3&&d.indexOf(c)===l),r=[{direct:!0,rows:t.candles},{direct:!0,rows:t.chartCandles},{direct:!0,rows:t.priceHistory},{direct:!0,rows:t.trades},{direct:!0,rows:t.transactions},{direct:!0,rows:t.recentTrades},{direct:!0,rows:t.sourceEvents},{direct:!1,rows:n.liveTrades},{direct:!1,rows:n.liveTradeRows},{direct:!1,rows:n.tradeTape},{direct:!1,rows:n.recentTrades},{direct:!1,rows:n.pumpTrades},{direct:!1,rows:n.pumpActivity},{direct:!1,rows:n.livePairs},{direct:!1,rows:n.livePairsRows},{direct:!1,rows:n.freshPairs},{direct:!1,rows:n.slimeScopePairs}],s=[];for(const c of r){const l=qk(c.rows).slice(-350);for(const d of l){if(!d||typeof d!="object"||!c.direct&&!Hk(d,t,a))continue;const u=xm(d);if(!Number.isFinite(u)||u<=0)continue;const p=String(d.side||d.type||d.action||d.tradeType||"").toLowerCase();s.push({row:d,value:u,time:Uk(d),side:p.includes("sell")?"sell":p.includes("buy")?"buy":"trade"})}}const o=xm(t);return Number.isFinite(o)&&o>0&&s.push({row:t,value:o,time:Date.now(),side:"snapshot"}),s.sort((c,l)=>c.time-l.time).filter((c,l,d)=>l===0||c.time!==d[l-1].time||c.value!==d[l-1].value).slice(-120)}function Ao(e){return Number.isFinite(e)?e>=1e6?`$${(e/1e6).toFixed(e>=1e7?1:2)}M`:e>=1e3?`$${(e/1e3).toFixed(e>=1e4?1:2)}K`:e>=1?`$${e.toFixed(e>=100?0:3)}`:`$${e.toPrecision(3)}`:"n/a"}function zk(){const e=String(n.pumpChartSource||"slime").toLowerCase();return e==="pump"||e==="dex"?e:"slime"}function jk(e={},t={}){const a=Dl(e),r=Ul(a),s=zk(),o=String(n.pumpChartMode||"line").toLowerCase()==="candles"?"candles":"line",c=String(n.pumpChartTimeframe||"5m"),d=Mm(a).slice(-70),u=!d.length||d.every(q=>q.side==="snapshot"||q.row?.snapshotFallback),p=d.map(q=>q.value),f=p.length?Math.min(...p):NaN,y=p.length?Math.max(...p):NaN,b=720,v=260,P=22,A=Number.isFinite(y-f)&&y!==f?y-f:1,g=q=>d.length<=1?b/2:P+q/(d.length-1)*(b-P*2),$=q=>v-P-(q-(Number.isFinite(f)?f:0))/A*(v-P*2),C=d.map((q,Oe)=>`${Oe?"L":"M"}${g(Oe).toFixed(1)},${$(q.value).toFixed(1)}`).join(" "),B=d.length>1?`${C} L${g(d.length-1).toFixed(1)},${v-P} L${g(0).toFixed(1)},${v-P} Z`:"",U=Math.max(4,Math.min(12,(b-P*2)/Math.max(d.length*2,1))),H=d.map((q,Oe)=>{const Ue=(d[Math.max(0,Oe-1)]||q).value,Mt=q.value,Pn=Math.max(Ue,Mt),Bt=Math.min(Ue,Mt),Ba=g(Oe),Br=$(Ue),ee=$(Mt),Cn=$(Pn),Mo=$(Bt);return`<g class="slime-pump-candle ${Mt>=Ue?"up":"down"}"><line x1="${Ba.toFixed(1)}" y1="${Cn.toFixed(1)}" x2="${Ba.toFixed(1)}" y2="${Mo.toFixed(1)}" /><rect x="${(Ba-U/2).toFixed(1)}" y="${Math.min(Br,ee).toFixed(1)}" width="${U.toFixed(1)}" height="${Math.max(2,Math.abs(ee-Br)).toFixed(1)}" rx="2" /></g>`}).join(""),Se=r?`https://dexscreener.com/solana/${encodeURIComponent(r)}?embed=1&theme=dark&trades=1&info=0`:"",De=s==="dex"&&Se?`<iframe class="slime-pump-dex-frame" src="${Jt(Se)}" title="Dex chart" loading="lazy"></iframe>`:d.length>1?`<svg class="slime-pump-svg" viewBox="0 0 ${b} ${v}" preserveAspectRatio="none"><defs><linearGradient id="slimePumpArea" x1="0" x2="0" y1="0" y2="1"><stop offset="0%" stop-color="#7cff4f" stop-opacity="0.34"/><stop offset="100%" stop-color="#7cff4f" stop-opacity="0.02"/></linearGradient></defs><path class="slime-pump-area" d="${B}" />${o==="candles"?H:`<path class="slime-pump-line" d="${C}" />`}</svg>`:`<div class="slime-pump-wait"><strong>Waiting for live feed</strong><span>${s==="pump"?"Pump pre-bonding ticks":"Slime live ticks"} will draw here from real feed data only.</span></div>`;return`
  ...
  `,document.head.appendChild(e)}function Co(){if(I.root)return I.root;e0();const e=document.createElement("div");return e.setAttribute("data-trailer-overlay",""),e.style.cssText="position:fixed;inset:0;z-index:99999;pointer-events:none;font-family:Inter,system-ui,sans-serif;",e.innerHTML=`
  ...
  `,e.querySelector("[data-trailer-stop]").addEventListener("click",()=>Hl("stopped")),document.body.appendChild(e),I.root=e,e}function Lo(){const e=Co().querySelector("[data-trailer-flash]");e.style.animation="none",e.offsetWidth,e.style.animation="twFlash 0.55s ease-out forwards"}function xo(e,t=""){const a=Co(),r=a.querySelector("[data-trailer-caption]");a.querySelector("[data-trailer-caption-main]").textContent=e,a.querySelector("[data-trailer-caption-sub]").textContent=t,e?(r.style.animation="none",r.offsetWidth,r.style.animation="twCapIn 0.5s cubic-bezier(0.2,1.4,0.4,1) forwards",r.style.opacity="1"):r.style.opacity="0"}function Mr(e){const t=Co().querySelector("[data-trailer-center]");if(!e){t.style.display="none",t.innerHTML="";return}t.innerHTML=e,t.style.display="flex"}function t0(){const e=["video/mp4;codecs=avc1.64001f,mp4a.40.2","video/mp4","video/webm;codecs=vp9,opus","video/webm"];for(const t of e)try{if(MediaRecorder.isTypeSupported(t))return t}catch{}return"video/webm"}async function a0(){if(!navigator.mediaDevices?.getDisplayMedia||!window.MediaRecorder)return!1;try{const e=await navigator.mediaDevices.getDisplayMedia({video:{frameRate:30},audio:!1,preferCurrentTab:!0,selfBrowserSurface:"include"});I.stream=e;const t=[...e.getVideoTracks()],a=I.audio?.dest?.stream?.getAudioTracks()||[];t.push(...a);const r=new MediaStream(t);I.mime=t0(),I.chunks=[];const s=new MediaRecorder(r,{mimeType:I.mime,videoBitsPerSecond:6e6});return s.ondataavailable=o=>{o.data?.size&&I.chunks.push(o.data)},s.start(1e3),I.recorder=s,e.getVideoTracks()[0]?.addEventListener("ended",()=>Hl("screen-share-ended")),!0}catch{return!1}}function n0(e){const t=I.mime.includes("mp4")?"mp4":"webm",a=`slimewire-trailer-${new Date().toISOString().replace(/[:.]/g,"-").slice(0,19)}.${t}`,r=URL.createObjectURL(e),s=document.createElement("div");s.setAttribute("data-trailer-result",""),s.style.cssText="position:fixed;inset:0;z-index:100000;background:rgba(2,7,2,0.94);display:flex;align-items:center;justify-content:center;padding:18px;font-family:Inter,system-ui,sans-serif;",s.innerHTML=`
  ...
  `,s.querySelector("[data-trailer-close]").addEventListener("click",()=>{s.remove(),setTimeout(()=>URL.revokeObjectURL(r),5e3)}),s.querySelector("[data-trailer-share]").addEventListener("click",async()=>{try{const o=new File([e],a,{type:I.mime.split(";")[0]});if(navigator.canShare?.({files:[o]})){await navigator.share({files:[o],title:"SlimeWire",text:"SlimeWire - verify before you ape. slimewire.org"});return}}catch{}s.querySelector("a[download]")?.click()}),document.body.appendChild(s)}function r0(){const e=I.recorder;if(!e)return;const t=()=>{try{const a=new Blob(I.chunks,{type:I.mime.split(";")[0]});a.size>0&&n0(a)}catch{}};if(e.state!=="inactive"){e.addEventListener("stop",t,{once:!0});try{e.stop()}catch{t()}}else t();I.stream?.getTracks().forEach(a=>{try{a.stop()}catch{}}),I.recorder=null,I.stream=null}function Hl(e="done"){if(I.running){I.running=!1,I.timers.forEach(t=>clearTimeout(t)),I.timers=[],r0();try{I.audio?.ctx?.close()}catch{}I.audio=null,I.root?.remove(),I.root=null}}function s0(){const e=n.livePairsByBucket?.live?.rows||n.livePairs?.rows||n.livePairRows||[];return[...e].filter(a=>a?.tokenMint).sort((a,r)=>(Number(r.volume5m)||0)-(Number(a.volume5m)||0)||(Number(r.bestPickScore||r.score)||0)-(Number(a.bestPickScore||a.score)||0))[0]||e[0]||null}async function o0(e=9e3){const t=Date.now();for(;Date.now()-t<e;){const a=s0();if(a)return a;if(!I.running)return null;await Ma(500)}try{return((await k("/api/web/live-pairs?bucket=live&sort=fresh"))?.livePairs?.rows||[]).find(s=>s?.tokenMint)||null}catch{return null}}async function i0(e,t=4e3){const a=Date.now();for(;Date.now()-a<t;){if(document.querySelector(e))return!0;if(!I.running)return!1;await Ma(250)}return!1}function l0(){return new Promise(e=>{Mr(`
    ...
    `),I.root.querySelector("[data-trailer-go]")?.addEventListener("click",()=>e(!0),{once:!0})})}async function c0(){if(I.running)return;I.running=!0,Co(),Jk();const e=await a0(),t=Xk();if(!e&&(await l0(),!I.running))return;Pe("/terminal/live-pairs"),Mr('<div style="color:#72ff23;font-weight:900;font-size:clamp(18px,5vw,24px);animation:twPulse 1.2s infinite;">locking onto live pairs...</div>');const a=await o0(9e3);if(!I.running)return;const r=3,s=6.5,o=9,c=6.5,l=4.6,d=[r,r+s,r+s+o,r+s+o+c],u=r+s+o+c+l;Zk(d,u);const f=(I.audio?.ctx?.currentTime||0)+.05;for(let b=0;b<r;b+=1)Qk(f+b,600+b*90);for(let b=r;b>=1;b-=1){if(!I.running)return;Mr(`<div style="color:#72ff23;font-size:clamp(64px,22vw,110px);font-weight:900;text-shadow:0 0 30px rgba(114,255,35,0.75);animation:twPulse 1s infinite;">${b}</div>`),await Ma(1e3)}if(Mr(""),!I.running)return;Lo(),xo("FRESH PAIRS. SECONDS OLD.","every pump.fun launch lands here instantly"),await Ma(s*1e3);const y=a?.symbol?`$${String(a.symbol).slice(0,12)}`:"live pair";if(I.running&&a?.tokenMint){Lo(),Pe(`/terminal/chart?token=${encodeURIComponent(a.tokenMint)}`);const b=await i0("iframe[src*='dexscreener'], .smart-chart-terminal iframe, [data-chart] canvas",4500);if(!I.running||(xo("CHARTS WITH A BRAIN",`${y} - live candles, live flow, shield verdict on top`),await Ma((b?o:4)*1e3),!I.running))return;Lo(),Ep(a.tokenMint),xo("TRIPLE-ENGINE RUG CHECK","SlimeShield x Rugcheck x GoPlus - dodge the rug BEFORE you ape"),await Ma(c*1e3),vl()}I.running&&(xo(""),Lo(),Mr(`
  ...
  `),await Ma(l*1e3),Hl("done"))}document.addEventListener("click",e=>{e.target instanceof Element&&e.target.closest("[data-trailer-mode]")&&(e.preventDefault(),I.running||c0())});
