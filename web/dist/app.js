...
`)}function me(e){e&&(n.user=e,Object.prototype.hasOwnProperty.call(e,"xHandle")?(n.xHandle=Je(e.xHandle),n.xHandle?jl(n.xHandle):To()):n.xHandle||(n.xHandle=zl()))}function _r(e){for(const t of e){const a=Rn(t);if(a&&!a.closest("[hidden]"))return String(a.value||"")}for(const t of e){const a=m(t);if(a)return String(a.value||"")}return""}function Bn(){const e=m("[data-connect-status]");return e&&!e.closest("[hidden]")?e:Rn("[data-login-status]")||e}function Rn(e){const t=[...document.querySelectorAll(e)];return t.find(a=>!a.closest("[hidden]")&&a.offsetParent!==null)||t.find(a=>!a.closest("[hidden]"))||t[0]||null}function In(){return Rn("[data-wallet-connect-modal] [data-wallet-connect-status]")||Rn("[data-wallet-connect-status]")}function re(e=""){n.walletConnectStatus=String(e||""),v(In(),n.walletConnectStatus)}function fc(e="solana"){const t=Fe(e);return Ve()?En(e)?`${t} is not injected in this browser. Tap Open ${t} to use the mobile wallet connect flow, or choose another wallet option.`:Sc(e)?`${t} is not injected in this browser. Use Open ${t} to continue in the wallet app, or choose another wallet option.`:`${t} is not available in this browser. Install or open the wallet app, or choose another wallet option.`:`${t} extension not found. Install or unlock ${t}, or choose another wallet.`}function It(e="solana",t=null,a={}){const r=fe(e),s={walletName:Fe(e,r),userId:n.user?.id||"",route:n.route,adapterReadyState:r?"detected":"not_detected",errorName:t?.name||"",errorMessage:String(t?.message||t||"").slice(0,240),...a};try{console.warn("[slimewire_wallet_connect]",s)}catch{}}function hc(e=n.route==="connect"){window.setTimeout(()=>{const t=n.loginModalOpen?`[data-login-modal-${n.loginModalTab==="create"?"create":"login"}-section] [data-login-username], [data-login-modal-${n.loginModalTab==="create"?"create":"login"}-section] [data-login-password]`:e?"[data-connect-login-username], [data-connect-login-password]":"[data-login-username], [data-login-password]";Rn(t)?.focus?.()},0)}function If(){const e=document.activeElement;e instanceof HTMLElement&&!e.closest("[data-login-modal]")&&(Po=e)}function Of(){const e=Po;Po=null,window.setTimeout(()=>{e?.isConnected&&typeof e.focus=="function"&&e.focus({preventScroll:!0})},0)}function gc({restoreFocus:e=!0}={}){const t=!!n.loginModalOpen;n.loginCollapsed=!0,n.loginModalOpen=!1,h({force:!0}),t&&e&&Of()}function Ef(){return!Pe||Pe.hidden||!n.loginModalOpen?[]:[...Pe.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')].filter(e=>!e.closest("[hidden]")&&e.offsetParent!==null)}function Ff(e){if(!n.loginModalOpen||e.key!=="Tab"||!Pe||Pe.hidden)return!1;const t=Ef();if(!t.length)return!1;const a=t[0],r=t[t.length-1];return e.shiftKey&&document.activeElement===a?(e.preventDefault(),r.focus({preventScroll:!0}),!0):!e.shiftKey&&document.activeElement===r?(e.preventDefault(),a.focus({preventScroll:!0}),!0):!1}function ja(){try{return`${window.location.pathname||"/terminal"}${window.location.search||""}${window.location.hash||""}`}catch{return"/terminal"}}function Wf(e=ja()){return`/login?returnTo=${encodeURIComponent(e||"/terminal")}`}function bc(e="",t=80){return String(e||"").replace(/[\r\n\t]+/g," ").replace(/[^\w .:/?&=#@-]/g,"").trim().slice(0,t)}function _f(e="unknown"){const t=Date.now();if(t-Number(n.lastLockInClickAt||0)<300)return;n.lastLockInClickAt=t;const a={route:bc(n.route||Ka(),40),viewport:Math.round(window.innerWidth||0),source:bc(e,60),at:new Date(t).toISOString()};try{const r=JSON.parse(window.localStorage?.getItem("slimewireLockInClicks")||"[]");r.push(a),window.localStorage?.setItem("slimewireLockInClicks",JSON.stringify(r.slice(-10)))}catch{}try{console.info("LOCK_IN_CLICKED",a)}catch{}try{k("/api/web/lock-in-clicked",{method:"POST",timeoutMs:3e3,body:JSON.stringify(a)}).catch(()=>{})}catch{}}function yc({defaultTab:e="login",returnTo:t=ja(),source:a="unknown",connectPanel:r=n.route==="connect"}={}){if(If(),_f(a),n.loginModalOpen=!0,n.loginModalTab=e==="create"?"create":"login",n.loginReturnTo=t||ja(),n.loginCollapsed=!1,n.walletConnectMenuOpen=!1,!Pe&&!No){window.location.assign(Wf(n.loginReturnTo));return}h({force:!0}),hc(r)}function vc(e={}){yc(e)}function Ve(){return/Android|iPhone|iPad|iPod/i.test(navigator.userAgent||"")}function wc(){try{const e=new URL(window.location.href);return e.hash="",e.toString()}catch{return window.location.href}}function Nf(){try{return new URL(window.location.href).origin}catch{return"https://slimewire.org"}}function Sc(e=""){if(!Ve())return"";const t=encodeURIComponent(wc()),a=encodeURIComponent(Nf());return e==="phantom"?`https://phantom.app/ul/browse/${t}?ref=${a}`:e==="solflare"?`https://solflare.com/ul/v1/browse/${t}?ref=${a}`:""}function Yo(e=""){return e==="phantom"?"https://phantom.app/download":e==="solflare"?"https://solflare.com/download":e==="backpack"?"https://backpack.app/download":""}function Ga(e=""){return e==="phantom"?"./assets/slimewire/clean-ui/wallet_icons/default/phantom.png":e==="solflare"?"./assets/slimewire/clean-ui/wallet_icons/default/solflare.png":"./assets/slimewire/svg/icons/wallet.svg"}function Qo(e){const t=e instanceof Uint8Array?e:new Uint8Array(e||[]);if(!t.length)return"";let a=0n;for(const s of t)a=(a<<8n)+BigInt(s);let r="";for(;a>0n;){const s=Number(a%58n);r=Vl[s]+r,a/=58n}for(const s of t){if(s!==0)break;r="1"+r}return r||"1"}function Nr(e=""){const t=String(e||"").trim();if(!t)return new Uint8Array;let a=0n;for(const s of t){const o=Qm.get(s);if(o===void 0)throw new Error("Invalid wallet callback encoding.");a=a*58n+BigInt(o)}const r=[];for(;a>0n;)r.unshift(Number(a&255n)),a>>=8n;for(const s of t){if(s!=="1")break;r.unshift(0)}return new Uint8Array(r)}function Df(e="phantom",t="",a=n.walletConnectReturnPath||"/terminal",r=""){const s=new URL(a||window.location.pathname||"/terminal",window.location.origin);return s.searchParams.delete("sw_wallet"),s.searchParams.delete("sw_wallet_state"),s.searchParams.delete("sw_wallet_pending"),s.searchParams.delete("phantom_encryption_public_key"),s.searchParams.delete("solflare_encryption_public_key"),s.searchParams.delete("nonce"),s.searchParams.delete("data"),s.searchParams.delete("errorCode"),s.searchParams.delete("errorMessage"),s.searchParams.set("sw_wallet",e),s.searchParams.set("sw_wallet_state",t),r&&s.searchParams.set("sw_wallet_pending",r),s.toString()}function On(){try{const e=new URL(window.location.href);["sw_wallet","sw_wallet_state","sw_wallet_pending","phantom_encryption_public_key","solflare_encryption_public_key","nonce","data","errorCode","errorMessage"].forEach(t=>e.searchParams.delete(t)),window.history.replaceState({},"",`${e.pathname}${e.search}${e.hash}`)}catch{}}function kc(){try{const e=window.sessionStorage?.getItem(So)||window.localStorage?.getItem(ko)||"{}",t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function Uf(e){try{window.sessionStorage?.setItem(So,JSON.stringify(e))}catch{}try{window.localStorage?.setItem(ko,JSON.stringify(e))}catch{}}function Zo(){try{window.sessionStorage?.removeItem(So)}catch{}try{window.localStorage?.removeItem(ko)}catch{}}function $c(e=""){return e==="solflare"?"solflare_encryption_public_key":"phantom_encryption_public_key"}function En(e=""){return e==="phantom"?"https://phantom.app/ul/v1/connect":e==="solflare"?"https://solflare.com/ul/v1/connect":""}function qf(e="",t={}){const a=En(e);if(!a)return"";const r=new URL(a);return r.searchParams.set("app_url",wc()),r.searchParams.set("redirect_link",Df(e,t.stateId,t.returnPath,t.pendingConnectId)),r.searchParams.set("dapp_encryption_public_key",t.dappEncryptionPublicKey),r.searchParams.set("cluster","mainnet-beta"),r.toString()}function oa(){return/Android/i.test(navigator.userAgent||"")?"android":/iPhone|iPad|iPod/i.test(navigator.userAgent||"")?"ios":Ve()?"mobile":"desktop"}function Tc(e=""){return Ve()&&!!En(e)}function Hf(){const e=navigator.userAgent||"";return/CriOS|Chrome/i.test(e)?"chrome":/Safari/i.test(e)&&!/Chrome|CriOS/i.test(e)?"safari":/Firefox|FxiOS/i.test(e)?"firefox":"mobile-browser"}async function Kf(e="",t="/terminal"){try{const a=await k("/api/web/mobile-wallet/start",{method:"POST",timeoutMs:Sn,body:JSON.stringify({provider:e,intendedRoute:t,platform:oa(),browser:Hf()})});return!a.pendingConnectId||!a.stateId||!a.dappEncryptionPublicKey?null:{providerId:e,pendingConnectId:a.pendingConnectId,stateId:a.stateId,returnPath:a.intendedRoute||t,dappEncryptionPublicKey:a.dappEncryptionPublicKey,createdAt:Date.now(),expiresAt:a.expiresAt||"",serverManaged:!0}}catch(a){return It(e,a,{action:"mobile_connect_pending_start_failed",connectionFlow:"deeplink_connect",platform:oa()}),null}}function Vf(e="",t="/terminal"){if(!window.nacl?.box?.keyPair||!window.crypto?.getRandomValues)return null;const a=window.nacl.box.keyPair(),r=new Uint8Array(16);return window.crypto.getRandomValues(r),{providerId:e,stateId:Qo(r),returnPath:t,dappEncryptionPublicKey:Qo(a.publicKey),dappEncryptionSecretKey:Qo(a.secretKey),createdAt:Date.now(),serverManaged:!1}}async function Ac(e="",{returnPath:t=n.walletConnectReturnPath||"/terminal"}={}){if(!Tc(e))return!1;const a=await Kf(e,t)||Vf(e,t);if(!a)return!1;Uf(a);const r=qf(e,a);if(!r)return!1;const s=Fe(e);return re(`Opening ${s} mobile connect. Approve in the wallet app, then return to SlimeWire.`),It(e,null,{action:"mobile_connect_redirect",adapterReadyState:"mobile_redirect",connectionFlow:"deeplink_connect",platform:oa()}),window.location.assign(r),!0}function Pc(e=""){const t=Fe(e),a=Sc(e);return a?(re(`Opening ${t}. If mobile connect is unavailable, use the wallet browser and return to SlimeWire.`),It(e,null,{action:"mobile_browse_redirect",adapterReadyState:"mobile_browse",connectionFlow:"browse_fallback",platform:oa()}),window.location.href=a,!0):!1}function Cc({requirePassword:e=!1}={}){const t=_r(["[data-connect-login-username]","[data-login-username]"]).trim(),a=_r(["[data-connect-login-password]","[data-login-password]"]);if(!t&&!a&&!e)return{};if(!t)throw new Error("Enter your username.");if(!a)throw new Error("Enter your password.");return{username:t,password:a}}function zf(e=""){n.token="",n.user=null,n.loading=!1,$o(),h(),$(e||"Your web session expired. Log in, or tap Create Account to start a fresh session.")}async function Y(e=null,t="Creating secure web profile..."){if(n.user&&n.token)return n.user;v(e,t);const a=await k("/api/web/signup",{method:"POST",body:JSON.stringify({referralCode:Jl()})});return n.token=a.token,me(a.user),Tn(n.token),n.user}function $(e=""){[ff,hf].forEach(t=>{t&&(t.hidden=!e,v(t,e))})}function Q(e){const t=String(e||"").trim();return t?`https://dexscreener.com/solana/${encodeURIComponent(t)}`:"#"}function jf(e){const t=String(e||"").trim();return t?`https://pump.fun/coin/${encodeURIComponent(t)}`:"#"}function Lc(e){const t=String(e||"").trim();return t?`https://kolscan.io/account/${encodeURIComponent(t)}`:"https://kolscan.io"}async function ei(){$("");const e=Bn();try{const t=Cc();v(e,t.username?"Creating saved login...":"Creating account...");const a=await k("/api/web/signup",{method:"POST",body:JSON.stringify({...t,referralCode:Jl()})});n.token=a.token,me(a.user),Tn(n.token),n.loginCollapsed=!0,n.loginModalOpen=!1,n.activeTab="dashboard",v(e,t.username?"Account created. Login saved.":"Quick web account created."),K(a.trade?.signature,"account-create")}catch(t){v(e,t.message),$(t.message)}}async function xc(){$("");const e=Bn();try{const t=Cc({requirePassword:!0});v(e,"Logging in...");const a=await k("/api/web/password-login",{method:"POST",body:JSON.stringify(t)});n.token=a.token,me(a.user),Tn(n.token),n.loginCollapsed=!0,n.loginModalOpen=!1,n.activeTab="dashboard",v(e,"Logged in."),K(a.trade?.signature,"password-login")}catch(t){v(e,t.message),$(t.message)}}function Mc(){return _r(["[data-connect-login-email]","[data-login-email]"]).trim()}function Gf(){return _r(["[data-connect-login-code]","[data-login-code]"]).trim()}function Bc(e=""){const t=String(e||"").trim();if(!t)throw new Error("Enter the email saved on your web account.");if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t))throw new Error("Enter a valid email address.");return t}async function Xf(){$("");const e=Bn();try{const t=Bc(Mc());v(e,"Sending login code...");const a=await k("/api/web/email-code",{method:"POST",body:JSON.stringify({email:t})});v(e,a.emailSent?"Code sent. Check your email, then enter it here.":"Code requested. Check your email if delivery is configured.")}catch(t){v(e,t.message),$(t.message)}}async function Jf(){$("");const e=Bn();try{const t=Bc(Mc()),a=Gf();if(!a)throw new Error("Enter the login code from your email.");v(e,"Checking login code...");const r=await k("/api/web/login",{method:"POST",body:JSON.stringify({email:t,code:a})});n.token=r.token,me(r.user),Tn(n.token),n.loginCollapsed=!0,n.loginModalOpen=!1,n.activeTab="dashboard",v(e,"Logged in."),K(r.trade?.signature,"email-code-login")}catch(t){v(e,t.message),$(t.message)}}function Rc(e="",t=new URLSearchParams){const a=kc(),r=t.get("sw_wallet_state")||"";if(!a.stateId||a.stateId!==r||a.providerId!==e)throw new Error("Wallet callback did not match the pending SlimeWire connection.");if(Date.now()-Number(a.createdAt||0)>1200*1e3)throw new Error("Wallet connection expired. Open Connect Wallet and try again.");const s=t.get($c(e))||"",o=t.get("nonce")||"",c=t.get("data")||"";if(!s||!o||!c)throw new Error("Wallet approval did not return the expected connection data.");const l=window.nacl;if(!l?.box?.before||!l.box.open?.after)throw new Error("Mobile wallet connection helper did not load. Refresh and try again.");const u=l.box.before(Nr(s),Nr(a.dappEncryptionSecretKey)),d=l.box.open.after(Nr(c),Nr(o),u);if(!d)throw new Error("Unable to verify the wallet approval response.");const p=JSON.parse(new TextDecoder().decode(d)),f=String(p.public_key||p.publicKey||"").trim();if(!f)throw new Error("Wallet approved, but no public address was returned.");return{publicKey:f,session:String(p.session||""),walletEncryptionPublicKey:s,dappEncryptionPublicKey:a.dappEncryptionPublicKey,returnPath:a.returnPath||"/terminal"}}async function Ic(e="",t={}){const a=In();await Y(a,"Creating secure web profile for connected wallet...");const r=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({publicKey:t.publicKey,provider:Fe(e)})});me(r.user||{...n.user,connectedWallet:r.profile?.connectedWallet||null}),n.connectedWalletBalance={publicKey:t.publicKey,shortPublicKey:w(t.publicKey),provider:Fe(e),tokens:[]};try{window.sessionStorage?.setItem(`${Dm}${e}`,JSON.stringify({providerId:e,publicKey:t.publicKey,session:t.session,walletEncryptionPublicKey:t.walletEncryptionPublicKey,dappEncryptionPublicKey:t.dappEncryptionPublicKey,connectedAt:new Date().toISOString()}))}catch{}Zo(),On(),n.walletConnectMenuOpen=!1,re(`Connected ${w(t.publicKey)}. Opening Live Terminal...`),Te(t.returnPath||n.walletConnectReturnPath||"/terminal","terminal"),h({force:!0}),Ur("mobile-wallet-connect")}function Yf(e="",t=new URLSearchParams){return{provider:e,pendingConnectId:t.get("sw_wallet_pending")||kc().pendingConnectId||"",stateId:t.get("sw_wallet_state")||"",queryKeys:[...t.keys()].filter(a=>a!=="data"&&a!=="nonce"),walletEncryptionPublicKey:t.get($c(e))||"",nonce:t.get("nonce")||"",data:t.get("data")||"",errorCode:t.get("errorCode")||"",errorMessage:t.get("errorMessage")||""}}async function Qf(e="",t={}){t.token&&(n.token=t.token,Tn(n.token)),me(t.user||{...n.user,connectedWallet:t.connectedWallet||t.profile?.connectedWallet||null});const a=t.publicKey||t.connectedWallet?.publicKey||t.profile?.connectedWallet?.publicKey||"";a&&(n.connectedWalletBalance={publicKey:a,shortPublicKey:w(a),provider:t.provider||Fe(e),tokens:[]}),Zo(),On(),n.walletConnectMenuOpen=!1,re(a?`Connected ${w(a)}. Opening Live Terminal...`:"Wallet connected. Opening Live Terminal..."),Te(t.finalRedirectRoute||n.walletConnectReturnPath||"/terminal","terminal"),h({force:!0}),Ur("mobile-wallet-callback")}async function Oc(e="",t=new URLSearchParams){const a=await k("/api/web/mobile-wallet/callback",{method:"POST",timeoutMs:Sn,body:JSON.stringify(Yf(e,t))});return await Qf(e,a),!0}async function Zf(){const e=new URLSearchParams(window.location.search||""),t=e.get("sw_wallet")||"";if(!["phantom","solflare"].includes(t))return!1;n.walletConnectMenuOpen=!0;const a=Fe(t),r=e.get("sw_wallet_pending")||"",s=e.get("errorCode")||"",o=e.get("errorMessage")||"";if(s||o)return r&&await Oc(t,e).catch(()=>{}),Zo(),On(),re(`${a} did not connect: ${o||s||"request cancelled"}. Choose another wallet or try again.`),It(t,new Error(o||s||"Wallet connect cancelled"),{action:"mobile_connect_cancelled",connectionFlow:"deeplink_connect",platform:oa()}),h({force:!0}),!0;try{if(re(`Finishing ${a} mobile connection...`),r)await Oc(t,e);else{const c=Rc(t,e);await Ic(t,c)}}catch(c){if(r)try{const l=Rc(t,e);await Ic(t,l)}catch{re(`${a} mobile connection could not finish: ${c.message}`),It(t,c,{action:"mobile_connect_callback_failed",connectionFlow:"deeplink_connect",platform:oa()}),On(),h({force:!0})}else re(`${a} mobile connection could not finish: ${c.message}`),It(t,c,{action:"mobile_connect_callback_failed",connectionFlow:"deeplink_connect",platform:oa()}),On(),h({force:!0})}return!0}async function eh(){$("");const e=In()||Bn();try{v(e,"Choose a wallet provider to connect."),da({returnPath:"/terminal"})}catch(t){v(e,t.message),$(t.message)}}async function th(){n.user||await ei(),n.user&&(n.walletConnectMenuOpen=!1,n.route="terminal",n.activeTab="wallets",n.toolSections={...n.toolSections||{},wallets:n.wallets.length?"balances":"create"},window.history.pushState({},"","/terminal"),h(),n.wallets.length||await yd())}async function ah(){if(n.logoutPending)return;if(!n.user){n.loginCollapsed=!1,h(),Ln?.scrollIntoView?.({behavior:"smooth",block:"start"});return}await td("logging out");const e=String(n.token||"");n.logoutPending=!0;const t=m("[data-logout]");t&&(t.disabled=!0,v(t,"Logging out...")),n.token="",n.user=null,n.wallets=[],n.balances=[],n.positions=[],n.pnl=null,n.connectedWalletBalance=null,n.walletRefreshing=!1,n.walletRefreshStatus="idle",n.walletRefreshError="",n.positionRefreshAction={state:"idle",startedAt:0,minUntil:0,error:""},n.manualSellActions={},n.tradeActionLocks={},n.ogreAgentStatus="",Al(),$o(),h({force:!0});try{e&&await k("/api/web/logout",{method:"POST",headers:{Authorization:`Bearer ${e}`},timeoutMs:4e3,dedupe:!1})}catch{}finally{n.logoutPending=!1}}async function nh(){if(!n.token){h();return}try{const e=await k("/api/web/me");me(e.user),h({preserveSmartChartFrame:n.activeTab==="smartChart"}),De({force:!1,deep:!1,reason:"session-load"}).catch(t=>{n.walletRefreshError=t.message||"Wallet refresh failed.",h({preserveSmartChartFrame:n.activeTab==="smartChart"})})}catch{n.token="",$o(),h()}}async function ia(e={}){const t=L();if(!n.user||!n.token){n.wallets=[],n.balances=[],n.positions=[],n.pnl=null,n.connectedWalletBalance=null,n.launchWatches=[],n.presets={trade:[],bundle:[]},n.tradePlans=[],n.watchlist={rows:[],count:0},h();return}const a=!e.silent;a&&(n.loading=!0,h());try{const r=e.force?"?force=true":"";if(e.skipCore){const[y,g,S,A,T]=await Promise.all([k("/api/web/pnl"),k("/api/web/launch/watches"),k("/api/web/presets"),k("/api/web/watchlist"),k("/api/web/trade/plans")]);n.pnl=y.pnl||null,n.launchWatches=g.watches||[],n.presets=S.presets||{trade:[],bundle:[]},Wd(),n.watchlist=A.watchlist||{rows:[],count:0},n.tradePlans=T.plans||[],hs();return}const[s,o,c,l,u,d,p,f]=await Promise.all([k("/api/web/wallets"),k(`/api/web/balances${r}`),k(`/api/web/positions${r}`),k("/api/web/pnl"),k("/api/web/launch/watches"),k("/api/web/presets"),k("/api/web/watchlist"),k("/api/web/trade/plans")]);n.wallets=s.wallets||[],n.balances=o.balances||[],n.connectedWalletBalance=o.connectedWallet||c.connectedWallet||null,n.positions=c.positions||[],n.pnl=l.pnl||null,n.launchWatches=u.watches||[],n.presets=d.presets||{trade:[],bundle:[]},Wd(),n.watchlist=p.watchlist||{rows:[],count:0},n.tradePlans=f.plans||[],hs(),e.force&&(n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshError="")}finally{H("load-all",t,{component:"wallet",resultCount:(n.balances?.length||0)+(n.positions?.length||0),details:e.skipCore?"skip-core":"core"}),a&&(n.loading=!1),h()}}async function ti(e={}){if(!n.user||!n.token)return;const t=L(),a=e.requestId||0,r=()=>a&&n.walletRefreshRequestId!==a,s=e.force?"?force=true":"",o=e.force||e.deep?"?force=true":"",c=e.timeoutMs||Sn,l=k("/api/web/wallets",{timeoutMs:c}),u=k(`/api/web/balances${s}`,{timeoutMs:c}),d=k("/api/web/trade/plans",{timeoutMs:c}),p=await u;if(r())return;n.balances=p.balances||[],n.connectedWalletBalance=p.connectedWallet||null,n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshError="",H("wallet-refresh",t,{component:"wallet",resultCount:n.balances.length,cacheHit:!!p.cacheHit,details:`wallets=${n.wallets.length};connected=${!!n.connectedWalletBalance}`}),e.progress!==!1&&h({preserveSmartChartFrame:!!e.preserveSmartChartFrame});const[f,y]=await Promise.all([l.then(g=>({ok:!0,wallets:g})).catch(g=>({ok:!1,error:g})),d.then(g=>({ok:!0,tradePlans:g})).catch(g=>({ok:!1,error:g}))]);if(!r()&&(f.ok&&(n.wallets=f.wallets.wallets||n.wallets||[]),y.ok&&(n.tradePlans=y.tradePlans.plans||n.tradePlans||[],hs()),e.progress!==!1&&(f.ok||y.ok)&&h({preserveSmartChartFrame:!!e.preserveSmartChartFrame}),e.deep)){const g=L(),S=k(`/api/web/positions${o}`,{timeoutMs:c}).catch(A=>({__error:A}));try{const A=await S;if(A?.__error)throw A.__error;if(r())return;n.connectedWalletBalance=A.connectedWallet||n.connectedWalletBalance||null,n.positions=A.positions||[],n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshError="",H("positions-refresh",g,{component:"positions",resultCount:n.positions.length,cacheHit:!!A.cacheHit,details:`open=${n.positions.length}`})}catch(A){n.walletRefreshError=A.message||"Position refresh failed.",H("positions-refresh",g,{errorCode:A?.code||A?.name||"POSITIONS_REFRESH_FAILED",component:"positions",details:N(A?.message||"Position refresh failed.")})}}}function Ec(e=n.positions){return(Array.isArray(e)?e:[]).some(t=>{const a=t?.estimatedValueSol!==null&&t?.estimatedValueSol!==void 0&&t?.estimatedValueSol!=="";return!!(t?.valuePending||!a&&/refreshing|updating|background/i.test(t?.valueError||""))})}function Fc(e=120,t="positions-value-followup"){!n.user||!n.token||(Mr&&window.clearTimeout(Mr),Mr=window.setTimeout(()=>{Mr=null,yt({force:!0,fast:!1,silent:!0,followUpValues:!1,reason:t,timeoutMs:Yt}).then(a=>{a?(n.lastWalletRefreshAt=new Date().toISOString(),h({preserveSmartChartFrame:n.activeTab==="smartChart"})):Dr(`${t}-failed`)}).catch(()=>Dr(`${t}-failed`))},Math.max(0,Number(e)||0)))}function rh(e=[],t=[],a={}){const r=new Map((Array.isArray(t)?t:[]).map(s=>[String(s?.tokenMint||""),s]));return(Array.isArray(e)?e:[]).map(s=>{const o=r.get(String(s?.tokenMint||""));if(!o||a.fast===!1)return s;const c=!!(s?.valuePending||/refreshing|updating|background/i.test(s?.valueError||"")),l=o.estimatedValueSol!==null&&o.estimatedValueSol!==void 0&&o.estimatedValueSol!=="";return!c||!l?s:{...s,estimatedValueSol:o.estimatedValueSol,openPnlSol:o.openPnlSol,openPnlPercent:o.openPnlPercent,valuePending:!1,valueError:""}})}function Dr(e="positions-value-refresh-delayed"){let t=!1;return n.positions=(Array.isArray(n.positions)?n.positions:[]).map(a=>{const r=a?.estimatedValueSol!==null&&a?.estimatedValueSol!==void 0&&a?.estimatedValueSol!=="";return!(a?.valuePending||/refreshing|updating|background/i.test(a?.valueError||""))?a:(t=!0,{...a,valuePending:!1,valueError:r?"":"Price refresh delayed; tap Refresh."})}),t?(H("positions-value-refresh-cleanup",L(),{component:"positions",details:e}),h({preserveSmartChartFrame:n.activeTab==="smartChart"}),!0):!1}function Wc(e="portfolio-supplemental"){if(!n.user||!n.token)return;const t=L();Promise.allSettled([k("/api/web/balances?force=true",{timeoutMs:Yt}),k("/api/web/pnl?force=true",{timeoutMs:Yt,dedupe:!1})]).then(([a,r])=>{a.status==="fulfilled"&&(n.balances=a.value.balances||n.balances||[],n.connectedWalletBalance=a.value.connectedWallet||n.connectedWalletBalance||null),r.status==="fulfilled"&&(n.pnl=r.value.pnl||n.pnl||null),n.lastWalletRefreshAt=new Date().toISOString(),H("portfolio-supplemental-refresh",t,{component:"wallet",resultCount:(n.balances?.length||0)+(n.positions?.length||0),details:e}),h({preserveSmartChartFrame:n.activeTab==="smartChart"})}).catch(()=>{})}async function yt(e={}){if(!n.user||!n.token)return;const t=L(),a=new URLSearchParams;e.force&&a.set("force","true"),e.fast!==!1&&a.set("fast","true");const r=a.toString()?`?${a.toString()}`:"",s=r||"full";if(Cn&&Co===s)return Cn;const o=++Lo;return Co=s,Cn=(async()=>{try{const c=await k(`/api/web/positions${r}`,{timeoutMs:e.timeoutMs||(e.fast===!1?Yt:wo)});return Lo!==o?!1:(n.connectedWalletBalance=c.connectedWallet||n.connectedWalletBalance||null,n.positions=rh(c.positions||n.positions||[],n.positions||[],e),n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshError="",H("positions-refresh",t,{component:"positions",resultCount:n.positions.length,cacheHit:!!c.cacheHit,details:`${e.reason||(e.silent?"silent":"refresh")};fast=${e.fast!==!1}`}),e.followUpValues&&e.fast!==!1&&Ec(n.positions)&&Fc(120,`${e.reason||"positions"}-values`),e.syncPnl&&Wc(`${e.reason||"positions"}-sync-pnl`),!0)}catch(c){return e.silent||(n.walletRefreshError=c.message||"Position refresh failed."),H("positions-refresh",t,{errorCode:c?.code||c?.name||"POSITIONS_REFRESH_FAILED",component:"positions",details:N(c?.message||"Position refresh failed.")}),!1}finally{Lo===o&&(Cn=null,Co="")}})(),Cn}async function sh(e={}){if(!n.user||!n.token){$("Connect your wallet before refreshing positions."),Ke("error",{error:"Wallet not connected"});return}const t=L();za("refreshing",{startedAt:n.positionRefreshAction?.startedAt||t}),n.walletRefreshError="",Ie("[data-sync-health]",jr()),le(),await Le(20);try{if(!await yt({force:!!e.force,fast:!1,silent:!1,followUpValues:!1,reason:e.reason||"positions-only",timeoutMs:Yt}))throw new Error(n.walletRefreshError||"Position refresh failed.");n.lastWalletRefreshAt=new Date().toISOString(),Ke("success",{error:""}),Wc(`${e.reason||"positions-only"}-balances-pnl`),Ec(n.positions)&&Fc(120,`${e.reason||"positions-only"}-full-values`),H("positions-only-refresh",t,{component:"positions",resultCount:n.positions.length,details:e.reason||"positions-only"})}catch(a){const r=a?.message||"Position refresh failed.";n.walletRefreshError=r,Ke("error",{error:N(r)}),$(r),H("positions-only-refresh",t,{errorCode:a?.code||a?.name||"POSITIONS_REFRESH_FAILED",component:"positions",details:N(r)})}finally{h()}}function Fn(){return String(n.smartChartToken||n.tradeToken||n.bundleToken||n.volumeToken||n.terminalToken||"").trim()}function ze(e=n.activeTab){return Sf[e]||null}function Xa(e=ze()){return String(e?.cacheKey||e?.tabKey||"terminal:unknown").replace("{bucket}",Dn(n.livePairBucket)).replace("{sort}",String(n.terminalSort||"best")).replace("{scopeMode}",String(n.slimeScopeMode||"new")).replace("{kolMode}",String(n.kolMode||"hot")).replace("{kolWallet}",n.kolWallet?w(n.kolWallet):"global").replace("{scanMode}",String(n.scanMode||"safe")).replace("{tokenMint}",Fn()?w(Fn()):"none")}function _c(e=n.activeTab,t="pageSize",a=25){const r=ze(e),s=Number(r?.[t]);return Number.isFinite(s)&&s>0?s:a}function Ja(e=n.activeTab){return _c(e,"pageSize",25)}function ai(e=n.activeTab){return Math.max(Ja(e),_c(e,"maxPageSize",Ja(e)))}function Nc(e=n.activeTab){return!!ze(e)?.supportsPagination}function ni(e=n.activeTab){const t=ze(e)||{tabKey:e};return`${e}:${Xa(t)}`}function Wn(e=n.activeTab,t=0){const a=ni(e),r=Ja(e),s=ai(e),o=Number(n.terminalFeedVisibleLimits?.[a]||0),c=Number.isFinite(o)&&o>0?o:r,l=Number(t||0),u=Math.min(Math.max(r,c),s);return l>0?Math.min(u,l):u}function Z(e=n.activeTab){const t=ni(e);if(!n.terminalFeedVisibleLimits?.[t])return;const a={...n.terminalFeedVisibleLimits||{}};delete a[t],n.terminalFeedVisibleLimits=a}function oh(e=n.activeTab,t=0){const a=ni(e),r=Wn(e,t),s=Ja(e),o=ai(e),c=Number(t||0),l=Math.min(o,c>0?c:o,r+s);return n.terminalFeedVisibleLimits={...n.terminalFeedVisibleLimits||{},[a]:l},l}function nt(e=n.activeTab,t=[]){const a=Array.isArray(t)?t:[];return a.slice(0,Wn(e,a.length))}function ih(e=n.activeTab,t=[]){const a=Array.isArray(t)?t:[];return Nc(e)&&a.length>Wn(e,a.length)}function la(e=n.activeTab,t=[],a="rows"){const r=Array.isArray(t)?t:[];if(!ih(e,r))return"";const s=Wn(e,r.length);return`
  ...
  `}function z(e=n.activeTab){return n.terminalFeeds[e]||{}}function Dc(e=n.activeTab){return e==="live"||e==="terminal"||e==="slimeScope"?ca():e==="kol"?n.kolLastUpdatedAt||"":e==="watchlist"?z("watchlist").lastFetchAt||"":["wallets","positions","trade","bundle","volume","smartChart"].includes(e)?n.lastWalletRefreshAt||z(e).lastFetchAt||"":z(e).lastFetchAt||""}function Ot(e=n.activeTab){return e==="terminal"?Number(Ne()?.rows?.length||0)+Number(n.kolScan?.rows?.length||0):e==="live"?Number(Ne()?.rows?.length||0):e==="liveTrades"?Number(n.pnl?.trades?.length||0):e==="slimeScope"?Number(kp?.(n.slimeScopeMode)?.length||0):e==="kol"?Number(n.kolScan?.rows?.length||0):e==="watchlist"?Number(n.watchlist?.rows?.length||0):e==="smartChart"?Fn()?1:Number(cr?.()?.length||0):e==="trade"||e==="bundle"||e==="volume"?Fn()?1:0:e==="sniper"?Number(n.scan?.rows?.length||0):e==="launch"||e==="launchCoin"?Number(n.launchWatches?.length||0):e==="wallets"?Number(n.wallets?.length||0)+Number(n.balances?.length||0):e==="positions"?Number(n.positions?.length||0):e==="pnl"?Number(n.pnl?.trades?.length||0):e==="ogreAi"?n.ogreAiResult?1:0:e==="ogreTek"?Number(n.ogreTek?.markets?.length||0)+Number(n.ogreTek?.positions?.length||0):0}function _n(e=n.activeTab){const t=Ot(e);return["live","liveTrades","slimeScope","kol","watchlist","sniper"].includes(e)?Math.min(t,Wn(e,t)):t}function Nn(e=n.activeTab){const t=ze(e);if(!t)return!1;const a=Date.parse(Dc(e)||"");return Number.isFinite(a)?Date.now()-a>Number(t.staleMs||3e4):!0}function Uc(e=n.activeTab){return Ot(e)>0||!!Dc(e)}function lh(e=n.activeTab,t={}){const a=ze(e)||{};return{tabKey:e,label:a.label||e,category:a.category||"unknown",endpoint:a.endpoint||"",cacheKey:Xa(a),requestId:t.requestId||"",status:t.status||"unknown",reason:t.reason||"",resultCount:Number(t.resultCount||0),renderedCount:Number(t.renderedCount??_n(e)??0),pageSize:Ja(e),maxPageSize:ai(e),supportsPagination:Nc(e),hasMore:!!(t.hasMore??Ot(e)>_n(e)),nextCursor:String(t.nextCursor||"").slice(0,80),stale:!!t.stale,errorCode:String(t.errorCode||"").slice(0,80),errorMessage:String(t.errorMessage||"").slice(0,160),at:new Date().toISOString()}}function qc(e=n.activeTab,t={}){const a=lh(e,t);if(n.terminalFeedLog=[...n.terminalFeedLog||[],a].slice(-20),zo(Um,()=>n.terminalFeedLog,"feed"),a.status==="error"||a.status==="timeout"||/manual|post-trade|visibility|resume/i.test(a.reason||"")||!!(a.stale&&a.resultCount===0))try{k("/api/web/terminal-feed-event",{method:"POST",timeoutMs:2500,body:JSON.stringify(a)}).catch(()=>{})}catch{}return a}function ch(e=n.activeTab,t={}){const a=ze(e);if(!a)return"";const r=globalThis.crypto?.randomUUID?.()||`feed-${Date.now()}-${Math.random().toString(36).slice(2,8)}`;return n.terminalFeeds={...n.terminalFeeds,[e]:{...z(e),label:a.label,category:a.category,endpoint:a.endpoint,cacheKey:Xa(a),refreshMs:a.refreshMs,staleMs:a.staleMs,pageSize:a.pageSize,maxPageSize:a.maxPageSize,supportsPagination:!!a.supportsPagination,inFlight:!0,lastRequestId:r,lastReason:t.reason||"refresh",lastStartedAt:new Date().toISOString()}},r}function ri(e=n.activeTab,t="",a="success",r={}){const s=ze(e);if(!s)return;const o=Ot(e),c=_n(e),l={...z(e),label:s.label,category:s.category,endpoint:s.endpoint,cacheKey:Xa(s),refreshMs:s.refreshMs,staleMs:s.staleMs,pageSize:s.pageSize,maxPageSize:s.maxPageSize,supportsPagination:!!s.supportsPagination,inFlight:!1,lastRequestId:t,lastStatus:a,lastFetchAt:new Date().toISOString(),resultCount:o,renderedCount:c,hasMore:o>c,stale:a!=="success"||Nn(e),errorCode:r.errorCode||"",errorMessage:r.errorMessage||""};n.terminalFeeds={...n.terminalFeeds,[e]:l},qc(e,{requestId:t,status:a,reason:l.lastReason,resultCount:o,renderedCount:c,hasMore:l.hasMore,stale:l.stale,errorCode:l.errorCode,errorMessage:l.errorMessage})}function uh(e=n.activeTab){return["watchlist","wallets","positions","pnl","liveTrades","trade","bundle","volume","smartChart","launch","launchCoin"].includes(e)}function dh(e={}){const t=String(e.reason||"").toLowerCase();return!!e.userInitiated||t.includes("manual")||t.includes("button")||t.includes("bucket-switch")||t.includes("mode-switch")}async function ee(e=n.activeTab,t={}){const a=L(),r=ze(e);if(!r)return null;if(t.ifStale&&Uc(e)&&!Nn(e)||z(e).inFlight)return z(e);const s=dh(t),o=Date.now(),c=Number(_l.get(e)||0);if(!s&&c&&o-c<kn)return z(e);if(uh(e)&&!n.user&&!["smartChart","trade","bundle","volume","launchCoin"].includes(e))return ri(e,"","skipped",{errorCode:"ACCOUNT_REQUIRED",errorMessage:"Account or wallet required."}),z(e);_l.set(e,o);const l=ch(e,t);if(s&&t.renderStart!==!1){const u=n.activeTab==="smartChart"&&["smartChart"].includes(e);h({force:!0,preserveSmartChartFrame:u})}try{if(e==="terminal"){const u=[Et({silent:!0,force:!!t.force})];n.kolWallet||u.push(zr(n.kolMode,"",{silent:!0})),await Promise.allSettled(u)}else if(e==="live")await Hr({silent:t.silent!==!1,bucket:n.livePairBucket,force:!!t.force});else if(e==="liveTrades")n.user&&n.token&&await ia({silent:!0,skipCore:!0,force:!!t.force});else if(e==="slimeScope"){const u=[Et({silent:!0,force:!!t.force}),qn(n.scanMode,{silent:!0,force:!!t.force}).catch(()=>{})];n.kolScan||u.push(zr(n.kolMode,n.kolWallet,{silent:!0}).catch(()=>{})),await Promise.allSettled(u)}else if(e==="kol")await zr(n.kolMode,n.kolWallet,{silent:t.silent!==!1});else if(e==="watchlist")await Vc({silent:t.silent!==!1});else if(e==="sniper")await qn(n.scanMode,{silent:t.silent!==!1});else if(e==="positions")n.user&&n.token&&await yt({force:!!t.force,fast:!0,silent:!0,reason:t.reason||"positions-feed-refresh",followUpValues:!0,syncPnl:!!t.force,timeoutMs:wo});else if(["wallets","pnl"].includes(e))n.user&&n.token&&await De({force:!!t.force,deep:!1});else if(e==="smartChart")n.user&&n.token&&await De({force:!!t.force,deep:!1});else if(["trade","bundle","volume"].includes(e)){const u=[Et({silent:!0,force:!!t.force})];n.user&&n.token&&u.push(ia({silent:!0,skipCore:!0,force:!!t.force})),await Promise.allSettled(u)}else if(e==="launch"||e==="launchCoin"){const u=[Et({silent:!0,force:!!t.force})];n.scan||u.push(qn(n.scanMode,{silent:!0,force:!!t.force}).catch(()=>{})),n.user&&n.token&&u.push(ia({silent:!0,skipCore:!0,force:!!t.force})),await Promise.allSettled(u)}else e==="ogreTek"&&await br({silent:!0}).catch(u=>{n.ogreTek.error=u.message});return ri(e,l,"success"),z(e)}catch(u){if(ri(e,l,"error",{errorCode:u?.code||u?.name||"REFRESH_FAILED",errorMessage:N(u?.message||"Feed refresh failed.")}),t.throwOnError)throw u;return z(e)}finally{H("feed-refresh",a,{component:r.component||e,resultCount:Ot(e),cacheHit:!!z(e).cacheHit,stale:Nn(e),requestId:z(e).lastRequestId||"",errorCode:z(e).errorCode||"",details:`${e}:${Xa(r)}`}),t.render!==!1&&(!s&&ui()?Yc():h({force:!0,preserveSmartChartFrame:n.activeTab==="smartChart"&&e==="smartChart"}))}}async function Ya(e={}){const t=n.activeTab||"terminal",a=[ee(t,{...e,reason:e.reason||"visible-refresh"})];return await Promise.allSettled(a)}function Ur(e="terminal-entry"){n.route==="terminal"&&(Ya({silent:!0,ifStale:!0,reason:e}).catch(t=>$(t.message)),n.user&&n.token&&De({force:!0,deep:!1,reason:e}).catch(t=>{n.walletRefreshError=t.message||"Wallet refresh failed.",h({preserveSmartChartFrame:n.activeTab==="smartChart"})}))}function si(){const e=()=>{Wa&&clearTimeout(Wa),Wa=null,Cr=""};if(n.route!=="terminal"||document.hidden){e();return}const t=ze(n.activeTab);if(!t||["terminal","live","slimeScope","kol","watchlist","sniper","launchCoin"].includes(n.activeTab)){e();return}const a=Math.max(5e3,Number(t.refreshMs||3e4)),r=`${n.activeTab}:${Xa(t)}:${a}`;Wa&&Cr===r||(e(),Cr=r,Wa=setTimeout(async()=>{Wa=null,Cr="",!(n.route!=="terminal"||document.hidden)&&(await ee(n.activeTab,{silent:!0,force:!0,ifStale:!0,reason:"active-tab-auto"}).catch(s=>$(s.message)),si())},a))}function Dn(e){const t=String(e||"live");return Bt.some(([a])=>a===t)?t:"live"}function Hc(e=n.slimeScopeMode){const t=String(e||"new");return t==="steady"?"under1h":t==="graduating"?"under3h":t==="graduated"?"under1d":"live"}function qr(e=n.activeTab){return e==="slimeScope"?Hc(n.slimeScopeMode):Dn(n.livePairBucket)}function Ne(e=qr()){const t=Dn(e);return n.livePairsByBucket[t]||(t===n.livePairBucket?n.livePairs:null)||null}function ca(e=qr()){const t=Dn(e);return n.livePairsLastUpdatedByBucket[t]||(t===n.livePairBucket?n.livePairsLastUpdatedAt:"")||""}function Kc(e=[]){return Array.isArray(e)&&e.length>0}function Oe(e={},t={},a=[]){for(const r of a){const s=e?.[r];if(s!=null&&s!=="")return s}for(const r of a){const s=t?.[r];if(s!=null&&s!=="")return s}return""}function ph(e=[],t=[]){const a=new Map((Array.isArray(e)?e:[]).map(r=>[ba(r),r]).filter(([r])=>r));return(Array.isArray(t)?t:[]).map(r=>{const s=a.get(ba(r));return s?{...s,...r,tokenMint:Oe(r,s,["tokenMint","mint","tokenAddress","address"]),mint:Oe(r,s,["mint","tokenMint","tokenAddress","address"]),symbol:Oe(r,s,["symbol","ticker","shortMint"]),name:Oe(r,s,["name","tokenName","category"]),imageUrl:Oe(r,s,["imageUrl","image","icon","logoURI","logoUrl"]),image:Oe(r,s,["image","imageUrl","icon","logoURI","logoUrl"]),avatarUrl:Oe(r,s,["avatarUrl","avatar_url","avatar"]),avatarState:Oe(r,s,["avatarState"]),dexUrl:Oe(r,s,["dexUrl","url"]),pumpUrl:Oe(r,s,["pumpUrl","pumpFunUrl","pumpfunUrl"]),websiteUrl:Oe(r,s,["websiteUrl","website"]),twitterUrl:Oe(r,s,["twitterUrl","xUrl"]),telegramUrl:Oe(r,s,["telegramUrl"]),metadata:r?.metadata||s?.metadata||r?.tokenMetadata||s?.tokenMetadata||null,tokenMetadata:r?.tokenMetadata||s?.tokenMetadata||r?.metadata||s?.metadata||null,dex:r?.dex||s?.dex||r?.dexScreener||s?.dexScreener||null,pump:r?.pump||s?.pump||r?.pumpFun||s?.pumpFun||null}:r})}async function Hr({silent:e=!1,bucket:t=n.livePairBucket,renderOnComplete:a=!0,force:r=!1}={}){const s=L(),o=Dn(t),c=o===n.livePairBucket,l=n.terminalSort||"best",u=`${o}:${l}`,d=Ir.get(u);if(d?.promise){n.livePairsLoadingByBucket={...n.livePairsLoadingByBucket,[o]:d.requestId},n.livePairsLoading=!!n.livePairsLoadingByBucket[n.livePairBucket],!e&&c&&(n.loading=!0);const A=n.livePairsByBucket?.[o]?.rows||(c?n.livePairs?.rows:[]);return!e&&!Kc(A)&&qa(Hl),d.promise}const p=`${Date.now()}:${Math.random().toString(16).slice(2)}`,f=(xo[o]||0)+1;xo[o]=f;const y=()=>xo[o]===f;n.livePairsLoadingByBucket={...n.livePairsLoadingByBucket,[o]:p},n.livePairsLoading=!!n.livePairsLoadingByBucket[n.livePairBucket],!e&&c&&(n.loading=!0);const g=n.livePairsByBucket?.[o]?.rows||(c?n.livePairs?.rows:[]);!e&&!Kc(g)&&qa(Hl);const S=(async()=>{try{const A=r?"&force=true":"",T=`/api/web/live-pairs?bucket=${encodeURIComponent(o)}&sort=${encodeURIComponent(l)}${A}`,b=await Promise.race([k(T),new Promise((U,_e)=>window.setTimeout(()=>_e(new Error("Live feed refresh timed out.")),12e3))]),P=Bt.find(([U])=>U===o)?.[1]||"Live",C=n.livePairsByBucket[o]||(c?n.livePairs:null);let M=b.livePairs||{bucket:o,rows:[],refreshedAt:new Date().toISOString(),refreshSeconds:5,message:`${P} feed returned no rows yet. Retrying automatically.`};const q=Array.isArray(M?.rows)?M.rows:[],J=Array.isArray(C?.rows)?C.rows:[];if(q.length===0&&J.length>0?M={...C,...M,rows:C.rows,stale:!0,emptyRefresh:!0,message:`${P} is scanning for fresh rows. Showing the last good feed until the next qualifying refresh.`}:q.length>0&&J.length>0&&(M={...M,rows:ph(J,q)}),!y())return M;const ke=M?.refreshedAt||new Date().toISOString(),et={...n.livePairsRefreshErrorByBucket||{}};return delete et[o],n.livePairsRefreshErrorByBucket=et,n.livePairsByBucket={...n.livePairsByBucket,[o]:M},n.livePairsLastUpdatedByBucket={...n.livePairsLastUpdatedByBucket,[o]:ke},c&&(n.livePairs=M,n.livePairsLastUpdatedAt=ke),M}catch(A){const T=N(A?.message||"Live feed refresh failed."),b=Bt.find(([M])=>M===o)?.[1]||"Live",P=n.livePairsByBucket[o]||(c?n.livePairs:null),C=P?{...P,stale:!0,refreshError:T,message:`Showing last good ${b} feed. Refresh failed, retrying automatically.`}:{bucket:o,rows:[],refreshedAt:new Date().toISOString(),refreshSeconds:5,stale:!0,refreshError:T,message:`${b} refresh failed. Retrying automatically.`};return y()&&(n.livePairsRefreshErrorByBucket={...n.livePairsRefreshErrorByBucket||{},[o]:T},n.livePairsByBucket={...n.livePairsByBucket,[o]:C},n.livePairsLastUpdatedByBucket={...n.livePairsLastUpdatedByBucket,[o]:C.refreshedAt},c&&(n.livePairs=C,n.livePairsLastUpdatedAt=C.refreshedAt)),C}finally{if(!y())return;const A=n.livePairsByBucket?.[o]?.rows||[];H("live-pairs-refresh",s,{component:"livePairs",resultCount:Array.isArray(A)?A.length:0,stale:!!n.livePairsByBucket?.[o]?.stale,errorCode:n.livePairsRefreshErrorByBucket?.[o]?"LIVE_PAIRS_REFRESH_FAILED":"",details:`${o}:${l}`});const T={...n.livePairsLoadingByBucket};(T[o]===p||T[o]===!0)&&(delete T[o],n.livePairsLoadingByBucket=T),n.livePairsLoading=!!T[n.livePairBucket],!e&&c&&(n.loading=!1),a&&(c&&["terminal","live","slimeScope"].includes(n.activeTab)?qa("load-live-pairs-complete"):h())}})();return Ir.set(u,{requestId:p,requestVersion:f,safeBucket:o,promise:S}),S.finally(()=>{Ir.get(u)?.requestId===p&&Ir.delete(u)}),S}async function Et({silent:e=!1,force:t=!1,warmAll:a=!1}={}){if(await Hr({silent:e,bucket:n.livePairBucket,force:t}),a){const r=Bt.map(([s])=>s).filter(s=>s!==n.livePairBucket);await Promise.allSettled(r.map(s=>Hr({silent:!0,bucket:s,renderOnComplete:!1,force:t})))}(n.activeTab==="live"||n.activeTab==="terminal"||n.activeTab==="slimeScope")&&qa(a?"live-pair-buckets-warm-all":"live-pair-active-bucket")}function ua(){if(Kn()||document.hidden||Da()||n.activeTab!=="live"&&n.activeTab!=="terminal"&&n.activeTab!=="slimeScope"){Ua();return}const e=qr(n.activeTab),a=(n.activeTab==="slimeScope"?12:8)*1e3,r=`${n.activeTab}:${e}:${n.terminalSort}:${a}`;Ra&&$r===r||(Ua(),$r=r,Ra=setTimeout(async()=>{if(Ra=null,$r="",document.hidden||Da()){ua();return}if(n.activeTab==="live"||n.activeTab==="terminal"||n.activeTab==="slimeScope"){if(n.livePairsLoadingByBucket?.[e]){ua();return}try{n.activeTab==="slimeScope"?await ee("slimeScope",{silent:!0,render:!1,force:!1,reason:"slime-scope-auto-refresh"}):await Hr({silent:!0,bucket:n.livePairBucket,force:!1})}catch{}finally{ua()}}},a))}function mh({force:e=!1}={}){if(Kn()||!(n.activeTab==="live"||n.activeTab==="terminal"||n.activeTab==="slimeScope"))return;const a=qr(n.activeTab),r=`${a}:${n.terminalSort||"best"}`;Ao.has(r)||n.livePairsLoadingByBucket[a]||!e&&n.livePairsByBucket[a]||(Ao.add(r),window.setTimeout(()=>{const s=n.activeTab==="slimeScope"?ee("slimeScope",{silent:!0,render:!1,force:!0,reason:"slime-scope-warmup"}):Et({silent:!0,force:!0,warmAll:!1});Promise.resolve(s).catch(o=>$(o.message)).finally(()=>{Ao.delete(r),ua()})},900))}function Kr(){const e=()=>{Ia&&clearTimeout(Ia),Ia=null,Tr=""};if(document.hidden||n.activeTab!=="sniper"){e();return}const t=`${n.activeTab}:${n.scanMode}`;Ia&&Tr===t||(e(),Tr=t,Ia=setTimeout(async()=>{if(Ia=null,Tr="",document.hidden){Kr();return}if(n.activeTab==="sniper"){if(n.loading){Kr();return}try{await qn(n.scanMode,{silent:!0})}catch(a){$(a.message)}finally{Kr()}}},2e4))}function Un(){const e=()=>{Oa&&clearTimeout(Oa),Oa=null,Ar=""};if(Kn()||document.hidden||n.activeTab!=="kol"&&n.activeTab!=="terminal"||n.kolWallet){e();return}const t=String(n.kolMode||"hot"),s=t==="hot"||t==="fresh"?1e4:3e4,o=`${n.activeTab}:${n.kolMode}:${s}`;Oa&&Ar===o||(e(),Ar=o,Oa=setTimeout(async()=>{if(Oa=null,Ar="",document.hidden){Un();return}if(!(n.activeTab!=="kol"&&n.activeTab!=="terminal"||n.kolWallet)){if(n.kolLoading){Un();return}try{await zr(n.kolMode,"",{silent:!0})}catch(c){$(c.message)}finally{Un()}}},s))}function Vr(){const e=()=>{Fa&&clearTimeout(Fa),Fa=null,Pr=""};if(Kn()||document.hidden||n.activeTab!=="watchlist"&&n.activeTab!=="terminal"||!n.user||!n.token){e();return}const t=`${n.activeTab}:${n.user?.id||"guest"}`;Fa&&Pr===t||(e(),Pr=t,Fa=setTimeout(async()=>{if(Fa=null,Pr="",document.hidden){Vr();return}if(!(n.activeTab!=="watchlist"&&n.activeTab!=="terminal"))try{await Vc({silent:!0})}catch(a){$(a.message)}finally{Vr()}},3e4))}async function qn(e=n.scanMode,t={}){const a=L(),r=!!t.silent;n.scanMode=e,r||(n.loading=!0,h());try{const s=await k(`/api/web/sniper/scan?mode=${encodeURIComponent(e)}`);n.scan=s.scan}finally{H("scanner-refresh",a,{component:"sniper",resultCount:Array.isArray(n.scan?.candidates)?n.scan.candidates.length:0,details:e}),r||(n.loading=!1),h()}}async function zr(e=n.kolMode,t=n.kolWallet,a={}){const r=L(),s=!!a.silent;n.kolMode=e,n.kolWallet=String(t||"").trim();let o="";n.kolWallet&&!_t(n.kolWallet)&&(n.kolWallet="",o="Skipped invalid KOL wallet. Paste a verified Solana public wallet to scan positions."),!s&&!n.kolScan&&(n.loading=!0),n.kolLoading=!0,n.kolStatus=o||(n.kolWallet?"Scanning custom KOL wallet...":`Loading ${tr(n.kolMode)}...`),$(""),s||h();try{const c=new URLSearchParams({mode:e});n.kolWallet&&c.set("wallet",n.kolWallet);const l=await k(`/api/web/kol/scan?${c.toString()}`);n.kolScan=l.scan,n.kolLastUpdatedAt=new Date().toISOString(),n.kolStatus=l.scan?.message||`${tr(n.kolMode)} loaded.`,n.kolDumpStatsLoadedAt=0}catch(c){throw n.kolStatus=c.message||"KOL scan failed.",c}finally{H("kol-refresh",r,{component:"kol",resultCount:Array.isArray(n.kolScan?.rows)?n.kolScan.rows.length:Array.isArray(n.kolScan?.signals)?n.kolScan.signals.length:0,errorCode:n.kolStatus&&/failed/i.test(n.kolStatus)?"KOL_REFRESH_FAILED":"",details:n.kolWallet?"wallet":e}),s||(n.loading=!1),n.kolLoading=!1,h()}}async function Vc(e={}){if(!n.user||!n.token)return;const t=L(),a=!!e.silent;n.watchlistLoading=!0,a||h();try{const r=await k("/api/web/watchlist");n.watchlist=r.watchlist||{rows:[],count:0}}finally{H("watchlist-refresh",t,{component:"watchlist",resultCount:n.watchlist?.count||n.watchlist?.rows?.length||0}),n.watchlistLoading=!1,h()}}function fh(){return n.balances.reduce((e,t)=>e+Number(t.sol||0),0)}function hh(){const e=Number(n.connectedWalletBalance?.sol);return Number.isFinite(e)&&e>0?e:0}function Ft(){return fh()+hh()}const gh=[{symbol:"SOL",name:"Solana",mint:"SOL",kind:"native"},{symbol:"USDC",name:"USD Coin",mint:"EPjFWdd5AufqSSqeM2qer6k8zQfM3qNw6ddnCGWRPpC",kind:"popular"},{symbol:"USDT",name:"Tether USD",mint:"Es9vMFrzaCERmJfrF4H2FYD4KCoE5gXn4wYwG9ksz4T8Js3",kind:"popular"},{symbol:"JUP",name:"Jupiter",mint:"JUPyiwrYJFskUPiHa7hkeR8VUtAeFoSYbKedZNsDvCN",kind:"popular"},{symbol:"RAY",name:"Raydium",mint:"4k3Dyjzvzp8eCTuFJYgmGnN95VhWPuTsf1KfzYEU7K1k",kind:"popular"},{symbol:"BONK",name:"Bonk",mint:"DezXAZ8z7PnrnRJjz3uq8NgV8Q9ddCzB9Ckr7JpPvvR",kind:"popular"},{symbol:"WIF",name:"dogwifhat",mint:"EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLQBkRzUPzWf",kind:"popular"}];function Ee(e=""){const t=String(e||"").trim();return!t||t.toLowerCase()==="custom"?"":t.toUpperCase()==="SOL"?"SOL":t}function bh(){const e=new Map,t=(a={})=>{const r=Ee(a.mint||a.tokenMint||"");if(!r||e.has(r))return;const s=a.balance??a.uiAmount??a.amount??a.uiBalance??"";e.set(r,{mint:r,symbol:String(a.symbol||a.shortMint||(r==="SOL"?"SOL":w(r))||"").trim(),name:String(a.name||a.label||"").trim(),balance:s,kind:"wallet"})};return t({mint:"SOL",symbol:"SOL",name:"Solana",balance:`${Ft().toFixed(4)} SOL`}),rt().forEach(a=>t({mint:a.tokenMint||a.mint,symbol:a.symbol||a.shortMint,name:a.name||"",balance:a.uiAmount||a.amountToken||"",kind:"wallet"})),(n.balances||[]).forEach(a=>{(a.tokens||[]).forEach(r=>t({mint:r.tokenMint||r.mint,symbol:r.symbol||r.shortMint,name:r.name||"",balance:r.uiAmount||r.amount||r.balance||"",kind:"wallet"}))}),[...e.values()]}function oi(e={}){const t=new Map,a=(s={})=>{const o=Ee(s.mint||s.tokenMint||"");!o||t.has(o)||t.set(o,{mint:o,symbol:String(s.symbol||s.shortMint||(o==="SOL"?"SOL":w(o))||"").trim(),name:String(s.name||s.label||"").trim(),balance:s.balance??s.uiAmount??s.amount??"",kind:s.kind||s.source||"held"})};return bh().forEach(a),e.walletOnly||gh.forEach(s=>{s.mint!=="SOL"&&a(s)}),[...t.values()]}function zc(e=""){const t=Ee(e);return oi().find(a=>a.mint===t)||null}function jc(e="",t={}){const a=Ee(e),r=t.includeCustom!==!1,s=oi({walletOnly:!!t.walletOnly}),o=s.some(u=>u.mint===a);return`${s.map(u=>{const d=u.mint==="SOL"?`SOL${u.balance?` - ${u.balance}`:""}`:`${u.symbol||w(u.mint)}${u.kind==="wallet"?` - ${u.balance?`${u.balance} `:""}in wallet`:u.name?` - ${u.name}`:""}`;return`<option value="${i(u.mint)}" ${a===u.mint?"selected":""}>${i(d)}</option>`}).join("")}${r?`<option value="custom" ${r&&(!a||!o)?"selected":""}>Custom CA</option>`:""}`}function ii(){const e=Ee(n.tradeSwapFrom||"SOL")||"SOL";return oi({walletOnly:!0}).some(t=>t.mint===e)?e:"SOL"}function Gc(){const e=ii(),t=Ee(n.tradeSwapTo||""),a=Ee(n.tradeToken||"");return t&&t!==e?t:a&&a!==e||e==="SOL"?a:"SOL"}function yh(){const e=ii(),t=Gc();return e!=="SOL"&&t&&t!=="SOL"&&e!==t?"two-step":t&&t!=="SOL"||Ee(n.tradeToken||"")?n.swapDirection==="sell"?"sell":"buy":"select"}function vh(e="buy"){const t=Ee(m("[data-swap-from]")?.value||n.tradeSwapFrom||""),a=Ee(m("[data-swap-to]")?.value||n.tradeSwapTo||""),r=String(m("[data-trade-token]")?.value||n.tradeToken||"").trim();return e==="sell"&&t&&t!=="SOL"?t:a&&a!=="SOL"?a:r}function Xc(){return(n.connectedWalletBalance||n.user?.connectedWallet||null)?.publicKey?(n.connectedWalletBalance?.tokens||[]).filter(t=>t?.mint||t?.tokenMint).map(t=>{const a=String(t.mint||t.tokenMint||"").trim();return{tokenMint:a,shortMint:t.shortMint||w(a),symbol:t.symbol||t.shortMint||w(a),name:t.name||"",imageUrl:t.imageUrl||t.imageUri||"",imageUri:t.imageUri||t.imageUrl||"",dexUrl:t.dexUrl||Q(a),pumpUrl:jf(a),uiAmount:t.uiAmount??"held",walletCount:1,buys:0,sells:0,spentSol:"0",receivedSol:"0",realizedSol:"+0",estimatedValueSol:null,openPnlSol:null,openPnlPercent:null,valuePending:!1,valueError:"",viewOnly:!0,source:"connected-wallet"}}):[]}function rt(){const e=new Set,t=[];for(const a of[...n.positions||[],...Xc()]){const r=String(a?.tokenMint||a?.mint||"").trim();!r||e.has(r)||(e.add(r),t.push(a))}return t}function li(){const e=n.connectedWalletBalance?.publicKey||n.user?.connectedWallet?.publicKey||"";return n.wallets.length+(e?1:0)}function ci(){return n.pnl?.totals?.realizedSol||"+0 SOL"}function Qa(e){const t=Date.parse(e||"");return Number.isFinite(t)?Math.max(0,Math.floor((Date.now()-t)/1e3)):null}function Hn(e){return Number.isFinite(e)?e<5?"just now":e<60?`${e}s ago`:e<3600?`${Math.floor(e/60)}m ago`:`${Math.floor(e/3600)}h ago`:"never"}function jr(){if(n.walletRefreshing||n.walletRefreshStatus==="refreshing")return"Syncing";if(n.walletRefreshStatus==="timeout")return"Delayed";if(n.walletRefreshError||n.walletRefreshStatus==="error")return"Retry";const e=Qa(n.lastWalletRefreshAt);return e===null?"Idle":e>45?"Stale":"Synced"}function wh(){const e=oe("trade",n.selectedTradePresetId),t=oe("bundle",n.selectedBundlePresetId),a=e?`${e.name||"Trade"} ${e.amountSol||""} SOL`.trim():"Manual",r=t?t.name||"Bundle":"No bundle";return`Preset ${a} | ${r}`}async function Jc(){if(!n.user||!n.token)return;const e=L();try{const[t,a]=await Promise.allSettled([k("/api/web/pnl?force=true",{dedupe:!1}),k("/api/web/trade/plans")]);t.status==="fulfilled"&&(n.pnl=t.value.pnl||n.pnl||null),a.status==="fulfilled"&&(n.tradePlans=a.value.plans||n.tradePlans||[],hs()),H("post-trade-supplemental-refresh",e,{component:"post-trade",resultCount:(n.tradePlans?.length||0)+(n.pnl?1:0),details:"pnl,trade-plans"})}catch(t){H("post-trade-supplemental-refresh",e,{component:"post-trade",errorCode:t?.code||t?.name||"POST_TRADE_SUPPLEMENTAL_FAILED",details:N(t?.message||"Post-trade supplemental refresh failed.")})}}function Sh(e=350,t={}){Lr&&window.clearTimeout(Lr),Lr=window.setTimeout(async()=>{if(Lr=null,!(!n.user||!n.token))try{t.reason==="post-trade"?await Promise.all([Jc(),yt({force:!0,fast:!1,silent:!0,syncPnl:!0,reason:"post-trade-background-values"})]):await Promise.all([ia({force:!1,skipCore:!0,silent:!0}),yt({force:!1,fast:!1,silent:!0,reason:"background-values"})])}catch(a){n.walletRefreshError=a.message||"Background refresh failed.",h()}},e)}async function De({force:e=!1,deep:t=!1,reason:a="manual"}={}){if(!n.user||!n.token)return n.walletRefreshing=!1,n.walletRefreshStatus="idle",n.walletRefreshError="Wallet not connected",Ie("[data-sync-health]","Wallet not connected"),Ke("error",{error:"Wallet not connected"}),h({preserveSmartChartFrame:n.activeTab==="smartChart"}),{ok:!1,data:null,error:"Wallet not connected",durationMs:0,fromCache:!1,degraded:!0};const r=String(a||"").toLowerCase(),s=r==="manual_header_click",o=r.includes("post-trade");if(e&&!t&&!o&&!s&&Date.now()-Zl<Km?(e=!1,W({component:"wallet",action:"wallet-refresh-force-throttled",durationMs:0,cacheHit:!0,details:r||"manual"})):e&&!t&&!o&&(Zl=Date.now()),ea)return W({component:"wallet",action:"wallet-refresh-dedupe",durationMs:0,cacheHit:!0,details:e?"force-shared":"shared"}),n.positionRefreshAction?.state==="clicked"&&za("refreshing",{startedAt:n.positionRefreshAction.startedAt||L()}),ea.finally(()=>{if(["clicked","refreshing"].includes(n.positionRefreshAction?.state)){const u=n.walletRefreshStatus==="error"||n.walletRefreshStatus==="timeout";Ke(u?"error":"success",{error:u?N(n.walletRefreshError||"Refresh delayed"):""})}});const c=L(),l=++uf;return n.walletRefreshRequestId=l,ea=(async()=>{let u={ok:!1,data:null,error:"",durationMs:0,fromCache:!1,degraded:!1};n.positionRefreshAction?.state==="clicked"&&za("refreshing",{startedAt:n.positionRefreshAction.startedAt||c}),n.walletRefreshing=!0,n.walletRefreshStatus="refreshing",n.walletRefreshError="",Ie("[data-sync-health]",jr()),Mt("[data-refresh-spinner]",!1),le(),ta&&window.clearTimeout(ta),ta=window.setTimeout(()=>{ta=null,!(n.walletRefreshRequestId!==l||!n.walletRefreshing)&&(n.walletRefreshing=!1,n.walletRefreshStatus==="refreshing"&&(n.walletRefreshStatus="timeout"),ea=null,Ke("error",{error:"Refresh delayed; retrying..."}),h({preserveSmartChartFrame:n.activeTab==="smartChart"}))},vo+6e3),await Le(20);try{if(await Promise.race([ti({force:e,deep:t,preserveSmartChartFrame:n.activeTab==="smartChart",requestId:l,timeoutMs:vo}),new Promise((d,p)=>window.setTimeout(()=>p(Object.assign(new Error("Wallet refresh timed out."),{code:"TIMEOUT"})),vo))]),n.walletRefreshRequestId!==l)return u={ok:!1,data:null,error:"Stale wallet refresh ignored.",durationMs:L()-c,fromCache:!1,degraded:!0},u;n.walletRefreshRequestId===l&&(n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshStatus="success"),t?await ia({force:e,skipCore:!0,silent:!0}):((s||o)&&yt({force:!0,fast:!1,silent:!0,followUpValues:!1,syncPnl:!0,reason:`${a}-positions-values`,timeoutMs:Yt}).then(d=>{d?h({preserveSmartChartFrame:n.activeTab==="smartChart"}):Dr(`${a}-positions-values-failed`)}).catch(()=>Dr(`${a}-positions-values-failed`)),Sh(o?200:350,{reason:a})),H("wallet-refresh-total",c,{component:"wallet",resultCount:(n.balances?.length||0)+(n.positions?.length||0),details:t?"deep":`core-plus-background:${a}`}),Ke("success",{error:""}),u={ok:!0,data:{balances:n.balances,positions:n.positions,pnl:n.pnl},error:"",durationMs:L()-c,fromCache:!1,degraded:!1}}catch(d){const p=d?.code==="TIMEOUT"||/timed out|timeout|blocked or could not open/i.test(String(d?.message||""));n.walletRefreshRequestId===l&&(n.walletRefreshStatus=p?"timeout":"error",n.walletRefreshError=d.message||"Refresh failed."),p&&!r.includes("auto-retry")&&n.user&&n.token&&window.setTimeout(()=>{n.user&&n.token&&n.walletRefreshStatus!=="success"&&De({force:!1,deep:!1,reason:"auto-retry-timeout"}).catch(()=>{})},4e3),H("wallet-refresh-total",c,{component:"wallet",errorCode:d?.code||d?.name||"WALLET_REFRESH_FAILED",details:N(n.walletRefreshError)}),Ke("error",{error:N(n.walletRefreshError)}),$(n.walletRefreshError),u={ok:!1,data:{balances:n.balances,positions:n.positions,pnl:n.pnl},error:N(n.walletRefreshError),durationMs:L()-c,fromCache:!1,degraded:!0}}finally{ta&&(window.clearTimeout(ta),ta=null),n.walletRefreshRequestId===l&&(n.walletRefreshing=!1),ea=null,h({preserveSmartChartFrame:n.activeTab==="smartChart"})}return u})(),ea}async function vt({force:e=!0,reason:t="manual_header_click",deep:a=!1}={}){return De({force:e,reason:t,deep:a})}function Kn(){return!!n.postTradeRefresh?.active&&Number(n.postTradeRefresh?.activeUntil||0)>Date.now()}async function Kk(e="",t="legacy-post-trade"){K(e,t)}function K(e="",t="post-trade",a={}){e&&(n.lastTradeSignature=e),xt.length&&(xt.forEach(o=>window.clearTimeout(o)),xt=[]);const r=a.tradeAttemptId||bt("post-trade"),s=Array.isArray(a.affectedKeys)&&a.affectedKeys.length?a.affectedKeys.slice(0,12).map(o=>ve(o,48)):Ym;n.postTradeRefresh={active:!0,attemptId:r,action:ve(t,70),signaturePresent:!!e,invalidatedKeys:s,refreshedKeys:[],requestCount:0,errors:[],startedAt:new Date().toISOString(),activeUntil:Date.now()+12e3},W({component:"post-trade",action:"post-trade-invalidation-start",durationMs:0,requestId:r,resultCount:s.length,details:s.join(",")}),zm.forEach(o=>{const c=window.setTimeout(()=>{xt=xt.filter(p=>p!==c);const l=Number(n.postTradeRefresh?.requestCount||0)+1;n.postTradeRefresh={...n.postTradeRefresh||{},requestCount:l},W({component:"post-trade",action:"post-trade-refresh-start",durationMs:0,requestId:r,resultCount:n.postTradeRefresh.requestCount,details:t});const u=L();(l<=1?De({force:!0,deep:!1,reason:"post-trade"}):Promise.all([yt({force:!0,fast:!1,silent:!0,followUpValues:!1,syncPnl:!0,reason:"post-trade-values",timeoutMs:Yt}),Jc()])).catch(p=>{n.walletRefreshError=p.message||"Post-trade refresh failed.",n.postTradeRefresh={...n.postTradeRefresh||{},errors:[...n.postTradeRefresh?.errors||[],N(p.message||"Post-trade refresh failed.")].slice(-5)},W({component:"post-trade",action:"position-refresh-post-trade-error",durationMs:L()-u,requestId:r,errorCode:p?.code||p?.name||"POST_TRADE_REFRESH_FAILED",details:t}),h()}).finally(()=>{n.postTradeRefresh={...n.postTradeRefresh||{},refreshedKeys:[...new Set([...n.postTradeRefresh?.refreshedKeys||[],"wallet-summary","positions","pnl"])],active:xt.length>0,activeUntil:xt.length>0?Date.now()+8e3:Date.now()},W({component:"post-trade",action:"post-trade-refresh-end",durationMs:L()-u,requestId:r,resultCount:(n.balances?.length||0)+(n.positions?.length||0),details:n.postTradeRefresh.refreshedKeys.join(",")}),h({preserveSmartChartFrame:n.activeTab==="smartChart"})})},o);xt.push(c)}),le()}function xe({title:e="Confirm",lines:t=[],confirmLabel:a="Confirm",cancelLabel:r="Cancel",danger:s=!1,input:o=null}={}){if(!document?.body){const c=[].concat(t).filter(Boolean).join(`
`);return o?Promise.resolve(window.prompt(c||e,o.value||"")):Promise.resolve(window.confirm(c||e))}return new Promise(c=>{const l=document.createElement("div");l.className="slime-confirm-overlay",l.innerHTML=`
    ...
    `;const u=document.activeElement,d=l.querySelector(".slime-confirm-input"),p=S=>{l.remove(),document.removeEventListener("keydown",g,!0);try{u?.focus?.({preventScroll:!0})}catch{}c(S)},f=()=>p(o?d?.value??"":!0),y=()=>p(o?null:!1),g=S=>{S.key==="Escape"?(S.preventDefault(),y()):S.key==="Enter"&&(!o||S.target===d)&&(S.preventDefault(),f())};l.addEventListener("pointerdown",S=>{S.target===l&&y()}),l.querySelector(".slime-confirm-accept").addEventListener("click",f),l.querySelector(".slime-confirm-cancel").addEventListener("click",y),document.addEventListener("keydown",g,!0),document.body.appendChild(l),(d||l.querySelector(".slime-confirm-accept"))?.focus({preventScroll:!0}),d&&d.select()})}function ui(){if(document.hidden&&n.route==="terminal")return!0;const e=document.activeElement;if(!e||n.route!=="terminal")return!1;const t=String(e.tagName||"").toLowerCase();return e.isContentEditable||["input","textarea","select"].includes(t)?!!e.closest(".fast-preset-builder, .preset-toolbar, .terminal-quick-buy-bar, .command-controls, .live-control-strip, .terminal-preset-strip, .preset-card, .order-ticket, .order-ticket-stack, .terminal-dock, .trade-side, .volume-grid, .sniper-setup, .wallet-exit-grid, .pump-launch-form, .launch-coin-form, .profile-grid, .preset-manager, .trade-panel, .terminal-side-panel, [data-preserve-focus]"):!1}function Yc(){n.pendingRender=!0}function Qc(){!n.pendingRender||ui()||(n.pendingRender=!1,h({force:!0}))}function di(e,t){e&&(e.hidden=t,e.dataset.routeViewHidden=t?"true":"false",e.setAttribute("aria-hidden",t?"true":"false"))}function Za(){if(!ie||!Ln||!ae)return;const e=!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey||n.wallets.length);ie.dataset.loading=n.loading?"true":"false",ie.dataset.route=n.route,ie.dataset.walletConnected=e?"true":"false",e&&NS("shell-wallet-context"),e?mu("shell-wallet-context"):Al(),e||(n.tpslAutoEnableInFlight=!1,n.tpslAutoEnableScheduledAt=0),di(Ln,!["intro","login"].includes(n.route)),di(ac,n.route!=="connect"),di(ae,n.route!=="terminal"),Mt("[data-terminal-global-search]",n.route!=="terminal"),Mt("[data-top-sync-strip]",n.route!=="terminal")}function Vn(){const e=!!(Pe&&n.loginModalOpen),t=!!n.quickBuyModal?.open;document.body.classList.toggle("login-modal-open",e),document.body.classList.toggle("quick-buy-modal-open",t),!e&&!t&&(document.body.style.overflow="",document.documentElement.style.overflow="");const a=m("[data-wallet-connect-modal]");a&&(a.style.pointerEvents=a.hidden?"none":"");const r=m("[data-quick-buy-modal-root]");r&&(r.style.pointerEvents=r.hidden?"none":"")}function pi(e,t=48){if(!e||document.hidden)return!1;try{const a=e.getBoundingClientRect();return a.width<24||a.height<t}catch{return!1}}function Zc(e="resume"){if(!ie||document.hidden)return;Za(),Vn();const t=`${Date.now()}:${e}`,a=ie.style.transform;ie.dataset.resumePaint=t,ie.style.transform=a?`${a} translateZ(0)`:"translateZ(0)",ie.offsetHeight,window.requestAnimationFrame(()=>{!ie||ie.dataset.resumePaint!==t||(ie.style.transform=a,delete ie.dataset.resumePaint)})}function kh(){if(!ie)return!1;if(ie.dataset.route!==n.route)return!0;const e=document.body.classList.contains("login-modal-open")&&(!Pe||Pe.hidden||!n.loginModalOpen),t=document.body.classList.contains("quick-buy-modal-open")&&!n.quickBuyModal?.open;if(e||t||pi(ie,80))return!0;if(n.route!=="terminal")return!1;const a=m("[data-panel]");return ae?.hidden||pi(ae,80)||a&&pi(a,32)||a&&!a.children.length&&!String(a.textContent||"").trim()?!0:![Ln,ac,ae].some(s=>s&&!s.hidden)}function $h(e="watchdog"){const t=n.positionRefreshAction||{},a=t.startedAt?Math.max(0,L()-Number(t.startedAt||0)):0;(t.state==="clicked"||t.state==="refreshing")&&a>Jm&&(Ke("error",{error:"Refresh delayed"}),W({component:"positions",action:"stale-position-refresh-lock-cleared",durationMs:a,details:e})),n.walletRefreshing&&!ea&&(n.walletRefreshing=!1,n.walletRefreshStatus=n.walletRefreshStatus==="refreshing"?"timeout":n.walletRefreshStatus,Mt("[data-refresh-spinner]",!0)),Vn(),le()}function eu(e="watchdog",t={}){return $h(e),kh()?(W({component:"app-shell",action:"recover-blank-shell",durationMs:Math.max(0,Date.now()-ec),details:`${e}:${n.route}:${n.activeTab||""}`}),Ko({keepLogin:n.route==="login"}),Za(),Zc(e),h({force:!0,preserveSmartChartFrame:n.activeTab==="smartChart"}),!0):(t.forcePaint&&Zc(e),!1)}function tu(){return!!(navigator.mediaDevices?.getDisplayMedia&&window.MediaRecorder)}function au(){try{return document.createElement("canvas")}catch{return null}}function nu(){const e=au();return!!(e&&(typeof e.toBlob=="function"||(e.captureStream||e.mozCaptureStream)&&window.MediaRecorder))}function Th(){return tu()||nu()}function mi(){const e=Ve()?"This mobile browser blocked both screen recording and SlimeWire clip fallback. Use your phone screen recorder, then share the saved clip.":"This browser cannot start screen recording. Use desktop Chrome/Edge or your device recorder.";Wt(e),typeof window.alert=="function"&&window.alert(e)}function ru(){return["video/mp4;codecs=avc1.42E01E,mp4a.40.2","video/mp4;codecs=h264,aac","video/mp4","video/webm;codecs=vp9,opus","video/webm;codecs=vp8,opus","video/webm"].find(t=>{try{return MediaRecorder.isTypeSupported(t)}catch{return!1}})||""}function zn(e=""){return/^image\/png/i.test(String(e||""))?"png":/^video\/mp4/i.test(String(e||""))?"mp4":"webm"}function su(){const e=n.clipFarm?.fileExtension||zn(n.clipFarm?.mimeType||n.clipFarm?.blob?.type||"");return`slimewire-clip-${Date.now()}.${e}`}function jn(){try{n.clipFarm?.stream?.getTracks?.().forEach(e=>e.stop())}catch{}n.clipFarm?.fallbackFrameTimer&&clearInterval(n.clipFarm.fallbackFrameTimer),n.clipFarm?.fallbackStopTimer&&clearTimeout(n.clipFarm.fallbackStopTimer)}function Wt(e=""){n.clipFarm={...n.clipFarm,status:String(e||"")},je()}function fi(){if(n.clipFarm?.videoUrl)try{URL.revokeObjectURL(n.clipFarm.videoUrl)}catch{}n.clipFarm={...n.clipFarm,blob:null,videoUrl:"",mimeType:"",fileExtension:"",status:n.clipFarm?.recording?"Recording...":""},je()}function je(){const e=document.querySelector("[data-clip-farm]");if(!e)return;const t=n.clipFarm||{},a=Th(),r=!!t.recording,s=!!(t.blob&&t.videoUrl),o=t.status||(r?"Recording":s?"Clip ready":"Clip farm");e.innerHTML=`
  ...
  `}const bu="slimewire-ogre-memory";function Gr(){try{return JSON.parse(localStorage.getItem(bu)||"{}")||{}}catch{return{}}}function Xr(e={}){const t={...Gr(),...e};try{localStorage.setItem(bu,JSON.stringify(t))}catch{}return t}function zh(e,t=""){if(!e)return;const r=(Gr().recentTokens||[]).filter(s=>s.mint!==e);r.unshift({mint:e,symbol:String(t||"").slice(0,14),at:Date.now()}),Xr({recentTokens:r.slice(0,5)})}(function(){const t=Gr();t.quickBuy&&!n.quickBuyAmountOverride&&(n.quickBuyAmountOverride=t.quickBuy)})();function yu(){const t=or().filter(l=>{const u=Number(l.marketCapUsd??l.marketCap)||0;return u>0&&u<8e3}).length,r=(Array.isArray(n.tradePlans)?n.tradePlans:[]).filter(l=>["watching","active"].includes(String(l.status||"").toLowerCase())),s=r.filter(l=>{const u=Number(l.lastMovePct??l.wallets?.[0]?.lastMovePct),d=Number(l.takeProfitPct);return Number.isFinite(u)&&Number.isFinite(d)&&d>0&&u>d*.7}).length,o=Number(n.shieldReceipts?.stats?.watching||0),c=Number(n.proofStats?.wins||0);return[c?`✅ ${c} tracked call(s) hit 2x - the proof wall has receipts`:"",t?`🐣 ${t} fresh under 8k MC on the feed`:"",r.length?`🛡 ${r.length} plan(s) armed${s?` - ${s} near take-profit`:""}`:"",o?`🔎 ${o} flagged token(s) being tracked to outcome`:""].filter(Boolean)}let vu=!1;function jh(){if(vu||yn().length)return;vu=!0;const e=yu(),t=Gr(),a=[t.quickBuy?`your quick buy is still ${t.quickBuy} SOL`:"",t.risk==="degen"?"serving the early risky ones first, like you asked":t.risk==="careful"?"keeping it shield-clean first, like you asked":"",t.recentTokens?.[0]?.symbol?`last visit you were on $${t.recentTokens[0].symbol}`:""].filter(Boolean),r=a.length?` I remember: ${a.join(", ")}.`:"";de({role:"assistant",text:e.length?`Welcome back. Right now: ${e.join(". ")}.${r} Ask me anything or say "open positions".`:`Welcome to SlimeWire. I can navigate anywhere, check any CA, set your quick buy, and run trades from chat.${r} Try "whats cooking" or paste a token address.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Positions",type:"open_tab",tab:"positions"}]})}function Gh(){return`
    <section class="trade-card ogre-brief-card">
      ...
      <ul class="ogre-brief-list">
        ${[...yu(),"🧾 Proof wall is public - slimewire.org/proof"].map(t=>`<li>${i(t)}</li>`).join("")}
      </ul>
    </section>
  ...
  `}function Jh(e){const t=Number(e)||0;return t<90?`${t} min`:t<2880?`${Math.round(t/60)}h`:`${Math.round(t/1440)}d`}let wu=0;function Yh(){Date.now()-wu<300*1e3||(wu=Date.now(),k("/api/web/shield/receipts").then(e=>{n.shieldReceipts=e,n.activeTab==="tek"&&h()}).catch(()=>{}),k("/api/web/proof").then(e=>{n.proofStats=e?.alpha||null}).catch(()=>{}))}function Qh(){return`
    ${cg()}
    ${Jr()}
  ...
  `,".wallet-connect-dialog")}function hg(){const e=n.quickBuyModal||{},t=Is()?.tokenMint===e.tokenMint?Is():be(e.tokenMint,{source:e.source||"quick-buy-modal"}),a=/validating|submitting|opening wallet/i.test(String(e.status||"")),r=Si(e.error||e.status||""),s=a||!!r,o=ue(e.walletIndex||"");return`
  ...
  `}function yg(){const e=n.user?.referralCode||"",t=`${Lt.replace(/\/+$/,"")}/r/`,a=n.user?.referralLink||(e?`${Lt.replace(/\/+$/,"")}/r/${encodeURIComponent(e)}`:""),r=n.user?.referralStats||{},s=Array.isArray(r.referrals)?r.referrals:[];return`
    <section class="create-wallet-card referral-card">
      ...
      <div class="card-actions">
        ...
        ${a?Cu(`Trade faster on SlimeWire. Referral: ${a}`,"Share TG"):""}
      </div>
  ...
  `}function Bu(e={},t={}){const a=!!t.compact,r=String(e.wallet||"").trim();return`
    <article class="curated-kol-card ${a?"is-compact":""}" data-tier="${i(e.tier||"hot")}">
      <div class="curated-kol-top">
        ${Ou(e,a?"kol-avatar small":"kol-avatar")}
        <div>
  ...
  `}function Bg(){const e=Ti("hot"),t=Ti("slimewire");return`
      ...
      <div class="curated-kol-layout">
        <article class="curated-kol-main">
          ...
          <div class="curated-kol-list">
            ${e.length?e.map(a=>Bu(a)).join(""):F("No curated hot wallets yet","Add wallets to the curated database to pin them here.")}
          </div>
        </article>
    ...
    <section class="trade-layout">
      ...
      <aside class="trade-side">
        ...
        <article>
          ...
          ${n.tradeToken?`<div class="card-actions">${Ge($i(n.tradeToken),"Share Watch")}</div>`:""}
        </article>
        ${bb()}
        <article>
          <h3>Balance Check</h3>
  ...
  `}function Gu(e){const t=Yn.find(([a])=>a===e);return t?t[1]:"Super-fresh"}function db(){if(!n.wallets.length)return`${Jr()}${F("No managed wallets loaded","Ogre A.I. needs managed/imported SlimeWire wallets so the server can submit TP/SL and timer exits after it buys.")}`;const e=Xl(),t=e.amountSol||"0.1",a=e.runCount||"1",r=(o,c,l)=>{const u=String(o||l||"");return u==="custom"?String(c||"custom"):u},s=as();return`
  ...
  `:Xu("Bundle","Bundle fires many managed wallets in one shot, so it needs at least one SlimeWire wallet. Tap to create one — your backup downloads instantly.")}function mb(){if(!n.bundleResult)return`
      <article>
        <h3>Latest Bundle</h3>
  ...
  `}function fb(e=""){return n.wallets.length?n.wallets.map((t,a)=>{const r=String(t.index??a+1),s=`${r}. ${t.label||"Wallet"} ${t.shortPublicKey||w(t.publicKey||"")}`;return`<option value="${i(r)}" ${String(e)===r?"selected":""}>${i(s)}</option>`}).join(""):'<option value="">No managed wallets loaded</option>'}function x(e,t,a=""){const r=m(e)?.value||a;if(r!=="custom")return r;const s=m(t)?.value?.trim();if(!s)throw new Error("Enter the custom value first.");return s}function it(e,t=""){const a=n.presets?.[e]||[],r=!t||t==="none"||t==="manual",s=e==="bundle"?"Create / edit bundle preset":"Create / edit trade preset";return a.length?`
  ...
  `:`
      <option value="" ${r?"selected":""}>No preset / manual</option>
      <option value="custom" ${t==="custom"?"selected":""}>${s}</option>
    `}function Ju(){return`<input data-quick-buy-amount type="text" inputmode="decimal" autocomplete="off" placeholder="${i(He()||"0.10")}" value="${i(n.quickBuyAmountOverride)}">`}function Yu(e="scanner"){return`
  ...
  `}function Xe(e,t,a="off"){return Dt({selectAttr:`${t}`,customAttr:`${t}-custom`,customFor:e,options:hb,selected:a,customPlaceholder:"Custom: 45s, 20, 2h"})}function ns(e,t,a="0"){return Dt({selectAttr:`${t}`,customAttr:`${t}-custom`,customFor:e,options:gb,selected:a,customPlaceholder:"Custom: 30s, 20, 2h"})}function Ri(e="scanner"){return`
  ...
  `}function Qu(e){const t=e==="trade"?n.editingTradePresetId:n.editingBundlePresetId;return t?oe(e,t):null}function rs(e,t){e==="trade"&&(n.editingTradePresetId=t||""),e==="bundle"&&(n.editingBundlePresetId=t||"")}function bb(){const e=Qu("trade"),t=!!e?.readonly,a=e?t?"Save Edited Copy":"Update Trade Preset":"Save Trade Preset";return`
  ...
  `}function yb(){const e=Qu("bundle"),t=!!e?.readonly,a=e?t?"Save Edited Copy":"Update Bundle Preset":"Save Bundle Preset";return`
    ...
    <article class="account-check-card distribute-card" data-preserve-focus>
      ...
      <div class="volume-grid">
        <label>
          ...
          <select data-distribute-source>${ed()}</select>
        </label>
        <label>
          New wallets (1-20)
    ...
    <section class="trade-card volume-bot-card slime-configurator ovs-skin" data-preserve-focus>
      ...
      <div class="ovs-below">
        <label class="vbot-config-field">
          ...
          <select data-vbot-source>${ed()}</select>
        </label>
  ...
  `}function Mb(){const e=n.slimeBotMode==="spam"?"spam":"smart",t=["low","med","high"].includes(n.slimeBotAggr)?n.slimeBotAggr:"med",a=Math.max(.05,Math.min(50,Number(m("[data-vbot-invest-num]")?.value||m("[data-vbot-invest]")?.value||"1"))),r=Math.max(20,Math.min(360,Number(m("[data-vbot-duration]")?.value||"60"))),o={low:{delaySecs:30,buyBias:55,walletCount:4},med:{delaySecs:12,buyBias:60,walletCount:6},high:{delaySecs:5,buyBias:70,walletCount:10}}[t],c=e==="smart",l=o.delaySecs*(c?4:1);let u=Math.round(r*60/l);u=Math.max(1,Math.min(250,u,Math.floor(a/.01)));const d=Math.max(.005,Math.min(.5,a/u));return{tokenMint:m("[data-vbot-token]")?.value?.trim()||"",sourceWalletIndex:m("[data-vbot-source]")?.value||"1",rollingWallets:c,autoCreateWallets:!c,walletCount:String(o.walletCount),fundPerWalletSol:c?"":(d+.02).toFixed(4),buyAmountSol:d.toFixed(4),sellPercent:"100",buyBias:String(o.buyBias),cycles:String(u),maxRounds:String(u),delaySecs:String(o.delaySecs),slippageBps:"400",sweepBack:!0,walletIndexes:[],walletGroup:"",keepDust:!!m("[data-vbot-keepdust]")?.checked,offsetSell:!!m("[data-vbot-offset]")?.checked,staggerPattern:["steady","waves","organic","ladder"].includes(n.slimeBotStagger)?n.slimeBotStagger:"steady",investment:a,durationMin:r,mode:e,aggr:t}}function ha(e){n.volumeBotStatus=String(e||"");const t=m("[data-vbot-status]");t&&(t.textContent=n.volumeBotStatus)}async function ls({silent:e=!0}={}){try{const t=await k("/api/web/volume-bot");n.volumeBots=Array.isArray(t.bots)?t.bots:[],n.activeTab==="volume"&&h()}catch(t){e||$(t.message)}}async function Bb(){if(n.volumeBotBusy)return;const e=Mb();if(!e.tokenMint){ha("Paste a token CA first.");return}const t=e.durationMin>=60?`${(e.durationMin/60).toFixed(e.durationMin%60?1:0)}h`:`${e.durationMin}m`;if(await xe({title:"Start SlimeBot",lines:["This spends REAL SOL.",`Token: ${e.tokenMint}`,`${e.mode==="smart"?"Smart":"Spam"} mode, ${e.aggr.toUpperCase()} aggressiveness.`,`Deploys up to ~${e.investment} SOL over ${t} from your source wallet,`,`as ${e.cycles} round(s) of randomized ~${e.buyAmountSol} SOL buys / sells.`,"Sweeps funds back to the source wallet when done."],confirmLabel:"Start SlimeBot"})){n.volumeBotBusy=!0,ha("Funding wallets and starting bot..."),h();try{const r=await k("/api/web/volume-bot/start",{method:"POST",body:JSON.stringify(e),dedupe:!1,timeoutMs:te});n.volumeBotBusy=!1,r.bot&&(n.volumeBots=[r.bot,...n.volumeBots.filter(s=>s.id!==r.bot.id)]),ha(r.bot?.message||"SlimeBot started."),h(),ls()}catch(r){n.volumeBotBusy=!1,ha(r.message),h()}}}async function Rb(e){if(e)try{ha("Stopping bot...");const t=await k("/api/web/volume-bot/stop",{method:"POST",body:JSON.stringify({planId:e}),dedupe:!1,timeoutMs:te});t.bot&&(n.volumeBots=n.volumeBots.map(a=>a.id===t.bot.id?t.bot:a)),ha(t.bot?.message||"Stop requested."),h(),ls()}catch(t){ha(t.message)}}function Ib(){return n.wallets.length?xb():Xu("SlimeBot","SlimeBot funds and trades from a managed SlimeWire wallet, so it needs at least one saved. Tap to create one — your backup downloads instantly.")}function Ob(){const e=ye([...n.livePairsByBucket.live?.rows||[],...n.livePairsByBucket.under1h?.rows||[],...Ne()?.rows||[],...n.scan?.rows||[]]).sort(Ze),t=fn(e),a=nt("launch",t),r=mn(),s=$t(Be().keywords)[0]||"";return`
    <section class="trade-layout">
      <article class="trade-card">
        ...
        ${rl(e,t)}
        ${a.length?ut(a,{context:"launch-snipe",hideToolbar:!0,primaryAction:"snipe",primaryActionLabel:"Snipe",shareBuilder:Aa}):r?pr(e,"launch candidates"):F("No launch filter set","Enter a ticker keyword like cook or broscook to watch fresh live pairs before they launch.")}
    ...
    <section class="launch-coin-card pump-live-panel" data-pump-live-panel>
      ...
      <div class="pump-live-grid">
        ...
        <div class="pump-live-stack">
          ...
          <div class="pump-live-stat"><span>Stream route</span><strong>${i(nd(t))}</strong></div>
        </div>
      </div>
  ...
  `}function Db(e={}){rd();const t=n.hypePages||[],r=new Date(Date.now()+600*1e3-new Date().getTimezoneOffset()*60*1e3).toISOString().slice(0,16);return`
    <div class="volume-grid">
      ...
      <aside class="trade-side">
        <article>
          ...
          <div class="card-actions">
            ...
            ${n.kolWallet?Ge(xu(n.kolWallet),"Share KOL"):""}
          </div>
        </article>
        <article>
          <h3>KOL Tools</h3>
  ...
  `}function oy(){const e=n.kolScan||null,t=tr(n.kolMode),a=n.kolLoading?`Scanning ${t}`:e?`${t} loaded`:`Pick ${t} or tap Refresh`,r=Number(e?.kolCount||e?.kols?.length||0),s=Number(e?.rows?.length||0),o=n.kolLastUpdatedAt?Se(n.kolLastUpdatedAt):"Not run";return`
        ...
        ${t.slice(0,12).map((a,r)=>`
          <article class="kol-profile">
            ...
            <div class="card-actions kol-profile-actions">
              ...
              ${a.kolscanUrl||a.wallet?`<a href="${i(a.kolscanUrl||Lc(a.wallet))}" target="_blank" rel="noreferrer">Trader Profile</a>`:""}
              ${Ei(a)}
              ${Ge(Pg(a),"Share Watch")}
  ...
  `}function uy(){const e=n.kolScan||{};if(e.configured===!1)return F("KOL Tracker is not connected yet",e.message||"Use Scan Wallet for a public wallet, or try again later.");const t=e.rows||[],a=nt("kol",t);return t.length?`
...
`)}async function Py(e){const t=m("[data-wallet-sweep-status]");n.walletSweepStatus="Running wallet action...",v(t,n.walletSweepStatus),$("");try{await Y(t,"Opening secure web profile...");const r={"sweep-sol":"/api/web/wallets/sweep-sol","sweep-tokens":"/api/web/wallets/sweep-tokens","sell-all":"/api/web/wallets/sell-all-tokens","sell-all-sweep":"/api/web/wallets/sell-all-tokens","send-sol-many":"/api/web/wallets/send-sol"}[e];if(!r)throw new Error("Unknown wallet action.");const s=e==="send-sol-many"?Ty():$y();if(e==="sell-all"&&(s.destination=""),e==="sell-all-sweep"&&!s.destination)throw new Error("Enter a destination wallet for Sell Tokens + Send SOL.");const o=await k(r,{method:"POST",body:JSON.stringify(s),timeoutMs:te});n.walletSweepStatus=Ay(o.sweep),v(t,n.walletSweepStatus),await De({force:!0,deep:!0}),n.activeTab="wallets",h()}catch(a){n.walletSweepStatus=a.message,v(t,a.message),$(a.message)}}async function Cy(e){const t=m("[data-restore-status]"),a=m("[data-restore-text]"),r=e?.files?.[0];if(!(!r||!a)){v(t,"Reading backup file...");try{a.value=await r.text(),v(t,"Backup loaded. Tap Restore Wallets.")}catch(s){v(t,`Could not read file: ${s.message}`)}}}function he(e,t){const a=new Blob([t],{type:"text/plain"}),r=URL.createObjectURL(a),s=document.createElement("a");s.href=r,s.download=e,document.body.appendChild(s),s.click(),s.remove(),setTimeout(()=>URL.revokeObjectURL(r),1e4)}async function Ly(){const e=m("[data-x-handle]"),t=m("[data-x-status]"),a=Je(e?.value||"");if(!a){v(t,"Enter a valid X handle first.");return}const r=window.open(Ci(a),"_blank","noopener,noreferrer");try{v(t,r?`Opening X and saving @${a}...`:`Saving @${a}. Allow popups if X did not open.`),await Y(t,"Creating secure web profile for X sharing...");const s=await k("/api/web/profile/x",{method:"POST",body:JSON.stringify({xHandle:a})});me(s.user||{...n.user,xHandle:s.profile?.xHandle||a}),jl(n.xHandle),v(t,`Connected @${n.xHandle}. Share buttons now open X posts with SlimeWire tagged.`),h()}catch(s){v(t,s.message),$(s.message)}}function xy(){const e=m("[data-x-status]"),t=Je(m("[data-x-handle]")?.value||n.xHandle||""),a=Ci(t||n.xHandle);window.open(a,"_blank","noopener,noreferrer"),v(e,t?`Opened X for @${t}. Tap Connect X after checking the handle.`:"Opened X login. Add your handle here after signing in.")}async function My(){const e=m("[data-x-status]"),t=m("[data-x-handle]");try{if(!n.user||!n.token){n.xHandle="",t&&(t.value=""),To(),v(e,"X unlinked. Enter a new handle any time and tap Save X Handle."),h();return}const a=await k("/api/web/profile/x",{method:"POST",body:JSON.stringify({clear:!0})});me(a.user||{...n.user,xHandle:""}),n.xHandle="",t&&(t.value=""),To(),v(e,"X unlinked. Enter a new handle any time and tap Save X Handle."),h()}catch(a){v(e,a.message),$(a.message)}}async function ys(e,t="Saving PFP..."){const a=m("[data-avatar-status]");v(a,t);try{await Y(a,"Creating secure web profile for PFP...");const r=await k("/api/web/profile/avatar",{method:"POST",body:JSON.stringify(e)});me(r.user||{...n.user,avatar:r.profile?.avatarDataUrl||r.profile?.avatarUrl||"",avatarSource:r.profile?.avatarSource||"",avatarUpdatedAt:r.profile?.avatarUpdatedAt||""}),v(a,n.user.avatar?"PFP saved.":"PFP removed."),h()}catch(r){v(a,r.message),$(r.message)}}async function By(e){const t=m("[data-avatar-status]"),a=e?.files?.[0];if(a){if(!/^image\/(png|jpe?g|webp)$/i.test(a.type)){v(t,"Use a PNG, JPG, or WebP image.");return}if(a.size>5*1024*1024){v(t,"Use an image under 5 MB.");return}try{v(t,"Compressing PFP...");const r=await vd(a);await ys({avatarDataUrl:r},"Saving compressed PFP...")}catch(r){v(t,r.message),$(r.message)}finally{e.value=""}}}function vd(e){return new Promise((t,a)=>{const r=new FileReader;r.onerror=()=>a(new Error("Could not read that image.")),r.onload=()=>{const s=new Image;s.onerror=()=>a(new Error("Could not load that image.")),s.onload=()=>{const c=document.createElement("canvas");c.width=256,c.height=256;const l=c.getContext("2d");if(!l){a(new Error("This browser cannot resize images."));return}const u=Math.max(256/s.width,256/s.height),d=Math.round(s.width*u),p=Math.round(s.height*u),f=Math.round((256-d)/2),y=Math.round((256-p)/2);l.clearRect(0,0,256,256),l.drawImage(s,f,y,d,p);const g=c.toDataURL("image/jpeg",.84);if(g.length>22e4){a(new Error("Compressed PFP is still too large. Try a simpler image."));return}t(g)},s.src=String(r.result||"")},r.readAsDataURL(e)})}async function Ry(e){const t=document.querySelector('script[src*="app.js"]')?.src||document.baseURI||window.location.href,a=new URL(String(e||""),t).toString(),r=await fetch(a,{cache:"force-cache"});if(!r.ok)throw new Error("Could not load that preset PFP.");const s=await r.blob();return vd(s)}async function Iy(){const e=Pi(n.xHandle);if(!e){const t=m("[data-avatar-status]");v(t,"Connect an X handle first.");return}await ys({avatarUrl:e,avatarSource:"x"},"Saving X PFP...")}async function wd(e,t={}){const a=In(),r=fe(e);if(!r){if(await Ac(e,t)||Pc(e))return;const s=fc(e);re(s),It(e,new Error(s),{action:"provider_missing",platform:Ve()?"mobile":"desktop"});return}try{const s=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(s){if(!(t.confirmSwitch===!1?!0:await xe({title:"Reconnect or Switch Wallet",lines:[`Current wallet: ${w(s)}`,"Your wallet extension will open so you can approve the wallet to use on Live Terminal."],confirmLabel:"Open Wallet"}))){re("Wallet connection unchanged."),Te("/terminal","terminal");return}try{await Promise.resolve(r.disconnect?.())}catch{}}re(`Opening ${Fe(e,r)}...`);const c=(await r.connect?.({onlyIfTrusted:!1}))?.publicKey||r.publicKey,l=c?.toBase58?.()||c?.toString?.()||"";if(!l)throw new Error("Wallet connected, but no public address was returned.");await Y(a,"Creating secure web profile for connected wallet...");const u=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({publicKey:l,provider:Fe(e,r)})});me(u.user||{...n.user,connectedWallet:u.profile?.connectedWallet||null}),n.connectedWalletBalance={publicKey:l,shortPublicKey:w(l),provider:Fe(e,r),tokens:[]},hi(`connected:${l}`),n.walletConnectMenuOpen=!1,re(`Connected ${w(l)}. Opening Live Terminal...`),Te(t.returnPath||n.walletConnectReturnPath||"/terminal","terminal"),h({force:!0}),mu("browser-wallet-connect"),Ur("browser-wallet-connect")}catch(s){const o=s.message||"Wallet connection was cancelled.";re(o),It(e,s,{action:"connect_failed"})}}async function Sd(){await td("disconnecting");const e=In(),t=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(!n.user||!n.token){n.connectedWalletBalance=null,hi(t?`connected:${t}`:""),re("Connected wallet disconnected."),h({force:!0});return}try{const a=n.user?.connectedWallet?.provider||"";await(a.toLowerCase().includes("phantom")?fe("phantom"):a.toLowerCase().includes("solflare")?fe("solflare"):a.toLowerCase().includes("backpack")?fe("backpack"):fe("solana"))?.disconnect?.()}catch{}try{const a=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({clear:!0})});me(a.user||{...n.user,connectedWallet:null}),n.connectedWalletBalance=null,hi(t?`connected:${t}`:""),re("Connected wallet disconnected."),h({force:!0})}catch(a){re(a.message),$(a.message)}}async function Oy(){const e=m("[data-profile-username]"),t=m("[data-profile-password]"),a=m("[data-login-security-status]"),r=String(e?.value||"").trim(),s=String(t?.value||"");if(!r||!s){v(a,"Enter a username and password first.");return}try{await Y(a,"Creating secure web profile..."),v(a,"Saving login...");const o=await k("/api/web/profile/credentials",{method:"POST",body:JSON.stringify({username:r,password:s})});me(o.user||{...n.user,username:r,hasPasswordLogin:!0}),t&&(t.value=""),v(a,"Saved. You can now log back in with this username and password."),h()}catch(o){v(a,o.message),$(o.message)}}function Je(e){return String(e||"").trim().replace(/^@+/,"").replace(/[^a-z0-9_]/gi,"").slice(0,15)}function Ui(e){const t=ki(e),a=String(n.user?.referralLink||"").trim(),r=a&&!t.includes("/r/")?a:Lt,s=`https://twitter.com/intent/tweet?text=${encodeURIComponent(t)}&url=${encodeURIComponent(r)}`;window.open(s,"_blank","noopener,noreferrer")}function kd(e){const t=e==="kol",a=m(t?"[data-share-watch-kol]":"[data-share-watch-token]"),r=m("[data-share-watch-status]"),s=a?.value?.trim()||"";if(!s){v(r,t?"Enter a KOL handle or wallet first.":"Enter a coin, ticker, or CA first.");return}Ui(t?xu(s):$i(s)),v(r,t?"KOL watch post opened in X.":"Coin watch post opened in X.")}async function $d(e){const t={};n.token&&(t.Authorization=`Bearer ${n.token}`);const a=await Mn(Va(`/api/web/pnl/card?tokenMint=${encodeURIComponent(e)}`),{headers:t,cache:"no-store"},3e4);if(!a.ok){const r=await mc(a);throw new Error(r.message||r.error||`Could not build PnL card (${a.status}).`)}return{blob:await a.blob(),filename:a.headers.get("x-ogre-filename")||`pnl-card-${w(e)}.png`}}async function Td(e){const{blob:t,filename:a}=await $d(e),r=URL.createObjectURL(t),s=document.createElement("a");s.href=r,s.download=a,document.body.appendChild(s),s.click(),s.remove(),setTimeout(()=>URL.revokeObjectURL(r),1e4)}async function Ey(e,t){try{const{blob:a,filename:r}=await $d(e),s=new File([a],r,{type:"image/png"});if(navigator.canShare?.({files:[s]})){await navigator.share({title:"SlimeWire PnL Card",text:ki(t),url:Lt,files:[s]});return}await Td(e),Ui(`${t} PnL card downloaded and ready to attach.`)}catch(a){$(a.message)}}function Ad(e="buy"){const t=m("[data-trade-wallet]")?.value||"",a=vh(e)||m("[data-trade-token]")?.value?.trim()||"",r=x("[data-trade-slippage]","[data-trade-slippage-custom]","400");if(!t)throw new Error("Choose a wallet first.");if(!a)throw new Error("Paste a token CA first.");return n.tradeToken=a,e==="sell"?(n.tradeSwapFrom=a,n.tradeSwapTo="SOL"):(n.tradeSwapFrom="SOL",n.tradeSwapTo=a),{walletIndex:t,tokenMint:a,slippageBps:r}}function ue(e=""){return String(e||"").trim().toLowerCase()==="connected"}function Fy(e={}){if(!e?.sessionWallet||e.sessionStatus!=="funded")return!1;const t=Date.parse(e.sessionExpiresAt||"");return!Number.isFinite(t)||t>Date.now()}function Pd(){const e=Array.isArray(n.wallets)?n.wallets:[];for(let t=e.length-1;t>=0;t-=1)if(Fy(e[t]))return e[t];return null}function Cd(e=ce()){if(!e?.publicKey)return!1;const t=ar(e),a=fe(t)||fe("solana");return!!(a&&typeof a.signTransaction=="function")}function vs(e=ce()){const t=e?.provider||Fe(ar(e));return`${t} is connected, but this mobile browser cannot sign trades after the wallet-app handoff. Open SlimeWire inside the ${t} in-app browser, or fund a Session Wallet once so buys, sells, TP/SL, and Ogre A.I. can run without reconnect loops.`}function ws(e={},{side:t="trade",statusWriter:a=ge,allowSessionFallback:r=!0}={}){if(!ue(e.walletIndex))return{form:e,sessionWallet:null};if(Cd())return{form:e,sessionWallet:null};const s=r?Pd():null;if(s?.index){const o=`Using Session Wallet ${s.index} for ${t}; mobile wallet signing is not available in this browser.`;return typeof a=="function"&&a(o),{form:{...e,walletIndex:String(s.index)},sessionWallet:s}}throw new Error(vs())}function Ld(e){const t=[];for(let r=0;r<e.length;r+=32768)t.push(String.fromCharCode(...e.subarray(r,r+32768)));return btoa(t.join(""))}function xd(e=""){const t=atob(String(e||"")),a=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)a[r]=t.charCodeAt(r);return a}function ar(e=ce()){const t=String(e?.provider||"").trim().toLowerCase();return t.includes("phantom")?"phantom":t.includes("solflare")?"solflare":t.includes("backpack")?"backpack":"solana"}async function Wy(e=ce(),{returnPath:t=ja()||"/terminal/trade"}={}){const a=ar(e),r=e?.provider||Fe(a);if(da({returnPath:t}),Ve()&&e?.publicKey&&!fe(a)){const o=vs(e);return re(o),o}if(Tc(a)){const o=`${r} needs to reconnect before it can sign here. Opening ${r} mobile connect now.`;if(re(o),await Ac(a,{returnPath:t}).catch(()=>!1))return o}if(Pc(a))return`Opening ${r}. Use the wallet browser to reconnect and approve the trade.`;const s=fc(a);return re(s),s}async function Md(){const e=ce();if(!e?.publicKey)throw new Error("Connect Phantom, Solflare, or another wallet before trading.");const t=ar(e),a=fe(t)||fe("solana");if(!a){if(Ve()&&e?.publicKey)throw new Error(vs(e));const o=await Wy(e,{returnPath:ja()||"/terminal/trade"});throw new Error(o)}if(typeof a.signTransaction!="function")throw Ve()&&e?.publicKey?new Error(vs(e)):new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const r=()=>a.publicKey?.toBase58?.()||a.publicKey?.toString?.()||"";let s=r();if(s!==e.publicKey)try{const o=await a.connect?.({onlyIfTrusted:!0});s=o?.publicKey?.toBase58?.()||o?.publicKey?.toString?.()||r()}catch{}if(s!==e.publicKey){const o=await a.connect?.({onlyIfTrusted:!1}),c=o?.publicKey?.toBase58?.()||o?.publicKey?.toString?.()||r();if(c!==e.publicKey)throw new Error(`Wallet mismatch. SlimeWire has ${w(e.publicKey)} connected, but the browser returned ${w(c)}. Reconnect the wallet you want to trade with.`)}return{provider:a,connected:e}}async function _y(){try{if(Ve())return;const e=ce();if(!e?.publicKey)return;const t=ar(e),a=fe(t)||fe("solana");if(!a||typeof a.connect!="function"||(a.publicKey?.toBase58?.()||a.publicKey?.toString?.()||"")===e.publicKey)return;await a.connect({onlyIfTrusted:!0}).catch(()=>{})}catch{}}const Ny=6e4;async function Bd(e,t,a=Ny){let r=0;const s=new Promise((o,c)=>{r=window.setTimeout(()=>{c(new Error("Wallet approval timed out. Reopen your wallet and try the trade again."))},a)});try{return await Promise.race([Promise.resolve(e.signTransaction(t)),s])}finally{window.clearTimeout(r)}}async function Dy(e,t){if(!e||typeof e!="string")throw new Error("SlimeWire could not build a wallet approval transaction. Try again or choose another token.");if(!window.solanaWeb3?.VersionedTransaction)throw new Error("Solana wallet signing library did not load. Refresh the page and try again.");if(typeof t.signTransaction!="function")throw new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const a=window.solanaWeb3.VersionedTransaction.deserialize(xd(e)),r=await Bd(t,a);return Ld(r.serialize())}async function Uy(e,t){if(!e||typeof e!="string")throw new Error("SlimeWire could not build a wallet approval transaction. Try again.");if(!window.solanaWeb3?.Transaction)throw new Error("Solana wallet signing library did not load. Refresh the page and try again.");if(typeof t.signTransaction!="function")throw new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const a=window.solanaWeb3.Transaction.from(xd(e)),r=await Bd(t,a);return Ld(r.serialize())}function qy({side:e,connected:t,form:a={},actionDetail:r="",amountSol:s="",amountMode:o="",percent:c=""}={}){const l=e==="sell"?"Sell":"Buy",u=`${t?.provider||"Connected wallet"} ${t?.publicKey?w(t.publicKey):""}`.trim(),d=e==="sell"?`${c||r||"100"}%`:o==="max"?"Max SOL":`${s||r||"custom"} SOL`;return xe({title:`Confirm ${l}`,lines:[`${l} with ${u}?`,`Token: ${a.tokenMint||""}`,`Amount: ${d}`,"Next step: approve the transaction in your wallet."],confirmLabel:l})}async function nr({side:e,form:t,actionDetail:a,amountSol:r="",amountMode:s="",percent:o="",attemptId:c,statusWriter:l=ge}){const u=typeof l=="function"?l:ge,{provider:d,connected:p}=await Md();if(!n.walletFastApprovalsEnabled&&!await qy({side:e,connected:p,form:t,actionDetail:a,amountSol:r,amountMode:s,percent:o}))throw new Error("Connected-wallet trade cancelled.");hm(`${e==="buy"?"Buy":"Sell"} ${w(t.tokenMint||"")}`),Re("submitted","pending"),u(n.walletFastApprovalsEnabled?`Building ${e} approval for ${p.provider||"your wallet"}...`:`Preparing ${e} approval...`);const f=await k("/api/web/browser-trade/order",{method:"POST",body:JSON.stringify({side:e,tokenMint:t.tokenMint,walletPublicKey:p.publicKey,slippageBps:t.slippageBps,amountSol:r,amountMode:s,percent:o,tradeAttemptId:c}),dedupe:!1,timeoutMs:te});Re("submitted","ok"),Re("approved","pending",`Approve in ${p.provider||"your wallet"}`),u(`Approve ${e} in ${p.provider||"your wallet"}...`);let y;try{y=await Dy(f.order?.transaction,d)}catch(S){throw Re("approved","fail",N(S?.message||"Wallet approval was declined.")),S}Re("approved","ok"),Re("sent","pending"),u("Submitting signed trade...");let g;try{g=await k("/api/web/browser-trade/execute",{method:"POST",body:JSON.stringify({browserTradeAttemptId:f.order?.browserTradeAttemptId,signedTransaction:y}),dedupe:!1,timeoutMs:te})}catch(S){throw V(e==="buy"?"trade-buy":"trade-sell",t.tokenMint,a,{state:"error",error:N(S?.message||"Trade submit failed.")}),K("",`browser-${e}-error`,{tradeAttemptId:c}),Re("sent","fail",N(S?.message||"Submit failed - it may still have landed; positions are being re-checked.")),u(`${e==="buy"?"Buy":"Sell"} submit failed or timed out - re-checking your wallet in case the trade landed...`),S}return Re("sent","ok"),Re("confirmed",g.trade?.signature?"ok":"pending",g.trade?.signature?`tx ${String(g.trade.signature).slice(0,8)}...`:""),n.tradeResult=g.trade,u(g.trade?.message||`${e==="buy"?"Buy":"Sell"} submitted from connected wallet.`),V(e==="buy"?"trade-buy":"trade-sell",t.tokenMint,a,{state:"submitted",signature:g.trade?.signature||""}),K(g.trade?.signature,`browser-${e}`,{tradeAttemptId:c}),g.trade}function Ue(e){const t=String(e||"").trim().toLowerCase();return!!t&&!["0","off","none","no","disabled"].includes(t)}function on(e,t){const a=String(t||"").trim().toLowerCase();return["0","off","none","no","disabled"].includes(a)?{sellDelay:"off",sellPercent:"100"}:{sellDelay:e,sellPercent:t}}function Hy(){const e=x("[data-trade-auto-tp]","[data-trade-auto-tp-custom]","25"),t=x("[data-trade-auto-sl]","[data-trade-auto-sl-custom]","8");let a=x("[data-trade-auto-delay]","[data-trade-auto-delay-custom]","off"),r=x("[data-trade-auto-sell-percent]","[data-trade-auto-sell-percent-custom]","100");return{sellDelay:a,sellPercent:r}=on(a,r),{enabled:Ue(e)||Ue(t)||Ue(a),takeProfitPct:e,stopLossPct:t,sellDelay:a,sellPercent:r}}function Rd(){const e=x("[data-chart-buy-tp]","[data-chart-buy-tp-custom]","25"),t=x("[data-chart-buy-sl]","[data-chart-buy-sl-custom]","8");let a=x("[data-chart-buy-delay]","[data-chart-buy-delay-custom]","off"),r=x("[data-chart-buy-sell-percent]","[data-chart-buy-sell-percent-custom]","100");return{sellDelay:a,sellPercent:r}=on(a,r),{enabled:Ue(e)||Ue(t)||Ue(a),takeProfitPct:e,stopLossPct:t,sellDelay:a,sellPercent:r}}function ge(e){const t=m("[data-trade-status]");v(t,e)}function We(e=""){n.chartTradeStatus=String(e||""),v(m("[data-chart-trade-status]"),n.chartTradeStatus)}function qi(e="",t=""){n.quickBuyModal={...n.quickBuyModal,status:String(e||""),error:String(t||"")};const a=m("[data-quick-buy-modal-status]"),r=m("[data-quick-buy-modal-error]");v(a,n.quickBuyModal.status),v(r,n.quickBuyModal.error),a&&(a.hidden=!n.quickBuyModal.status),r&&(r.hidden=!n.quickBuyModal.error)}async function Ss(e,t="fixed"){const a=L();let r=t==="max"?"max":String(e||"custom"),s="";try{let o=Ad("buy");r=t==="max"?"max":String(e||"custom");const c=at("trade-buy",o.tokenMint,r);if(c){ne("buttonDoubleClickPrevented"),W({component:"post-trade",action:"trade-action-dedupe",durationMs:L()-a,cacheHit:!0,requestId:c.tradeAttemptId||"",details:`trade-buy:${w(o.tokenMint)}:${r}`});return}s=bt("trade-buy");const l={tokenMint:o.tokenMint,walletIndex:o.walletIndex,slippageBps:o.slippageBps,tradeAttemptId:s},u=Dd();if((Ue(u.takeProfitPct)||Ue(u.stopLossPct)||Ue(u.sellDelay))&&Object.assign(l,{autoExit:!0,...u}),t==="max")l.amountMode="max";else{const S=Number(e);if(!Number.isFinite(S)||S<=0)throw new Error("Enter a buy amount greater than zero.");l.amountSol=String(S)}if(o=ws(o,{side:"buy",statusWriter:ge}).form,l.walletIndex=o.walletIndex,ue(o.walletIndex)){V("trade-buy",o.tokenMint,r,{state:"clicked",tradeAttemptId:s,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"browser-trade-click-to-ui",durationMs:L()-a,requestId:s,details:`browser-buy:${w(o.tokenMint)}:${r}`}),ge("Building wallet-approved buy..."),le(),await nr({side:"buy",form:o,actionDetail:r,amountSol:l.amountSol||"",amountMode:l.amountMode||"fixed",attemptId:s}),n.activeTab="trade",h({preserveSmartChartFrame:n.activeTab==="smartChart"}),Ce("trade-buy",o.tokenMint,r,3e3);return}const f=Hy();f.enabled&&Object.assign(l,{autoExit:!0,takeProfitPct:f.takeProfitPct,stopLossPct:f.stopLossPct,sellDelay:f.sellDelay,sellPercent:f.sellPercent}),V("trade-buy",o.tokenMint,r,{state:"clicked",tradeAttemptId:s,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"trade-click-to-ui",durationMs:L()-a,requestId:s,details:`trade-buy:${w(o.tokenMint)}:${r}`}),h(),ge(f.enabled?"Sending buy and arming auto-exit...":"Sending buy..."),await Le(20);const y=L();V("trade-buy",o.tokenMint,r,{state:"submitting"});const g=await k("/api/web/trade/buy",{method:"POST",body:JSON.stringify({...l,clientClickToUiMs:Math.round(y-a)}),dedupe:!1});W({component:"post-trade",action:"trade-backend-ack",durationMs:L()-y,requestId:s,resultCount:g.trade?.signature?1:0,details:"trade-buy"}),n.tradeResult=g.trade,hm(`Buy ${w(o.tokenMint||"")}`),Re("submitted","ok"),Re("sent","ok"),Re("confirmed",g.trade?.signature?"ok":"pending",g.trade?.signature?`tx ${String(g.trade.signature).slice(0,8)}...`:""),g.trade?.autoExitPlan?(Re("armed","ok"),n.tradePlanResult=g.trade.autoExitPlan,ge(g.trade.autoExitPlan.shortMessage||"Buy landed and auto-exit is armed."),bs()):g.trade?.autoExitRequested&&(Re("armed","fail","Auto-exit was NOT armed - exit manually or create a managed plan."),ge("Buy landed, but auto-exit was not armed. Use Positions to exit manually or create a managed plan.")),V("trade-buy",o.tokenMint,r,{state:"submitted",signature:g.trade?.signature||""}),K(g.trade?.signature,"trade-buy",{tradeAttemptId:s}),n.activeTab="trade",h(),Ce("trade-buy",o.tokenMint,r,3e3)}catch(o){s&&(V("trade-buy",n.tradeToken||m("[data-trade-token]")?.value||"",r,{state:"error",error:N(o.message||"Buy failed")}),Ce("trade-buy",n.tradeToken||m("[data-trade-token]")?.value||"",r,4e3)),W({component:"post-trade",action:"trade-action-error",durationMs:L()-a,requestId:s,errorCode:o?.code||o?.name||"TRADE_BUY_FAILED",details:N(o.message||"Buy failed")}),ge(o.message)}}async function Hi(e){const t=L(),a=bt("manual-sell");let r=null,s=String(e||"custom");try{r=Ad("sell");const o=Number.parseInt(e,10);if(s=String(o||s),!Number.isInteger(o)||o<1||o>100)throw new Error("Sell percent must be from 1 to 100.");const c=at("trade-sell",r.tokenMint,s);if(c){ne("buttonDoubleClickPrevented"),W({component:"manual-sell",action:"manual-sell-dedupe",durationMs:L()-t,cacheHit:!0,requestId:c.tradeAttemptId||"",details:`${w(r.tokenMint)}:${o}`});return}if(V("trade-sell",r.tokenMint,s,{state:"clicked",tradeAttemptId:a,clickedAt:new Date().toISOString()}),ge("Sending sell..."),W({component:"manual-sell",action:"manual-sell-click-to-ui",durationMs:L()-t,requestId:a,details:`${w(r.tokenMint)}:${o}`}),r=ws(r,{side:"sell",statusWriter:ge}).form,ue(r.walletIndex)){le();const p=L();V("trade-sell",r.tokenMint,s,{state:"submitting"}),await nr({side:"sell",form:r,actionDetail:s,percent:String(o),attemptId:a}),W({component:"manual-sell",action:"browser-sell-request",durationMs:L()-p,requestId:a,resultCount:n.tradeResult?.signature?1:0,details:"browser-wallet"}),n.activeTab="trade",h({preserveSmartChartFrame:n.activeTab==="smartChart"}),Ce("trade-sell",r.tokenMint,s,3e3);return}h(),await Le(20);const u=L();V("trade-sell",r.tokenMint,s,{state:"submitting"});const d=await k("/api/web/trade/sell",{method:"POST",body:JSON.stringify({tokenMint:r.tokenMint,walletIndex:r.walletIndex,slippageBps:r.slippageBps,percent:o,manualSellAttemptId:a,clientClickToUiMs:Math.round(u-t)}),timeoutMs:te,dedupe:!1});W({component:"manual-sell",action:"manual-sell-request",durationMs:L()-u,requestId:a,resultCount:d.trade?.signature?1:0,details:"single-wallet"}),n.tradeResult=d.trade,ge(d.trade?.signature?"Submitted. Refreshing position in the background...":"Sell submitted. Refreshing position in the background..."),V("trade-sell",r.tokenMint,s,{state:"submitted",signature:d.trade?.signature||""}),K(d.trade?.signature||Me(d.trade),"manual-sell-trade"),n.activeTab="trade",h(),Ce("trade-sell",r.tokenMint,s,3e3)}catch(o){r?.tokenMint&&(V("trade-sell",r.tokenMint,s,{state:"error",error:N(o.message||"Sell failed")}),Ce("trade-sell",r.tokenMint,s,4e3)),W({component:"manual-sell",action:"manual-sell-error",durationMs:L()-t,requestId:a,errorCode:o?.code||o?.name||"MANUAL_SELL_FAILED",details:N(o.message||"Sell failed")}),ge(o.message)}}function Ky(){const e=qe("trade-plan"),t=m("[data-trade-plan-group]")?.value?.trim()||"",a=m("[data-trade-token]")?.value?.trim()||"",r=x("[data-trade-plan-amount]","[data-trade-plan-amount-custom]","0.1"),s=x("[data-trade-plan-tp]","[data-trade-plan-tp-custom]","25"),o=x("[data-trade-plan-sl]","[data-trade-plan-sl-custom]","8");let c=x("[data-trade-plan-delay]","[data-trade-plan-delay-custom]","5"),l=x("[data-trade-plan-sell-percent]","[data-trade-plan-sell-percent-custom]","100");({sellDelay:c,sellPercent:l}=on(c,l));const u=x("[data-trade-plan-slippage]","[data-trade-plan-slippage-custom]","400");if(!e.length&&!t)throw new Error("Choose at least one wallet or enter a group label.");if(!a)throw new Error("Paste a token CA first.");return n.tradeToken=a,n.volumeToken=a,n.bundleToken=a,{walletIndexes:e,walletGroup:t,tokenMint:a,amountSol:r,sellDelay:c,takeProfitPct:s,stopLossPct:o,sellPercent:l,loopCount:"1",loopDelay:"0",slippageBps:u,...fa("trade-plan")}}async function Vy(){try{const e=Ky();ge("Buying and arming managed exit...");const t=await k("/api/web/trade/plan",{method:"POST",body:JSON.stringify(e)});n.tradePlanResult=t.plan,n.tradeResult=null,K(t.trade?.signature,"trade-plan"),n.activeTab="trade",h()}catch(e){ge(e.message)}}function zy(){const e=qe("volume"),t=m("[data-volume-group]")?.value?.trim()||"",a=m("[data-volume-token]")?.value?.trim()||"",r=m("[data-volume-amount]")?.value||"";let s=x("[data-volume-delay]","[data-volume-delay-custom]","5");const o=x("[data-volume-tp]","[data-volume-tp-custom]","25"),c=x("[data-volume-sl]","[data-volume-sl-custom]","8"),l=x("[data-volume-loop]","[data-volume-loop-custom]","1"),u=x("[data-volume-loop-delay]","[data-volume-loop-delay-custom]","0");let d=x("[data-volume-sell-percent]","[data-volume-sell-percent-custom]","100");({sellDelay:s,sellPercent:d}=on(s,d));const p=x("[data-volume-slippage]","[data-volume-slippage-custom]","400");if(!e.length&&!t)throw new Error("Choose at least one wallet or enter a group label.");if(!a)throw new Error("Paste a token CA first.");return n.volumeToken=a,{walletIndexes:e,walletGroup:t,tokenMint:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,loopCount:l,loopDelay:u,sellPercent:d,slippageBps:p,...fa("volume")}}function Id(e){const t=m("[data-volume-status]");v(t,e)}async function jy(){try{const e=zy();Id("Buying and arming plan...");const t=await k("/api/web/volume/plan",{method:"POST",body:JSON.stringify(e)});n.volumeResult=t.plan,K(Me(t.plan),"volume-plan"),n.activeTab="volume",h()}catch(e){Id(e.message)}}function Gy(e){const t=qe("sniper"),a=m("[data-sniper-group]")?.value?.trim()||"",r=m("[data-sniper-amount]")?.value||"",s=x("[data-sniper-delay]","[data-sniper-delay-custom]",n.scanMode==="pumpsnipe"?"3":"5"),o=x("[data-sniper-tp]","[data-sniper-tp-custom]",n.scanMode==="pumpsnipe"?"40":"25"),c=x("[data-sniper-sl]","[data-sniper-sl-custom]","8"),l=x("[data-sniper-loop]","[data-sniper-loop-custom]","1"),u=x("[data-sniper-loop-delay]","[data-sniper-loop-delay-custom]","0"),d=x("[data-sniper-slippage]","[data-sniper-slippage-custom]",n.scanMode==="pumpsnipe"?"300":"400");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!e)throw new Error("Pick a token first.");return n.tradeToken=e,n.volumeToken=e,n.bundleToken=e,{mode:n.scanMode,tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,slippageBps:d,loopCount:l,loopDelay:u,...fa("sniper")}}function Od(e){const t=m("[data-sniper-status]");v(t,e)}async function Xy(e){try{const t=Gy(e);Od("Buying and arming exits...");const a=await k("/api/web/sniper/entry",{method:"POST",body:JSON.stringify(t)});n.sniperResult=a.plan,K(Me(a.plan),"sniper-entry"),n.activeTab="sniper",h()}catch(t){Od(t.message)}}function Jy(){const e=qe("ogre-ai"),t=m("[data-ogre-ai-group]")?.value?.trim()||"",a=m("[data-ogre-ai-amount]")?.value?.trim()||"",r=as(),s=m("[data-ogre-ai-runs]")?.value||"1",o=m("[data-ogre-ai-tp]")?.value||"25",c=m("[data-ogre-ai-tp-custom]")?.value?.trim()||"",l=m("[data-ogre-ai-sl]")?.value||"8",u=m("[data-ogre-ai-sl-custom]")?.value?.trim()||"",d=m("[data-ogre-ai-delay]")?.value||"5",p=m("[data-ogre-ai-delay-custom]")?.value?.trim()||"",f=m("[data-ogre-ai-slippage]")?.value||"400",y=m("[data-ogre-ai-slippage-custom]")?.value?.trim()||"";nf({amountSol:a,runCount:s,category:r,takeProfitSelect:o,takeProfitCustom:c,stopLossSelect:l,stopLossCustom:u,delaySelect:d,delayCustom:p,slippageSelect:f,slippageCustom:y,walletGroup:t});const g=x("[data-ogre-ai-delay]","[data-ogre-ai-delay-custom]","60"),S=x("[data-ogre-ai-tp]","[data-ogre-ai-tp-custom]","100"),A=x("[data-ogre-ai-sl]","[data-ogre-ai-sl-custom]","40"),T=x("[data-ogre-ai-slippage]","[data-ogre-ai-slippage-custom]","400"),b="";if(!e.length&&!t)throw new Error("Choose at least one managed wallet or enter a group label.");if(!a)throw new Error("Enter SOL per wallet for Ogre A.I.");return{walletIndexes:e,walletGroup:t,category:r,mode:r,amountSol:a,runCount:s,sellDelay:g,takeProfitPct:S,stopLossPct:A,sellPercent:"100",slippageBps:T,minScore:b,recentMints:Gl()}}function ks(e){n.ogreAiStatus=e||"";const t=m("[data-ogre-ai-status]");v(t,n.ogreAiStatus)}async function Yy(){if(Rr){_a=!0,ks("Stopping the hunt after this scan...");return}const e=Symbol("ogre-ai-run");_a=!1;try{const t=Jy();n.ogreAiLoading=!0,Rr=e;const a=Array.isArray(t.recentMints)?[...t.recentMints]:[];let r=null,s=!1,o=0;const c=120;for(;!s&&!_a&&o<c&&(o+=1,ks(o===1?"Scanning fresh low-MC pairs and arming managed exits...":`Hunting fresh pairs... (scan ${o}) - tap Scan again to stop.`),h(),r=await k("/api/web/ogre-ai/start",{method:"POST",body:JSON.stringify({...t,recentMints:a}),timeoutMs:te}),s=Number(r.ogreAi?.armedCount||0)>0||(r.ogreAi?.plans?.length||0)>0,!s);){for(const l of r.ogreAi?.errors||[])l?.tokenMint&&!a.includes(l.tokenMint)&&a.push(l.tokenMint);for(const l of r.ogreAi?.attemptedPicks||[])l?.tokenMint&&!a.includes(l.tokenMint)&&a.push(l.tokenMint);if(_a)break;await Le(5e3)}n.ogreAiResult=r?.ogreAi,af(r?.ogreAi),n.tradePlanResult=r?.ogreAi?.plans?.[0]||n.tradePlanResult,ks(s?r?.ogreAi?.message||"Ogre A.I. run armed.":_a?"Hunt stopped. Tap Scan to hunt again.":"Still hunting - no clean fresh pair armed yet. Tap Scan to keep going."),s&&K(Me(r?.ogreAi?.plans?.[0]),"ogre-ai-run"),n.activeTab="ogreAi",h()}catch(t){ks(t.message),$(t.message)}finally{n.ogreAiLoading=!1,_a=!1,Rr===e&&(Rr=null),h()}}function rr(e){const t=m("[data-autopilot-status]");t&&(t.textContent=String(e||""))}async function Qy({silent:e=!0}={}){try{const t=await k("/api/web/ogre-ai/autopilot");n.ogreAutopilot=t.autopilot||null,n.activeTab==="ogreAi"&&h()}catch(t){e||rr(t.message)}}function Zy(){return{enabled:!!m("[data-autopilot-enabled]")?.checked,category:as(),amountSol:m("[data-ogre-ai-amount]")?.value?.trim()||(n.ogreAutopilot?.amountSol??"0.05"),takeProfitPct:x("[data-ogre-ai-tp]","[data-ogre-ai-tp-custom]","25"),stopLossPct:x("[data-ogre-ai-sl]","[data-ogre-ai-sl-custom]","8"),sellDelay:x("[data-ogre-ai-delay]","[data-ogre-ai-delay-custom]","5"),slippageBps:x("[data-ogre-ai-slippage]","[data-ogre-ai-slippage-custom]","400"),walletIndexes:qe("ogre-ai"),walletGroup:m("[data-ogre-ai-group]")?.value?.trim()||"",maxSpendPerHourSol:m("[data-autopilot-maxspend]")?.value?.trim()||"0.3",maxConcurrent:m("[data-autopilot-maxconcurrent]")?.value?.trim()||"2",minScore:m("[data-autopilot-minscore]")?.value?.trim()||"62",intervalMinutes:m("[data-autopilot-interval]")?.value?.trim()||"10"}}async function ev(){if(n.ogreAutopilotBusy)return;const e=Zy();if(e.enabled&&!e.walletIndexes.length&&!e.walletGroup){rr("Pick at least one managed wallet (or a wallet group) above before enabling autopilot.");return}if(!(e.enabled&&!await xe({title:"Enable Ogre A.I. Autopilot",lines:["This will spend REAL SOL automatically.",`Category: ${Gu(e.category)}`,`Up to ${e.amountSol} SOL per wallet, max ${e.maxSpendPerHourSol} SOL/hour, every ${e.intervalMinutes} min.`,`Only buys picks scoring >= ${e.minScore}, max ${e.maxConcurrent} live plans.`,"You can turn it off any time."],confirmLabel:"Enable Autopilot"}))){n.ogreAutopilotBusy=!0,rr(e.enabled?"Arming autopilot...":"Saving..."),h();try{const t=await k("/api/web/ogre-ai/autopilot",{method:"POST",body:JSON.stringify(e)});n.ogreAutopilot=t.autopilot||null,rr(n.ogreAutopilot?.lastStatus||"Saved.")}catch(t){rr(t.message),$(t.message)}finally{n.ogreAutopilotBusy=!1,h()}}}function Ut(e){const t=m("[data-kol-status]");v(t,e)}function tv(e){const t=qe("kol"),a=m("[data-kol-group]")?.value?.trim()||"",r=m("[data-kol-amount]")?.value||"",s=x("[data-kol-delay]","[data-kol-delay-custom]","5"),o=x("[data-kol-tp]","[data-kol-tp-custom]","25"),c=x("[data-kol-sl]","[data-kol-sl-custom]","8"),l=x("[data-kol-loop]","[data-kol-loop-custom]","1"),u=x("[data-kol-loop-delay]","[data-kol-loop-delay-custom]","0"),d=x("[data-kol-slippage]","[data-kol-slippage-custom]","400");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!e)throw new Error("Pick a KOL signal first.");return n.tradeToken=e,n.volumeToken=e,n.bundleToken=e,{tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,loopCount:l,loopDelay:u,sellPercent:"100",slippageBps:d,...fa("kol")}}function av(e){const t=qe("kol"),a=m("[data-kol-group]")?.value?.trim()||"",r=m("[data-kol-amount]")?.value||"",s=x("[data-kol-delay]","[data-kol-delay-custom]","5"),o=x("[data-kol-tp]","[data-kol-tp-custom]","25"),c=x("[data-kol-sl]","[data-kol-sl-custom]","8"),l=x("[data-kol-loop]","[data-kol-loop-custom]","1"),u=x("[data-kol-loop-delay]","[data-kol-loop-delay-custom]","0"),d=x("[data-kol-slippage]","[data-kol-slippage-custom]","400"),p=String(e||n.kolWallet||m("[data-kol-wallet]")?.value||"").trim();if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!p)throw new Error("Paste or choose a KOL wallet first.");if(!_t(p))throw new Error("That KOL entry does not have a verified Solana wallet yet.");return{copyWallet:p,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,loopCount:l,loopDelay:u,sellPercent:"100",slippageBps:d,...fa("kol")}}async function nv(e){try{const t=tv(e);Ut("Buying and arming KOL copy plan...");const a=await k("/api/web/kol/entry",{method:"POST",body:JSON.stringify(t)});n.kolResult=a.plan,K(Me(a.plan),"kol-copy-plan"),n.activeTab="kol",h()}catch(t){Ut(t.message)}}async function rv(e){try{const t=av(e);Ut("Arming Copy Wallet watch...");const a=await k("/api/web/kol/copy-wallet",{method:"POST",body:JSON.stringify(t)});n.kolResult=a.plan,n.kolWallet=t.copyWallet,n.activeTab="kol",h()}catch(t){Ut(t.message)}}function qe(e){return[...document.querySelectorAll(`[data-${e}-wallet]:checked`)].map(t=>t.value)}function $s(e){const t=m("[data-bundle-status]");v(t,e)}function Ed(){const e=m("[data-bundle-token]")?.value?.trim()||"",t=qe("bundle"),a=m("[data-bundle-group]")?.value?.trim()||"",r=m("[data-bundle-amount]")?.value||"",s=x("[data-bundle-percent]","[data-bundle-percent-custom]","100"),o=x("[data-bundle-slippage]","[data-bundle-slippage-custom]","400");if(!e)throw new Error("Paste a token CA first.");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");return n.bundleToken=e,{tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,percent:s,slippageBps:o}}function sv(){const e=Ed();let t=x("[data-bundle-plan-delay]","[data-bundle-plan-delay-custom]","5"),a=x("[data-bundle-plan-sell-percent]","[data-bundle-plan-sell-percent-custom]","100");return{sellDelay:t,sellPercent:a}=on(t,a),{...e,sellDelay:t,takeProfitPct:x("[data-bundle-plan-tp]","[data-bundle-plan-tp-custom]","60"),stopLossPct:x("[data-bundle-plan-sl]","[data-bundle-plan-sl-custom]","10"),loopCount:x("[data-bundle-plan-loop]","[data-bundle-plan-loop-custom]","1"),loopDelay:x("[data-bundle-plan-loop-delay]","[data-bundle-plan-loop-delay-custom]","0"),sellPercent:a,...fa("bundle-plan")}}async function Fd(e){const t=L();let a=null,r="";const s=e==="buy"?"bundle-buy":"bundle-sell";try{a=Ed();const o=at(s,a.tokenMint,"bundle");if(o){ne("buttonDoubleClickPrevented"),W({component:"post-trade",action:"trade-action-dedupe",durationMs:L()-t,cacheHit:!0,requestId:o.tradeAttemptId||"",details:`${s}:${w(a.tokenMint)}`});return}r=bt(s),V(s,a.tokenMint,"bundle",{state:"clicked",tradeAttemptId:r,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"trade-click-to-ui",durationMs:L()-t,requestId:r,details:`${s}:${w(a.tokenMint)}`}),h(),$s(e==="buy"?"Sending bundle buy...":"Sending bundle sell..."),await Le(20);const c=L();V(s,a.tokenMint,"bundle",{state:"submitting"});const l=await k(`/api/web/bundle/${e}`,{method:"POST",body:JSON.stringify({...a,tradeAttemptId:r,clientClickToUiMs:Math.round(c-t)}),dedupe:!1});W({component:"post-trade",action:"trade-backend-ack",durationMs:L()-c,requestId:r,resultCount:l.bundle?.successCount||0,details:s}),n.bundleResult=l.bundle,V(s,a.tokenMint,"bundle",{state:"submitted",signature:Me(l.bundle)}),K(Me(l.bundle),`bundle-${e}`,{tradeAttemptId:r}),n.activeTab="bundle",h(),Ce(s,a.tokenMint,"bundle",3e3)}catch(o){a?.tokenMint&&(V(s,a.tokenMint,"bundle",{state:"error",error:N(o.message||"Bundle trade failed")}),Ce(s,a.tokenMint,"bundle",4e3)),W({component:"post-trade",action:"trade-action-error",durationMs:L()-t,requestId:r,errorCode:o?.code||o?.name||"BUNDLE_TRADE_FAILED",details:N(o.message||"Bundle trade failed")}),$s(o.message)}}async function ov(){try{const e=sv();$s("Buying and arming bundle exits...");const t=await k("/api/web/bundle/plan",{method:"POST",body:JSON.stringify(e)});n.bundleResult=t.plan,K(Me(t.plan),"bundle-plan"),n.activeTab="bundle",h()}catch(e){$s(e.message)}}function oe(e,t){return(n.presets?.[e]||[]).find(a=>a.id===t)||null}function Wd(){(n.selectedTradePresetId==="custom"||n.selectedTradePresetId&&!oe("trade",n.selectedTradePresetId))&&(n.selectedTradePresetId=""),(n.selectedBundlePresetId==="custom"||n.selectedBundlePresetId&&!oe("bundle",n.selectedBundlePresetId))&&(n.selectedBundlePresetId=""),n.editingTradePresetId&&!oe("trade",n.editingTradePresetId)&&(n.editingTradePresetId=""),n.editingBundlePresetId&&!oe("bundle",n.editingBundlePresetId)&&(n.editingBundlePresetId="")}function _d(e,t="trade",a=""){t==="bundle"?n.bundleToken=e:n.tradeToken=e,n.activeTab=t,a&&$(a),window.history.pushState({},"","/terminal"),h({force:!0})}async function Nd(e=""){const t=String(e||"").trim();if(!t)return;const a=t.replace(/^\$+/,"").trim(),r=/^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(a),s=(o,c={})=>St(be(o,{source:"global-search",...c}),{defaultTab:"buy",view:"chartTxns",focusAmountInput:!0,source:"global-search"});if(r){s(a);return}try{const c=((await k(`/api/web/token-search?q=${encodeURIComponent(t)}`)).matches||[])[0];if(!c?.tokenMint){$(`No coin found for "${t}". Try the exact ticker or paste the contract address.`);return}s(c.tokenMint,{symbol:c.symbol,name:c.name})}catch(o){$(o.message||"Token search failed.")}}function be(e="",t={}){const a=String(e||"").trim(),r=a?sr().find(s=>String(s?.tokenMint||"")===a):null;return{chain:"solana",tokenMint:a,tokenAddress:a,mint:a,pairAddress:r?.pairAddress||r?.pairId||t.pairAddress||"",symbol:r?.symbol||t.symbol||w(a),name:r?.name||t.name||"Token",imageUri:r?.imageUrl||t.imageUri||"",source:t.source||r?.source||r?.category||"",dex:r?.dexId||t.dex||"",pool:r?.pool||t.pool||"",pumpUrl:r?.pumpUrl||t.pumpUrl||"",isPump:!!(r?.isPump||t.isPump||a.toLowerCase().endsWith("pump")),graduated:!!(r?.graduated||r?.isGraduated||r?.bonded||r?.isBonded||t.graduated||t.isGraduated||t.bonded||t.isBonded),isGraduated:!!(r?.isGraduated||r?.graduated||r?.bonded||r?.isBonded||t.isGraduated||t.graduated||t.bonded||t.isBonded),bonded:!!(r?.bonded||r?.isBonded||r?.graduated||r?.isGraduated||t.bonded||t.isBonded||t.graduated||t.isGraduated),isBonded:!!(r?.isBonded||r?.bonded||r?.graduated||r?.isGraduated||t.isBonded||t.bonded||t.graduated||t.isGraduated)}}function Qk(e={},t={}){return be(e?.tokenMint||e?.mint||e?.tokenAddress||"",{...t,pairAddress:e?.pairAddress||e?.pairId||t.pairAddress||"",symbol:e?.symbol||t.symbol||"",name:e?.name||t.name||"",imageUri:e?.imageUrl||e?.imageUri||t.imageUri||"",source:t.source||e?.source||e?.category||"",dex:e?.dexId||t.dex||"",pool:e?.pool||t.pool||"",pumpUrl:e?.pumpUrl||t.pumpUrl||"",isPump:e?.isPump||t.isPump,graduated:e?.graduated||e?.isGraduated||e?.bonded||e?.isBonded||t.graduated||t.isGraduated||t.bonded||t.isBonded,isGraduated:e?.isGraduated||e?.graduated||e?.bonded||e?.isBonded||t.isGraduated||t.graduated||t.bonded||t.isBonded,bonded:e?.bonded||e?.isBonded||e?.graduated||e?.isGraduated||t.bonded||t.isBonded||t.graduated||t.isGraduated,isBonded:e?.isBonded||e?.bonded||e?.graduated||e?.isGraduated||t.isBonded||t.bonded||t.graduated||t.isGraduated})}function Ts(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim();return t?(n.smartChartTokenRef={...e,tokenMint:t,tokenAddress:t,mint:t},Os(n.smartChartTokenRef),n.terminalToken=t,n.terminalAutoToken=t,n.tradeToken=t,n.bundleToken=t,n.volumeToken=t,n.smartChartToken=t,t):""}function iv(e,t={}){const a=new URLSearchParams;a.set("token",e);const r=t.defaultTab==="sell"?"sell":t.defaultTab==="chart"?"chart":"buy";return a.set("tab",r),["chart","chartTxns","txns","info"].includes(t.view)&&a.set("view",t.view),t.focusAmountInput&&a.set("focusAmount","1"),t.source&&a.set("source",String(t.source).slice(0,40)),t.returnTo&&a.set("returnTo",t.returnTo),`/terminal/chart?${a.toString()}`}function Ki(e={}){const t=String(e?.tokenMint||e?.mint||e?.tokenAddress||"").trim(),a=`${e?.source||""} ${e?.category||""} ${e?.dex||""} ${e?.pool||""}`.toLowerCase(),r=!!(e?.isPump||e?.pumpUrl||t.toLowerCase().endsWith("pump")||a.includes("pump")),s=!!(e?.graduated||e?.isGraduated||e?.bonded||e?.isBonded||e?.complete||e?.completed||e?.bondingComplete||e?.raydiumPool||e?.poolAddress);return!!(r&&!s)}function lv(e={},t={}){return["chart","chartTxns","txns","info"].includes(t.view)?t.view:"chartTxns"}const As=new Map;function Vi(e){const t=String(e||"").trim();if(!t)return;const a=As.get(t)||0;Date.now()-a<3e4||(As.set(t,Date.now()),As.size>200&&As.clear(),k(`/api/web/prebuy-warm?mint=${encodeURIComponent(t)}`,{method:"GET"}).catch(()=>{}))}function St(e={},t={}){ra("chartRouteStart");const a=L(),r=Ts(e);if(!r){$("Select a token before opening the chart.");return}Zi(e,{source:t.source||"token-entry"}),Vi(r),n.chartTradeTab=t.defaultTab==="sell"?"sell":(t.defaultTab==="chart","buy"),n.smartChartView=lv(n.smartChartTokenRef||e,t),n.chartFocusAmountInput=!!t.focusAmountInput,n.chartScrollIntoView=!0,n.activeTab="smartChart",n.route="terminal",n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},n.chartTradeStatus="",n.chartBuyWalletIndex="";const s=iv(r,{defaultTab:t.defaultTab||"buy",view:n.smartChartView,focusAmountInput:t.focusAmountInput,source:t.source||"token-entry",returnTo:t.returnTo||ja()});window.history.pushState({},"",s),h({force:!0}),H("chart-route-open",a,{component:"smartChart",cacheHit:!!(Ye(r)?.cacheHit||lr(r)?.pairAddress),details:`${r}:${t.source||"token-entry"}`})}function zi(){if(!window.location.pathname.includes("/terminal/chart"))return;ra("chartRouteStart");const e=L(),t=new URLSearchParams(window.location.search||""),a=String(t.get("token")||t.get("mint")||"").trim(),r=String(n.smartChartToken||"").trim();if(a){const s=be(a,{source:t.get("source")||"route"});Ts(s),Zi(s,{source:t.get("source")||"route"}),t.get("buy")==="1"&&window.setTimeout(()=>{try{ln(s,{forceModal:!0,source:"deep-link"})}catch{}},900),a!==r&&(n.chartTradeStatus="",n.chartBuyWalletIndex="")}n.chartTradeTab=t.get("tab")==="sell"?"sell":"buy",n.smartChartView=["chart","chartTxns","txns","info"].includes(t.get("view"))?t.get("view"):"chartTxns",n.chartFocusAmountInput=t.get("focusAmount")==="1",n.chartScrollIntoView=!0,n.route="terminal",n.activeTab="smartChart",H("chart-route-apply",e,{component:"smartChart",cacheHit:!!(Ye(a)?.cacheHit||lr(a)?.pairAddress),details:a})}function ln(e={},t={}){const a=Ts(e);if(!a){$("Select a token before quick buying.");return}const r=cn(a);if(r&&Rs(r)){$("Safety block: this token has mintable/freezable/honeypot-style risk signals and cannot be quick bought.");return}const s=t.preset||ct(),o=s&&!t.forceModal?He(s):"",c=s?.walletIndex||(s?.walletIndexes||[])[0]||(n.wallets[0]?.index?String(n.wallets[0].index):"");if(s&&o&&c&&!t.forceModal){Ls(a,{...s,walletIndex:c,walletIndexes:[c]});return}const l=ce();n.quickBuyModal={open:!0,tokenMint:a,amountSol:o||n.quickBuyAmountOverride||"",walletIndex:l?.publicKey?"connected":n.wallets[0]?.index?String(n.wallets[0].index):"",slippageBps:"400",status:o?`Preset ${o} SOL loaded. Confirm when ready.`:s?"Your selected preset has no SOL amount - set one here (or edit the preset in the Trade tab) and Buy becomes one-click.":"Enter a SOL amount to quick buy - or save a Trade preset and Buy becomes one-click.",source:t.source||"quick-buy",error:"",tradeAttemptId:""},Vi(a),h({force:!0}),requestAnimationFrame(()=>m("[data-quick-buy-modal-amount]")?.focus())}function ji(){n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},h({force:!0})}function cv(e={},t={}){if(!D("protectedBuyEnabled",!0))return;const a=Ts(e);if(!a){$("Select a token before opening Protected Buy.");return}const r=cn(a);if(r&&Rs(r)){$("Safety block: this token has mintable/freezable/honeypot-style risk signals and cannot be bought from quick actions.");return}const s=Sa(a)||{tokenMint:a},o=Qe(s),c=t.presetId||o.protectedBuyPreset||nl(o.verdict),l=Number(X(t.amountSol||n.quickBuyAmountOverride||He()||"0.1")),u=c==="conservative"&&Number.isFinite(l)&&l>.25?"0.25":dr(l||.1),d=ce();Vi(a),n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},n.protectedBuyModal={open:!0,tokenMint:a,presetId:c,amountSol:u,walletIndex:t.walletIndex||(d?.publicKey?"connected":n.wallets[0]?.index?String(n.wallets[0].index):""),slippageBps:String(t.slippageBps||"400"),riskAccepted:!1,status:o.verdict==="AVOID"?"Avoid recommended. Check the risk box if you still want to continue.":"Review this plan before wallet confirmation.",error:"",source:t.source||"protected-buy"},h({force:!0}),requestAnimationFrame(()=>m("[data-protected-buy-amount]")?.focus())}function Ps(){n.protectedBuyModal={...n.protectedBuyModal,open:!1,status:"",error:"",riskAccepted:!1},h({force:!0})}function uv(){const e=n.protectedBuyModal||{},t=String(e.tokenMint||"").trim(),a=String(m("[data-protected-buy-preset]")?.value||e.presetId||"conservative").trim(),r=String(m("[data-protected-buy-wallet]")?.value||e.walletIndex||"").trim(),s=X(m("[data-protected-buy-amount]")?.value||e.amountSol||""),o=String(m("[data-protected-buy-slippage]")?.value||e.slippageBps||"400").trim(),c=!!(m("[data-protected-buy-risk-accept]")?.checked||e.riskAccepted);if(!t)throw new Error("Select a token before Protected Buy.");if(!r)throw new Error("Choose a wallet before Protected Buy.");if(!s)throw new Error("Enter a SOL amount greater than zero.");return{tokenMint:t,presetId:a,walletIndex:r,amountSol:s,slippageBps:o,riskAccepted:c}}function dv(){const e=n.protectedBuyModal||{};if(!e.open)return"";const t=Sa(e.tokenMint)||{tokenMint:e.tokenMint},a=Qe(t),r=_s(e.presetId),s=ue(e.walletIndex),o=a.verdict==="AVOID"&&!e.riskAccepted,c=/submitting|opening wallet/i.test(String(e.status||""));return`
  ...
  `}function Pv(){const e=Vu();if(!e.length)return"";const t=e.length;return`
  ...
  `},{key:"fund",label:"Fund / Sweep",hint:"Move SOL",html:`${kb()}${Pv()}${Sb()}${Av()}`},{key:"create",label:"Create",hint:"New wallets",html:Jr()},{key:"import",label:"Import",hint:"Add keys",html:Au()},{key:"backup",label:"Backup",hint:"Save / restore",html:Tu()},{key:"downloads",label:"Downloads",hint:"Exports",html:Pu()}];if(!n.wallets.length){const r=a.filter(s=>s.key!=="balances"&&s.key!=="fund");return`
      ${e}
  ...
  `}function zd(){const e=n.balances.reduce((a,r)=>a+Number(r.tokens?.length||0),0)+Xc().length,t=n.balances.filter(a=>a.error).length;return`
    <section class="pnl-summary wallet-summary">
      <div><span>Wallets</span><strong>${li()}</strong></div>
  ...
  `}function ap(){const e=[...Object.values(n.livePairsByBucket||{}).flatMap(a=>a?.rows||[]),...n.livePairs?.rows||[],...n.scan?.rows||[],...n.kolScan?.rows||[],...n.watchlist?.rows||[]],t=new Map;for(const a of e){const r=String(a?.tokenMint||"");if(!r)continue;const s=t.get(r);(!s||Bs(a)>Bs(s))&&t.set(r,a)}return t}function Gv(e={}){return[e.marketCap,e.liquidityUsd,e.volume5m,e.volumeM15,e.volumeH1,e.pairCreatedAt,e.imageUrl,e.twitterUrl,e.telegramUrl,e.websiteUrl].reduce((t,a)=>t+(a&&String(a).toLowerCase()!=="n/a"?1:0),0)}function np(e=[]){const t=ap();return(e||[]).map(a=>rp(a,t.get(String(a?.tokenMint||""))))}function lt(e){if(e==null||e==="")return null;if(typeof e=="number")return Number.isFinite(e)?e:null;const t=String(e).trim();if(!t)return null;const r=t.replace(/[$,%_\s,]/g,"").match(/^([-+]?\d*\.?\d+)([kmb])?$/i);if(!r)return null;const s=Number(r[1]);if(!Number.isFinite(s))return null;const o=String(r[2]||"").toLowerCase();return o==="k"?s*1e3:o==="m"?s*1e6:o==="b"?s*1e9:s}function O(...e){for(const t of e){const a=lt(t);if(Number.isFinite(a)&&a>0)return a}for(const t of e){const a=lt(t);if(Number.isFinite(a))return a}return 0}function rp(e={},t=null){return t?{...e,imageUrl:e.imageUrl||t.imageUrl||"",websiteUrl:e.websiteUrl||t.websiteUrl||"",twitterUrl:e.twitterUrl||t.twitterUrl||"",telegramUrl:e.telegramUrl||t.telegramUrl||"",dexUrl:e.dexUrl||t.dexUrl,pumpUrl:e.pumpUrl||t.pumpUrl||"",isPump:e.isPump||t.isPump,pairCreatedAt:e.pairCreatedAt||t.pairCreatedAt,pairAgeSeconds:Number.isFinite(Number(e.pairAgeSeconds))?e.pairAgeSeconds:t.pairAgeSeconds,pairAgeMinutes:Number.isFinite(Number(e.pairAgeMinutes))?e.pairAgeMinutes:t.pairAgeMinutes,pairAgeLabel:e.pairAgeLabel||t.pairAgeLabel,marketCap:O(e.marketCap,t.marketCap,e.fdv,t.fdv),fdv:O(e.fdv,t.fdv,e.marketCap,t.marketCap),marketCapLabel:_(e.marketCapLabel,t.marketCapLabel,B(e.marketCap),B(t.marketCap)),fdvLabel:_(e.fdvLabel,t.fdvLabel,B(e.fdv),B(t.fdv)),liquidityUsd:O(e.liquidityUsd,t.liquidityUsd),liquidityLabel:_(e.liquidityLabel,t.liquidityLabel,B(e.liquidityUsd),B(t.liquidityUsd)),volume5m:O(e.volume5m,t.volume5m),volume5mLabel:_(e.volume5mLabel,t.volume5mLabel,B(e.volume5m),B(t.volume5m)),volumeM15:O(e.volumeM15,t.volumeM15),volumeM15Label:_(e.volumeM15Label,t.volumeM15Label,B(e.volumeM15),B(t.volumeM15)),volumeM30:O(e.volumeM30,t.volumeM30),volumeM30Label:_(e.volumeM30Label,t.volumeM30Label,B(e.volumeM30),B(t.volumeM30)),volumeH1:O(e.volumeH1,t.volumeH1),volumeH1Label:_(e.volumeH1Label,e.volumeLabel,t.volumeH1Label,t.volumeLabel,B(e.volumeH1),B(t.volumeH1)),volumeH24:O(e.volumeH24,t.volumeH24),volumeH24Label:_(e.volumeH24Label,t.volumeH24Label,B(e.volumeH24),B(t.volumeH24)),volumeLabel:_(e.volumeLabel,t.volumeLabel,e.volumeH1Label,t.volumeH1Label,B(e.volumeH1),B(t.volumeH1)),sniperCount:O(e.sniperCount,t.sniperCount)}:e}function cr(e=[],t=[]){return ye([...n.livePairsByBucket.under1d?.rows||[],...n.livePairsByBucket.under3h?.rows||[],...n.livePairsByBucket.under1h?.rows||[],...n.livePairsByBucket.live?.rows||[],...n.scan?.rows||[],...e,...t]).sort((r,s)=>Number(s.bestPickScore||s.score||0)-Number(r.bestPickScore||r.score||0)||O(s.volumeM15,s.volumeM30,s.volumeH1,s.volume5m,s.volumeH24)-O(r.volumeM15,r.volumeM30,r.volumeH1,r.volume5m,r.volumeH24)||O(s.marketCap,s.fdv)-O(r.marketCap,r.fdv)||Ze(r,s))}function j(e,t,a,r,s){return{key:e,label:t,severity:a,message:r,weight:s}}function Xv(e={}){const t=lt(e.pairAgeMinutes??e.ageMinutes??e.tokenAgeMinutes);if(Number.isFinite(t))return t;const a=lt(e.pairAgeSeconds??e.ageSeconds);return Number.isFinite(a)?a/60:null}function Jv(e,t=[]){const a=(t||[]).some(s=>s.key==="hard_flag"),r=(t||[]).filter(s=>s.severity==="risk"&&s.key!=="liquidity_extreme").length;return a||e<35&&r>=2?"AVOID":e<60?"RISK":e<75?"CAUTION":"BUY"}function Yv(e,t=[]){if(e==="BUY")return"Clean setup. Normal size still depends on your risk.";if(e==="CAUTION")return"Trade small or use protection.";if(e==="RISK")return"High-risk setup. Protected Buy recommended if you enter.";const a=(t||[]).find(r=>r.severity==="risk");return a?.message?`Avoid recommended. ${a.message}`:"Avoid recommended. Multiple danger signals."}const Es=Object.freeze({unknown:"",new:"New",hold:"Hold",mixed:"Mixed",risk:"Risk",dump:"Dev"});function ga(e=""){const t=String(e||"unknown").trim().toLowerCase();return Object.hasOwn(Es,t)?t:"unknown"}function Fs(e="",t="Unknown"){const a=ga(e);return Es[a]||t}function sp(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim(),a=String(e.creatorWallet||e.creator||e.deployerWallet||e.poolCreator||"").trim(),r=a?"new":"unknown";return{mint:t,status:r,label:Es[r],confidence:a?"low":"unknown",summary:a?"Limited dev-wallet history. Treat this as a new launch wallet.":"No reliable creator wallet detected yet.",likelyDevWallet:a||null,updatedAt:""}}function ur(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim();return t&&(n.devInfoSummaries?.[t]||e.devInfoSummary)||sp(e)}function Qv(e={}){const t=ga(e.status);return t==="hold"?j("dev_info_hold","Dev Info","positive","Likely dev wallet is still holding.",6):t==="mixed"?j("dev_info_mixed","Dev Info","caution","Dev wallet history is mixed.",-8):t==="risk"?j("dev_info_risk","Dev Info","risk","Likely dev wallet has fast-sell history.",-18):t==="dump"?j("dev_info_dump","Dev Info","risk","Likely dev wallet sold quickly or has repeated dump behavior.",-30):t==="new"?j("dev_info_limited","Dev Info","neutral","Dev wallet history is limited.",-2):j("dev_info_unknown","Dev Info","neutral","Dev wallet history is limited.",-4)}function op(e={},t={}){if(!D("devInfoEnabled",!0))return"";const a=String(e.tokenMint||e.mint||e.tokenAddress||"").trim();if(!a)return"";const r=ur(e),s=ga(r.status),c=!!n.devInfoLoading?.[`summary:${a}`]?"...":s==="unknown"?"":r.label||Es[s]||"",l=!!t.compact;return`
  ...
  `}function tw(e={}){if(!D("slimeShieldEnabled",!0)){const s=Number(e.bestPickScore||e.score||0);return`<em class="mobile-score-mini" title="${i(tl(e))}">${i(s?`${s}`:"n/a")} score</em>`}const t=Qe(e),a=String(e.tokenMint||t.mint||"").trim(),r=t.verdict||"CAUTION";return`<button type="button" class="mobile-score-mini slimeshield-mini slimeshield-${i(un(r))}" data-slimeshield-details="${i(a)}" title="${i(t.summary||"Open SlimeShield details")}">Details</button>`}function n0(e={}){if(!D("slimeShieldEnabled",!0)){const s=Number(e.bestPickScore||e.score||0),o=s?`${s}`:"n/a";return`
  ...
  `}function aw(e={}){return D("slimeShieldEnabled",!0)?`SlimeShield ${Qe(e).verdict||"CAUTION"}`:e.bestPickScore?`Score ${e.bestPickScore}/100`:e.valueLabel||e.smartMoney||""}function nw(e={}){const t=Number(e.bestPickScore||e.score||0),a=e.scoreWarnings||e.bestPickWarnings||[],r=t?`${t}/100`:"n/a";return`
    <span class="score-badge" title="${i(tl(e))}">
      <strong>${i(r)}</strong>
      <small>${a.length?"warnings":"best pick"}</small>
    </span>
  `}function rw(e={}){return ew(e,{compact:!0})}function tl(e={}){const t=e.scoreBreakdown||e.bestPickInputs||{},a=Object.entries(t).map(([s,o])=>`${s}: ${o}`),r=e.scoreWarnings||e.bestPickWarnings||[];return[...a,...r.map(s=>`warning: ${s}`)].join(" | ")||"Score uses available liquidity, volume, age, momentum, buys/sells, KOL, and risk signals."}function sw(e={}){return""}function B(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"n/a":t>=1e6?`$${(t/1e6).toFixed(t>=1e7?0:1)}M`:t>=1e3?`$${(t/1e3).toFixed(t>=1e5?0:1)}K`:`$${Math.round(t)}`}function _(...e){for(const t of e){const a=String(t??"").trim();if(a&&a!=="$0"&&a.toLowerCase()!=="n/a")return a}return"n/a"}function ip(e={}){return[["15m",_(e.volumeM15Label,B(e.volumeM15))],["30m",_(e.volumeM30Label,B(e.volumeM30))],["1h",_(e.volumeH1Label,e.volumeLabel,B(e.volumeH1))],["24h",_(e.volumeH24Label,B(e.volumeH24))]]}function r0(e={}){const t=dt(e),a=pt(e),r=_(e.marketCapLabel,e.fdvLabel,t>0?B(t):"","checking"),s=_(e.liquidityLabel,a>0?B(a):"","checking"),o=ip(e);return`
    <div class="compact-stat-grid">
      <span>MC <b>${i(r)}</b></span>
      <span>Liq <b>${i(s)}</b></span>
      ${o.map(([c,l])=>`<span>${i(c)} <b>${i(l)}</b></span>`).join("")}
    </div>
  `}function ow(e={}){const t=dt(e),a=pt(e),r=_(e.marketCapLabel,e.fdvLabel,t>0?B(t):"","checking"),s=_(e.liquidityLabel,a>0?B(a):"","checking"),o=_(e.volumeM15Label,B(e.volumeM15)),c=_(e.volumeH1Label,e.volumeLabel,B(e.volumeH1));return`
  ...
  `}function Ze(e={},t={}){const a=Number(e.pairAgeSeconds),r=Number(t.pairAgeSeconds);if(Number.isFinite(a)&&Number.isFinite(r)&&a!==r)return a-r;const s=Number(e.pairCreatedAt||0),o=Number(t.pairCreatedAt||0);return s||o?o-s:Number(t.bestPickScore||0)-Number(e.bestPickScore||0)}function lp(e=""){let t=0;for(let a=0;a<String(e).length;a+=1)t=(t<<5)-t+String(e).charCodeAt(a),t|=0;return Math.abs(t)}function ba(e={}){return String(e.tokenMint||e.mint||e.address||e.pairAddress||"").trim().toLowerCase()}function ya(e=""){const t=Ne();return[e,n.livePairBucket,n.terminalSort,pp(),t?.refreshCount||"",n.livePairsLastUpdatedByBucket[n.livePairBucket]||n.livePairsLastUpdatedAt||"",n.kolScan?.refreshCount||"",n.kolScan?.refreshedAt||n.kolLastUpdatedAt||""].join(":")}function va(e=[],t=12,a="",r=0){const s=ye(e||[]),o=Math.max(0,Number(t)||s.length);if(!o)return[];if(!a||s.length<=o)return s.slice(0,o);const c=Math.min(Math.max(0,Number(r)||0),Math.max(0,o-1),s.length),l=s.slice(0,c),u=s.slice(c);if(!u.length)return l.slice(0,o);const d=lp(a)%u.length,p=[...u.slice(d),...u.slice(0,d)];return[...l,...p].slice(0,o)}function cp(e=[],t=new Set){return(e||[]).filter(a=>{const r=ba(a);return!r||!t.has(r)})}function up(e={}){const t=dt(e),a=pt(e),r=wl(e),s=Zs(e),o=jp(e),c=_(e.marketCapLabel,e.fdvLabel,t>0?B(t):"","checking"),l=_(e.liquidityLabel,a>0?B(a):"","checking"),u=_(e.volumeM15Label,r>0?B(r):"","checking"),d=_(e.volumeH1Label,e.volumeLabel,s>0?B(s):"","checking"),p=_(e.volumeH24Label,o>0?B(o):"","checking");return`
  ...
  `}function dp(e,{source:t,actionLabel:a="Trade",isKolContext:r=!1}={}){const s=Ys(e.tokenMint);return`
    ...
    ${r?bd(e):""}
    <button type="button" class="watch-action" data-watched="${s}" title="${s?"Saved to watchlist":"Watch / save coin"}" data-watch-token="${i(e.tokenMint)}" data-watch-symbol="${i(e.symbol||"")}" data-watch-name="${i(e.name||"")}" data-watch-image="${i(Qs(e)||"")}">${s?"Saved":"Watch"}</button>
    ${op(e,{compact:!0})}
      ...
      ${c.map((d,p)=>{const f=d.scalpSetup||d.momentum||d.category||"live";return`
          <article class="terminal-token-row${u} ${l?"is-kol-signal":""}" data-token-chart="${i(d.tokenMint)}" data-token-chart-source="terminal-row">
            ...
            <div class="terminal-token-actions has-dev-info">
              ${dp(d,{source:"terminal-row",actionLabel:r,isKolContext:l})}
            </div>
          </article>
        `}).join("")}
    </div>
  `:F(s,o)}function kt(e,t={}){if(t.layout==="terminal")return iw(e,t);const a=t.limit||6,r=t.actionLabel||"Trade",s=t.emptyTitle||"No signals loaded",o=t.emptyMessage||"Refresh the feed to load current signals.",c=va(e||[],a,t.rotateKey||"",t.stickyCount||0),l=t.context==="kol";return c.length?`
      ...
      ${c.map((u,d)=>`
        <article class="compact-signal-row ${l?"is-kol-signal":""}" data-token-chart="${i(u.tokenMint)}" data-token-chart-source="compact-row">
          ...
          <div class="compact-row-actions has-dev-info">
            ${dp(u,{source:"compact-row",actionLabel:r,isKolContext:l})}
          </div>
        </article>
      `).join("")}
    </div>
  ...
  `}function mp(){Or&&window.clearTimeout(Or),Or=window.setTimeout(()=>{Or=null,Z("live"),Z("launch"),Z("sniper"),h()},180)}function Us(e={}){const t=Number(e.pairCreatedAt||e.createdAt||0);if(t>0){const s=t<1e10?t*1e3:t;return Math.max(0,Math.round((Date.now()-s)/1e3))}const a=["source-age","trusted-source-age"].includes(String(e.pairAgeSource||"").toLowerCase()),r=Number(e.pairAgeSeconds);return a&&Number.isFinite(r)&&r>=0?r:Number.POSITIVE_INFINITY}const gw=100,bw=7200,yw=75e4,vw=86400,ww=2e6,Sw=28e3,fp=18e4,kw=16e4;function hp(){const e=ap();return ye([...n.livePairs?.rows||[],...n.livePairsByBucket.live?.rows||[],...n.livePairsByBucket.under1h?.rows||[],...n.livePairsByBucket.under3h?.rows||[],...n.livePairsByBucket.under1d?.rows||[],...n.scan?.rows||[],...n.kolScan?.rows||[]]).map(t=>rp(t,e.get(String(t?.tokenMint||"")))).filter(t=>t?.tokenMint&&!ir(t))}function hn(e={}){return O(e.marketCap,e.fdv)}function gp(e={}){return O(e.liquidityUsd)}function bp(e={}){return O(e.volumeM5,e.volume5m,e.volumeM15,e.volumeM30,e.volumeH1,e.volumeH24,e.volumeUsd)}function ol(e={}){if(gn(e))return!1;const t=Us(e);return!Number.isFinite(t)||t<0||t>bw||hn(e)>yw?!1:qt(e)<70}function qs(e={}){if(gn(e))return!1;const t=qt(e),a=hn(e),r=a>=Sw&&a<=fp;return t>=55&&(!a||a<=fp)||r}function yp(e={}){if(ol(e)||qs(e)||gn(e))return!1;const t=Us(e);return Number.isFinite(t)&&(t<0||t>vw)||hn(e)>ww?!1:gp(e)>0||bp(e)>0||Number(e.bestPickScore||e.score||0)>0||Array.isArray(e.reasons)&&e.reasons.length>0}function vp(e={}){return[e.tokenMint,e.symbol,e.name,e.source,e.category,e.dexId,e.dexName,e.poolType,e.platform,e.raydiumPool,e.pairUrl,...e.riskFlags||[],...e.reasons||[]].filter(Boolean).join(" ").toLowerCase()}function qt(e={}){const t=O(e.bondingProgressPct,e.bondingProgress,e.bonding_curve_progress,e.bondingCurveProgress,e.pumpProgress,e.graduationProgress,e.completion,e.completePct);if(t>0)return t<=1?t*100:t;const a=hn(e),r=vp(e);return(!!e.isPump||r.includes("pump")||String(e.tokenMint||"").toLowerCase().endsWith("pump"))&&a>0?Math.max(1,Math.min(99,a/69e3*100)):0}function gn(e={}){if(e.isGraduated||e.graduated||e.bonded||e.isBonded||e.complete||e.completed||e.bondingComplete||e.raydiumPool||e.raydium_pool||e.poolAddress)return!0;const t=vp(e);if(/\b(graduated|bonded|bonding complete|complete)\b/.test(t))return!0;const a=!!e.isPump||t.includes("pump")||String(e.tokenMint||"").toLowerCase().endsWith("pump"),r=hn(e);return a&&r>=kw?!0:!!(a&&/\b(raydium|meteora|orca)\b/.test(t))}function Hs(e={}){if(gn(e))return"graduated";const t=String(e.slimeScopeCategory||"").trim().toLowerCase();return t==="graduated"?"graduated":qs(e)||t==="graduating"?"graduating":ol(e)?"new":(t==="steady"||t==="unknown"||yp(e),"steady")}function wp(e={}){const t=Number(e.bestPickScore||e.score||0),a=bp(e),r=gp(e),s=hn(e),o=Us(e),c=Number.isFinite(o)?Math.max(0,86400-o)/86400:0;return t*1e3+Math.log10(a+1)*160+Math.log10(r+1)*120+Math.log10(s+1)*80+c*100}function Sp(e=[]){return[...e].sort((t,a)=>wp(a)-wp(t)||Ze(t,a))}function $w(e=[],t=[],a=gw){const r=new Set,s=[];for(const o of[...e,...t]){const c=String(o?.tokenMint||"");if(!(!c||r.has(c))&&(r.add(c),s.push(o),s.length>=a))break}return s}function kp(e=n.slimeScopeMode){const t=hp(),a=e==="graduated"?"graduated":e==="graduating"?"graduating":e==="steady"?"steady":"new",r=t.filter(l=>Hs(l)===a),s=t.filter(l=>{const u=Hs(l);return a==="graduated"?u==="graduated"||gn(l):a==="graduating"?u==="graduating"||qs(l):a==="steady"?u==="steady"||yp(l):u==="new"||ol(l)}),o=a==="new"?[...r].sort(Ze):Sp(r),c=a==="new"?ye(s).sort(Ze):Sp(s);return $w(o,c)}function Tw(e=[],t="new"){const a=nt(`slimeScope:${t}`,e).slice(0,12);return a.length?a.map((r,s)=>{const o=r.pairAgeLabel||Kt(r)||"age ?",c=_(r.marketCapLabel,r.fdvLabel,B(dt(r)),"checking"),l=_(r.liquidityLabel,B(pt(r)),"checking"),u=_(r.volumeM15Label,B(wl(r)),"checking");return`
    ...
    <div class="slime-scope-web-columns" aria-label="Slime Scope desktop columns">
      ${[["new","New","Fresh launches"],["graduating","Graduating","Near migration"],["graduated","Graduated","Moved to market"]].map(([t,a,r])=>{const s=kp(t);return`
  ...
  `}function Pw(){const e=yl(),[,,t]=e,a=Hc(n.slimeScopeMode),s=!!(z("slimeScope").inFlight||n.livePairsLoadingByBucket?.[a]),o=n.livePairsRefreshErrorByBucket?.[a],c=ye(Kp(hp(),e[0])),l=nt("slimeScope",c),u=l.length?Xn()?ut(l,{context:"live",shareBuilder:Aa,hideToolbar:!0}):kt(l,{layout:"terminal",limit:Math.max(1,l.length),actionLabel:"Trade"}):o?F("Unable to load pairs. Try refreshing.","Cook Spot hit a snag — it keeps retrying, or tap Refresh Scope."):s?F("Loading Cook Spot…","Scanning DEX, boosted, and pump pairs for this category."):F("No pairs found for this filter yet","Try another category — Cook Spot keeps scanning in the background.");return`
  ...
  `}function o0(){const e=Ne(),t=ye(e?.rows||[]),a=fn(t),r=[...a].sort(Ze),s=np(n.kolScan?.rows||[]).filter(C=>!ir(C)),o=fn(s),c=cr(t,s),l=fn(c),u=mn(),d=va(l,8,ya("best-picks"),2),p=new Set(d.map(ba).filter(Boolean)),f=cp(r,p),y=va(f.length?f:r,12,ya("live-pairs"),0),g=new Set([...p,...y.map(ba).filter(Boolean)]),S=cp(o,g),A=va(S.length?S:o,12,ya("kol-signals"),1),T=!!n.livePairsLoadingByBucket[n.livePairBucket],b=ca(),P="Trade";return`
      ...
      <main class="command-workspace">
        ...
        <div class="command-controls">
          ...
          <label>
            ...
            <select data-terminal-sort>
              ${gf.map(([C,M])=>`<option value="${C}" ${n.terminalSort===C?"selected":""}>${M}</option>`).join("")}
            </select>
          </label>
          ${Yu("terminal-top")}
        ...
        <section class="command-grid">
          <article class="terminal-panel best-picks-panel">
            ...
            ${d.length?kt(d,{layout:"terminal",cooksStyle:!0,limit:8,actionLabel:P,emptyTitle:"No Best Picks yet",emptyMessage:"Refresh Live Pairs to score current pairs."}):u?pr(c,"best picks"):kt(d,{layout:"terminal",cooksStyle:!0,limit:8,actionLabel:P,emptyTitle:"No Best Picks yet",emptyMessage:"Refresh Live Pairs to score current pairs."})}
          </article>
          <article class="terminal-panel live-pairs-panel">
            <header><h4>Cooks</h4><button data-tab="live">Open</button></header>
            ${y.length?kt(y,{layout:"terminal",cooksStyle:!0,limit:12,actionLabel:P}):u?pr(t,"live pairs"):kt(y,{layout:"terminal",cooksStyle:!0,limit:12,actionLabel:P})}
          </article>
          <article class="terminal-panel kol-panel">
            ...
            ${A.length?kt(A,{layout:"terminal",cooksStyle:!0,limit:12,actionLabel:P,emptyTitle:"No KOL signals loaded",emptyMessage:"Refresh KOL Tracker to load signals."}):u?pr(s,"KOL signals"):kt(A,{layout:"terminal",cooksStyle:!0,limit:12,actionLabel:P,emptyTitle:"No KOL signals loaded",emptyMessage:"Refresh KOL Tracker to load signals."})}
          </article>
        </section>
  ...
  `}function i0(){const e=ct();if(!e)return"Trade";const t=He(e);return t?`Buy ${t} SOL`:Om(e,"Trade")}function wa(){const e=ct(),t=He(e);return t?`Buy ${t} SOL`:"Quick Buy"}function Ks(){const e=wa();document.querySelectorAll("[data-quick-buy-token]").forEach(t=>{v(t,e)})}function Sa(e=""){const t=String(e||"").trim();if(!t)return null;const a=or().find(s=>String(s?.tokenMint||s?.mint||s?.tokenAddress||"").trim()===t);if(a)return a;const r=n.smartChartTokenRef||{};return String(r.tokenMint||r.mint||"").trim()===t?r:{tokenMint:t,shortMint:w(t),symbol:w(t),dexUrl:Q(t)}}function Cw(e=""){return{normal_buy:"Normal buy size can be considered",small_buy:"Trade small or use protection",watch_only:"Watch-only unless you accept high risk",avoid:"Avoid recommended"}[e]||"Review risk before buying"}function Lw(e=""){return{conservative:"Conservative",scalp:"Scalp",degen:"Degen"}[e]||"Conservative"}function $p(e={}){if(!D("slimeShieldEnabled",!0))return"";const t=Qe(e),a=String(e.tokenMint||t.mint||"").trim(),r=t.verdict||"CAUTION";return`
  ...
  `}function Tp(e=[],t="risk",a="No strong signal cached yet."){const r=(Array.isArray(e)?e:[]).filter(s=>t==="positive"?s.severity==="positive":s.severity!=="positive").slice(0,5);return r.length?`
    <ul class="slimeshield-factor-list">
      ${r.map(s=>`
        <li>
    ...
    <aside class="dev-info-drawer" role="dialog" aria-modal="true" aria-label="Dev Info details">
      ...
      <section>
        ...
        <dl class="kol-dump-metrics">
          ...
          <div><dt>Confidence</dt><dd>${i(Cp(u))}</dd></div>
      ...
      <section>
        ...
        <dl class="kol-dump-metrics">
          <div><dt>Market cap</dt><dd>${i(Xs(b,B))}</dd></div>
          <div><dt>Liquidity</dt><dd>${i(Xs(P,B))}</dd></div>
          <div><dt>5m volume</dt><dd>${i(Xs(C,B))}</dd></div>
          <div><dt>1h volume</dt><dd>${i(Xs(M,B))}</dd></div>
      ...
      <div class="slimeshield-drawer-actions">
        <button type="button" data-watch-token="${i(r)}" data-watch-symbol="${i(s.symbol||"")}" data-watch-name="${i(s.name||"")}" data-watch-image="${i(Qs(s)||"")}">${Ys(r)?"Saved":"Add Watch"}</button>
  ...
  `;fr(e,Ct,".dev-info-drawer")}function Mp(e=""){return{mint:e,sampleSize:0,confidence:"low",matchedTraits:[],winRatePercent:null,medianMaxUpsidePercent:null,medianMaxDrawdownPercent:null,failRatePercent:null,bestExitPattern:"",summary:"Not enough local history yet. Replay improves as SlimeWire tracks more launches.",updatedAt:new Date().toISOString()}}function cl(e=""){const t=String(e||"").trim();return n.replayResults?.[t]||Mp(t)}function bn(e,t="%"){return Number.isFinite(Number(e))?`${Math.round(Number(e))}${t}`:"n/a"}function Ow(e=""){if(!D("replayBeforeBuyEnabled",!0))return"";const t=String(e||"").trim();if(!t)return"";const a=cl(t);return`
  ...
  `}async function ul(e="",t={}){const a=String(e||"").trim();if(!a||!D("replayBeforeBuyEnabled",!0))return null;if(!t.force&&n.replayResults?.[a])return n.replayResults[a];if(n.replayLoading?.[a])return null;n.replayLoading={...n.replayLoading||{},[a]:!0},hr(),$a();try{const r=new URLSearchParams({mint:a});t.force&&r.set("force","true");const o=(await k(`/api/web/replay-before-buy?${r.toString()}`,{timeoutMs:t.force?4500:3e3,preserveSafeError:!0}))?.replay||null;return o&&(n.replayResults={...n.replayResults||{},[a]:o},ne(o.cacheHit?"replayCacheHit":"replayCacheMiss")),o}catch{return n.replayResults={...n.replayResults||{},[a]:Mp(a)},null}finally{const r={...n.replayLoading||{}};delete r[a],n.replayLoading=r,hr(),$a()}}function Ew(e=""){const t=String(e||"").trim();!t||!D("replayBeforeBuyEnabled",!0)||(n.replayDetails={open:!0,tokenMint:t},Ua(),hr(),ul(t))}function dl(){n.replayDetails={open:!1,tokenMint:""},hr(),Er()}function hr(){let e=document.querySelector("[data-replay-drawer-root]");e||(e=document.createElement("div"),e.dataset.replayDrawerRoot="true",document.body.appendChild(e));const t=n.replayDetails||{},a=!!(t.open&&t.tokenMint);if(document.body.classList.toggle("replay-drawer-open",a),!a||!D("replayBeforeBuyEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=String(t.tokenMint||"").trim(),s=cl(r),o=!!n.replayLoading?.[r],c=`
    ...
    <aside class="slimeshield-drawer" role="dialog" aria-modal="true" aria-label="SlimeShield details">
      ...
      <section>
        ...
        <dl class="kol-dump-metrics">
          ...
          <div><dt>Age</dt><dd>${i(Number.isFinite(A)?zs(A):Gs(s.pairAgeLabel||Kt(s),"Not cached yet"))}</dd></div>
          <div><dt>Liquidity</dt><dd>${i(Number.isFinite(g)&&g>0?B(g):Gs(s.liquidityLabel,"Not cached yet"))}</dd></div>
          <div><dt>MC / FDV</dt><dd>${i(Number.isFinite(y)&&y>0?B(y):Gs(s.marketCapLabel,"Not cached yet"))}</dd></div>
          <div><dt>Volume</dt><dd>${i(Number.isFinite(S)&&S>0?B(S):Gs(s.volumeH1Label||s.volumeLabel,"Not cached yet"))}</dd></div>
          <div><dt>Dev Info</dt><dd>${i(Fs(q))} · ${i(M.confidence||"unknown")}</dd></div>
      ...
      <section>
        ...
        ${Tp(f,"risk","No major cached risk reason yet. Missing data lowers confidence.")}
      </section>
      <section>
        <h4>Positive Signals</h4>
        ${Tp(f,"positive","No positive signal is strong enough to highlight yet.")}
      </section>
      <section class="slimeshield-action-note">
        <h4>Suggested Action</h4>
  ...
  `}function Fw(e=""){const t=String(e||"").trim();return t?(n.pnl?.trades||[]).filter(a=>String(a?.tokenMint||a?.mint||"").trim()===t):[]}function u0(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=Fw(a),s=!!(dn(e)&&Ki(e)),o=s?dn(e):e.dexUrl||Q(Gd(e)||a),c=s?"Pump":"DEX";return`
  ...
  `}function Nw(){try{return Dw()}catch(e){console.error("Smart Chart render failed:",e);const t=String(n.smartChartToken||n.tradeToken||n.terminalToken||"").trim(),a=t?w(t):"No token selected",r=t?`https://dexscreener.com/solana/${encodeURIComponent(t)}?embed=1&theme=dark&trades=1&info=0`:"";return`
    ...
    `}}function Dw(){const e=Is(),t=String(e?.tokenMint||"").trim(),a=t?rt().find(o=>String(o.tokenMint)===t):null,r=t?ye([e,...sr().filter(o=>String(o.tokenMint||"")===t)]).filter(Boolean).slice(0,5):va(cr(),5,ya("smart-chart-suggest"),1);if(!t)return`
    ...
    <section class="smart-chart-terminal smart-chart-clean-terminal">
      ...
      <div class="smart-chart-grid smart-chart-clean-grid">
        <article class="terminal-panel smart-chart-main smart-chart-clean-main">
          ${(()=>{Uw(t);const o=Bp(t);return o?`<div class="coin-banner-hero" style="background-image:url('${o}')" role="img" aria-label="Coin banner"></div>`:""})()}
          <div class="smart-chart-token-header smart-chart-clean-token-header${Bp(t)?" has-banner":""}">
            ${mt(e)}
            <div>
              <strong>${i(s)}</strong>
              <small>${i(e.name||e.category||"Token")}</small>
  ...
  `}function Bp(e){const t=String(e||"").trim();return n.coinBanners&&n.coinBanners[t]||""}let Rp="";function Uw(e){const t=String(e||"").trim();!t||Rp===t||(Rp=t,k(`/api/web/coin-banner?mint=${encodeURIComponent(t)}`).then(a=>{const r=String(a?.bannerUri||"");r&&(n.coinBanners=n.coinBanners||{},n.coinBanners[t]=st(r),n.activeTab==="smartChart"&&h({preserveSmartChartFrame:!0}))}).catch(()=>{}))}let ml="",Ip=0;function Op(e){e&&(ml===e&&Date.now()-Ip<3e4||(ml=e,Ip=Date.now(),k(`/api/web/calls?mint=${encodeURIComponent(e)}`).then(t=>{n.chartCalls={mint:e,...t},n.activeTab==="smartChart"&&h({preserveSmartChartFrame:!0})}).catch(()=>{})))}function qw(e){const t={bullish:["🟢","BULLISH"],bearish:["🔴","BEARISH"],warning:["⚠️","WARNING"],question:["❓","QUESTION"]},[a,r]=t[e]||["⚪",String(e||"").toUpperCase()];return`${a} ${r}`}function Hw(e){Op(e);const t=n.chartCalls?.mint===e?n.chartCalls:null,a=t?.calls||[],r=!!(n.token&&n.user);return`
  ...
  `}async function Kw(e){const t=m("[data-call-status]");try{const a=m("[data-call-side]")?.value||"bullish",r=m("[data-call-target]")?.value||"",s=m("[data-call-note]")?.value||"";v(t,"Posting call..."),await k("/api/web/calls",{method:"POST",body:JSON.stringify({tokenMint:e,side:a,targetX:r,note:s,source:"site"})}),v(t,"Call posted - it is now being tracked."),ml="",Op(e)}catch(a){v(t,N(a?.message||"Could not post call."))}}function Vw(e,t=!1){const a=e?.tokenMint?n.positions.find(o=>String(o.tokenMint)===String(e.tokenMint)):null,r=pn("trade"),s=pn("bundle");return t?`
  ...
  `}function jw(){if(n.terminalSubtab==="orders")return Wp();if(n.terminalSubtab==="history")return fl(12);if(n.terminalSubtab==="wallets")return zd();if(n.terminalSubtab==="kol"){const e=np(n.kolScan?.rows||[]).filter(t=>!ir(t));return kt(e,{layout:"terminal",cooksStyle:!0,limit:12,rotateKey:ya("bottom-kol"),stickyCount:1})}return n.terminalSubtab==="sniper"?n.scan?ut(n.scan.rows||[],{context:"sniper",primaryAction:"snipe",primaryActionLabel:"Snipe",hideToolbar:!0}):F("No sniper scan loaded","Open Sniper or refresh a scan mode."):n.terminalSubtab==="tx"?Np(!0):n.terminalSubtab==="reconcile"?_p():Gw(6)}function Gw(e=25){const t=rt();return t.length?`
    <div class="table-list compact-table">
      ${t.slice(0,e).map(Fp).join("")}
    </div>
  `:F("No open positions","Open token holdings will show here after refresh.")}const Ep=new Map;function Xw(e){const t=String(e.tokenMint||"");if(!t)return"";const a=(n.pnl?.tokens||[]).find(d=>String(d.tokenMint)===t),r=or().find(d=>String(d?.tokenMint||"")===t),s=(Array.isArray(n.tradePlans)?n.tradePlans:[]).find(d=>String(d.tokenMint)===t&&["watching","active","armed","pending"].includes(String(d.status||"").toLowerCase())),o=[];a?.spentSol&&o.push(`Entry ${a.spentSol} SOL`),r?.marketCapLabel&&o.push(`MC ${r.marketCapLabel}`),o.push(s?`TP ${s.takeProfitSummary||s.takeProfitPct||"off"} / SL ${s.stopLossSummary||s.stopLossPct||"off"} armed`:"no auto-exit armed");const c=Number(e.estimatedValueSol);let l="";if(Number.isFinite(c)){const d=Ep.get(t);if(d&&Number.isFinite(d.value)&&Math.abs(c-d.value)>5e-4){const p=c-d.value;l=`${p>0?"▲ +":"▼ "}${p.toFixed(4)} SOL since last refresh`}Ep.set(t,{value:c,at:Date.now()})}let u="";if(s){const d=Number(s.lastMovePct??s.wallets?.[0]?.lastMovePct),p=Number(s.takeProfitPct),f=Number(s.stopLossPct),y=Date.parse(s.sellAfterAt||s.wallets?.[0]?.sellAfterAt||""),g=Number.isFinite(y)?Math.round((y-Date.now())/6e4):null;Number.isFinite(d)&&Number.isFinite(p)&&p>0&&d>=p*.75?u=`Up ${d.toFixed(1)}% - take-profit at +${p}% is close`:Number.isFinite(d)&&Number.isFinite(f)&&f>0&&d<=-(f*.6)?u=`Down ${Math.abs(d).toFixed(1)}% - stop-loss at -${f}% is near`:g!==null&&g>0&&g<=10?u=`Timer exit in ~${g} min`:Number.isFinite(d)&&(u=`${d>=0?"Up":"Down"} ${Math.abs(d).toFixed(1)}% - exits watching`)}else Jb(t)||e.source==="launch-optimistic"?u="⏳ Exits arming from your launch - TP/SL/timer registering...":u="No auto-exit on this bag - Arm Exits if you are stepping away";return`
  ...
  `:F("No live trade history yet","Submitted web trades will appear here after refresh.")}function Jw(){const e=n.pnl?.trades||[],t=nt("liveTrades",e);return`
  ...
  `}function Wp(){const e=Array.isArray(n.tradePlans)?n.tradePlans:[],t=[n.tradePlanResult,n.bundleResult,n.volumeResult,n.sniperResult,n.kolResult,n.launchResult].filter(Boolean).map(r=>({...r,localOnly:!0})),a=e.length?e:t;return a.length?`
    <div class="table-list compact-table">
      ${a.map(r=>`
  ...
  `}function _p(){const e=n.balances.filter(a=>a.error),t=n.balances.reduce((a,r)=>a+Number(r.warnings?.length||0),0);return`
  ...
  `}function Np(e=!1){const t=n.terminalTxAudit;return`
    <section class="${e?"tx-audit compact":"terminal-layout tx-audit"}">
      ...
      ${e?"":`<aside class="trade-side order-ticket-stack">${Wp()}${_p()}</aside>`}
    </section>
...
`)||"No logs returned.")}</pre>
  ...
  `}function Zw(e=[]){const t=[...e].sort((a,r)=>Number(r.bestPickScore||r.score||0)-Number(a.bestPickScore||a.score||0)||Ze(a,r));return va(t,5,ya("cooks-best"),1)}function Ae(e){const t=Number(e);return Number.isFinite(t)?t:0}function Dp(){const e=n.liveFeedCategory||"best";return Do.find(([t])=>t===e)||Do[0]}function Ta(e={}){return Zs(e)||jp(e)||wl(e)||0}function hl(e={}){return Ae(e.buys5m)+Ae(e.buysH1)+Ae(e.sells5m)+Ae(e.sellsH1)}function Up(e={}){const t=Ae(e.buys5m)+Ae(e.buysH1),a=Ae(e.sells5m)+Ae(e.sellsH1),r=t+a;return r>0?t/r:.5}function gr(e={}){return Math.max(Ae(e.m5),Ae(e.h1),Ae(e.h24))}function Js(e={}){return Math.max(Ae(e.m5),Ae(e.h1))}function Ht(e={}){return Js(e)*Math.log10(10+Ta(e))*(.5+Up(e))}function gl(e={}){return e.boosted||e.isBoosted||e.boost||e.boosts?!0:`${e.source||""} ${e.category||""} ${e.liveLabel||""} ${e.sourceLabel||""}`.toLowerCase().includes("boost")}function eS(e=[],t="best"){const a=[...e];switch(t){case"volume":return a.sort((r,s)=>Ta(s)-Ta(r));case"liquidity":return a.sort((r,s)=>pt(s)-pt(r));case"marketcap":return a.sort((r,s)=>dt(s)-dt(r));case"active":return a.sort((r,s)=>hl(s)-hl(r));case"fresh":return a.sort(Ze);case"gainers":return a.sort((r,s)=>gr(s)-gr(r));default:return a.sort((r,s)=>Ae(s.bestPickScore||s.score)-Ae(r.bestPickScore||r.score)||Ze(r,s))}}function qp(){const e=n.liveTerminalCategory||"dexTrending";return Ha.find(([t])=>t===e)||Ha[0]}function tS(e,t,a,r){return`
    ...
    </label>`}function aS(){if(n.activeTab==="terminal"){const t=qp();return{categories:Ha,activeId:t[0],sub:t[2],attr:"data-live-terminal-category",cap:"Discover",rank:a=>Kp(a,t[0]),hasBest:!1}}const e=Dp();return{categories:Do,activeId:e[0],sub:e[2],attr:"data-live-feed-category",cap:"Feed",rank:t=>eS(t,e[0]),hasBest:e[0]==="best"}}function nS(e={}){if(gl(e))return{cls:"boost",text:"⚡ Boosted"};const t=gr(e);if(t>=40)return{cls:"gain",text:`▲ ${Math.round(t)}%`};const a=Number(e.pairAgeMinutes);return Number.isFinite(a)&&a>=0&&a<=10?{cls:"fresh",text:"✨ Fresh"}:Js(e)>=25?{cls:"hot",text:"🔥 Hot"}:Up(e)>=.7&&hl(e)>=24?{cls:"active",text:"● Active"}:null}function bl(e={}){const t=nS(e);return t?`<span class="signal-badge signal-badge-${t.cls}">${i(t.text)}</span>`:""}function Hp(e={}){return e.isPump||e.pump||e.pumpFun||e.pumpUrl?!0:`${e.source||""} ${e.category||""} ${e.dexId||""} ${e.dexName||""}`.toLowerCase().includes("pump")}function rS(e={}){const t=`${e.name||""} ${e.symbol||""} ${e.category||""}`.toLowerCase();return Hp(e)||/meme|dog|cat|pepe|wif|inu|elon|moon|bonk|frog|chad/.test(t)}function yl(){const e=n.cookSpotCategory||"dexTrending";return Ha.find(([t])=>t===e)||Ha[0]}function Kp(e=[],t="dexTrending"){const a=[...e];switch(t){case"fresh":return a.sort(Ze);case"dexBoosted":{const r=a.filter(gl).sort((o,c)=>Ta(c)-Ta(o)),s=a.filter(o=>!gl(o)).sort((o,c)=>Ht(c)-Ht(o));return[...r,...s]}case"pumpTrending":{const r=a.filter(Hp);return(r.length?r:a).sort((s,o)=>Ht(o)-Ht(s))}case"memeMovers":{const r=a.filter(rS);return(r.length?r:a).sort((s,o)=>gr(o)-gr(s))}case"earlyMomentum":{const r=a.filter(s=>{const o=Number(s.pairAgeMinutes);return!Number.isFinite(o)||o<=180});return(r.length?r:a).sort((s,o)=>Js(o)-Js(s))}case"graduating":{const r=a.filter(s=>qs(s)||Hs(s)==="graduating");return(r.length?r:a).sort((s,o)=>Ht(o)-Ht(s))}case"graduated":{const r=a.filter(s=>gn(s)||Hs(s)==="graduated");return(r.length?r:a).sort((s,o)=>Ta(o)-Ta(s))}default:return a.sort((r,s)=>Ht(s)-Ht(r))}}function sS(e=yl()){const[t]=e;return`
    ...
    <div class="cooks-feed">
      ...
      <div class="cooks-section" data-cooks-best>
        ...
        ${l.length?ut(l,o):F("No pairs found for this filter yet","Keep this tab open or tap Refresh — picks fill in as pairs qualify.")}
      </div>
      <div class="cooks-section" data-cooks-newest>
        ...
        ${p.length?ut(p,o):F("Scanning fresh pairs","Newest launches fill here as they qualify.")}
      </div>
  ...
  `}function m0(e){const t={live:"Brand-new launches under an hour old. Best Picks rotates the strongest; Newest streams them as they appear.",under1h:"Pairs aged about 1 to 2 hours - past the first-minute chaos, early momentum still forming.",under3h:"Pairs aged about 3 to 6 hours - established enough to show a real volume and liquidity trend.",under1d:"Pairs aged about 24 to 48 hours - day-old survivors ranked by liquidity, volume, momentum, and risk."};return t[e]||t.live}function oS(){if(!n.user||!n.token)return`${Jr()}${F("Create or log in to save a watchlist","You can browse scanners as a guest. Tap Watch after creating an account to save coins here.")}`;const e=n.watchlist?.rows||[],t=nt("watchlist",e);return`
    <section class="terminal-layout watchlist-terminal">
      <main class="terminal-main">
        ...
        ${t.length?ut(t,{context:"watchlist",shareBuilder:a=>$i(a.tokenMint)}):F("No watched coins yet","Tap Watch on Cooks, Sniper, or KOL signals to save coins here.")}
  ...
  `}function f0(e){return ut(e,{context:"live",shareBuilder:Aa})}function ut(e,t={}){const a=t.shareBuilder||Aa,r=ye(e),s=`signal-list ${t.context==="kol"?"signal-list-kol":""}`.trim();return r.length?`
  ...
  `:`
    ...
    <article class="signal-row ${l?"is-kol-signal":""}" data-token-chart="${i(e.tokenMint)}" data-token-chart-source="${i(a.context||"signal-row")}">
      ...
      <div class="signal-cell" data-cell="Liq"><span>${i(_(e.liquidityLabel,pt(e)>0?B(pt(e)):"","checking"))}</span><small>${lS(e.h1)}</small></div>
      ...
      <div class="signal-cell volume-windows" data-cell="Vol">
        <span>${i(_(e.volumeH1Label,e.volumeLabel,Zs(e)>0?B(Zs(e)):"","checking"))}</span>
        <small>${ip(e).map(([d,p])=>`${d} ${p}`).join(" | ")}</small>
      </div>
  ...
  `}function mS(){const e=n.sniperResult;return e?.results?.length?`<div class="mini-results">${e.results.map(t=>`<span data-ok="${t.ok?"true":"false"}">${i(t.message||t)}</span>`).join("")}</div>`:""}function fS(){const e=n.scan.rows||[],t=nt("sniper",e);return e.length?`
    ...
    ${ut(t,{context:"sniper",primaryAction:"snipe",primaryActionLabel:"Snipe",shareBuilder:Tg})}
    ${la("sniper",e,"snipe candidates")}
  `:F("No usable picks","Refresh again or choose a different mode.")}function eo(){return n.user?.connectedWallet?.publicKey||""}function Gp(){return n.ogreTek.markets.find(e=>e.symbol===n.ogreTek.selectedMarket)||n.ogreTek.markets[0]||null}function hS(){return{marketSymbol:n.ogreTek.selectedMarket,direction:n.ogreTek.direction,orderType:n.ogreTek.orderType,collateralUsd:n.ogreTek.collateralUsd,leverage:n.ogreTek.leverage,slippagePct:n.ogreTek.slippagePct,priorityFeeLamports:n.ogreTek.priorityFeeLamports,limitPrice:n.ogreTek.limitPrice,stopPrice:n.ogreTek.stopPrice}}function Xp(){return Rm(hS(),Gp(),n.ogreTek.account,$e)}function we(e,t=2){const a=Number(e);return Number.isFinite(a)?Math.abs(a)>=1e9?`$${(a/1e9).toFixed(2)}B`:Math.abs(a)>=1e6?`$${(a/1e6).toFixed(2)}M`:Math.abs(a)>=1e3?`$${(a/1e3).toFixed(1)}K`:`$${a.toFixed(t)}`:"n/a"}function ft(e){const t=Number(e);return Number.isFinite(t)?t>=1e3?`$${t.toLocaleString(void 0,{maximumFractionDigits:2})}`:`$${t.toFixed(t>=10?2:4)}`:"n/a"}function to(e,t=3){const a=Number(e);return Number.isFinite(a)?`${a>=0?"+":""}${a.toFixed(t)}%`:"n/a"}function Jp(e){const t=Date.parse(e||"");if(!t)return"not loaded";const a=Math.max(0,Math.round((Date.now()-t)/1e3));return a<60?`${a}s ago`:`${Math.round(a/60)}m ago`}function ao(){document.querySelectorAll("[data-ogre-tek-field]").forEach(e=>{const t=e.dataset.ogreTekField;!t||!(t in n.ogreTek)||(e.type==="checkbox"?n.ogreTek[t]=!!e.checked:n.ogreTek[t]=e.value)})}async function gS(){!$e.enabled||n.ogreTek.loading||n.ogreTek.markets.length||n.ogreTek.error||await br({silent:!0}).catch(e=>{n.ogreTek.error=N(e.message),h({force:!0})})}async function br({force:e=!1,silent:t=!1}={}){if($e.enabled&&!(n.ogreTek.loading&&!e)){n.ogreTek.loading=!0,n.ogreTek.error="",t||h({force:!0});try{const a=eo(),[r,s,o,c]=await Promise.all([wr.getMarkets(),wr.getAccount(a),wr.getPositions(a),wr.getOpenOrders(a)]);n.ogreTek.markets=r||[],n.ogreTek.account=s||null,n.ogreTek.positions=o||[],n.ogreTek.orders=c||[],n.ogreTek.markets.some(l=>l.symbol===n.ogreTek.selectedMarket)||(n.ogreTek.selectedMarket=n.ogreTek.markets[0]?.symbol||"SOL-PERP"),n.ogreTek.status=`Updated ${new Date().toLocaleTimeString()}`}catch(a){n.ogreTek.error=N(a.message)}finally{n.ogreTek.loading=!1,h({force:!0})}}}function bS(){return`
  ...
  `}function yS(){if(xm($e)!=="enabled")return bS();const e=!!eo(),t=Gp(),a=Xp(),r=a.quote,s=n.ogreTek.account,o=a.ok&&!n.ogreTek.loading,c=n.ogreTek.error?"Provider Error":n.ogreTek.loading?"Loading":"Ready",l=$e.demoMode?"Review Demo Trade":"Review Trade",u=$e.demoMode?"Confirm Demo Review":"Confirm Order",d=$e.demoMode?!n.ogreTek.riskAccepted||!a.ok:!Cm({validation:a,riskAccepted:n.ogreTek.riskAccepted,demoMode:$e.demoMode});return`
    <section class="ogre-tek-page">
    ...
    <div class="ogre-market-grid">
      ${n.ogreTek.markets.map(e=>`
        <button type="button" class="ogre-market-card" data-ogre-tek-market="${i(e.symbol)}" data-active="${e.symbol===n.ogreTek.selectedMarket}">
          ...
          <small>Oracle ${ft(e.oraclePrice)} | 24h ${to(e.change24hPct,2)}</small>
          <small>Funding ${to(e.fundingRatePct,3)} | OI ${we(e.openInterestUsd,0)}</small>
  ...
  `}function SS(){return eo()?n.ogreTek.positions.length?`
    <div class="ogre-tek-table">
      ...
      ${n.ogreTek.positions.map(e=>`
        <div class="ogre-table-row">
          <span><strong>${i(e.marketSymbol)}</strong><small>${i(e.side)} | margin ${to(e.marginRatioPct,1)}</small></span>
  ...
  `:F("No open positions","Mock positions will appear here when the provider reports them."):F("Wallet disconnected","Connect Phantom, Solflare, Backpack, or another detected Solana wallet to view perps account data.")}function kS(){return eo()?n.ogreTek.orders.length?`
    ...
    <div class="ogre-tek-modal-backdrop" role="presentation">
      <article class="ogre-tek-modal" role="dialog" aria-modal="true" aria-label="Ogre Tek risk confirmation">
        ...
        <div class="ogre-review-grid">
          ...
          <span><small>Funding Rate</small><strong>${to(a?.fundingRatePct,3)}</strong></span>
...
`),actions:[s?.tokenMint?{label:"Open Top Chart",type:"open_chart",tokenMint:s.tokenMint}:null,{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}].filter(Boolean)}}const QS=[["terminal",["terminal","command center","cooks","main feed","live feed","home"]],["live",["live pairs","fresh pairs","new pairs","pairs"]],["slimeScope",["slime scope","scope","scanner","cook spot"]],["smartChart",["smart chart","chart page","charting"]],["trade",["trade desk","trade page","swap page","slime swap","manual trade"]],["bundle",["bundle","bundle buy","multi wallet buy"]],["volume",["volume","slimebot","slime bot","volume bot"]],["sniper",["sniper","ogre sniper","snipe picks","picks"]],["launchCoin",["pump launch","launch a coin","launch coin","create coin","create a token","make a coin","launcher"]],["launch",["launch watch","launch watches","watch launches","snipe launches"]],["kol",["kol","kols","kol tracker","copy trading","copy wallet"]],["ogreAi",["ogre ai","ogre a.i","autopilot","auto pilot","ai buyer"]],["wallets",["wallets","wallet page","balances","my wallets","fund","sweep"]],["positions",["positions","open positions","bags","holdings","my coins"]],["pnl",["pnl","profit","results","p&l","pnl card","share card"]],["txAudit",["tx audit","stop loss audit","audit","armed plans","my plans","tp sl status"]],["profile",["profile","account","referral","referrals","badges","pfp","alerts","push alerts","notifications"]],["tek",["ogre tek","tek hub","tools","tool hub","automation deck","shield receipts","receipts"]],["ogreTek",["perps","perp","perp mode","leverage"]],["watchlist",["watchlist","watch list","saved coins","saved tokens"]],["liveTrades",["live trades","recent trades","trade history"]]],ZS=/\b(open|go to|goto|show me|show|take me|bring up|pull up|switch to|navigate|where is|where's|wheres|where are|where do i|how do i (?:get to|open|find)|find)\b/i;function ek(e){const t=String(e||"").toLowerCase().replace(/[?!.]+$/g,"").trim();if(!t||t.length>120||Ll(e)||At(e))return null;const a=/(?:set\s+)?quick\s*buy(?:\s+amount)?\s*(?:to|at|=)?\s*([0-9]*\.?[0-9]+)\s*(?:sol)?$/i.exec(t);if(a){const s=dr(a[1]);if(s)return n.quickBuyAmountOverride=s,Xr({quickBuy:s}),Ks(),{text:`Quick buy set to ${s} SOL - every Buy button across the site now fires with that amount.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}if(/\b(i (?:like|prefer|want|am)|keep (?:it|them)|show me|give me)\b/.test(t)){if(/\b(risky|degen|moonshots?|early|low\s*mc|gambl)/.test(t))return Xr({risk:"degen"}),{text:"Noted - early risky plays it is. The fresh low-MC line in the brief is yours, and I'll keep that preference next visit too.",actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Sniper",type:"open_tab",tab:"sniper"}]};if(/\b(safe|careful|low risk|clean|less risky)\b/.test(t))return Xr({risk:"careful"}),{text:"Noted - shield-clean setups first. I'll remember that next visit. SlimeShield verdicts are on every pair and /t page.",actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}if(/\brefresh\b.*\b(feed|pairs|scan)/.test(t)||t==="refresh feeds")return{text:"Refreshing the live feeds now.",run:{type:"refresh_feeds"},actions:[]};if(/\brefresh\b/.test(t)||/\bsync\b.*\b(wallet|balance|position)/.test(t))return{text:"Refreshing wallets, balances, and positions now.",run:{type:"refresh_wallet"},actions:[]};if(/\b(connect|link|hook up)\b.*\bwallet\b/.test(t))return{text:"Opening the wallet connect chooser.",run:{type:"open_wallet_connect"},actions:[]};if(/what can you do|what do you do|help me|how do you work|what are you/.test(t))return{text:`I can take you anywhere on the site (just say "open positions" or "where is the sniper"), check any coin (paste a CA), run buys and sells ("buy 0.1 of <CA>"), set your quick-buy amount, refresh wallets and feeds, and read risk with SlimeShield. Ask in your own words - I'll keep up.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Positions",type:"open_tab",tab:"positions"},{label:"Ogre Tek",type:"open_tab",tab:"tek"}]};const r=ZS.test(t);for(const[s,o]of QS)for(const c of o){if(!(t===c||t===`the ${c}`||t===`my ${c}`)&&!(r&&t.includes(c)))continue;return{text:`Opening ${tk(s)} now.${s==="profile"&&/alert|push|notification/.test(t)?" Push alerts live under Profile > Alerts.":""}`,run:{type:"open_tab",tab:s},actions:[{label:"Back to Terminal",type:"open_tab",tab:"terminal"}]}}return null}function tk(e){return{terminal:"the Live Terminal",live:"Live Pairs",slimeScope:"Slime Scope",smartChart:"Smart Chart",trade:"the Trade Desk",bundle:"Bundle",volume:"SlimeBot Volume",sniper:"OgreSniper",launchCoin:"Pump Launch",launch:"Launch Watch",kol:"the KOL Tracker",ogreAi:"Ogre A.I.",wallets:"Wallets",positions:"Positions",pnl:"PnL",txAudit:"the TP/SL Audit",profile:"your Profile",tek:"the Ogre Tek hub",ogreTek:"Perp Mode",watchlist:"your Watchlist",liveTrades:"Live Trades"}[e]||e}const ak={submitted:"Order submitted",approved:"Wallet approved",sent:"Transaction sent",confirmed:"Confirmed on-chain",armed:"TP/SL armed"};function hm(e){n.tradeTrace={title:String(e||"Trade"),steps:[],startedAt:Date.now(),done:!1},co()}function Re(e,t="ok",a=""){if(!n.tradeTrace||n.tradeTrace.done&&t==="pending")return;const r=n.tradeTrace.steps,s=r.find(l=>l.key===e),o=s||{key:e,label:ak[e]||e};if(o.status=t,o.detail=String(a||"").slice(0,140),s||r.push(o),t==="fail"&&(n.tradeTrace.done=!0),co(),t==="fail")return;r.length>=3&&r.every(l=>l.status==="ok")&&(n.tradeTrace.done=!0,window.setTimeout(()=>{n.tradeTrace?.done&&!n.tradeTrace.steps.some(l=>l.status==="fail")&&(n.tradeTrace=null,co())},8e3))}function co(){let e=document.querySelector("[data-trade-trace-mount]");e||(e=document.createElement("div"),e.dataset.tradeTraceMount="true",document.body.appendChild(e));const t=n.tradeTrace;if(!t){e.innerHTML="",e.__lastDrawerHtml="";return}const a=r=>r==="ok"?"✅":r==="fail"?"❌":"⏳";e.innerHTML=`
  ...
  `,document.head.appendChild(e)}function fo(){if(I.root)return I.root;Mk();const e=document.createElement("div");return e.setAttribute("data-trailer-overlay",""),e.style.cssText="position:fixed;inset:0;z-index:99999;pointer-events:none;font-family:Inter,system-ui,sans-serif;",e.innerHTML=`
  ...
  `),await xa(l*1e3),Il("done"))}document.addEventListener("click",e=>{e.target instanceof Element&&e.target.closest("[data-trailer-mode]")&&(e.preventDefault(),I.running||Nk())});
