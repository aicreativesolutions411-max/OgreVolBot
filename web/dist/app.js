...
`)}function he(e){e&&(n.user=e,Object.prototype.hasOwnProperty.call(e,"xHandle")?(n.xHandle=et(e.xHandle),n.xHandle?Zl(n.xHandle):Fo()):n.xHandle||(n.xHandle=Ql()))}function Gr(e){for(const t of e){const a=Nn(t);if(a&&!a.closest("[hidden]"))return String(a.value||"")}for(const t of e){const a=m(t);if(a)return String(a.value||"")}return""}function _n(){const e=m("[data-connect-status]");return e&&!e.closest("[hidden]")?e:Nn("[data-login-status]")||e}function Nn(e){const t=[...document.querySelectorAll(e)];return t.find(a=>!a.closest("[hidden]")&&a.offsetParent!==null)||t.find(a=>!a.closest("[hidden]"))||t[0]||null}function Dn(){return Nn("[data-wallet-connect-modal] [data-wallet-connect-status]")||Nn("[data-wallet-connect-status]")}function oe(e=""){n.walletConnectStatus=String(e||""),S(Dn(),n.walletConnectStatus)}function Sc(e="solana"){const t=_e(e);return Ge()?qn(e)?`${t} is not injected in this browser. Tap Open ${t} to use the mobile wallet connect flow, or choose another wallet option.`:Lc(e)?`${t} is not injected in this browser. Use Open ${t} to continue in the wallet app, or choose another wallet option.`:`${t} is not available in this browser. Install or open the wallet app, or choose another wallet option.`:`${t} extension not found. Install or unlock ${t}, or choose another wallet.`}function Ft(e="solana",t=null,a={}){const r=ge(e),s={walletName:_e(e,r),userId:n.user?.id||"",route:n.route,adapterReadyState:r?"detected":"not_detected",errorName:t?.name||"",errorMessage:String(t?.message||t||"").slice(0,240),...a};try{console.warn("[slimewire_wallet_connect]",s)}catch{}}function kc(e=n.route==="connect"){window.setTimeout(()=>{const t=n.loginModalOpen?`[data-login-modal-${n.loginModalTab==="create"?"create":"login"}-section] [data-login-username], [data-login-modal-${n.loginModalTab==="create"?"create":"login"}-section] [data-login-password]`:e?"[data-connect-login-username], [data-connect-login-password]":"[data-login-username], [data-login-password]";Nn(t)?.focus?.()},0)}function _f(){const e=document.activeElement;e instanceof HTMLElement&&!e.closest("[data-login-modal]")&&(Wo=e)}function Nf(){const e=Wo;Wo=null,window.setTimeout(()=>{e?.isConnected&&typeof e.focus=="function"&&e.focus({preventScroll:!0})},0)}function $c({restoreFocus:e=!0}={}){const t=!!n.loginModalOpen;n.loginCollapsed=!0,n.loginModalOpen=!1,h({force:!0}),t&&e&&Nf()}function Df(){return!Ce||Ce.hidden||!n.loginModalOpen?[]:[...Ce.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')].filter(e=>!e.closest("[hidden]")&&e.offsetParent!==null)}function Uf(e){if(!n.loginModalOpen||e.key!=="Tab"||!Ce||Ce.hidden)return!1;const t=Df();if(!t.length)return!1;const a=t[0],r=t[t.length-1];return e.shiftKey&&document.activeElement===a?(e.preventDefault(),r.focus({preventScroll:!0}),!0):!e.shiftKey&&document.activeElement===r?(e.preventDefault(),a.focus({preventScroll:!0}),!0):!1}function Ja(){try{return`${window.location.pathname||"/terminal"}${window.location.search||""}${window.location.hash||""}`}catch{return"/terminal"}}function qf(e=Ja()){return`/login?returnTo=${encodeURIComponent(e||"/terminal")}`}function Tc(e="",t=80){return String(e||"").replace(/[\r\n\t]+/g," ").replace(/[^\w .:/?&=#@-]/g,"").trim().slice(0,t)}function Hf(e="unknown"){const t=Date.now();if(t-Number(n.lastLockInClickAt||0)<300)return;n.lastLockInClickAt=t;const a={route:Tc(n.route||ja(),40),viewport:Math.round(window.innerWidth||0),source:Tc(e,60),at:new Date(t).toISOString()};try{const r=JSON.parse(window.localStorage?.getItem("slimewireLockInClicks")||"[]");r.push(a),window.localStorage?.setItem("slimewireLockInClicks",JSON.stringify(r.slice(-10)))}catch{}try{console.info("LOCK_IN_CLICKED",a)}catch{}try{k("/api/web/lock-in-clicked",{method:"POST",timeoutMs:3e3,body:JSON.stringify(a)}).catch(()=>{})}catch{}}function Ac({defaultTab:e="login",returnTo:t=Ja(),source:a="unknown",connectPanel:r=n.route==="connect"}={}){if(_f(),Hf(a),n.loginModalOpen=!0,n.loginModalTab=e==="create"?"create":"login",n.loginReturnTo=t||Ja(),n.loginCollapsed=!1,n.walletConnectMenuOpen=!1,!Ce&&!Xo){window.location.assign(qf(n.loginReturnTo));return}h({force:!0}),kc(r)}function Pc(e={}){Ac(e)}function Ge(){return/Android|iPhone|iPad|iPod/i.test(navigator.userAgent||"")}function Cc(){try{const e=new URL(window.location.href);return e.hash="",e.toString()}catch{return window.location.href}}function Kf(){try{return new URL(window.location.href).origin}catch{return"https://slimewire.org"}}function Lc(e=""){if(!Ge())return"";const t=encodeURIComponent(Cc()),a=encodeURIComponent(Kf());return e==="phantom"?`https://phantom.app/ul/browse/${t}?ref=${a}`:e==="solflare"?`https://solflare.com/ul/v1/browse/${t}?ref=${a}`:""}function ii(e=""){return e==="phantom"?"https://phantom.app/download":e==="solflare"?"https://solflare.com/download":e==="backpack"?"https://backpack.app/download":""}function Ya(e=""){return e==="phantom"?"./assets/slimewire/clean-ui/wallet_icons/default/phantom.png":e==="solflare"?"./assets/slimewire/clean-ui/wallet_icons/default/solflare.png":"./assets/slimewire/svg/icons/wallet.svg"}function li(e){const t=e instanceof Uint8Array?e:new Uint8Array(e||[]);if(!t.length)return"";let a=0n;for(const s of t)a=(a<<8n)+BigInt(s);let r="";for(;a>0n;){const s=Number(a%58n);r=Yl[s]+r,a/=58n}for(const s of t){if(s!==0)break;r="1"+r}return r||"1"}function Xr(e=""){const t=String(e||"").trim();if(!t)return new Uint8Array;let a=0n;for(const s of t){const o=nf.get(s);if(o===void 0)throw new Error("Invalid wallet callback encoding.");a=a*58n+BigInt(o)}const r=[];for(;a>0n;)r.unshift(Number(a&255n)),a>>=8n;for(const s of t){if(s!=="1")break;r.unshift(0)}return new Uint8Array(r)}function Vf(e="phantom",t="",a=n.walletConnectReturnPath||"/terminal",r=""){const s=new URL(a||window.location.pathname||"/terminal",window.location.origin);return s.searchParams.delete("sw_wallet"),s.searchParams.delete("sw_wallet_state"),s.searchParams.delete("sw_wallet_pending"),s.searchParams.delete("phantom_encryption_public_key"),s.searchParams.delete("solflare_encryption_public_key"),s.searchParams.delete("nonce"),s.searchParams.delete("data"),s.searchParams.delete("errorCode"),s.searchParams.delete("errorMessage"),s.searchParams.set("sw_wallet",e),s.searchParams.set("sw_wallet_state",t),r&&s.searchParams.set("sw_wallet_pending",r),s.toString()}function Un(){try{const e=new URL(window.location.href);["sw_wallet","sw_wallet_state","sw_wallet_pending","phantom_encryption_public_key","solflare_encryption_public_key","nonce","data","errorCode","errorMessage"].forEach(t=>e.searchParams.delete(t)),window.history.replaceState({},"",`${e.pathname}${e.search}${e.hash}`)}catch{}}function xc(){try{const e=window.sessionStorage?.getItem(Io)||window.localStorage?.getItem(Oo)||"{}",t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function zf(e){try{window.sessionStorage?.setItem(Io,JSON.stringify(e))}catch{}try{window.localStorage?.setItem(Oo,JSON.stringify(e))}catch{}}function ci(){try{window.sessionStorage?.removeItem(Io)}catch{}try{window.localStorage?.removeItem(Oo)}catch{}}function Mc(e=""){return e==="solflare"?"solflare_encryption_public_key":"phantom_encryption_public_key"}function qn(e=""){return e==="phantom"?"https://phantom.app/ul/v1/connect":e==="solflare"?"https://solflare.com/ul/v1/connect":""}function jf(e="",t={}){const a=qn(e);if(!a)return"";const r=new URL(a);return r.searchParams.set("app_url",Cc()),r.searchParams.set("redirect_link",Vf(e,t.stateId,t.returnPath,t.pendingConnectId)),r.searchParams.set("dapp_encryption_public_key",t.dappEncryptionPublicKey),r.searchParams.set("cluster","mainnet-beta"),r.toString()}function ia(){return/Android/i.test(navigator.userAgent||"")?"android":/iPhone|iPad|iPod/i.test(navigator.userAgent||"")?"ios":Ge()?"mobile":"desktop"}function Bc(e=""){return Ge()&&!!qn(e)}function Gf(){const e=navigator.userAgent||"";return/CriOS|Chrome/i.test(e)?"chrome":/Safari/i.test(e)&&!/Chrome|CriOS/i.test(e)?"safari":/Firefox|FxiOS/i.test(e)?"firefox":"mobile-browser"}async function Xf(e="",t="/terminal"){try{const a=await k("/api/web/mobile-wallet/start",{method:"POST",timeoutMs:Cn,body:JSON.stringify({provider:e,intendedRoute:t,platform:ia(),browser:Gf()})});return!a.pendingConnectId||!a.stateId||!a.dappEncryptionPublicKey?null:{providerId:e,pendingConnectId:a.pendingConnectId,stateId:a.stateId,returnPath:a.intendedRoute||t,dappEncryptionPublicKey:a.dappEncryptionPublicKey,createdAt:Date.now(),expiresAt:a.expiresAt||"",serverManaged:!0}}catch(a){return Ft(e,a,{action:"mobile_connect_pending_start_failed",connectionFlow:"deeplink_connect",platform:ia()}),null}}function Jf(e="",t="/terminal"){if(!window.nacl?.box?.keyPair||!window.crypto?.getRandomValues)return null;const a=window.nacl.box.keyPair(),r=new Uint8Array(16);return window.crypto.getRandomValues(r),{providerId:e,stateId:li(r),returnPath:t,dappEncryptionPublicKey:li(a.publicKey),dappEncryptionSecretKey:li(a.secretKey),createdAt:Date.now(),serverManaged:!1}}async function Rc(e="",{returnPath:t=n.walletConnectReturnPath||"/terminal"}={}){if(!Bc(e))return!1;const a=await Xf(e,t)||Jf(e,t);if(!a)return!1;zf(a);const r=jf(e,a);if(!r)return!1;const s=_e(e);return oe(`Opening ${s} mobile connect. Approve in the wallet app, then return to SlimeWire.`),Ft(e,null,{action:"mobile_connect_redirect",adapterReadyState:"mobile_redirect",connectionFlow:"deeplink_connect",platform:ia()}),window.location.assign(r),!0}function Ic(e=""){const t=_e(e),a=Lc(e);return a?(oe(`Opening ${t}. If mobile connect is unavailable, use the wallet browser and return to SlimeWire.`),Ft(e,null,{action:"mobile_browse_redirect",adapterReadyState:"mobile_browse",connectionFlow:"browse_fallback",platform:ia()}),window.location.href=a,!0):!1}function Oc({requirePassword:e=!1}={}){const t=Gr(["[data-connect-login-username]","[data-login-username]"]).trim(),a=Gr(["[data-connect-login-password]","[data-login-password]"]);if(!t&&!a&&!e)return{};if(!t)throw new Error("Enter your username.");if(!a)throw new Error("Enter your password.");return{username:t,password:a}}function Yf(e=""){n.token="",n.user=null,n.loading=!1,Eo(),h(),T(e||"Your web session expired. Log in, or tap Create Account to start a fresh session.")}async function J(e=null,t="Creating secure web profile..."){if(n.user&&n.token)return n.user;S(e,t);const a=await k("/api/web/signup",{method:"POST",body:JSON.stringify({referralCode:ac()})});return n.token=a.token,he(a.user),Mn(n.token),n.user}function T(e=""){[vf,wf].forEach(t=>{t&&(t.hidden=!e,S(t,e))})}function Q(e){const t=String(e||"").trim();return t?`https://dexscreener.com/solana/${encodeURIComponent(t)}`:"#"}function Qf(e){const t=String(e||"").trim();return t?`https://pump.fun/coin/${encodeURIComponent(t)}`:"#"}function Ec(e){const t=String(e||"").trim();return t?`https://kolscan.io/account/${encodeURIComponent(t)}`:"https://kolscan.io"}async function di(){T("");const e=_n();try{const t=Oc();S(e,t.username?"Creating saved login...":"Creating account...");const a=await k("/api/web/signup",{method:"POST",body:JSON.stringify({...t,referralCode:ac()})});n.token=a.token,he(a.user),Mn(n.token),n.loginCollapsed=!0,n.loginModalOpen=!1,n.activeTab="dashboard",S(e,t.username?"Account created. Login saved.":"Quick web account created."),V(a.trade?.signature,"account-create")}catch(t){S(e,t.message),T(t.message)}}async function Fc(){T("");const e=_n();try{const t=Oc({requirePassword:!0});S(e,"Logging in...");const a=await k("/api/web/password-login",{method:"POST",body:JSON.stringify(t)});n.token=a.token,he(a.user),Mn(n.token),n.loginCollapsed=!0,n.loginModalOpen=!1,n.activeTab="dashboard",S(e,"Logged in."),V(a.trade?.signature,"password-login")}catch(t){S(e,t.message),T(t.message)}}function Wc(){return Gr(["[data-connect-login-email]","[data-login-email]"]).trim()}function Zf(){return Gr(["[data-connect-login-code]","[data-login-code]"]).trim()}function _c(e=""){const t=String(e||"").trim();if(!t)throw new Error("Enter the email saved on your web account.");if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t))throw new Error("Enter a valid email address.");return t}async function eh(){T("");const e=_n();try{const t=_c(Wc());S(e,"Sending login code...");const a=await k("/api/web/email-code",{method:"POST",body:JSON.stringify({email:t})});S(e,a.emailSent?"Code sent. Check your email, then enter it here.":"Code requested. Check your email if delivery is configured.")}catch(t){S(e,t.message),T(t.message)}}async function th(){T("");const e=_n();try{const t=_c(Wc()),a=Zf();if(!a)throw new Error("Enter the login code from your email.");S(e,"Checking login code...");const r=await k("/api/web/login",{method:"POST",body:JSON.stringify({email:t,code:a})});n.token=r.token,he(r.user),Mn(n.token),n.loginCollapsed=!0,n.loginModalOpen=!1,n.activeTab="dashboard",S(e,"Logged in."),V(r.trade?.signature,"email-code-login")}catch(t){S(e,t.message),T(t.message)}}function Nc(e="",t=new URLSearchParams){const a=xc(),r=t.get("sw_wallet_state")||"";if(!a.stateId||a.stateId!==r||a.providerId!==e)throw new Error("Wallet callback did not match the pending SlimeWire connection.");if(Date.now()-Number(a.createdAt||0)>1200*1e3)throw new Error("Wallet connection expired. Open Connect Wallet and try again.");const s=t.get(Mc(e))||"",o=t.get("nonce")||"",c=t.get("data")||"";if(!s||!o||!c)throw new Error("Wallet approval did not return the expected connection data.");const l=window.nacl;if(!l?.box?.before||!l.box.open?.after)throw new Error("Mobile wallet connection helper did not load. Refresh and try again.");const d=l.box.before(Xr(s),Xr(a.dappEncryptionSecretKey)),u=l.box.open.after(Xr(c),Xr(o),d);if(!u)throw new Error("Unable to verify the wallet approval response.");const p=JSON.parse(new TextDecoder().decode(u)),f=String(p.public_key||p.publicKey||"").trim();if(!f)throw new Error("Wallet approved, but no public address was returned.");return{publicKey:f,session:String(p.session||""),walletEncryptionPublicKey:s,dappEncryptionPublicKey:a.dappEncryptionPublicKey,returnPath:a.returnPath||"/terminal"}}async function Dc(e="",t={}){const a=Dn();await J(a,"Creating secure web profile for connected wallet...");const r=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({publicKey:t.publicKey,provider:_e(e)})});he(r.user||{...n.user,connectedWallet:r.profile?.connectedWallet||null}),n.connectedWalletBalance={publicKey:t.publicKey,shortPublicKey:w(t.publicKey),provider:_e(e),tokens:[]};try{window.sessionStorage?.setItem(`${Vm}${e}`,JSON.stringify({providerId:e,publicKey:t.publicKey,session:t.session,walletEncryptionPublicKey:t.walletEncryptionPublicKey,dappEncryptionPublicKey:t.dappEncryptionPublicKey,connectedAt:new Date().toISOString()}))}catch{}ci(),Un(),n.walletConnectMenuOpen=!1,oe(`Connected ${w(t.publicKey)}. Opening Live Terminal...`),Pe(t.returnPath||n.walletConnectReturnPath||"/terminal","terminal"),h({force:!0}),Yr("mobile-wallet-connect")}function ah(e="",t=new URLSearchParams){return{provider:e,pendingConnectId:t.get("sw_wallet_pending")||xc().pendingConnectId||"",stateId:t.get("sw_wallet_state")||"",queryKeys:[...t.keys()].filter(a=>a!=="data"&&a!=="nonce"),walletEncryptionPublicKey:t.get(Mc(e))||"",nonce:t.get("nonce")||"",data:t.get("data")||"",errorCode:t.get("errorCode")||"",errorMessage:t.get("errorMessage")||""}}async function nh(e="",t={}){t.token&&(n.token=t.token,Mn(n.token)),he(t.user||{...n.user,connectedWallet:t.connectedWallet||t.profile?.connectedWallet||null});const a=t.publicKey||t.connectedWallet?.publicKey||t.profile?.connectedWallet?.publicKey||"";a&&(n.connectedWalletBalance={publicKey:a,shortPublicKey:w(a),provider:t.provider||_e(e),tokens:[]}),ci(),Un(),n.walletConnectMenuOpen=!1,oe(a?`Connected ${w(a)}. Opening Live Terminal...`:"Wallet connected. Opening Live Terminal..."),Pe(t.finalRedirectRoute||n.walletConnectReturnPath||"/terminal","terminal"),h({force:!0}),Yr("mobile-wallet-callback")}async function Uc(e="",t=new URLSearchParams){const a=await k("/api/web/mobile-wallet/callback",{method:"POST",timeoutMs:Cn,body:JSON.stringify(ah(e,t))});return await nh(e,a),!0}async function rh(){const e=new URLSearchParams(window.location.search||""),t=e.get("sw_wallet")||"";if(!["phantom","solflare"].includes(t))return!1;n.walletConnectMenuOpen=!0;const a=_e(t),r=e.get("sw_wallet_pending")||"",s=e.get("errorCode")||"",o=e.get("errorMessage")||"";if(s||o)return r&&await Uc(t,e).catch(()=>{}),ci(),Un(),oe(`${a} did not connect: ${o||s||"request cancelled"}. Choose another wallet or try again.`),Ft(t,new Error(o||s||"Wallet connect cancelled"),{action:"mobile_connect_cancelled",connectionFlow:"deeplink_connect",platform:ia()}),h({force:!0}),!0;try{if(oe(`Finishing ${a} mobile connection...`),r)await Uc(t,e);else{const c=Nc(t,e);await Dc(t,c)}}catch(c){if(r)try{const l=Nc(t,e);await Dc(t,l)}catch{oe(`${a} mobile connection could not finish: ${c.message}`),Ft(t,c,{action:"mobile_connect_callback_failed",connectionFlow:"deeplink_connect",platform:ia()}),Un(),h({force:!0})}else oe(`${a} mobile connection could not finish: ${c.message}`),Ft(t,c,{action:"mobile_connect_callback_failed",connectionFlow:"deeplink_connect",platform:ia()}),Un(),h({force:!0})}return!0}async function sh(){T("");const e=Dn()||_n();try{S(e,"Choose a wallet provider to connect."),pa({returnPath:"/terminal"})}catch(t){S(e,t.message),T(t.message)}}async function oh(){n.user||await di(),n.user&&(n.walletConnectMenuOpen=!1,n.route="terminal",n.activeTab="wallets",n.toolSections={...n.toolSections||{},wallets:n.wallets.length?"balances":"create"},window.history.pushState({},"","/terminal"),h(),n.wallets.length||await Au())}async function ih(){if(n.logoutPending)return;if(!n.user){n.loginCollapsed=!1,h(),En?.scrollIntoView?.({behavior:"smooth",block:"start"});return}await lu("logging out");const e=String(n.token||"");n.logoutPending=!0;const t=m("[data-logout]");t&&(t.disabled=!0,S(t,"Logging out...")),n.token="",n.user=null,n.wallets=[],n.balances=[],n.positions=[],n.pnl=null,n.connectedWalletBalance=null,n.walletRefreshing=!1,n.walletRefreshStatus="idle",n.walletRefreshError="",n.positionRefreshAction={state:"idle",startedAt:0,minUntil:0,error:""},n.manualSellActions={},n.tradeActionLocks={},n.ogreAgentStatus="",Il(),Eo(),h({force:!0});try{e&&await k("/api/web/logout",{method:"POST",headers:{Authorization:`Bearer ${e}`},timeoutMs:4e3,dedupe:!1})}catch{}finally{n.logoutPending=!1}}async function lh(){if(!n.token){h();return}try{const e=await k("/api/web/me");he(e.user),h({preserveSmartChartFrame:n.activeTab==="smartChart"}),He({force:!1,deep:!1,reason:"session-load"}).catch(t=>{n.walletRefreshError=t.message||"Wallet refresh failed.",h({preserveSmartChartFrame:n.activeTab==="smartChart"})})}catch{n.token="",Eo(),h()}}async function la(e={}){const t=L();if(!n.user||!n.token){n.wallets=[],n.balances=[],n.positions=[],n.pnl=null,n.connectedWalletBalance=null,n.launchWatches=[],n.presets={trade:[],bundle:[]},n.tradePlans=[],n.watchlist={rows:[],count:0},h();return}const a=!e.silent;a&&(n.loading=!0,h());try{const r=e.force?"?force=true":"";if(e.skipCore){const[y,b,v,P,A]=await Promise.all([k("/api/web/pnl"),k("/api/web/launch/watches"),k("/api/web/presets"),k("/api/web/watchlist"),k("/api/web/trade/plans")]);n.pnl=y.pnl||null,n.launchWatches=b.watches||[],n.presets=v.presets||{trade:[],bundle:[]},Ku(),n.watchlist=P.watchlist||{rows:[],count:0},n.tradePlans=A.plans||[],Ps();return}const[s,o,c,l,d,u,p,f]=await Promise.all([k("/api/web/wallets"),k(`/api/web/balances${r}`),k(`/api/web/positions${r}`),k("/api/web/pnl"),k("/api/web/launch/watches"),k("/api/web/presets"),k("/api/web/watchlist"),k("/api/web/trade/plans")]);n.wallets=s.wallets||[],n.balances=o.balances||[],n.connectedWalletBalance=o.connectedWallet||c.connectedWallet||null,n.positions=c.positions||[],n.pnl=l.pnl||null,n.launchWatches=d.watches||[],n.presets=u.presets||{trade:[],bundle:[]},Ku(),n.watchlist=p.watchlist||{rows:[],count:0},n.tradePlans=f.plans||[],Ps(),e.force&&(n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshError="")}finally{K("load-all",t,{component:"wallet",resultCount:(n.balances?.length||0)+(n.positions?.length||0),details:e.skipCore?"skip-core":"core"}),a&&(n.loading=!1),h()}}async function ui(e={}){if(!n.user||!n.token)return;const t=L(),a=e.requestId||0,r=()=>a&&n.walletRefreshRequestId!==a,s=e.force?"?force=true":"",o=e.force||e.deep?"?force=true":"",c=e.timeoutMs||Cn,l=k("/api/web/wallets",{timeoutMs:c}),d=k(`/api/web/balances${s}`,{timeoutMs:c}),u=k("/api/web/trade/plans",{timeoutMs:c}),p=await d;if(r())return;n.balances=p.balances||[],n.connectedWalletBalance=p.connectedWallet||null,n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshError="",K("wallet-refresh",t,{component:"wallet",resultCount:n.balances.length,cacheHit:!!p.cacheHit,details:`wallets=${n.wallets.length};connected=${!!n.connectedWalletBalance}`}),e.progress!==!1&&h({preserveSmartChartFrame:!!e.preserveSmartChartFrame});const[f,y]=await Promise.all([l.then(b=>({ok:!0,wallets:b})).catch(b=>({ok:!1,error:b})),u.then(b=>({ok:!0,tradePlans:b})).catch(b=>({ok:!1,error:b}))]);if(!r()&&(f.ok&&(n.wallets=f.wallets.wallets||n.wallets||[]),y.ok&&(n.tradePlans=y.tradePlans.plans||n.tradePlans||[],Ps()),e.progress!==!1&&(f.ok||y.ok)&&h({preserveSmartChartFrame:!!e.preserveSmartChartFrame}),e.deep)){const b=L(),v=k(`/api/web/positions${o}`,{timeoutMs:c}).catch(P=>({__error:P}));try{const P=await v;if(P?.__error)throw P.__error;if(r())return;n.connectedWalletBalance=P.connectedWallet||n.connectedWalletBalance||null,n.positions=P.positions||[],n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshError="",K("positions-refresh",b,{component:"positions",resultCount:n.positions.length,cacheHit:!!P.cacheHit,details:`open=${n.positions.length}`})}catch(P){n.walletRefreshError=P.message||"Position refresh failed.",K("positions-refresh",b,{errorCode:P?.code||P?.name||"POSITIONS_REFRESH_FAILED",component:"positions",details:N(P?.message||"Position refresh failed.")})}}}function qc(e=n.positions){return(Array.isArray(e)?e:[]).some(t=>{const a=t?.estimatedValueSol!==null&&t?.estimatedValueSol!==void 0&&t?.estimatedValueSol!=="";return!!(t?.valuePending||!a&&/refreshing|updating|background/i.test(t?.valueError||""))})}function Hc(e=120,t="positions-value-followup"){!n.user||!n.token||(Ur&&window.clearTimeout(Ur),Ur=window.setTimeout(()=>{Ur=null,wt({force:!0,fast:!1,silent:!0,followUpValues:!1,reason:t,timeoutMs:Yt}).then(a=>{a?(n.lastWalletRefreshAt=new Date().toISOString(),h({preserveSmartChartFrame:n.activeTab==="smartChart"})):Jr(`${t}-failed`)}).catch(()=>Jr(`${t}-failed`))},Math.max(0,Number(e)||0)))}function ch(e=[],t=[],a={}){const r=new Map((Array.isArray(t)?t:[]).map(s=>[String(s?.tokenMint||""),s]));return(Array.isArray(e)?e:[]).map(s=>{const o=r.get(String(s?.tokenMint||""));if(!o||a.fast===!1)return s;const c=!!(s?.valuePending||/refreshing|updating|background/i.test(s?.valueError||"")),l=o.estimatedValueSol!==null&&o.estimatedValueSol!==void 0&&o.estimatedValueSol!=="";return!c||!l?s:{...s,estimatedValueSol:o.estimatedValueSol,openPnlSol:o.openPnlSol,openPnlPercent:o.openPnlPercent,valuePending:!1,valueError:""}})}function Jr(e="positions-value-refresh-delayed"){let t=!1;return n.positions=(Array.isArray(n.positions)?n.positions:[]).map(a=>{const r=a?.estimatedValueSol!==null&&a?.estimatedValueSol!==void 0&&a?.estimatedValueSol!=="";return!(a?.valuePending||/refreshing|updating|background/i.test(a?.valueError||""))?a:(t=!0,{...a,valuePending:!1,valueError:r?"":"Price refresh delayed; tap Refresh."})}),t?(K("positions-value-refresh-cleanup",L(),{component:"positions",details:e}),h({preserveSmartChartFrame:n.activeTab==="smartChart"}),!0):!1}function Kc(e="portfolio-supplemental"){if(!n.user||!n.token)return;const t=L();Promise.allSettled([k("/api/web/balances?force=true",{timeoutMs:Yt}),k("/api/web/pnl?force=true",{timeoutMs:Yt,dedupe:!1})]).then(([a,r])=>{a.status==="fulfilled"&&(n.balances=a.value.balances||n.balances||[],n.connectedWalletBalance=a.value.connectedWallet||n.connectedWalletBalance||null),r.status==="fulfilled"&&(n.pnl=r.value.pnl||n.pnl||null),n.lastWalletRefreshAt=new Date().toISOString(),K("portfolio-supplemental-refresh",t,{component:"wallet",resultCount:(n.balances?.length||0)+(n.positions?.length||0),details:e}),h({preserveSmartChartFrame:n.activeTab==="smartChart"})}).catch(()=>{})}async function wt(e={}){if(!n.user||!n.token)return;const t=L(),a=new URLSearchParams;e.force&&a.set("force","true"),e.fast!==!1&&a.set("fast","true");const r=a.toString()?`?${a.toString()}`:"",s=r||"full";if(In&&_o===s)return In;const o=++No;return _o=s,In=(async()=>{try{const c=await k(`/api/web/positions${r}`,{timeoutMs:e.timeoutMs||(e.fast===!1?Yt:Bo)});return No!==o?!1:(n.connectedWalletBalance=c.connectedWallet||n.connectedWalletBalance||null,n.positions=ch(c.positions||n.positions||[],n.positions||[],e),n.lastWalletRefreshAt=new Date().toISOString(),n.walletRefreshError="",K("positions-refresh",t,{component:"positions",resultCount:n.positions.length,cacheHit:!!c.cacheHit,details:`${e.reason||(e.silent?"silent":"refresh")};fast=${e.fast!==!1}`}),e.followUpValues&&e.fast!==!1&&qc(n.positions)&&Hc(120,`${e.reason||"positions"}-values`),e.syncPnl&&Kc(`${e.reason||"positions"}-sync-pnl`),!0)}catch(c){return e.silent||(n.walletRefreshError=c.message||"Position refresh failed."),K("positions-refresh",t,{errorCode:c?.code||c?.name||"POSITIONS_REFRESH_FAILED",component:"positions",details:N(c?.message||"Position refresh failed.")}),!1}finally{No===o&&(In=null,_o="")}})(),In}async function dh(e={}){if(!n.user||!n.token){T("Connect your wallet before refreshing positions."),je("error",{error:"Wallet not connected"});return}const t=L();Xa("refreshing",{startedAt:n.positionRefreshAction?.startedAt||t}),n.walletRefreshError="",Ee("[data-sync-health]",rs()),de(),await xe(20);try{if(!await wt({force:!!e.force,fast:!1,silent:!1,followUpValues:!1,reason:e.reason||"positions-only",timeoutMs:Yt}))throw new Error(n.walletRefreshError||"Position refresh failed.");n.lastWalletRefreshAt=new Date().toISOString(),je("success",{error:""}),Kc(`${e.reason||"positions-only"}-balances-pnl`),qc(n.positions)&&Hc(120,`${e.reason||"positions-only"}-full-values`),K("positions-only-refresh",t,{component:"positions",resultCount:n.positions.length,details:e.reason||"positions-only"})}catch(a){const r=a?.message||"Position refresh failed.";n.walletRefreshError=r,je("error",{error:N(r)}),T(r),K("positions-only-refresh",t,{errorCode:a?.code||a?.name||"POSITIONS_REFRESH_FAILED",component:"positions",details:N(r)})}finally{h()}}function Hn(){return String(n.smartChartToken||n.tradeToken||n.bundleToken||n.volumeToken||n.terminalToken||"").trim()}function Xe(e=n.activeTab){return Pf[e]||null}function Qa(e=Xe()){return String(e?.cacheKey||e?.tabKey||"terminal:unknown").replace("{bucket}",tn(n.livePairBucket)).replace("{sort}",String(n.terminalSort||"best")).replace("{scopeMode}",String(n.slimeScopeMode||"new")).replace("{kolMode}",String(n.kolMode||"hot")).replace("{kolWallet}",n.kolWallet?w(n.kolWallet):"global").replace("{scanMode}",String(n.scanMode||"safe")).replace("{tokenMint}",Hn()?w(Hn()):"none")}function Vc(e=n.activeTab,t="pageSize",a=25){const r=Xe(e),s=Number(r?.[t]);return Number.isFinite(s)&&s>0?s:a}function Za(e=n.activeTab){return Vc(e,"pageSize",25)}function pi(e=n.activeTab){return Math.max(Za(e),Vc(e,"maxPageSize",Za(e)))}function zc(e=n.activeTab){return!!Xe(e)?.supportsPagination}function mi(e=n.activeTab){const t=Xe(e)||{tabKey:e};return`${e}:${Qa(t)}`}function Kn(e=n.activeTab,t=0){const a=mi(e),r=Za(e),s=pi(e),o=Number(n.terminalFeedVisibleLimits?.[a]||0),c=Number.isFinite(o)&&o>0?o:r,l=Number(t||0),d=Math.min(Math.max(r,c),s);return l>0?Math.min(d,l):d}function Z(e=n.activeTab){const t=mi(e);if(!n.terminalFeedVisibleLimits?.[t])return;const a={...n.terminalFeedVisibleLimits||{}};delete a[t],n.terminalFeedVisibleLimits=a}function uh(e=n.activeTab,t=0){const a=mi(e),r=Kn(e,t),s=Za(e),o=pi(e),c=Number(t||0),l=Math.min(o,c>0?c:o,r+s);return n.terminalFeedVisibleLimits={...n.terminalFeedVisibleLimits||{},[a]:l},l}function ot(e=n.activeTab,t=[]){const a=Array.isArray(t)?t:[];return a.slice(0,Kn(e,a.length))}function ph(e=n.activeTab,t=[]){const a=Array.isArray(t)?t:[];return zc(e)&&a.length>Kn(e,a.length)}function ca(e=n.activeTab,t=[],a="rows"){const r=Array.isArray(t)?t:[];if(!ph(e,r))return"";const s=Kn(e,r.length);return`
...
`);return o?Promise.resolve(window.prompt(c||e,o.value||"")):Promise.resolve(window.confirm(c||e))}return new Promise(c=>{const l=document.createElement("div");l.className="slime-confirm-overlay",l.innerHTML=`
  ...
  `}function md(){const e=we([...qe()?.rows||[],...typeof gr=="function"?gr():[],...n.slimeScopeRows||[],...n.livePairRows||[],...Object.values(n.livePairsByBucket||{}).flatMap(t=>t?.rows||[])]).filter(t=>t?.tokenMint).slice(0,4);return e.length?e:[{tokenMint:n.smartChartToken||n.tradeToken||"",symbol:"SlimeWire",name:"Live Terminal",marketCapLabel:"checking",liquidityLabel:"checking",volumeH1Label:"live"}]}function fd(e,t={}){const a=e?.getContext?.("2d");if(!a)return;const r=Math.max(1,Math.min(3,window.devicePixelRatio||1)),s=720,o=1280;(e.width!==s*r||e.height!==o*r)&&(e.width=s*r,e.height=o*r,e.style.width=`${s}px`,e.style.height=`${o}px`),a.setTransform(r,0,0,r,0,0);const c=Math.max(0,Math.min(1,Number(t.progress||0))),l=t.rows||md(),d=new Date;a.fillStyle="#020803",a.fillRect(0,0,s,o);const u=a.createRadialGradient(s*.2,o*.12,20,s*.2,o*.12,460);u.addColorStop(0,"rgba(118,255,45,0.35)"),u.addColorStop(1,"rgba(118,255,45,0)"),a.fillStyle=u,a.fillRect(0,0,s,o),a.strokeStyle="rgba(118,255,45,0.38)",a.lineWidth=2,a.strokeRect(24,24,s-48,o-48),a.fillStyle="#baff4d",a.font="900 34px Arial, sans-serif",a.fillText("SlimeWire REC",48,88),a.fillStyle="#f4fff0",a.font="800 54px Arial, sans-serif",a.fillText("Fresh Live Picks",48,154),a.fillStyle="rgba(226,255,215,0.78)",a.font="700 22px Arial, sans-serif",a.fillText(`Mobile in-site clip - ${d.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}`,48,196);const p=s-96;a.fillStyle="rgba(118,255,45,0.12)",a.fillRect(48,226,p,12),a.fillStyle="#78ff2d",a.fillRect(48,226,Math.max(24,p*c),12),l.forEach((f,y)=>{const b=292+y*188,v=String(f.symbol||f.baseSymbol||w(f.tokenMint||"")||"Token").slice(0,18),P=String(f.name||f.category||"fresh pair").slice(0,34),A=_(f.marketCapLabel,f.fdvLabel,M(mt(f)),"checking"),g=_(f.liquidityLabel,M(ft(f)),"checking"),$=_(f.volumeH1Label,f.volumeLabel,M(f.volumeH1),"checking"),C=String(f.pairAgeLabel||Vt(f)||"live").slice(0,18);a.fillStyle="rgba(4,24,8,0.92)",a.strokeStyle="rgba(118,255,45,0.34)",a.lineWidth=2,a.beginPath(),typeof a.roundRect=="function"?a.roundRect(48,b,s-96,156,18):a.rect(48,b,s-96,156),a.fill(),a.stroke(),a.fillStyle="#f4fff0",a.font="900 32px Arial, sans-serif",a.fillText(v,76,b+48),a.fillStyle="rgba(226,255,215,0.72)",a.font="700 18px Arial, sans-serif",a.fillText(P,76,b+78),[["MC",A],["LIQ",g],["VOL",$],["AGE",C]].forEach(([B,U],H)=>{const Se=76+H*140;a.fillStyle="#aaff8f",a.font="800 15px Arial, sans-serif",a.fillText(B,Se,b+114),a.fillStyle="#ffffff",a.font="900 23px Arial, sans-serif",a.fillText(String(U).slice(0,10),Se,b+142)})}),a.fillStyle="rgba(226,255,215,0.72)",a.font="700 20px Arial, sans-serif",a.fillText("Generated by SlimeWire Clip Farm when mobile screen capture is blocked.",48,o-78),a.fillStyle="#78ff2d",a.font="900 24px Arial, sans-serif",a.fillText("slimewire.org",48,o-44)}async function Mh(e){fd(e,{progress:1});const t=await new Promise(r=>{try{e.toBlob(s=>r(s),"image/png",.92)}catch{r(null)}});if(!t){$i();return}const a=URL.createObjectURL(t);n.clipFarm={...n.clipFarm,recording:!1,recorder:null,stream:null,chunks:[],fallbackFrameTimer:null,fallbackStopTimer:null,blob:t,videoUrl:a,mimeType:"image/png",fileExtension:"png",status:"Mobile clip ready (.png)."},Je()}async function Bh(){const e=cd();if(!e){$i();return}const t=e.captureStream||e.mozCaptureStream;if(!t||!window.MediaRecorder){await Mh(e);return}Ti();const a=md(),r=Date.now(),s=t.call(e,12),o=ud(),c=[],l=new MediaRecorder(s,o?{mimeType:o}:void 0),d=()=>fd(e,{rows:a,progress:(Date.now()-r)/4200});d();const u=setInterval(d,1e3/12);l.addEventListener("dataavailable",f=>{f.data?.size>0&&c.push(f.data)}),l.addEventListener("stop",()=>{Zn();const f=o||"video/webm",y=new Blob(c,{type:f}),b=y.size>0?URL.createObjectURL(y):"",v=Qn(y.type||f);n.clipFarm={...n.clipFarm,recording:!1,recorder:null,stream:null,chunks:[],fallbackFrameTimer:null,fallbackStopTimer:null,blob:y.size>0?y:null,videoUrl:b,mimeType:y.type||f,fileExtension:v,status:y.size>0?`Mobile clip ready (.${v}).`:"No mobile clip captured."},Je()},{once:!0}),l.start(500);const p=setTimeout(()=>{n.clipFarm?.recording&&er()},4300);n.clipFarm={recording:!0,status:"Recording mobile clip...",blob:null,videoUrl:"",mimeType:o,fileExtension:Qn(o),recorder:l,stream:s,chunks:c,fallbackFrameTimer:u,fallbackStopTimer:p},Je()}async function hd(){if(!ld()){if(dd()){await Bh();return}$i();return}if(n.clipFarm?.recording){er();return}Ti();try{const e=await navigator.mediaDevices.getDisplayMedia({video:{frameRate:{ideal:30,max:30},width:{ideal:1280},height:{ideal:720}},audio:!0}),t=ud(),a=[],r=new MediaRecorder(e,t?{mimeType:t}:void 0);r.addEventListener("dataavailable",s=>{s.data?.size>0&&a.push(s.data)}),r.addEventListener("stop",()=>{Zn();const s=t||"video/webm",o=new Blob(a,{type:s}),c=o.size>0?URL.createObjectURL(o):"",l=Qn(o.type||s);n.clipFarm={...n.clipFarm,recording:!1,recorder:null,stream:null,chunks:[],blob:o.size>0?o:null,videoUrl:c,mimeType:o.type||s,fileExtension:l,status:o.size>0?`Clip ready (.${l}).`:"No clip captured."},Je()},{once:!0}),e.getVideoTracks?.()[0]?.addEventListener?.("ended",()=>er(),{once:!0}),r.start(1e3),n.clipFarm={recording:!0,status:"Recording...",blob:null,videoUrl:"",mimeType:t,fileExtension:Qn(t),recorder:r,stream:e,chunks:a},Je()}catch(e){Zn(),n.clipFarm={...n.clipFarm,recording:!1,recorder:null,stream:null,chunks:[],status:e?.name==="NotAllowedError"?"Recording cancelled.":"Recording could not start."},Je()}}function er(){const e=n.clipFarm?.recorder;if(!e){Zn(),n.clipFarm={...n.clipFarm,recording:!1,stream:null,recorder:null,chunks:[],fallbackFrameTimer:null,fallbackStopTimer:null},Je();return}try{if(e.state!=="inactive"){Nt("Saving clip..."),e.stop();return}}catch{}Zn(),n.clipFarm={...n.clipFarm,recording:!1,stream:null,recorder:null,chunks:[],fallbackFrameTimer:null,fallbackStopTimer:null},Je()}async function Rh(){const e=n.clipFarm?.blob;if(!e){Nt("Record a clip first.");return}const t=new File([e],pd(),{type:e.type||n.clipFarm?.mimeType||"video/webm"});try{if(navigator.canShare?.({files:[t]})&&navigator.share){await navigator.share({title:"SlimeWire clip",text:"SlimeWire clip farm",files:[t]}),Nt("Shared.");return}}catch(a){if(a?.name==="AbortError"){Nt("Share cancelled.");return}}Nt("Use Save, then attach the clip to X or Telegram.")}function Ih(){const e=n.clipFarm?.videoUrl;if(!e){Nt("Record a clip first.");return}const t=document.createElement("a");t.href=e,t.download=pd(),document.body.appendChild(t),t.click(),t.remove(),Nt("Saved.")}function Oh(e=null,t="chartTxns"){const a=e||Ks(),r=String(a?.tokenMint||n.smartChartToken||"").trim();return r?{mint:r,mode:t,src:lp(a,t)}:null}function Eh(e={}){if(e.refreshSmartChartFrame||n.route!=="terminal"||n.activeTab!=="smartChart")return null;const t=document.querySelector("[data-panel] .smart-chart-frame[data-chart-mint][data-chart-mode]"),a=t?.querySelector("iframe");if(!t||!a)return null;const r=String(t.dataset.chartMode||"chartTxns"),s=Oh(null,r);if(!s||t.dataset.chartMint!==s.mint||t.dataset.chartMode!==s.mode)return null;const o=String(t.dataset.chartSrc||a.getAttribute("src")||""),c=t.dataset.loaded==="true",l=o!==s.src;return t.dataset.preserving="true",{frame:t,mint:s.mint,mode:s.mode,src:l?o:s.src,loaded:c,keepByMint:l}}function Fh(e=null){if(!e?.frame||!e.frame.querySelector?.("iframe"))return!1;const t=String(e.mint||"").replace(/["\\]/g,"\\$&"),a=String(e.mode||"").replace(/["\\]/g,"\\$&"),r=document.querySelector(`[data-panel] .smart-chart-frame[data-chart-mint="${t}"][data-chart-mode="${a}"]`),s=r?.dataset?.chartSrc||r?.querySelector?.("iframe")?.getAttribute("src")||"";return!r||r===e.frame||s!==e.src&&!e.keepByMint?(e.frame.removeAttribute("data-preserving"),!1):(e.frame.removeAttribute("data-preserving"),e.loaded&&(e.frame.dataset.loaded="true"),r.replaceWith(e.frame),!0)}function h(e={}){if(!ce||!En||!re)return;if(rn(),!e.force&&wi()){rd();return}const t=L(),a=`${n.route}:${n.activeTab||"none"}`;try{n.perfRenderCounts={...n.perfRenderCounts||{},[a]:(n.perfRenderCounts?.[a]||0)+1},n.pendingRender=!1;const r=!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey||n.wallets.length);rn(),ce.dataset.activeTab=n.activeTab||"";const o=!!((e.preserveSmartChartFrame||n.activeTab==="smartChart")&&n.route==="terminal"&&n.activeTab==="smartChart"&&document.querySelector("[data-panel] .smart-chart-frame iframe"))?Eh(e):null,c=!!Ce,l=!!(c&&n.loginModalOpen);Xo&&(Xo.hidden=c||!!n.user||n.loginCollapsed),It("[data-connect-login-panel]",c||!!n.user||n.loginCollapsed),Ce?(Ce.hidden=!l,Ce.setAttribute("aria-hidden",l?"false":"true"),Ce.toggleAttribute("inert",!l),document.body.classList.toggle("login-modal-open",l),document.querySelectorAll("[data-login-tab]").forEach(v=>{const P=v.dataset.loginTab===n.loginModalTab;v.dataset.active=P?"true":"false",v.setAttribute("aria-selected",P?"true":"false")}),It("[data-login-modal-login-section]",n.loginModalTab!=="login"),It("[data-login-modal-create-section]",n.loginModalTab!=="create")):document.body.classList.remove("login-modal-open"),cc&&(cc.hidden=!1),dc&&(dc.hidden=!!n.user),uc&&(uc.hidden=!n.user),rn(),Ee("[data-user-id]",n.user?.id||"guest"),Ee("[data-wallet-count]",yi()),Ee("[data-total-sol]",_t().toFixed(4));const d=it();Ee("[data-position-count]",d.length),Ee("[data-realized]",vi());try{const v=m("[data-realized]");if(v){const P=/-/.test(String(vi()||""));v.classList.toggle("metric-neg",P),v.classList.toggle("metric-pos",!P)}}catch{}Ee("[data-top-sol]",`${_t().toFixed(4)} SOL`),Ee("[data-top-portfolio]",`${d.length} position${d.length===1?"":"s"}`),Ee("[data-sync-health]",r?rs():"Sync idle"),Ee("[data-active-preset-label]",Ah()),Pi(),Nh(),It("[data-refresh-spinner]",!n.walletRefreshing),document.querySelectorAll('[data-feature="ogre-tek"]').forEach(v=>{v.hidden=!Um||!Fm(Ae)});const u=m("[data-user-avatar]");u&&(u.innerHTML=sn("SW"));const p=m("[data-top-avatar]");p&&(p.innerHTML=sn("SW"));const f=n.user?.connectedWallet||null;Ee("[data-connected-wallet-summary]",f?`${f.provider||"Browser wallet"} connected: ${w(f.publicKey)}`:n.user?"No browser wallet connected.":"Browse scans now. Create or connect only when you are ready.");const y=m("[data-logout]");y&&(y.hidden=!n.user,y.disabled=!!n.logoutPending,S(y,n.logoutPending?"Logging out...":"Log Out")),n.route==="terminal"&&Gh(),Fh(o),vg(),Sg(),rl(),Ta(),Aa(),As(),kr(),Je(),E(),Kw("render"),Yn(),de();const b=L()-t;(b>=16||n.perfRenderCounts[a]%20===0)&&W({component:"render",action:"render",durationMs:b,resultCount:n.perfRenderCounts[a],details:a}),oc=Date.now()}catch(r){rn(),Yn(),ni({component:"render-boundary",errorCode:r?.name||"RENDER_FAILED",message:r?.message||"Render failed",caughtByBoundary:!0});const s=m("[data-panel]");n.route==="terminal"&&s?(re.hidden=!1,s.innerHTML=`
      ...
      `),T("Display refresh failed. Your trade was not resubmitted. Tap Retry Refresh.")}}function gd(e=""){const t=String(e||"").trim();if(t)return t.toLowerCase();const a=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(a)return`connected:${String(a).toLowerCase()}`;const r=Array.isArray(n.wallets)&&n.wallets.length?n.wallets.map(s=>s.publicKey||s.address||s.label||"").filter(Boolean).join("|"):"";return r?`managed:${r.toLowerCase().slice(0,240)}`:"wallet-session"}function Wh(e=""){try{return sessionStorage.getItem(`tpslAutoRevoked:${gd(e)}`)==="yes"}catch{return!1}}function bd(e,t=""){try{const a=`tpslAutoRevoked:${gd(t)}`;e?sessionStorage.setItem(a,"yes"):sessionStorage.removeItem(a)}catch{}}function Ai(e=""){bd(!1,e)}function yd(){return!!(Array.isArray(n.wallets)&&n.wallets.length||n.user?.connectedWallet||n.connectedWalletBalance?.publicKey)}function vd(){const e=n.user?.automationPermission||{},t=Date.parse(e.expiresAt||""),a=!!e.enabled&&Number.isFinite(t)&&t<=Date.now();return!!n.user?.automationPermissionActive&&!a&&!e.revokedAt}function _h(){return!(!yd()||Wh()||vd()||n.tpslAutoEnableInFlight)}function wd(e="wallet-session"){if(!_h())return;const t=L();n.tpslAutoEnableScheduledAt&&t-n.tpslAutoEnableScheduledAt<2e3||(n.tpslAutoEnableScheduledAt=t,n.tpslAutoEnableInFlight=!0,setTimeout(()=>{Gi("enable",{auto:!0,reason:e}).catch(a=>{n.automationDelegationStatus=a?.message||"TP/SL auto-enable failed.",T(n.automationDelegationStatus)}).finally(()=>{n.tpslAutoEnableInFlight=!1,Pi()})},50))}function Pi(){const e=m("[data-tpsl-status-button]");if(!e)return;const t=m("[data-tpsl-status-label]"),a=n.user?.automationPermission||{},r=!!n.user?.automationPermissionActive,s=!!a.revokedAt,o=Date.parse(a.expiresAt||""),c=!!a.enabled&&Number.isFinite(o)&&o<=Date.now(),l=r?"enabled":s||c?"invalid":"disabled";e.dataset.tpslState=l;const d=l==="enabled"?"TP/SL Enabled":l==="invalid"?"Re-enable TP/SL":"Enable TP/SL";S(t,d),e.setAttribute("aria-label",`${d}. Stop loss and take profit require wallet auto-sell approval.`),e.title=l==="enabled"?`Server exits enabled${a.expiresAt?` until ${Te(a.expiresAt)}`:""}.`:"Stop loss and take profit require wallet auto-sell approval."}function Nh(){const e=n.user?.connectedWallet||n.connectedWalletBalance||null,t=String(e?.publicKey||"").trim(),a=Array.isArray(n.wallets)?n.wallets.length:0,r=!!(t||a),s=r?"Connected":"Connect",o=t?"Wallet: Connected":a?`Wallets: ${a}`:"Wallet: Connect",c=t?`${e.provider||"Browser wallet"} connected: ${w(t)}`:a?`${a} SlimeWire wallet${a===1?"":"s"} available.`:"Connect a browser wallet.";document.querySelectorAll("[data-top-wallet-connect]").forEach(l=>{l.dataset.walletState=r?"connected":"disconnected",l.title=c,l.setAttribute("aria-label",r?`${c} Open wallets.`:"Connect wallet");const d=l.querySelector("[data-top-wallet-connect-label]")||l;S(d,s)}),document.querySelectorAll("[data-top-wallet-status]").forEach(l=>{l.dataset.walletState=t?"browser-connected":r?"managed-connected":"disconnected",l.title=t?`${c} Click to disconnect.`:r?`${c} Click to open wallets.`:"Click to connect a wallet.",l.setAttribute("aria-label",t?`${c}. Disconnect wallet.`:r?`${c} Open wallets.`:"Wallet not connected. Connect wallet."),S(l,o)})}async function Dh(){const e=n.user?.connectedWallet||n.connectedWalletBalance||null,t=String(e?.publicKey||"").trim(),a=Array.isArray(n.wallets)?n.wallets.length:0;if(t){await Me({title:"Disconnect Wallet",lines:[`Disconnect ${e.provider||"wallet"} ${w(t)}?`],confirmLabel:"Disconnect",danger:!0})&&await Lu();return}if(a>0){Pe("/terminal","wallets");return}pa({returnPath:"/terminal"})}function Uh(e=document){const t=()=>{const a=e.querySelector?.(".smart-chart-terminal")||document.querySelector(".smart-chart-terminal");if(!a)return;const r=Math.max(0,a.getBoundingClientRect().top+window.scrollY);window.scrollTo({top:r,behavior:"auto"})};requestAnimationFrame(()=>{t(),window.setTimeout(t,80),window.setTimeout(t,280),window.setTimeout(t,800)})}const Sd=new Set(["terminal","live","slimeScope","kol","watchlist","liveTrades","sniper"]),qh=[".signal-row[data-token-chart]",".terminal-token-row[data-token-chart]",".compact-signal-row[data-token-chart]","[data-token-chart][data-token-chart-source]"].join(",");function Hh(e=""){return String(e).replace(/\\/g,"\\\\").replace(/"/g,'\\"')}function tr(){return!!(window.matchMedia?.("(max-width: 760px)")?.matches||(window.innerWidth||0)<=760)}function Ci(e=m("[data-panel]")){if(!e||n.route!=="terminal"||!Sd.has(n.activeTab))return null;const t=e.dataset.renderedTab,a=document.scrollingElement||document.documentElement,r={tab:n.activeTab,windowY:window.scrollY||0,documentY:a?.scrollTop||0,panelScrollTop:e.scrollTop||0,dashboardScrollTop:re?.scrollTop||0,anchorKey:"",anchorTop:0},s=Array.from(e.querySelectorAll(qh));if(t&&t!==n.activeTab&&!s.length||!s.length)return r;const o=s.find(l=>{const d=l.getBoundingClientRect(),u=tr()?42:72;return d.bottom>u&&d.top<Math.min(window.innerHeight||720,720)})||s[0],c=o?.dataset?.tokenChart||o?.dataset?.tokenMint||"";return{...r,anchorKey:c,anchorTop:o?o.getBoundingClientRect().top:0}}function Li(e,t=m("[data-panel]")){if(!e||n.route!=="terminal"||e.tab!==n.activeTab)return;const a=(o,c)=>{if(!o||!Number.isFinite(Number(c))||o.scrollHeight<=o.clientHeight+2)return;const l=Math.max(0,Math.min(Number(c),o.scrollHeight-o.clientHeight));Math.abs((o.scrollTop||0)-l)>4&&(o.scrollTop=l)},r=o=>{const c=document.scrollingElement||document.documentElement;a(re,e.dashboardScrollTop),a(o,e.panelScrollTop),a(c,e.documentY),Math.abs((window.scrollY||0)-Number(e.windowY||0))>8&&window.scrollTo(0,Math.max(0,Number(e.windowY||0)))},s=()=>{const o=t?.isConnected?t:m("[data-panel]");let c=!1;if(e.anchorKey&&o){const l=Hh(e.anchorKey),d=o.querySelector(`[data-token-chart="${l}"], [data-token-mint="${l}"]`);if(d){const p=d.getBoundingClientRect().top-Number(e.anchorTop||0);Number.isFinite(p)&&Math.abs(p)>1&&window.scrollTo(0,Math.max(0,(window.scrollY||0)+p)),c=!0}}c||r(o)};s(),requestAnimationFrame(()=>{s(),window.setTimeout(s,90),window.setTimeout(s,240),tr()&&window.setTimeout(s,520)})}function kd(e,t){const a=Object.keys(e.dataset||{}).filter(o=>o!=="customFor"&&o!=="customSelect").sort().map(o=>`${o}=${e.dataset[o]}`).join("|"),r=e.type==="checkbox"||e.type==="radio"?`:${e.value}`:"",s=`${e.tagName}:${e.type||""}:${e.name||""}:${a}${r}`;return a?s:`${s}:idx${t}`}function $d(e){const t=Array.from(e.options||[]),a=t.find(r=>r.defaultSelected);return a?a.value:t[0]?.value??""}function Kh(e){if(!e||e.dataset.renderedTab!==n.activeTab)return null;const t=new Map;let a="",r=null,s=null;return Array.from(e.querySelectorAll("input, textarea, select")).forEach((o,c)=>{const l=kd(o,c);if(t.has(l))return;const d=o.type==="checkbox"||o.type==="radio",u=o.tagName==="SELECT",p=d?String(o.defaultChecked):u?$d(o):o.defaultValue,f=d?String(o.checked):o.value;if(f!==p&&(t.set(l,{value:f,defaultValue:p,isToggle:d,isSelect:u}),document.activeElement===o)){a=l;try{r=o.selectionStart,s=o.selectionEnd}catch{}}}),t.size?{tab:n.activeTab,fields:t,focusedKey:a,selectionStart:r,selectionEnd:s}:null}function Vh(e,t){if(!e||!t||e.tab!==n.activeTab)return;const a=Array.from(t.querySelectorAll("input, textarea, select")),r=s=>{a.forEach((o,c)=>{const l=o.tagName==="SELECT";if(s!==l)return;const d=kd(o,c),u=e.fields.get(d);if(!u)return;const p=o.type==="checkbox"||o.type==="radio";if((p?String(o.defaultChecked):l?$d(o):o.defaultValue)===u.defaultValue&&(p?o.checked=u.value==="true":o.value=u.value,d===e.focusedKey&&document.activeElement!==o))try{o.focus({preventScroll:!0}),Number.isFinite(e.selectionStart)&&Number.isFinite(e.selectionEnd)&&o.setSelectionRange(e.selectionStart,e.selectionEnd)}catch{}})};r(!0),r(!1)}function zh(e){return!e||n.route!=="terminal"||n.activeTab==="terminal"||Sd.has(n.activeTab)||e.dataset.renderedTab!==n.activeTab||n.activeTab==="smartChart"&&n.chartScrollIntoView?null:{tab:n.activeTab,windowY:window.scrollY||0,panelScrollTop:e.scrollTop||0,dashboardScrollTop:re?.scrollTop||0}}function jh(e,t){if(!e||e.tab!==n.activeTab)return;const a=()=>{const r=t?.isConnected?t:m("[data-panel]");r&&r.scrollHeight>r.clientHeight+2&&(r.scrollTop=Math.min(e.panelScrollTop,r.scrollHeight-r.clientHeight)),re&&re.scrollHeight>re.clientHeight+2&&(re.scrollTop=Math.min(e.dashboardScrollTop,re.scrollHeight-re.clientHeight)),Math.abs((window.scrollY||0)-e.windowY)>8&&window.scrollTo(0,Math.max(0,e.windowY))};a(),requestAnimationFrame(a)}function Gh(){const e=m("[data-panel]");if(!e)return;const t=Ci(e),a=Kh(e),r=zh(e),s=n.activeTab==="terminal"&&e.querySelector(".terminal-dock")?.scrollTop||0,o=n.activeTab==="terminal"?window.scrollY:0;document.querySelectorAll("[data-tab]").forEach(c=>{!c.closest(".tabs")&&!c.closest("[data-nav-drop]")&&c.removeAttribute("data-active")}),Tk();try{document.body.classList.toggle("launch-focus",window.location.pathname.includes("/launch-coin")&&n.activeTab==="launchCoin")}catch{}if(document.querySelectorAll(".tabs [data-tab]").forEach(c=>{c.dataset.active=c.dataset.tab===n.activeTab?"true":"false"}),document.querySelectorAll(".tabs .nav-tool-group").forEach(c=>{const l=!!c.querySelector('[data-active="true"]'),d=typeof window<"u"&&window.matchMedia?.("(min-width: 761px)")?.matches;c.open=!!d||!!n.navTekOpen||!pf()&&l}),n.activeTab==="terminal"&&(e.innerHTML=Zp()),n.activeTab==="tek"&&(e.innerHTML=Jh()),n.activeTab==="dashboard"&&(e.innerHTML=ng()),n.activeTab==="profile"&&(e.innerHTML=rg()),n.activeTab==="trade"&&(e.innerHTML=db()),n.activeTab==="bundle"&&(e.innerHTML=bb()),n.activeTab==="volume"&&(e.innerHTML=_b()),n.activeTab==="live"&&(e.innerHTML=Zp()),n.activeTab==="liveTrades"&&(e.innerHTML=lS()),n.activeTab==="slimeScope"&&(e.innerHTML=Rw()),n.activeTab==="watchlist"&&(e.innerHTML=wS()),n.activeTab==="smartChart"&&(e.innerHTML=Yw()),n.activeTab==="launchCoin"&&(e.innerHTML=jb()),n.activeTab==="launch"&&(e.innerHTML=Nb()),n.activeTab==="kol"&&(e.innerHTML=dy()),n.activeTab==="ogreAi"&&(e.innerHTML=gb()),n.activeTab==="wallets"&&(e.innerHTML=Iv()),n.activeTab==="positions"&&(e.innerHTML=_v()),n.activeTab==="pnl"&&(e.innerHTML=Hv()),n.activeTab==="txAudit"&&(e.innerHTML=Gp()),n.activeTab==="sniper"&&(e.innerHTML=TS()),e.dataset.renderedTab=n.activeTab||"",n.activeTab==="ogreTek"&&(e.innerHTML=RS(),e.dataset.renderedTab=n.activeTab||"",MS()),Vh(a,e),bs(e),jh(r,e),["trade","volume","launchCoin","sniper","ogreAi","bundle","positions","pnl"].includes(n.activeTab))try{ma[n.activeTab]&&!e.querySelector("[data-ogre-stage]")&&e.insertAdjacentHTML("afterbegin",ob(n.activeTab)),sb(e)}catch{}if(["terminal","live","kol","slimeScope","watchlist","smartChart"].includes(n.activeTab))try{eb(e,n.activeTab)}catch{}try{Qg()}catch{}if(n.activeTab==="smartChart"&&n.chartFocusAmountInput&&requestAnimationFrame(()=>{const c=m("[data-chart-buy-amount]");c&&c.focus(),n.chartFocusAmountInput=!1}),n.activeTab==="smartChart"&&n.chartScrollIntoView&&(Uh(e),n.chartScrollIntoView=!1),n.activeTab==="terminal"){const c=e.querySelector(".terminal-dock");c&&(c.scrollTop=s),requestAnimationFrame(()=>{Math.abs(window.scrollY-o)>8&&window.scrollTo(0,o);const d=e.querySelector(".terminal-dock");d&&(d.scrollTop=s)})}Li(t,e),yh(),ua(),ts(),jn(),as(),hi(),n.activeTab==="kol"&&zi()}function Xh(){const e=n.pnl?.totals?.realizedSol||"+0 SOL";return`
  ...
  `}const Td="slimewire-ogre-memory";function ss(){try{return JSON.parse(localStorage.getItem(Td)||"{}")||{}}catch{return{}}}function os(e={}){const t={...ss(),...e};try{localStorage.setItem(Td,JSON.stringify(t))}catch{}return t}function Yh(e,t=""){if(!e)return;const r=(ss().recentTokens||[]).filter(s=>s.mint!==e);r.unshift({mint:e,symbol:String(t||"").slice(0,14),at:Date.now()}),os({recentTokens:r.slice(0,5)})}(function(){const t=ss();t.quickBuy&&!n.quickBuyAmountOverride&&(n.quickBuyAmountOverride=t.quickBuy)})();function Ad(){const t=pr().filter(l=>{const d=Number(l.marketCapUsd??l.marketCap)||0;return d>0&&d<8e3}).length,r=(Array.isArray(n.tradePlans)?n.tradePlans:[]).filter(l=>["watching","active"].includes(String(l.status||"").toLowerCase())),s=r.filter(l=>{const d=Number(l.lastMovePct??l.wallets?.[0]?.lastMovePct),u=Number(l.takeProfitPct);return Number.isFinite(d)&&Number.isFinite(u)&&u>0&&d>u*.7}).length,o=Number(n.shieldReceipts?.stats?.watching||0),c=Number(n.proofStats?.wins||0);return[c?`✅ ${c} tracked call(s) hit 2x - the proof wall has receipts`:"",t?`🐣 ${t} fresh under 8k MC on the feed`:"",r.length?`🛡 ${r.length} plan(s) armed${s?` - ${s} near take-profit`:""}`:"",o?`🔎 ${o} flagged token(s) being tracked to outcome`:""].filter(Boolean)}let Pd=!1;function Qh(){if(Pd||$n().length)return;Pd=!0;const e=Ad(),t=ss(),a=[t.quickBuy?`your quick buy is still ${t.quickBuy} SOL`:"",t.risk==="degen"?"serving the early risky ones first, like you asked":t.risk==="careful"?"keeping it shield-clean first, like you asked":"",t.recentTokens?.[0]?.symbol?`last visit you were on $${t.recentTokens[0].symbol}`:""].filter(Boolean),r=a.length?` I remember: ${a.join(", ")}.`:"";fe({role:"assistant",text:e.length?`Welcome back. Right now: ${e.join(". ")}.${r} Ask me anything or say "open positions".`:`Welcome to SlimeWire. I can navigate anywhere, check any CA, set your quick buy, and run trades from chat.${r} Try "whats cooking" or paste a token address.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Positions",type:"open_tab",tab:"positions"}]})}function Zh(){return`
    <section class="trade-card ogre-brief-card">
      ...
      <ul class="ogre-brief-list">
        ${[...Ad(),"🧾 Proof wall is public - slimewire.org/proof"].map(t=>`<li>${i(t)}</li>`).join("")}
      </ul>
    </section>
          ...
          ${t.map(r=>`
            <article class="row-card">
              <div class="row-main">
                ...
                <span>Flagged ${i(r.verdict)} (score ${i(String(r.score))}) ${r.confirmedAfterMinutes?`- confirmed dead within ${i(tg(r.confirmedAfterMinutes))}`:""}</span>
  ...
  `}function tg(e){const t=Number(e)||0;return t<90?`${t} min`:t<2880?`${Math.round(t/60)}h`:`${Math.round(t/1440)}d`}let Cd=0;function ag(){Date.now()-Cd<300*1e3||(Cd=Date.now(),k("/api/web/shield/receipts").then(e=>{n.shieldReceipts=e,n.activeTab==="tek"&&h()}).catch(()=>{}),k("/api/web/proof").then(e=>{n.proofStats=e?.alpha||null}).catch(()=>{}))}function ng(){return`
    ${fg()}
    ${is()}
  ...
  `}function r0(){const e=n.user?.connectedWallet;return`
  ...
  `}function pa({returnPath:e="/terminal"}={}){n.walletConnectMenuOpen=!0,n.walletConnectReturnPath=e||"/terminal",n.walletConnectStatus=n.user?.connectedWallet?`Connected ${w(n.user.connectedWallet.publicKey)}. Pick a provider to reconnect or switch.`:"Pick a wallet. Your extension will ask you to approve.",h({force:!0})}function bg(e={}){return pa(e)}window.openWalletConnectModal=bg;function yg(e){n.walletFastApprovalsEnabled=!!e;try{localStorage.setItem("walletFastApprovalsEnabled",n.walletFastApprovalsEnabled?"on":"off")}catch{}}function vg(){const e=m("[data-wallet-connect-modal]");if(!e)return;if(!n.walletConnectMenuOpen){e.hidden=!0,e.innerHTML="",e.__lastDrawerHtml="";return}const t=n.user?.connectedWallet||n.connectedWalletBalance;e.hidden=!1,Sn(e,`
  ...
  `,".wallet-connect-dialog")}function wg(){const e=n.quickBuyModal||{},t=Ks()?.tokenMint===e.tokenMint?Ks():ve(e.tokenMint,{source:e.source||"quick-buy-modal"}),a=/validating|submitting|opening wallet/i.test(String(e.status||"")),r=Bi(e.error||e.status||""),s=a||!!r,o=pe(e.walletIndex||"");return`
  ...
  `}function $g(){const e=n.user?.referralCode||"",t=`${Bt.replace(/\/+$/,"")}/r/`,a=n.user?.referralLink||(e?`${Bt.replace(/\/+$/,"")}/r/${encodeURIComponent(e)}`:""),r=n.user?.referralStats||{},s=Array.isArray(r.referrals)?r.referrals:[];return`
    <section class="create-wallet-card referral-card">
      ...
      <div class="card-actions">
        ...
        ${a?Od(`Trade faster on SlimeWire. Referral: ${a}`,"Share TG"):""}
      </div>
  ...
  `}function Id(){return n.downloads?`
  ...
  `:""}function Ye(e,t="Share X"){return`<button type="button" data-share-x data-share-text="${i(e)}">${i(t)}</button>`}function Od(e,t="TG"){const a=Ri(e),r=`https://t.me/share/url?url=${encodeURIComponent(Bt)}&text=${encodeURIComponent(a)}`;return`<a href="${i(r)}" target="_blank" rel="noreferrer">${i(t)}</a>`}function Ri(e){const t=String(e||"").replace(/\s+/g," ").trim();return`${t.length>210?`${t.slice(0,207).trim()}...`:t} ${Bt}`}function Pg(e){const t=e.type==="buy",a=t?`${e.spentSol} SOL`:`${e.netSol} SOL`;return`${t?"Bought":"Sold"} ${e.shortMint||w(e.tokenMint)} for ${a}. Chart ${Q(e.tokenMint)}`}function s0(e){return`${e.type==="bundle_sell"?"Bundle sold":e.source==="web_bundle_plan"?"Armed bundle auto-exit":"Bundle bought"} ${e.shortMint||w(e.tokenMint)} across ${e.successCount||0}/${e.walletCount||0} wallet(s).`}function Cg(e,t="Armed timed trade"){return`${t} on ${e.shortMint||w(e.tokenMint)} with ${e.successCount||0}/${e.walletCount||0} wallet(s), TP ${e.takeProfitSummary||`+${e.takeProfitPct}%`}, SL ${e.stopLossSummary||`-${e.stopLossPct}%`}.`}function Ed(e){return`PnL on ${e.shortMint||w(e.tokenMint)}: ${e.realizedSol} realized, ${e.buys} buy(s), ${e.sells} sell(s).`}function Lg(e){return`Watching ${e.shortMint||w(e.tokenMint)}: ${e.uiAmount} tokens across ${e.walletCount} wallet(s), PnL ${e.openPnlSol||e.realizedSol||"tracking"}.`}function xg(e){return`Watching ${e.symbol||w(e.tokenMint)}: score ${e.score}/100, MC ${e.marketCapLabel}, liq ${e.liquidityLabel}. Chart ${Q(e.tokenMint)}`}function Mg(e){return`KOL signal ${e.symbol||w(e.tokenMint)}: score ${e.score||0}/100, value ${e.valueLabel||"$0"}, signal ${e.winRateLabel||"n/a"}. Chart ${Q(e.tokenMint)}`}function Bg(e){return`Watching KOL ${e.twitter?`@${e.twitter}`:e.name||e.shortWallet||w(e.wallet)}: realized ${e.realizedLabel||"n/a"}, ROI ${e.roiLabel||"n/a"}, trades ${e.trades??"n/a"}.`}function Rg(e){return`Watching $${e.ticker} with Launch Snipe: ${e.walletCount} wallet(s), ${e.amountSol} SOL each, TP ${e.takeProfitSummary||`+${e.takeProfitPct}%`}, SL ${e.stopLossSummary||`-${e.stopLossPct}%`}.`}function Ii(e){const t=String(e||"").trim(),a=t.startsWith("$")?t:t.length>30?w(t):`$${t.replace(/^\$+/,"")}`,r=t.length>30?` Chart ${Q(t)}`:"";return`Watching ${a}.${r}`}function Fd(e){const t=String(e||"").trim();return`Watching KOL ${t.startsWith("@")?t:t.length>30?w(t):`@${t.replace(/^@+/,"")}`}.`}const Ig=[{tier:"hot",pinned:!0,rank:1,name:"Idontpaytaxes",twitter:"Idontpaytaxes",wallet:"",kolscanUrl:"https://kolscan.io/account/2T5NgDDidkvhJQg8AHDI74uCFwgp25pYFMRZXBaCUNBH",tag:"External KOLscan profile",note:"External public/KOLscan stats only. These are not SlimeWire trades and do not create SlimeWire fees unless copied through your SlimeWire wallets. Add a verified Solana wallet before scan/copy.",winRateLabel:"36.8%",realizedLabel:"-$28.1",roiLabel:"Watch",trades:"24 ext",volumeLabel:"$6.58K volume",lastTradeAt:new Date(Date.now()-1020*60*1e3).toISOString()},{tier:"slimewire",pinned:!0,rank:1,name:"MoonPieJoe",twitter:"moonpiejoe",tag:"SlimeWire KOL",note:"Supporter profile. Add wallet later to enable scan/copy trade.",winRateLabel:"Supporter",realizedLabel:"n/a",roiLabel:"Social",trades:"Add wallet"},{tier:"slimewire",pinned:!0,rank:2,name:"Rezzy",twitter:"zero_taxes",tag:"SlimeWire KOL",note:"Supporter profile. Add wallet later to enable scan/copy trade.",winRateLabel:"Supporter",realizedLabel:"n/a",roiLabel:"Social",trades:"Add wallet"}];function Oi(e=""){const t=String(e||"").trim().toLowerCase();return Ig.filter(a=>!t||String(a.tier||"").toLowerCase()===t).sort((a,r)=>+!!r.pinned-+!!a.pinned||Number(a.rank||999)-Number(r.rank||999))}function Dt(e=""){return/^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(String(e||"").trim())}function Wd(e=""){const t=String(e||"").trim();return Dt(t)?t:""}function Og(e={}){const t=String(e.wallet||"").trim(),a=Wd(t),r=et(e.twitter||e.x||e.username||"");return{x:r?Wi(r):"",wallet:a?`https://solscan.io/account/${encodeURIComponent(a)}`:"",kolscan:e.kolscanUrl||e.externalProfileUrl||(a?Ec(a):"")}}function Eg(e={}){const t=String(e.wallet||"").trim(),a=Wd(t),r=Og(e);return`
  ...
  `}function _d(e={},t={}){const a=!!t.compact,r=String(e.wallet||"").trim();return`
    <article class="curated-kol-card ${a?"is-compact":""}" data-tier="${i(e.tier||"hot")}">
      <div class="curated-kol-top">
        ${Ud(e,a?"kol-avatar small":"kol-avatar")}
        <div>
  ...
  `}function Fg(){const e=Oi("hot"),t=Oi("slimewire");return`
      ...
      <div class="curated-kol-layout">
        <article class="curated-kol-main">
          ...
          <div class="curated-kol-list">
            ${e.length?e.map(a=>_d(a)).join(""):F("No curated hot wallets yet","Add wallets to the curated database to pin them here.")}
          </div>
        </article>
  ...
  `}function sn(e="SW"){const t=Qe(n.user?.avatar||"");if(Nd(t))return`<img src="${i(t)}" alt="" referrerpolicy="no-referrer" onerror="this.onerror=null;this.src='${xl("ogre")}';">`;const a=xl("ogre");if(e==="SW"||e==="OG")return`<img src="${a}" alt="">`;const r=String(e||"SW").trim().slice(0,2).toUpperCase()||"SW";return`<span>${i(r)}</span>`}function Nd(e){const t=String(e||"").trim();return/^data:image\/(png|jpe?g|webp|gif);base64,/i.test(t)||/^https?:\/\/[^\s"'<>]+$/i.test(t)}function Qe(e){const t=String(e||"").trim();if(!t)return"";if(/^\/api\/web\/token-image\?/i.test(t))return t;if(/^ipfs:\/\//i.test(t)){const a=t.replace(/^ipfs:\/\//i,"").replace(/^ipfs\//i,"");return a?`https://ipfs.io/ipfs/${encodeURIComponent(a).replace(/%2F/g,"/")}`:""}return/^\/\//.test(t)?`https:${t}`:/^https?:\/\/[^\s"'<>]+$/i.test(t)||/^data:image\/(png|jpe?g|webp|gif);base64,/i.test(t)?t:""}function Wg(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||e.address||"").trim();return t?`/api/web/token-image?mint=${encodeURIComponent(t)}`:""}function _g(e="",t=""){const a=String(e||"").trim(),r=Qe(t);if(!a||!r||ls(a,r))return"";if(yt.set(a,r),se("avatarCacheHit"),yt.size>900){for(const s of yt.keys())if(yt.delete(s),yt.size<=720)break}return r}function Dd(e="",t=""){return`${String(e||"").trim()}|${Qe(t)}`}function Ng(e=""){return/^\/api\/web\/token-image\?/i.test(String(e||""))?45e3:1800*1e3}function ls(e="",t=""){const a=Dd(e,t);if(!Qt.has(a))return!1;const r=Number(Rr.get(a)||0);return r&&Date.now()-r>Ng(t)?(Qt.delete(a),Rr.delete(a),!1):!0}function Dg(e="",t=""){const a=String(e||"").trim(),r=Qe(t);if(!a||!r)return;const s=Dd(a,r);if(Qt.add(s),Rr.set(s,Date.now()),Qt.size>1200){for(const o of Qt)if(Qt.delete(o),Rr.delete(o),Qt.size<=900)break}yt.get(a)===r&&yt.delete(a),se("avatarFetchFailed")}function Ei(e="",...t){const a=String(e||"").trim(),r=a?yt.get(a):"";if(r&&!ls(a,r))return se("avatarCacheHit"),r;r&&yt.delete(a);for(const s of t){const o=Qe(s);if(o&&!ls(a,o))return se("avatarCacheMiss"),o}return se("avatarFallbackShown"),""}window.__slimeRememberAvatar=_g,window.__slimeAvatarLoadFailed=function(t){const a=t?.dataset?.avatarKey||"",r=t?.currentSrc||t?.src||t?.dataset?.avatarSrc||"";Dg(a,r);const s=Qe(t?.dataset?.backupSrc||"");if(s&&!ls(a,s)){t.dataset.backupSrc="",t.dataset.avatarSrc=s,t.src=s;return}const o=Qe(t?.dataset?.proxySrc||""),c=Number(t?.dataset?.avatarRetries||0);if(o&&c<3){t.dataset.avatarRetries=String(c+1),t.hidden=!0,setTimeout(()=>{try{if(!t.isConnected)return;t.hidden=!1,t.src=o+(o.indexOf("?")>=0?"&":"?")+"rt="+(c+1)}catch{}},2600);return}t&&(t.hidden=!0,t.removeAttribute("src"))};function Fi(e){const t=et(e);return t?`https://unavatar.io/twitter/${encodeURIComponent(t)}`:""}function Wi(e=n.xHandle){const t=et(e);return t?`https://x.com/${encodeURIComponent(t)}`:"https://x.com/i/flow/login"}function Ug(e={}){const t=Qe(e.avatar||e.image||"");if(Nd(t))return t;const a=et(e.twitter||e.x||e.username||"");if(a)return Fi(a);const r=et(e.name||e.kolName||"");return r&&r.length>=2?Fi(r):""}function qg(e={}){return String(e.twitter||e.name||e.kolName||e.shortWallet||e.wallet||"KO").trim().replace(/^@+/,"").slice(0,2).toUpperCase()||"KO"}function Ud(e={},t="kol-avatar"){const a=`kol:${String(e.wallet||e.address||e.twitter||e.x||e.username||e.name||e.kolName||"").trim().toLowerCase()}`,r=Ei(a,Ug(e)),s=qg(e);return r?`<img class="${i(t)}" src="${i(r)}" data-avatar-key="${i(a)}" data-avatar-fallback="${i(s)}" alt="" loading="eager" decoding="async" referrerpolicy="no-referrer" onload="window.__slimeRememberAvatar&&window.__slimeRememberAvatar(this.dataset.avatarKey,this.currentSrc||this.src);" onerror="var d=document.createElement('div');d.className=this.className+' kol-avatar-fallback';d.setAttribute('aria-hidden','true');d.textContent=this.dataset.avatarFallback||'KO';this.replaceWith(d);">`:`<div class="${i(t)} kol-avatar-fallback" aria-hidden="true">${i(s)}</div>`}function cs(){const e=Ge();return[{id:"phantom",label:"Phantom",detected:!!ge("phantom"),mobileRedirect:e&&!!qn("phantom"),installUrl:ii("phantom"),icon:Ya("phantom")},{id:"solflare",label:"Solflare",detected:!!ge("solflare"),mobileRedirect:e&&!!qn("solflare"),installUrl:ii("solflare"),icon:Ya("solflare")},{id:"backpack",label:"Backpack",detected:!!ge("backpack"),mobileRedirect:!1,installUrl:ii("backpack"),icon:Ya("backpack")},{id:"solana",label:"Detected Wallet",detected:!!ge("solana"),mobileRedirect:!1,installUrl:"",icon:Ya("solana")}]}function ge(e){return e==="phantom"?window.phantom?.solana||(window.solana?.isPhantom?window.solana:null):e==="solflare"?window.solflare||(window.solana?.isSolflare?window.solana:null):e==="backpack"?window.backpack?.solana||null:e==="solana"&&(window.solana||window.solflare||window.phantom?.solana||window.backpack?.solana)||null}function _e(e,t){return e==="phantom"?"Phantom":e==="solflare"?"Solflare":e==="backpack"?"Backpack":t?.isPhantom?"Phantom":t?.isSolflare?"Solflare":t?.isBackpack?"Backpack":"Solana Wallet"}function ue(){return n.user?.connectedWallet||n.connectedWalletBalance||null}function Hg(e=""){const t=ue();if(!t?.publicKey)return"";const a=String(e||"")==="connected"||!e&&!n.wallets.length,r=t.provider||"Browser Wallet";return`<option value="connected" ${a?"selected":""}>${i(r)} - ${i(w(t.publicKey))}</option>`}function w(e){const t=String(e||"");return t.length>10?`${t.slice(0,4)}...${t.slice(-4)}`:t||"token"}const _i="/assets/slimewire/swap/states/",lt="/assets/slimewire/swap/sfx/",qd="/assets/slimewire/volume/states/",ds="/assets/slimewire/volume/sfx/",Kg="/assets/slimewire/ui/tick.mp3",Vg="/assets/slimewire/ui/flip.mp3",zg={swap:new Set(["idle","appraise","buy","sell","banking","win","loss"]),volume:new Set(["idle","running","sweep","stop"]),sniper:new Set(["idle","fire","lock"]),ogreAi:new Set(["idle","speak","think"]),bundle:new Set(["idle","volley","sell"]),launchCoin:new Set(["idle","launch","forge"]),positions:new Set(["idle","win","survey"]),pnl:new Set(["idle","win","survey"])},jg={swap:{appraise:[lt+"appraise.mp3",.7],buy:[lt+"buy.mp3",.85],sell:[lt+"sell.mp3",.85],win:[lt+"win.mp3",.85],loss:[lt+"loss.mp3",.6],banking:[lt+"bank.mp3",.8]},volume:{running:[ds+"start.mp3",.7],sweep:[ds+"sweep.mp3",.8],stop:[ds+"stop.mp3",.8]},sniper:{fire:["/assets/slimewire/auto/sfx/shockwave.mp3",.8],lock:["/assets/slimewire/sniper/sfx/lock.mp3",.7]},ogreAi:{think:["/assets/slimewire/ogreai/sfx/think.mp3",.6],speak:[lt+"appraise.mp3",.6]},bundle:{volley:["/assets/slimewire/auto/sfx/shockwave.mp3",.8],sell:["/assets/slimewire/bundle/sfx/sell.mp3",.8]},launchCoin:{forge:["/assets/slimewire/launch/sfx/forge.mp3",.85],launch:[lt+"win.mp3",.8]},positions:{survey:["/assets/slimewire/positions/sfx/survey.mp3",.7],win:["/assets/slimewire/auto/sfx/victory.mp3",.85]},pnl:{survey:["/assets/slimewire/positions/sfx/survey.mp3",.7],win:["/assets/slimewire/auto/sfx/victory.mp3",.85]}},Gg={sniper:[["[data-sniper-arm]","lock"],["__text:snipe|ape|fire","fire"]],ogreAi:[["[data-ogre-ai-start]","think"]],bundle:[["[data-bundle-buy]","volley"],["[data-bundle-sell]","sell"]],launchCoin:[["[data-launch-coin-submit]","forge"],["__text:launch","forge"]],positions:[["[data-refresh-all],[data-refresh],[data-refresh-positions]","survey"]],pnl:[["[data-refresh-all],[data-refresh]","survey"]]},Hd={},ma={launchCoin:{base:"/assets/slimewire/launch/states/",poster:"/assets/slimewire/launch/hero.png",tier:"OGRE FORGE",cap:["Pump Launcher","Forge it · birth it · send it."],accent:"launch",idle:"idle",event:"launch",sfx:[lt+"win.mp3",.8]},sniper:{base:"/assets/slimewire/sniper/states/",poster:"/assets/slimewire/sniper/hero.png",tier:"OGRESNIPER",cap:["OgreSniper","Lock on · strike first."],accent:"sniper",idle:"idle",event:"fire",sfx:["/assets/slimewire/auto/sfx/shockwave.mp3",.8]},ogreAi:{base:"/assets/slimewire/ogreai/states/",poster:"/assets/slimewire/ogreai/hero.png",tier:"OGRE A.I.",cap:["Ogre A.I.","Ask the swamp oracle."],accent:"ogreai",idle:"idle",event:"speak",sfx:[lt+"appraise.mp3",.6]},bundle:{base:"/assets/slimewire/bundle/states/",poster:"/assets/slimewire/bundle/hero.png",tier:"OGRE BUNDLE",cap:["Bundle","Many wallets · one volley."],accent:"bundle",idle:"idle",event:"volley",sfx:["/assets/slimewire/auto/sfx/shockwave.mp3",.8]},positions:{base:"/assets/slimewire/positions/states/",poster:"/assets/slimewire/positions/hero.png",tier:"POSITIONS",cap:["Open Positions","Your swamp, live."],accent:"positions",idle:"idle",event:"win",sfx:["/assets/slimewire/auto/sfx/victory.mp3",.85]},pnl:{base:"/assets/slimewire/positions/states/",poster:"/assets/slimewire/positions/hero.png",tier:"PROFIT & LOSS",cap:["PnL","Count the winnings."],accent:"positions",idle:"idle",event:"win",sfx:["/assets/slimewire/auto/sfx/victory.mp3",.85]}};function Kd(){const e=R.kind;return e==="swap"?_i:e==="volume"?qd:ma[e]?ma[e].base:_i}const o0={launchCoin:"[data-launch-coin-submit]",ogreAi:"[data-ogre-ai-start]",bundle:"[data-bundle-buy]"};let Vd=!1;function Xg(){Vd||(Vd=!0,document.addEventListener("click",e=>{try{const t=e.target.closest("[data-ogre-card]");if(t){e.preventDefault(),e.stopPropagation(),Yg(t.getAttribute("data-ogre-card"));return}const a=R.kind;if(!a)return;const r=document.querySelector(`[data-ogre-stage="${a}"]`);if(!r)return;const s=e.target.closest("button, a[role='button'], [data-swap-reverse], select, input[type='range'], label.oss-pill, [role='button']");if(!s||s.closest("[data-ogre-snd],[data-ogre-card]"))return;const o=r.closest("[data-rendered-tab]")||r.parentElement||document;if(o.contains&&!o.contains(s))return;const c=()=>ps(Kg,.5);if(ma[a]){const l=Gg[a]||[],d=(s.textContent||"").toLowerCase();for(const[u,p]of l)if(u.startsWith("__text:")){if(new RegExp(u.slice(7)).test(d)){ie(r,p,!0);return}}else if(s.closest(u)){ie(r,p,!0);return}c();return}if(a==="swap"){s.closest("[data-swap-use-custom-amount]")?ie(r,n.swapDirection==="sell"?"sell":"buy",!0):s.closest("[data-swap-reverse]")?(ie(r,"appraise",!0),ps(Vg,.6)):s.closest("[data-swap-to],[data-swap-from],[data-trade-token]")?ie(r,"appraise",!0):c();return}if(a==="volume"){s.closest("[data-vbot-start]")?ie(r,"running",!0):s.closest("[data-vbot-stop]")?ie(r,"stop",!0):s.closest("[data-vbot-set-mode],[data-vbot-set-aggr],[data-vbot-set-stagger],[data-vbot-source]")?ie(r,"sweep",!0):c();return}}catch{}},!0))}function Jg(e,t){try{const a=document.createElement("a");a.href=t,a.download=e,document.body.appendChild(a),a.click(),a.remove()}catch{}}async function Yg(e){const t=r=>{const s=Number(r);return Number.isFinite(s)?s.toFixed(4):"0"};let a=null;if(e==="swap"){const r=n.tradeResult||{};a={theme:"swap",receipt:!0,loss:!1,headline:"SWAPPED",mint:r.tokenMint||n.tradeToken||"",symbol:String(r.symbol||r.shortMint||"TOKEN"),name:"OgreSwap",lines:[r.type==="sell"?`Received ${t(r.netSol)} SOL`:r.type==="buy"?`Aped ${t(r.spentSol)} SOL`:"Swapped on SlimeWire","OgreSwap · on-chain","slimewire.org"]}}else if(e==="volume"){const r=Array.isArray(n.volumeBots)?n.volumeBots:[],s=r.find(d=>d&&d.status!=="completed")||r[r.length-1]||{},o=s.stats||{},c=Number(s.buyAmountSol||0),l=(Number(o.buys||0)+Number(o.sells||0))*c;a={theme:"volume",receipt:!0,loss:!1,headline:"VOLUME RUN",mint:s.tokenMint||"",symbol:String(s.shortMint||"SLIMEBOT"),name:"SlimeBot",lines:[`${l.toFixed(2)} SOL volume`,`${Number(s.walletCount||0)} wallets · ${Number(s.currentCycle||s.cycles||0)} rounds`,"SlimeBot · slimewire.org"]}}else return;try{const r=await k("/api/web/card",{method:"POST",body:JSON.stringify(a)});r&&r.ok&&r.png&&Jg(`slimewire-${e}-card.png`,r.png)}catch{}}let zd=!1;function Qg(){zd||(zd=!0,document.addEventListener("click",e=>{try{const t=e.target.closest("button");if(!t||!(t.matches("[data-top-refresh-wallet],[data-refresh-all],[data-refresh-live-pairs],[data-refresh-scanner],[data-refresh],[data-refresh-watchlist],[data-refresh-kol]")||/(^|\s)(refresh|reload)(\b|$)/i.test((t.textContent||"").trim())))return;t.classList.remove("ogre-refreshing"),t.offsetWidth,t.classList.add("ogre-refreshing"),setTimeout(()=>t.classList.remove("ogre-refreshing"),900)}catch{}},!0))}function us(e,t){return`<video class="${e}" autoplay muted loop playsinline preload="auto" src="/assets/slimewire/ui/${t}.mp4"></video>`}function Zg(e){try{const t=e.querySelector(".trade-head h3")||e.querySelector(".pump-live-head h3")||e.querySelector(".pump-live-head")||e.querySelector(".trade-head");t&&!t.querySelector(".ogre-spy")&&t.insertAdjacentHTML("afterbegin",`<span class="ogre-spy" title="Intel watch">${us("spy-vid","eye")}<i></i></span>`)}catch{}}let Ni=0;function eb(e,t){try{if(t==="terminal"||t==="live"){if(!e.querySelector(".ogre-radar-bar")){const a=e.querySelector(".cooks-category-label")?.parentElement||e.querySelector(".terminal-main")||e.querySelector(".terminal-layout")||e,r=e.querySelectorAll(".signal-row, [data-token-mint]").length,s=document.createElement("div");if(s.className="ogre-radar-wrap",s.innerHTML='<span class="ogre-radar-bar">'+us("rbar-bg","conduit")+`<span class="orb-scope">${us("orb-vid","scope")}<span class="ring"></span><span class="ring r2"></span><span class="sweep"></span><span class="blip b1"></span><span class="blip b2"></span><span class="blip b3"></span></span><span class="orb-read"><span class="t">SWAMP RADAR</span><span class="s"><b>${r}</b> live pairs · scanning the swamp</span></span><span class="ogre-spy radar-eye" title="Intel watch">${us("spy-vid","eye")}<i></i></span><span class="orb-heat">LIVE</span></span>`,a.insertBefore(s,a.firstChild),r>Ni&&Ni>0){const o=s.querySelector(".ogre-radar-bar");o.classList.add("hit"),setTimeout(()=>o.classList.remove("hit"),800)}Ni=r}return}if(Zg(e),t==="smartChart"){const a=e.querySelector(".trade-head");a&&!a.querySelector(".ogre-chartwatch")&&a.insertAdjacentHTML("beforeend",'<span class="ogre-chartwatch"><span class="ce"></span>WATCHING</span>')}}catch{}}let fa=!0;try{fa=localStorage.getItem("ogreStageSound")!=="off"}catch{}const jd={};function ps(e,t){if(fa)try{let a=jd[e];a||(a=new Audio(e),a.preload="auto",jd[e]=a),a.volume=t??.7,a.currentTime=0,a.play().catch(()=>{})}catch{}}const R={kind:null,clip:"",eventUntil:0,prev:{},feed:[],feedIdx:0,tkTimer:0};function tb(e){return e=String(e||""),e.length>9?`${e.slice(0,4)}…${e.slice(-4)}`:e||"coin"}function Di(e){return e&&e.symbol?`$${e.symbol}`:e&&e.shortMint?`$${e.shortMint}`:"the coin"}function Gd(e){return`<video class="ogre-bg" data-ogre-bg autoplay muted loop playsinline preload="auto" poster="${e==="swap"?"/assets/slimewire/swap/hero.png":"/assets/slimewire/volume/hero.png"}" src="${e==="swap"?_i:qd}idle.mp4"></video>`}function ab(){return`
    ...
    `;const a=bi(),r=td(),s=Zc(a)||{symbol:a==="SOL"?"SOL":w(a),name:a==="SOL"?"Solana":""},o=Zc(r)||{symbol:r?w(r):"Custom",name:r?"Selected token":"Paste CA below"},c=$h(),l=n.swapDirection==="sell",d=c==="two-step"?"Token-to-token uses a sell-to-SOL then buy route until direct routing is enabled.":l?"Sell: swap the pair back to SOL. Set the percent, then hit SWAP.":"Buy: swap SOL into the pair. Set the SOL amount, then hit SWAP.",u=l?a:r,p=u&&u!=="SOL"?u:n.tradeToken,f=`
              ...
              <select class="oss-tok" data-swap-from aria-label="Swap from token">
                ${ed(a,{includeCustom:!1,walletOnly:!0})}
              </select>`,y=`
  ...
  `}function Ui(){return(Array.isArray(n.wallets)?n.wallets:[]).filter(e=>!e?.volumeBot)}function Qd(){return(Array.isArray(n.wallets)?n.wallets:[]).filter(e=>!!e?.volumeBot)}function ln(e=""){const t=Hg(e),a=Ui().map(r=>{const s=n.balances.find(l=>Number(l.index)===Number(r.index)),o=s?.sol!==null&&s?.sol!==void 0?`${Number(s.sol).toFixed(4)} SOL`:"balance loading",c=r.sessionWallet?" Session":"";return`<option value="${r.index}" ${String(r.index)===String(e||"")?"selected":""}>${r.index}. ${i(r.label)}${c} - ${o}</option>`}).join("");return t||a?`${t}${a}`:'<option value="">No wallet connected</option>'}function ub(){if(!n.tradeResult)return`
      <article>
        <h3>Latest Result</h3>
  ...
  `}function pb(){if(!n.tradePlanResult)return`
    ...
    <article class="latest-trade">
      ...
      <dl>
        ...
        <div><dt>Timer Exit</dt><dd>${i(Tb(e))}</dd></div>
      </dl>
  ...
  `}function tu(e){const t=nr.find(([a])=>a===e);return t?t[1]:"Super-fresh"}function gb(){if(!n.wallets.length)return`${is()}${F("No managed wallets loaded","Ogre A.I. needs managed/imported SlimeWire wallets so the server can submit TP/SL and timer exits after it buys.")}`;const e=tc(),t=e.amountSol||"0.1",a=e.runCount||"1",r=(o,c,l)=>{const d=String(o||l||"");return d==="custom"?String(c||"custom"):d},s=ms();return`
    <section class="trade-layout ogre-ai-terminal">
      <article class="trade-card">
        ...
        <div class="ogre-cat-field" data-preserve-focus>
          ...
          ${fb(s)}
          <small class="ogre-cat-hint">${i(eu(s))}</small>
        </div>
        ...
        <small data-ogre-ai-status>${i(n.ogreAiStatus||eu(s))}</small>
      </article>
  ...
  `:au("Bundle","Bundle fires many managed wallets in one shot, so it needs at least one SlimeWire wallet. Tap to create one — your backup downloads instantly.")}function yb(){if(!n.bundleResult)return`
      <article>
        <h3>Latest Bundle</h3>
  ...
  `}function vb(e=""){return n.wallets.length?n.wallets.map((t,a)=>{const r=String(t.index??a+1),s=`${r}. ${t.label||"Wallet"} ${t.shortPublicKey||w(t.publicKey||"")}`;return`<option value="${i(r)}" ${String(e)===r?"selected":""}>${i(s)}</option>`}).join(""):'<option value="">No managed wallets loaded</option>'}function x(e,t,a=""){const r=m(e)?.value||a;if(r!=="custom")return r;const s=m(t)?.value?.trim();if(!s)throw new Error("Enter the custom value first.");return s}function ct(e,t=""){const a=n.presets?.[e]||[],r=!t||t==="none"||t==="manual",s=e==="bundle"?"Create / edit bundle preset":"Create / edit trade preset";return a.length?`
  ...
  `:`
      <option value="" ${r?"selected":""}>No preset / manual</option>
      <option value="custom" ${t==="custom"?"selected":""}>${s}</option>
    `}function nu(){return`<input data-quick-buy-amount type="text" inputmode="decimal" autocomplete="off" placeholder="${i(ze()||"0.10")}" value="${i(n.quickBuyAmountOverride)}">`}function ru(e="scanner"){return`
  ...
  `}function Ze(e,t,a="off"){return qt({selectAttr:`${t}`,customAttr:`${t}-custom`,customFor:e,options:wb,selected:a,customPlaceholder:"Custom: 45s, 20, 2h"})}function fs(e,t,a="0"){return qt({selectAttr:`${t}`,customAttr:`${t}-custom`,customFor:e,options:Sb,selected:a,customPlaceholder:"Custom: 30s, 20, 2h"})}function qi(e="scanner"){return`
  ...
  `}function l0(){const e=n.fastTradePresetStatus||(n.wallets.length?"Save this once, then tap Trade on any row.":"Load or connect a wallet before live trading.");return`
  ...
  `}function c0(){const e=n.fastBundlePresetStatus||(n.wallets.length?"Save this once, then tap Bundle on any row.":"Load wallets before live bundle trading.");return`
  ...
  `}function su(e){const t=e==="trade"?n.editingTradePresetId:n.editingBundlePresetId;return t?le(e,t):null}function hs(e,t){e==="trade"&&(n.editingTradePresetId=t||""),e==="bundle"&&(n.editingBundlePresetId=t||"")}function kb(){const e=su("trade"),t=!!e?.readonly,a=e?t?"Save Edited Copy":"Update Trade Preset":"Save Trade Preset";return`
  ...
  `}function $b(){const e=su("bundle"),t=!!e?.readonly,a=e?t?"Save Edited Copy":"Update Bundle Preset":"Save Bundle Preset";return`
  ...
  `}function ou(e){const t=n.presets?.[e]||[];if(!t.length)return'<p class="muted">No presets loaded yet.</p>';const a=e==="trade"?n.selectedTradePresetId:n.selectedBundlePresetId;return`
  ...
  `}function Tb(e){return Number(e?.sellDelaySeconds||0)>0?`${e?.sellPercent||100}%`:"Off"}function gs(e){return`
    ...
    <article class="account-check-card distribute-card" data-preserve-focus>
      ...
      <div class="volume-grid">
        <label>
          ...
          <select data-distribute-source>${iu()}</select>
        </label>
        <label>
          New wallets (1-20)
  ...
  `:""}function ys(e){n.distributeStatus=String(e||"");const t=m("[data-distribute-status]");t&&(t.textContent=n.distributeStatus)}function Cb(){const e=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!e?.publicKey)return"";const t=n.wallets.filter(r=>r.sessionWallet),a=t.length?t:n.wallets;return a.length?`
      ...
      <article class="volume-bot-status">
        <header class="volume-bot-status-head">
          <div>
            ...
            <span class="volume-bot-stage" data-stage="${i(a.stage||"")}">${i(Mb(a))}</span>
          </div>
    ...
    <section class="trade-card volume-bot-card slime-configurator ovs-skin" data-preserve-focus>
      ...
      <div class="ovs-below">
        <label class="vbot-config-field">
          ...
          <select data-vbot-source>${iu()}</select>
        </label>
  ...
  `}function Eb(){const e=n.slimeBotMode==="spam"?"spam":"smart",t=["low","med","high"].includes(n.slimeBotAggr)?n.slimeBotAggr:"med",a=Math.max(.05,Math.min(50,Number(m("[data-vbot-invest-num]")?.value||m("[data-vbot-invest]")?.value||"1"))),r=Math.max(20,Math.min(360,Number(m("[data-vbot-duration]")?.value||"60"))),o={low:{delaySecs:30,buyBias:55,walletCount:4},med:{delaySecs:12,buyBias:60,walletCount:6},high:{delaySecs:5,buyBias:70,walletCount:10}}[t],c=e==="smart",l=o.delaySecs*(c?4:1);let d=Math.round(r*60/l);d=Math.max(1,Math.min(250,d,Math.floor(a/.01)));const u=Math.max(.005,Math.min(.5,a/d));return{tokenMint:m("[data-vbot-token]")?.value?.trim()||"",sourceWalletIndex:m("[data-vbot-source]")?.value||"1",rollingWallets:c,autoCreateWallets:!c,walletCount:String(o.walletCount),fundPerWalletSol:c?"":(u+.02).toFixed(4),buyAmountSol:u.toFixed(4),sellPercent:"100",buyBias:String(o.buyBias),cycles:String(d),maxRounds:String(d),delaySecs:String(o.delaySecs),slippageBps:"400",sweepBack:!0,walletIndexes:[],walletGroup:"",keepDust:!!m("[data-vbot-keepdust]")?.checked,offsetSell:!!m("[data-vbot-offset]")?.checked,staggerPattern:["steady","waves","organic","ladder"].includes(n.slimeBotStagger)?n.slimeBotStagger:"steady",investment:a,durationMin:r,mode:e,aggr:t}}function ga(e){n.volumeBotStatus=String(e||"");const t=m("[data-vbot-status]");t&&(t.textContent=n.volumeBotStatus)}async function vs({silent:e=!0}={}){try{const t=await k("/api/web/volume-bot");n.volumeBots=Array.isArray(t.bots)?t.bots:[],n.activeTab==="volume"&&h()}catch(t){e||T(t.message)}}async function Fb(){if(n.volumeBotBusy)return;const e=Eb();if(!e.tokenMint){ga("Paste a token CA first.");return}const t=e.durationMin>=60?`${(e.durationMin/60).toFixed(e.durationMin%60?1:0)}h`:`${e.durationMin}m`;if(await Me({title:"Start SlimeBot",lines:["This spends REAL SOL.",`Token: ${e.tokenMint}`,`${e.mode==="smart"?"Smart":"Spam"} mode, ${e.aggr.toUpperCase()} aggressiveness.`,`Deploys up to ~${e.investment} SOL over ${t} from your source wallet,`,`as ${e.cycles} round(s) of randomized ~${e.buyAmountSol} SOL buys / sells.`,"Sweeps funds back to the source wallet when done."],confirmLabel:"Start SlimeBot"})){n.volumeBotBusy=!0,ga("Funding wallets and starting bot..."),h();try{const r=await k("/api/web/volume-bot/start",{method:"POST",body:JSON.stringify(e),dedupe:!1,timeoutMs:ae});n.volumeBotBusy=!1,r.bot&&(n.volumeBots=[r.bot,...n.volumeBots.filter(s=>s.id!==r.bot.id)]),ga(r.bot?.message||"SlimeBot started."),h(),vs()}catch(r){n.volumeBotBusy=!1,ga(r.message),h()}}}async function Wb(e){if(e)try{ga("Stopping bot...");const t=await k("/api/web/volume-bot/stop",{method:"POST",body:JSON.stringify({planId:e}),dedupe:!1,timeoutMs:ae});t.bot&&(n.volumeBots=n.volumeBots.map(a=>a.id===t.bot.id?t.bot:a)),ga(t.bot?.message||"Stop requested."),h(),vs()}catch(t){ga(t.message)}}function _b(){return n.wallets.length?Ob():au("SlimeBot","SlimeBot funds and trades from a managed SlimeWire wallet, so it needs at least one saved. Tap to create one — your backup downloads instantly.")}function Nb(){const e=we([...n.livePairsByBucket.live?.rows||[],...n.livePairsByBucket.under1h?.rows||[],...qe()?.rows||[],...n.scan?.rows||[]]).sort(nt),t=vn(e),a=ot("launch",t),r=yn(),s=At(Re().keywords)[0]||"";return`
    <section class="trade-layout">
      ...
      <aside class="trade-side">
        ...
        <article>
          <h3>How It Works</h3>
          <p>It scans live launch/profile feeds about every ${i(ry())} seconds while the bot is online.</p>
        </article>
        <article>
  ...
  `}function cu(e=n.launchCoinDraft||{}){return String(e.tokenMint||e.mint||e.ca||n.launchWatches?.[0]?.tokenMint||n.launchWatches?.[0]?.mint||n.smartChartToken?.tokenMint||n.smartChartToken?.mint||"").trim()}function Ki(){return!!(Jt&&Jt.enabled&&(Jt.provider||Jt.playbackBaseUrl||Jt.ingestUrl))}function Db(){const e=String(Jt.provider||"").trim();return e?e.toUpperCase():"Provider not configured"}function Ub(e){const t=String(Jt.playbackBaseUrl||"").trim();if(!t||!e)return"";if(t.includes("{mint}"))return t.replace(/\{mint\}/g,encodeURIComponent(e));const a=t.includes("?")?"&":"?";return`${t}${a}mint=${encodeURIComponent(e)}`}function qb(e){return e?e.length>14?`${e.slice(0,6)}...${e.slice(-6)}`:e:"No CA yet"}function du(e){return`slime-pump-live-${e?`${e.slice(0,6)}-${e.slice(-6)}`:"pending-ca"}`}function Hb(e=n.launchCoinDraft||{}){const t=cu(e),a=Ki(),r=Ub(t),s=n.pumpLiveStatus||(t?a?"Ready to stage Pump Live for this launch.":"Provider hooks ready. Add Pump Live envs to enable real video.":"Launch or paste a CA to stage Pump Live."),o=t?"":"disabled",c=a&&r?`<iframe class="pump-live-frame" src="${i(r)}" title="Pump Live preview" loading="lazy" allow="autoplay; fullscreen; picture-in-picture"></iframe>`:'<div class="pump-live-placeholder"><span>LIVE</span><strong>Pump Live standby</strong><p>Video stays off Render until a streaming provider is configured.</p></div>';return`
    <section class="launch-coin-card pump-live-panel" data-pump-live-panel>
      ...
      <div class="pump-live-grid">
        ...
        <div class="pump-live-stack">
          <div class="pump-live-stat"><span>Launch CA</span><strong>${i(qb(t))}</strong></div>
          <div class="pump-live-stat"><span>Provider</span><strong>${i(Db())}</strong></div>
          <div class="pump-live-stat"><span>Chart mode</span><strong>Pump chart + txns</strong></div>
          <div class="pump-live-stat"><span>Stream route</span><strong>${i(du(t))}</strong></div>
        </div>
      </div>
  ...
  `}function Vb(e={}){uu();const t=n.hypePages||[],r=new Date(Date.now()+600*1e3-new Date().getTimezoneOffset()*60*1e3).toISOString().slice(0,16);return`
    <div class="volume-grid">
  ...
  `;Sn(e,d,".kol-dump-drawer")}function dy(){const e=n.kolScan?.configured!==!1,t=n.kolLoading?"disabled":"",a=String(n.kolMode||"hot"),r=!!n.kolScan,s=!!n.kolScan?.kols?.length,o=s&&a!=="hot",c=!r&&!s;return`
    ...
    <p class="scan-meta">${i(py(n.kolMode))}</p>
    ${uy()}
    ${o?fy():c?Fg():""}
      ...
      <aside class="trade-side">
        <article>
          ...
          <div class="card-actions">
            ...
            ${n.kolWallet?Ye(Fd(n.kolWallet),"Share KOL"):""}
          </div>
        </article>
        <article>
          <h3>KOL Tools</h3>
  ...
  `}function uy(){const e=n.kolScan||null,t=ir(n.kolMode),a=n.kolLoading?`Scanning ${t}`:e?`${t} loaded`:`Pick ${t} or tap Refresh`,r=Number(e?.kolCount||e?.kols?.length||0),s=Number(e?.rows?.length||0),o=n.kolLastUpdatedAt?Te(n.kolLastUpdatedAt):"Not run";return`
  ...
  `}function ir(e){const t={hot:"Hot Buys",top:"Top KOLs",consistent:"Consistent",fresh:"Fresh",slimewire:"Top SlimeWire Traders"};return t[e]||t.hot}function py(e){const t={hot:"Top coins KOL wallets are calling now. Hot Buys refreshes around every 10 seconds while the tab is open.",top:"Best ranked KOL wallets by realized performance, then their highest-value current token positions.",consistent:"KOLs ranked by consistency/win rate from the available leaderboard, then filtered into cleaner copyable positions.",fresh:"KOL wallets with the newest activity first, useful when you want faster signal flow.",slimewire:"Opt-in SlimeWire users ranked by closed trades and recent activity."};return t[e]||t.hot}function my(){const e=n.kolResult;return e?.results?.length?`<div class="mini-results">${e.results.map(t=>`<span data-ok="${t.ok?"true":"false"}">${i(t.message||t)}</span>`).join("")}</div>`:""}function fy(){const e=n.kolScan||{},t=(e.kols||[]).filter(a=>a.wallet||a.twitter);return!t.length||e.configured===!1?"":`
        ...
        ${t.slice(0,12).map((a,r)=>`
          <article class="kol-profile">
            ...
            <div class="card-actions kol-profile-actions">
              ...
              ${a.kolscanUrl||a.wallet?`<a href="${i(a.kolscanUrl||Ec(a.wallet))}" target="_blank" rel="noreferrer">Trader Profile</a>`:""}
              ${Vi(a)}
              ${Ye(Bg(a),"Share Watch")}
  ...
  `}function hy(){const e=n.kolScan||{};if(e.configured===!1)return F("KOL Tracker is not connected yet",e.message||"Use Scan Wallet for a public wallet, or try again later.");const t=e.rows||[],a=ot("kol",t);return t.length?`
...
`)}async function By(e){const t=m("[data-wallet-sweep-status]");n.walletSweepStatus="Running wallet action...",S(t,n.walletSweepStatus),T("");try{await J(t,"Opening secure web profile...");const r={"sweep-sol":"/api/web/wallets/sweep-sol","sweep-tokens":"/api/web/wallets/sweep-tokens","sell-all":"/api/web/wallets/sell-all-tokens","sell-all-sweep":"/api/web/wallets/sell-all-tokens","send-sol-many":"/api/web/wallets/send-sol"}[e];if(!r)throw new Error("Unknown wallet action.");const s=e==="send-sol-many"?xy():Ly();if(e==="sell-all"&&(s.destination=""),e==="sell-all-sweep"&&!s.destination)throw new Error("Enter a destination wallet for Sell Tokens + Send SOL.");const o=await k(r,{method:"POST",body:JSON.stringify(s),timeoutMs:ae});n.walletSweepStatus=My(o.sweep),S(t,n.walletSweepStatus),await He({force:!0,deep:!0}),n.activeTab="wallets",h()}catch(a){n.walletSweepStatus=a.message,S(t,a.message),T(a.message)}}async function Ry(e){const t=m("[data-restore-status]"),a=m("[data-restore-text]"),r=e?.files?.[0];if(!(!r||!a)){S(t,"Reading backup file...");try{a.value=await r.text(),S(t,"Backup loaded. Tap Restore Wallets.")}catch(s){S(t,`Could not read file: ${s.message}`)}}}function be(e,t){const a=new Blob([t],{type:"text/plain"}),r=URL.createObjectURL(a),s=document.createElement("a");s.href=r,s.download=e,document.body.appendChild(s),s.click(),s.remove(),setTimeout(()=>URL.revokeObjectURL(r),1e4)}async function Iy(){const e=m("[data-x-handle]"),t=m("[data-x-status]"),a=et(e?.value||"");if(!a){S(t,"Enter a valid X handle first.");return}const r=window.open(Wi(a),"_blank","noopener,noreferrer");try{S(t,r?`Opening X and saving @${a}...`:`Saving @${a}. Allow popups if X did not open.`),await J(t,"Creating secure web profile for X sharing...");const s=await k("/api/web/profile/x",{method:"POST",body:JSON.stringify({xHandle:a})});he(s.user||{...n.user,xHandle:s.profile?.xHandle||a}),Zl(n.xHandle),S(t,`Connected @${n.xHandle}. Share buttons now open X posts with SlimeWire tagged.`),h()}catch(s){S(t,s.message),T(s.message)}}function Oy(){const e=m("[data-x-status]"),t=et(m("[data-x-handle]")?.value||n.xHandle||""),a=Wi(t||n.xHandle);window.open(a,"_blank","noopener,noreferrer"),S(e,t?`Opened X for @${t}. Tap Connect X after checking the handle.`:"Opened X login. Add your handle here after signing in.")}async function Ey(){const e=m("[data-x-status]"),t=m("[data-x-handle]");try{if(!n.user||!n.token){n.xHandle="",t&&(t.value=""),Fo(),S(e,"X unlinked. Enter a new handle any time and tap Save X Handle."),h();return}const a=await k("/api/web/profile/x",{method:"POST",body:JSON.stringify({clear:!0})});he(a.user||{...n.user,xHandle:""}),n.xHandle="",t&&(t.value=""),Fo(),S(e,"X unlinked. Enter a new handle any time and tap Save X Handle."),h()}catch(a){S(e,a.message),T(a.message)}}async function xs(e,t="Saving PFP..."){const a=m("[data-avatar-status]");S(a,t);try{await J(a,"Creating secure web profile for PFP...");const r=await k("/api/web/profile/avatar",{method:"POST",body:JSON.stringify(e)});he(r.user||{...n.user,avatar:r.profile?.avatarDataUrl||r.profile?.avatarUrl||"",avatarSource:r.profile?.avatarSource||"",avatarUpdatedAt:r.profile?.avatarUpdatedAt||""}),S(a,n.user.avatar?"PFP saved.":"PFP removed."),h()}catch(r){S(a,r.message),T(r.message)}}async function Fy(e){const t=m("[data-avatar-status]"),a=e?.files?.[0];if(a){if(!/^image\/(png|jpe?g|webp)$/i.test(a.type)){S(t,"Use a PNG, JPG, or WebP image.");return}if(a.size>5*1024*1024){S(t,"Use an image under 5 MB.");return}try{S(t,"Compressing PFP...");const r=await Pu(a);await xs({avatarDataUrl:r},"Saving compressed PFP...")}catch(r){S(t,r.message),T(r.message)}finally{e.value=""}}}function Pu(e){return new Promise((t,a)=>{const r=new FileReader;r.onerror=()=>a(new Error("Could not read that image.")),r.onload=()=>{const s=new Image;s.onerror=()=>a(new Error("Could not load that image.")),s.onload=()=>{const c=document.createElement("canvas");c.width=256,c.height=256;const l=c.getContext("2d");if(!l){a(new Error("This browser cannot resize images."));return}const d=Math.max(256/s.width,256/s.height),u=Math.round(s.width*d),p=Math.round(s.height*d),f=Math.round((256-u)/2),y=Math.round((256-p)/2);l.clearRect(0,0,256,256),l.drawImage(s,f,y,u,p);const b=c.toDataURL("image/jpeg",.84);if(b.length>22e4){a(new Error("Compressed PFP is still too large. Try a simpler image."));return}t(b)},s.src=String(r.result||"")},r.readAsDataURL(e)})}async function Wy(e){const t=document.querySelector('script[src*="app.js"]')?.src||document.baseURI||window.location.href,a=new URL(String(e||""),t).toString(),r=await fetch(a,{cache:"force-cache"});if(!r.ok)throw new Error("Could not load that preset PFP.");const s=await r.blob();return Pu(s)}async function _y(){const e=Fi(n.xHandle);if(!e){const t=m("[data-avatar-status]");S(t,"Connect an X handle first.");return}await xs({avatarUrl:e,avatarSource:"x"},"Saving X PFP...")}async function Cu(e,t={}){const a=Dn(),r=ge(e);if(!r){if(await Rc(e,t)||Ic(e))return;const s=Sc(e);oe(s),Ft(e,new Error(s),{action:"provider_missing",platform:Ge()?"mobile":"desktop"});return}try{const s=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(s){if(!(t.confirmSwitch===!1?!0:await Me({title:"Reconnect or Switch Wallet",lines:[`Current wallet: ${w(s)}`,"Your wallet extension will open so you can approve the wallet to use on Live Terminal."],confirmLabel:"Open Wallet"}))){oe("Wallet connection unchanged."),Pe("/terminal","terminal");return}try{await Promise.resolve(r.disconnect?.())}catch{}}oe(`Opening ${_e(e,r)}...`);const c=(await r.connect?.({onlyIfTrusted:!1}))?.publicKey||r.publicKey,l=c?.toBase58?.()||c?.toString?.()||"";if(!l)throw new Error("Wallet connected, but no public address was returned.");await J(a,"Creating secure web profile for connected wallet...");const d=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({publicKey:l,provider:_e(e,r)})});he(d.user||{...n.user,connectedWallet:d.profile?.connectedWallet||null}),n.connectedWalletBalance={publicKey:l,shortPublicKey:w(l),provider:_e(e,r),tokens:[]},Ai(`connected:${l}`),n.walletConnectMenuOpen=!1,oe(`Connected ${w(l)}. Opening Live Terminal...`),Pe(t.returnPath||n.walletConnectReturnPath||"/terminal","terminal"),h({force:!0}),wd("browser-wallet-connect"),Yr("browser-wallet-connect")}catch(s){const o=s.message||"Wallet connection was cancelled.";oe(o),Ft(e,s,{action:"connect_failed"})}}async function Lu(){await lu("disconnecting");const e=Dn(),t=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(!n.user||!n.token){n.connectedWalletBalance=null,Ai(t?`connected:${t}`:""),oe("Connected wallet disconnected."),h({force:!0});return}try{const a=n.user?.connectedWallet?.provider||"";await(a.toLowerCase().includes("phantom")?ge("phantom"):a.toLowerCase().includes("solflare")?ge("solflare"):a.toLowerCase().includes("backpack")?ge("backpack"):ge("solana"))?.disconnect?.()}catch{}try{const a=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({clear:!0})});he(a.user||{...n.user,connectedWallet:null}),n.connectedWalletBalance=null,Ai(t?`connected:${t}`:""),oe("Connected wallet disconnected."),h({force:!0})}catch(a){oe(a.message),T(a.message)}}async function Ny(){const e=m("[data-profile-username]"),t=m("[data-profile-password]"),a=m("[data-login-security-status]"),r=String(e?.value||"").trim(),s=String(t?.value||"");if(!r||!s){S(a,"Enter a username and password first.");return}try{await J(a,"Creating secure web profile..."),S(a,"Saving login...");const o=await k("/api/web/profile/credentials",{method:"POST",body:JSON.stringify({username:r,password:s})});he(o.user||{...n.user,username:r,hasPasswordLogin:!0}),t&&(t.value=""),S(a,"Saved. You can now log back in with this username and password."),h()}catch(o){S(a,o.message),T(o.message)}}function et(e){return String(e||"").trim().replace(/^@+/,"").replace(/[^a-z0-9_]/gi,"").slice(0,15)}function Yi(e){const t=Ri(e),a=String(n.user?.referralLink||"").trim(),r=a&&!t.includes("/r/")?a:Bt,s=`https://twitter.com/intent/tweet?text=${encodeURIComponent(t)}&url=${encodeURIComponent(r)}`;window.open(s,"_blank","noopener,noreferrer")}function xu(e){const t=e==="kol",a=m(t?"[data-share-watch-kol]":"[data-share-watch-token]"),r=m("[data-share-watch-status]"),s=a?.value?.trim()||"";if(!s){S(r,t?"Enter a KOL handle or wallet first.":"Enter a coin, ticker, or CA first.");return}Yi(t?Fd(s):Ii(s)),S(r,t?"KOL watch post opened in X.":"Coin watch post opened in X.")}async function Mu(e){const t={};n.token&&(t.Authorization=`Bearer ${n.token}`);const a=await Wn(Ga(`/api/web/pnl/card?tokenMint=${encodeURIComponent(e)}`),{headers:t,cache:"no-store"},3e4);if(!a.ok){const r=await wc(a);throw new Error(r.message||r.error||`Could not build PnL card (${a.status}).`)}return{blob:await a.blob(),filename:a.headers.get("x-ogre-filename")||`pnl-card-${w(e)}.png`}}async function Bu(e){const{blob:t,filename:a}=await Mu(e),r=URL.createObjectURL(t),s=document.createElement("a");s.href=r,s.download=a,document.body.appendChild(s),s.click(),s.remove(),setTimeout(()=>URL.revokeObjectURL(r),1e4)}async function Dy(e,t){try{const{blob:a,filename:r}=await Mu(e),s=new File([a],r,{type:"image/png"});if(navigator.canShare?.({files:[s]})){await navigator.share({title:"SlimeWire PnL Card",text:Ri(t),url:Bt,files:[s]});return}await Bu(e),Yi(`${t} PnL card downloaded and ready to attach.`)}catch(a){T(a.message)}}function Ru(e="buy"){const t=m("[data-trade-wallet]")?.value||"",a=Th(e)||m("[data-trade-token]")?.value?.trim()||"",r=x("[data-trade-slippage]","[data-trade-slippage-custom]","400");if(!t)throw new Error("Choose a wallet first.");if(!a)throw new Error("Paste a token CA first.");return n.tradeToken=a,e==="sell"?(n.tradeSwapFrom=a,n.tradeSwapTo="SOL"):(n.tradeSwapFrom="SOL",n.tradeSwapTo=a),{walletIndex:t,tokenMint:a,slippageBps:r}}function pe(e=""){return String(e||"").trim().toLowerCase()==="connected"}function Uy(e={}){if(!e?.sessionWallet||e.sessionStatus!=="funded")return!1;const t=Date.parse(e.sessionExpiresAt||"");return!Number.isFinite(t)||t>Date.now()}function Iu(){const e=Array.isArray(n.wallets)?n.wallets:[];for(let t=e.length-1;t>=0;t-=1)if(Uy(e[t]))return e[t];return null}function Ou(e=ue()){if(!e?.publicKey)return!1;const t=lr(e),a=ge(t)||ge("solana");return!!(a&&typeof a.signTransaction=="function")}function Ms(e=ue()){const t=e?.provider||_e(lr(e));return`${t} is connected, but this mobile browser cannot sign trades after the wallet-app handoff. Open SlimeWire inside the ${t} in-app browser, or fund a Session Wallet once so buys, sells, TP/SL, and Ogre A.I. can run without reconnect loops.`}function Bs(e={},{side:t="trade",statusWriter:a=ye,allowSessionFallback:r=!0}={}){if(!pe(e.walletIndex))return{form:e,sessionWallet:null};if(Ou())return{form:e,sessionWallet:null};const s=r?Iu():null;if(s?.index){const o=`Using Session Wallet ${s.index} for ${t}; mobile wallet signing is not available in this browser.`;return typeof a=="function"&&a(o),{form:{...e,walletIndex:String(s.index)},sessionWallet:s}}throw new Error(Ms())}function Eu(e){const t=[];for(let r=0;r<e.length;r+=32768)t.push(String.fromCharCode(...e.subarray(r,r+32768)));return btoa(t.join(""))}function Fu(e=""){const t=atob(String(e||"")),a=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)a[r]=t.charCodeAt(r);return a}function lr(e=ue()){const t=String(e?.provider||"").trim().toLowerCase();return t.includes("phantom")?"phantom":t.includes("solflare")?"solflare":t.includes("backpack")?"backpack":"solana"}async function qy(e=ue(),{returnPath:t=Ja()||"/terminal/trade"}={}){const a=lr(e),r=e?.provider||_e(a);if(pa({returnPath:t}),Ge()&&e?.publicKey&&!ge(a)){const o=Ms(e);return oe(o),o}if(Bc(a)){const o=`${r} needs to reconnect before it can sign here. Opening ${r} mobile connect now.`;if(oe(o),await Rc(a,{returnPath:t}).catch(()=>!1))return o}if(Ic(a))return`Opening ${r}. Use the wallet browser to reconnect and approve the trade.`;const s=Sc(a);return oe(s),s}async function Wu(){const e=ue();if(!e?.publicKey)throw new Error("Connect Phantom, Solflare, or another wallet before trading.");const t=lr(e),a=ge(t)||ge("solana");if(!a){if(Ge()&&e?.publicKey)throw new Error(Ms(e));const o=await qy(e,{returnPath:Ja()||"/terminal/trade"});throw new Error(o)}if(typeof a.signTransaction!="function")throw Ge()&&e?.publicKey?new Error(Ms(e)):new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const r=()=>a.publicKey?.toBase58?.()||a.publicKey?.toString?.()||"";let s=r();if(s!==e.publicKey)try{const o=await a.connect?.({onlyIfTrusted:!0});s=o?.publicKey?.toBase58?.()||o?.publicKey?.toString?.()||r()}catch{}if(s!==e.publicKey){const o=await a.connect?.({onlyIfTrusted:!1}),c=o?.publicKey?.toBase58?.()||o?.publicKey?.toString?.()||r();if(c!==e.publicKey)throw new Error(`Wallet mismatch. SlimeWire has ${w(e.publicKey)} connected, but the browser returned ${w(c)}. Reconnect the wallet you want to trade with.`)}return{provider:a,connected:e}}async function Hy(){try{if(Ge())return;const e=ue();if(!e?.publicKey)return;const t=lr(e),a=ge(t)||ge("solana");if(!a||typeof a.connect!="function"||(a.publicKey?.toBase58?.()||a.publicKey?.toString?.()||"")===e.publicKey)return;await a.connect({onlyIfTrusted:!0}).catch(()=>{})}catch{}}const Ky=6e4;async function _u(e,t,a=Ky){let r=0;const s=new Promise((o,c)=>{r=window.setTimeout(()=>{c(new Error("Wallet approval timed out. Reopen your wallet and try the trade again."))},a)});try{return await Promise.race([Promise.resolve(e.signTransaction(t)),s])}finally{window.clearTimeout(r)}}async function Vy(e,t){if(!e||typeof e!="string")throw new Error("SlimeWire could not build a wallet approval transaction. Try again or choose another token.");if(!window.solanaWeb3?.VersionedTransaction)throw new Error("Solana wallet signing library did not load. Refresh the page and try again.");if(typeof t.signTransaction!="function")throw new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const a=window.solanaWeb3.VersionedTransaction.deserialize(Fu(e)),r=await _u(t,a);return Eu(r.serialize())}async function zy(e,t){if(!e||typeof e!="string")throw new Error("SlimeWire could not build a wallet approval transaction. Try again.");if(!window.solanaWeb3?.Transaction)throw new Error("Solana wallet signing library did not load. Refresh the page and try again.");if(typeof t.signTransaction!="function")throw new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const a=window.solanaWeb3.Transaction.from(Fu(e)),r=await _u(t,a);return Eu(r.serialize())}function jy({side:e,connected:t,form:a={},actionDetail:r="",amountSol:s="",amountMode:o="",percent:c=""}={}){const l=e==="sell"?"Sell":"Buy",d=`${t?.provider||"Connected wallet"} ${t?.publicKey?w(t.publicKey):""}`.trim(),u=e==="sell"?`${c||r||"100"}%`:o==="max"?"Max SOL":`${s||r||"custom"} SOL`;return Me({title:`Confirm ${l}`,lines:[`${l} with ${d}?`,`Token: ${a.tokenMint||""}`,`Amount: ${u}`,"Next step: approve the transaction in your wallet."],confirmLabel:l})}async function cr({side:e,form:t,actionDetail:a,amountSol:r="",amountMode:s="",percent:o="",attemptId:c,statusWriter:l=ye}){const d=typeof l=="function"?l:ye,{provider:u,connected:p}=await Wu();if(!n.walletFastApprovalsEnabled&&!await jy({side:e,connected:p,form:t,actionDetail:a,amountSol:r,amountMode:s,percent:o}))throw new Error("Connected-wallet trade cancelled.");km(`${e==="buy"?"Buy":"Sell"} ${w(t.tokenMint||"")}`),Ie("submitted","pending"),d(n.walletFastApprovalsEnabled?`Building ${e} approval for ${p.provider||"your wallet"}...`:`Preparing ${e} approval...`);const f=await k("/api/web/browser-trade/order",{method:"POST",body:JSON.stringify({side:e,tokenMint:t.tokenMint,walletPublicKey:p.publicKey,slippageBps:t.slippageBps,amountSol:r,amountMode:s,percent:o,tradeAttemptId:c}),dedupe:!1,timeoutMs:ae});Ie("submitted","ok"),Ie("approved","pending",`Approve in ${p.provider||"your wallet"}`),d(`Approve ${e} in ${p.provider||"your wallet"}...`);let y;try{y=await Vy(f.order?.transaction,u)}catch(v){throw Ie("approved","fail",N(v?.message||"Wallet approval was declined.")),v}Ie("approved","ok"),Ie("sent","pending"),d("Submitting signed trade...");let b;try{b=await k("/api/web/browser-trade/execute",{method:"POST",body:JSON.stringify({browserTradeAttemptId:f.order?.browserTradeAttemptId,signedTransaction:y}),dedupe:!1,timeoutMs:ae})}catch(v){throw z(e==="buy"?"trade-buy":"trade-sell",t.tokenMint,a,{state:"error",error:N(v?.message||"Trade submit failed.")}),V("",`browser-${e}-error`,{tradeAttemptId:c}),Ie("sent","fail",N(v?.message||"Submit failed - it may still have landed; positions are being re-checked.")),d(`${e==="buy"?"Buy":"Sell"} submit failed or timed out - re-checking your wallet in case the trade landed...`),v}return Ie("sent","ok"),Ie("confirmed",b.trade?.signature?"ok":"pending",b.trade?.signature?`tx ${String(b.trade.signature).slice(0,8)}...`:""),n.tradeResult=b.trade,d(b.trade?.message||`${e==="buy"?"Buy":"Sell"} submitted from connected wallet.`),z(e==="buy"?"trade-buy":"trade-sell",t.tokenMint,a,{state:"submitted",signature:b.trade?.signature||""}),V(b.trade?.signature,`browser-${e}`,{tradeAttemptId:c}),b.trade}function Ke(e){const t=String(e||"").trim().toLowerCase();return!!t&&!["0","off","none","no","disabled"].includes(t)}function pn(e,t){const a=String(t||"").trim().toLowerCase();return["0","off","none","no","disabled"].includes(a)?{sellDelay:"off",sellPercent:"100"}:{sellDelay:e,sellPercent:t}}function Gy(){const e=x("[data-trade-auto-tp]","[data-trade-auto-tp-custom]","25"),t=x("[data-trade-auto-sl]","[data-trade-auto-sl-custom]","8");let a=x("[data-trade-auto-delay]","[data-trade-auto-delay-custom]","off"),r=x("[data-trade-auto-sell-percent]","[data-trade-auto-sell-percent-custom]","100");return{sellDelay:a,sellPercent:r}=pn(a,r),{enabled:Ke(e)||Ke(t)||Ke(a),takeProfitPct:e,stopLossPct:t,sellDelay:a,sellPercent:r}}function Nu(){const e=x("[data-chart-buy-tp]","[data-chart-buy-tp-custom]","25"),t=x("[data-chart-buy-sl]","[data-chart-buy-sl-custom]","8");let a=x("[data-chart-buy-delay]","[data-chart-buy-delay-custom]","off"),r=x("[data-chart-buy-sell-percent]","[data-chart-buy-sell-percent-custom]","100");return{sellDelay:a,sellPercent:r}=pn(a,r),{enabled:Ke(e)||Ke(t)||Ke(a),takeProfitPct:e,stopLossPct:t,sellDelay:a,sellPercent:r}}function ye(e){const t=m("[data-trade-status]");S(t,e)}function Ne(e=""){n.chartTradeStatus=String(e||""),S(m("[data-chart-trade-status]"),n.chartTradeStatus)}function Qi(e="",t=""){n.quickBuyModal={...n.quickBuyModal,status:String(e||""),error:String(t||"")};const a=m("[data-quick-buy-modal-status]"),r=m("[data-quick-buy-modal-error]");S(a,n.quickBuyModal.status),S(r,n.quickBuyModal.error),a&&(a.hidden=!n.quickBuyModal.status),r&&(r.hidden=!n.quickBuyModal.error)}async function Rs(e,t="fixed"){const a=L();let r=t==="max"?"max":String(e||"custom"),s="";try{let o=Ru("buy");r=t==="max"?"max":String(e||"custom");const c=st("trade-buy",o.tokenMint,r);if(c){se("buttonDoubleClickPrevented"),W({component:"post-trade",action:"trade-action-dedupe",durationMs:L()-a,cacheHit:!0,requestId:c.tradeAttemptId||"",details:`trade-buy:${w(o.tokenMint)}:${r}`});return}s=vt("trade-buy");const l={tokenMint:o.tokenMint,walletIndex:o.walletIndex,slippageBps:o.slippageBps,tradeAttemptId:s},d=ju();if((Ke(d.takeProfitPct)||Ke(d.stopLossPct)||Ke(d.sellDelay))&&Object.assign(l,{autoExit:!0,...d}),t==="max")l.amountMode="max";else{const v=Number(e);if(!Number.isFinite(v)||v<=0)throw new Error("Enter a buy amount greater than zero.");l.amountSol=String(v)}if(o=Bs(o,{side:"buy",statusWriter:ye}).form,l.walletIndex=o.walletIndex,pe(o.walletIndex)){z("trade-buy",o.tokenMint,r,{state:"clicked",tradeAttemptId:s,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"browser-trade-click-to-ui",durationMs:L()-a,requestId:s,details:`browser-buy:${w(o.tokenMint)}:${r}`}),ye("Building wallet-approved buy..."),de(),await cr({side:"buy",form:o,actionDetail:r,amountSol:l.amountSol||"",amountMode:l.amountMode||"fixed",attemptId:s}),n.activeTab="trade",h({preserveSmartChartFrame:n.activeTab==="smartChart"}),Le("trade-buy",o.tokenMint,r,3e3);return}const f=Gy();f.enabled&&Object.assign(l,{autoExit:!0,takeProfitPct:f.takeProfitPct,stopLossPct:f.stopLossPct,sellDelay:f.sellDelay,sellPercent:f.sellPercent}),z("trade-buy",o.tokenMint,r,{state:"clicked",tradeAttemptId:s,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"trade-click-to-ui",durationMs:L()-a,requestId:s,details:`trade-buy:${w(o.tokenMint)}:${r}`}),h(),ye(f.enabled?"Sending buy and arming auto-exit...":"Sending buy..."),await xe(20);const y=L();z("trade-buy",o.tokenMint,r,{state:"submitting"});const b=await k("/api/web/trade/buy",{method:"POST",body:JSON.stringify({...l,clientClickToUiMs:Math.round(y-a)}),dedupe:!1});W({component:"post-trade",action:"trade-backend-ack",durationMs:L()-y,requestId:s,resultCount:b.trade?.signature?1:0,details:"trade-buy"}),n.tradeResult=b.trade,km(`Buy ${w(o.tokenMint||"")}`),Ie("submitted","ok"),Ie("sent","ok"),Ie("confirmed",b.trade?.signature?"ok":"pending",b.trade?.signature?`tx ${String(b.trade.signature).slice(0,8)}...`:""),b.trade?.autoExitPlan?(Ie("armed","ok"),n.tradePlanResult=b.trade.autoExitPlan,ye(b.trade.autoExitPlan.shortMessage||"Buy landed and auto-exit is armed."),Ls()):b.trade?.autoExitRequested&&(Ie("armed","fail","Auto-exit was NOT armed - exit manually or create a managed plan."),ye("Buy landed, but auto-exit was not armed. Use Positions to exit manually or create a managed plan.")),z("trade-buy",o.tokenMint,r,{state:"submitted",signature:b.trade?.signature||""}),V(b.trade?.signature,"trade-buy",{tradeAttemptId:s}),n.activeTab="trade",h(),Le("trade-buy",o.tokenMint,r,3e3)}catch(o){s&&(z("trade-buy",n.tradeToken||m("[data-trade-token]")?.value||"",r,{state:"error",error:N(o.message||"Buy failed")}),Le("trade-buy",n.tradeToken||m("[data-trade-token]")?.value||"",r,4e3)),W({component:"post-trade",action:"trade-action-error",durationMs:L()-a,requestId:s,errorCode:o?.code||o?.name||"TRADE_BUY_FAILED",details:N(o.message||"Buy failed")}),ye(o.message)}}async function Zi(e){const t=L(),a=vt("manual-sell");let r=null,s=String(e||"custom");try{r=Ru("sell");const o=Number.parseInt(e,10);if(s=String(o||s),!Number.isInteger(o)||o<1||o>100)throw new Error("Sell percent must be from 1 to 100.");const c=st("trade-sell",r.tokenMint,s);if(c){se("buttonDoubleClickPrevented"),W({component:"manual-sell",action:"manual-sell-dedupe",durationMs:L()-t,cacheHit:!0,requestId:c.tradeAttemptId||"",details:`${w(r.tokenMint)}:${o}`});return}if(z("trade-sell",r.tokenMint,s,{state:"clicked",tradeAttemptId:a,clickedAt:new Date().toISOString()}),ye("Sending sell..."),W({component:"manual-sell",action:"manual-sell-click-to-ui",durationMs:L()-t,requestId:a,details:`${w(r.tokenMint)}:${o}`}),r=Bs(r,{side:"sell",statusWriter:ye}).form,pe(r.walletIndex)){de();const p=L();z("trade-sell",r.tokenMint,s,{state:"submitting"}),await cr({side:"sell",form:r,actionDetail:s,percent:String(o),attemptId:a}),W({component:"manual-sell",action:"browser-sell-request",durationMs:L()-p,requestId:a,resultCount:n.tradeResult?.signature?1:0,details:"browser-wallet"}),n.activeTab="trade",h({preserveSmartChartFrame:n.activeTab==="smartChart"}),Le("trade-sell",r.tokenMint,s,3e3);return}h(),await xe(20);const d=L();z("trade-sell",r.tokenMint,s,{state:"submitting"});const u=await k("/api/web/trade/sell",{method:"POST",body:JSON.stringify({tokenMint:r.tokenMint,walletIndex:r.walletIndex,slippageBps:r.slippageBps,percent:o,manualSellAttemptId:a,clientClickToUiMs:Math.round(d-t)}),timeoutMs:ae,dedupe:!1});W({component:"manual-sell",action:"manual-sell-request",durationMs:L()-d,requestId:a,resultCount:u.trade?.signature?1:0,details:"single-wallet"}),n.tradeResult=u.trade,ye(u.trade?.signature?"Submitted. Refreshing position in the background...":"Sell submitted. Refreshing position in the background..."),z("trade-sell",r.tokenMint,s,{state:"submitted",signature:u.trade?.signature||""}),V(u.trade?.signature||Be(u.trade),"manual-sell-trade"),n.activeTab="trade",h(),Le("trade-sell",r.tokenMint,s,3e3)}catch(o){r?.tokenMint&&(z("trade-sell",r.tokenMint,s,{state:"error",error:N(o.message||"Sell failed")}),Le("trade-sell",r.tokenMint,s,4e3)),W({component:"manual-sell",action:"manual-sell-error",durationMs:L()-t,requestId:a,errorCode:o?.code||o?.name||"MANUAL_SELL_FAILED",details:N(o.message||"Sell failed")}),ye(o.message)}}function Xy(){const e=Ve("trade-plan"),t=m("[data-trade-plan-group]")?.value?.trim()||"",a=m("[data-trade-token]")?.value?.trim()||"",r=x("[data-trade-plan-amount]","[data-trade-plan-amount-custom]","0.1"),s=x("[data-trade-plan-tp]","[data-trade-plan-tp-custom]","25"),o=x("[data-trade-plan-sl]","[data-trade-plan-sl-custom]","8");let c=x("[data-trade-plan-delay]","[data-trade-plan-delay-custom]","5"),l=x("[data-trade-plan-sell-percent]","[data-trade-plan-sell-percent-custom]","100");({sellDelay:c,sellPercent:l}=pn(c,l));const d=x("[data-trade-plan-slippage]","[data-trade-plan-slippage-custom]","400");if(!e.length&&!t)throw new Error("Choose at least one wallet or enter a group label.");if(!a)throw new Error("Paste a token CA first.");return n.tradeToken=a,n.volumeToken=a,n.bundleToken=a,{walletIndexes:e,walletGroup:t,tokenMint:a,amountSol:r,sellDelay:c,takeProfitPct:s,stopLossPct:o,sellPercent:l,loopCount:"1",loopDelay:"0",slippageBps:d,...ha("trade-plan")}}async function Jy(){try{const e=Xy();ye("Buying and arming managed exit...");const t=await k("/api/web/trade/plan",{method:"POST",body:JSON.stringify(e)});n.tradePlanResult=t.plan,n.tradeResult=null,V(t.trade?.signature,"trade-plan"),n.activeTab="trade",h()}catch(e){ye(e.message)}}function Yy(){const e=Ve("volume"),t=m("[data-volume-group]")?.value?.trim()||"",a=m("[data-volume-token]")?.value?.trim()||"",r=m("[data-volume-amount]")?.value||"";let s=x("[data-volume-delay]","[data-volume-delay-custom]","5");const o=x("[data-volume-tp]","[data-volume-tp-custom]","25"),c=x("[data-volume-sl]","[data-volume-sl-custom]","8"),l=x("[data-volume-loop]","[data-volume-loop-custom]","1"),d=x("[data-volume-loop-delay]","[data-volume-loop-delay-custom]","0");let u=x("[data-volume-sell-percent]","[data-volume-sell-percent-custom]","100");({sellDelay:s,sellPercent:u}=pn(s,u));const p=x("[data-volume-slippage]","[data-volume-slippage-custom]","400");if(!e.length&&!t)throw new Error("Choose at least one wallet or enter a group label.");if(!a)throw new Error("Paste a token CA first.");return n.volumeToken=a,{walletIndexes:e,walletGroup:t,tokenMint:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,loopCount:l,loopDelay:d,sellPercent:u,slippageBps:p,...ha("volume")}}function Du(e){const t=m("[data-volume-status]");S(t,e)}async function Qy(){try{const e=Yy();Du("Buying and arming plan...");const t=await k("/api/web/volume/plan",{method:"POST",body:JSON.stringify(e)});n.volumeResult=t.plan,V(Be(t.plan),"volume-plan"),n.activeTab="volume",h()}catch(e){Du(e.message)}}function Zy(e){const t=Ve("sniper"),a=m("[data-sniper-group]")?.value?.trim()||"",r=m("[data-sniper-amount]")?.value||"",s=x("[data-sniper-delay]","[data-sniper-delay-custom]",n.scanMode==="pumpsnipe"?"3":"5"),o=x("[data-sniper-tp]","[data-sniper-tp-custom]",n.scanMode==="pumpsnipe"?"40":"25"),c=x("[data-sniper-sl]","[data-sniper-sl-custom]","8"),l=x("[data-sniper-loop]","[data-sniper-loop-custom]","1"),d=x("[data-sniper-loop-delay]","[data-sniper-loop-delay-custom]","0"),u=x("[data-sniper-slippage]","[data-sniper-slippage-custom]",n.scanMode==="pumpsnipe"?"300":"400");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!e)throw new Error("Pick a token first.");return n.tradeToken=e,n.volumeToken=e,n.bundleToken=e,{mode:n.scanMode,tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,slippageBps:u,loopCount:l,loopDelay:d,...ha("sniper")}}function Uu(e){const t=m("[data-sniper-status]");S(t,e)}async function ev(e){try{const t=Zy(e);Uu("Buying and arming exits...");const a=await k("/api/web/sniper/entry",{method:"POST",body:JSON.stringify(t)});n.sniperResult=a.plan,V(Be(a.plan),"sniper-entry"),n.activeTab="sniper",h()}catch(t){Uu(t.message)}}function tv(){const e=Ve("ogre-ai"),t=m("[data-ogre-ai-group]")?.value?.trim()||"",a=m("[data-ogre-ai-amount]")?.value?.trim()||"",r=ms(),s=m("[data-ogre-ai-runs]")?.value||"1",o=m("[data-ogre-ai-tp]")?.value||"25",c=m("[data-ogre-ai-tp-custom]")?.value?.trim()||"",l=m("[data-ogre-ai-sl]")?.value||"8",d=m("[data-ogre-ai-sl-custom]")?.value?.trim()||"",u=m("[data-ogre-ai-delay]")?.value||"5",p=m("[data-ogre-ai-delay-custom]")?.value?.trim()||"",f=m("[data-ogre-ai-slippage]")?.value||"400",y=m("[data-ogre-ai-slippage-custom]")?.value?.trim()||"";cf({amountSol:a,runCount:s,category:r,takeProfitSelect:o,takeProfitCustom:c,stopLossSelect:l,stopLossCustom:d,delaySelect:u,delayCustom:p,slippageSelect:f,slippageCustom:y,walletGroup:t});const b=x("[data-ogre-ai-delay]","[data-ogre-ai-delay-custom]","60"),v=x("[data-ogre-ai-tp]","[data-ogre-ai-tp-custom]","100"),P=x("[data-ogre-ai-sl]","[data-ogre-ai-sl-custom]","40"),A=x("[data-ogre-ai-slippage]","[data-ogre-ai-slippage-custom]","400"),g="";if(!e.length&&!t)throw new Error("Choose at least one managed wallet or enter a group label.");if(!a)throw new Error("Enter SOL per wallet for Ogre A.I.");return{walletIndexes:e,walletGroup:t,category:r,mode:r,amountSol:a,runCount:s,sellDelay:b,takeProfitPct:v,stopLossPct:P,sellPercent:"100",slippageBps:A,minScore:g,recentMints:ec()}}function Is(e){n.ogreAiStatus=e||"";const t=m("[data-ogre-ai-status]");S(t,n.ogreAiStatus)}async function av(){if(Hr){Ua=!0,Is("Stopping the hunt after this scan...");return}const e=Symbol("ogre-ai-run");Ua=!1;try{const t=tv();n.ogreAiLoading=!0,Hr=e;const a=Array.isArray(t.recentMints)?[...t.recentMints]:[];let r=null,s=!1,o=0;const c=120;for(;!s&&!Ua&&o<c&&(o+=1,Is(o===1?"Scanning fresh low-MC pairs and arming managed exits...":`Hunting fresh pairs... (scan ${o}) - tap Scan again to stop.`),h(),r=await k("/api/web/ogre-ai/start",{method:"POST",body:JSON.stringify({...t,recentMints:a}),timeoutMs:ae}),s=Number(r.ogreAi?.armedCount||0)>0||(r.ogreAi?.plans?.length||0)>0,!s);){for(const l of r.ogreAi?.errors||[])l?.tokenMint&&!a.includes(l.tokenMint)&&a.push(l.tokenMint);for(const l of r.ogreAi?.attemptedPicks||[])l?.tokenMint&&!a.includes(l.tokenMint)&&a.push(l.tokenMint);if(Ua)break;await xe(5e3)}n.ogreAiResult=r?.ogreAi,lf(r?.ogreAi),n.tradePlanResult=r?.ogreAi?.plans?.[0]||n.tradePlanResult,Is(s?r?.ogreAi?.message||"Ogre A.I. run armed.":Ua?"Hunt stopped. Tap Scan to hunt again.":"Still hunting - no clean fresh pair armed yet. Tap Scan to keep going."),s&&V(Be(r?.ogreAi?.plans?.[0]),"ogre-ai-run"),n.activeTab="ogreAi",h()}catch(t){Is(t.message),T(t.message)}finally{n.ogreAiLoading=!1,Ua=!1,Hr===e&&(Hr=null),h()}}function dr(e){const t=m("[data-autopilot-status]");t&&(t.textContent=String(e||""))}async function nv({silent:e=!0}={}){try{const t=await k("/api/web/ogre-ai/autopilot");n.ogreAutopilot=t.autopilot||null,n.activeTab==="ogreAi"&&h()}catch(t){e||dr(t.message)}}function rv(){return{enabled:!!m("[data-autopilot-enabled]")?.checked,category:ms(),amountSol:m("[data-ogre-ai-amount]")?.value?.trim()||(n.ogreAutopilot?.amountSol??"0.05"),takeProfitPct:x("[data-ogre-ai-tp]","[data-ogre-ai-tp-custom]","25"),stopLossPct:x("[data-ogre-ai-sl]","[data-ogre-ai-sl-custom]","8"),sellDelay:x("[data-ogre-ai-delay]","[data-ogre-ai-delay-custom]","5"),slippageBps:x("[data-ogre-ai-slippage]","[data-ogre-ai-slippage-custom]","400"),walletIndexes:Ve("ogre-ai"),walletGroup:m("[data-ogre-ai-group]")?.value?.trim()||"",maxSpendPerHourSol:m("[data-autopilot-maxspend]")?.value?.trim()||"0.3",maxConcurrent:m("[data-autopilot-maxconcurrent]")?.value?.trim()||"2",minScore:m("[data-autopilot-minscore]")?.value?.trim()||"62",intervalMinutes:m("[data-autopilot-interval]")?.value?.trim()||"10"}}async function sv(){if(n.ogreAutopilotBusy)return;const e=rv();if(e.enabled&&!e.walletIndexes.length&&!e.walletGroup){dr("Pick at least one managed wallet (or a wallet group) above before enabling autopilot.");return}if(!(e.enabled&&!await Me({title:"Enable Ogre A.I. Autopilot",lines:["This will spend REAL SOL automatically.",`Category: ${tu(e.category)}`,`Up to ${e.amountSol} SOL per wallet, max ${e.maxSpendPerHourSol} SOL/hour, every ${e.intervalMinutes} min.`,`Only buys picks scoring >= ${e.minScore}, max ${e.maxConcurrent} live plans.`,"You can turn it off any time."],confirmLabel:"Enable Autopilot"}))){n.ogreAutopilotBusy=!0,dr(e.enabled?"Arming autopilot...":"Saving..."),h();try{const t=await k("/api/web/ogre-ai/autopilot",{method:"POST",body:JSON.stringify(e)});n.ogreAutopilot=t.autopilot||null,dr(n.ogreAutopilot?.lastStatus||"Saved.")}catch(t){dr(t.message),T(t.message)}finally{n.ogreAutopilotBusy=!1,h()}}}function Ht(e){const t=m("[data-kol-status]");S(t,e)}function ov(e){const t=Ve("kol"),a=m("[data-kol-group]")?.value?.trim()||"",r=m("[data-kol-amount]")?.value||"",s=x("[data-kol-delay]","[data-kol-delay-custom]","5"),o=x("[data-kol-tp]","[data-kol-tp-custom]","25"),c=x("[data-kol-sl]","[data-kol-sl-custom]","8"),l=x("[data-kol-loop]","[data-kol-loop-custom]","1"),d=x("[data-kol-loop-delay]","[data-kol-loop-delay-custom]","0"),u=x("[data-kol-slippage]","[data-kol-slippage-custom]","400");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!e)throw new Error("Pick a KOL signal first.");return n.tradeToken=e,n.volumeToken=e,n.bundleToken=e,{tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,loopCount:l,loopDelay:d,sellPercent:"100",slippageBps:u,...ha("kol")}}function iv(e){const t=Ve("kol"),a=m("[data-kol-group]")?.value?.trim()||"",r=m("[data-kol-amount]")?.value||"",s=x("[data-kol-delay]","[data-kol-delay-custom]","5"),o=x("[data-kol-tp]","[data-kol-tp-custom]","25"),c=x("[data-kol-sl]","[data-kol-sl-custom]","8"),l=x("[data-kol-loop]","[data-kol-loop-custom]","1"),d=x("[data-kol-loop-delay]","[data-kol-loop-delay-custom]","0"),u=x("[data-kol-slippage]","[data-kol-slippage-custom]","400"),p=String(e||n.kolWallet||m("[data-kol-wallet]")?.value||"").trim();if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!p)throw new Error("Paste or choose a KOL wallet first.");if(!Dt(p))throw new Error("That KOL entry does not have a verified Solana wallet yet.");return{copyWallet:p,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,loopCount:l,loopDelay:d,sellPercent:"100",slippageBps:u,...ha("kol")}}async function lv(e){try{const t=ov(e);Ht("Buying and arming KOL copy plan...");const a=await k("/api/web/kol/entry",{method:"POST",body:JSON.stringify(t)});n.kolResult=a.plan,V(Be(a.plan),"kol-copy-plan"),n.activeTab="kol",h()}catch(t){Ht(t.message)}}async function cv(e){try{const t=iv(e);Ht("Arming Copy Wallet watch...");const a=await k("/api/web/kol/copy-wallet",{method:"POST",body:JSON.stringify(t)});n.kolResult=a.plan,n.kolWallet=t.copyWallet,n.activeTab="kol",h()}catch(t){Ht(t.message)}}function Ve(e){return[...document.querySelectorAll(`[data-${e}-wallet]:checked`)].map(t=>t.value)}function Os(e){const t=m("[data-bundle-status]");S(t,e)}function qu(){const e=m("[data-bundle-token]")?.value?.trim()||"",t=Ve("bundle"),a=m("[data-bundle-group]")?.value?.trim()||"",r=m("[data-bundle-amount]")?.value||"",s=x("[data-bundle-percent]","[data-bundle-percent-custom]","100"),o=x("[data-bundle-slippage]","[data-bundle-slippage-custom]","400");if(!e)throw new Error("Paste a token CA first.");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");return n.bundleToken=e,{tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,percent:s,slippageBps:o}}function dv(){const e=qu();let t=x("[data-bundle-plan-delay]","[data-bundle-plan-delay-custom]","5"),a=x("[data-bundle-plan-sell-percent]","[data-bundle-plan-sell-percent-custom]","100");return{sellDelay:t,sellPercent:a}=pn(t,a),{...e,sellDelay:t,takeProfitPct:x("[data-bundle-plan-tp]","[data-bundle-plan-tp-custom]","60"),stopLossPct:x("[data-bundle-plan-sl]","[data-bundle-plan-sl-custom]","10"),loopCount:x("[data-bundle-plan-loop]","[data-bundle-plan-loop-custom]","1"),loopDelay:x("[data-bundle-plan-loop-delay]","[data-bundle-plan-loop-delay-custom]","0"),sellPercent:a,...ha("bundle-plan")}}async function Hu(e){const t=L();let a=null,r="";const s=e==="buy"?"bundle-buy":"bundle-sell";try{a=qu();const o=st(s,a.tokenMint,"bundle");if(o){se("buttonDoubleClickPrevented"),W({component:"post-trade",action:"trade-action-dedupe",durationMs:L()-t,cacheHit:!0,requestId:o.tradeAttemptId||"",details:`${s}:${w(a.tokenMint)}`});return}r=vt(s),z(s,a.tokenMint,"bundle",{state:"clicked",tradeAttemptId:r,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"trade-click-to-ui",durationMs:L()-t,requestId:r,details:`${s}:${w(a.tokenMint)}`}),h(),Os(e==="buy"?"Sending bundle buy...":"Sending bundle sell..."),await xe(20);const c=L();z(s,a.tokenMint,"bundle",{state:"submitting"});const l=await k(`/api/web/bundle/${e}`,{method:"POST",body:JSON.stringify({...a,tradeAttemptId:r,clientClickToUiMs:Math.round(c-t)}),dedupe:!1});W({component:"post-trade",action:"trade-backend-ack",durationMs:L()-c,requestId:r,resultCount:l.bundle?.successCount||0,details:s}),n.bundleResult=l.bundle,z(s,a.tokenMint,"bundle",{state:"submitted",signature:Be(l.bundle)}),V(Be(l.bundle),`bundle-${e}`,{tradeAttemptId:r}),n.activeTab="bundle",h(),Le(s,a.tokenMint,"bundle",3e3)}catch(o){a?.tokenMint&&(z(s,a.tokenMint,"bundle",{state:"error",error:N(o.message||"Bundle trade failed")}),Le(s,a.tokenMint,"bundle",4e3)),W({component:"post-trade",action:"trade-action-error",durationMs:L()-t,requestId:r,errorCode:o?.code||o?.name||"BUNDLE_TRADE_FAILED",details:N(o.message||"Bundle trade failed")}),Os(o.message)}}async function uv(){try{const e=dv();Os("Buying and arming bundle exits...");const t=await k("/api/web/bundle/plan",{method:"POST",body:JSON.stringify(e)});n.bundleResult=t.plan,V(Be(t.plan),"bundle-plan"),n.activeTab="bundle",h()}catch(e){Os(e.message)}}function le(e,t){return(n.presets?.[e]||[]).find(a=>a.id===t)||null}function Ku(){(n.selectedTradePresetId==="custom"||n.selectedTradePresetId&&!le("trade",n.selectedTradePresetId))&&(n.selectedTradePresetId=""),(n.selectedBundlePresetId==="custom"||n.selectedBundlePresetId&&!le("bundle",n.selectedBundlePresetId))&&(n.selectedBundlePresetId=""),n.editingTradePresetId&&!le("trade",n.editingTradePresetId)&&(n.editingTradePresetId=""),n.editingBundlePresetId&&!le("bundle",n.editingBundlePresetId)&&(n.editingBundlePresetId="")}function Vu(e,t="trade",a=""){t==="bundle"?n.bundleToken=e:n.tradeToken=e,n.activeTab=t,a&&T(a),window.history.pushState({},"","/terminal"),h({force:!0})}async function zu(e=""){const t=String(e||"").trim();if(!t)return;const a=t.replace(/^\$+/,"").trim(),r=/^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(a),s=(o,c={})=>$t(ve(o,{source:"global-search",...c}),{defaultTab:"buy",view:"chartTxns",focusAmountInput:!0,source:"global-search"});if(r){s(a);return}try{const c=((await k(`/api/web/token-search?q=${encodeURIComponent(t)}`)).matches||[])[0];if(!c?.tokenMint){T(`No coin found for "${t}". Try the exact ticker or paste the contract address.`);return}s(c.tokenMint,{symbol:c.symbol,name:c.name})}catch(o){T(o.message||"Token search failed.")}}function ve(e="",t={}){const a=String(e||"").trim(),r=a?ur().find(s=>String(s?.tokenMint||"")===a):null;return{chain:"solana",tokenMint:a,tokenAddress:a,mint:a,pairAddress:r?.pairAddress||r?.pairId||t.pairAddress||"",symbol:r?.symbol||t.symbol||w(a),name:r?.name||t.name||"Token",imageUri:r?.imageUrl||t.imageUri||"",source:t.source||r?.source||r?.category||"",dex:r?.dexId||t.dex||"",pool:r?.pool||t.pool||"",pumpUrl:r?.pumpUrl||t.pumpUrl||"",isPump:!!(r?.isPump||t.isPump||a.toLowerCase().endsWith("pump")),graduated:!!(r?.graduated||r?.isGraduated||r?.bonded||r?.isBonded||t.graduated||t.isGraduated||t.bonded||t.isBonded),isGraduated:!!(r?.isGraduated||r?.graduated||r?.bonded||r?.isBonded||t.isGraduated||t.graduated||t.bonded||t.isBonded),bonded:!!(r?.bonded||r?.isBonded||r?.graduated||r?.isGraduated||t.bonded||t.isBonded||t.graduated||t.isGraduated),isBonded:!!(r?.isBonded||r?.bonded||r?.graduated||r?.isGraduated||t.isBonded||t.bonded||t.graduated||t.isGraduated)}}function u0(e={},t={}){return ve(e?.tokenMint||e?.mint||e?.tokenAddress||"",{...t,pairAddress:e?.pairAddress||e?.pairId||t.pairAddress||"",symbol:e?.symbol||t.symbol||"",name:e?.name||t.name||"",imageUri:e?.imageUrl||e?.imageUri||t.imageUri||"",source:t.source||e?.source||e?.category||"",dex:e?.dexId||t.dex||"",pool:e?.pool||t.pool||"",pumpUrl:e?.pumpUrl||t.pumpUrl||"",isPump:e?.isPump||t.isPump,graduated:e?.graduated||e?.isGraduated||e?.bonded||e?.isBonded||t.graduated||t.isGraduated||t.bonded||t.isBonded,isGraduated:e?.isGraduated||e?.graduated||e?.bonded||e?.isBonded||t.isGraduated||t.graduated||t.bonded||t.isBonded,bonded:e?.bonded||e?.isBonded||e?.graduated||e?.isGraduated||t.bonded||t.isBonded||t.graduated||t.isGraduated,isBonded:e?.isBonded||e?.bonded||e?.graduated||e?.isGraduated||t.isBonded||t.bonded||t.graduated||t.isGraduated})}function Es(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim();return t?(n.smartChartTokenRef={...e,tokenMint:t,tokenAddress:t,mint:t},Vs(n.smartChartTokenRef),n.terminalToken=t,n.terminalAutoToken=t,n.tradeToken=t,n.bundleToken=t,n.volumeToken=t,n.smartChartToken=t,t):""}function pv(e,t={}){const a=new URLSearchParams;a.set("token",e);const r=t.defaultTab==="sell"?"sell":t.defaultTab==="chart"?"chart":"buy";return a.set("tab",r),["chart","chartTxns","txns","info"].includes(t.view)&&a.set("view",t.view),t.focusAmountInput&&a.set("focusAmount","1"),t.source&&a.set("source",String(t.source).slice(0,40)),t.returnTo&&a.set("returnTo",t.returnTo),`/terminal/chart?${a.toString()}`}function el(e={}){const t=String(e?.tokenMint||e?.mint||e?.tokenAddress||"").trim(),a=`${e?.source||""} ${e?.category||""} ${e?.dex||""} ${e?.pool||""}`.toLowerCase(),r=!!(e?.isPump||e?.pumpUrl||t.toLowerCase().endsWith("pump")||a.includes("pump")),s=!!(e?.graduated||e?.isGraduated||e?.bonded||e?.isBonded||e?.complete||e?.completed||e?.bondingComplete||e?.raydiumPool||e?.poolAddress);return!!(r&&!s)}function mv(e={},t={}){return["chart","chartTxns","txns","info"].includes(t.view)?t.view:"chartTxns"}const Fs=new Map;function tl(e){const t=String(e||"").trim();if(!t)return;const a=Fs.get(t)||0;Date.now()-a<3e4||(Fs.set(t,Date.now()),Fs.size>200&&Fs.clear(),k(`/api/web/prebuy-warm?mint=${encodeURIComponent(t)}`,{method:"GET"}).catch(()=>{}))}function $t(e={},t={}){sa("chartRouteStart");const a=L(),r=Es(e);if(!r){T("Select a token before opening the chart.");return}cl(e,{source:t.source||"token-entry"}),tl(r),n.chartTradeTab=t.defaultTab==="sell"?"sell":(t.defaultTab==="chart","buy"),n.smartChartView=mv(n.smartChartTokenRef||e,t),n.chartFocusAmountInput=!!t.focusAmountInput,n.chartScrollIntoView=!0,n.activeTab="smartChart",n.route="terminal",n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},n.chartTradeStatus="",n.chartBuyWalletIndex="";const s=pv(r,{defaultTab:t.defaultTab||"buy",view:n.smartChartView,focusAmountInput:t.focusAmountInput,source:t.source||"token-entry",returnTo:t.returnTo||Ja()});window.history.pushState({},"",s),h({force:!0}),K("chart-route-open",a,{component:"smartChart",cacheHit:!!(tt(r)?.cacheHit||fr(r)?.pairAddress),details:`${r}:${t.source||"token-entry"}`})}function al(){if(!window.location.pathname.includes("/terminal/chart"))return;sa("chartRouteStart");const e=L(),t=new URLSearchParams(window.location.search||""),a=String(t.get("token")||t.get("mint")||"").trim(),r=String(n.smartChartToken||"").trim();if(a){const s=ve(a,{source:t.get("source")||"route"});Es(s),cl(s,{source:t.get("source")||"route"}),t.get("buy")==="1"&&window.setTimeout(()=>{try{mn(s,{forceModal:!0,source:"deep-link"})}catch{}},900),a!==r&&(n.chartTradeStatus="",n.chartBuyWalletIndex="")}n.chartTradeTab=t.get("tab")==="sell"?"sell":"buy",n.smartChartView=["chart","chartTxns","txns","info"].includes(t.get("view"))?t.get("view"):"chartTxns",n.chartFocusAmountInput=t.get("focusAmount")==="1",n.chartScrollIntoView=!0,n.route="terminal",n.activeTab="smartChart",K("chart-route-apply",e,{component:"smartChart",cacheHit:!!(tt(a)?.cacheHit||fr(a)?.pairAddress),details:a})}function mn(e={},t={}){const a=Es(e);if(!a){T("Select a token before quick buying.");return}const r=fn(a);if(r&&Hs(r)){T("Safety block: this token has mintable/freezable/honeypot-style risk signals and cannot be quick bought.");return}const s=t.preset||ut(),o=s&&!t.forceModal?ze(s):"",c=s?.walletIndex||(s?.walletIndexes||[])[0]||(n.wallets[0]?.index?String(n.wallets[0].index):"");if(s&&o&&c&&!t.forceModal){Ns(a,{...s,walletIndex:c,walletIndexes:[c]});return}const l=ue();n.quickBuyModal={open:!0,tokenMint:a,amountSol:o||n.quickBuyAmountOverride||"",walletIndex:l?.publicKey?"connected":n.wallets[0]?.index?String(n.wallets[0].index):"",slippageBps:"400",status:o?`Preset ${o} SOL loaded. Confirm when ready.`:s?"Your selected preset has no SOL amount - set one here (or edit the preset in the Trade tab) and Buy becomes one-click.":"Enter a SOL amount to quick buy - or save a Trade preset and Buy becomes one-click.",source:t.source||"quick-buy",error:"",tradeAttemptId:""},tl(a),h({force:!0}),requestAnimationFrame(()=>m("[data-quick-buy-modal-amount]")?.focus())}function nl(){n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},h({force:!0})}function fv(e={},t={}){if(!D("protectedBuyEnabled",!0))return;const a=Es(e);if(!a){T("Select a token before opening Protected Buy.");return}const r=fn(a);if(r&&Hs(r)){T("Safety block: this token has mintable/freezable/honeypot-style risk signals and cannot be bought from quick actions.");return}const s=ka(a)||{tokenMint:a},o=at(s),c=t.presetId||o.protectedBuyPreset||ml(o.verdict),l=Number(Y(t.amountSol||n.quickBuyAmountOverride||ze()||"0.1")),d=c==="conservative"&&Number.isFinite(l)&&l>.25?"0.25":yr(l||.1),u=ue();tl(a),n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},n.protectedBuyModal={open:!0,tokenMint:a,presetId:c,amountSol:d,walletIndex:t.walletIndex||(u?.publicKey?"connected":n.wallets[0]?.index?String(n.wallets[0].index):""),slippageBps:String(t.slippageBps||"400"),riskAccepted:!1,status:o.verdict==="AVOID"?"Avoid recommended. Check the risk box if you still want to continue.":"Review this plan before wallet confirmation.",error:"",source:t.source||"protected-buy"},h({force:!0}),requestAnimationFrame(()=>m("[data-protected-buy-amount]")?.focus())}function Ws(){n.protectedBuyModal={...n.protectedBuyModal,open:!1,status:"",error:"",riskAccepted:!1},h({force:!0})}function hv(){const e=n.protectedBuyModal||{},t=String(e.tokenMint||"").trim(),a=String(m("[data-protected-buy-preset]")?.value||e.presetId||"conservative").trim(),r=String(m("[data-protected-buy-wallet]")?.value||e.walletIndex||"").trim(),s=Y(m("[data-protected-buy-amount]")?.value||e.amountSol||""),o=String(m("[data-protected-buy-slippage]")?.value||e.slippageBps||"400").trim(),c=!!(m("[data-protected-buy-risk-accept]")?.checked||e.riskAccepted);if(!t)throw new Error("Select a token before Protected Buy.");if(!r)throw new Error("Choose a wallet before Protected Buy.");if(!s)throw new Error("Enter a SOL amount greater than zero.");return{tokenMint:t,presetId:a,walletIndex:r,amountSol:s,slippageBps:o,riskAccepted:c}}function gv(){const e=n.protectedBuyModal||{};if(!e.open)return"";const t=ka(e.tokenMint)||{tokenMint:e.tokenMint},a=at(t),r=Xs(e.presetId),s=pe(e.walletIndex),o=a.verdict==="AVOID"&&!e.riskAccepted,c=/submitting|opening wallet/i.test(String(e.status||""));return`
    ...
    <section class="protected-buy-modal" role="dialog" aria-modal="true" aria-label="Protected Buy preview">
      ...
      <article class="protected-buy-preview">
        ...
        <small>${i(gw(r))}</small>
        <small>Wallet: ${i(yw(e.walletIndex))}</small>
  ...
  `}function Bv(){const e=Qd();if(!e.length)return"";const t=e.length;return`
  ...
  `},{key:"fund",label:"Fund / Sweep",hint:"Move SOL",html:`${Cb()}${Bv()}${Pb()}${Mv()}`},{key:"create",label:"Create",hint:"New wallets",html:is()},{key:"import",label:"Import",hint:"Add keys",html:Rd()},{key:"backup",label:"Backup",hint:"Save / restore",html:Bd()},{key:"downloads",label:"Downloads",hint:"Exports",html:Id()}];if(!n.wallets.length){const r=a.filter(s=>s.key!=="balances"&&s.key!=="fund");return`
      ${e}
  ...
  `}function Ov(){return(Array.isArray(n.wallets)?n.wallets:[]).find(t=>t?.sessionWallet&&t?.sessionStatus==="funded")||null}function Ev(){if(!(n.connectedWalletBalance||n.user?.connectedWallet||null)?.publicKey)return"";const t=Ov();return t?`
  ...
  `}function Zu(){const e=n.balances.reduce((a,r)=>a+Number(r.tokens?.length||0),0)+ad().length,t=n.balances.filter(a=>a.error).length;return`
  ...
  `}function Wv(e){const t=n.balances.find(o=>Number(o.index)===Number(e.index));if(!t)return"<span>Balance: loading</span>";if(t.error)return`<span>Balance check failed: ${i(t.error)}</span>`;const a=Number.isFinite(Number(t.sol))?`${Number(t.sol).toFixed(4)} SOL`:"SOL unavailable",r=Number(t.tokens?.length||0)===1?"1 token":`${Number(t.tokens?.length||0)} tokens`,s=t.warnings?.length?` | ${t.warnings.length} warning(s)`:"";return`<span>Balance: ${i(a)} | ${i(r)}${i(s)}</span>`}function _v(){const e=it(),t=`
    <section class="account-check-card">
      <div>
  ...
  `}async function Dv(e){const t=String(e||"").trim();if(!t)return;n.devWatch||(n.devWatch={});const a=!n.devWatch[t];try{const r=await k("/api/web/dev-watch",{method:"POST",body:JSON.stringify({wallet:t,watch:a}),timeoutMs:15e3});n.devWatch[t]=!!r.watching}catch(r){T(r?.message||"Could not update dev watch.")}Ta()}async function Uv(e,t=null){const a=String(e||"").trim();if(!a)return;const r=ut();t&&(t.disabled=!0,t.textContent="Arming...");try{const s=await k("/api/web/positions/arm-exits",{method:"POST",body:JSON.stringify({tokenMint:a,takeProfitPct:r?.takeProfitPct||"40",stopLossPct:r?.stopLossPct||"8",sellDelay:r?.sellDelay||"off",sellPercent:r?.sellPercent||"100",slippageBps:r?.slippageBps||"1000"}),timeoutMs:2e4});vu(a),n.walletRemoveStatus=s.message||"Exits armed.",t&&(t.textContent="✅ Armed"),wu().then(()=>h())}catch(s){T(s?.message||"Could not arm exits."),t&&(t.disabled=!1,t.textContent="Arm Exits")}}async function qv(){n.bagScan={status:"loading"},h();try{const e=await k("/api/web/shield/scan-bags",{timeoutMs:3e4});n.bagScan={status:"done",bags:e.bags||[]}}catch(e){n.bagScan={status:"error",message:e?.message||""}}h()}function Hv(){const e=`
    <section class="account-check-card">
      <div>
        <h3>PnL / Results</h3>
  ...
  `}function lw(e={}){return D("slimeShieldEnabled",!0)?`SlimeShield ${at(e).verdict||"CAUTION"}`:e.bestPickScore?`Score ${e.bestPickScore}/100`:e.valueLabel||e.smartMoney||""}function cw(e={}){const t=Number(e.bestPickScore||e.score||0),a=e.scoreWarnings||e.bestPickWarnings||[],r=t?`${t}/100`:"n/a";return`
    <span class="score-badge" title="${i(ul(e))}">
      <strong>${i(r)}</strong>
      <small>${a.length?"warnings":"best pick"}</small>
    </span>
  `}function dw(e={}){return ow(e,{compact:!0})}function ul(e={}){const t=e.scoreBreakdown||e.bestPickInputs||{},a=Object.entries(t).map(([s,o])=>`${s}: ${o}`),r=e.scoreWarnings||e.bestPickWarnings||[];return[...a,...r.map(s=>`warning: ${s}`)].join(" | ")||"Score uses available liquidity, volume, age, momentum, buys/sells, KOL, and risk signals."}function uw(e={}){return""}function M(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"n/a":t>=1e6?`$${(t/1e6).toFixed(t>=1e7?0:1)}M`:t>=1e3?`$${(t/1e3).toFixed(t>=1e5?0:1)}K`:`$${Math.round(t)}`}function _(...e){for(const t of e){const a=String(t??"").trim();if(a&&a!=="$0"&&!/^(n\/a|checking|warming|loading|pending|tracking)\.{0,3}$/i.test(a))return a}return"n/a"}function fp(e={}){return[["15m",_(e.volumeM15Label,M(e.volumeM15))],["30m",_(e.volumeM30Label,M(e.volumeM30))],["1h",_(e.volumeH1Label,e.volumeLabel,M(e.volumeH1))],["24h",_(e.volumeH24Label,M(e.volumeH24))]]}function b0(e={}){const t=mt(e),a=ft(e),r=_(e.marketCapLabel,e.fdvLabel,t>0?M(t):"","checking"),s=_(e.liquidityLabel,a>0?M(a):"","checking"),o=fp(e);return`
    <div class="compact-stat-grid">
      <span>MC <b>${i(r)}</b></span>
      <span>Liq <b>${i(s)}</b></span>
      ${o.map(([c,l])=>`<span>${i(c)} <b>${i(l)}</b></span>`).join("")}
    </div>
  `}function pw(e={}){const t=mt(e),a=ft(e),r=_(e.marketCapLabel,e.fdvLabel,t>0?M(t):"","checking"),s=_(e.liquidityLabel,a>0?M(a):"","checking"),o=_(e.volumeM15Label,M(e.volumeM15)),c=_(e.volumeH1Label,e.volumeLabel,M(e.volumeH1));return`
  ...
  `}function yp(e,{source:t,actionLabel:a="Trade",isKolContext:r=!1}={}){const s=co(e.tokenMint);return`
    ...
    ${mp(e,{compact:!0})}
  `}function mw(e,t={}){const a=t.limit||6,r=t.actionLabel||"Trade",s=t.emptyTitle||"No signals loaded",o=t.emptyMessage||"Refresh the feed to load current signals.",c=wa(e||[],a,t.rotateKey||"",t.stickyCount||0),l=t.context==="kol",d=t.cooksStyle?" is-cooks":"";return c.length?`
      ...
      ${c.map((u,p)=>{const f=u.scalpSetup||u.momentum||u.category||"live";return`
          <article class="terminal-token-row${d} ${l?"is-kol-signal":""}" data-token-chart="${i(u.tokenMint)}" data-token-chart-source="terminal-row">
            ...
            <div class="terminal-token-actions has-dev-info">
              ${yp(u,{source:"terminal-row",actionLabel:r,isKolContext:l})}
            </div>
          </article>
        `}).join("")}
    </div>
  `:F(s,o)}function Tt(e,t={}){if(t.layout==="terminal")return mw(e,t);const a=t.limit||6,r=t.actionLabel||"Trade",s=t.emptyTitle||"No signals loaded",o=t.emptyMessage||"Refresh the feed to load current signals.",c=wa(e||[],a,t.rotateKey||"",t.stickyCount||0),l=t.context==="kol";return c.length?`
      ...
      ${c.map((d,u)=>`
        <article class="compact-signal-row ${l?"is-kol-signal":""}" data-token-chart="${i(d.tokenMint)}" data-token-chart-source="compact-row">
          ...
          <div class="compact-row-actions has-dev-info">
            ${yp(d,{source:"compact-row",actionLabel:r,isKolContext:l})}
          </div>
        </article>
      `).join("")}
    </div>
  `:F(s,o)}function bn(e){const t=le(e,e==="trade"?n.selectedTradePresetId:n.selectedBundlePresetId);if(!t)return"Custom / manual";const a=[t.name,`${t.amountSol} SOL`,`TP ${t.takeProfitPct}`,`SL ${t.stopLossPct}`];return t.sellDelay&&t.sellDelay!=="off"&&a.push(`Timer ${t.sellDelay}`),a.join(" | ")}function y0(){return`
  ...
  `}function wp(){Kr&&window.clearTimeout(Kr),Kr=window.setTimeout(()=>{Kr=null,Z("live"),Z("launch"),Z("sniper"),h()},180)}function Qs(e={}){const t=Number(e.pairCreatedAt||e.createdAt||0);if(t>0){const s=t<1e10?t*1e3:t;return Math.max(0,Math.round((Date.now()-s)/1e3))}const a=["source-age","trusted-source-age"].includes(String(e.pairAgeSource||"").toLowerCase()),r=Number(e.pairAgeSeconds);return a&&Number.isFinite(r)&&r>=0?r:Number.POSITIVE_INFINITY}const kw=100,$w=7200,Tw=75e4,Aw=86400,Pw=2e6,Cw=28e3,Sp=18e4,Lw=16e4;function kp(){const e=cp();return we([...n.livePairs?.rows||[],...n.livePairsByBucket.live?.rows||[],...n.livePairsByBucket.under1h?.rows||[],...n.livePairsByBucket.under3h?.rows||[],...n.livePairsByBucket.under1d?.rows||[],...n.scan?.rows||[],...n.kolScan?.rows||[]]).map(t=>up(t,e.get(String(t?.tokenMint||"")))).filter(t=>t?.tokenMint&&!mr(t))}function wn(e={}){return O(e.marketCap,e.fdv)}function $p(e={}){return O(e.liquidityUsd)}function Tp(e={}){return O(e.volumeM5,e.volume5m,e.volumeM15,e.volumeM30,e.volumeH1,e.volumeH24,e.volumeUsd)}function gl(e={}){if(wr(e))return!1;const t=Qs(e);return!Number.isFinite(t)||t<0||t>$w||wn(e)>Tw?!1:Kt(e)<70}function bl(e={}){if(wr(e))return!1;const t=Kt(e),a=wn(e),r=a>=Cw&&a<=Sp;return t>=55&&(!a||a<=Sp)||r}function Ap(e={}){if(gl(e)||bl(e)||wr(e))return!1;const t=Qs(e);return Number.isFinite(t)&&(t<0||t>Aw)||wn(e)>Pw?!1:$p(e)>0||Tp(e)>0||Number(e.bestPickScore||e.score||0)>0||Array.isArray(e.reasons)&&e.reasons.length>0}function Pp(e={}){return[e.tokenMint,e.symbol,e.name,e.source,e.category,e.dexId,e.dexName,e.poolType,e.platform,e.raydiumPool,e.pairUrl,...e.riskFlags||[],...e.reasons||[]].filter(Boolean).join(" ").toLowerCase()}function Kt(e={}){const t=O(e.bondingProgressPct,e.bondingProgress,e.bonding_curve_progress,e.bondingCurveProgress,e.pumpProgress,e.graduationProgress,e.completion,e.completePct);if(t>0)return t<=1?t*100:t;const a=wn(e),r=Pp(e);return(!!e.isPump||r.includes("pump")||String(e.tokenMint||"").toLowerCase().endsWith("pump"))&&a>0?Math.max(1,Math.min(99,a/69e3*100)):0}function wr(e={}){if(e.isGraduated||e.graduated||e.bonded||e.isBonded||e.complete||e.completed||e.bondingComplete||e.raydiumPool||e.raydium_pool||e.poolAddress)return!0;const t=Pp(e);if(/\b(graduated|bonded|bonding complete|complete)\b/.test(t))return!0;const a=!!e.isPump||t.includes("pump")||String(e.tokenMint||"").toLowerCase().endsWith("pump"),r=wn(e);return a&&r>=Lw?!0:!!(a&&/\b(raydium|meteora|orca)\b/.test(t))}function Cp(e={}){if(wr(e))return"graduated";const t=String(e.slimeScopeCategory||"").trim().toLowerCase();return t==="graduated"?"graduated":bl(e)||t==="graduating"?"graduating":gl(e)?"new":(t==="steady"||t==="unknown"||Ap(e),"steady")}function Lp(e={}){const t=Number(e.bestPickScore||e.score||0),a=Tp(e),r=$p(e),s=wn(e),o=Qs(e),c=Number.isFinite(o)?Math.max(0,86400-o)/86400:0;return t*1e3+Math.log10(a+1)*160+Math.log10(r+1)*120+Math.log10(s+1)*80+c*100}function xp(e=[]){return[...e].sort((t,a)=>Lp(a)-Lp(t)||nt(t,a))}function xw(e=[],t=[],a=kw){const r=new Set,s=[];for(const o of[...e,...t]){const c=String(o?.tokenMint||"");if(!(!c||r.has(c))&&(r.add(c),s.push(o),s.length>=a))break}return s}function Mp(e=n.slimeScopeMode){const t=kp(),a=e==="graduated"?"graduated":e==="graduating"?"graduating":e==="steady"?"steady":"new",r=t.filter(l=>Cp(l)===a),s=t.filter(l=>{const d=Cp(l);return a==="graduated"?d==="graduated"||wr(l):a==="graduating"?d==="graduating"||bl(l):a==="steady"?d==="steady"||Ap(l):d==="new"||gl(l)}),o=a==="new"?[...r].sort(nt):xp(r),c=a==="new"?we(s).sort(nt):xp(s);return xw(o,c)}function Mw(e=[],t="new"){const a=ot(`slimeScope:${t}`,e).slice(0,12);return a.length?a.map((r,s)=>{const o=r.pairAgeLabel||Vt(r)||"age ?",c=_(r.marketCapLabel,r.fdvLabel,M(mt(r)),"checking"),l=_(r.liquidityLabel,M(ft(r)),"checking"),d=_(r.volumeM15Label,M(po(r)),"checking");return`
    ...
    `}).join(""):`<div class="slime-scope-column-empty">Warming up ${i(t)} pairs.</div>`}function Bw(){return`
  ...
  `}function v0(){const e=qe(),t=we(e?.rows||[]),a=vn(t),r=[...a].sort(nt),s=dp(n.kolScan?.rows||[]).filter(C=>!mr(C)),o=vn(s),c=gr(t,s),l=vn(c),d=yn(),u=wa(l,8,va("best-picks"),2),p=new Set(u.map(ya).filter(Boolean)),f=gp(r,p),y=wa(f.length?f:r,12,va("live-pairs"),0),b=new Set([...p,...y.map(ya).filter(Boolean)]),v=gp(o,b),P=wa(v.length?v:o,12,va("kol-signals"),1),A=!!n.livePairsLoadingByBucket[n.livePairBucket],g=da(),$="Trade";return`
  ...
  `}function w0(){const e=ut();if(!e)return"Trade";const t=ze(e);return t?`Buy ${t} SOL`:Nm(e,"Trade")}function Sa(){const e=ut(),t=ze(e);return t?`Buy ${t} SOL`:"Quick Buy"}function Zs(){const e=Sa();document.querySelectorAll("[data-quick-buy-token]").forEach(t=>{S(t,e)})}function ka(e=""){const t=String(e||"").trim();if(!t)return null;const a=pr().find(s=>String(s?.tokenMint||s?.mint||s?.tokenAddress||"").trim()===t);if(a)return a;const r=n.smartChartTokenRef||{};return String(r.tokenMint||r.mint||"").trim()===t?r:{tokenMint:t,shortMint:w(t),symbol:w(t),dexUrl:Q(t)}}function Iw(e=""){return{normal_buy:"Normal buy size can be considered",small_buy:"Trade small or use protection",watch_only:"Watch-only unless you accept high risk",avoid:"Avoid recommended"}[e]||"Review risk before buying"}function Ow(e=""){return{conservative:"Conservative",scalp:"Scalp",degen:"Degen"}[e]||"Conservative"}function Bp(e={}){if(!D("slimeShieldEnabled",!0))return"";const t=at(e),a=String(e.tokenMint||t.mint||"").trim(),r=t.verdict||"CAUTION";return`
    ...
    <ul class="radar-rule-list">
      ${a.map(l=>`
        <li class="radar-rule ${l.enabled===!1?"is-off":""}">
          <span class="radar-rule-icon">${_w(l.type)}</span>
  ...
  `:`<p class="slimeshield-muted">${i(t)}</p>`}function no(e,t="Not cached yet"){const a=String(e||"").trim();return!a||a.toLowerCase()==="warming"||a.toLowerCase()==="checking"?t:a}function ro(e,t=r=>String(r),a="Not cached yet"){return Number.isFinite(e)&&e>0?t(e):a}function Sn(e,t,a=""){if(e.__lastDrawerHtml===t)return!1;const r=a?e.querySelector(a):null,s=r?r.scrollTop:0;if(e.innerHTML=t,e.__lastDrawerHtml=t,a&&s){const o=e.querySelector(a);o&&(o.scrollTop=s)}return!0}function Ta(){let e=document.querySelector("[data-dev-info-drawer-root]");e||(e=document.createElement("div"),e.dataset.devInfoDrawerRoot="true",document.body.appendChild(e));const t=n.devInfoDetails||{},a=!!(t.open&&t.tokenMint);if(document.body.classList.toggle("dev-info-drawer-open",a),!a||!D("devInfoEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=String(t.tokenMint||"").trim(),s=ka(r)||fn(r)||{tokenMint:r},o=Op(r),c=n.devInfoSummaries?.[r]||br(s),l=ba(o.status||c.status),d=o.confidence||c.confidence||"unknown",u=!!n.devInfoLoading?.[`details:${r}`],p=o.likelyDevWallet||c.likelyDevWallet||"",f=o.currentPosition||null,y=o.historicalStats||{},b=o.linkedWalletSignals||{},v=o.marketContext||{},P=o.sourceHydration||{},A=Array.isArray(o.sourceEvidence)?o.sourceEvidence.slice(0,8):[],g=O(v.marketCap,s.marketCap,s.fdv),$=O(v.liquidityUsd,s.liquidityUsd),C=O(v.volume5m,s.volume5m,s.volumeM5),B=O(v.volumeH1,s.volumeH1,s.volume1h),U=O(v.pairAgeMinutes,s.pairAgeMinutes,Number(s.pairAgeSeconds)/60),H=v.metadataAuthority||s.metadataAuthority||s.updateAuthority||"",Se=v.mintAuthority||s.mintAuthority||"",De=v.freezeAuthority||s.freezeAuthority||"",q=!!(v.heliusDasIndexedAt||v.heliusDasSource||s.heliusDasSource||H||Se||De),Oe=[...Array.isArray(o.externalLinks)?o.externalLinks:[],...Array.isArray(c.externalLinks)?c.externalLinks:[],{label:"Solscan Token",url:r?`https://solscan.io/token/${encodeURIComponent(r)}`:""},{label:"Dex",url:s.dexUrl||Q(r)},{label:"Solscan Wallet",url:p?`https://solscan.io/account/${encodeURIComponent(p)}`:""},{label:"KOLscan Wallet",url:p?`https://kolscan.io/account/${encodeURIComponent(p)}`:""},{label:"Bubblemap",url:r?`https://app.bubblemaps.io/sol/token/${encodeURIComponent(r)}`:""},{label:"X",url:s.twitterUrl||s.xUrl},{label:"TG",url:s.telegramUrl},{label:"Website",url:s.websiteUrl}].filter((ee,Pn,xo)=>/^https?:\/\//i.test(String(ee.url||""))&&xo.findIndex(ql=>String(ql.url||"")===String(ee.url||""))===Pn).slice(0,8),X=Array.isArray(y.recentLaunches)?y.recentLaunches.slice(0,5):[],Ue=!!v.solanaTrackerLoaded,xt=!!f||Number(y.launchesTracked)>0||X.length>0,An=A.length>0||Array.isArray(o.riskReasons)&&o.riskReasons.length>0||Array.isArray(o.positiveReasons)&&o.positiveReasons.length>0||!!b.linkedWalletCount||Array.isArray(b.notes)&&b.notes.length>0,Mt=[["overview","Overview"]];Ue&&Mt.push(["holders","Holders"]),xt&&Mt.push(["history","History"]),An&&Mt.push(["signals","Signals"]);const Ba=Mt.some(([ee])=>ee===n.devInfoTab)?n.devInfoTab:"overview",Mr=`
    ...
    <aside class="dev-info-drawer dossier-drawer" data-active-pane="${i(Ba)}" role="dialog" aria-modal="true" aria-label="Dev Info details">
      ...
      <section data-pane="overview">
        ...
        <dl class="kol-dump-metrics">
          <div><dt>Wallet</dt><dd>${i(Fw(p))}</dd></div>
          <div><dt>Confidence</dt><dd>${i(Ep(d))}</dd></div>
  ...
  `;Sn(e,Mr,".dev-info-drawer")}function Np(e=""){return{mint:e,sampleSize:0,confidence:"low",matchedTraits:[],winRatePercent:null,medianMaxUpsidePercent:null,medianMaxDrawdownPercent:null,failRatePercent:null,bestExitPattern:"",summary:"Not enough local history yet. Replay improves as SlimeWire tracks more launches.",updatedAt:new Date().toISOString()}}function wl(e=""){const t=String(e||"").trim();return n.replayResults?.[t]||Np(t)}function kn(e,t="%"){return Number.isFinite(Number(e))?`${Math.round(Number(e))}${t}`:"n/a"}function zw(e=""){if(!D("replayBeforeBuyEnabled",!0))return"";const t=String(e||"").trim();if(!t)return"";const a=wl(t);return`
  ...
  `}async function Sl(e="",t={}){const a=String(e||"").trim();if(!a||!D("replayBeforeBuyEnabled",!0))return null;if(!t.force&&n.replayResults?.[a])return n.replayResults[a];if(n.replayLoading?.[a])return null;n.replayLoading={...n.replayLoading||{},[a]:!0},kr(),Aa();try{const r=new URLSearchParams({mint:a});t.force&&r.set("force","true");const o=(await k(`/api/web/replay-before-buy?${r.toString()}`,{timeoutMs:t.force?4500:3e3,preserveSafeError:!0}))?.replay||null;return o&&(n.replayResults={...n.replayResults||{},[a]:o},se(o.cacheHit?"replayCacheHit":"replayCacheMiss")),o}catch{return n.replayResults={...n.replayResults||{},[a]:Np(a)},null}finally{const r={...n.replayLoading||{}};delete r[a],n.replayLoading=r,kr(),Aa()}}function jw(e=""){const t=String(e||"").trim();!t||!D("replayBeforeBuyEnabled",!0)||(n.replayDetails={open:!0,tokenMint:t},Ka(),kr(),Sl(t))}function kl(){n.replayDetails={open:!1,tokenMint:""},kr(),Vr()}function kr(){let e=document.querySelector("[data-replay-drawer-root]");e||(e=document.createElement("div"),e.dataset.replayDrawerRoot="true",document.body.appendChild(e));const t=n.replayDetails||{},a=!!(t.open&&t.tokenMint);if(document.body.classList.toggle("replay-drawer-open",a),!a||!D("replayBeforeBuyEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=String(t.tokenMint||"").trim(),s=wl(r),o=!!n.replayLoading?.[r],c=`
    ...
    <aside class="slimeshield-drawer dossier-drawer" data-active-pane="${i(q)}" role="dialog" aria-modal="true" aria-label="SlimeShield details">
      ...
      <section data-pane="verdict">
        ...
        <dl class="kol-dump-metrics">
          ...
          <div><dt>Age</dt><dd>${i(Number.isFinite(P)?to(P):no(s.pairAgeLabel||Vt(s),"Not cached yet"))}</dd></div>
      ...
      <section class="slimeshield-action-note" data-pane="verdict">
        <h4>Suggested Action</h4>
        <p>${i(Iw(o.suggestedAction))}</p>
        <small>Protected Buy preset suggestion: ${i(Ow(o.protectedBuyPreset))}</small>
      </section>
      ${zw(r)}
      <div class="slimeshield-drawer-actions">
  ...
  `;Sn(e,Oe,".slimeshield-drawer")}function $l(e){const t=e==="bundle"?"bundle":"trade";n.activeTab=t,t==="trade"&&(n.editingTradePresetId=""),t==="bundle"&&(n.editingBundlePresetId=""),window.history.pushState({},"","/terminal"),h({force:!0})}function S0(e){if(!e?.tokenMint)return F("No token selected","Click any row to preview it here without leaving the live feeds.");const t=it().some(a=>String(a.tokenMint)===String(e.tokenMint));return`
  ...
  `}function Gw(e=""){const t=String(e||"").trim();return t?(n.pnl?.trades||[]).filter(a=>String(a?.tokenMint||a?.mint||"").trim()===t):[]}function $0(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=Gw(a),s=!!(gn(e)&&el(e)),o=s?gn(e):e.dexUrl||Q(tp(e)||a),c=s?"Pump":"DEX";return`
  ...
  `}function T0(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=_m(e||{});return`
  ...
  `}function Xw(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=n.chartTradeTab==="sell"?"sell":"buy",s=ue(),o=n.wallets?.length?String(n.wallets[0]?.index||""):"",c=Iu(),l=ut(),d=l?.walletIndex||(l?.walletIndexes||[])[0]||"",u=s?.publicKey&&Ou(s)?"connected":"",p=n.chartBuyWalletIndex||u||(c?.index?String(c.index):"")||d||o||(s?.publicKey?"connected":""),f=pe(p),y=n.quickBuyAmountOverride||ze(l)||"",b=l?bn("trade"):"No preset / manual",v=String(l?.slippageBps||"400"),P=String(l?.takeProfitPct||"25"),A=String(l?.stopLossPct||"8"),g=String(l?.sellDelay||"off"),$=String(l?.sellPercent||"100"),C=new Set(["300","400","500"]),B=Number.isFinite(Number(v))?`${Number(v)/100}%`:v,U=t?`${i(t.uiAmount||"Position")} tokens | ${i(t.estimatedValueSol||"value n/a")} SOL`:"No SlimeWire position tracked for this token.";return`
  ...
  `}function A0(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim();return a?`
  ...
  `}function Yw(){try{return Qw()}catch(e){console.error("Smart Chart render failed:",e);const t=String(n.smartChartToken||n.tradeToken||n.terminalToken||"").trim(),a=t?w(t):"No token selected",r=t?`https://dexscreener.com/solana/${encodeURIComponent(t)}?embed=1&theme=dark&trades=1&info=0`:"";return`
    ...
    `}}function Qw(){const e=Ks(),t=String(e?.tokenMint||"").trim(),a=t?it().find(o=>String(o.tokenMint)===t):null,r=t?we([e,...ur().filter(o=>String(o.tokenMint||"")===t)]).filter(Boolean).slice(0,5):wa(gr(),5,va("smart-chart-suggest"),1);if(!t)return`
    ...
    `;sa("tokenHeaderRendered"),sa("chartSkeletonRendered"),sa("buyPanelReady"),W({component:"smartChart",action:"chart-shell-rendered",durationMs:0,cacheHit:!!(tt(t)?.cacheHit||fr(t)?.pairAddress),stale:!!tt(t)?.stale,details:t});const s=e.symbol||e.shortMint||w(t);return`
    <section class="smart-chart-terminal smart-chart-clean-terminal">
      ...
      <div class="smart-chart-grid smart-chart-clean-grid">
        <article class="terminal-panel smart-chart-main smart-chart-clean-main">
          ${(()=>{Zw(t);const o=Dp(t);return o?`<div class="coin-banner-hero" style="background-image:url('${o}')" role="img" aria-label="Coin banner"></div>`:""})()}
          <div class="smart-chart-token-header smart-chart-clean-token-header${Dp(t)?" has-banner":""}">
            ${ht(e)}
            <div>
              <strong>${i(s)}</strong>
              <small>${i(e.name||e.category||"Token")}</small>
  ...
  `}function Dp(e){const t=String(e||"").trim();return n.coinBanners&&n.coinBanners[t]||""}let Up="";function Zw(e){const t=String(e||"").trim();!t||Up===t||(Up=t,k(`/api/web/coin-banner?mint=${encodeURIComponent(t)}`).then(a=>{const r=String(a?.bannerUri||"");r&&(n.coinBanners=n.coinBanners||{},n.coinBanners[t]=Qe(r),n.activeTab==="smartChart"&&h({preserveSmartChartFrame:!0}))}).catch(()=>{}))}let Tl="",qp=0;function Hp(e){e&&(Tl===e&&Date.now()-qp<3e4||(Tl=e,qp=Date.now(),k(`/api/web/calls?mint=${encodeURIComponent(e)}`).then(t=>{n.chartCalls={mint:e,...t},n.activeTab==="smartChart"&&h({preserveSmartChartFrame:!0})}).catch(()=>{})))}function eS(e){const t={bullish:["🟢","BULLISH"],bearish:["🔴","BEARISH"],warning:["⚠️","WARNING"],question:["❓","QUESTION"]},[a,r]=t[e]||["⚪",String(e||"").toUpperCase()];return`${a} ${r}`}function tS(e){Hp(e);const t=n.chartCalls?.mint===e?n.chartCalls:null,a=t?.calls||[],r=!!(n.token&&n.user);return`
      ...
      ${a.length?`
        <div class="table-list compact-table">
          ${a.map(s=>`
            <article class="row-card">
              <div class="row-main">
                <strong>${i(eS(s.side))} <span class="muted-text">by ${i(s.handle)}</span>
  ...
  `}async function aS(e){const t=m("[data-call-status]");try{const a=m("[data-call-side]")?.value||"bullish",r=m("[data-call-target]")?.value||"",s=m("[data-call-note]")?.value||"";S(t,"Posting call..."),await k("/api/web/calls",{method:"POST",body:JSON.stringify({tokenMint:e,side:a,targetX:r,note:s,source:"site"})}),S(t,"Call posted - it is now being tracked."),Tl="",Hp(e)}catch(a){S(t,N(a?.message||"Could not post call."))}}function nS(e,t=!1){const a=e?.tokenMint?n.positions.find(o=>String(o.tokenMint)===String(e.tokenMint)):null,r=bn("trade"),s=bn("bundle");return t?`
  ...
  `}function sS(){if(n.terminalSubtab==="orders")return zp();if(n.terminalSubtab==="history")return Al(12);if(n.terminalSubtab==="wallets")return Zu();if(n.terminalSubtab==="kol"){const e=dp(n.kolScan?.rows||[]).filter(t=>!mr(t));return Tt(e,{layout:"terminal",cooksStyle:!0,limit:12,rotateKey:va("bottom-kol"),stickyCount:1})}return n.terminalSubtab==="sniper"?n.scan?pt(n.scan.rows||[],{context:"sniper",primaryAction:"snipe",primaryActionLabel:"Snipe",hideToolbar:!0}):F("No sniper scan loaded","Open Sniper or refresh a scan mode."):n.terminalSubtab==="tx"?Gp(!0):n.terminalSubtab==="reconcile"?jp():oS(6)}function oS(e=25){const t=it();return t.length?`
    <div class="table-list compact-table">
      ${t.slice(0,e).map(Vp).join("")}
    </div>
  `:F("No open positions","Open token holdings will show here after refresh.")}const Kp=new Map;function iS(e){const t=String(e.tokenMint||"");if(!t)return"";const a=(n.pnl?.tokens||[]).find(u=>String(u.tokenMint)===t),r=pr().find(u=>String(u?.tokenMint||"")===t),s=(Array.isArray(n.tradePlans)?n.tradePlans:[]).find(u=>String(u.tokenMint)===t&&["watching","active","armed","pending"].includes(String(u.status||"").toLowerCase())),o=[];a?.spentSol&&o.push(`Entry ${a.spentSol} SOL`),r?.marketCapLabel&&o.push(`MC ${r.marketCapLabel}`),o.push(s?`TP ${s.takeProfitSummary||s.takeProfitPct||"off"} / SL ${s.stopLossSummary||s.stopLossPct||"off"} armed`:"no auto-exit armed");const c=Number(e.estimatedValueSol);let l="";if(Number.isFinite(c)){const u=Kp.get(t);if(u&&Number.isFinite(u.value)&&Math.abs(c-u.value)>5e-4){const p=c-u.value;l=`${p>0?"▲ +":"▼ "}${p.toFixed(4)} SOL since last refresh`}Kp.set(t,{value:c,at:Date.now()})}let d="";if(s){const u=Number(s.lastMovePct??s.wallets?.[0]?.lastMovePct),p=Number(s.takeProfitPct),f=Number(s.stopLossPct),y=Date.parse(s.sellAfterAt||s.wallets?.[0]?.sellAfterAt||""),b=Number.isFinite(y)?Math.round((y-Date.now())/6e4):null;Number.isFinite(u)&&Number.isFinite(p)&&p>0&&u>=p*.75?d=`Up ${u.toFixed(1)}% - take-profit at +${p}% is close`:Number.isFinite(u)&&Number.isFinite(f)&&f>0&&u<=-(f*.6)?d=`Down ${Math.abs(u).toFixed(1)}% - stop-loss at -${f}% is near`:b!==null&&b>0&&b<=10?d=`Timer exit in ~${b} min`:Number.isFinite(u)&&(d=`${u>=0?"Up":"Down"} ${Math.abs(u).toFixed(1)}% - exits watching`)}else ty(t)||e.source==="launch-optimistic"?d="⏳ Exits arming from your launch - TP/SL/timer registering...":d="No auto-exit on this bag - Arm Exits if you are stepping away";return`
  ...
  `}function Al(e=10,t=null){const a=Array.isArray(t)?t:n.pnl?.trades||[];return a.length?`
  ...
  `:F("No live trade history yet","Submitted web trades will appear here after refresh.")}function lS(){const e=n.pnl?.trades||[],t=ot("liveTrades",e);return`
      ...
      ${a.map(r=>`
        <article class="row-card stop-loss-audit-card">
          <div class="row-main">
            ...
            ${r.wallets?.length?`<div class="audit-wallet-list">${r.wallets.map(cS).join("")}</div>`:""}
          </div>
          <div class="card-actions compact">
  ...
  `}function Gp(e=!1){const t=n.terminalTxAudit;return`
    <section class="${e?"tx-audit compact":"terminal-layout tx-audit"}">
      <main class="terminal-main">
        ...
        ${t?dS(t):F("No transaction loaded","Use this when a wallet balance looks stale or a trade needs accounting review.")}
      </main>
      ${e?"":`<aside class="trade-side order-ticket-stack">${zp()}${jp()}</aside>`}
    </section>
  `}function dS(e){return e.error?`<article class="row-card"><strong>Audit failed</strong><span>${i(e.error)}</span></article>`:`
...
`)||"No logs returned.")}</pre>
  ...
  `}function uS(e=[]){const t=[...e].sort((a,r)=>Number(r.bestPickScore||r.score||0)-Number(a.bestPickScore||a.score||0)||nt(a,r));return wa(t,5,va("cooks-best"),1)}function me(e){const t=Number(e);return Number.isFinite(t)?t:0}function so(){const e=n.liveFeedCategory||"best";return Jo.find(([t])=>t===e)||Jo[0]}function $r(e={}){return Pr(e)||em(e)||po(e)||0}function oo(e={}){return me(e.buys5m)+me(e.buysH1)+me(e.sells5m)+me(e.sellsH1)}function Pl(e={}){const t=me(e.buys5m)+me(e.buysH1),a=me(e.sells5m)+me(e.sellsH1),r=t+a;return r>0?t/r:.5}function Tr(e={}){return Math.max(me(e.m5),me(e.h1),me(e.h24))}function io(e={}){return Math.max(me(e.m5),me(e.h1))}function Xp(e={}){return io(e)*Math.log10(10+$r(e))*(.5+Pl(e))}function Jp(e={}){return e.boosted||e.isBoosted||e.boost||e.boosts?!0:`${e.source||""} ${e.category||""} ${e.liveLabel||""} ${e.sourceLabel||""}`.toLowerCase().includes("boost")}function pS(e=[],t="best"){const a=[...e];switch(t){case"volume":return a.sort((r,s)=>$r(s)-$r(r));case"liquidity":return a.sort((r,s)=>ft(s)-ft(r));case"marketcap":return a.sort((r,s)=>mt(s)-mt(r));case"active":return a.sort((r,s)=>oo(s)-oo(r));case"fresh":return a.sort(nt);case"gainers":return a.sort((r,s)=>Tr(s)-Tr(r));default:return a.sort((r,s)=>me(s.bestPickScore||s.score)-me(r.bestPickScore||r.score)||nt(r,s))}}function lo(){const e=n.liveTerminalCategory||"dexTrending";return za.find(([t])=>t===e)||za[0]}function mS(e,t,a,r){return`
    ...
    </label>`}function fS(){if(n.activeTab==="terminal"){const t=lo();return{categories:za,activeId:t[0],sub:t[2],attr:"data-live-terminal-category",cap:"Discover",rank:a=>Yp(a,t[0]),hasBest:!1}}const e=so();return{categories:Jo,activeId:e[0],sub:e[2],attr:"data-live-feed-category",cap:"Feed",rank:t=>pS(t,e[0]),hasBest:e[0]==="best"}}function hS(e={}){if(Jp(e))return{cls:"boost",text:"⚡ Boosted"};const t=Tr(e);if(t>=40)return{cls:"gain",text:`▲ ${Math.round(t)}%`};const a=Number(e.pairAgeMinutes);return Number.isFinite(a)&&a>=0&&a<=10?{cls:"fresh",text:"✨ Fresh"}:io(e)>=25?{cls:"hot",text:"🔥 Hot"}:Pl(e)>=.7&&oo(e)>=24?{cls:"active",text:"● Active"}:null}function Cl(e={}){const t=hS(e);return t?`<span class="signal-badge signal-badge-${t.cls}">${i(t.text)}</span>`:""}function gS(e={}){const t=[];Jp(e)&&t.push("⚡ boosted");const a=[["5m",me(e.m5)],["1h",me(e.h1)],["24h",me(e.h24)]];a.sort((c,l)=>l[1]-c[1]),a[0][1]>=12&&t.push(`▲${Math.round(a[0][1])}% ${a[0][0]}`);const r=oo(e),s=Pl(e);r>=12&&s>=.62&&t.push(`${Math.round(s*100)}% buys`),e.smartMoney&&t.push("smart money in");const o=Pr(e)||po(e);return o>=2e3&&t.length<3&&t.push(`${M(o)} vol`),r>=30&&t.length<3&&t.push(`${r} trades`),Number(e.sniperCount||0)===0&&a[0][1]>=12&&t.length<3&&t.push("no snipers"),t.slice(0,3)}function bS(e={}){const t=gS(e);return t.length?`<div class="signal-why" title="Why it's moving"><small><span class="signal-why-tag">Why</span> ${i(t.join(" · "))}</small></div>`:""}function yS(e={}){return e.isPump||e.pump||e.pumpFun||e.pumpUrl?!0:`${e.source||""} ${e.category||""} ${e.dexId||""} ${e.dexName||""}`.toLowerCase().includes("pump")}function P0(e={}){const t=`${e.name||""} ${e.symbol||""} ${e.category||""}`.toLowerCase();return yS(e)||/meme|dog|cat|pepe|wif|inu|elon|moon|bonk|frog|chad/.test(t)}function Ar(){const e=n.cookSpotCategory||"dexTrending";return za.find(([t])=>t===e)||za[0]}function Yp(e=[],t="dexTrending"){const a=[...e];switch(t){case"fresh":return a.sort(nt);case"dexBoosted":case"graduated":return a.sort((r,s)=>$r(s)-$r(r));case"memeMovers":return a.sort((r,s)=>Tr(s)-Tr(r));case"earlyMomentum":return a.sort((r,s)=>io(s)-io(r));default:return a.sort((r,s)=>Xp(s)-Xp(r))}}function vS(e=Ar()){const[t]=e;return`
    ...
    </label>`}function Qp(e=0,t=""){const a=nn(t),r=a===null?"live":Xn(a);return`<div class="cooks-meta" data-cooks-meta><span><b>${e}</b> ${e===1?"pair":"pairs"}</span><span aria-hidden="true">·</span><span>updated ${i(r)}</span></div>`}function Ll(e=[]){const t=fS(),a=mS(t.categories,t.activeId,t.attr,t.cap),r='<button type="button" class="cooks-inline-refresh" data-refresh-live-pairs title="Refresh feed">↻ Refresh</button>',s=Qp(e.length,da()),o={context:"live",shareBuilder:Pa,hideToolbar:!0};if(t.hasBest){const l=uS(e),d=new Set(l.map(ya).filter(Boolean)),u=[...e].sort(nt).filter(f=>!d.has(ya(f))),p=ot("live",u);return`
    ...
    </div>`}function Zp(){const e=qe(),t=we(e?.rows||[]),a=vn(t),r=ot("live",a),s=Ot.find(([f])=>f===n.livePairBucket)?.[1]||"Live",o=da(),c=!!n.livePairsLoadingByBucket[n.livePairBucket],l=yn(),d=n.livePairsRefreshErrorByBucket?.[n.livePairBucket],u=c?"Scanning live pairs...":e?.message||"Cooks refreshes while this tab is open.",p=a.length?Ll(a):l?vr(t,`${s.toLowerCase()} pairs`):d?F("Unable to load pairs. Try refreshing.","The live feed hit a snag — it keeps retrying automatically, or tap ↻ Refresh."):c?F("Loading live pairs…","Scanning fresh pairs for this time window."):F("No pairs found for this filter yet","Keep this tab open or tap Refresh Live. Trade safety checks run before any buy.");return`
  ...
  `}function C0(e){const t={live:"Brand-new launches under an hour old. Best Picks rotates the strongest; Newest streams them as they appear.",under1h:"Pairs aged about 1 to 2 hours - past the first-minute chaos, early momentum still forming.",under3h:"Pairs aged about 3 to 6 hours - established enough to show a real volume and liquidity trend.",under1d:"Pairs aged about 24 to 48 hours - day-old survivors ranked by liquidity, volume, momentum, and risk."};return t[e]||t.live}function wS(){if(!n.user||!n.token)return`${is()}${F("Create or log in to save a watchlist","You can browse scanners as a guest. Tap Watch after creating an account to save coins here.")}`;const e=n.watchlist?.rows||[],t=ot("watchlist",e);return`
  ...
  `}function L0(e){return pt(e,{context:"live",shareBuilder:Pa})}function pt(e,t={}){const a=t.shareBuilder||Pa,r=we(e),s=`signal-list ${t.context==="kol"?"signal-list-kol":""}`.trim();return r.length?`
    ...
    <div class="${i(s)}">
      ...
      ${r.map((o,c)=>SS(o,c,{...t,shareText:a(o),priority:c<12})).join("")}
    </div>
  `:`
      ${t.hideToolbar?"":qi(t.context||"scanner")}
    ...
    <article class="signal-row ${l?"is-kol-signal":""}" data-token-chart="${i(e.tokenMint)}" data-token-chart-source="${i(a.context||"signal-row")}">
      ...
      <div class="signal-cell" data-cell="Liq"><span>${i(_(e.liquidityLabel,ft(e)>0?M(ft(e)):"","checking"))}</span><small>${kS(e.h1)}</small></div>
      ...
      <div class="signal-cell" data-cell="Txns"><span>${i(e.txnsLabel||e.winRateLabel||"n/a")}</span><small>${i(lw(e))}</small></div>
  ...
  `}function CS(){const e=n.sniperResult;return e?.results?.length?`<div class="mini-results">${e.results.map(t=>`<span data-ok="${t.ok?"true":"false"}">${i(t.message||t)}</span>`).join("")}</div>`:""}function LS(){const e=n.scan.rows||[],t=ot("sniper",e);return e.length?`
    ...
    ${pt(t,{context:"sniper",primaryAction:"snipe",primaryActionLabel:"Snipe",shareBuilder:xg})}
    ${ca("sniper",e,"snipe candidates")}
  `:F("No usable picks","Refresh again or choose a different mode.")}function mo(){return n.user?.connectedWallet?.publicKey||""}function tm(){return n.ogreTek.markets.find(e=>e.symbol===n.ogreTek.selectedMarket)||n.ogreTek.markets[0]||null}function xS(){return{marketSymbol:n.ogreTek.selectedMarket,direction:n.ogreTek.direction,orderType:n.ogreTek.orderType,collateralUsd:n.ogreTek.collateralUsd,leverage:n.ogreTek.leverage,slippagePct:n.ogreTek.slippagePct,priorityFeeLamports:n.ogreTek.priorityFeeLamports,limitPrice:n.ogreTek.limitPrice,stopPrice:n.ogreTek.stopPrice}}function am(){return Wm(xS(),tm(),n.ogreTek.account,Ae)}function $e(e,t=2){const a=Number(e);return Number.isFinite(a)?Math.abs(a)>=1e9?`$${(a/1e9).toFixed(2)}B`:Math.abs(a)>=1e6?`$${(a/1e6).toFixed(2)}M`:Math.abs(a)>=1e3?`$${(a/1e3).toFixed(1)}K`:`$${a.toFixed(t)}`:"n/a"}function gt(e){const t=Number(e);return Number.isFinite(t)?t>=1e3?`$${t.toLocaleString(void 0,{maximumFractionDigits:2})}`:`$${t.toFixed(t>=10?2:4)}`:"n/a"}function fo(e,t=3){const a=Number(e);return Number.isFinite(a)?`${a>=0?"+":""}${a.toFixed(t)}%`:"n/a"}function nm(e){const t=Date.parse(e||"");if(!t)return"not loaded";const a=Math.max(0,Math.round((Date.now()-t)/1e3));return a<60?`${a}s ago`:`${Math.round(a/60)}m ago`}function ho(){document.querySelectorAll("[data-ogre-tek-field]").forEach(e=>{const t=e.dataset.ogreTekField;!t||!(t in n.ogreTek)||(e.type==="checkbox"?n.ogreTek[t]=!!e.checked:n.ogreTek[t]=e.value)})}async function MS(){!Ae.enabled||n.ogreTek.loading||n.ogreTek.markets.length||n.ogreTek.error||await Cr({silent:!0}).catch(e=>{n.ogreTek.error=N(e.message),h({force:!0})})}async function Cr({force:e=!1,silent:t=!1}={}){if(Ae.enabled&&!(n.ogreTek.loading&&!e)){n.ogreTek.loading=!0,n.ogreTek.error="",t||h({force:!0});try{const a=mo(),[r,s,o,c]=await Promise.all([Br.getMarkets(),Br.getAccount(a),Br.getPositions(a),Br.getOpenOrders(a)]);n.ogreTek.markets=r||[],n.ogreTek.account=s||null,n.ogreTek.positions=o||[],n.ogreTek.orders=c||[],n.ogreTek.markets.some(l=>l.symbol===n.ogreTek.selectedMarket)||(n.ogreTek.selectedMarket=n.ogreTek.markets[0]?.symbol||"SOL-PERP"),n.ogreTek.status=`Updated ${new Date().toLocaleTimeString()}`}catch(a){n.ogreTek.error=N(a.message)}finally{n.ogreTek.loading=!1,h({force:!0})}}}function BS(){return`
  ...
  `}function RS(){if(Om(Ae)!=="enabled")return BS();const e=!!mo(),t=tm(),a=am(),r=a.quote,s=n.ogreTek.account,o=a.ok&&!n.ogreTek.loading,c=n.ogreTek.error?"Provider Error":n.ogreTek.loading?"Loading":"Ready",l=Ae.demoMode?"Review Demo Trade":"Review Trade",d=Ae.demoMode?"Confirm Demo Review":"Confirm Order",u=Ae.demoMode?!n.ogreTek.riskAccepted||!a.ok:!Rm({validation:a,riskAccepted:n.ogreTek.riskAccepted,demoMode:Ae.demoMode});return`
    <section class="ogre-tek-page">
      ...
      ${n.ogreTek.reviewOpen?_S({validation:a,quote:r,market:t,confirmButtonText:d,confirmDisabled:u}):""}
    </section>
  `}function IS(){return n.ogreTek.loading&&!n.ogreTek.markets.length?F("Loading markets","Ogre Tek is loading demo perps markets."):n.ogreTek.markets.length?`
    <div class="ogre-market-grid">
      ${n.ogreTek.markets.map(e=>`
        <button type="button" class="ogre-market-card" data-ogre-tek-market="${i(e.symbol)}" data-active="${e.symbol===n.ogreTek.selectedMarket}">
          ...
          <small>Fresh ${i(nm(e.updatedAt))}</small>
        </button>
      `).join("")}
    </div>
  `:F("No markets available","No allowed perps markets are available for this provider.")}function OS(e,t){return`
  ...
  `}function ES(){return mo()?n.ogreTek.positions.length?`
  ...
  `:F("No open positions","Mock positions will appear here when the provider reports them."):F("Wallet disconnected","Connect Phantom, Solflare, Backpack, or another detected Solana wallet to view perps account data.")}function FS(){return mo()?n.ogreTek.orders.length?`
  ...
  `:F("No orders","Open, trigger, and history orders will list here when a real adapter is configured."):F("Wallet disconnected","Connect a wallet to load open and trigger orders.")}function WS(e){return e?.connected?`
    <div class="ogre-account-grid">
      ...
      <span><small>Account Freshness</small><strong>${i(nm(e.updatedAt))}</strong></span>
    </div>
  `:"<p>Connect a wallet to load collateral, health, positions, and margin risk.</p>"}function _S({validation:e,quote:t,market:a,confirmButtonText:r,confirmDisabled:s}){const o=e.order||{};return`
  ...
  `}function VS(){const e=!!n.ogreAgentOpen,t=$n(),a=n.ogreAgentVoiceEnabled?"Voice On":"Voice Off",r=um(),s=n.ogreAgentListening?"Stop":"Mic";return`
  ...
  `}function E({force:e=!1}={}){let t=document.querySelector("[data-ogre-agent-mount]");t||(t=document.createElement("div"),t.dataset.ogreAgentMount="true",document.body.appendChild(t));const a=t.querySelector("[data-ogre-agent-input]"),r=!!(a&&document.activeElement===a),s=r?a.selectionStart:null,o=r?a.selectionEnd:null,c=t.querySelector("[data-ogre-agent-feed]"),l=c?c.scrollTop:0,d=c?c.scrollHeight-c.scrollTop-c.clientHeight<64:!0;a&&(n.ogreAgentDraft=a.value);const u=Array.isArray(n.ogreAgentMessages)?n.ogreAgentMessages:[],p=u[u.length-1]||{},f=[n.ogreAgentOpen?"open":"closed",n.ogreAgentLoading?"loading":"idle",n.ogreAgentStatus||"",u.length,p.role||"",p.text||"",Array.isArray(p.actions)?p.actions.length:0,n.ogreAgentVoiceEnabled?"voice-on":"voice-off",n.ogreAgentSpeaking?"speaking":"silent",n.ogreAgentListening?"listening":"not-listening"].join("|");if(!e&&r&&t.dataset.ogreAgentSignature===f)return;t.innerHTML=VS(),t.dataset.ogreAgentSignature=f,t.querySelector("[data-ogre-agent-close]")?.addEventListener("click",v=>{v.preventDefault(),v.stopPropagation(),vo()});const y=t.querySelector("[data-ogre-agent-input]");y&&(y.value=n.ogreAgentDraft||"",r&&(y.focus({preventScroll:!0}),s!==null&&o!==null&&y.setSelectionRange(s,o),setTimeout(()=>y.scrollIntoView({block:"nearest",behavior:"smooth"}),90)));const b=t.querySelector("[data-ogre-agent-feed]");b&&(e||d||n.ogreAgentLoading?b.scrollTop=b.scrollHeight:b.scrollTop=Math.min(l,Math.max(0,b.scrollHeight-b.clientHeight)))}document.addEventListener("focusin",e=>{const t=e.target?.matches?.("[data-ogre-agent-input]")?e.target:null;t&&setTimeout(()=>t.scrollIntoView({block:"nearest",behavior:"smooth"}),160)},{passive:!0});function fe(e={}){const t={role:e.role==="user"?"user":"assistant",text:String(e.text||"").slice(0,1800),actions:Array.isArray(e.actions)?e.actions.slice(0,4):[],retryText:String(e.retryText||"").slice(0,1200)};n.ogreAgentMessages=[...$n(),t].slice(-50),DS(),t.role==="assistant"&&cm(t.text||"")}function Rl(){return typeof window<"u"&&"speechSynthesis"in window&&"SpeechSynthesisUtterance"in window}function zS(){if(!Rl())return null;const e=window.speechSynthesis.getVoices?.()||[];if(!e.length)return null;const t=a=>{const r=`${a.name||""} ${a.voiceURI||""}`.toLowerCase(),s=String(a.lang||"").toLowerCase();let o=0;return(/^en[-_]/.test(s)||s==="en")&&(o+=18),/google|microsoft|natural|premium|enhanced|neural|online|siri|alex|daniel|guy|david|mark|george|james|fred/i.test(r)&&(o+=18),/google us english|microsoft guy|microsoft david|google uk english male|daniel|alex|george|james|mark/i.test(r)&&(o+=14),/female|zira|samantha|victoria|karen|moira|susan/i.test(r)&&(o-=2),/compact|eloquence|robot|novelty|whisper|bells|bubbles|organ|zarvox/i.test(r)&&(o-=25),a.localService&&(o+=3),o};return e.slice().sort((a,r)=>t(r)-t(a))[0]||e[0]||null}let Tn=null;function jS(){if(typeof window>"u")return null;const e=window.AudioContext||window.webkitAudioContext;if(!e)return null;try{return(!Tn||Tn.state==="closed")&&(Tn=new e),Tn.state==="suspended"&&Tn.resume(),Tn}catch{return null}}function lm(e="reply"){if(!n.ogreAgentVoiceEnabled||!n.ogreAgentOpen)return;const t=jS();if(t)try{const a=t.currentTime,r=e==="online"?.22:.34,s=t.createGain(),o=t.createBiquadFilter(),c=t.createOscillator(),l=t.createOscillator(),d=t.createGain();s.gain.setValueAtTime(1e-4,a),s.gain.exponentialRampToValueAtTime(e==="online"?.08:.105,a+.035),s.gain.exponentialRampToValueAtTime(1e-4,a+r),o.type="lowpass",o.frequency.setValueAtTime(210,a),o.frequency.exponentialRampToValueAtTime(92,a+r),o.Q.setValueAtTime(5.2,a),c.type="sawtooth",c.frequency.setValueAtTime(e==="online"?92:68,a),c.frequency.exponentialRampToValueAtTime(e==="online"?64:49,a+r),l.type="sine",l.frequency.setValueAtTime(e==="online"?45:38,a),l.frequency.exponentialRampToValueAtTime(e==="online"?35:31,a+r),d.gain.setValueAtTime(.18,a),d.gain.exponentialRampToValueAtTime(1e-4,a+r),c.connect(o),o.connect(s),l.connect(d),d.connect(s),s.connect(t.destination),c.start(a),l.start(a),c.stop(a+r+.02),l.stop(a+r+.02)}catch{}}function Pt(e=!1){n.ogreAgentSpeaking=!!e,n.ogreAgentOpen&&E({force:!0})}function bo(){if(!Rl()){Pt(!1);return}try{window.speechSynthesis.cancel()}catch{}Pt(!1)}function GS(e=""){return String(e||"").replace(/https?:\/\/\S+/gi," link available ").replace(/[•*_`#>~|]+/g," ").replace(/\b[A-HJ-NP-Za-km-z1-9]{32,44}\b/g," token address ").split(/\n+/).map(r=>r.replace(/^\d+\.\s*/,"").trim()).filter(r=>r&&!/^(open|refresh|show|check|buy|sell|dex|pump|telegram|website|x search|kol tracker)\b/i.test(r)).join(". ").replace(/\s+/g," ").split(/(?<=[.!?])\s+/).map(r=>r.trim()).filter(Boolean).slice(0,3).join(" ").trim().slice(0,360)}function cm(e=""){if(!n.ogreAgentVoiceEnabled||!n.ogreAgentOpen||!Rl()){Pt(!1);return}const t=GS(e);if(!t){Pt(!1);return}try{window.speechSynthesis.cancel();const a=new window.SpeechSynthesisUtterance(t),r=zS();r&&(a.voice=r),a.pitch=.72,a.rate=.86,a.volume=1,a.onstart=()=>Pt(!0),a.onend=()=>Pt(!1),a.onerror=()=>Pt(!1),Pt(!0),lm("reply"),window.speechSynthesis.speak(a)}catch{Pt(!1)}}function XS(e){n.ogreAgentVoiceEnabled=!!e;try{localStorage.setItem("ogreAgentVoiceEnabled",n.ogreAgentVoiceEnabled?"on":"off")}catch{}n.ogreAgentVoiceEnabled?(n.ogreAgentStatus="Ogre voice on.",lm("online"),cm("Ogre voice online.")):(bo(),n.ogreAgentStatus="Ogre voice muted."),E({force:!0})}function dm(){return typeof window>"u"?null:window.SpeechRecognition||window.webkitSpeechRecognition||null}function um(){return!!dm()}async function pm(){if(typeof navigator>"u"||!navigator.mediaDevices?.getUserMedia)return"unavailable";try{return(await navigator.mediaDevices.getUserMedia({audio:!0}))?.getTracks?.().forEach(t=>{try{t.stop()}catch{}}),"granted"}catch(e){const t=String(e?.name||e?.message||"").toLowerCase();return/notallowed|permission|denied/.test(t)?"denied":/notfound|notreadable|overconstrained/.test(t)?"unavailable":"failed"}}function mm(e=""){const t=String(e||"").replace(/\s+/g," ").trimStart();n.ogreAgentDraft=t;const a=document.querySelector("[data-ogre-agent-input]");if(a){a.value=t;try{a.focus({preventScroll:!0}),a.setSelectionRange(t.length,t.length)}catch{}}}function yo(){Zt&&(clearTimeout(Zt),Zt=null),_a&&(clearTimeout(_a),_a=null)}function fm(e,t=n.ogreAgentSpeechRecognizer){_a&&clearTimeout(_a),_a=setTimeout(()=>{e!==rt||n.ogreAgentSpeechRecognizer!==t||jt("Mic timed out instead of staying open. Tap Mic again or type the command.")},ef)}function jt(e=""){rt+=1,yo();const t=n.ogreAgentSpeechRecognizer;if(n.ogreAgentSpeechRecognizer=null,n.ogreAgentListening=!1,n.ogreAgentSpeechFinal="",t){t.onstart=null,t.onresult=null,t.onerror=null,t.onend=null;try{t.abort?.()}catch{}try{t.stop?.()}catch{}}e&&(n.ogreAgentStatus=e),n.ogreAgentOpen&&E({force:!0})}async function JS(){if(!um()){const o=await pm();n.ogreAgentStatus=o==="denied"?"Mic permission was denied. Allow microphone access, then use Chrome or Edge speech input.":"This browser does not expose speech-to-text to SlimeWire. Typing and device keyboard dictation still work.",E({force:!0});return}n.ogreAgentLoading&&(n.ogreAgentRequestId="",n.ogreAgentLoading=!1,n.ogreAgentStatus="Cleared the stuck reply. Mic is opening..."),bo(),jt();const e=rt;n.ogreAgentStatus="Checking microphone permission...",E({force:!0});const t=await pm();if(e!==rt||!n.ogreAgentOpen)return;if(t==="denied"){n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentSpeechFinal="",n.ogreAgentStatus="Mic permission denied. Allow microphone access to talk to Ogre.",E({force:!0});return}if(t==="unavailable"){n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentSpeechFinal="",n.ogreAgentStatus="No microphone is available to this browser. Typing still works.",E({force:!0});return}const a=dm(),r=new a,s=++rt;n.ogreAgentSpeechRecognizer=r,n.ogreAgentListening=!0,n.ogreAgentSpeechBaseDraft=String(document.querySelector("[data-ogre-agent-input]")?.value||n.ogreAgentDraft||"").trim(),n.ogreAgentSpeechFinal="",n.ogreAgentStatus="Opening microphone...",E({force:!0}),r.continuous=!1,r.interimResults=!0,r.maxAlternatives=1,r.lang=/^en/i.test(navigator.language||"")?navigator.language:"en-US",Zt=setTimeout(()=>{s!==rt||n.ogreAgentSpeechRecognizer!==r||jt("Mic did not start. Check browser permission, then tap Mic again.")},Zm),r.onstart=()=>{s!==rt||n.ogreAgentSpeechRecognizer!==r||(Zt&&(clearTimeout(Zt),Zt=null),n.ogreAgentListening=!0,n.ogreAgentStatus="Listening... speak your Ogre command.",fm(s,r),E({force:!0}))},r.onresult=o=>{if(s!==rt||n.ogreAgentSpeechRecognizer!==r)return;fm(s,r);let c="",l="";for(let u=o.resultIndex||0;u<o.results.length;u+=1){const p=String(o.results[u]?.[0]?.transcript||"");o.results[u]?.isFinal?l+=` ${p}`:c+=` ${p}`}l.trim()&&(n.ogreAgentSpeechFinal=`${n.ogreAgentSpeechFinal||""} ${l}`.replace(/\s+/g," ").trim());const d=[n.ogreAgentSpeechBaseDraft,n.ogreAgentSpeechFinal,c.trim()].filter(Boolean).join(" ").replace(/\s+/g," ").trim();mm(d)},r.onerror=o=>{if(s!==rt||n.ogreAgentSpeechRecognizer!==r)return;yo();const c=String(o?.error||"");n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentSpeechFinal="",n.ogreAgentStatus=c==="not-allowed"?"Mic permission denied. Allow microphone access to talk to Ogre.":c==="no-speech"?"No voice heard. Tap Mic and try again.":c==="aborted"?"Voice input stopped.":"Voice input stopped. Typing still works.",E({force:!0})},r.onend=()=>{if(s!==rt||n.ogreAgentSpeechRecognizer!==r)return;yo();const o=String(n.ogreAgentDraft||"").trim(),c=!!(o&&n.ogreAgentSpeechFinal&&!n.ogreAgentLoading);n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentStatus=c?"Voice command captured.":"Voice input stopped.",E({force:!0}),c&&setTimeout(()=>{mm(o),bt()},100)};try{r.start()}catch{yo(),n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentSpeechFinal="",n.ogreAgentStatus="Mic could not start. Typing still works.",E({force:!0})}}function YS(){n.ogreAgentListening||n.ogreAgentSpeechRecognizer?jt("Voice input stopped."):JS()}function vo(){n.ogreAgentOpen=!1,n.ogreAgentStatus="",n.ogreAgentLoading=!1,n.ogreAgentRequestId="",jt(),bo(),E({force:!0})}function QS(e=""){const[t,a]=String(e).split(":");return $n()[Number(t)]?.actions?.[Number(a)]||null}function hm(){return Array.isArray(n.wallets)&&n.wallets.length>0}function gm(){return!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey||n.walletPublicKey||n.connectedWalletPublicKey)}function wo(){return!!(!bm()&&(n.ogreAgentAutoTradeApproved||hm()||gm()))}function ZS(e="wallet-sync"){return bm()?!1:hm()||gm()?(Ol(!0),!0):(Il(),!1)}function bm(){try{return sessionStorage.getItem("ogreAgentAutoTradeRevoked")==="yes"}catch{return!1}}function Il(){n.ogreAgentAutoTradeApproved=!1;try{sessionStorage.removeItem("ogreAgentAutoTradeApproved"),sessionStorage.removeItem("ogreAgentAutoTradeRevoked"),localStorage.removeItem("ogreAgentAutoTradeApproved")}catch{}}function Ol(e,t={}){n.ogreAgentAutoTradeApproved=!!e;try{localStorage.removeItem("ogreAgentAutoTradeApproved"),n.ogreAgentAutoTradeApproved?(sessionStorage.setItem("ogreAgentAutoTradeApproved","yes"),sessionStorage.removeItem("ogreAgentAutoTradeRevoked")):(sessionStorage.removeItem("ogreAgentAutoTradeApproved"),t.revoked&&sessionStorage.setItem("ogreAgentAutoTradeRevoked","yes"))}catch{}}function ym(e){n.ogreAgentFastMode=!!e;try{localStorage.setItem("ogreAgentFastMode",n.ogreAgentFastMode?"on":"off")}catch{}}function Ct(e=""){const t=String(e||"").toLowerCase(),a=/\b(buy|ape|enter|grab|snipe|purchase|get in|go in|long|take entry)\b/.test(t),r=/\b(sell|exit|close|dump|cash out)\b/.test(t),s=/\b(take profit|tp)\b/.test(t)&&!/\b(set|with|stop loss|sl|target|preset)\b/.test(t);return a?"buy":r||s?"sell":""}function ek(e=""){const t=String(e||"").toLowerCase(),a=Ct(t);if(!a||/\b(if|only if|unless|after you check|check first|looks good|seems good|safe enough|popular enough|passes|good choice|good pick)\b/.test(t))return!1;const r=/\b(will you|would you|can you|could you|are you able|do i have to|will it|you will be able)\b/.test(t),s=a==="buy"?/\b(buy|ape|enter|grab|snipe|purchase|get in|go in|long|take entry)\b/.test(t):/\b(sell|exit|close|dump|cash out)\b/.test(t),o=!!(zt()||n.smartChartToken||n.tradeToken),c=/\b(now|please|with|for|from|wallet|sol|%|all|half|quarter|this|it)\b/.test(t)||/\b[A-HJ-NP-Za-km-z1-9]{32,48}\b/.test(e)||a==="buy"&&o&&/\b(just\s+)?buy\b/.test(t);return!!(s&&c&&!r)}function tk(e=""){const t=String(e||"").toLowerCase(),a=(t.match(/(?:buy|ape|enter|grab|snipe|purchase|get in|go in|long|take entry).*?(?:with|for|using)\s*(\d+(?:\.\d+)?)\s*sol\b/)||t.match(/(\d+(?:\.\d+)?)\s*sol\b/)||[])[1];return a?Number(a):0}function El(){const e=typeof ut=="function"?ut():null,t=Number(n.quickBuyAmountOverride||(typeof ze=="function"?ze(e):"")||e?.amountSol||"0");return Number.isFinite(t)&&t>0?t:0}function ak(e=""){const t=String(e||"").toLowerCase(),a=(t.match(/(?:take\s*profit|profit\s*take|tp|target|profit)[^0-9]*(\d{1,4}(?:\.\d+)?)\s*%?/)||[])[1]||"",r=(t.match(/(?:stop\s*loss|stoploss|sl)[^0-9]*(\d{1,3}(?:\.\d+)?)\s*%?/)||[])[1]||"",s=(t.match(/(?:slippage|slip)[^0-9]*(\d{1,3}(?:\.\d+)?)\s*%?/)||[])[1]||"",o=s?Math.round(Number(s)*100):0,c=[];return a&&c.push(`TP +${a}%`),r&&c.push(`SL -${r}%`),s&&c.push(`slippage ${s}%`),{takeProfitPct:a,stopLossPct:r,slippagePct:s,slippageBps:Number.isFinite(o)&&o>0?o:0,summary:c.join(" / ")}}function nk(e=""){const t=String(e||"").toLowerCase(),a=(t.match(/(\d{1,3})\s*%/)||[])[1];return a||(/\bhalf\b/.test(t)?"50":/\bquarter\b/.test(t)?"25":(/\ball\b|\bfull\b|100/.test(t),"100"))}function rk(e=""){const t=(String(e||"").toLowerCase().match(/(?:wallet|from)\s*#?\s*(\d{1,2})/)||[])[1];return t?Math.max(0,Number(t)-1):void 0}function sk(){const e=[],t=(r={})=>{const s=String(r.tokenMint||r.mint||r.tokenAddress||r.baseMint||r.pairAddress||"").trim();s&&e.push({tokenMint:s,symbol:String(r.symbol||r.baseSymbol||r.ticker||"").trim(),name:String(r.name||r.baseName||r.label||"").trim()})};n.smartChartToken&&t({tokenMint:n.smartChartToken,symbol:n.smartChartTokenSymbol}),n.tradeToken&&t({tokenMint:n.tradeToken,symbol:n.tradeTokenSymbol}),[n.livePairRows,n.slimeScopeRows,n.watchlist,n.positions,n.portfolioRows,n.ogreAiResult?.candidates].filter(Array.isArray).forEach(r=>r.forEach(t));const a=new Set;return e.filter(r=>{const s=r.tokenMint.toLowerCase();return a.has(s)?!1:(a.add(s),!0)})}function ok(e=""){const t=String(e||"").trim(),a=(t.match(/\b[A-HJ-NP-Za-km-z1-9]{32,48}\b/)||[])[0];if(a)return a;const r=t.toLowerCase();return sk().map(o=>{const c=o.symbol.toLowerCase(),l=o.name.toLowerCase();let d=0;return c&&new RegExp(`(^|[^a-z0-9])${c.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}([^a-z0-9]|$)`,"i").test(r)&&(d+=12+c.length),l&&r.includes(l)&&(d+=8+Math.min(16,l.length)),{...o,score:d}}).filter(o=>o.score>0).sort((o,c)=>c.score-o.score)[0]?.tokenMint||""}function So(e={},t=""){const a={...e},r=Ct(t);if(!a.tokenMint&&!a.mint&&!a.ca){const s=ok(t)||zt()||n.smartChartToken||n.tradeToken;s&&(a.tokenMint=s)}if(a.type==="confirm_buy"||r==="buy"){if(a.type=a.type||"confirm_buy",!a.amountSol){const o=tk(t)||El();o>0&&(a.amountSol=o)}const s=ak(t);if(s.takeProfitPct&&!a.takeProfitPct&&(a.takeProfitPct=s.takeProfitPct),s.stopLossPct&&!a.stopLossPct&&(a.stopLossPct=s.stopLossPct),s.slippageBps&&!a.slippageBps&&(a.slippageBps=s.slippageBps),a.walletIndex===void 0){const o=rk(t);o!==void 0&&(a.walletIndex=o)}}return(a.type==="confirm_sell"||r==="sell")&&(a.type=a.type||"confirm_sell",a.percent=a.percent||nk(t)),a}function vm(e={}){const t=[];return e.takeProfitPct&&t.push(`TP +${e.takeProfitPct}%`),e.stopLossPct&&t.push(`SL -${e.stopLossPct}%`),t.length?` Targets noted: ${t.join(" / ")}.`:""}function wm(e={},t=""){if(!n.ogreAgentFastMode||!wo()||e.requiresReview||e.conditional)return!1;const a=Ct(t);return a?a==="buy"?e.type==="confirm_buy"&&!!(e.tokenMint||e.mint||e.ca)&&Number(e.amountSol||e.sol||e.amount||0)>0:a==="sell"?e.type==="confirm_sell"&&!!(e.tokenMint||e.mint||e.ca):!1:!1}async function Gt(e={}){const t=String(e.type||""),a=String(e.tokenMint||e.mint||e.ca||n.smartChartToken||n.tradeToken||zt()||"").trim();if(t==="toggle_agent_fast_mode"){ym(!n.ogreAgentFastMode),n.ogreAgentStatus=n.ogreAgentFastMode?"Fast Mode ON: clear trade requests run directly.":"Fast Mode OFF: Ogre will stage actions first.",fe({role:"assistant",text:n.ogreAgentStatus,actions:[{label:n.ogreAgentFastMode?"Turn Fast Mode Off":"Turn Fast Mode On",type:"toggle_agent_fast_mode"}]}),E();return}if(t==="approve_agent_auto_trade"){Ol(!0),ym(!0),n.ogreAgentStatus="Agent Auto-Trade is enabled for this session. SlimeWire managed/session wallets run directly through the saved trade flow; connected wallets still approve direct wallet trades.",fe({role:"assistant",text:`${n.ogreAgentStatus}
External wallet apps may still require their own signature prompts. Managed wallets can run through the saved SlimeWire flow.`,actions:[{label:"Revoke Auto-Trade",type:"revoke_agent_auto_trade"},{label:"Show Positions",type:"open_tab",tab:"positions"},{label:"Best Picks",type:"open_tab",tab:"ogreAi"}]}),E();return}if(t==="revoke_agent_auto_trade"){Ol(!1,{revoked:!0}),n.ogreAgentStatus="Agent Auto-Trade revoked. Ogre will still help, but direct trade requests need approval again.",fe({role:"assistant",text:n.ogreAgentStatus,actions:[{label:"Auto-Trade On",type:"approve_agent_auto_trade"}]}),E();return}if(t==="open_tab"){n.route="terminal",n.activeTab=e.tab||"terminal",window.history.pushState({},"",e.path||"/terminal"),h({force:!0});return}if(t==="open_chart"||t==="prepare_buy"){if(!a){n.ogreAgentStatus="Paste a token CA in the message first.",E();return}$t(ve(a,{source:"ogre-agent"}),{defaultTab:t==="prepare_buy"?"buy":"chart",focusAmountInput:t==="prepare_buy",source:"ogre-agent"});return}if(t==="prepare_sell"){n.route="terminal",n.activeTab="positions",window.history.pushState({},"","/terminal"),n.ogreAgentStatus=e.percent?`Sell ${e.percent}% staged. Use the position card confirm buttons.`:"Open Positions and use the sell confirm buttons.",h({force:!0});return}if(t==="refresh_wallet"){ne(()=>St({force:!0,reason:"ogre_agent"})),n.ogreAgentStatus="Wallet refresh started.",E();return}if(t==="refresh_feeds"){ne(()=>en({force:!0,reason:"ogre_agent"})),n.ogreAgentStatus="Feed refresh started.",E();return}if(t==="open_wallet_connect"){pa({returnPath:"/terminal"}),n.ogreAgentStatus="Wallet connect opened.",E();return}if(t==="start_clip_recording"){hd(),n.ogreAgentStatus="REC started from Ogre Agent.",E();return}if(e.type==="open_quick_buy"){const r=String(e.tokenMint||e.mint||n.selectedToken?.mint||n.selectedToken?.pairAddress||"").trim();if(!r){n.ogreAgentStatus="Send me a token address first, then I can open the buy panel.",E();return}Number(e.amountSol||e.sol||e.amount||0)>0&&(n.quickBuyAmountOverride=String(e.amountSol||e.sol||e.amount||"")),mn(ve(r,{source:"ogre-agent-open-buy"}),{source:"ogre-agent-open-buy",forceModal:!0}),n.ogreAgentStatus="Buy panel opened. Review it and confirm with your wallet.",E();return}if(e.type==="confirm_buy"){const r=String(e.tokenMint||e.mint||e.ca||n.selectedToken?.mint||n.selectedToken?.pairAddress||n.smartChartToken||n.tradeToken||zt()||"").trim(),s=Number(e.amountSol||e.sol||e.amount||El()||0);if(!r||!Number.isFinite(s)||s<=0){r&&mn(ve(r,{source:"ogre-agent-buy-missing-amount"}),{source:"ogre-agent-buy-missing-amount",forceModal:!0}),n.ogreAgentStatus=r?"Buy panel opened. Pick the SOL amount and confirm with your wallet.":"Tell me the token address and amount, like: buy 0.1 SOL of CA.",E();return}const o=e.walletIndex!==void 0?e.walletIndex:ue()?.publicKey?"connected":n.wallets[0]?.index??0,c=Number.isFinite(Number(e.slippageBps))?Number(e.slippageBps):void 0;n.ogreAgentLoading=!0,n.ogreAgentStatus=`Sending ${s} SOL buy request...`,E();try{const l=await _s({tokenMint:r,walletIndex:o,amountSol:s,slippageBps:c,takeProfitPct:e.takeProfitPct||"",stopLossPct:e.stopLossPct||"",source:"ogre-agent-confirm-buy"});n.ogreAgentStatus=l?.ok===!1?l.error||l.message||"Buy failed. Check wallet/RPC status and retry.":`Buy submitted. Refreshing wallet and positions in the background.${vm(e)}`,typeof St=="function"&&St({force:!0,reason:"ogre_agent_buy"}),typeof refreshPositionsNow=="function"&&refreshPositionsNow({force:!0,reason:"ogre_agent_buy"})}catch(l){n.ogreAgentStatus=l?.message||"Buy failed. Check wallet/RPC status and retry."}finally{n.ogreAgentLoading=!1,E()}return}if(e.type==="confirm_sell"){const r=String(e.tokenMint||e.mint||e.ca||n.selectedToken?.mint||n.selectedToken?.pairAddress||"").trim(),s=String(e.percent||e.percentText||"100").replace(/[^0-9.]/g,"")||"100";if(!r){n.activeTab="positions",n.ogreAgentStatus="I opened Positions. Pick a token or tell me the CA to sell.",h();return}n.ogreAgentLoading=!0,n.ogreAgentStatus=`Preparing sell ${s}%...`,E();try{await Ds(r,s,{skipConfirm:!0,source:"ogre-agent-confirm-sell"}),n.ogreAgentStatus=`Sell ${s}% submitted. Refreshing wallet and positions in the background.`,typeof St=="function"&&St({force:!0,reason:"ogre_agent_sell"}),typeof refreshPositionsNow=="function"&&refreshPositionsNow({force:!0,reason:"ogre_agent_sell"})}catch(o){n.ogreAgentStatus=o?.message||"Sell failed. Check wallet/RPC status and retry."}finally{n.ogreAgentLoading=!1,E()}return}if(e.type==="open_external"){const r=String(e.url||e.href||"").trim();if(!/^https?:\/\//i.test(r)){n.ogreAgentStatus="That link is not available yet. Send the token CA and ask for links.",E();return}window.open(r,"_blank","noopener,noreferrer"),n.ogreAgentStatus="Opened trusted coin link.",E();return}if(e.type==="coin_breakdown"||e.type==="analyze_coin"){const r=go(String(e.tokenMint||e.mint||e.ca||n.smartChartToken||n.tradeToken||zt()||"").trim());if(!r){n.ogreAgentStatus="Paste a token CA and ask me to check it.",E();return}const s=o=>{const c=Number(o);return!Number.isFinite(c)||c<=0?"n/a":c>=1e9?`$${(c/1e9).toFixed(2)}B`:c>=1e6?`$${(c/1e6).toFixed(2)}M`:c>=1e3?`$${(c/1e3).toFixed(1)}K`:`$${c.toFixed(c>=1?2:6)}`};n.ogreAgentLoading=!0,n.ogreAgentStatus="Checking coin details...",E();try{const c=(await k(`/api/web/dex-token?token=${encodeURIComponent(r)}`,{timeoutMs:8e3,dedupe:!1,preserveSafeError:!0}))?.dexToken||{},l=c.symbol||c.baseSymbol||w(r),d=c.name||c.baseName||"Token",u=c.dexUrl||c.pairUrl||`https://dexscreener.com/solana/${r}`,p=c.pumpUrl||(String(r).toLowerCase().endsWith("pump")?`https://pump.fun/coin/${r}`:""),f=c.websiteUrl||c.website||c.links?.website||"",y=c.twitterUrl||c.xUrl||c.links?.twitter||c.links?.x||"",b=c.telegramUrl||c.links?.telegram||"",v=s(c.liquidityUsd||c.liquidity?.usd),P=s(c.marketCap||c.fdv||c.marketCapUsd),A=s(c.volume24h||c.volume?.h24||c.volume?.m5),g=[`${l} breakdown`,`${d} | ${w(r)}`,`MC/FDV: ${P} | Liquidity: ${v} | Volume: ${A}`,`Socials: X ${y?"found":"not returned"} | Telegram ${b?"found":"not returned"} | Website ${f?"found":"not returned"}`,"Read: look for live buys vs sells, liquidity depth, holder/risk badges, socials, and whether the chart is building higher lows.","Risk note: fresh Solana launches can still rug even with good socials. Size smaller until liquidity, volume, and holder distribution prove out."],$=[{label:"Open Chart",type:"open_chart",tokenMint:r},{label:"Dex",type:"open_external",url:u}];p&&$.push({label:"Pump",type:"open_external",url:p}),f&&$.push({label:"Website",type:"open_external",url:f}),y&&$.push({label:"X",type:"open_external",url:y}),b&&$.push({label:"Telegram",type:"open_external",url:b}),fe({role:"assistant",text:g.join(`
`),actions:$}),n.ogreAgentStatus="Coin breakdown ready."}catch(o){fe({role:"assistant",text:`I could not pull live metadata for ${w(r)} yet, but I can still open chart, Dex, Pump, or help inspect risk badges.`,actions:[{label:"Open Chart",type:"open_chart",tokenMint:r},{label:"Dex",type:"open_external",url:`https://dexscreener.com/solana/${r}`},{label:"Pump",type:"open_external",url:`https://pump.fun/coin/${r}`}]}),n.ogreAgentStatus=o?.message||"Coin check delayed."}finally{n.ogreAgentLoading=!1,E()}return}n.ogreAgentStatus="Action noted. Ask Ogre to open a panel, chart, refresh, trade, or check a coin.",E()}function ik(e=""){return/\b(check|analy[sz]e|rug|honeypot|community|social|website|telegram|twitter|x\b|links?|good choice|good pick|good buy|bullish|bearish|safe|risky|risk|will it do well|looks good|breakdown|details?)\b/i.test(String(e||""))}function Fl(e=""){return(String(e||"").match(/\b[A-HJ-NP-Za-km-z1-9]{32,48}\b/)||[])[0]||""}function Sm(e=""){return/\b(x|twitter|tweet|tweets|post|posts|posting|mentions?|popular|viral|trending|trend|kols?|influencers?|callers?|community|socials?)\b/i.test(String(e||""))}function lk(e="",t=[]){const a=[String(e||"").trim(),...Array.isArray(t)?t:[t]].map(s=>String(s||"").trim()).filter((s,o,c)=>s&&c.findIndex(l=>l.toLowerCase()===s.toLowerCase())===o).slice(0,4),r=a.length?a.map(s=>`"${s.replace(/"/g,"")}"`).join(" OR "):`"${String(e||"").trim()}"`;return`https://x.com/search?q=${encodeURIComponent(r)}&src=typed_query&f=live`}function ck(e=""){if(!Sm(e))return null;const t=go(Fl(e)||zt()||n.smartChartToken||n.tradeToken||"");return t?{text:[`${w(t)} X/KOL check`,"I kept this token active in the conversation. Server social scan is still warming, so I can use SlimeWire-visible rows and open live X search without inventing callers.","If no verified posts or KOL rows return, treat the social side as unconfirmed and check chart, liquidity, buys/sells, and risk badges before sizing."].join(`
`),actions:[{label:"Open X Search",type:"open_external",url:lk(t)},{label:"Open Chart",type:"open_chart",tokenMint:t},{label:"KOL Tracker",type:"open_tab",tab:"kol"},{label:"Refresh Feeds",type:"refresh_feeds"}]}:null}function dk(e=""){const t=String(e||"").toLowerCase();return/\b(top|best|hot|trending|trend|viral|runner|moving|today|now|low mc|low mcap|fresh|climbing|x2|2x)\b/.test(t)&&/\b(meme|memecoin|coin|token|pair|launch|x|twitter|volume|market cap|mc)\b/.test(t)}function uk(e=""){if(!dk(e))return null;const t=om().slice(0,4),a=o=>{const c=Number(o);return!Number.isFinite(c)||c<=0?"n/a":c>=1e6?`$${(c/1e6).toFixed(2)}M`:c>=1e3?`$${(c/1e3).toFixed(1)}K`:`$${c.toFixed(c>=1?2:6)}`};if(!t.length)return{text:["Fast scan is ready, but I do not have fresh rows loaded in this screen yet.","Tap Refresh Feeds, then ask again. If a broad X result is not returned, I will rank SlimeWire-visible live candidates and exact live-search links instead of faking callers."].join(`
...
`),actions:[s?.tokenMint?{label:"Open Top Chart",type:"open_chart",tokenMint:s.tokenMint}:null,{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}].filter(Boolean)}}const pk=[["terminal",["terminal","command center","cooks","main feed","live feed","home"]],["live",["live pairs","fresh pairs","new pairs","pairs"]],["slimeScope",["slime scope","scope","scanner","cook spot"]],["smartChart",["smart chart","chart page","charting"]],["trade",["trade desk","trade page","swap page","slime swap","manual trade"]],["bundle",["bundle","bundle buy","multi wallet buy"]],["volume",["volume","slimebot","slime bot","volume bot"]],["sniper",["sniper","ogre sniper","snipe picks","picks"]],["launchCoin",["pump launch","launch a coin","launch coin","create coin","create a token","make a coin","launcher"]],["launch",["launch watch","launch watches","watch launches","snipe launches"]],["kol",["kol","kols","kol tracker","copy trading","copy wallet"]],["ogreAi",["ogre ai","ogre a.i","autopilot","auto pilot","ai buyer"]],["wallets",["wallets","wallet page","balances","my wallets","fund","sweep"]],["positions",["positions","open positions","bags","holdings","my coins"]],["pnl",["pnl","profit","results","p&l","pnl card","share card"]],["txAudit",["tx audit","stop loss audit","audit","armed plans","my plans","tp sl status"]],["profile",["profile","account","referral","referrals","badges","pfp","alerts","push alerts","notifications"]],["tek",["ogre tek","tek hub","tools","tool hub","automation deck","shield receipts","receipts"]],["ogreTek",["perps","perp","perp mode","leverage"]],["watchlist",["watchlist","watch list","saved coins","saved tokens"]],["liveTrades",["live trades","recent trades","trade history"]]],mk=/\b(open|go to|goto|show me|show|take me|bring up|pull up|switch to|navigate|where is|where's|wheres|where are|where do i|how do i (?:get to|open|find)|find)\b/i;function fk(e){const t=String(e||"").toLowerCase().replace(/[?!.]+$/g,"").trim();if(!t||t.length>120||Fl(e)||Ct(e))return null;const a=/(?:set\s+)?quick\s*buy(?:\s+amount)?\s*(?:to|at|=)?\s*([0-9]*\.?[0-9]+)\s*(?:sol)?$/i.exec(t);if(a){const s=yr(a[1]);if(s)return n.quickBuyAmountOverride=s,os({quickBuy:s}),Zs(),{text:`Quick buy set to ${s} SOL - every Buy button across the site now fires with that amount.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}if(/\b(i (?:like|prefer|want|am)|keep (?:it|them)|show me|give me)\b/.test(t)){if(/\b(risky|degen|moonshots?|early|low\s*mc|gambl)/.test(t))return os({risk:"degen"}),{text:"Noted - early risky plays it is. The fresh low-MC line in the brief is yours, and I'll keep that preference next visit too.",actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Sniper",type:"open_tab",tab:"sniper"}]};if(/\b(safe|careful|low risk|clean|less risky)\b/.test(t))return os({risk:"careful"}),{text:"Noted - shield-clean setups first. I'll remember that next visit. SlimeShield verdicts are on every pair and /t page.",actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}if(/\brefresh\b.*\b(feed|pairs|scan)/.test(t)||t==="refresh feeds")return{text:"Refreshing the live feeds now.",run:{type:"refresh_feeds"},actions:[]};if(/\brefresh\b/.test(t)||/\bsync\b.*\b(wallet|balance|position)/.test(t))return{text:"Refreshing wallets, balances, and positions now.",run:{type:"refresh_wallet"},actions:[]};if(/\b(connect|link|hook up)\b.*\bwallet\b/.test(t))return{text:"Opening the wallet connect chooser.",run:{type:"open_wallet_connect"},actions:[]};if(/what can you do|what do you do|help me|how do you work|what are you/.test(t))return{text:`I can take you anywhere on the site (just say "open positions" or "where is the sniper"), check any coin (paste a CA), run buys and sells ("buy 0.1 of <CA>"), set your quick-buy amount, refresh wallets and feeds, and read risk with SlimeShield. Ask in your own words - I'll keep up.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Positions",type:"open_tab",tab:"positions"},{label:"Ogre Tek",type:"open_tab",tab:"tek"}]};const r=mk.test(t);for(const[s,o]of pk)for(const c of o){if(!(t===c||t===`the ${c}`||t===`my ${c}`)&&!(r&&t.includes(c)))continue;return{text:`Opening ${hk(s)} now.${s==="profile"&&/alert|push|notification/.test(t)?" Push alerts live under Profile > Alerts.":""}`,run:{type:"open_tab",tab:s},actions:[{label:"Back to Terminal",type:"open_tab",tab:"terminal"}]}}return null}function hk(e){return{terminal:"the Live Terminal",live:"Live Pairs",slimeScope:"Slime Scope",smartChart:"Smart Chart",trade:"the Trade Desk",bundle:"Bundle",volume:"SlimeBot Volume",sniper:"OgreSniper",launchCoin:"Pump Launch",launch:"Launch Watch",kol:"the KOL Tracker",ogreAi:"Ogre A.I.",wallets:"Wallets",positions:"Positions",pnl:"PnL",txAudit:"the TP/SL Audit",profile:"your Profile",tek:"the Ogre Tek hub",ogreTek:"Perp Mode",watchlist:"your Watchlist",liveTrades:"Live Trades"}[e]||e}const gk={submitted:"Order submitted",approved:"Wallet approved",sent:"Transaction sent",confirmed:"Confirmed on-chain",armed:"TP/SL armed"};function km(e){n.tradeTrace={title:String(e||"Trade"),steps:[],startedAt:Date.now(),done:!1},ko()}function Ie(e,t="ok",a=""){if(!n.tradeTrace||n.tradeTrace.done&&t==="pending")return;const r=n.tradeTrace.steps,s=r.find(l=>l.key===e),o=s||{key:e,label:gk[e]||e};if(o.status=t,o.detail=String(a||"").slice(0,140),s||r.push(o),t==="fail"&&(n.tradeTrace.done=!0),ko(),t==="fail")return;r.length>=3&&r.every(l=>l.status==="ok")&&(n.tradeTrace.done=!0,window.setTimeout(()=>{n.tradeTrace?.done&&!n.tradeTrace.steps.some(l=>l.status==="fail")&&(n.tradeTrace=null,ko())},8e3))}function ko(){let e=document.querySelector("[data-trade-trace-mount]");e||(e=document.createElement("div"),e.dataset.tradeTraceMount="true",document.body.appendChild(e));const t=n.tradeTrace;if(!t){e.innerHTML="",e.__lastDrawerHtml="";return}const a=r=>r==="ok"?"✅":r==="fail"?"❌":"⏳";e.innerHTML=`
  ...
  `}async function bt(e=""){const t=document.querySelector("[data-ogre-agent-input]"),a=String(e||t?.value||"").trim();if(!a||n.ogreAgentLoading)return;const r=Fl(a);if(r&&go(r),t&&(t.value=""),n.ogreAgentDraft="",fe({role:"user",text:a,actions:[]}),ek(a)){const l=Ct(a),d=So({type:l==="buy"?"confirm_buy":"confirm_sell"},a),u=String(d.tokenMint||d.mint||d.ca||"").trim(),p=Number(d.amountSol||d.sol||d.amount||0);if(!u){fe({role:"assistant",text:'Send the token CA first, then say the buy/sell command. I will keep that CA active for follow-up commands like "buy it" or "sell half".',actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}),n.ogreAgentStatus="Need token CA.",E({force:!0});return}if(l==="buy"&&(!Number.isFinite(p)||p<=0)){fe({role:"assistant",text:"I have the token, but I need a SOL amount or a saved quick-buy amount. Example: buy it with 0.1 SOL.",actions:[{label:"Open Buy Panel",type:"open_quick_buy",tokenMint:u},{label:"Trade Panel",type:"open_tab",tab:"trade"}]}),n.ogreAgentStatus="Need buy amount.",E({force:!0});return}if(!wo()){fe({role:"assistant",text:"Connect or create a wallet and Auto-Trade becomes ready for this session. SlimeWire managed/session wallets can run through the saved flow; external wallet apps may still show their own signature prompt.",actions:[{label:"Auto-Trade On",type:"approve_agent_auto_trade"},{label:"Open Wallets",type:"open_tab",tab:"wallets"}]}),n.ogreAgentStatus="Wallet session needed.",E({force:!0});return}fe({role:"assistant",text:l==="buy"?`Sending ${p} SOL buy for ${w(u)}.${vm(d)}`:`Sending sell request for ${w(u)}${d.percent?` at ${d.percent}%`:""}.`,actions:[{label:"Show Positions",type:"open_tab",tab:"positions"},{label:"Open Chart",type:"open_chart",tokenMint:u}]}),n.ogreAgentStatus="Fast Mode: sending trade request...",E({force:!0}),await Gt(d);return}const s=fk(a);if(s){fe({role:"assistant",text:s.text,actions:s.actions||[]}),n.ogreAgentStatus="Instant local reply.",E({force:!0}),s.run&&await Gt(s.run);return}n.ogreAgentLoading=!0,n.ogreAgentStatus="",se("chatRequestStarted");const o=`${Date.now()}:${Math.random().toString(16).slice(2)}`;n.ogreAgentRequestId=o;const c=setTimeout(()=>{n.ogreAgentRequestId!==o||!n.ogreAgentLoading||(n.ogreAgentRequestId="",n.ogreAgentLoading=!1,n.ogreAgentStatus="Agent reply timed out.",se("chatRequestTimedOut"),fe({role:"assistant",text:"I timed out instead of staying stuck. I can still open panels, refresh feeds, check a coin, show positions, or open chart from here.",retryText:a,actions:[{label:"Show Positions",type:"open_tab",tab:"positions"},{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Live Terminal",type:"open_tab",tab:"terminal"}]}),E({force:!0}))},7500);E();try{const l=await k("/api/web/ogre-agent/chat",{method:"POST",body:JSON.stringify({message:a,context:US()}),timeoutMs:7e3,dedupe:!1,preserveSafeError:!0});if(n.ogreAgentRequestId!==o)return;const d=(l?.agent?.actions||[]).map(v=>So(v,a));l?.agent?.tokenMint&&go(l.agent.tokenMint),fe({role:"assistant",text:l?.agent?.reply||"I can help with panel functions, charts, positions, presets, coin checks, links, risk reads, and fast trade requests.",actions:d}),se("chatRequestSucceeded");const u=!!(l?.agent?.coinEnriched||l?.agent?.tokenMint||l?.agent?.socialLinks||l?.agent?.socialScan),f=!Sm(a)&&!u&&!Ct(a)&&ik(a)?d.find(v=>v.type==="coin_breakdown"||v.type==="analyze_coin")||So({type:"coin_breakdown"},a):null;if(f?.tokenMint||f?.mint||f?.ca){n.ogreAgentStatus="Checking coin now...",await Gt(f);return}const y=So({type:Ct(a)==="buy"?"confirm_buy":Ct(a)==="sell"?"confirm_sell":""},a);if(Ct(a)&&n.ogreAgentFastMode&&!wo()){fe({role:"assistant",text:"Agent Auto-Trade turns on automatically for this session when a wallet is connected or created. If an external wallet still asks for a signature, that is the wallet provider layer.",actions:[{label:"Auto-Trade On",type:"approve_agent_auto_trade"},{label:"Fast Mode Off",type:"toggle_agent_fast_mode"}]}),n.ogreAgentStatus="Auto-Trade approval needed once.";return}const b=d.find(v=>wm(v,a))||(wm(y,a)?y:null);if(b){n.ogreAgentStatus="Fast Mode: sending trade request...",await Gt(b);return}n.ogreAgentStatus=l?.agent?.modelPowered?"AI reply":"Fast local Ogre reply"}catch(l){if(n.ogreAgentRequestId!==o)return;const d=ck(a);if(d){fe({role:"assistant",text:d.text,actions:d.actions}),n.ogreAgentStatus="Fast local X/KOL fallback.";return}const u=uk(a);if(u){fe({role:"assistant",text:u.text,actions:u.actions}),n.ogreAgentStatus="Fast local trend scan.";return}fe({role:"assistant",text:"Ogre Agent is still here, but the server reply timed out. I can still open panels, refresh feeds, check coins, open links, and route trade actions.",retryText:a,actions:[{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Positions",type:"open_tab",tab:"positions"},{label:"Live Terminal",type:"open_tab",tab:"terminal"}]}),se("chatRequestFailed"),n.ogreAgentStatus=l?.message||"Agent reply failed."}finally{clearTimeout(c),n.ogreAgentRequestId===o&&(n.ogreAgentRequestId="",n.ogreAgentLoading=!1,E())}}function F(e,t){return`<article class="empty"><h3>${i(e)}</h3><p>${i(t)}</p></article>`}function i(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Te(e){const t=new Date(e||"");return Number.isNaN(t.getTime())?"unknown":t.toLocaleString()}function bk(e){try{e.dataset.lockInPointerHandledAt=String(Date.now())}catch{}}function $m(e){const t=Number(e?.dataset?.lockInPointerHandledAt||0);return Number.isFinite(t)&&Date.now()-t<900}document.addEventListener("pointerup",e=>{const a=(e.target instanceof Element?e.target:e.target?.parentElement)?.closest?.("[data-open-login], [data-connect-login-toggle]");a&&(e.preventDefault(),bk(a),Ac({connectPanel:a.matches("[data-connect-login-toggle]")||n.route==="connect",source:a.matches("[data-connect-login-toggle]")?"connect-lock-in":"top-lock-in"}))},{capture:!0}),document.addEventListener("keydown",e=>{if(Uf(e))return;if(e.target?.closest?.("[data-ogre-agent-input]")&&e.key==="Enter"&&!e.shiftKey){e.preventDefault(),bt();return}const a=e.target?.closest?.("[data-global-token-search]");if(a&&e.key==="Enter"){e.preventDefault(),zu(a.value||"");return}if(e.key==="Escape"){if(n.ogreAgentOpen){vo();return}if(n.slimeShieldDetails?.open){yl();return}if(n.kolDumpDetails?.open){ji();return}if(n.replayDetails?.open){kl();return}if(n.protectedBuyModal?.open){Ws();return}if(!(!n.loginModalOpen&&!n.quickBuyModal?.open)){if(n.quickBuyModal?.open){nl();return}$c()}}});function Wl(e=null,t="interaction"){const a=e?.closest?.("[data-token-trade], [data-token-chart], [data-preview-token]");if(!a)return!1;const r=a.dataset.tokenTrade||a.dataset.tokenChart||a.dataset.previewToken||"";if(!r)return!1;if(String(t||"").includes("prefetch")){const c=Date.now(),l=Number(n.smartChartInteractionPrefetchAt||0),d=n.smartChartInteractionPrefetchSeen||{};if(l&&c-l<jv||Number(d[r]||0)&&c-Number(d[r])<Jv)return!1;const u=(n.smartChartInteractionPrefetchRecent||[]).filter(p=>c-Number(p||0)<Gv);if(u.length>=Xv)return n.smartChartInteractionPrefetchRecent=u,!1;n.smartChartInteractionPrefetchAt=c,n.smartChartInteractionPrefetchRecent=[...u,c],n.smartChartInteractionPrefetchSeen={...d,[r]:c}}return cl(ve(r,{source:a.dataset.tokenTradeSource||a.dataset.tokenChartSource||t}),{source:a.dataset.tokenTradeSource||a.dataset.tokenChartSource||t})}document.addEventListener("pointerenter",e=>{Wl(e.target instanceof Element?e.target:null,"pointer-prefetch")},!0),document.addEventListener("touchstart",e=>{Wl(e.target instanceof Element?e.target:null,"touch-prefetch")},{capture:!0,passive:!0}),document.addEventListener("focusin",e=>{Wl(e.target instanceof Element?e.target:null,"focus-prefetch")},!0);const Tm=new WeakMap;function yk(e){let t=Tm.get(e);if(!t){const a=window.getComputedStyle(e);t={scrollable:["auto","scroll","overlay"].includes(a.overflowY),contained:/contain|none/.test(a.overscrollBehaviorY)},Tm.set(e,t)}return t}document.addEventListener("wheel",e=>{if(e.defaultPrevented||e.ctrlKey||e.deltaY===0||n.route!=="terminal"||tr())return;let t=e.target instanceof Element?e.target:null;if(t&&t.tagName==="IFRAME")return;const a=e.deltaY>0?1:-1;for(;t&&t!==document.body&&t!==document.documentElement;){const o=yk(t);if(o.scrollable&&t.scrollHeight>t.clientHeight+1){const c=t.scrollTop<=0,l=t.scrollTop+t.clientHeight>=t.scrollHeight-1;if(!(a<0&&c||a>0&&l)||o.contained)return}t=t.parentElement}const r=document.scrollingElement||document.documentElement;if(!r||r.scrollHeight<=r.clientHeight+1)return;let s=e.deltaY;e.deltaMode===1?s*=40:e.deltaMode===2&&(s*=r.clientHeight),r.scrollTop+=s,e.preventDefault()},{passive:!1}),document.addEventListener("click",async e=>{const t=e.target instanceof Element?e.target:e.target?.parentElement;if(t?.closest?.("[data-slimeshield-close]")){e.preventDefault(),yl();return}if(t?.closest?.("[data-protected-buy-close]")){e.preventDefault(),Ws();return}if(t?.closest?.("[data-kol-dump-close]")){e.preventDefault(),ji();return}if(t?.closest?.("[data-replay-close]")){e.preventDefault(),kl();return}const c=t?.closest?.(".tabs .nav-tool-group summary");if(c){e.preventDefault();const g=c.closest(".nav-tool-group");n.navTekOpen=!g?.open,mf(n.navTekOpen),g&&(g.open=n.navTekOpen);return}const l=t?.closest?.("button, a, [data-preview-token], [data-token-chart], [data-token-trade], [data-quick-buy-token], [data-quick-trade-token], [data-dev-info], [data-quick-bundle-token], [data-watch-token], [data-unwatch-token], [data-share-x]");if(!l)return;if(l.tagName==="A"){const g=l.getAttribute("href")||"",$=/^https?:\/\//i.test(g)&&!g.startsWith(window.location.origin),C=!!(window.matchMedia?.("(display-mode: standalone)")?.matches||window.navigator?.standalone);if($&&(l.getAttribute("target")==="_blank"||C)){e.preventDefault();try{window.open(g,"_blank","noopener,noreferrer")}catch{window.location.href=g}return}}if(l.matches("[data-tool-section]")){e.preventDefault();const g=l.dataset.toolSection,[$]=g.split(":"),C=g.slice($.length+1);n.toolSections={...n.toolSections||{},[$]:C};const B=l.closest("[data-tool-panels]");B&&(B.querySelectorAll(`[data-tool-section^="${$}:"]`).forEach(U=>{U.dataset.active=U.dataset.toolSection===g?"true":"false"}),B.querySelectorAll(`[data-tool-panel^="${$}:"]`).forEach(U=>{U.hidden=U.dataset.toolPanel!==g}),bs(B));return}if(l.matches("[data-clip-record]")){e.preventDefault(),n.clipFarm?.recording?er():hd();return}if(l.matches("[data-clip-share]")){e.preventDefault(),Rh();return}if(l.matches("[data-clip-download]")){e.preventDefault(),Ih();return}if(l.matches("[data-clip-clear]")){e.preventDefault(),Ti();return}if(l.matches("[data-slimeshield-tab]")){e.preventDefault();const g=l.dataset.slimeshieldTab||"verdict";n.slimeShieldTab=g;const $=l.closest(".dossier-drawer");$&&($.setAttribute("data-active-pane",g),$.querySelectorAll("[data-slimeshield-tab]").forEach(C=>{C.dataset.active=C.dataset.slimeshieldTab===g?"true":"false"}));return}if(l.matches("[data-slimeshield-details]")){e.preventDefault(),l.closest("[data-dev-info-drawer-root]")&&vl(),Ip(l.dataset.slimeshieldDetails||"");return}if(l.matches("[data-slimeshield-refresh]")){e.preventDefault(),eo(l.dataset.slimeshieldRefresh||"",{force:!0});return}if(l.matches("[data-kol-dump-details]")){e.preventDefault(),cy(l.dataset.kolDumpDetails||"");return}if(l.matches("[data-kol-dump-refresh]")){e.preventDefault(),zi({force:!0});return}if(l.matches("[data-replay-open]")){e.preventDefault(),jw(l.dataset.replayOpen||"");return}if(l.matches("[data-replay-refresh]")){e.preventDefault(),Sl(l.dataset.replayRefresh||"",{force:!0});return}if(l.matches("[data-ogre-agent-toggle]")){n.ogreAgentOpen?vo():(n.ogreAgentOpen=!0,Qh(),E({force:!0}));return}if(l.matches("[data-ogre-agent-close]")){vo();return}if(l.matches("[data-ogre-agent-voice]")){XS(!n.ogreAgentVoiceEnabled);return}if(l.matches("[data-ogre-agent-send]")){jt(),bt();return}if(l.matches("[data-ogre-agent-mic]")){YS();return}if(l.matches("[data-ogre-agent-quick]")){const g=l.dataset.ogreAgentQuick||"";if(g==="positions"&&Gt({type:"open_tab",tab:"positions"}),g==="whats_cooking"&&bt("whats cooking"),g==="my_bags"&&bt("how are my bags"),g==="refresh_feeds"&&Gt({type:"refresh_feeds"}),g==="risk"&&bt("Why is this token risky?"),g==="dev_info"&&bt("Explain Dev Info for this token."),g==="protected_buy"&&bt("Should I use Protected Buy?"),g==="replay"&&bt("Replay similar launches for this token."),g==="auto_trade"&&Gt({type:"approve_agent_auto_trade"}),g==="clear_chat"){jt(),bo(),n.ogreAgentMessages=[sm()],n.ogreAgentStatus="Chat cleared.",n.ogreAgentDraft="",n.ogreAgentLastTokenMint="";try{localStorage.removeItem(Ml),localStorage.removeItem(Bl)}catch{}E({force:!0})}return}if(l.matches("[data-ogre-agent-retry]")){const g=Number(l.dataset.ogreAgentRetry),$=String(n.ogreAgentMessages?.[g]?.retryText||"").trim();$&&bt($);return}if(l.matches("[data-ogre-agent-action]")){const g=l.dataset.ogreAgentAction,C=QS(g)||(n.ogreAgentMessages||[]).flatMap(B=>Array.isArray(B.actions)?B.actions:[]).find(B=>B.key===g||B.label===g||B.type===g);Gt(C||{type:g});return}if(l.matches("[data-nav-route]")){e.preventDefault(),Pe(l.dataset.navRoute||"/terminal",l.dataset.tab||null);return}if(l.matches("[data-policy]")){e.preventDefault(),window.alert(Wf(l.dataset.policy==="privacy"?"privacy":"terms"));return}if(l.matches("[data-top-wallet-connect]")){e.preventDefault(),l.dataset.walletState==="connected"||!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey||n.wallets.length)?Pe("/terminal","wallets"):pa({returnPath:"/terminal"});return}if(l.matches("[data-top-wallet-status]")){e.preventDefault(),await Dh();return}if(l.matches("[data-top-refresh-wallet]")){const g=L();Xa("clicked",{startedAt:g}),W({component:"ui-action",action:"position-refresh-click-to-state",durationMs:L()-g,details:"top-refresh-wallet"}),St({force:!0,deep:!1,reason:"manual_header_click"}).then(()=>{Sy()&&ne(()=>Xi())}).catch($=>T($.message));return}if(l.matches("[data-ogre-tek-refresh]")){await Cr({force:!0}).catch(g=>T(g.message));return}if(l.matches("[data-ogre-ai-start]")){ne(()=>av());return}const d=l.closest?.("[data-ogre-cat]");if(d){e.preventDefault(),n.ogreAiCategory=d.dataset.ogreCat||"strong",h({force:!0});return}if(l.closest?.("[data-autopilot-save]")){e.preventDefault(),ne(()=>sv());return}if(l.matches("[data-ogre-tek-market]")){n.ogreTek.selectedMarket=l.dataset.ogreTekMarket||n.ogreTek.selectedMarket,n.ogreTek.reviewOpen=!1,h({force:!0});return}if(l.matches("[data-ogre-tek-side]")){n.ogreTek.direction=l.dataset.ogreTekSide==="short"?"short":"long",n.ogreTek.reviewOpen=!1,h({force:!0});return}if(l.matches("[data-ogre-tek-review]")){ho(),n.ogreTek.reviewOpen=!0,n.ogreTek.riskAccepted=!1,h({force:!0});return}if(l.matches("[data-ogre-tek-close-review]")){n.ogreTek.reviewOpen=!1,n.ogreTek.riskAccepted=!1,h({force:!0});return}if(l.matches("[data-ogre-tek-confirm-review]")){ho();const g=am();!n.ogreTek.riskAccepted||!g.ok?n.ogreTek.status="Risk confirmation is incomplete.":Ae.demoMode?(n.ogreTek.status="Demo review confirmed. No live transaction was submitted.",n.ogreTek.reviewOpen=!1,n.ogreTek.riskAccepted=!1):(n.ogreTek.status="Live perps adapter is not wired in this build.",n.ogreTek.reviewOpen=!1,n.ogreTek.riskAccepted=!1),h({force:!0});return}if(l.matches("[data-ogre-tek-demo-action]")){const g=l.dataset.ogreTekDemoAction||"action";n.ogreTek.status=`Demo mode: ${g.replace(/-/g," ")} is staged for the real provider adapter. No transaction was submitted.`,h({force:!0});return}if(l.matches("[data-toggle-terminal-ticket]")){n.terminalTradeCollapsed=!n.terminalTradeCollapsed,h({force:!0});return}if(l.matches("[data-global-token-open]")){const g=m("[data-global-token-search]")?.value?.trim()||"";g&&zu(g);return}if(l.matches("[data-token-chart]")){e.preventDefault();const g=l.dataset.tokenChart||l.dataset.previewToken||"";$t(ve(l.dataset.tokenChart||l.dataset.previewToken||"",{source:l.dataset.tokenChartSource||"token-card"}),{defaultTab:l.dataset.tokenChartTab||"buy",view:"chartTxns",focusAmountInput:!!l.closest?.(".live-pair-avatar"),source:l.dataset.tokenChartSource||"token-card"});return}if(l.matches("[data-token-trade]")){e.preventDefault(),e.stopPropagation();const g=l.dataset.tokenTrade||"",$=fn(g);$&&Hs($)&&T("Risk flagged. Opening chart review first; fast buy safety checks still apply before any wallet prompt."),$t(ve(l.dataset.tokenTrade||"",{source:l.dataset.tokenTradeSource||"trade-button"}),{defaultTab:"buy",view:"chartTxns",focusAmountInput:!0,source:l.dataset.tokenTradeSource||"trade-button"});return}if(l.matches("[data-quick-buy-token]")){e.preventDefault(),e.stopPropagation(),mn(ve(l.dataset.quickBuyToken||"",{source:l.dataset.quickBuySource||"quick-buy-button"}),{source:l.dataset.quickBuySource||"quick-buy-button"});return}if(l.matches("[data-protected-buy-open]")){e.preventDefault(),e.stopPropagation(),l.closest("[data-dev-info-drawer-root]")&&vl();const g=l.dataset.protectedBuySource||"protected-buy",$=!!l.closest("[data-quick-buy-modal-root]"),C=!!l.closest(".chart-trade-panel"),B=l.dataset.protectedBuyOpen||n.quickBuyModal?.tokenMint||n.smartChartToken||n.tradeToken||"";fv(ve(B,{source:g}),{source:g,presetId:l.dataset.protectedBuyPreset||"",amountSol:$?m("[data-quick-buy-modal-amount]")?.value||n.quickBuyModal?.amountSol||"":C&&m("[data-chart-buy-amount]")?.value||"",walletIndex:$?m("[data-quick-buy-modal-wallet]")?.value||n.quickBuyModal?.walletIndex||"":C&&m("[data-chart-buy-wallet]")?.value||"",slippageBps:$?m("[data-quick-buy-modal-slippage]")?.value||n.quickBuyModal?.slippageBps||"400":C&&m("[data-chart-buy-slippage]")?.value||"400"});return}if(l.matches("[data-quick-buy-close]")){e.preventDefault(),nl();return}if(l.matches("[data-protected-buy-close]")){e.preventDefault(),Ws();return}if(l.matches("[data-protected-buy-confirm]")){e.preventDefault(),ne(()=>bv());return}if(l.matches("[data-quick-buy-modal-preset]")){e.preventDefault(),n.quickBuyModal={...n.quickBuyModal,amountSol:l.dataset.quickBuyModalPreset||"",status:`${l.dataset.quickBuyModalPreset||""} SOL selected.`,error:""},h({force:!0});return}if(l.matches("[data-quick-buy-confirm]")){e.preventDefault(),ne(()=>wv());return}if(l.matches("[data-preview-token]")){const g=l.dataset.previewToken||"";g&&$t(ve(g,{source:"preview-card"}),{defaultTab:"chart",source:"preview-card"});return}if(l.matches("[data-terminal-subtab]")){n.terminalSubtab=l.dataset.terminalSubtab||"positions",h();return}if(l.matches("[data-position-sell]")){e.preventDefault(),e.stopPropagation(),await Ds(l.dataset.positionSell||"",l.dataset.positionSellPercent||"100",{slippageBps:n.activeTab==="smartChart"&&m("[data-chart-buy-slippage]")?.value||"400"});return}if(l.matches("[data-position-sell-custom]")){e.preventDefault(),e.stopPropagation();const g=await Me({title:"Custom Sell",input:{label:"Sell what percent of this position?",value:"100",type:"text",inputmode:"numeric"},confirmLabel:"Sell"});g&&await Ds(l.dataset.positionSellCustom||"",g,{slippageBps:n.activeTab==="smartChart"&&m("[data-chart-buy-slippage]")?.value||"400"});return}if(l.matches("[data-run-tx-audit]")){e.preventDefault(),ne(()=>Sv());return}if(l.matches("[data-connect-login-toggle]")){$m(l)||Pc({connectPanel:!0,source:"connect-lock-in"});return}if(l.matches("[data-login-tab]")){n.loginModalTab=l.dataset.loginTab==="create"?"create":"login",h({force:!0}),kc(!1);return}if(l.matches("[data-connect-password-login]")){await Fc();return}if(l.matches("[data-send-email-code]")){await eh();return}if(l.matches("[data-web-code-login]")){await th();return}if(l.matches("[data-connect-create-account]")){await di();return}if(l.matches("[data-connect-create-wallet]")){await oh();return}if(l.matches("[data-web-signup]")&&await di(),l.matches("[data-web-password-login]")&&await Fc(),l.matches("[data-close-login]")){$c();return}if(l.matches("[data-web-signup-connect]")){await sh();return}if(l.matches("[data-open-login]")){$m(l)||Pc({connectPanel:n.route==="connect",source:"top-lock-in"});return}if(l.matches("[data-browse-guest]")){n.loginCollapsed=!0,n.route="terminal",n.activeTab="terminal",window.history.pushState({},"","/terminal"),h(),Yr("browse-terminal");return}if(l.matches("[data-logout]")&&await ih(),l.matches("[data-connect-x]")&&await Iy(),l.matches("[data-open-x-login]")&&Oy(),l.matches("[data-clear-x]")&&await Ey(),l.matches("[data-save-login-credentials]")&&await Ny(),l.matches("[data-save-referral]")&&await Yu(),l.matches("[data-generate-referral-code]")&&await Yu({generate:!0}),l.matches("[data-save-trader-board]")&&await Pv(),l.matches("[data-use-x-avatar]")&&await _y(),l.matches("[data-clear-avatar]")&&await xs({clear:!0},"Removing PFP..."),l.matches("[data-preset-avatar]")){const g=m("[data-avatar-status]");S(g,"Loading preset PFP...");try{const $=await Wy(l.dataset.presetAvatar);await xs({avatarDataUrl:$,avatarSource:l.dataset.avatarLabel||"preset"},"Saving preset PFP...")}catch($){S(g,$.message),T($.message)}}if(l.matches("[data-launch-coin-save]")){sr();return}if(l.matches("[data-launch-coin-submit]")){await ny();return}if(l.matches("[data-launch-coin-use-ca]")){await Zb();return}if(l.matches("[data-connect-wallet]")){const g=l.dataset.connectWallet||"solana";if(g&&g!=="solana"){await Cu(g,{returnPath:"/terminal"});return}pa({returnPath:"/terminal"});return}if(l.matches("[data-connect-wallet-provider]")){await Cu(l.dataset.connectWalletProvider||"solana",{returnPath:"/terminal"});return}if(l.matches("[data-wallet-connect-close]")){n.walletConnectMenuOpen=!1,h({force:!0});return}if(l.matches("[data-wallet-fast-approvals-toggle]")){yg(!n.walletFastApprovalsEnabled),T(n.walletFastApprovalsEnabled?"Fast approvals on. SlimeWire will open wallet prompts immediately, but Phantom/Solflare still require approval.":"Fast approvals off. Browser wallet trades still require wallet approval."),h({force:!0});return}if(l.matches("[data-disconnect-wallet]")){await Lu();return}if(l.matches("[data-share-x]")&&Yi(l.dataset.shareText||""),l.matches("[data-share-watch-token-btn]")&&xu("token"),l.matches("[data-share-watch-kol-btn]")&&xu("kol"),l.matches("[data-save-preset]")){await Xu(l.dataset.savePreset);return}if(l.matches("[data-save-fast-preset]")){await Xu(l.dataset.saveFastPreset,"fast");return}if(l.matches("[data-use-preset]")){Tv(l.dataset.usePreset,l.dataset.presetId||"");return}if(l.matches("[data-edit-preset]")){Ju(l.dataset.editPreset,l.dataset.presetId||"");return}if(l.matches("[data-edit-selected-preset]")){const g=l.dataset.editSelectedPreset==="bundle"?"bundle":"trade",$=g==="bundle"?n.selectedBundlePresetId:n.selectedTradePresetId;$&&$!=="custom"?Ju(g,$):$l(g);return}if(l.matches("[data-cancel-preset-edit]")){hs(l.dataset.cancelPresetEdit,""),h();return}if(l.matches("[data-delete-preset]")){await Av(l.dataset.deletePreset,l.dataset.presetId||"");return}if(l.matches("[data-quick-trade-token]")){e.preventDefault(),e.stopPropagation(),mn(ve(l.dataset.quickTradeToken||"",{source:"legacy-quick-trade"}),{source:"legacy-quick-trade"});return}if(l.matches("[data-quick-bundle-token]")){e.preventDefault(),e.stopPropagation(),ne(()=>Gu(l.dataset.quickBundleToken||""));return}if(l.matches("[data-smart-chart-token]")){$t(ve(l.dataset.smartChartToken||"",{source:"chart-button"}),{defaultTab:"chart",source:"chart-button"});return}if(l.matches("[data-smart-chart-view]")){const g=l.dataset.smartChartView||"chart";n.smartChartView=["chart","chartTxns","txns","info"].includes(g)?g:"chart",h();return}if(l.matches("[data-chart-trade-tab]")){n.chartTradeTab=l.dataset.chartTradeTab==="sell"?"sell":"buy",h({force:!0,preserveSmartChartFrame:!0}),n.chartTradeTab==="buy"&&requestAnimationFrame(()=>m("[data-chart-buy-amount]")?.focus());return}if(l.matches("[data-chart-buy-preset]")){const g=m("[data-chart-buy-amount]");g&&(g.value=l.dataset.chartBuyPreset||""),n.quickBuyAmountOverride=Y(l.dataset.chartBuyPreset||""),Zs();return}if(l.matches("[data-chart-confirm-buy]")){const g=l.dataset.chartConfirmBuy||n.smartChartToken||"";e.preventDefault(),e.stopPropagation();const $=m("[data-chart-buy-wallet]")?.value||"";if(pe($)){try{l.dataset.actionState="clicked",l.disabled=!0,await vv(g)}catch(C){const B=N(C.message||"Chart buy failed."),U=Y(m("[data-chart-buy-amount]")?.value||"")||"custom";z("trade-buy",g,String(U),{state:"error",error:B}),Le("trade-buy",g,String(U),4e3),Ne(B),T(B),de()}return}Ne("Buy queued. Opening wallet approval..."),l.dataset.actionState="clicked",l.disabled=!0,ne(async()=>{try{const C=Nu();await _s({tokenMint:g,walletIndex:$,amountSol:Y(m("[data-chart-buy-amount]")?.value||""),slippageBps:m("[data-chart-buy-slippage]")?.value||"400",takeProfitPct:C.takeProfitPct,stopLossPct:C.stopLossPct,sellDelay:C.sellDelay,sellPercent:C.sellPercent,source:"chart-buy-panel"}),n.chartTradeTab="buy",Ne("Buy submitted. Refreshing position..."),h({force:!0,preserveSmartChartFrame:!0})}catch(C){const B=N(C.message||"Chart buy failed.");Ne(B),T(B),h({force:!0,preserveSmartChartFrame:!0})}});return}if(l.matches("[data-chart-confirm-sell]")){e.preventDefault(),e.stopPropagation();const g=m("[data-chart-sell-percent]")?.value||"";if(g)try{await Ds(l.dataset.chartConfirmSell||"",g,{slippageBps:m("[data-chart-buy-slippage]")?.value||"400"})}catch($){const C=N($.message||"Chart sell failed.");Ne(C),T(C)}return}if(l.matches("[data-smart-chart-open]")){const g=String(m("[data-smart-chart-input]")?.value||"").trim();if(!g){T("Paste a token CA first.");return}$t(ve(g,{source:"smart-chart-search"}),{defaultTab:"buy",focusAmountInput:!0,source:"smart-chart-search"});return}if(l.matches("[data-refresh-feeds]")){ne(()=>en({force:!0,reason:"manual-refresh-feeds"}));return}if(l.matches("[data-terminal-load-more]")){const g=l.dataset.terminalLoadMore||n.activeTab;uh(g,Wt(g)),Xc(g,{requestId:j(g).lastRequestId||"",status:j(g).lastStatus||"render",reason:"load-more",resultCount:Wt(g),renderedCount:Vn(g),hasMore:Wt(g)>Vn(g),stale:zn(g),errorCode:j(g).errorCode||"",errorMessage:j(g).errorMessage||""}),h({force:!0});return}if(l.matches("[data-dev-info]")){e.preventDefault(),e.stopPropagation(),Ww(l.dataset.devInfo||"");return}if(l.matches("[data-radar-open]")){e.preventDefault(),Dw(l.dataset.radarOpen||"",l.dataset.radarSymbol||"");return}if(l.matches("[data-radar-close]")){Uw();return}if(l.matches("[data-radar-submit]")){e.preventDefault(),Hw();return}if(l.matches("[data-radar-toggle]")){e.preventDefault(),_p("toggle",l.dataset.radarToggle||"");return}if(l.matches("[data-radar-remove]")){e.preventDefault(),_p("remove",l.dataset.radarRemove||"");return}if(l.matches("[data-dev-info-tab]")){e.preventDefault();const g=l.dataset.devInfoTab||"overview";n.devInfoTab=g;const $=l.closest(".dossier-drawer");$&&($.setAttribute("data-active-pane",g),$.querySelectorAll("[data-dev-info-tab]").forEach(C=>{C.dataset.active=C.dataset.devInfoTab===g?"true":"false"}));return}if(l.matches("[data-dev-info-close]")){vl();return}if(l.matches("[data-dev-info-refresh]")){const g=l.dataset.devInfoRefresh||n.devInfoDetails?.tokenMint||"";await Wp(g,{force:!0});return}if(l.matches("[data-watch-token]")&&await Qu("add",l),l.matches("[data-unwatch-token]")&&await Qu("remove",l),l.matches("[data-pnl-card]"))try{await Bu(l.dataset.pnlCard)}catch(g){T(g.message)}if(l.matches("[data-share-pnl-card]")&&await Dy(l.dataset.sharePnlCard,l.dataset.shareText||""),l.matches("[data-scan-bags]")){await qv();return}if(l.matches("[data-arm-exits]")){await Uv(l.dataset.armExits,l);return}if(l.matches("[data-dev-watch]")){await Dv(l.dataset.devWatch);return}if(l.matches("[data-hype-create]")){await zb();return}if(l.matches("[data-push-enable]")){await lg();return}if(l.matches("[data-push-disable]")){await cg();return}if(l.matches("[data-call-post]")){await aS(l.dataset.callPost);return}if(l.matches("[data-telegram-link]")){await og();return}if(l.matches("[data-trade-trace-close]")){n.tradeTrace=null,ko();return}if(l.matches("[data-launch-kit-close]")){n.launchShareKit=null,h();return}if(l.matches("[data-create-wallets]")&&await Au(),l.matches("[data-distribute-fresh]")){await xb();return}if(l.matches("[data-return-funds]")){await Lb();return}if(l.matches("[data-sweep-background-wallets]")){await Rv();return}if(l.matches("[data-create-automation-wallet]")&&await gy(),l.matches("[data-create-session-wallet]")){e.preventDefault(),e.stopPropagation(),await vy(l);return}if(l.matches("[data-tpsl-status-button]")){l.dataset.tpslState==="enabled"?(n.activeTab="profile",Pe("/terminal","profile"),n.automationDelegationStatus=n.automationDelegationStatus||"Server exits are enabled for managed wallets.",h({force:!0})):await Gi("enable");return}if(l.matches("[data-automation-permission]")&&await Gi(l.dataset.automationPermission||"enable"),l.matches("[data-run-trade-plans]")&&await Xi(),l.matches("[data-restore-backup]")&&await Ty(),l.matches("[data-export-backup]")&&await Ay(),l.matches("[data-import-wallet]")&&await Py(),l.matches("[data-remove-wallet]")&&await Cy(l.dataset.removeWallet||"",l.dataset.walletLabel||"",l.dataset.removeWalletKey||""),l.matches("[data-wallet-sweep-action]")&&await By(l.dataset.walletSweepAction||""),l.matches("[data-download]")){const g=n.downloads?.[l.dataset.download];g&&be(g.filename,g.text)}if(l.matches("[data-trade-buy-quick]")&&await Rs(l.dataset.tradeBuyQuick),l.closest?.("[data-swap-reverse]")){n.swapDirection=n.swapDirection==="sell"?"buy":"sell",h({force:!0});return}if(l.matches("[data-swap-use-custom-amount]")){const g=String(m("[data-swap-amount]")?.value||"").trim();n.swapDirection==="sell"?await Zi(g||"100"):await Rs(g);return}l.matches("[data-trade-buy-max]")&&await Rs(null,"max"),l.matches("[data-trade-buy-custom]")&&await Rs(m("[data-buy-custom]")?.value||m("[data-swap-amount]")?.value),l.matches("[data-trade-sell-quick]")&&await Zi(l.dataset.tradeSellQuick),l.matches("[data-trade-sell-custom]")&&await Zi(m("[data-sell-custom]")?.value||m("[data-swap-amount]")?.value),l.matches("[data-trade-plan-start]")&&await Jy(),l.matches("[data-volume-start]")&&await Qy();const u=l.closest?.("[data-vbot-set-mode]");if(u){e.preventDefault(),n.slimeBotMode=u.dataset.vbotSetMode||"smart",u.parentElement?.querySelectorAll("[data-vbot-set-mode]").forEach(g=>{g.dataset.active=String(g===u)});return}const p=l.closest?.("[data-vbot-set-aggr]");if(p){e.preventDefault(),n.slimeBotAggr=p.dataset.vbotSetAggr||"med",p.parentElement?.querySelectorAll("[data-vbot-set-aggr]").forEach(g=>{g.dataset.active=String(g===p)});return}const f=l.closest?.("[data-vbot-set-stagger]");if(f){e.preventDefault(),n.slimeBotStagger=f.dataset.vbotSetStagger||"steady",f.parentElement?.querySelectorAll("[data-vbot-set-stagger]").forEach(g=>{g.dataset.active=String(g===f)});return}if(l.matches("[data-vbot-start]")){e.preventDefault(),await Fb();return}const y=l.closest?.("[data-vbot-stop]");if(y){e.preventDefault(),await Wb(y.dataset.vbotStop||"");return}if(l.matches("[data-sniper-buy]")&&await ev(l.dataset.sniperBuy),l.matches("[data-kol-mode]")){n.kolWallet="",n.kolMode=l.dataset.kolMode||n.kolMode,Z("kol"),await te("kol",{force:!0,reason:"kol-mode-switch"}).catch(g=>T(g.message));return}if(l.matches("[data-kol-refresh]")){await te("kol",{force:!0,reason:"manual-kol-refresh"}).catch(g=>T(g.message));return}if(l.matches("[data-kol-wallet-scan]")){if(n.kolWallet=String(m("[data-kol-wallet]")?.value||"").trim(),n.kolWallet&&!Dt(n.kolWallet)){Ht("That is not a valid Solana public wallet. Paste a real wallet address before scanning."),n.kolWallet="";return}Z("kol"),await te("kol",{force:!0,reason:"kol-wallet-scan"}).catch(g=>T(g.message));return}if(l.matches("[data-kol-scan-wallet]")){if(n.kolWallet=String(l.dataset.kolScanWallet||"").trim(),n.kolWallet&&!Dt(n.kolWallet)){Ht("This curated KOL profile does not have a verified Solana wallet yet, so Scan is locked."),n.kolWallet="";return}Z("kol"),await te("kol",{force:!0,reason:"kol-signal-wallet-scan"}).catch(g=>T(g.message));return}if(l.matches("[data-kol-copy-setup]")){const g=String(l.dataset.kolCopySetup||"").trim();if(g&&!Dt(g)){Ht("This curated KOL profile does not have a verified Solana wallet yet, so Copy Setup is locked.");return}g&&(n.kolWallet=g),n.activeTab="kol",h(),setTimeout(()=>{const $=document.querySelector("[data-kol-management-settings]");$&&($.open=!0,$.scrollIntoView({behavior:"smooth",block:"start"}));const C=m("[data-kol-wallet]");C&&g&&(C.value=g);const B=m("[data-kol-status]");B&&S(B,`Copy setup loaded for ${w(g)}. Choose presets, then tap Copy Wallet Next Buy.`),m("[data-kol-amount]")?.focus?.({preventScroll:!0})},40);return}if(l.matches("[data-kol-copy]")){await lv(l.dataset.kolCopy);return}if(l.matches("[data-kol-copy-wallet]")){const g=String(l.dataset.kolCopyWallet||"").trim();if(g&&!Dt(g)){Ht("That KOL entry does not have a verified Solana wallet yet.");return}await cv(l.dataset.kolCopyWallet||"");return}if(l.matches("[data-kol-trade]")){n.tradeToken=l.dataset.kolTrade||"",n.activeTab="trade",h();return}if(l.matches("[data-kol-bundle]")){n.bundleToken=l.dataset.kolBundle||"",n.activeTab="bundle",h();return}if(l.matches("[data-bundle-buy]")&&await Hu("buy"),l.matches("[data-bundle-sell]")&&await Hu("sell"),l.matches("[data-bundle-plan]")&&await uv(),l.matches("[data-launch-start]")&&await Lv(),l.matches("[data-launch-cancel]")&&await xv(l.dataset.launchCancel),l.matches("[data-use-token]")&&(n.tradeToken=l.dataset.useToken||"",n.volumeToken=l.dataset.useToken||"",n.bundleToken=l.dataset.useToken||"",n.activeTab="trade",h()),l.matches("[data-use-token-bundle]")&&(n.bundleToken=l.dataset.useTokenBundle||"",n.tradeToken=n.bundleToken,n.volumeToken=n.bundleToken,n.activeTab="bundle",h()),l.matches("[data-use-token-volume]")&&(n.volumeToken=l.dataset.useTokenVolume||"",n.tradeToken=n.volumeToken,n.bundleToken=n.volumeToken,n.activeTab="volume",h()),l.matches("[data-refresh-all]")){const g=L();if(Xa("clicked",{startedAt:g}),W({component:"ui-action",action:"position-refresh-click-to-state",durationMs:L()-g,details:n.activeTab||"terminal"}),!n.user||!n.token)Xe(n.activeTab)?await te(n.activeTab,{force:!0,reason:"manual-refresh-all"}).catch($=>T($.message)):T("Browsing is open. Create or connect a profile when you want saved wallets, balances, or trades."),je("success");else{const $=L();n.activeTab==="positions"?dh({force:!0,reason:"manual-positions-refresh"}).catch(C=>{je("error",{error:N(C?.message||"Position refresh failed")}),T(C.message),h()}):(St({force:!0,deep:!1,reason:"manual_refresh_all"}).catch(C=>T(C.message)),te(n.activeTab,{force:!0,reason:"manual-refresh-all"}).catch(C=>T(C.message))),K("position-refresh-request-start",$,{component:"positions",cacheHit:!1,details:n.activeTab||"terminal"})}}if(l.matches("[data-tab]")){const g=L();if(n.activeTab=l.dataset.tab,n.activeTab==="volume"&&vs(),n.activeTab==="ogreAi"&&nv(),n.activeTab==="ogreTek"){n.route="terminal",window.history.pushState({},"","/ogre-tek"),await Cr({silent:!0}).catch(B=>T(B.message)),h();return}n.route!=="terminal"&&(n.route="terminal",window.history.pushState({},"","/terminal")),n.activeTab==="smartChart"?window.history.pushState({},"","/terminal/chart"):n.activeTab==="slimeScope"?window.history.pushState({},"","/terminal/slime-scope"):(window.location.pathname.includes("/terminal/chart")||window.location.pathname.includes("/terminal/slime-scope"))&&window.history.pushState({},"","/terminal");const $=Gc(n.activeTab);h();const C=te(n.activeTab,{silent:!0,ifStale:!0,force:!$,reason:"tab-switch"}).catch(B=>T(B.message));$||await C,K("tab-switch",g,{component:"terminal",cacheHit:$,details:n.activeTab})}if(l.matches("[data-refresh-scan]")&&ne(()=>te("sniper",{force:!0,reason:"manual-sniper-refresh"})),l.closest?.("[data-refresh-live-pairs]")){const g=n.activeTab==="slimeScope"?"slimeScope":n.activeTab==="terminal"?"terminal":n.activeTab==="launch"||n.activeTab==="launchCoin"?"launch":"live",C=n.activeTab==="live"||n.activeTab==="terminal"?null:Ci();ne(async()=>{await te(g,{force:!0,reason:"manual-live-refresh",renderStart:!1,userInitiated:!0}),C&&Li(C)})}if(l.closest?.("[data-terminal-filter-toggle]")){const g=Re();g.open=!g.open,h();return}if(l.closest?.("[data-terminal-filter-clear]")){n.terminalLaunchFilters={open:!0,keywords:"",excludeKeywords:"",socials:{},quotes:{},audits:{}},Z("live"),Z("launch"),Z("sniper"),h();return}l.matches("[data-refresh-watchlist]")&&ne(()=>te("watchlist",{force:!0,reason:"manual-watchlist-refresh"}));const v=l.closest?.("[data-live-pair-bucket]");v&&(n.livePairBucket=v.dataset.livePairBucket||"live",n.livePairs=qe(),n.livePairsLastUpdatedAt=da(),Z("live"),Z("slimeScope"),h(),ne(()=>te(n.activeTab==="terminal"?"terminal":"live",{force:!0,reason:"live-bucket-switch"})));const P=l.closest?.("[data-slime-scope-mode]");P&&(n.slimeScopeMode=P.dataset.slimeScopeMode||"new",n.activeTab="slimeScope",Z("slimeScope"),h(),ne(()=>te("slimeScope",{force:!0,reason:"slime-scope-mode-switch"}))),l.matches("[data-scan-mode]")&&(Z("sniper"),n.scanMode=l.dataset.scanMode||n.scanMode,h(),ne(()=>Gn(n.scanMode)));const A=l.getAttribute("data-copy");if(A){const g=l.getAttribute("data-copy-label")||l.textContent||"Copy";await navigator.clipboard.writeText(A),S(l,"Copied"),setTimeout(()=>{S(l,g)},1e3)}}),document.addEventListener("keydown",e=>{if(e.key==="Escape"){if(n.replayDetails?.open){kl();return}if(n.kolDumpDetails?.open){ji();return}if(n.protectedBuyModal?.open){Ws();return}if(n.quickBuyModal?.open){nl();return}if(n.walletConnectMenuOpen){n.walletConnectMenuOpen=!1,h({force:!0});return}n.loginCollapsed||(n.loginCollapsed=!0,h({force:!0}))}}),document.addEventListener("change",async e=>{const t=e.target;if(t?.matches?.("[data-vbot-autocreate]")){const a=document.querySelector("[data-vbot-manual-wallets]");a&&(a.hidden=!!t.checked)}if(t?.matches?.("[data-vbot-keepdust]")&&(n.slimeBotKeepDust=!!t.checked),t?.matches?.("[data-vbot-offset]")&&(n.slimeBotOffset=!!t.checked),t?.matches?.("[data-vbot-rolling]")){const a=!!t.checked;document.querySelectorAll("[data-vbot-pool-only]").forEach(s=>{s.style.display=a?"none":""});const r=document.querySelector("[data-vbot-manual-wallets]");r&&(r.hidden=a||!!document.querySelector("[data-vbot-autocreate]")?.checked)}if(t?.matches?.("[data-custom-select]")&&(bs(),Ab(t)),t?.matches?.("[data-swap-from]")){const a=We(t.value||"SOL")||"SOL";n.tradeSwapFrom=a,a!=="SOL"?(n.tradeToken=a,n.tradeSwapTo="SOL"):We(n.tradeSwapTo||n.tradeToken||"")||(n.tradeSwapTo=""),h({force:!0});return}if(t?.matches?.("[data-swap-to]")){const a=We(t.value||"");if(n.tradeSwapTo=a,a&&a!=="SOL"){n.tradeToken=a,n.swapDirection="buy";const r=m("[data-trade-token]");r&&(r.value=a)}a||m("[data-trade-token]")?.focus?.({preventScroll:!0}),h({force:!0});return}if(t?.matches?.("[data-chart-buy-wallet]")){n.chartBuyWalletIndex=String(t.value||"");return}if(t?.matches?.("[data-fast-trade-preset]")){const a=t.value||"";if(a==="custom"){$l("trade");return}if(n.selectedTradePresetId=a,n.fastTradePresetStatus=n.selectedTradePresetId?"Trade preset selected. Tap Trade or Buy on a token row to use it.":"No fast trade preset selected. Token rows open the manual Trade form.",(t.dataset.fastTradePreset||"")==="chart-panel"){const r=le("trade",n.selectedTradePresetId);n.chartBuyWalletIndex="",r?.amountSol&&(n.quickBuyAmountOverride=Y(r.amountSol)),n.chartTradeStatus=r?`${r.name||"Preset"} loaded.`:"",h({force:!0,preserveSmartChartFrame:!0});return}h()}if(t?.matches?.("[data-quick-buy-amount]")&&(n.quickBuyAmountOverride=Y(t.value),t.value=n.quickBuyAmountOverride,Zs()),t?.matches?.("[data-protected-buy-preset], [data-protected-buy-wallet], [data-protected-buy-slippage], [data-protected-buy-risk-accept], [data-protected-buy-amount]")&&(n.protectedBuyModal={...n.protectedBuyModal||{},presetId:m("[data-protected-buy-preset]")?.value||n.protectedBuyModal?.presetId||"conservative",walletIndex:m("[data-protected-buy-wallet]")?.value||n.protectedBuyModal?.walletIndex||"",amountSol:Y(m("[data-protected-buy-amount]")?.value||n.protectedBuyModal?.amountSol||""),slippageBps:m("[data-protected-buy-slippage]")?.value||n.protectedBuyModal?.slippageBps||"400",riskAccepted:!!m("[data-protected-buy-risk-accept]")?.checked},rl()),t?.matches?.("[data-fast-bundle-preset]")){const a=t.value||"";if(a==="custom"){$l("bundle");return}n.selectedBundlePresetId=a,n.fastBundlePresetStatus=n.selectedBundlePresetId?"Bundle preset selected. It will not buy until you tap a Bundle button.":"No fast bundle preset selected. Bundle rows open the manual Bundle form.",h()}if(t?.matches?.("[data-terminal-sort]")&&(n.terminalSort=t.value||"best",n.terminalCat="",Z("live"),Z("slimeScope"),es()),t?.matches?.("[data-live-feed-category]")){n.liveFeedCategory=t.value||"best";try{localStorage.setItem("liveFeedCategory",n.liveFeedCategory)}catch{}n.terminalSort=so()[3]||"best",n.terminalCat=so()[0]||"",Z("live"),es()}if(t?.matches?.("[data-live-terminal-category]")){n.liveTerminalCategory=t.value||"dexTrending";try{localStorage.setItem("liveTerminalCategory",n.liveTerminalCategory)}catch{}n.terminalSort=lo()[3]||"volume",n.terminalCat=lo()[0]||"",Z("live"),es()}if(t?.matches?.("[data-cook-spot-category]")){n.cookSpotCategory=t.value||"dexTrending";try{localStorage.setItem("cookSpotCategory",n.cookSpotCategory)}catch{}n.terminalSort=Ar()[3]||"volume",n.terminalCat=Ar()[0]||"",Z("slimeScope"),es(()=>te("slimeScope",{force:!0,reason:"cook-spot-category"}))}if(t?.matches?.("[data-launch-coin-image]")){const a=t.files?.[0],r=m("[data-launch-image-preview-wrap]"),s=m("[data-launch-image-preview]"),o=m("[data-launch-image-preview-meta]");if(!a){r&&(r.hidden=!0);return}const c=Math.round(a.size/1024);o&&(o.textContent=`${a.name} · ${c>=1024?`${(c/1024).toFixed(1)} MB`:`${c} KB`} · saved with the sheet`);try{const l=URL.createObjectURL(a);s&&(s.onload=()=>URL.revokeObjectURL(l),s.src=l),r&&(r.hidden=!1)}catch{r&&(r.hidden=!0)}fu(a).then(l=>{if(n.launchCoinDraft={...n.launchCoinDraft||{},imageDataUrl:l,imageName:a.name,imageType:un(l,a.type||"application/octet-stream")},String(l).length<15e5)try{Oa(n.launchCoinDraft)}catch{}}).catch(()=>{});return}if(t?.matches?.("[data-launch-coin-banner]")){const a=t.files?.[0],r=m("[data-launch-banner-preview-wrap]"),s=m("[data-launch-banner-preview]"),o=m("[data-launch-banner-preview-meta]");if(!a){r&&(r.hidden=!0);return}const c=Math.round(a.size/1024);o&&(o.textContent=`${a.name} · ${c>=1024?`${(c/1024).toFixed(1)} MB`:`${c} KB`} · saved with the sheet`);try{const l=URL.createObjectURL(a);s&&(s.onload=()=>URL.revokeObjectURL(l),s.src=l),r&&(r.hidden=!1)}catch{r&&(r.hidden=!0)}hu(a).then(l=>{if(n.launchCoinDraft={...n.launchCoinDraft||{},bannerDataUrl:l,bannerName:a.name,bannerType:un(l,a.type||"image/jpeg")},String(l).length<15e5)try{Oa(n.launchCoinDraft)}catch{}}).catch(l=>{const d=m("[data-launch-coin-status]");d&&S(d,l?.message||"Could not read that banner.")});return}if(t?.matches?.("[data-terminal-filter-social], [data-terminal-filter-quote], [data-terminal-filter-audit]")){const a=Re(),r=t.getAttribute("data-terminal-filter-social"),s=t.getAttribute("data-terminal-filter-quote"),o=t.getAttribute("data-terminal-filter-audit");r&&(a.socials[r]=!!t.checked),s&&(a.quotes[s]=!!t.checked),o&&(a.audits[o]=!!t.checked),a.open=!0,Z("live"),Z("launch"),Z("sniper"),h()}t?.matches?.("[data-ogre-tek-field]")&&(ho(),n.ogreTek.reviewOpen=!1,h({force:!0})),t?.matches?.("[data-ogre-tek-risk-accepted]")&&(n.ogreTek.riskAccepted=!!t.checked,h({force:!0})),t?.matches?.("[data-restore-file]")&&await Ry(t),t?.matches?.("[data-avatar-file]")&&await Fy(t)}),document.addEventListener("focusout",()=>{setTimeout(sd,50)});let Ca=null;const Am=e=>{if(e.target?.closest?.(".launch-coin-card")&&String(e.target?.tagName||"").match(/INPUT|TEXTAREA|SELECT/)&&!e.target.matches("[data-launch-coin-image]")&&!e.target.matches("[data-launch-coin-banner]")){if(e.target.matches("[data-launch-coin-amount], [data-launch-coin-dev-buy-sol]")){const a=String(e.target.value||"");let r=a.replace(/[^0-9.]/g,"");const s=r.indexOf(".");if(s!==-1&&(r=r.slice(0,s+1)+r.slice(s+1).replace(/\./g,"")),r!==a){const o=e.target.selectionStart;e.target.value=r;try{e.target.setSelectionRange(o-(a.length-r.length),o-(a.length-r.length))}catch{}}}Ca&&clearTimeout(Ca),Ca=setTimeout(()=>{Ca=null,sr({silent:!0})},350)}};document.addEventListener("input",Am),document.addEventListener("change",Am),document.addEventListener("click",()=>{Ca&&(clearTimeout(Ca),Ca=null,sr({silent:!0}))},!0),document.addEventListener("input",e=>{const t=e.target;if(t?.matches?.("[data-quick-buy-amount]")){n.quickBuyAmountOverride=String(t.value||"").replace(/[^0-9.]/g,"").slice(0,12),Zs();return}if(t?.matches?.("[data-trade-token]")){const a=String(t.value||"").trim();n.tradeToken=a,n.tradeSwapTo=a;return}if(t?.matches?.("[data-terminal-filter-field]")){const a=t.getAttribute("data-terminal-filter-field"),r=Re();(a==="keywords"||a==="excludeKeywords")&&(r[a]=String(t.value||""),r.open=!0,wp());return}if(t?.matches?.("[data-launch-ticker]")){const a=Re();a.keywords=String(t.value||""),a.open=!0,wp();return}if(t?.matches?.("[data-smart-chart-zoom]")){n.smartChartZoom=Math.min(115,Math.max(60,Number(t.value)||72));const a=t.closest(".smart-chart-zoom")?.querySelector("strong");a&&S(a,`${n.smartChartZoom}%`);const r=t.closest(".smart-chart-main")?.querySelector(".smart-chart-frame");r&&r.style.setProperty("--smart-chart-scale",String(n.smartChartZoom/100));return}t?.matches?.("[data-ogre-tek-field]")&&(ho(),t.type==="range"&&h({force:!0}))});function Lr(e=null){if(document.hidden)return;const t=e?.persisted?"pageshow-bfcache":"visibility-return",a=id(t,{forcePaint:!0});sd(),!a&&e?.persisted&&n.route==="terminal"&&h({force:!0,preserveSmartChartFrame:n.activeTab==="smartChart"}),ra&&window.clearTimeout(ra),ra=window.setTimeout(()=>{if(ra=null,!(document.hidden||n.route!=="terminal")){if(Jn()){W({component:"post-trade",action:"hidden-feed-refresh-skipped",durationMs:0,requestId:n.postTradeRefresh?.attemptId||"",details:n.activeTab||"terminal"});return}te(n.activeTab,{silent:!0,ifStale:!0,force:!1,reason:"visibility-focus-return"}).catch(r=>T(r.message)),n.user&&n.token&&zn("positions")&&wt({force:!1,fast:!0,silent:!0,followUpValues:!0,reason:"visibility-position-resume",timeoutMs:Bo}).catch(()=>{}),ua(),jn(),as(),hi()}},Jl)}document.addEventListener("visibilitychange",()=>{if(document.hidden){(n.ogreAgentListening||n.ogreAgentSpeechRecognizer)&&jt("Voice input paused while tab was hidden.");return}const e=!!document.activeElement?.matches?.("[data-ogre-agent-input]");if(n.ogreAgentOpen&&(n.ogreAgentListening||n.ogreAgentLoading||e)){clearTimeout(appResumeTimer),appResumeTimer=setTimeout(()=>{!document.hidden&&!n.ogreAgentListening&&!n.ogreAgentLoading&&!document.activeElement?.matches?.("[data-ogre-agent-input]")&&Lr()},Jl+900);return}Lr()}),window.addEventListener("focus",Lr),window.addEventListener("pageshow",Lr),window.addEventListener("online",Lr),window.addEventListener("pagehide",()=>{ra&&(window.clearTimeout(ra),ra=null),n.clipFarm?.recording&&er()});function vk(){jo&&window.clearInterval(jo),jo=window.setInterval(()=>{document.hidden||id("watchdog")},Qm)}const wk=[{key:"live",label:"Live",items:[["terminal","Live Terminal"],["live","Cooks"],["liveTrades","Live Trades"]]},{key:"chart",label:"Swap & Chart",items:[["trade","Slime Swap"],["smartChart","Smart Chart"]]},{key:"intel",label:"Intel",items:[["slimeScope","Slime Scope"],["watchlist","Watchlist"],["kol","KOL Tracker"],["sniper","OgreSniper"],["txAudit","TP/SL Audit"]]},{key:"tools",label:"Ogre Tek",items:[["tek","Tek Hub"],["ogreAi","Ogre A.I."],["launchCoin","Pump Launch"],["bundle","Bundle"],["volume","SlimeBot"],["launch","Launch Watch"]]},{key:"portfolio",label:"Portfolio",items:[["wallets","Wallets"],["positions","Positions"],["pnl","PnL"],["raids","Raid Board","/raids"]]},{key:"profile",label:"Profile",items:[["profile","Home / Profile"]]}];function La(e,t){return t=t||"#8dff45",`<svg class="swampi" viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="1.5" y="1.5" width="21" height="21" rx="6.5" fill="${t}" fill-opacity="0.2" stroke="${t}" stroke-opacity="0.5" stroke-width="1.1"/><g stroke="${t}" stroke-width="1.95">${e}</g></svg>`}const Sk={terminal:"#46e8ff",live:"#8dff45",liveTrades:"#ffd24a",smartChart:"#72ff23",trade:"#3fe0d0",slimeScope:"#5ab0ff",watchlist:"#ffd24a",kol:"#ffcf5a",sniper:"#ff6b6b",txAudit:"#bbff63",tek:"#9fb6c2",ogreAi:"#b06bff",launchCoin:"#ff8a5a",bundle:"#ffa64d",volume:"#46e8ff",launch:"#9bff9b",wallets:"#ffd24a",positions:"#5ab0ff",pnl:"#72ff23",profile:"#8dff45"},xa={terminal:'<rect x="3" y="4" width="18" height="16" rx="2.5"/><path d="M7 9l3 3-3 3"/><path d="M13 15h4"/>',live:'<path d="M4 11h16"/><path d="M5 11a7 7 0 0 0 14 0"/><path d="M7 18l-1 2"/><path d="M17 18l1 2"/><path d="M10 7c0-1.3 1-1.3 1-2.5"/><path d="M14 8c0-1.3 1-1.3 1-2.5"/>',liveTrades:'<path d="M13 3L6 13h5l-1 8 8-11h-5z"/>',smartChart:'<path d="M3 17l5-5 4 3 8-9"/><path d="M16 6h4v4"/>',trade:'<path d="M4 8h13l-3-3"/><path d="M20 16H7l3 3"/>',slimeScope:'<circle cx="11" cy="11" r="6"/><path d="M11 5v2.5"/><path d="M11 14.5V17"/><path d="M5 11h2.5"/><path d="M14.5 11H17"/><circle cx="11" cy="11" r="1.2"/><path d="M15.5 15.5L20 20"/>',watchlist:'<path d="M12 4l2.3 4.7 5.2.8-3.8 3.6.9 5.1-4.6-2.4-4.6 2.4.9-5.1L4.3 9.5l5.2-.8z"/>',kol:'<path d="M4 8l3 9h10l3-9-5 4-3-6-3 6z"/><path d="M7 17h10"/>',sniper:'<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3.3"/><path d="M12 2v3"/><path d="M12 19v3"/><path d="M2 12h3"/><path d="M19 12h3"/>',txAudit:'<path d="M6 3h12v18l-3-2-3 2-3-2-3 2z"/><path d="M9 8h6"/><path d="M9 12h6"/>',tek:'<path d="M15 5a4 4 0 0 1-5.2 5L5 14.8 9.2 19l4.8-4.8a4 4 0 0 1 5-5.2l-2.7 2.7-2.3-.5-.5-2.3z"/>',ogreAi:'<path d="M5 10a7 5 0 0 1 14 0v3a5 5 0 0 1-5 5h-4a5 5 0 0 1-5-5z"/><path d="M4 8L2.5 6"/><path d="M20 8l1.5-2"/><circle cx="9.5" cy="11" r="1"/><circle cx="14.5" cy="11" r="1"/><path d="M9.5 15l-.7 2.5"/><path d="M14.5 15l.7 2.5"/>',launchCoin:'<path d="M12 3c3 2 5 6 5 10l-3 3h-4l-3-3c0-4 2-8 5-10z"/><circle cx="12" cy="10" r="1.6"/><path d="M9 17l-2 4"/><path d="M15 17l2 4"/>',bundle:'<path d="M12 3l8 4-8 4-8-4z"/><path d="M4 7v6l8 4 8-4V7"/><path d="M12 11v6"/>',volume:'<path d="M4 13v4"/><path d="M8 9v8"/><path d="M12 5v12"/><path d="M16 10v7"/><path d="M20 13v4"/>',launch:'<path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/>',wallets:'<rect x="3" y="6" width="18" height="13" rx="2.5"/><path d="M3 10h18"/><circle cx="17" cy="14" r="1.3"/>',positions:'<rect x="3" y="8" width="18" height="11" rx="2"/><path d="M8 8V6a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M3 13h18"/>',pnl:'<path d="M4 20V11"/><path d="M10 20V4"/><path d="M16 20v-7"/><path d="M21 20H3"/>',profile:'<path d="M5 12a7 6 0 0 1 14 0v2a5 5 0 0 1-5 5h-4a5 5 0 0 1-5-5z"/><circle cx="8" cy="8" r="2.2"/><circle cx="16" cy="8" r="2.2"/><path d="M9 14.5c1.2 1.4 4.8 1.4 6 0"/>',prelaunch:'<path d="M4 11h16"/><path d="M5 11a7 7 0 0 0 14 0"/><path d="M7 18l-1 2"/><path d="M17 18l1 2"/><path d="M10 7c0-1.3 1-1.3 1-2.5"/><path d="M14 8c0-1.3 1-1.3 1-2.5"/>',raids:'<path d="M5 4l9 9"/><path d="M19 4l-9 9"/><path d="M11 13l-4 7"/><path d="M13 13l4 7"/>'},Pm=Object.fromEntries(Object.entries(xa).map(([e,t])=>[e,La(t,Sk[e])])),kk={live:La(xa.live,"#8dff45"),chart:La(xa.trade,"#3fe0d0"),intel:La(xa.slimeScope,"#5ab0ff"),tools:La(xa.tek,"#9fb6c2"),portfolio:La(xa.positions,"#5ab0ff"),profile:La(xa.profile,"#8dff45")};function $k(){const e=document.querySelector(".tabs");if(!e||document.querySelector("[data-nav-drop]"))return;const t=document.createElement("nav");t.className="nav-drop-bar",t.setAttribute("data-nav-drop",""),t.setAttribute("aria-label","Portal areas");const a=`<a class="nav-drop-pro" href="/autopilot-pro" title="SlimeWire Auto — Pro autopilot" aria-label="Pro autopilot">
  ...
  `,document.head.appendChild(e)}function Po(){if(I.root)return I.root;Kk();const e=document.createElement("div");return e.setAttribute("data-trailer-overlay",""),e.style.cssText="position:fixed;inset:0;z-index:99999;pointer-events:none;font-family:Inter,system-ui,sans-serif;",e.innerHTML=`
  ...
  `,s.querySelector("[data-trailer-close]").addEventListener("click",()=>{s.remove(),setTimeout(()=>URL.revokeObjectURL(r),5e3)}),s.querySelector("[data-trailer-share]").addEventListener("click",async()=>{try{const o=new File([e],a,{type:I.mime.split(";")[0]});if(navigator.canShare?.({files:[o]})){await navigator.share({files:[o],title:"SlimeWire",text:"SlimeWire - verify before you ape. slimewire.org"});return}}catch{}s.querySelector("a[download]")?.click()}),document.body.appendChild(s)}function Gk(){const e=I.recorder;if(!e)return;const t=()=>{try{const a=new Blob(I.chunks,{type:I.mime.split(";")[0]});a.size>0&&jk(a)}catch{}};if(e.state!=="inactive"){e.addEventListener("stop",t,{once:!0});try{e.stop()}catch{t()}}else t();I.stream?.getTracks().forEach(a=>{try{a.stop()}catch{}}),I.recorder=null,I.stream=null}function Ul(e="done"){if(I.running){I.running=!1,I.timers.forEach(t=>clearTimeout(t)),I.timers=[],Gk();try{I.audio?.ctx?.close()}catch{}I.audio=null,I.root?.remove(),I.root=null}}function Xk(){const e=n.livePairsByBucket?.live?.rows||n.livePairs?.rows||n.livePairRows||[];return[...e].filter(a=>a?.tokenMint).sort((a,r)=>(Number(r.volume5m)||0)-(Number(a.volume5m)||0)||(Number(r.bestPickScore||r.score)||0)-(Number(a.bestPickScore||a.score)||0))[0]||e[0]||null}async function Jk(e=9e3){const t=Date.now();for(;Date.now()-t<e;){const a=Xk();if(a)return a;if(!I.running)return null;await Ma(500)}try{return((await k("/api/web/live-pairs?bucket=live&sort=fresh"))?.livePairs?.rows||[]).find(s=>s?.tokenMint)||null}catch{return null}}async function Yk(e,t=4e3){const a=Date.now();for(;Date.now()-a<t;){if(document.querySelector(e))return!0;if(!I.running)return!1;await Ma(250)}return!1}function Qk(){return new Promise(e=>{xr(`
    ...
    `),I.root.querySelector("[data-trailer-go]")?.addEventListener("click",()=>e(!0),{once:!0})})}async function Zk(){if(I.running)return;I.running=!0,Po(),Dk();const e=await zk(),t=Nk();if(!e&&(await Qk(),!I.running))return;Pe("/terminal/live-pairs"),xr('<div style="color:#72ff23;font-weight:900;font-size:clamp(18px,5vw,24px);animation:twPulse 1.2s infinite;">locking onto live pairs...</div>');const a=await Jk(9e3);if(!I.running)return;const r=3,s=6.5,o=9,c=6.5,l=4.6,d=[r,r+s,r+s+o,r+s+o+c],u=r+s+o+c+l;Hk(d,u);const f=(I.audio?.ctx?.currentTime||0)+.05;for(let b=0;b<r;b+=1)qk(f+b,600+b*90);for(let b=r;b>=1;b-=1){if(!I.running)return;xr(`<div style="color:#72ff23;font-size:clamp(64px,22vw,110px);font-weight:900;text-shadow:0 0 30px rgba(114,255,35,0.75);animation:twPulse 1s infinite;">${b}</div>`),await Ma(1e3)}if(xr(""),!I.running)return;Co(),Lo("FRESH PAIRS. SECONDS OLD.","every pump.fun launch lands here instantly"),await Ma(s*1e3);const y=a?.symbol?`$${String(a.symbol).slice(0,12)}`:"live pair";if(I.running&&a?.tokenMint){Co(),Pe(`/terminal/chart?token=${encodeURIComponent(a.tokenMint)}`);const b=await Yk("iframe[src*='dexscreener'], .smart-chart-terminal iframe, [data-chart] canvas",4500);if(!I.running||(Lo("CHARTS WITH A BRAIN",`${y} - live candles, live flow, shield verdict on top`),await Ma((b?o:4)*1e3),!I.running))return;Co(),Ip(a.tokenMint),Lo("TRIPLE-ENGINE RUG CHECK","SlimeShield x Rugcheck x GoPlus - dodge the rug BEFORE you ape"),await Ma(c*1e3),yl()}I.running&&(Lo(""),Co(),xr(`
  ...
  `),await Ma(l*1e3),Ul("done"))}document.addEventListener("click",e=>{e.target instanceof Element&&e.target.closest("[data-trailer-mode]")&&(e.preventDefault(),I.running||Zk())});
