...
`);return s?Promise.resolve(window.prompt(c||e,s.value||"")):Promise.resolve(window.confirm(c||e))}return new Promise(c=>{const l=document.createElement("div");l.className="slime-confirm-overlay",l.innerHTML=`
  ...
  `}function Dh(){_h();const e=n.shieldReceipts;if(!e)return`
          ...
          ${t.map(r=>`
            <article class="row-card">
              <div class="row-main">
                ...
                <span>Flagged ${i(r.verdict)} (score ${i(String(r.score))}) ${r.confirmedAfterMinutes?`- confirmed dead within ${i(Nh(r.confirmedAfterMinutes))}`:""}</span>
  ...
  `}function Nh(e){const t=Number(e)||0;return t<90?`${t} min`:t<2880?`${Math.round(t/60)}h`:`${Math.round(t/1440)}d`}let bu=0;function _h(){Date.now()-bu<300*1e3||(bu=Date.now(),k("/api/web/shield/receipts").then(e=>{n.shieldReceipts=e,n.activeTab==="tek"&&h()}).catch(()=>{}),k("/api/web/proof").then(e=>{n.proofStats=e?.alpha||null}).catch(()=>{}))}function Uh(){return`
    ${Qh()}
    ${Za()}
  ...
  `}function qh(){if(!hi())return`
    ...
    `;const t=[{key:"account",label:"Account",hint:"Profile & name",html:Jh()},{key:"login",label:"Login",hint:"Security",html:Yh()},{key:"pfp",label:"PFP",hint:"Avatar",html:Zh()},{key:"x",label:"X",hint:"Connect X",html:sg()},{key:"alerts",label:"Alerts",hint:"Push to phone",html:Hh()},{key:"badges",label:"Badges",hint:"Earned",html:wu()},{key:"referral",label:"Referral",hint:"Invite & earn",html:ig()},{key:"board",label:"Board",hint:"Top traders",html:cg()}];return`
  ...
  `}function Hh(){const e="serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window,t=e?Notification.permission:"unsupported",a=n.pushAlertsEnabled===!0;return`
  ...
  `}function Jh(){const e=n.user?.connectedWallet;return`
  ...
  `}function Yh(){const e=n.user?.username||"";return`
  ...
  `}function Zh(){const e=!!n.user?.avatar,t=n.xHandle?`@${n.xHandle}`:"";return`
  ...
  `}function Lk(){const e=n.user?.connectedWallet;return`
  ...
  `}function ua({returnPath:e="/terminal"}={}){n.walletConnectMenuOpen=!0,n.walletConnectReturnPath=e||"/terminal",n.walletConnectStatus=n.user?.connectedWallet?`Connected ${w(n.user.connectedWallet.publicKey)}. Pick a provider to reconnect or switch.`:"Pick a wallet. Your extension will ask you to approve.",h({force:!0})}function tg(e={}){return ua(e)}window.openWalletConnectModal=tg;function ag(e){n.walletFastApprovalsEnabled=!!e;try{localStorage.setItem("walletFastApprovalsEnabled",n.walletFastApprovalsEnabled?"on":"off")}catch{}}function ng(){const e=m("[data-wallet-connect-modal]");if(!e)return;if(!n.walletConnectMenuOpen){e.hidden=!0,e.innerHTML="",e.__lastDrawerHtml="";return}const t=n.user?.connectedWallet||n.connectedWalletBalance;e.hidden=!1,fr(e,`
  ...
  `,".wallet-connect-dialog")}function rg(){const e=n.quickBuyModal||{},t=Bo()?.tokenMint===e.tokenMint?Bo():ge(e.tokenMint,{source:e.source||"quick-buy-modal"}),a=/validating|submitting|opening wallet/i.test(String(e.status||"")),r=bi(e.error||e.status||""),o=a||!!r,s=ce(e.walletIndex||"");return`
  ...
  `}function ig(){const e=n.user?.referralCode||"",t=`${Ct.replace(/\/+$/,"")}/r/`,a=n.user?.referralLink||(e?`${Ct.replace(/\/+$/,"")}/r/${encodeURIComponent(e)}`:""),r=n.user?.referralStats||{},o=Array.isArray(r.referrals)?r.referrals:[];return`
  ...
  `:""}function je(e,t="Share X"){return`<button type="button" data-share-x data-share-text="${i(e)}">${i(t)}</button>`}function Tu(e,t="TG"){const a=yi(e),r=`https://t.me/share/url?url=${encodeURIComponent(Ct)}&text=${encodeURIComponent(a)}`;return`<a href="${i(r)}" target="_blank" rel="noreferrer">${i(t)}</a>`}function yi(e){const t=String(e||"").replace(/\s+/g," ").trim();return`${t.length>210?`${t.slice(0,207).trim()}...`:t} ${Ct}`}function ug(e){const t=e.type==="buy",a=t?`${e.spentSol} SOL`:`${e.netSol} SOL`;return`${t?"Bought":"Sold"} ${e.shortMint||w(e.tokenMint)} for ${a}. Chart ${Q(e.tokenMint)}`}function xk(e){return`${e.type==="bundle_sell"?"Bundle sold":e.source==="web_bundle_plan"?"Armed bundle auto-exit":"Bundle bought"} ${e.shortMint||w(e.tokenMint)} across ${e.successCount||0}/${e.walletCount||0} wallet(s).`}function dg(e,t="Armed timed trade"){return`${t} on ${e.shortMint||w(e.tokenMint)} with ${e.successCount||0}/${e.walletCount||0} wallet(s), TP ${e.takeProfitSummary||`+${e.takeProfitPct}%`}, SL ${e.stopLossSummary||`-${e.stopLossPct}%`}.`}function Au(e){return`PnL on ${e.shortMint||w(e.tokenMint)}: ${e.realizedSol} realized, ${e.buys} buy(s), ${e.sells} sell(s).`}function pg(e){return`Watching ${e.shortMint||w(e.tokenMint)}: ${e.uiAmount} tokens across ${e.walletCount} wallet(s), PnL ${e.openPnlSol||e.realizedSol||"tracking"}.`}function mg(e){return`Watching ${e.symbol||w(e.tokenMint)}: score ${e.score}/100, MC ${e.marketCapLabel}, liq ${e.liquidityLabel}. Chart ${Q(e.tokenMint)}`}function fg(e){return`KOL signal ${e.symbol||w(e.tokenMint)}: score ${e.score||0}/100, value ${e.valueLabel||"$0"}, signal ${e.winRateLabel||"n/a"}. Chart ${Q(e.tokenMint)}`}function hg(e){return`Watching KOL ${e.twitter?`@${e.twitter}`:e.name||e.shortWallet||w(e.wallet)}: realized ${e.realizedLabel||"n/a"}, ROI ${e.roiLabel||"n/a"}, trades ${e.trades??"n/a"}.`}function gg(e){return`Watching $${e.ticker} with Launch Snipe: ${e.walletCount} wallet(s), ${e.amountSol} SOL each, TP ${e.takeProfitSummary||`+${e.takeProfitPct}%`}, SL ${e.stopLossSummary||`-${e.stopLossPct}%`}.`}function vi(e){const t=String(e||"").trim(),a=t.startsWith("$")?t:t.length>30?w(t):`$${t.replace(/^\$+/,"")}`,r=t.length>30?` Chart ${Q(t)}`:"";return`Watching ${a}.${r}`}function Pu(e){const t=String(e||"").trim();return`Watching KOL ${t.startsWith("@")?t:t.length>30?w(t):`@${t.replace(/^@+/,"")}`}.`}const bg=[{tier:"hot",pinned:!0,rank:1,name:"Idontpaytaxes",twitter:"Idontpaytaxes",wallet:"",kolscanUrl:"https://kolscan.io/account/2T5NgDDidkvhJQg8AHDI74uCFwgp25pYFMRZXBaCUNBH",tag:"External KOLscan profile",note:"External public/KOLscan stats only. These are not SlimeWire trades and do not create SlimeWire fees unless copied through your SlimeWire wallets. Add a verified Solana wallet before scan/copy.",winRateLabel:"36.8%",realizedLabel:"-$28.1",roiLabel:"Watch",trades:"24 ext",volumeLabel:"$6.58K volume",lastTradeAt:new Date(Date.now()-1020*60*1e3).toISOString()},{tier:"slimewire",pinned:!0,rank:1,name:"MoonPieJoe",twitter:"moonpiejoe",tag:"SlimeWire KOL",note:"Supporter profile. Add wallet later to enable scan/copy trade.",winRateLabel:"Supporter",realizedLabel:"n/a",roiLabel:"Social",trades:"Add wallet"},{tier:"slimewire",pinned:!0,rank:2,name:"Rezzy",twitter:"zero_taxes",tag:"SlimeWire KOL",note:"Supporter profile. Add wallet later to enable scan/copy trade.",winRateLabel:"Supporter",realizedLabel:"n/a",roiLabel:"Social",trades:"Add wallet"}];function wi(e=""){const t=String(e||"").trim().toLowerCase();return bg.filter(a=>!t||String(a.tier||"").toLowerCase()===t).sort((a,r)=>+!!r.pinned-+!!a.pinned||Number(a.rank||999)-Number(r.rank||999))}function Wt(e=""){return/^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(String(e||"").trim())}function Cu(e=""){const t=String(e||"").trim();return Wt(t)?t:""}function yg(e={}){const t=String(e.wallet||"").trim(),a=Cu(t),r=Xe(e.twitter||e.x||e.username||"");return{x:r?$i(r):"",wallet:a?`https://solscan.io/account/${encodeURIComponent(a)}`:"",kolscan:e.kolscanUrl||e.externalProfileUrl||(a?Tc(a):"")}}function vg(e={}){const t=String(e.wallet||"").trim(),a=Cu(t),r=yg(e);return`
    ...
    <article class="curated-kol-card ${a?"is-compact":""}" data-tier="${i(e.tier||"hot")}">
      <div class="curated-kol-top">
        ...
        <div>
          ...
          <p>${e.twitter?`@${i(Xe(e.twitter))}`:i(w(r)||"Social pending")}</p>
        </div>
        <b>#${i(e.rank||1)}</b>
      </div>
      <dl>
  ...
  `}function wg(){const e=wi("hot"),t=wi("slimewire");return`
  ...
  `}function en(e="SW"){const t=rt(n.user?.avatar||"");if(xu(t))return`<img src="${i(t)}" alt="" referrerpolicy="no-referrer" onerror="this.onerror=null;this.src='${bl("ogre")}';">`;const a=bl("ogre");if(e==="SW"||e==="OG")return`<img src="${a}" alt="">`;const r=String(e||"SW").trim().slice(0,2).toUpperCase()||"SW";return`<span>${i(r)}</span>`}function xu(e){const t=String(e||"").trim();return/^data:image\/(png|jpe?g|webp|gif);base64,/i.test(t)||/^https?:\/\/[^\s"'<>]+$/i.test(t)}function rt(e){const t=String(e||"").trim();if(!t)return"";if(/^\/api\/web\/token-image\?/i.test(t))return t;if(/^ipfs:\/\//i.test(t)){const a=t.replace(/^ipfs:\/\//i,"").replace(/^ipfs\//i,"");return a?`https://ipfs.io/ipfs/${encodeURIComponent(a).replace(/%2F/g,"/")}`:""}return/^\/\//.test(t)?`https:${t}`:/^https?:\/\/[^\s"'<>]+$/i.test(t)||/^data:image\/(png|jpe?g|webp|gif);base64,/i.test(t)?t:""}function Sg(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||e.address||"").trim();return t?`/api/web/token-image?mint=${encodeURIComponent(t)}`:""}function kg(e="",t=""){const a=String(e||"").trim(),r=rt(t);if(!a||!r||Jr(a,r))return"";if(ht.set(a,r),ne("avatarCacheHit"),ht.size>900){for(const o of ht.keys())if(ht.delete(o),ht.size<=720)break}return r}function Mu(e="",t=""){return`${String(e||"").trim()}|${rt(t)}`}function $g(e=""){return/^\/api\/web\/token-image\?/i.test(String(e||""))?45e3:1800*1e3}function Jr(e="",t=""){const a=Mu(e,t);if(!Yt.has(a))return!1;const r=Number(kr.get(a)||0);return r&&Date.now()-r>$g(t)?(Yt.delete(a),kr.delete(a),!1):!0}function Tg(e="",t=""){const a=String(e||"").trim(),r=rt(t);if(!a||!r)return;const o=Mu(a,r);if(Yt.add(o),kr.set(o,Date.now()),Yt.size>1200){for(const s of Yt)if(Yt.delete(s),kr.delete(s),Yt.size<=900)break}ht.get(a)===r&&ht.delete(a),ne("avatarFetchFailed")}function Si(e="",...t){const a=String(e||"").trim(),r=a?ht.get(a):"";if(r&&!Jr(a,r))return ne("avatarCacheHit"),r;r&&ht.delete(a);for(const o of t){const s=rt(o);if(s&&!Jr(a,s))return ne("avatarCacheMiss"),s}return ne("avatarFallbackShown"),""}window.__slimeRememberAvatar=kg,window.__slimeAvatarLoadFailed=function(t){const a=t?.dataset?.avatarKey||"",r=t?.currentSrc||t?.src||t?.dataset?.avatarSrc||"";Tg(a,r);const o=rt(t?.dataset?.backupSrc||"");if(o&&!Jr(a,o)){t.dataset.backupSrc="",t.dataset.avatarSrc=o,t.src=o;return}t&&(t.hidden=!0,t.removeAttribute("src"))};function ki(e){const t=Xe(e);return t?`https://unavatar.io/twitter/${encodeURIComponent(t)}`:""}function $i(e=n.xHandle){const t=Xe(e);return t?`https://x.com/${encodeURIComponent(t)}`:"https://x.com/i/flow/login"}function Ag(e={}){const t=rt(e.avatar||e.image||"");if(xu(t))return t;const a=Xe(e.twitter||e.x||e.username||"");if(a)return ki(a);const r=Xe(e.name||e.kolName||"");return r&&r.length>=2?ki(r):""}function Pg(e={}){return String(e.twitter||e.name||e.kolName||e.shortWallet||e.wallet||"KO").trim().replace(/^@+/,"").slice(0,2).toUpperCase()||"KO"}function Bu(e={},t="kol-avatar"){const a=`kol:${String(e.wallet||e.address||e.twitter||e.x||e.username||e.name||e.kolName||"").trim().toLowerCase()}`,r=Si(a,Ag(e)),o=Pg(e);return r?`<img class="${i(t)}" src="${i(r)}" data-avatar-key="${i(a)}" data-avatar-fallback="${i(o)}" alt="" loading="eager" decoding="async" referrerpolicy="no-referrer" onload="window.__slimeRememberAvatar&&window.__slimeRememberAvatar(this.dataset.avatarKey,this.currentSrc||this.src);" onerror="var d=document.createElement('div');d.className=this.className+' kol-avatar-fallback';d.setAttribute('aria-hidden','true');d.textContent=this.dataset.avatarFallback||'KO';this.replaceWith(d);">`:`<div class="${i(t)} kol-avatar-fallback" aria-hidden="true">${i(o)}</div>`}function Yr(){const e=Ke();return[{id:"phantom",label:"Phantom",detected:!!me("phantom"),mobileRedirect:e&&!!En("phantom"),installUrl:Gs("phantom"),icon:ja("phantom")},{id:"solflare",label:"Solflare",detected:!!me("solflare"),mobileRedirect:e&&!!En("solflare"),installUrl:Gs("solflare"),icon:ja("solflare")},{id:"backpack",label:"Backpack",detected:!!me("backpack"),mobileRedirect:!1,installUrl:Gs("backpack"),icon:ja("backpack")},{id:"solana",label:"Detected Wallet",detected:!!me("solana"),mobileRedirect:!1,installUrl:"",icon:ja("solana")}]}function me(e){return e==="phantom"?window.phantom?.solana||(window.solana?.isPhantom?window.solana:null):e==="solflare"?window.solflare||(window.solana?.isSolflare?window.solana:null):e==="backpack"?window.backpack?.solana||null:e==="solana"&&(window.solana||window.solflare||window.phantom?.solana||window.backpack?.solana)||null}function Ee(e,t){return e==="phantom"?"Phantom":e==="solflare"?"Solflare":e==="backpack"?"Backpack":t?.isPhantom?"Phantom":t?.isSolflare?"Solflare":t?.isBackpack?"Backpack":"Solana Wallet"}function le(){return n.user?.connectedWallet||n.connectedWalletBalance||null}function Cg(e=""){const t=le();if(!t?.publicKey)return"";const a=String(e||"")==="connected"||!e&&!n.wallets.length,r=t.provider||"Browser Wallet";return`<option value="connected" ${a?"selected":""}>${i(r)} - ${i(w(t.publicKey))}</option>`}function w(e){const t=String(e||"");return t.length>10?`${t.slice(0,4)}...${t.slice(-4)}`:t||"token"}const Ti="/assets/slimewire/swap/states/",Ai="/assets/slimewire/swap/sfx/",Ru="/assets/slimewire/volume/states/",Pi="/assets/slimewire/volume/sfx/",da={launchCoin:{base:"/assets/slimewire/launch/states/",poster:"/assets/slimewire/launch/hero.png",tier:"OGRE FORGE",cap:["Pump Launcher","Forge it · birth it · send it."],accent:"launch",idle:"idle",event:"launch",sfx:[Ai+"win.mp3",.8]},sniper:{base:"/assets/slimewire/sniper/states/",poster:"/assets/slimewire/sniper/hero.png",tier:"OGRESNIPER",cap:["OgreSniper","Lock on · strike first."],accent:"sniper",idle:"idle",event:"fire",sfx:["/assets/slimewire/auto/sfx/shockwave.mp3",.8]},ogreAi:{base:"/assets/slimewire/ogreai/states/",poster:"/assets/slimewire/ogreai/hero.png",tier:"OGRE A.I.",cap:["Ogre A.I.","Ask the swamp oracle."],accent:"ogreai",idle:"idle",event:"speak",sfx:[Ai+"appraise.mp3",.6]},bundle:{base:"/assets/slimewire/volume/states/",poster:"/assets/slimewire/volume/hero.png",tier:"OGRE BUNDLE",cap:["Bundle","Many wallets · one tap."],accent:"bundle",idle:"idle",event:"running",sfx:[Pi+"start.mp3",.7]},positions:{base:"/assets/slimewire/auto/states/",poster:"/assets/slimewire/auto/reactor.jpg",tier:"POSITIONS",cap:["Open Positions","Your swamp, live."],accent:"positions",idle:"idle",event:"win",sfx:["/assets/slimewire/auto/sfx/victory.mp3",.85]},pnl:{base:"/assets/slimewire/auto/states/",poster:"/assets/slimewire/auto/reactor.jpg",tier:"PROFIT & LOSS",cap:["PnL","Count the winnings."],accent:"positions",idle:"idle",event:"win",sfx:["/assets/slimewire/auto/sfx/victory.mp3",.85]}};function Lg(){const e=I.kind;return e==="swap"?Ti:e==="volume"?Ru:da[e]?da[e].base:Ti}let pa=!0;try{pa=localStorage.getItem("ogreStageSound")!=="off"}catch{}const Iu={};function Qr(e,t){if(pa)try{let a=Iu[e];a||(a=new Audio(e),a.preload="auto",Iu[e]=a),a.volume=t??.7,a.currentTime=0,a.play().catch(()=>{})}catch{}}const I={kind:null,clip:"",eventUntil:0,prev:{},feed:[],feedIdx:0,tkTimer:0};function xg(e){return e=String(e||""),e.length>9?`${e.slice(0,4)}…${e.slice(-4)}`:e||"coin"}function Ci(e){return e&&e.symbol?`$${e.symbol}`:e&&e.shortMint?`$${e.shortMint}`:"the coin"}function Ou(e){return`<video class="ogre-bg" data-ogre-bg autoplay muted loop playsinline preload="auto" poster="${e==="swap"?"/assets/slimewire/swap/hero.png":"/assets/slimewire/volume/hero.png"}" src="${e==="swap"?Ti:Ru}idle.mp4"></video>`}function Mg(){return`
    ...
    </div>`}function Rg(e){return e==="volume"&&(n.volumeBots||[]).some(t=>t&&t.status!=="completed")?"running":"idle"}function Ig(e){const t=da[I.kind];if(t){t.sfx&&e===t.event&&Qr(t.sfx[0],t.sfx[1]);return}if(I.kind==="swap"){const a={appraise:["appraise.mp3",.7],buy:["buy.mp3",.85],win:["win.mp3",.85],loss:["loss.mp3",.6],banking:["bank.mp3",.8]};a[e]&&Qr(Ai+a[e][0],a[e][1])}else if(I.kind==="volume"){const a={running:["start.mp3",.7],sweep:["sweep.mp3",.8]};a[e]&&Qr(Pi+a[e][0],a[e][1])}}function ot(e,t,a){const r=e.querySelector("[data-ogre-bg]");if(!r||I.clip===t)return;I.clip=t;const o=Lg();try{r.loop=!a,r.muted=!0,r.src=o+t+".mp4",r.load();const s=r.play();s&&s.catch&&s.catch(()=>{})}catch{}a&&(I.eventUntil=Date.now()+(t==="running"?8500:4600),Ig(t))}function tn(e,t){I.feed.unshift({text:e,color:t||""}),I.feed.length>16&&I.feed.pop(),I.feedIdx=0}function Og(){const e=document.querySelector("[data-ogre-stage]");if(!e){I.tkTimer&&(clearInterval(I.tkTimer),I.tkTimer=0);return}const t=e.querySelector("[data-os-tk]");if(!t)return;if(!I.feed.length){const o=da[I.kind];if(o)t.innerHTML='<span class="os-dot"></span>'+o.cap[1];else if(I.kind==="volume"){const s=(n.volumeBots||[]).some(c=>c&&c.status!=="completed");t.innerHTML='<span class="os-dot"></span>'+(s?"Swarm running — generating lifelike volume":"SlimeBot idle — set a token and start")}else t.innerHTML='<span class="os-dot"></span>'+(n.tradeToken?"Coin loaded — set your size and SWAP":"OgreSwap ready — paste a coin to appraise");return}const a=I.feed[I.feedIdx++%I.feed.length],r=a.color?`<span class="os-dot" style="background:${a.color};box-shadow:0 0 8px ${a.color}"></span>`:'<span class="os-dot"></span>';t.innerHTML=r+i(a.text),t.style.animation="none",t.offsetWidth,t.style.animation="os-tkin .5s ease"}function Eg(e){const t=e.querySelector("[data-ogre-stage]");if(!t){I.kind=null;return}const a=t.getAttribute("data-ogre-stage");I.kind!==a&&(I.kind=a,I.clip="",I.eventUntil=0,I.prev={},I.feed=[],I.feedIdx=0);const r=t.querySelector("[data-ogre-snd]");r&&(r.textContent=pa?"🔊":"🔇",r.onclick=s=>{s.stopPropagation(),pa=!pa;try{localStorage.setItem("ogreStageSound",pa?"on":"off")}catch{}r.textContent=pa?"🔊":"🔇"});const o=t.querySelector("[data-ogre-bg]");o&&!o.__ogreBound&&(o.__ogreBound=!0,o.addEventListener("ended",()=>{o.loop||(I.eventUntil=0,I.clip="",ot(t,Rg(I.kind),!1))})),I.tkTimer||(I.tkTimer=setInterval(Og,3400)),a==="swap"?Dg(t):a==="volume"?Ng(t):Wg(t,a)}function Fg(e){const t=da[e];return t?`
    ...
    <section class="trade-layout">
      ...
      <aside class="trade-side">
        ...
        <article>
          ...
          ${n.tradeToken?`<div class="card-actions">${je(vi(n.tradeToken),"Share Watch")}</div>`:""}
        </article>
        ${Qg()}
        <article>
          <h3>Balance Check</h3>
  ...
  `}function Li(){return(Array.isArray(n.wallets)?n.wallets:[]).filter(e=>!e?.volumeBot)}function Fu(){return(Array.isArray(n.wallets)?n.wallets:[]).filter(e=>!!e?.volumeBot)}function an(e=""){const t=Cg(e),a=Li().map(r=>{const o=n.balances.find(l=>Number(l.index)===Number(r.index)),s=o?.sol!==null&&o?.sol!==void 0?`${Number(o.sol).toFixed(4)} SOL`:"balance loading",c=r.sessionWallet?" Session":"";return`<option value="${r.index}" ${String(r.index)===String(e||"")?"selected":""}>${r.index}. ${i(r.label)}${c} - ${s}</option>`}).join("");return t||a?`${t}${a}`:'<option value="">No wallet connected</option>'}function Ug(){if(!n.tradeResult)return`
      <article>
        <h3>Latest Result</h3>
  ...
  `}function Nu(e){const t=Yn.find(([a])=>a===e);return t?t[1]:"Super-fresh"}function zg(){if(!n.wallets.length)return`${Za()}${O("No managed wallets loaded","Ogre A.I. needs managed/imported SlimeWire wallets so the server can submit TP/SL and timer exits after it buys.")}`;const e=Vl(),t=e.amountSol||"0.1",a=e.runCount||"1",r=(s,c,l)=>{const u=String(s||l||"");return u==="custom"?String(c||"custom"):u},o=Zr();return`
    <section class="trade-layout ogre-ai-terminal">
      <article class="trade-card">
        ...
        <div class="ogre-cat-field" data-preserve-focus>
          ...
          ${Kg(o)}
          <small class="ogre-cat-hint">${i(Du(o))}</small>
        </div>
        ...
        <small data-ogre-ai-status>${i(n.ogreAiStatus||Du(o))}</small>
      </article>
  ...
  `}function jg(){return n.wallets.length?`
    <section class="trade-layout">
      <article class="trade-card">
        <div class="trade-head">
          <div>
  ...
  `:`${Za()}${O("No wallets loaded yet","Create or restore wallets above first. Bundle works after the web account has managed wallets saved.")}`}function Gg(){if(!n.bundleResult)return`
      <article>
        <h3>Latest Bundle</h3>
  ...
  `}function Xg(e=""){return n.wallets.length?n.wallets.map((t,a)=>{const r=String(t.index??a+1),o=`${r}. ${t.label||"Wallet"} ${t.shortPublicKey||w(t.publicKey||"")}`;return`<option value="${i(r)}" ${String(e)===r?"selected":""}>${i(o)}</option>`}).join(""):'<option value="">No managed wallets loaded</option>'}function x(e,t,a=""){const r=m(e)?.value||a;if(r!=="custom")return r;const o=m(t)?.value?.trim();if(!o)throw new Error("Enter the custom value first.");return o}function st(e,t=""){const a=n.presets?.[e]||[],r=!t||t==="none"||t==="manual",o=e==="bundle"?"Create / edit bundle preset":"Create / edit trade preset";return a.length?`
  ...
  `:`
      <option value="" ${r?"selected":""}>No preset / manual</option>
      <option value="custom" ${t==="custom"?"selected":""}>${o}</option>
    `}function _u(){return`<input data-quick-buy-amount type="text" inputmode="decimal" autocomplete="off" placeholder="${i(qe()||"0.10")}" value="${i(n.quickBuyAmountOverride)}">`}function Uu(e="scanner"){return`
  ...
  `}function Ge(e,t,a="off"){return Nt({selectAttr:`${t}`,customAttr:`${t}-custom`,customFor:e,options:Jg,selected:a,customPlaceholder:"Custom: 45s, 20, 2h"})}function eo(e,t,a="0"){return Nt({selectAttr:`${t}`,customAttr:`${t}-custom`,customFor:e,options:Yg,selected:a,customPlaceholder:"Custom: 30s, 20, 2h"})}function xi(e="scanner"){return`
  ...
  `}function Bk(){const e=n.fastTradePresetStatus||(n.wallets.length?"Save this once, then tap Trade on any row.":"Load or connect a wallet before live trading.");return`
  ...
  `}function Rk(){const e=n.fastBundlePresetStatus||(n.wallets.length?"Save this once, then tap Bundle on any row.":"Load wallets before live bundle trading.");return`
  ...
  `}function qu(e){const t=e==="trade"?n.editingTradePresetId:n.editingBundlePresetId;return t?oe(e,t):null}function to(e,t){e==="trade"&&(n.editingTradePresetId=t||""),e==="bundle"&&(n.editingBundlePresetId=t||"")}function Qg(){const e=qu("trade"),t=!!e?.readonly,a=e?t?"Save Edited Copy":"Update Trade Preset":"Save Trade Preset";return`
  ...
  `}function Zg(){const e=qu("bundle"),t=!!e?.readonly,a=e?t?"Save Edited Copy":"Update Bundle Preset":"Save Bundle Preset";return`
  ...
  `}function Hu(e){const t=n.presets?.[e]||[];if(!t.length)return'<p class="muted">No presets loaded yet.</p>';const a=e==="trade"?n.selectedTradePresetId:n.selectedBundlePresetId;return`
  ...
  `}function eb(e){return Number(e?.sellDelaySeconds||0)>0?`${e?.sellPercent||100}%`:"Off"}function ao(e){return`
  ...
  `}function ma(e){return{walletTakeProfitTargets:x(`[data-${e}-wallet-tp]`,`[data-${e}-wallet-tp-custom]`,""),walletStopLossTargets:x(`[data-${e}-wallet-sl]`,`[data-${e}-wallet-sl-custom]`,"")}}function no(e=document){e.querySelectorAll("[data-custom-for]").forEach(t=>{const r=[...document.querySelectorAll("[data-custom-select]")].find(o=>o.dataset.customSelect===t.dataset.customFor)?.value==="custom";t.hidden=!r,r||(t.value="")})}function tb(e){if(!e?.dataset?.customSelect?.endsWith("-sell-percent")||e.value!=="off")return;const t=e.dataset.customSelect.replace(/-sell-percent$/,"-delay"),a=document.querySelector(`[data-custom-select="${t}"]`);a&&(a.value="off"),no()}function Ku(){return n.wallets.map(e=>`<option value="${i(e.index)}">${i(e.index)}. ${i(e.label||"Wallet")}${e.sessionWallet?" (session)":""}</option>`).join("")}function ab(){return n.wallets.length?`
  ...
  `:""}function ro(e){n.distributeStatus=String(e||"");const t=m("[data-distribute-status]");t&&(t.textContent=n.distributeStatus)}function nb(){const e=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!e?.publicKey)return"";const t=n.wallets.filter(r=>r.sessionWallet),a=t.length?t:n.wallets;return a.length?`
  ...
  `:""}function Qn(e){n.returnFundsStatus=String(e||"");const t=m("[data-return-funds-status]");t&&(t.textContent=n.returnFundsStatus)}async function Vu(e="leaving"){try{const t=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!t?.publicKey)return;const a=n.wallets.filter(s=>s.sessionWallet);if(!a.length)return;const r=a.map(s=>String(s.index));if(!await Le({title:"Return Session Funds",lines:[`Before ${e}, return tokens + SOL from your ${r.length} session wallet(s)`,`back to your connected wallet ${w(t.publicKey)}?`],confirmLabel:"Return Funds",cancelLabel:"Skip"}))return;await k("/api/web/wallets/return-to-connected",{method:"POST",body:JSON.stringify({destination:t.publicKey,walletIndexes:r}),dedupe:!1,timeoutMs:te})}catch(t){try{window.alert(`Could not return funds automatically: ${t.message}. Use the Return Funds button to retry.`)}catch{}}}async function rb(){if(n.returnFundsBusy)return;const e=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!e?.publicKey){Qn("Connect a wallet first.");return}const t=n.wallets.filter(s=>s.sessionWallet),r=(t.length?t:n.wallets).map(s=>String(s.index));if(!r.length){Qn("No managed wallets to return from.");return}if(await Le({title:"Return Funds",lines:[`Sell all tokens to SOL and send everything from ${r.length} wallet(s)`,`back to your connected wallet ${w(e.publicKey)}?`],confirmLabel:"Sell & Return",danger:!0})){n.returnFundsBusy=!0,Qn("Selling tokens and returning SOL..."),h();try{const s=await k("/api/web/wallets/return-to-connected",{method:"POST",body:JSON.stringify({destination:e.publicKey,walletIndexes:r}),dedupe:!1,timeoutMs:te});n.returnFundsBusy=!1,Qn(s.summary||"Funds returned to your connected wallet."),await Ne({force:!0,deep:!1,reason:"return-funds"}).catch(()=>{}),h()}catch(s){n.returnFundsBusy=!1,Qn(s.message),h()}}}async function ob(){if(n.distributeBusy)return;const e=m("[data-distribute-count]")?.value||"5",t=m("[data-distribute-amount]")?.value||"",a=m("[data-distribute-source]")?.value||"1",r=m("[data-distribute-label]")?.value?.trim()||"Fresh";if(!t||Number(t)<=0){ro("Enter SOL per wallet greater than zero.");return}const o=(Number(t)||0)*(Number(e)||0);if(await Le({title:"Create & Fund Wallets",lines:[`Create ${e} fresh wallet(s) and fund each with ${t} SOL?`,`That sends about ${o.toFixed(3)} SOL total from the source wallet (real SOL).`,"Backup/recovery files for the new wallets will download."],confirmLabel:"Create & Fund"})){n.distributeBusy=!0,ro("Creating and funding wallets..."),h();try{await Y(m("[data-distribute-status]"),"Creating secure web profile for wallet backups...");const c=await k("/api/web/wallets/distribute",{method:"POST",body:JSON.stringify({count:e,amountSol:t,sourceWalletIndex:a,label:r}),dedupe:!1,timeoutMs:te});c.downloads?.encryptedBackup?.text&&fe(c.downloads.encryptedBackup.filename,c.downloads.encryptedBackup.text),c.downloads?.recoveryKeys?.text&&fe(c.downloads.recoveryKeys.filename,c.downloads.recoveryKeys.text),n.distributeBusy=!1,ro(c.summary||"Fresh wallets created and funded. Backups downloaded."),await Ne({force:!0,deep:!1,reason:"distribute-fresh-wallets"}).catch(()=>{}),h()}catch(c){n.distributeBusy=!1,ro(c.message),h()}}}function sb(e){return e.status==="completed"?"Finished":e.stage==="sweeping"?"Sweeping back":e.stage==="running"?"Running":e.stage||"Armed"}function ib(){const e=Fu().length;return e?`
    ...
    </article>`:""}function lb(){const e=Array.isArray(n.volumeBots)?n.volumeBots:[],t=ib();return e.length?t+e.map(a=>{const r=a.stats||{},o=a.status!=="completed",s=(a.log||[]).slice(0,6);return`
    ...
    `}).join(""):`${t}<article class="volume-bot-status"><p class="muted">No SlimeBots running yet. Configure one above and press Start SlimeBot.</p></article>`}function Mi(e,t,a){return`<div class="vbot-segment" role="group">${a.map(([r,o])=>`<button type="button" data-vbot-set-${e}="${i(r)}" data-active="${t===r}">${i(o)}</button>`).join("")}</div>`}function cb(){const t=(Array.isArray(n.volumeBots)?n.volumeBots:[]).filter(c=>c.status!=="completed"),a=t.filter(c=>c.rolling),r=t.filter(c=>!c.rolling),o=c=>c.reduce((l,u)=>l+Math.max(0,Number(u.cycles||0)-Number(u.currentCycle||0)),0),s=(c,l,u,d,p)=>`
      ...
      <div class="ovs-below">
        ...
        <div class="vbot-config-row">
          <div class="vbot-config-field">
            ...
            ${Mi("stagger",n.slimeBotStagger,[["steady","Steady"],["waves","Waves"],["organic","Organic"],["ladder","Ladder"]])}
          </div>
        </div>
  ...
  `}function db(){const e=n.slimeBotMode==="spam"?"spam":"smart",t=["low","med","high"].includes(n.slimeBotAggr)?n.slimeBotAggr:"med",a=Math.max(.05,Math.min(50,Number(m("[data-vbot-invest-num]")?.value||m("[data-vbot-invest]")?.value||"1"))),r=Math.max(20,Math.min(360,Number(m("[data-vbot-duration]")?.value||"60"))),s={low:{delaySecs:30,buyBias:55,walletCount:4},med:{delaySecs:12,buyBias:60,walletCount:6},high:{delaySecs:5,buyBias:70,walletCount:10}}[t],c=e==="smart",l=s.delaySecs*(c?4:1);let u=Math.round(r*60/l);u=Math.max(1,Math.min(250,u,Math.floor(a/.01)));const d=Math.max(.005,Math.min(.5,a/u));return{tokenMint:m("[data-vbot-token]")?.value?.trim()||"",sourceWalletIndex:m("[data-vbot-source]")?.value||"1",rollingWallets:c,autoCreateWallets:!c,walletCount:String(s.walletCount),fundPerWalletSol:c?"":(d+.02).toFixed(4),buyAmountSol:d.toFixed(4),sellPercent:"100",buyBias:String(s.buyBias),cycles:String(u),maxRounds:String(u),delaySecs:String(s.delaySecs),slippageBps:"400",sweepBack:!0,walletIndexes:[],walletGroup:"",keepDust:!!m("[data-vbot-keepdust]")?.checked,offsetSell:!!m("[data-vbot-offset]")?.checked,staggerPattern:["steady","waves","organic","ladder"].includes(n.slimeBotStagger)?n.slimeBotStagger:"steady",investment:a,durationMin:r,mode:e,aggr:t}}function fa(e){n.volumeBotStatus=String(e||"");const t=m("[data-vbot-status]");t&&(t.textContent=n.volumeBotStatus)}async function oo({silent:e=!0}={}){try{const t=await k("/api/web/volume-bot");n.volumeBots=Array.isArray(t.bots)?t.bots:[],n.activeTab==="volume"&&h()}catch(t){e||$(t.message)}}async function pb(){if(n.volumeBotBusy)return;const e=db();if(!e.tokenMint){fa("Paste a token CA first.");return}const t=e.durationMin>=60?`${(e.durationMin/60).toFixed(e.durationMin%60?1:0)}h`:`${e.durationMin}m`;if(await Le({title:"Start SlimeBot",lines:["This spends REAL SOL.",`Token: ${e.tokenMint}`,`${e.mode==="smart"?"Smart":"Spam"} mode, ${e.aggr.toUpperCase()} aggressiveness.`,`Deploys up to ~${e.investment} SOL over ${t} from your source wallet,`,`as ${e.cycles} round(s) of randomized ~${e.buyAmountSol} SOL buys / sells.`,"Sweeps funds back to the source wallet when done."],confirmLabel:"Start SlimeBot"})){n.volumeBotBusy=!0,fa("Funding wallets and starting bot..."),h();try{const r=await k("/api/web/volume-bot/start",{method:"POST",body:JSON.stringify(e),dedupe:!1,timeoutMs:te});n.volumeBotBusy=!1,r.bot&&(n.volumeBots=[r.bot,...n.volumeBots.filter(o=>o.id!==r.bot.id)]),fa(r.bot?.message||"SlimeBot started."),h(),oo()}catch(r){n.volumeBotBusy=!1,fa(r.message),h()}}}async function mb(e){if(e)try{fa("Stopping bot...");const t=await k("/api/web/volume-bot/stop",{method:"POST",body:JSON.stringify({planId:e}),dedupe:!1,timeoutMs:te});t.bot&&(n.volumeBots=n.volumeBots.map(a=>a.id===t.bot.id?t.bot:a)),fa(t.bot?.message||"Stop requested."),h(),oo()}catch(t){fa(t.message)}}function fb(){return n.wallets.length?ub():`${Za()}${O("No wallets loaded yet","Create or restore a managed wallet above first. SlimeBot funds and trades from managed wallets, so it needs at least one saved source wallet.")}`}function hb(){const e=be([...n.livePairsByBucket.live?.rows||[],...n.livePairsByBucket.under1h?.rows||[],...De()?.rows||[],...n.scan?.rows||[]]).sort(Qe),t=fn(e),a=at("launch",t),r=mn(),o=kt(Me().keywords)[0]||"";return`
    <section class="trade-layout">
      ...
      <aside class="trade-side">
        ...
        <article>
          <h3>How It Works</h3>
          <p>It scans live launch/profile feeds about every ${i(Ob())} seconds while the bot is online.</p>
        </article>
        <article>
  ...
  `}function zu(e=n.launchCoinDraft||{}){return String(e.tokenMint||e.mint||e.ca||n.launchWatches?.[0]?.tokenMint||n.launchWatches?.[0]?.mint||n.smartChartToken?.tokenMint||n.smartChartToken?.mint||"").trim()}function Bi(){return!!(Xt&&Xt.enabled&&(Xt.provider||Xt.playbackBaseUrl||Xt.ingestUrl))}function gb(){const e=String(Xt.provider||"").trim();return e?e.toUpperCase():"Provider not configured"}function bb(e){const t=String(Xt.playbackBaseUrl||"").trim();if(!t||!e)return"";if(t.includes("{mint}"))return t.replace(/\{mint\}/g,encodeURIComponent(e));const a=t.includes("?")?"&":"?";return`${t}${a}mint=${encodeURIComponent(e)}`}function yb(e){return e?e.length>14?`${e.slice(0,6)}...${e.slice(-6)}`:e:"No CA yet"}function ju(e){return`slime-pump-live-${e?`${e.slice(0,6)}-${e.slice(-6)}`:"pending-ca"}`}function vb(e=n.launchCoinDraft||{}){const t=zu(e),a=Bi(),r=bb(t),o=n.pumpLiveStatus||(t?a?"Ready to stage Pump Live for this launch.":"Provider hooks ready. Add Pump Live envs to enable real video.":"Launch or paste a CA to stage Pump Live."),s=t?"":"disabled",c=a&&r?`<iframe class="pump-live-frame" src="${i(r)}" title="Pump Live preview" loading="lazy" allow="autoplay; fullscreen; picture-in-picture"></iframe>`:'<div class="pump-live-placeholder"><span>LIVE</span><strong>Pump Live standby</strong><p>Video stays off Render until a streaming provider is configured.</p></div>';return`
    <section class="launch-coin-card pump-live-panel" data-pump-live-panel>
      ...
      <div class="pump-live-grid">
        ...
        <div class="pump-live-stack">
          <div class="pump-live-stat"><span>Launch CA</span><strong>${i(yb(t))}</strong></div>
          <div class="pump-live-stat"><span>Provider</span><strong>${i(gb())}</strong></div>
  ...
  `}function Sb(e={}){Gu();const t=n.hypePages||[],r=new Date(Date.now()+600*1e3-new Date().getTimezoneOffset()*60*1e3).toISOString().slice(0,16);return`
    <div class="volume-grid">
      ...
      ${t.length?`
        <div class="full-span">
          ...
          <div class="volume-grid">
            ...
            <label>
              ...
              <select data-launch-coin-dev-wallet>
                ${Xg(e.devWalletIndex||(e.walletIndexes||[])[0]||"")}
              </select>
            </label>
            <label>
          ...
          <div class="volume-grid">
            ...
            <label>
              Buy SOL Per Wallet
              <input data-launch-coin-amount type="text" inputmode="decimal" autocomplete="off" placeholder="0.1" value="${i(e.amountSol||qe()||"0.1")}">
            </label>
            <label>
              Sell Percent
          ...
          </div>`},{key:"hype",label:"Hype",hint:"Pre-launch page",title:"Pre-Launch Hype Page",html:Sb(e)},{key:"live",label:"Live",hint:"Status feed",title:"Live Launch Status",html:vb(e)}];return`
    ${wb()}
  ...
  `}async function Ii(e={}){if(!_("kolDumpDetectorEnabled",!0))return null;const t=!!e.force;if(!t&&n.kolDumpStatsLoadedAt&&Date.now()-Number(n.kolDumpStatsLoadedAt||0)<900*1e3)return n.kolDumpStats;if(n.kolDumpStatsLoading)return null;n.kolDumpStatsLoading=!0;try{const a=new URLSearchParams({mode:n.kolMode||"hot"});n.kolWallet&&a.set("wallet",n.kolWallet),t&&a.set("force","true");const r=await k(`/api/web/kols/dump-stats?${a.toString()}`,{timeoutMs:t?5e3:3e3,preserveSafeError:!0});return n.kolDumpStats=r,n.kolDumpStatsLoadedAt=Date.now(),ne(r.cacheHit?"kolStatsCacheHit":"kolStatsCacheMiss"),r}catch{return n.kolDumpStats=n.kolDumpStats||{stats:[],message:"KOL dump stats unavailable. Showing local low-data fallback."},n.kolDumpStatsLoadedAt=Date.now(),null}finally{n.kolDumpStatsLoading=!1,n.kolDumpDetails?.open?po():n.activeTab==="kol"&&h({force:!0})}}function Nb(e=""){const t=String(e||"").trim();!t||!_("kolDumpDetectorEnabled",!0)||(n.kolDumpDetails={open:!0,kolId:t},_a(),po(),Ii({force:!0}))}function Oi(){n.kolDumpDetails={open:!1,kolId:""},po(),Er()}function po(){let e=document.querySelector("[data-kol-dump-drawer-root]");e||(e=document.createElement("div"),e.dataset.kolDumpDrawerRoot="true",document.body.appendChild(e));const t=n.kolDumpDetails||{},a=!!(t.open&&t.kolId);if(document.body.classList.toggle("kol-dump-drawer-open",a),!a||!_("kolDumpDetectorEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=uo().find(d=>String(d.kolId)===String(t.kolId))||Wb(t.kolId),o=!!n.kolDumpStatsLoading,s=Array.isArray(r.walletAddresses)?r.walletAddresses.filter(Boolean).slice(0,4):[],c=Array.isArray(r.externalLinks)?r.externalLinks.filter(d=>/^https?:\/\//i.test(String(d?.url||""))).slice(0,4):[],l=r.lastTokenMint?`${r.lastTokenSymbol?`${r.lastTokenSymbol} `:""}${w(r.lastTokenMint)}`:"n/a",u=`
  ...
  `;fr(e,u,".kol-dump-drawer")}function _b(){const e=n.kolScan?.configured!==!1,t=n.kolLoading?"disabled":"",a=String(n.kolMode||"hot"),r=!!n.kolScan,o=!!n.kolScan?.kols?.length,s=o&&a!=="hot",c=!r&&!o;return`
    ...
    ${Ub()}
    ${s?Kb():c?wg():""}
    ${n.kolMode==="slimewire"&&n.kolScan?n.kolScan.kols?.length?"":O("No SlimeWire traders yet","Traders appear here only after they opt in from Profile and have site trade history."):n.kolScan?Vb():O("No KOL scan loaded","Pick a KOL mode or tap Refresh.")}
      ...
      <aside class="trade-side">
        <article>
          ...
          <div class="card-actions">
            ...
            ${n.kolWallet?je(Pu(n.kolWallet),"Share KOL"):""}
          </div>
        </article>
        <article>
          <h3>KOL Tools</h3>
  ...
  `}function Ub(){const e=n.kolScan||null,t=tr(n.kolMode),a=n.kolLoading?`Scanning ${t}`:e?`${t} loaded`:`Pick ${t} or tap Refresh`,r=Number(e?.kolCount||e?.kols?.length||0),o=Number(e?.rows?.length||0),s=n.kolLastUpdatedAt?we(n.kolLastUpdatedAt):"Not run";return`
  ...
  `}function Vb(){const e=n.kolScan||{};if(e.configured===!1)return O("KOL Tracker is not connected yet",e.message||"Use Scan Wallet for a public wallet, or try again later.");const t=e.rows||[],a=at("kol",t);return t.length?`
...
`)}async function iy(e){const t=m("[data-wallet-sweep-status]");n.walletSweepStatus="Running wallet action...",v(t,n.walletSweepStatus),$("");try{await Y(t,"Opening secure web profile...");const r={"sweep-sol":"/api/web/wallets/sweep-sol","sweep-tokens":"/api/web/wallets/sweep-tokens","sell-all":"/api/web/wallets/sell-all-tokens","sell-all-sweep":"/api/web/wallets/sell-all-tokens","send-sol-many":"/api/web/wallets/send-sol"}[e];if(!r)throw new Error("Unknown wallet action.");const o=e==="send-sol-many"?oy():ry();if(e==="sell-all"&&(o.destination=""),e==="sell-all-sweep"&&!o.destination)throw new Error("Enter a destination wallet for Sell Tokens + Send SOL.");const s=await k(r,{method:"POST",body:JSON.stringify(o),timeoutMs:te});n.walletSweepStatus=sy(s.sweep),v(t,n.walletSweepStatus),await Ne({force:!0,deep:!0}),n.activeTab="wallets",h()}catch(a){n.walletSweepStatus=a.message,v(t,a.message),$(a.message)}}async function ly(e){const t=m("[data-restore-status]"),a=m("[data-restore-text]"),r=e?.files?.[0];if(!(!r||!a)){v(t,"Reading backup file...");try{a.value=await r.text(),v(t,"Backup loaded. Tap Restore Wallets.")}catch(o){v(t,`Could not read file: ${o.message}`)}}}function fe(e,t){const a=new Blob([t],{type:"text/plain"}),r=URL.createObjectURL(a),o=document.createElement("a");o.href=r,o.download=e,document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1e4)}async function cy(){const e=m("[data-x-handle]"),t=m("[data-x-status]"),a=Xe(e?.value||"");if(!a){v(t,"Enter a valid X handle first.");return}const r=window.open($i(a),"_blank","noopener,noreferrer");try{v(t,r?`Opening X and saving @${a}...`:`Saving @${a}. Allow popups if X did not open.`),await Y(t,"Creating secure web profile for X sharing...");const o=await k("/api/web/profile/x",{method:"POST",body:JSON.stringify({xHandle:a})});pe(o.user||{...n.user,xHandle:o.profile?.xHandle||a}),Hl(n.xHandle),v(t,`Connected @${n.xHandle}. Share buttons now open X posts with SlimeWire tagged.`),h()}catch(o){v(t,o.message),$(o.message)}}function uy(){const e=m("[data-x-status]"),t=Xe(m("[data-x-handle]")?.value||n.xHandle||""),a=$i(t||n.xHandle);window.open(a,"_blank","noopener,noreferrer"),v(e,t?`Opened X for @${t}. Tap Connect X after checking the handle.`:"Opened X login. Add your handle here after signing in.")}async function dy(){const e=m("[data-x-status]"),t=m("[data-x-handle]");try{if(!n.user||!n.token){n.xHandle="",t&&(t.value=""),Ss(),v(e,"X unlinked. Enter a new handle any time and tap Save X Handle."),h();return}const a=await k("/api/web/profile/x",{method:"POST",body:JSON.stringify({clear:!0})});pe(a.user||{...n.user,xHandle:""}),n.xHandle="",t&&(t.value=""),Ss(),v(e,"X unlinked. Enter a new handle any time and tap Save X Handle."),h()}catch(a){v(e,a.message),$(a.message)}}async function go(e,t="Saving PFP..."){const a=m("[data-avatar-status]");v(a,t);try{await Y(a,"Creating secure web profile for PFP...");const r=await k("/api/web/profile/avatar",{method:"POST",body:JSON.stringify(e)});pe(r.user||{...n.user,avatar:r.profile?.avatarDataUrl||r.profile?.avatarUrl||"",avatarSource:r.profile?.avatarSource||"",avatarUpdatedAt:r.profile?.avatarUpdatedAt||""}),v(a,n.user.avatar?"PFP saved.":"PFP removed."),h()}catch(r){v(a,r.message),$(r.message)}}async function py(e){const t=m("[data-avatar-status]"),a=e?.files?.[0];if(a){if(!/^image\/(png|jpe?g|webp)$/i.test(a.type)){v(t,"Use a PNG, JPG, or WebP image.");return}if(a.size>5*1024*1024){v(t,"Use an image under 5 MB.");return}try{v(t,"Compressing PFP...");const r=await cd(a);await go({avatarDataUrl:r},"Saving compressed PFP...")}catch(r){v(t,r.message),$(r.message)}finally{e.value=""}}}function cd(e){return new Promise((t,a)=>{const r=new FileReader;r.onerror=()=>a(new Error("Could not read that image.")),r.onload=()=>{const o=new Image;o.onerror=()=>a(new Error("Could not load that image.")),o.onload=()=>{const c=document.createElement("canvas");c.width=256,c.height=256;const l=c.getContext("2d");if(!l){a(new Error("This browser cannot resize images."));return}const u=Math.max(256/o.width,256/o.height),d=Math.round(o.width*u),p=Math.round(o.height*u),f=Math.round((256-d)/2),y=Math.round((256-p)/2);l.clearRect(0,0,256,256),l.drawImage(o,f,y,d,p);const g=c.toDataURL("image/jpeg",.84);if(g.length>22e4){a(new Error("Compressed PFP is still too large. Try a simpler image."));return}t(g)},o.src=String(r.result||"")},r.readAsDataURL(e)})}async function my(e){const t=document.querySelector('script[src*="app.js"]')?.src||document.baseURI||window.location.href,a=new URL(String(e||""),t).toString(),r=await fetch(a,{cache:"force-cache"});if(!r.ok)throw new Error("Could not load that preset PFP.");const o=await r.blob();return cd(o)}async function fy(){const e=ki(n.xHandle);if(!e){const t=m("[data-avatar-status]");v(t,"Connect an X handle first.");return}await go({avatarUrl:e,avatarSource:"x"},"Saving X PFP...")}async function ud(e,t={}){const a=In(),r=me(e);if(!r){if(await Sc(e,t)||kc(e))return;const o=uc(e);re(o),Rt(e,new Error(o),{action:"provider_missing",platform:Ke()?"mobile":"desktop"});return}try{const o=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(o){if(!(t.confirmSwitch===!1?!0:await Le({title:"Reconnect or Switch Wallet",lines:[`Current wallet: ${w(o)}`,"Your wallet extension will open so you can approve the wallet to use on Live Terminal."],confirmLabel:"Open Wallet"}))){re("Wallet connection unchanged."),$e("/terminal","terminal");return}try{await Promise.resolve(r.disconnect?.())}catch{}}re(`Opening ${Ee(e,r)}...`);const c=(await r.connect?.({onlyIfTrusted:!1}))?.publicKey||r.publicKey,l=c?.toBase58?.()||c?.toString?.()||"";if(!l)throw new Error("Wallet connected, but no public address was returned.");await Y(a,"Creating secure web profile for connected wallet...");const u=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({publicKey:l,provider:Ee(e,r)})});pe(u.user||{...n.user,connectedWallet:u.profile?.connectedWallet||null}),n.connectedWalletBalance={publicKey:l,shortPublicKey:w(l),provider:Ee(e,r),tokens:[]},di(`connected:${l}`),n.walletConnectMenuOpen=!1,re(`Connected ${w(l)}. Opening Live Terminal...`),$e(t.returnPath||n.walletConnectReturnPath||"/terminal","terminal"),h({force:!0}),uu("browser-wallet-connect"),Ur("browser-wallet-connect")}catch(o){const s=o.message||"Wallet connection was cancelled.";re(s),Rt(e,o,{action:"connect_failed"})}}async function dd(){await Vu("disconnecting");const e=In(),t=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(!n.user||!n.token){n.connectedWalletBalance=null,di(t?`connected:${t}`:""),re("Connected wallet disconnected."),h({force:!0});return}try{const a=n.user?.connectedWallet?.provider||"";await(a.toLowerCase().includes("phantom")?me("phantom"):a.toLowerCase().includes("solflare")?me("solflare"):a.toLowerCase().includes("backpack")?me("backpack"):me("solana"))?.disconnect?.()}catch{}try{const a=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({clear:!0})});pe(a.user||{...n.user,connectedWallet:null}),n.connectedWalletBalance=null,di(t?`connected:${t}`:""),re("Connected wallet disconnected."),h({force:!0})}catch(a){re(a.message),$(a.message)}}async function hy(){const e=m("[data-profile-username]"),t=m("[data-profile-password]"),a=m("[data-login-security-status]"),r=String(e?.value||"").trim(),o=String(t?.value||"");if(!r||!o){v(a,"Enter a username and password first.");return}try{await Y(a,"Creating secure web profile..."),v(a,"Saving login...");const s=await k("/api/web/profile/credentials",{method:"POST",body:JSON.stringify({username:r,password:o})});pe(s.user||{...n.user,username:r,hasPasswordLogin:!0}),t&&(t.value=""),v(a,"Saved. You can now log back in with this username and password."),h()}catch(s){v(a,s.message),$(s.message)}}function Xe(e){return String(e||"").trim().replace(/^@+/,"").replace(/[^a-z0-9_]/gi,"").slice(0,15)}function Di(e){const t=yi(e),a=String(n.user?.referralLink||"").trim(),r=a&&!t.includes("/r/")?a:Ct,o=`https://twitter.com/intent/tweet?text=${encodeURIComponent(t)}&url=${encodeURIComponent(r)}`;window.open(o,"_blank","noopener,noreferrer")}function pd(e){const t=e==="kol",a=m(t?"[data-share-watch-kol]":"[data-share-watch-token]"),r=m("[data-share-watch-status]"),o=a?.value?.trim()||"";if(!o){v(r,t?"Enter a KOL handle or wallet first.":"Enter a coin, ticker, or CA first.");return}Di(t?Pu(o):vi(o)),v(r,t?"KOL watch post opened in X.":"Coin watch post opened in X.")}async function md(e){const t={};n.token&&(t.Authorization=`Bearer ${n.token}`);const a=await Mn(Ka(`/api/web/pnl/card?tokenMint=${encodeURIComponent(e)}`),{headers:t,cache:"no-store"},3e4);if(!a.ok){const r=await cc(a);throw new Error(r.message||r.error||`Could not build PnL card (${a.status}).`)}return{blob:await a.blob(),filename:a.headers.get("x-ogre-filename")||`pnl-card-${w(e)}.png`}}async function fd(e){const{blob:t,filename:a}=await md(e),r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=a,document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1e4)}async function gy(e,t){try{const{blob:a,filename:r}=await md(e),o=new File([a],r,{type:"image/png"});if(navigator.canShare?.({files:[o]})){await navigator.share({title:"SlimeWire PnL Card",text:yi(t),url:Ct,files:[o]});return}await fd(e),Di(`${t} PnL card downloaded and ready to attach.`)}catch(a){$(a.message)}}function hd(e="buy"){const t=m("[data-trade-wallet]")?.value||"",a=lh(e)||m("[data-trade-token]")?.value?.trim()||"",r=x("[data-trade-slippage]","[data-trade-slippage-custom]","400");if(!t)throw new Error("Choose a wallet first.");if(!a)throw new Error("Paste a token CA first.");return n.tradeToken=a,e==="sell"?(n.tradeSwapFrom=a,n.tradeSwapTo="SOL"):(n.tradeSwapFrom="SOL",n.tradeSwapTo=a),{walletIndex:t,tokenMint:a,slippageBps:r}}function ce(e=""){return String(e||"").trim().toLowerCase()==="connected"}function by(e={}){if(!e?.sessionWallet||e.sessionStatus!=="funded")return!1;const t=Date.parse(e.sessionExpiresAt||"");return!Number.isFinite(t)||t>Date.now()}function gd(){const e=Array.isArray(n.wallets)?n.wallets:[];for(let t=e.length-1;t>=0;t-=1)if(by(e[t]))return e[t];return null}function bd(e=le()){if(!e?.publicKey)return!1;const t=ar(e),a=me(t)||me("solana");return!!(a&&typeof a.signTransaction=="function")}function bo(e=le()){const t=e?.provider||Ee(ar(e));return`${t} is connected, but this mobile browser cannot sign trades after the wallet-app handoff. Open SlimeWire inside the ${t} in-app browser, or fund a Session Wallet once so buys, sells, TP/SL, and Ogre A.I. can run without reconnect loops.`}function yo(e={},{side:t="trade",statusWriter:a=he,allowSessionFallback:r=!0}={}){if(!ce(e.walletIndex))return{form:e,sessionWallet:null};if(bd())return{form:e,sessionWallet:null};const o=r?gd():null;if(o?.index){const s=`Using Session Wallet ${o.index} for ${t}; mobile wallet signing is not available in this browser.`;return typeof a=="function"&&a(s),{form:{...e,walletIndex:String(o.index)},sessionWallet:o}}throw new Error(bo())}function yd(e){const t=[];for(let r=0;r<e.length;r+=32768)t.push(String.fromCharCode(...e.subarray(r,r+32768)));return btoa(t.join(""))}function vd(e=""){const t=atob(String(e||"")),a=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)a[r]=t.charCodeAt(r);return a}function ar(e=le()){const t=String(e?.provider||"").trim().toLowerCase();return t.includes("phantom")?"phantom":t.includes("solflare")?"solflare":t.includes("backpack")?"backpack":"solana"}async function yy(e=le(),{returnPath:t=za()||"/terminal/trade"}={}){const a=ar(e),r=e?.provider||Ee(a);if(ua({returnPath:t}),Ke()&&e?.publicKey&&!me(a)){const s=bo(e);return re(s),s}if(wc(a)){const s=`${r} needs to reconnect before it can sign here. Opening ${r} mobile connect now.`;if(re(s),await Sc(a,{returnPath:t}).catch(()=>!1))return s}if(kc(a))return`Opening ${r}. Use the wallet browser to reconnect and approve the trade.`;const o=uc(a);return re(o),o}async function wd(){const e=le();if(!e?.publicKey)throw new Error("Connect Phantom, Solflare, or another wallet before trading.");const t=ar(e),a=me(t)||me("solana");if(!a){if(Ke()&&e?.publicKey)throw new Error(bo(e));const s=await yy(e,{returnPath:za()||"/terminal/trade"});throw new Error(s)}if(typeof a.signTransaction!="function")throw Ke()&&e?.publicKey?new Error(bo(e)):new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const r=()=>a.publicKey?.toBase58?.()||a.publicKey?.toString?.()||"";let o=r();if(o!==e.publicKey)try{const s=await a.connect?.({onlyIfTrusted:!0});o=s?.publicKey?.toBase58?.()||s?.publicKey?.toString?.()||r()}catch{}if(o!==e.publicKey){const s=await a.connect?.({onlyIfTrusted:!1}),c=s?.publicKey?.toBase58?.()||s?.publicKey?.toString?.()||r();if(c!==e.publicKey)throw new Error(`Wallet mismatch. SlimeWire has ${w(e.publicKey)} connected, but the browser returned ${w(c)}. Reconnect the wallet you want to trade with.`)}return{provider:a,connected:e}}async function vy(){try{if(Ke())return;const e=le();if(!e?.publicKey)return;const t=ar(e),a=me(t)||me("solana");if(!a||typeof a.connect!="function"||(a.publicKey?.toBase58?.()||a.publicKey?.toString?.()||"")===e.publicKey)return;await a.connect({onlyIfTrusted:!0}).catch(()=>{})}catch{}}const wy=6e4;async function Sd(e,t,a=wy){let r=0;const o=new Promise((s,c)=>{r=window.setTimeout(()=>{c(new Error("Wallet approval timed out. Reopen your wallet and try the trade again."))},a)});try{return await Promise.race([Promise.resolve(e.signTransaction(t)),o])}finally{window.clearTimeout(r)}}async function Sy(e,t){if(!e||typeof e!="string")throw new Error("SlimeWire could not build a wallet approval transaction. Try again or choose another token.");if(!window.solanaWeb3?.VersionedTransaction)throw new Error("Solana wallet signing library did not load. Refresh the page and try again.");if(typeof t.signTransaction!="function")throw new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const a=window.solanaWeb3.VersionedTransaction.deserialize(vd(e)),r=await Sd(t,a);return yd(r.serialize())}async function ky(e,t){if(!e||typeof e!="string")throw new Error("SlimeWire could not build a wallet approval transaction. Try again.");if(!window.solanaWeb3?.Transaction)throw new Error("Solana wallet signing library did not load. Refresh the page and try again.");if(typeof t.signTransaction!="function")throw new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const a=window.solanaWeb3.Transaction.from(vd(e)),r=await Sd(t,a);return yd(r.serialize())}function $y({side:e,connected:t,form:a={},actionDetail:r="",amountSol:o="",amountMode:s="",percent:c=""}={}){const l=e==="sell"?"Sell":"Buy",u=`${t?.provider||"Connected wallet"} ${t?.publicKey?w(t.publicKey):""}`.trim(),d=e==="sell"?`${c||r||"100"}%`:s==="max"?"Max SOL":`${o||r||"custom"} SOL`;return Le({title:`Confirm ${l}`,lines:[`${l} with ${u}?`,`Token: ${a.tokenMint||""}`,`Amount: ${d}`,"Next step: approve the transaction in your wallet."],confirmLabel:l})}async function nr({side:e,form:t,actionDetail:a,amountSol:r="",amountMode:o="",percent:s="",attemptId:c,statusWriter:l=he}){const u=typeof l=="function"?l:he,{provider:d,connected:p}=await wd();if(!n.walletFastApprovalsEnabled&&!await $y({side:e,connected:p,form:t,actionDetail:a,amountSol:r,amountMode:o,percent:s}))throw new Error("Connected-wallet trade cancelled.");om(`${e==="buy"?"Buy":"Sell"} ${w(t.tokenMint||"")}`),Be("submitted","pending"),u(n.walletFastApprovalsEnabled?`Building ${e} approval for ${p.provider||"your wallet"}...`:`Preparing ${e} approval...`);const f=await k("/api/web/browser-trade/order",{method:"POST",body:JSON.stringify({side:e,tokenMint:t.tokenMint,walletPublicKey:p.publicKey,slippageBps:t.slippageBps,amountSol:r,amountMode:o,percent:s,tradeAttemptId:c}),dedupe:!1,timeoutMs:te});Be("submitted","ok"),Be("approved","pending",`Approve in ${p.provider||"your wallet"}`),u(`Approve ${e} in ${p.provider||"your wallet"}...`);let y;try{y=await Sy(f.order?.transaction,d)}catch(S){throw Be("approved","fail",N(S?.message||"Wallet approval was declined.")),S}Be("approved","ok"),Be("sent","pending"),u("Submitting signed trade...");let g;try{g=await k("/api/web/browser-trade/execute",{method:"POST",body:JSON.stringify({browserTradeAttemptId:f.order?.browserTradeAttemptId,signedTransaction:y}),dedupe:!1,timeoutMs:te})}catch(S){throw V(e==="buy"?"trade-buy":"trade-sell",t.tokenMint,a,{state:"error",error:N(S?.message||"Trade submit failed.")}),K("",`browser-${e}-error`,{tradeAttemptId:c}),Be("sent","fail",N(S?.message||"Submit failed - it may still have landed; positions are being re-checked.")),u(`${e==="buy"?"Buy":"Sell"} submit failed or timed out - re-checking your wallet in case the trade landed...`),S}return Be("sent","ok"),Be("confirmed",g.trade?.signature?"ok":"pending",g.trade?.signature?`tx ${String(g.trade.signature).slice(0,8)}...`:""),n.tradeResult=g.trade,u(g.trade?.message||`${e==="buy"?"Buy":"Sell"} submitted from connected wallet.`),V(e==="buy"?"trade-buy":"trade-sell",t.tokenMint,a,{state:"submitted",signature:g.trade?.signature||""}),K(g.trade?.signature,`browser-${e}`,{tradeAttemptId:c}),g.trade}function _e(e){const t=String(e||"").trim().toLowerCase();return!!t&&!["0","off","none","no","disabled"].includes(t)}function sn(e,t){const a=String(t||"").trim().toLowerCase();return["0","off","none","no","disabled"].includes(a)?{sellDelay:"off",sellPercent:"100"}:{sellDelay:e,sellPercent:t}}function Ty(){const e=x("[data-trade-auto-tp]","[data-trade-auto-tp-custom]","25"),t=x("[data-trade-auto-sl]","[data-trade-auto-sl-custom]","8");let a=x("[data-trade-auto-delay]","[data-trade-auto-delay-custom]","off"),r=x("[data-trade-auto-sell-percent]","[data-trade-auto-sell-percent-custom]","100");return{sellDelay:a,sellPercent:r}=sn(a,r),{enabled:_e(e)||_e(t)||_e(a),takeProfitPct:e,stopLossPct:t,sellDelay:a,sellPercent:r}}function kd(){const e=x("[data-chart-buy-tp]","[data-chart-buy-tp-custom]","25"),t=x("[data-chart-buy-sl]","[data-chart-buy-sl-custom]","8");let a=x("[data-chart-buy-delay]","[data-chart-buy-delay-custom]","off"),r=x("[data-chart-buy-sell-percent]","[data-chart-buy-sell-percent-custom]","100");return{sellDelay:a,sellPercent:r}=sn(a,r),{enabled:_e(e)||_e(t)||_e(a),takeProfitPct:e,stopLossPct:t,sellDelay:a,sellPercent:r}}function he(e){const t=m("[data-trade-status]");v(t,e)}function Fe(e=""){n.chartTradeStatus=String(e||""),v(m("[data-chart-trade-status]"),n.chartTradeStatus)}function Ni(e="",t=""){n.quickBuyModal={...n.quickBuyModal,status:String(e||""),error:String(t||"")};const a=m("[data-quick-buy-modal-status]"),r=m("[data-quick-buy-modal-error]");v(a,n.quickBuyModal.status),v(r,n.quickBuyModal.error),a&&(a.hidden=!n.quickBuyModal.status),r&&(r.hidden=!n.quickBuyModal.error)}async function vo(e,t="fixed"){const a=L();let r=t==="max"?"max":String(e||"custom"),o="";try{let s=hd("buy");r=t==="max"?"max":String(e||"custom");const c=tt("trade-buy",s.tokenMint,r);if(c){ne("buttonDoubleClickPrevented"),W({component:"post-trade",action:"trade-action-dedupe",durationMs:L()-a,cacheHit:!0,requestId:c.tradeAttemptId||"",details:`trade-buy:${w(s.tokenMint)}:${r}`});return}o=gt("trade-buy");const l={tokenMint:s.tokenMint,walletIndex:s.walletIndex,slippageBps:s.slippageBps,tradeAttemptId:o},u=Md();if((_e(u.takeProfitPct)||_e(u.stopLossPct)||_e(u.sellDelay))&&Object.assign(l,{autoExit:!0,...u}),t==="max")l.amountMode="max";else{const S=Number(e);if(!Number.isFinite(S)||S<=0)throw new Error("Enter a buy amount greater than zero.");l.amountSol=String(S)}if(s=yo(s,{side:"buy",statusWriter:he}).form,l.walletIndex=s.walletIndex,ce(s.walletIndex)){V("trade-buy",s.tokenMint,r,{state:"clicked",tradeAttemptId:o,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"browser-trade-click-to-ui",durationMs:L()-a,requestId:o,details:`browser-buy:${w(s.tokenMint)}:${r}`}),he("Building wallet-approved buy..."),ie(),await nr({side:"buy",form:s,actionDetail:r,amountSol:l.amountSol||"",amountMode:l.amountMode||"fixed",attemptId:o}),n.activeTab="trade",h({preserveSmartChartFrame:n.activeTab==="smartChart"}),Pe("trade-buy",s.tokenMint,r,3e3);return}const f=Ty();f.enabled&&Object.assign(l,{autoExit:!0,takeProfitPct:f.takeProfitPct,stopLossPct:f.stopLossPct,sellDelay:f.sellDelay,sellPercent:f.sellPercent}),V("trade-buy",s.tokenMint,r,{state:"clicked",tradeAttemptId:o,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"trade-click-to-ui",durationMs:L()-a,requestId:o,details:`trade-buy:${w(s.tokenMint)}:${r}`}),h(),he(f.enabled?"Sending buy and arming auto-exit...":"Sending buy..."),await Ce(20);const y=L();V("trade-buy",s.tokenMint,r,{state:"submitting"});const g=await k("/api/web/trade/buy",{method:"POST",body:JSON.stringify({...l,clientClickToUiMs:Math.round(y-a)}),dedupe:!1});W({component:"post-trade",action:"trade-backend-ack",durationMs:L()-y,requestId:o,resultCount:g.trade?.signature?1:0,details:"trade-buy"}),n.tradeResult=g.trade,om(`Buy ${w(s.tokenMint||"")}`),Be("submitted","ok"),Be("sent","ok"),Be("confirmed",g.trade?.signature?"ok":"pending",g.trade?.signature?`tx ${String(g.trade.signature).slice(0,8)}...`:""),g.trade?.autoExitPlan?(Be("armed","ok"),n.tradePlanResult=g.trade.autoExitPlan,he(g.trade.autoExitPlan.shortMessage||"Buy landed and auto-exit is armed."),ho()):g.trade?.autoExitRequested&&(Be("armed","fail","Auto-exit was NOT armed - exit manually or create a managed plan."),he("Buy landed, but auto-exit was not armed. Use Positions to exit manually or create a managed plan.")),V("trade-buy",s.tokenMint,r,{state:"submitted",signature:g.trade?.signature||""}),K(g.trade?.signature,"trade-buy",{tradeAttemptId:o}),n.activeTab="trade",h(),Pe("trade-buy",s.tokenMint,r,3e3)}catch(s){o&&(V("trade-buy",n.tradeToken||m("[data-trade-token]")?.value||"",r,{state:"error",error:N(s.message||"Buy failed")}),Pe("trade-buy",n.tradeToken||m("[data-trade-token]")?.value||"",r,4e3)),W({component:"post-trade",action:"trade-action-error",durationMs:L()-a,requestId:o,errorCode:s?.code||s?.name||"TRADE_BUY_FAILED",details:N(s.message||"Buy failed")}),he(s.message)}}async function _i(e){const t=L(),a=gt("manual-sell");let r=null,o=String(e||"custom");try{r=hd("sell");const s=Number.parseInt(e,10);if(o=String(s||o),!Number.isInteger(s)||s<1||s>100)throw new Error("Sell percent must be from 1 to 100.");const c=tt("trade-sell",r.tokenMint,o);if(c){ne("buttonDoubleClickPrevented"),W({component:"manual-sell",action:"manual-sell-dedupe",durationMs:L()-t,cacheHit:!0,requestId:c.tradeAttemptId||"",details:`${w(r.tokenMint)}:${s}`});return}if(V("trade-sell",r.tokenMint,o,{state:"clicked",tradeAttemptId:a,clickedAt:new Date().toISOString()}),he("Sending sell..."),W({component:"manual-sell",action:"manual-sell-click-to-ui",durationMs:L()-t,requestId:a,details:`${w(r.tokenMint)}:${s}`}),r=yo(r,{side:"sell",statusWriter:he}).form,ce(r.walletIndex)){ie();const p=L();V("trade-sell",r.tokenMint,o,{state:"submitting"}),await nr({side:"sell",form:r,actionDetail:o,percent:String(s),attemptId:a}),W({component:"manual-sell",action:"browser-sell-request",durationMs:L()-p,requestId:a,resultCount:n.tradeResult?.signature?1:0,details:"browser-wallet"}),n.activeTab="trade",h({preserveSmartChartFrame:n.activeTab==="smartChart"}),Pe("trade-sell",r.tokenMint,o,3e3);return}h(),await Ce(20);const u=L();V("trade-sell",r.tokenMint,o,{state:"submitting"});const d=await k("/api/web/trade/sell",{method:"POST",body:JSON.stringify({tokenMint:r.tokenMint,walletIndex:r.walletIndex,slippageBps:r.slippageBps,percent:s,manualSellAttemptId:a,clientClickToUiMs:Math.round(u-t)}),timeoutMs:te,dedupe:!1});W({component:"manual-sell",action:"manual-sell-request",durationMs:L()-u,requestId:a,resultCount:d.trade?.signature?1:0,details:"single-wallet"}),n.tradeResult=d.trade,he(d.trade?.signature?"Submitted. Refreshing position in the background...":"Sell submitted. Refreshing position in the background..."),V("trade-sell",r.tokenMint,o,{state:"submitted",signature:d.trade?.signature||""}),K(d.trade?.signature||xe(d.trade),"manual-sell-trade"),n.activeTab="trade",h(),Pe("trade-sell",r.tokenMint,o,3e3)}catch(s){r?.tokenMint&&(V("trade-sell",r.tokenMint,o,{state:"error",error:N(s.message||"Sell failed")}),Pe("trade-sell",r.tokenMint,o,4e3)),W({component:"manual-sell",action:"manual-sell-error",durationMs:L()-t,requestId:a,errorCode:s?.code||s?.name||"MANUAL_SELL_FAILED",details:N(s.message||"Sell failed")}),he(s.message)}}function Ay(){const e=Ue("trade-plan"),t=m("[data-trade-plan-group]")?.value?.trim()||"",a=m("[data-trade-token]")?.value?.trim()||"",r=x("[data-trade-plan-amount]","[data-trade-plan-amount-custom]","0.1"),o=x("[data-trade-plan-tp]","[data-trade-plan-tp-custom]","25"),s=x("[data-trade-plan-sl]","[data-trade-plan-sl-custom]","8");let c=x("[data-trade-plan-delay]","[data-trade-plan-delay-custom]","5"),l=x("[data-trade-plan-sell-percent]","[data-trade-plan-sell-percent-custom]","100");({sellDelay:c,sellPercent:l}=sn(c,l));const u=x("[data-trade-plan-slippage]","[data-trade-plan-slippage-custom]","400");if(!e.length&&!t)throw new Error("Choose at least one wallet or enter a group label.");if(!a)throw new Error("Paste a token CA first.");return n.tradeToken=a,n.volumeToken=a,n.bundleToken=a,{walletIndexes:e,walletGroup:t,tokenMint:a,amountSol:r,sellDelay:c,takeProfitPct:o,stopLossPct:s,sellPercent:l,loopCount:"1",loopDelay:"0",slippageBps:u,...ma("trade-plan")}}async function Py(){try{const e=Ay();he("Buying and arming managed exit...");const t=await k("/api/web/trade/plan",{method:"POST",body:JSON.stringify(e)});n.tradePlanResult=t.plan,n.tradeResult=null,K(t.trade?.signature,"trade-plan"),n.activeTab="trade",h()}catch(e){he(e.message)}}function Cy(){const e=Ue("volume"),t=m("[data-volume-group]")?.value?.trim()||"",a=m("[data-volume-token]")?.value?.trim()||"",r=m("[data-volume-amount]")?.value||"";let o=x("[data-volume-delay]","[data-volume-delay-custom]","5");const s=x("[data-volume-tp]","[data-volume-tp-custom]","25"),c=x("[data-volume-sl]","[data-volume-sl-custom]","8"),l=x("[data-volume-loop]","[data-volume-loop-custom]","1"),u=x("[data-volume-loop-delay]","[data-volume-loop-delay-custom]","0");let d=x("[data-volume-sell-percent]","[data-volume-sell-percent-custom]","100");({sellDelay:o,sellPercent:d}=sn(o,d));const p=x("[data-volume-slippage]","[data-volume-slippage-custom]","400");if(!e.length&&!t)throw new Error("Choose at least one wallet or enter a group label.");if(!a)throw new Error("Paste a token CA first.");return n.volumeToken=a,{walletIndexes:e,walletGroup:t,tokenMint:a,amountSol:r,sellDelay:o,takeProfitPct:s,stopLossPct:c,loopCount:l,loopDelay:u,sellPercent:d,slippageBps:p,...ma("volume")}}function $d(e){const t=m("[data-volume-status]");v(t,e)}async function Ly(){try{const e=Cy();$d("Buying and arming plan...");const t=await k("/api/web/volume/plan",{method:"POST",body:JSON.stringify(e)});n.volumeResult=t.plan,K(xe(t.plan),"volume-plan"),n.activeTab="volume",h()}catch(e){$d(e.message)}}function xy(e){const t=Ue("sniper"),a=m("[data-sniper-group]")?.value?.trim()||"",r=m("[data-sniper-amount]")?.value||"",o=x("[data-sniper-delay]","[data-sniper-delay-custom]",n.scanMode==="pumpsnipe"?"3":"5"),s=x("[data-sniper-tp]","[data-sniper-tp-custom]",n.scanMode==="pumpsnipe"?"40":"25"),c=x("[data-sniper-sl]","[data-sniper-sl-custom]","8"),l=x("[data-sniper-loop]","[data-sniper-loop-custom]","1"),u=x("[data-sniper-loop-delay]","[data-sniper-loop-delay-custom]","0"),d=x("[data-sniper-slippage]","[data-sniper-slippage-custom]",n.scanMode==="pumpsnipe"?"300":"400");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!e)throw new Error("Pick a token first.");return n.tradeToken=e,n.volumeToken=e,n.bundleToken=e,{mode:n.scanMode,tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:o,takeProfitPct:s,stopLossPct:c,slippageBps:d,loopCount:l,loopDelay:u,...ma("sniper")}}function Td(e){const t=m("[data-sniper-status]");v(t,e)}async function My(e){try{const t=xy(e);Td("Buying and arming exits...");const a=await k("/api/web/sniper/entry",{method:"POST",body:JSON.stringify(t)});n.sniperResult=a.plan,K(xe(a.plan),"sniper-entry"),n.activeTab="sniper",h()}catch(t){Td(t.message)}}function By(){const e=Ue("ogre-ai"),t=m("[data-ogre-ai-group]")?.value?.trim()||"",a=m("[data-ogre-ai-amount]")?.value?.trim()||"",r=Zr(),o=m("[data-ogre-ai-runs]")?.value||"1",s=m("[data-ogre-ai-tp]")?.value||"25",c=m("[data-ogre-ai-tp-custom]")?.value?.trim()||"",l=m("[data-ogre-ai-sl]")?.value||"8",u=m("[data-ogre-ai-sl-custom]")?.value?.trim()||"",d=m("[data-ogre-ai-delay]")?.value||"5",p=m("[data-ogre-ai-delay-custom]")?.value?.trim()||"",f=m("[data-ogre-ai-slippage]")?.value||"400",y=m("[data-ogre-ai-slippage-custom]")?.value?.trim()||"";zm({amountSol:a,runCount:o,category:r,takeProfitSelect:s,takeProfitCustom:c,stopLossSelect:l,stopLossCustom:u,delaySelect:d,delayCustom:p,slippageSelect:f,slippageCustom:y,walletGroup:t});const g=x("[data-ogre-ai-delay]","[data-ogre-ai-delay-custom]","60"),S=x("[data-ogre-ai-tp]","[data-ogre-ai-tp-custom]","100"),P=x("[data-ogre-ai-sl]","[data-ogre-ai-sl-custom]","40"),T=x("[data-ogre-ai-slippage]","[data-ogre-ai-slippage-custom]","400"),b="";if(!e.length&&!t)throw new Error("Choose at least one managed wallet or enter a group label.");if(!a)throw new Error("Enter SOL per wallet for Ogre A.I.");return{walletIndexes:e,walletGroup:t,category:r,mode:r,amountSol:a,runCount:o,sellDelay:g,takeProfitPct:S,stopLossPct:P,sellPercent:"100",slippageBps:T,minScore:b,recentMints:Kl()}}function wo(e){n.ogreAiStatus=e||"";const t=m("[data-ogre-ai-status]");v(t,n.ogreAiStatus)}async function Ry(){if(Rr){Wa=!0,wo("Stopping the hunt after this scan...");return}const e=Symbol("ogre-ai-run");Wa=!1;try{const t=By();n.ogreAiLoading=!0,Rr=e;const a=Array.isArray(t.recentMints)?[...t.recentMints]:[];let r=null,o=!1,s=0;const c=120;for(;!o&&!Wa&&s<c&&(s+=1,wo(s===1?"Scanning fresh low-MC pairs and arming managed exits...":`Hunting fresh pairs... (scan ${s}) - tap Scan again to stop.`),h(),r=await k("/api/web/ogre-ai/start",{method:"POST",body:JSON.stringify({...t,recentMints:a}),timeoutMs:te}),o=Number(r.ogreAi?.armedCount||0)>0||(r.ogreAi?.plans?.length||0)>0,!o);){for(const l of r.ogreAi?.errors||[])l?.tokenMint&&!a.includes(l.tokenMint)&&a.push(l.tokenMint);for(const l of r.ogreAi?.attemptedPicks||[])l?.tokenMint&&!a.includes(l.tokenMint)&&a.push(l.tokenMint);if(Wa)break;await Ce(5e3)}n.ogreAiResult=r?.ogreAi,Vm(r?.ogreAi),n.tradePlanResult=r?.ogreAi?.plans?.[0]||n.tradePlanResult,wo(o?r?.ogreAi?.message||"Ogre A.I. run armed.":Wa?"Hunt stopped. Tap Scan to hunt again.":"Still hunting - no clean fresh pair armed yet. Tap Scan to keep going."),o&&K(xe(r?.ogreAi?.plans?.[0]),"ogre-ai-run"),n.activeTab="ogreAi",h()}catch(t){wo(t.message),$(t.message)}finally{n.ogreAiLoading=!1,Wa=!1,Rr===e&&(Rr=null),h()}}function rr(e){const t=m("[data-autopilot-status]");t&&(t.textContent=String(e||""))}async function Iy({silent:e=!0}={}){try{const t=await k("/api/web/ogre-ai/autopilot");n.ogreAutopilot=t.autopilot||null,n.activeTab==="ogreAi"&&h()}catch(t){e||rr(t.message)}}function Oy(){return{enabled:!!m("[data-autopilot-enabled]")?.checked,category:Zr(),amountSol:m("[data-ogre-ai-amount]")?.value?.trim()||(n.ogreAutopilot?.amountSol??"0.05"),takeProfitPct:x("[data-ogre-ai-tp]","[data-ogre-ai-tp-custom]","25"),stopLossPct:x("[data-ogre-ai-sl]","[data-ogre-ai-sl-custom]","8"),sellDelay:x("[data-ogre-ai-delay]","[data-ogre-ai-delay-custom]","5"),slippageBps:x("[data-ogre-ai-slippage]","[data-ogre-ai-slippage-custom]","400"),walletIndexes:Ue("ogre-ai"),walletGroup:m("[data-ogre-ai-group]")?.value?.trim()||"",maxSpendPerHourSol:m("[data-autopilot-maxspend]")?.value?.trim()||"0.3",maxConcurrent:m("[data-autopilot-maxconcurrent]")?.value?.trim()||"2",minScore:m("[data-autopilot-minscore]")?.value?.trim()||"62",intervalMinutes:m("[data-autopilot-interval]")?.value?.trim()||"10"}}async function Ey(){if(n.ogreAutopilotBusy)return;const e=Oy();if(e.enabled&&!e.walletIndexes.length&&!e.walletGroup){rr("Pick at least one managed wallet (or a wallet group) above before enabling autopilot.");return}if(!(e.enabled&&!await Le({title:"Enable Ogre A.I. Autopilot",lines:["This will spend REAL SOL automatically.",`Category: ${Nu(e.category)}`,`Up to ${e.amountSol} SOL per wallet, max ${e.maxSpendPerHourSol} SOL/hour, every ${e.intervalMinutes} min.`,`Only buys picks scoring >= ${e.minScore}, max ${e.maxConcurrent} live plans.`,"You can turn it off any time."],confirmLabel:"Enable Autopilot"}))){n.ogreAutopilotBusy=!0,rr(e.enabled?"Arming autopilot...":"Saving..."),h();try{const t=await k("/api/web/ogre-ai/autopilot",{method:"POST",body:JSON.stringify(e)});n.ogreAutopilot=t.autopilot||null,rr(n.ogreAutopilot?.lastStatus||"Saved.")}catch(t){rr(t.message),$(t.message)}finally{n.ogreAutopilotBusy=!1,h()}}}function _t(e){const t=m("[data-kol-status]");v(t,e)}function Fy(e){const t=Ue("kol"),a=m("[data-kol-group]")?.value?.trim()||"",r=m("[data-kol-amount]")?.value||"",o=x("[data-kol-delay]","[data-kol-delay-custom]","5"),s=x("[data-kol-tp]","[data-kol-tp-custom]","25"),c=x("[data-kol-sl]","[data-kol-sl-custom]","8"),l=x("[data-kol-loop]","[data-kol-loop-custom]","1"),u=x("[data-kol-loop-delay]","[data-kol-loop-delay-custom]","0"),d=x("[data-kol-slippage]","[data-kol-slippage-custom]","400");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!e)throw new Error("Pick a KOL signal first.");return n.tradeToken=e,n.volumeToken=e,n.bundleToken=e,{tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:o,takeProfitPct:s,stopLossPct:c,loopCount:l,loopDelay:u,sellPercent:"100",slippageBps:d,...ma("kol")}}function Wy(e){const t=Ue("kol"),a=m("[data-kol-group]")?.value?.trim()||"",r=m("[data-kol-amount]")?.value||"",o=x("[data-kol-delay]","[data-kol-delay-custom]","5"),s=x("[data-kol-tp]","[data-kol-tp-custom]","25"),c=x("[data-kol-sl]","[data-kol-sl-custom]","8"),l=x("[data-kol-loop]","[data-kol-loop-custom]","1"),u=x("[data-kol-loop-delay]","[data-kol-loop-delay-custom]","0"),d=x("[data-kol-slippage]","[data-kol-slippage-custom]","400"),p=String(e||n.kolWallet||m("[data-kol-wallet]")?.value||"").trim();if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!p)throw new Error("Paste or choose a KOL wallet first.");if(!Wt(p))throw new Error("That KOL entry does not have a verified Solana wallet yet.");return{copyWallet:p,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:o,takeProfitPct:s,stopLossPct:c,loopCount:l,loopDelay:u,sellPercent:"100",slippageBps:d,...ma("kol")}}async function Dy(e){try{const t=Fy(e);_t("Buying and arming KOL copy plan...");const a=await k("/api/web/kol/entry",{method:"POST",body:JSON.stringify(t)});n.kolResult=a.plan,K(xe(a.plan),"kol-copy-plan"),n.activeTab="kol",h()}catch(t){_t(t.message)}}async function Ny(e){try{const t=Wy(e);_t("Arming Copy Wallet watch...");const a=await k("/api/web/kol/copy-wallet",{method:"POST",body:JSON.stringify(t)});n.kolResult=a.plan,n.kolWallet=t.copyWallet,n.activeTab="kol",h()}catch(t){_t(t.message)}}function Ue(e){return[...document.querySelectorAll(`[data-${e}-wallet]:checked`)].map(t=>t.value)}function So(e){const t=m("[data-bundle-status]");v(t,e)}function Ad(){const e=m("[data-bundle-token]")?.value?.trim()||"",t=Ue("bundle"),a=m("[data-bundle-group]")?.value?.trim()||"",r=m("[data-bundle-amount]")?.value||"",o=x("[data-bundle-percent]","[data-bundle-percent-custom]","100"),s=x("[data-bundle-slippage]","[data-bundle-slippage-custom]","400");if(!e)throw new Error("Paste a token CA first.");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");return n.bundleToken=e,{tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,percent:o,slippageBps:s}}function _y(){const e=Ad();let t=x("[data-bundle-plan-delay]","[data-bundle-plan-delay-custom]","5"),a=x("[data-bundle-plan-sell-percent]","[data-bundle-plan-sell-percent-custom]","100");return{sellDelay:t,sellPercent:a}=sn(t,a),{...e,sellDelay:t,takeProfitPct:x("[data-bundle-plan-tp]","[data-bundle-plan-tp-custom]","60"),stopLossPct:x("[data-bundle-plan-sl]","[data-bundle-plan-sl-custom]","10"),loopCount:x("[data-bundle-plan-loop]","[data-bundle-plan-loop-custom]","1"),loopDelay:x("[data-bundle-plan-loop-delay]","[data-bundle-plan-loop-delay-custom]","0"),sellPercent:a,...ma("bundle-plan")}}async function Pd(e){const t=L();let a=null,r="";const o=e==="buy"?"bundle-buy":"bundle-sell";try{a=Ad();const s=tt(o,a.tokenMint,"bundle");if(s){ne("buttonDoubleClickPrevented"),W({component:"post-trade",action:"trade-action-dedupe",durationMs:L()-t,cacheHit:!0,requestId:s.tradeAttemptId||"",details:`${o}:${w(a.tokenMint)}`});return}r=gt(o),V(o,a.tokenMint,"bundle",{state:"clicked",tradeAttemptId:r,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"trade-click-to-ui",durationMs:L()-t,requestId:r,details:`${o}:${w(a.tokenMint)}`}),h(),So(e==="buy"?"Sending bundle buy...":"Sending bundle sell..."),await Ce(20);const c=L();V(o,a.tokenMint,"bundle",{state:"submitting"});const l=await k(`/api/web/bundle/${e}`,{method:"POST",body:JSON.stringify({...a,tradeAttemptId:r,clientClickToUiMs:Math.round(c-t)}),dedupe:!1});W({component:"post-trade",action:"trade-backend-ack",durationMs:L()-c,requestId:r,resultCount:l.bundle?.successCount||0,details:o}),n.bundleResult=l.bundle,V(o,a.tokenMint,"bundle",{state:"submitted",signature:xe(l.bundle)}),K(xe(l.bundle),`bundle-${e}`,{tradeAttemptId:r}),n.activeTab="bundle",h(),Pe(o,a.tokenMint,"bundle",3e3)}catch(s){a?.tokenMint&&(V(o,a.tokenMint,"bundle",{state:"error",error:N(s.message||"Bundle trade failed")}),Pe(o,a.tokenMint,"bundle",4e3)),W({component:"post-trade",action:"trade-action-error",durationMs:L()-t,requestId:r,errorCode:s?.code||s?.name||"BUNDLE_TRADE_FAILED",details:N(s.message||"Bundle trade failed")}),So(s.message)}}async function Uy(){try{const e=_y();So("Buying and arming bundle exits...");const t=await k("/api/web/bundle/plan",{method:"POST",body:JSON.stringify(e)});n.bundleResult=t.plan,K(xe(t.plan),"bundle-plan"),n.activeTab="bundle",h()}catch(e){So(e.message)}}function oe(e,t){return(n.presets?.[e]||[]).find(a=>a.id===t)||null}function Cd(){(n.selectedTradePresetId==="custom"||n.selectedTradePresetId&&!oe("trade",n.selectedTradePresetId))&&(n.selectedTradePresetId=""),(n.selectedBundlePresetId==="custom"||n.selectedBundlePresetId&&!oe("bundle",n.selectedBundlePresetId))&&(n.selectedBundlePresetId=""),n.editingTradePresetId&&!oe("trade",n.editingTradePresetId)&&(n.editingTradePresetId=""),n.editingBundlePresetId&&!oe("bundle",n.editingBundlePresetId)&&(n.editingBundlePresetId="")}function Ld(e,t="trade",a=""){t==="bundle"?n.bundleToken=e:n.tradeToken=e,n.activeTab=t,a&&$(a),window.history.pushState({},"","/terminal"),h({force:!0})}async function xd(e=""){const t=String(e||"").trim();if(!t)return;const a=t.replace(/^\$+/,"").trim(),r=/^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(a),o=(s,c={})=>wt(ge(s,{source:"global-search",...c}),{defaultTab:"buy",view:"chartTxns",focusAmountInput:!0,source:"global-search"});if(r){o(a);return}try{const c=((await k(`/api/web/token-search?q=${encodeURIComponent(t)}`)).matches||[])[0];if(!c?.tokenMint){$(`No coin found for "${t}". Try the exact ticker or paste the contract address.`);return}o(c.tokenMint,{symbol:c.symbol,name:c.name})}catch(s){$(s.message||"Token search failed.")}}function ge(e="",t={}){const a=String(e||"").trim(),r=a?or().find(o=>String(o?.tokenMint||"")===a):null;return{chain:"solana",tokenMint:a,tokenAddress:a,mint:a,pairAddress:r?.pairAddress||r?.pairId||t.pairAddress||"",symbol:r?.symbol||t.symbol||w(a),name:r?.name||t.name||"Token",imageUri:r?.imageUrl||t.imageUri||"",source:t.source||r?.source||r?.category||"",dex:r?.dexId||t.dex||"",pool:r?.pool||t.pool||"",pumpUrl:r?.pumpUrl||t.pumpUrl||"",isPump:!!(r?.isPump||t.isPump||a.toLowerCase().endsWith("pump")),graduated:!!(r?.graduated||r?.isGraduated||r?.bonded||r?.isBonded||t.graduated||t.isGraduated||t.bonded||t.isBonded),isGraduated:!!(r?.isGraduated||r?.graduated||r?.bonded||r?.isBonded||t.isGraduated||t.graduated||t.bonded||t.isBonded),bonded:!!(r?.bonded||r?.isBonded||r?.graduated||r?.isGraduated||t.bonded||t.isBonded||t.graduated||t.isGraduated),isBonded:!!(r?.isBonded||r?.bonded||r?.graduated||r?.isGraduated||t.isBonded||t.bonded||t.graduated||t.isGraduated)}}function Ok(e={},t={}){return ge(e?.tokenMint||e?.mint||e?.tokenAddress||"",{...t,pairAddress:e?.pairAddress||e?.pairId||t.pairAddress||"",symbol:e?.symbol||t.symbol||"",name:e?.name||t.name||"",imageUri:e?.imageUrl||e?.imageUri||t.imageUri||"",source:t.source||e?.source||e?.category||"",dex:e?.dexId||t.dex||"",pool:e?.pool||t.pool||"",pumpUrl:e?.pumpUrl||t.pumpUrl||"",isPump:e?.isPump||t.isPump,graduated:e?.graduated||e?.isGraduated||e?.bonded||e?.isBonded||t.graduated||t.isGraduated||t.bonded||t.isBonded,isGraduated:e?.isGraduated||e?.graduated||e?.bonded||e?.isBonded||t.isGraduated||t.graduated||t.bonded||t.isBonded,bonded:e?.bonded||e?.isBonded||e?.graduated||e?.isGraduated||t.bonded||t.isBonded||t.graduated||t.isGraduated,isBonded:e?.isBonded||e?.bonded||e?.graduated||e?.isGraduated||t.isBonded||t.bonded||t.graduated||t.isGraduated})}function ko(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim();return t?(n.smartChartTokenRef={...e,tokenMint:t,tokenAddress:t,mint:t},Ro(n.smartChartTokenRef),n.terminalToken=t,n.terminalAutoToken=t,n.tradeToken=t,n.bundleToken=t,n.volumeToken=t,n.smartChartToken=t,t):""}function qy(e,t={}){const a=new URLSearchParams;a.set("token",e);const r=t.defaultTab==="sell"?"sell":t.defaultTab==="chart"?"chart":"buy";return a.set("tab",r),["chart","chartTxns","txns","info"].includes(t.view)&&a.set("view",t.view),t.focusAmountInput&&a.set("focusAmount","1"),t.source&&a.set("source",String(t.source).slice(0,40)),t.returnTo&&a.set("returnTo",t.returnTo),`/terminal/chart?${a.toString()}`}function Ui(e={}){const t=String(e?.tokenMint||e?.mint||e?.tokenAddress||"").trim(),a=`${e?.source||""} ${e?.category||""} ${e?.dex||""} ${e?.pool||""}`.toLowerCase(),r=!!(e?.isPump||e?.pumpUrl||t.toLowerCase().endsWith("pump")||a.includes("pump")),o=!!(e?.graduated||e?.isGraduated||e?.bonded||e?.isBonded||e?.complete||e?.completed||e?.bondingComplete||e?.raydiumPool||e?.poolAddress);return!!(r&&!o)}function Hy(e={},t={}){return["chart","chartTxns","txns","info"].includes(t.view)?t.view:"chartTxns"}const $o=new Map;function qi(e){const t=String(e||"").trim();if(!t)return;const a=$o.get(t)||0;Date.now()-a<3e4||($o.set(t,Date.now()),$o.size>200&&$o.clear(),k(`/api/web/prebuy-warm?mint=${encodeURIComponent(t)}`,{method:"GET"}).catch(()=>{}))}function wt(e={},t={}){na("chartRouteStart");const a=L(),r=ko(e);if(!r){$("Select a token before opening the chart.");return}Ji(e,{source:t.source||"token-entry"}),qi(r),n.chartTradeTab=t.defaultTab==="sell"?"sell":(t.defaultTab==="chart","buy"),n.smartChartView=Hy(n.smartChartTokenRef||e,t),n.chartFocusAmountInput=!!t.focusAmountInput,n.chartScrollIntoView=!0,n.activeTab="smartChart",n.route="terminal",n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},n.chartTradeStatus="",n.chartBuyWalletIndex="";const o=qy(r,{defaultTab:t.defaultTab||"buy",view:n.smartChartView,focusAmountInput:t.focusAmountInput,source:t.source||"token-entry",returnTo:t.returnTo||za()});window.history.pushState({},"",o),h({force:!0}),H("chart-route-open",a,{component:"smartChart",cacheHit:!!(Je(r)?.cacheHit||lr(r)?.pairAddress),details:`${r}:${t.source||"token-entry"}`})}function Hi(){if(!window.location.pathname.includes("/terminal/chart"))return;na("chartRouteStart");const e=L(),t=new URLSearchParams(window.location.search||""),a=String(t.get("token")||t.get("mint")||"").trim(),r=String(n.smartChartToken||"").trim();if(a){const o=ge(a,{source:t.get("source")||"route"});ko(o),Ji(o,{source:t.get("source")||"route"}),t.get("buy")==="1"&&window.setTimeout(()=>{try{ln(o,{forceModal:!0,source:"deep-link"})}catch{}},900),a!==r&&(n.chartTradeStatus="",n.chartBuyWalletIndex="")}n.chartTradeTab=t.get("tab")==="sell"?"sell":"buy",n.smartChartView=["chart","chartTxns","txns","info"].includes(t.get("view"))?t.get("view"):"chartTxns",n.chartFocusAmountInput=t.get("focusAmount")==="1",n.chartScrollIntoView=!0,n.route="terminal",n.activeTab="smartChart",H("chart-route-apply",e,{component:"smartChart",cacheHit:!!(Je(a)?.cacheHit||lr(a)?.pairAddress),details:a})}function ln(e={},t={}){const a=ko(e);if(!a){$("Select a token before quick buying.");return}const r=cn(a);if(r&&Mo(r)){$("Safety block: this token has mintable/freezable/honeypot-style risk signals and cannot be quick bought.");return}const o=t.preset||lt(),s=o&&!t.forceModal?qe(o):"",c=o?.walletIndex||(o?.walletIndexes||[])[0]||(n.wallets[0]?.index?String(n.wallets[0].index):"");if(o&&s&&c&&!t.forceModal){Po(a,{...o,walletIndex:c,walletIndexes:[c]});return}const l=le();n.quickBuyModal={open:!0,tokenMint:a,amountSol:s||n.quickBuyAmountOverride||"",walletIndex:l?.publicKey?"connected":n.wallets[0]?.index?String(n.wallets[0].index):"",slippageBps:"400",status:s?`Preset ${s} SOL loaded. Confirm when ready.`:o?"Your selected preset has no SOL amount - set one here (or edit the preset in the Trade tab) and Buy becomes one-click.":"Enter a SOL amount to quick buy - or save a Trade preset and Buy becomes one-click.",source:t.source||"quick-buy",error:"",tradeAttemptId:""},qi(a),h({force:!0}),requestAnimationFrame(()=>m("[data-quick-buy-modal-amount]")?.focus())}function Ki(){n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},h({force:!0})}function Ky(e={},t={}){if(!_("protectedBuyEnabled",!0))return;const a=ko(e);if(!a){$("Select a token before opening Protected Buy.");return}const r=cn(a);if(r&&Mo(r)){$("Safety block: this token has mintable/freezable/honeypot-style risk signals and cannot be bought from quick actions.");return}const o=wa(a)||{tokenMint:a},s=Ye(o),c=t.presetId||s.protectedBuyPreset||el(s.verdict),l=Number(X(t.amountSol||n.quickBuyAmountOverride||qe()||"0.1")),u=c==="conservative"&&Number.isFinite(l)&&l>.25?"0.25":dr(l||.1),d=le();qi(a),n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},n.protectedBuyModal={open:!0,tokenMint:a,presetId:c,amountSol:u,walletIndex:t.walletIndex||(d?.publicKey?"connected":n.wallets[0]?.index?String(n.wallets[0].index):""),slippageBps:String(t.slippageBps||"400"),riskAccepted:!1,status:s.verdict==="AVOID"?"Avoid recommended. Check the risk box if you still want to continue.":"Review this plan before wallet confirmation.",error:"",source:t.source||"protected-buy"},h({force:!0}),requestAnimationFrame(()=>m("[data-protected-buy-amount]")?.focus())}function To(){n.protectedBuyModal={...n.protectedBuyModal,open:!1,status:"",error:"",riskAccepted:!1},h({force:!0})}function Vy(){const e=n.protectedBuyModal||{},t=String(e.tokenMint||"").trim(),a=String(m("[data-protected-buy-preset]")?.value||e.presetId||"conservative").trim(),r=String(m("[data-protected-buy-wallet]")?.value||e.walletIndex||"").trim(),o=X(m("[data-protected-buy-amount]")?.value||e.amountSol||""),s=String(m("[data-protected-buy-slippage]")?.value||e.slippageBps||"400").trim(),c=!!(m("[data-protected-buy-risk-accept]")?.checked||e.riskAccepted);if(!t)throw new Error("Select a token before Protected Buy.");if(!r)throw new Error("Choose a wallet before Protected Buy.");if(!o)throw new Error("Enter a SOL amount greater than zero.");return{tokenMint:t,presetId:a,walletIndex:r,amountSol:o,slippageBps:s,riskAccepted:c}}function zy(){const e=n.protectedBuyModal||{};if(!e.open)return"";const t=wa(e.tokenMint)||{tokenMint:e.tokenMint},a=Ye(t),r=Fo(e.presetId),o=ce(e.walletIndex),s=a.verdict==="AVOID"&&!e.riskAccepted,c=/submitting|opening wallet/i.test(String(e.status||""));return`
    ...
    <section class="protected-buy-modal" role="dialog" aria-modal="true" aria-label="Protected Buy preview">
      ...
      <article class="protected-buy-preview">
        ...
        <small>${i(Vv(r))}</small>
        <small>Wallet: ${i(jv(e.walletIndex))}</small>
  ...
  `}function iv(){const e=Fu();if(!e.length)return"";const t=e.length;return`
  ...
  `},{key:"fund",label:"Fund / Sweep",hint:"Move SOL",html:`${nb()}${iv()}${ab()}${sv()}`},{key:"create",label:"Create",hint:"New wallets",html:Za()},{key:"import",label:"Import",hint:"Add keys",html:ku()},{key:"backup",label:"Backup",hint:"Save / restore",html:Su()},{key:"downloads",label:"Downloads",hint:"Exports",html:$u()}];if(!n.wallets.length){const r=a.filter(o=>o.key!=="balances"&&o.key!=="fund");return`
      ${e}
  ...
  `}function uv(){return(Array.isArray(n.wallets)?n.wallets:[]).find(t=>t?.sessionWallet&&t?.sessionStatus==="funded")||null}function dv(){if(!(n.connectedWalletBalance||n.user?.connectedWallet||null)?.publicKey)return"";const t=uv();return t?`
  ...
  `}function Fd(){const e=n.balances.reduce((a,r)=>a+Number(r.tokens?.length||0),0)+Vc().length,t=n.balances.filter(a=>a.error).length;return`
  ...
  `}function mv(e){const t=n.balances.find(s=>Number(s.index)===Number(e.index));if(!t)return"<span>Balance: loading</span>";if(t.error)return`<span>Balance check failed: ${i(t.error)}</span>`;const a=Number.isFinite(Number(t.sol))?`${Number(t.sol).toFixed(4)} SOL`:"SOL unavailable",r=Number(t.tokens?.length||0)===1?"1 token":`${Number(t.tokens?.length||0)} tokens`,o=t.warnings?.length?` | ${t.warnings.length} warning(s)`:"";return`<span>Balance: ${i(a)} | ${i(r)}${i(o)}</span>`}function fv(){const e=nt(),t=`
    <section class="account-check-card">
      <div>
  ...
  `}async function gv(e){const t=String(e||"").trim();if(!t)return;n.devWatch||(n.devWatch={});const a=!n.devWatch[t];try{const r=await k("/api/web/dev-watch",{method:"POST",body:JSON.stringify({wallet:t,watch:a}),timeoutMs:15e3});n.devWatch[t]=!!r.watching}catch(r){$(r?.message||"Could not update dev watch.")}Sa()}async function bv(e,t=null){const a=String(e||"").trim();if(!a)return;const r=lt();t&&(t.disabled=!0,t.textContent="Arming...");try{const o=await k("/api/web/positions/arm-exits",{method:"POST",body:JSON.stringify({tokenMint:a,takeProfitPct:r?.takeProfitPct||"40",stopLossPct:r?.stopLossPct||"8",sellDelay:r?.sellDelay||"off",sellPercent:r?.sellPercent||"100",slippageBps:r?.slippageBps||"1000"}),timeoutMs:2e4});ad(a),n.walletRemoveStatus=o.message||"Exits armed.",t&&(t.textContent="✅ Armed"),nd().then(()=>h())}catch(o){$(o?.message||"Could not arm exits."),t&&(t.disabled=!1,t.textContent="Arm Exits")}}async function yv(){n.bagScan={status:"loading"},h();try{const e=await k("/api/web/shield/scan-bags",{timeoutMs:3e4});n.bagScan={status:"done",bags:e.bags||[]}}catch(e){n.bagScan={status:"error",message:e?.message||""}}h()}function vv(){const e=`
    <section class="account-check-card">
      <div>
        <h3>PnL / Results</h3>
  ...
  `:`${e}${O("No PnL yet","Trades made through the bot will show here.")}`}function or(){return wv(sr())}function sr(){const e=Object.values(n.livePairsByBucket||{}).flatMap(o=>o?.rows||[]),t=n.scan?.rows||[],a=n.kolScan?.rows||[],r=n.watchlist?.rows||[];return[...e,...t,...a,...r]}function cn(e=""){const t=String(e||"");return t&&sr().find(a=>String(a?.tokenMint||"")===t)||null}function Ek(e=""){const t=cn(e);return!t||!Mo(t)?!1:($("Safety block: this feed token has mintable/freezable/honeypot-style risk signals."),!0)}function wv(e=[]){const t=new Map;for(const a of e||[]){if(ir(a))continue;const r=String(a?.tokenMint||"");r&&!t.has(r)&&t.set(r,a)}return[...t.values()]}function be(e=[]){const t=new Map;for(const a of e||[]){if(ir(a))continue;const r=String(a?.tokenMint||"");if(!r)continue;const o=t.get(r);(!o||xo(a)>xo(o))&&t.set(r,a)}return[...t.values()]}function xo(e={}){return xv(e)+Math.min(2,Number(e.bestPickScore||e.score||0)/50)+(E(e.volumeM15,e.volumeM30,e.volumeH1,e.volume5m,e.volumeH24)>0?1:0)}function Sv(e={}){const t=[e?.tokenMint,e?.symbol,e?.name,e?.source,e?.category,e?.platform,e?.market,e?.dexId,e?.profileSource,e?.profile?.source,e?.profile?.market,e?.profile?.mode,e?.metadata?.source,e?.metadata?.market,e?.metadata?.mode,e?.dexPair?.dexId,e?.dexPair?.labels,e?.labels,e?.riskFlags].flat().filter(Boolean).join(" ").toLowerCase();return/\bmayhem\b/.test(t)||t.includes("pump mayhem")||t.includes("mayhem mode")}function Mo(e={}){if(Sv(e))return!0;const t=[e?.tokenMint,e?.symbol,e?.name,e?.source,e?.category,e?.platform,e?.market,e?.dexId,e?.profileSource,e?.labels,e?.riskFlags,e?.bestPickWarnings,e?.scoreWarnings,e?.safetyNote,e?.tokenProgram,e?.mintAuthority?"mint authority":"",e?.freezeAuthority?"freeze authority":""].flat().filter(Boolean).join(" ").toLowerCase();if(/\b(honeypot|honey\s*pot|mintable|mint authority|freeze authority|freezable|freezeable|blacklist|cannot sell|can't sell|sell disabled|sell blocked|trading disabled|no sell|no route|rug|scam|liquidity pulled|liquidity removed|liquidity drained|lp pulled|lp removed|lp drained|pool drained|no liquidity|liquidity drain|drained liquidity)\b/i.test(t))return!0;const a=E(e.marketCap,e.fdv),r=E(e.liquidityUsd);return a>=1e8&&(!r||r/a<.01)}function ir(e={}){const t=[e?.tokenMint,e?.symbol,e?.name,e?.source,e?.category,e?.platform,e?.market,e?.dexId,e?.profileSource,e?.labels,e?.riskFlags,e?.bestPickWarnings,e?.scoreWarnings,e?.safetyNote].flat().filter(Boolean).join(" ").toLowerCase();if(/\b(honeypot|honey\s*pot|blacklist|rug|scam|mayhem|liquidity pulled|liquidity removed|liquidity drained|lp pulled|lp removed|lp drained|pool drained|liquidity drain|drained liquidity)\b/i.test(t))return!0;const a=E(e.marketCap,e.fdv),r=E(e.liquidityUsd);return a>=1e8&&(!r||r/a<.01)}function Wd(){const e=or(),t=s=>e.find(c=>String(c.tokenMint)===s)||{tokenMint:s,shortMint:w(s),symbol:w(s),dexUrl:Q(s)},a=String(n.terminalToken||n.tradeToken||"").trim();if(a)return t(a);const r=String(n.terminalAutoToken||"").trim();if(r)return t(r);const o=(De()?.rows||[])[0]||e[0]||null;return o?.tokenMint&&(n.terminalAutoToken=String(o.tokenMint)),o}function Bo(){const e=or(),t=n.smartChartTokenRef||null,a=o=>e.find(s=>String(s.tokenMint||"")===o)||{...String(t?.tokenMint||"")===o?t:{},tokenMint:o,shortMint:w(o),symbol:t?.symbol||w(o),name:t?.name||"Custom Token",imageUrl:t?.imageUrl||t?.imageUri||"",pairAddress:t?.pairAddress||t?.pairId||"",dexUrl:t?.dexUrl||Q(t?.pairAddress||o),pumpUrl:o.toLowerCase().endsWith("pump")?`https://pump.fun/coin/${encodeURIComponent(o)}`:""},r=String(n.smartChartToken||n.terminalToken||n.tradeToken||"").trim();return Ud(r?a(r):Wd())}function Dd(e={}){return typeof e=="string"?String(e||"").trim():String(e?.pairAddress||e?.pairId||e?.dexPair?.pairAddress||e?.dexPair?.pairId||e?.tokenMint||e?.mint||"").trim()}const kv=300*1e3,Nd=45*1e3,_d=600*1e3,$v=700,Tv=6e3,Av=4,Pv=3e4;function Je(e=""){const t=String(e||"").trim();if(!t)return null;const a=n.smartChartBootstrap?.[t]||null;if(!a)return null;const r=Date.now()-Number(a.loadedAt||a.resolvedAt||0);return a.status==="failed"?r<Nd?a:null:r<_d?a:null}function lr(e=""){const t=String(e||"").trim(),a=t?n.smartChartDexResolution?.[t]||Je(t):null;if(!a)return null;const r=Date.now()-Number(a.resolvedAt||0);return a.status==="failed"?r<Nd?a:null:r<kv?a:null}function Ud(e=null){if(!e)return e;const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim(),a=lr(t);return!a||a.status==="failed"?e:{...e,pairAddress:e.pairAddress||a.pairAddress||"",pairId:e.pairId||a.pairAddress||"",dexUrl:e.dexUrl||a.dexUrl||a.pairUrl||"",dexId:e.dexId||a.dexId||"",dexName:e.dexName||a.dexName||a.dexId||"",symbol:e.symbol||a.symbol||w(t),name:e.name||a.name||"Token",imageUrl:e.imageUrl||a.imageUrl||"",marketCap:e.marketCap||a.marketCap||0,marketCapUsd:e.marketCapUsd||a.marketCap||0,fdv:e.fdv||a.fdv||0,liquidityUsd:e.liquidityUsd||a.liquidityUsd||0,volumeH24:e.volumeH24||a.volumeH24||0,volumeH1:e.volumeH1||a.volumeH1||0,priceUsd:e.priceUsd||a.priceUsd||0,h1:e.h1||a.h1||0,volume:e.volume||a.volume||null,txns:e.txns||a.txns||null}}function Gi(e={}){const t=String(e.tokenMint||e.tokenAddress||e.mint||"").trim();if(!t)return;const a=Date.now(),r={...e,tokenMint:t,tokenAddress:t,status:e.errorCode?"failed":"resolved",loadedAt:a,resolvedAt:a};n.smartChartBootstrap={...n.smartChartBootstrap||{},[t]:r},(r.pairAddress||r.dexUrl||r.symbol||r.name)&&Ro({...r,mint:t,imageUri:r.imageUrl||r.imageUri||"",dex:r.dexId||r.dexName||""})}function Ro(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim(),a=String(e.pairAddress||e.pairId||"").trim();!t||!a&&!e.dexUrl&&!e.symbol&&!e.name||(n.smartChartDexResolution={...n.smartChartDexResolution||{},[t]:{...n.smartChartDexResolution?.[t]||{},tokenMint:t,pairAddress:a,dexUrl:e.dexUrl||Q(a||t),dexId:e.dex||e.dexId||"",symbol:e.symbol||"",name:e.name||"",imageUrl:e.imageUri||e.imageUrl||"",marketCap:Number(e.marketCap??e.marketCapUsd)||n.smartChartDexResolution?.[t]?.marketCap||0,fdv:Number(e.fdv)||n.smartChartDexResolution?.[t]?.fdv||0,liquidityUsd:Number(e.liquidityUsd??e.liquidity?.usd)||n.smartChartDexResolution?.[t]?.liquidityUsd||0,volumeH24:Number(e.volumeH24)||n.smartChartDexResolution?.[t]?.volumeH24||0,volumeH1:Number(e.volumeH1)||n.smartChartDexResolution?.[t]?.volumeH1||0,priceUsd:Number(e.priceUsd)||n.smartChartDexResolution?.[t]?.priceUsd||0,h1:Number(e.h1)||n.smartChartDexResolution?.[t]?.h1||0,status:"resolved",resolvedAt:Date.now()}})}function Cv(e={}){const t=String(e?.tokenMint||n.smartChartToken||"").trim();if(!t)return!1;const a=String(e?.pairAddress||e?.pairId||"").trim();if(a)return Ro({...e,tokenMint:t,pairAddress:a}),!1;if(Je(t)?.pairAddress)return!1;const r=lr(t);return r?.pairAddress||r?.status==="failed"?!1:(n.smartChartDexResolving?.[t]||(n.smartChartDexResolving={...n.smartChartDexResolving||{},[t]:!0},window.setTimeout(()=>{Kd(t).catch(()=>{})},0)),!0)}function qd(e={},t={}){const a=String(e?.tokenMint||e?.mint||e?.tokenAddress||n.smartChartToken||"").trim();return!a||!t.force&&Je(a)?.status==="resolved"?!1:(n.smartChartBootstrapLoading?.[a]||(n.smartChartBootstrapLoading={...n.smartChartBootstrapLoading||{},[a]:!0},window.setTimeout(()=>{Kd(a,{source:t.source||"chart-bootstrap"}).catch(()=>{})},0)),!0)}const Xi=new Map;async function Hd(e){const t=String(e||"").trim();if(!t)return;const a=Xi.get(t)||0;if(Date.now()-a<3e4)return;Xi.set(t,Date.now());const r=async()=>{const u=((await(await fetch(`https://api.dexscreener.com/latest/dex/tokens/${encodeURIComponent(t)}`,{cache:"no-store"})).json())?.pairs||[]).filter(d=>d?.chainId==="solana").sort((d,p)=>(Number(p?.liquidity?.usd)||0)-(Number(d?.liquidity?.usd)||0))[0];if(!u)throw new Error("no pair");return u},o=async()=>{const s=await k(`/api/web/pair-lite?mint=${encodeURIComponent(t)}`,{timeoutMs:5e3});if(!s?.pair)throw new Error("no pair");return s.pair};try{const s=await Promise.any([r(),o()]);Gi({tokenMint:t,symbol:s.baseToken?.symbol||"",name:s.baseToken?.name||"",priceUsd:s.priceUsd,marketCap:s.marketCap||s.fdv||null,marketCapUsd:s.marketCap||s.fdv||null,fdv:s.fdv||null,liquidityUsd:Number(s.liquidity?.usd)||null,liquidity:{usd:Number(s.liquidity?.usd)||null},volumeH24:Number(s.volume?.h24)||null,volumeH1:Number(s.volume?.h1)||null,h1:Number(s.priceChange?.h1)||null,imageUrl:s.info?.imageUrl||"",dexUrl:s.url||"",pairAddress:s.pairAddress||"",dexId:s.dexId||"",pumpCurve:!!s.pumpCurve,bondingProgressPct:s.bondingProgressPct??null,source:s.pumpCurve?"pump-curve":"direct-dexscreener"}),n.activeTab==="smartChart"&&h({preserveSmartChartFrame:!0})}catch{Xi.delete(t)}}function Ji(e={},t={}){const a=String(e?.tokenMint||e?.mint||e?.tokenAddress||"").trim();return a?(Ro(e),Eh(a,e.symbol||e.name||""),Hd(a),qd(e,{source:t.source||"prefetch"}),n.smartChartPrefetchLog=[...n.smartChartPrefetchLog||[],{at:new Date().toISOString(),tokenMint:a,source:t.source||"prefetch",routeChunkPrefetched:!0,metadataPrefetched:!!(e.symbol||e.name||e.imageUri||e.imageUrl),candlesPrefetched:!1,dedupeHit:!!(n.smartChartBootstrapLoading?.[a]||Je(a)),cacheTtlMs:_d}].slice(-20),!0):!1}async function Kd(e=""){const t=String(e||"").trim();if(!t)return null;try{const a=L(),r=await k(`/api/web/chart/bootstrap?token=${encodeURIComponent(t)}`,{timeoutMs:4500}),o=r.chart||r.dexToken||{};return Gi(o),H("chart-bootstrap",a,{component:"smartChart",cacheHit:!!o.cacheHit,stale:!!o.stale,details:`${t}:${o.chartProvider||"dexscreener-embed"}`}),n.route==="terminal"&&n.activeTab==="smartChart"&&String(n.smartChartToken||"")===t&&h({force:!0}),o}catch(a){return n.smartChartDexResolution={...n.smartChartDexResolution||{},[t]:{tokenMint:t,status:"failed",error:N(a?.message||"DEX pair lookup failed."),resolvedAt:Date.now()}},n.route==="terminal"&&n.activeTab==="smartChart"&&String(n.smartChartToken||"")===t&&h({force:!0}),null}finally{const a={...n.smartChartDexResolving||{}};delete a[t],n.smartChartDexResolving=a;const r={...n.smartChartBootstrapLoading||{}};delete r[t],n.smartChartBootstrapLoading=r}}function Lv(e,t={}){const a=Dd(e),r=new URLSearchParams({embed:"1",theme:"dark",trades:t.trades?"1":"0",info:t.info?"1":"0"});return`https://dexscreener.com/solana/${encodeURIComponent(a)}?${r.toString()}`}function Vd(e={},t="chart"){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=Je(a);return t==="info"&&r?.infoUrl?r.infoUrl:(t==="chartTxns"||t==="txns")&&(r?.chartTxnsUrl||r?.txnsUrl)?r.chartTxnsUrl||r.txnsUrl:r?.chartUrl?r.chartUrl:Lv(e,{trades:t==="chartTxns"||t==="txns",info:t==="info"})}function Fk(e={}){const t=String(e?.tokenMint||e?.mint||n.smartChartToken||""),a=Qd(t||e?.symbol||"pump"),r=Math.max(1,E(e.marketCap,e.fdv,e.liquidityUsd,1e4)),o=E(e.m5,e.h1,e.priceChange?.m5,e.priceChange?.h1,e.priceChange5m,e.priceChange1h,0),s=Math.max(4,Math.min(96,Ut(e)||E(e.bondingProgressPct,e.pumpProgress,12))),c=Math.max(2,Math.min(22,Math.abs(o)||E(e.volume5m,e.volumeM15,e.volumeH1,0)/Math.max(1,r)*100));return Array.from({length:22},(l,u)=>{const d=Math.sin((u+a%11)/2.2)*c,p=(u/21-.5)*(o||s/3),f=((a>>u%8&7)-3)*.7;return Math.max(1,r*(1+(d+p+f)/100))})}function Wk(e={},...t){for(const a of t){const r=Number(e?.[a]);if(Number.isFinite(r)&&r>0)return r;const o=a.split(".").reduce((c,l)=>c?.[l],e),s=Number(o);if(Number.isFinite(s)&&s>0)return s}return 0}function Dk(e={},t="chart"){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=t==="txns",o=Math.max(0,Math.min(100,Ut(e)||E(e.bondingProgressPct,e.pumpProgress,0))),s=D(e.marketCapLabel,e.fdvLabel,B(e.marketCap),B(e.fdv)),c=D(e.liquidityLabel,B(e.liquidityUsd)),l=D(e.volumeM15Label,e.volume5mLabel,e.volumeLabel,B(e.volumeM15),B(e.volume5m),B(e.volumeH1));return`
  ...
  `}function Yi(e={},t="chart"){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=t==="chartTxns"||t==="txns",o=t==="info",s=qd(e)||Cv(e),c=o?`DexScreener info for ${e.symbol||w(a)}`:r?`DexScreener chart and transactions for ${e.symbol||w(a)}`:`DexScreener chart for ${e.symbol||w(a)}`,l=["smart-chart-frame","smart-chart-dex-frame",r?"smart-chart-transactions-frame":"",t==="chartTxns"?"smart-chart-combined-frame":"",o?"smart-chart-info-frame":""].filter(Boolean).join(" "),d=s?"Loading DEX chart while resolving fastest pair...":o?"Loading token info...":r?"Loading DEX transactions...":"Loading DEX chart...",p=Vd(e,t);return`
  ...
  `}function zd(){const e=[...Object.values(n.livePairsByBucket||{}).flatMap(a=>a?.rows||[]),...n.livePairs?.rows||[],...n.scan?.rows||[],...n.kolScan?.rows||[],...n.watchlist?.rows||[]],t=new Map;for(const a of e){const r=String(a?.tokenMint||"");if(!r)continue;const o=t.get(r);(!o||xo(a)>xo(o))&&t.set(r,a)}return t}function xv(e={}){return[e.marketCap,e.liquidityUsd,e.volume5m,e.volumeM15,e.volumeH1,e.pairCreatedAt,e.imageUrl,e.twitterUrl,e.telegramUrl,e.websiteUrl].reduce((t,a)=>t+(a&&String(a).toLowerCase()!=="n/a"?1:0),0)}function jd(e=[]){const t=zd();return(e||[]).map(a=>Gd(a,t.get(String(a?.tokenMint||""))))}function it(e){if(e==null||e==="")return null;if(typeof e=="number")return Number.isFinite(e)?e:null;const t=String(e).trim();if(!t)return null;const r=t.replace(/[$,%_\s,]/g,"").match(/^([-+]?\d*\.?\d+)([kmb])?$/i);if(!r)return null;const o=Number(r[1]);if(!Number.isFinite(o))return null;const s=String(r[2]||"").toLowerCase();return s==="k"?o*1e3:s==="m"?o*1e6:s==="b"?o*1e9:o}function E(...e){for(const t of e){const a=it(t);if(Number.isFinite(a)&&a>0)return a}for(const t of e){const a=it(t);if(Number.isFinite(a))return a}return 0}function Gd(e={},t=null){return t?{...e,imageUrl:e.imageUrl||t.imageUrl||"",websiteUrl:e.websiteUrl||t.websiteUrl||"",twitterUrl:e.twitterUrl||t.twitterUrl||"",telegramUrl:e.telegramUrl||t.telegramUrl||"",dexUrl:e.dexUrl||t.dexUrl,pumpUrl:e.pumpUrl||t.pumpUrl||"",isPump:e.isPump||t.isPump,pairCreatedAt:e.pairCreatedAt||t.pairCreatedAt,pairAgeSeconds:Number.isFinite(Number(e.pairAgeSeconds))?e.pairAgeSeconds:t.pairAgeSeconds,pairAgeMinutes:Number.isFinite(Number(e.pairAgeMinutes))?e.pairAgeMinutes:t.pairAgeMinutes,pairAgeLabel:e.pairAgeLabel||t.pairAgeLabel,marketCap:E(e.marketCap,t.marketCap,e.fdv,t.fdv),fdv:E(e.fdv,t.fdv,e.marketCap,t.marketCap),marketCapLabel:D(e.marketCapLabel,t.marketCapLabel,B(e.marketCap),B(t.marketCap)),fdvLabel:D(e.fdvLabel,t.fdvLabel,B(e.fdv),B(t.fdv)),liquidityUsd:E(e.liquidityUsd,t.liquidityUsd),liquidityLabel:D(e.liquidityLabel,t.liquidityLabel,B(e.liquidityUsd),B(t.liquidityUsd)),volume5m:E(e.volume5m,t.volume5m),volume5mLabel:D(e.volume5mLabel,t.volume5mLabel,B(e.volume5m),B(t.volume5m)),volumeM15:E(e.volumeM15,t.volumeM15),volumeM15Label:D(e.volumeM15Label,t.volumeM15Label,B(e.volumeM15),B(t.volumeM15)),volumeM30:E(e.volumeM30,t.volumeM30),volumeM30Label:D(e.volumeM30Label,t.volumeM30Label,B(e.volumeM30),B(t.volumeM30)),volumeH1:E(e.volumeH1,t.volumeH1),volumeH1Label:D(e.volumeH1Label,e.volumeLabel,t.volumeH1Label,t.volumeLabel,B(e.volumeH1),B(t.volumeH1)),volumeH24:E(e.volumeH24,t.volumeH24),volumeH24Label:D(e.volumeH24Label,t.volumeH24Label,B(e.volumeH24),B(t.volumeH24)),volumeLabel:D(e.volumeLabel,t.volumeLabel,e.volumeH1Label,t.volumeH1Label,B(e.volumeH1),B(t.volumeH1)),sniperCount:E(e.sniperCount,t.sniperCount)}:e}function cr(e=[],t=[]){return be([...n.livePairsByBucket.under1d?.rows||[],...n.livePairsByBucket.under3h?.rows||[],...n.livePairsByBucket.under1h?.rows||[],...n.livePairsByBucket.live?.rows||[],...n.scan?.rows||[],...e,...t]).sort((r,o)=>Number(o.bestPickScore||o.score||0)-Number(r.bestPickScore||r.score||0)||E(o.volumeM15,o.volumeM30,o.volumeH1,o.volume5m,o.volumeH24)-E(r.volumeM15,r.volumeM30,r.volumeH1,r.volume5m,r.volumeH24)||E(o.marketCap,o.fdv)-E(r.marketCap,r.fdv)||Qe(r,o))}function j(e,t,a,r,o){return{key:e,label:t,severity:a,message:r,weight:o}}function Mv(e={}){const t=it(e.pairAgeMinutes??e.ageMinutes??e.tokenAgeMinutes);if(Number.isFinite(t))return t;const a=it(e.pairAgeSeconds??e.ageSeconds);return Number.isFinite(a)?a/60:null}function Bv(e,t=[]){const a=(t||[]).some(o=>o.key==="hard_flag"),r=(t||[]).filter(o=>o.severity==="risk"&&o.key!=="liquidity_extreme").length;return a||e<35&&r>=2?"AVOID":e<60?"RISK":e<75?"CAUTION":"BUY"}function Rv(e,t=[]){if(e==="BUY")return"Clean setup. Normal size still depends on your risk.";if(e==="CAUTION")return"Trade small or use protection.";if(e==="RISK")return"High-risk setup. Protected Buy recommended if you enter.";const a=(t||[]).find(r=>r.severity==="risk");return a?.message?`Avoid recommended. ${a.message}`:"Avoid recommended. Multiple danger signals."}const Io=Object.freeze({unknown:"",new:"New",hold:"Hold",mixed:"Mixed",risk:"Risk",dump:"Dev"});function ha(e=""){const t=String(e||"unknown").trim().toLowerCase();return Object.hasOwn(Io,t)?t:"unknown"}function Oo(e="",t="Unknown"){const a=ha(e);return Io[a]||t}function Xd(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim(),a=String(e.creatorWallet||e.creator||e.deployerWallet||e.poolCreator||"").trim(),r=a?"new":"unknown";return{mint:t,status:r,label:Io[r],confidence:a?"low":"unknown",summary:a?"Limited dev-wallet history. Treat this as a new launch wallet.":"No reliable creator wallet detected yet.",likelyDevWallet:a||null,updatedAt:""}}function ur(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim();return t&&(n.devInfoSummaries?.[t]||e.devInfoSummary)||Xd(e)}function Iv(e={}){const t=ha(e.status);return t==="hold"?j("dev_info_hold","Dev Info","positive","Likely dev wallet is still holding.",6):t==="mixed"?j("dev_info_mixed","Dev Info","caution","Dev wallet history is mixed.",-8):t==="risk"?j("dev_info_risk","Dev Info","risk","Likely dev wallet has fast-sell history.",-18):t==="dump"?j("dev_info_dump","Dev Info","risk","Likely dev wallet sold quickly or has repeated dump behavior.",-30):t==="new"?j("dev_info_limited","Dev Info","neutral","Dev wallet history is limited.",-2):j("dev_info_unknown","Dev Info","neutral","Dev wallet history is limited.",-4)}function Jd(e={},t={}){if(!_("devInfoEnabled",!0))return"";const a=String(e.tokenMint||e.mint||e.tokenAddress||"").trim();if(!a)return"";const r=ur(e),o=ha(r.status),c=!!n.devInfoLoading?.[`summary:${a}`]?"...":o==="unknown"?"":r.label||Io[o]||"",l=!!t.compact;return`
  ...
  `}function Fv(e={}){if(!_("slimeShieldEnabled",!0)){const o=Number(e.bestPickScore||e.score||0);return`<em class="mobile-score-mini" title="${i(Qi(e))}">${i(o?`${o}`:"n/a")} score</em>`}const t=Ye(e),a=String(e.tokenMint||t.mint||"").trim(),r=t.verdict||"CAUTION";return`<button type="button" class="mobile-score-mini slimeshield-mini slimeshield-${i(un(r))}" data-slimeshield-details="${i(a)}" title="${i(t.summary||"Open SlimeShield details")}">Details</button>`}function Nk(e={}){if(!_("slimeShieldEnabled",!0)){const o=Number(e.bestPickScore||e.score||0),s=o?`${o}`:"n/a";return`
  ...
  `}function Wv(e={}){return _("slimeShieldEnabled",!0)?`SlimeShield ${Ye(e).verdict||"CAUTION"}`:e.bestPickScore?`Score ${e.bestPickScore}/100`:e.valueLabel||e.smartMoney||""}function Dv(e={}){const t=Number(e.bestPickScore||e.score||0),a=e.scoreWarnings||e.bestPickWarnings||[],r=t?`${t}/100`:"n/a";return`
    <span class="score-badge" title="${i(Qi(e))}">
      <strong>${i(r)}</strong>
      <small>${a.length?"warnings":"best pick"}</small>
    </span>
  `}function Nv(e={}){return Ev(e,{compact:!0})}function Qi(e={}){const t=e.scoreBreakdown||e.bestPickInputs||{},a=Object.entries(t).map(([o,s])=>`${o}: ${s}`),r=e.scoreWarnings||e.bestPickWarnings||[];return[...a,...r.map(o=>`warning: ${o}`)].join(" | ")||"Score uses available liquidity, volume, age, momentum, buys/sells, KOL, and risk signals."}function _v(e={}){return""}function B(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"n/a":t>=1e6?`$${(t/1e6).toFixed(t>=1e7?0:1)}M`:t>=1e3?`$${(t/1e3).toFixed(t>=1e5?0:1)}K`:`$${Math.round(t)}`}function D(...e){for(const t of e){const a=String(t??"").trim();if(a&&a!=="$0"&&a.toLowerCase()!=="n/a")return a}return"n/a"}function Yd(e={}){return[["15m",D(e.volumeM15Label,B(e.volumeM15))],["30m",D(e.volumeM30Label,B(e.volumeM30))],["1h",D(e.volumeH1Label,e.volumeLabel,B(e.volumeH1))],["24h",D(e.volumeH24Label,B(e.volumeH24))]]}function _k(e={}){const t=ut(e),a=dt(e),r=D(e.marketCapLabel,e.fdvLabel,t>0?B(t):"","checking"),o=D(e.liquidityLabel,a>0?B(a):"","checking"),s=Yd(e);return`
    <div class="compact-stat-grid">
      <span>MC <b>${i(r)}</b></span>
      <span>Liq <b>${i(o)}</b></span>
      ${s.map(([c,l])=>`<span>${i(c)} <b>${i(l)}</b></span>`).join("")}
    </div>
  `}function Uv(e={}){const t=ut(e),a=dt(e),r=D(e.marketCapLabel,e.fdvLabel,t>0?B(t):"","checking"),o=D(e.liquidityLabel,a>0?B(a):"","checking"),s=D(e.volumeM15Label,B(e.volumeM15)),c=D(e.volumeH1Label,e.volumeLabel,B(e.volumeH1));return`
  ...
  `}function tp(e,{source:t,actionLabel:a="Trade",isKolContext:r=!1}={}){const o=Xo(e.tokenMint);return`
      ...
      ${c.map((d,p)=>{const f=d.scalpSetup||d.momentum||d.category||"live";return`
          <article class="terminal-token-row${u} ${l?"is-kol-signal":""}" data-token-chart="${i(d.tokenMint)}" data-token-chart-source="terminal-row">
            ...
            <div class="terminal-token-actions has-dev-info">
              ${tp(d,{source:"terminal-row",actionLabel:r,isKolContext:l})}
            </div>
          </article>
        `}).join("")}
    </div>
      ...
      ${c.map((u,d)=>`
        <article class="compact-signal-row ${l?"is-kol-signal":""}" data-token-chart="${i(u.tokenMint)}" data-token-chart-source="compact-row">
          ...
          <div class="compact-row-actions has-dev-info">
            ${tp(u,{source:"compact-row",actionLabel:r,isKolContext:l})}
          </div>
        </article>
      `).join("")}
    </div>
  `:O(o,s)}function pn(e){const t=oe(e,e==="trade"?n.selectedTradePresetId:n.selectedBundlePresetId);if(!t)return"Custom / manual";const a=[t.name,`${t.amountSol} SOL`,`TP ${t.takeProfitPct}`,`SL ${t.stopLossPct}`];return t.sellDelay&&t.sellDelay!=="off"&&a.push(`Timer ${t.sellDelay}`),a.join(" | ")}function Uk(){return`
  ...
  `}function np(){Or&&window.clearTimeout(Or),Or=window.setTimeout(()=>{Or=null,Z("live"),Z("launch"),Z("sniper"),h()},180)}function No(e={}){const t=Number(e.pairCreatedAt||e.createdAt||0);if(t>0){const o=t<1e10?t*1e3:t;return Math.max(0,Math.round((Date.now()-o)/1e3))}const a=["source-age","trusted-source-age"].includes(String(e.pairAgeSource||"").toLowerCase()),r=Number(e.pairAgeSeconds);return a&&Number.isFinite(r)&&r>=0?r:Number.POSITIVE_INFINITY}const Yv=100,Qv=7200,Zv=75e4,ew=86400,tw=2e6,aw=28e3,rp=18e4,nw=16e4;function op(){const e=zd();return be([...n.livePairs?.rows||[],...n.livePairsByBucket.live?.rows||[],...n.livePairsByBucket.under1h?.rows||[],...n.livePairsByBucket.under3h?.rows||[],...n.livePairsByBucket.under1d?.rows||[],...n.scan?.rows||[],...n.kolScan?.rows||[]]).map(t=>Gd(t,e.get(String(t?.tokenMint||"")))).filter(t=>t?.tokenMint&&!ir(t))}function hn(e={}){return E(e.marketCap,e.fdv)}function sp(e={}){return E(e.liquidityUsd)}function ip(e={}){return E(e.volumeM5,e.volume5m,e.volumeM15,e.volumeM30,e.volumeH1,e.volumeH24,e.volumeUsd)}function nl(e={}){if(gn(e))return!1;const t=No(e);return!Number.isFinite(t)||t<0||t>Qv||hn(e)>Zv?!1:Ut(e)<70}function _o(e={}){if(gn(e))return!1;const t=Ut(e),a=hn(e),r=a>=aw&&a<=rp;return t>=55&&(!a||a<=rp)||r}function lp(e={}){if(nl(e)||_o(e)||gn(e))return!1;const t=No(e);return Number.isFinite(t)&&(t<0||t>ew)||hn(e)>tw?!1:sp(e)>0||ip(e)>0||Number(e.bestPickScore||e.score||0)>0||Array.isArray(e.reasons)&&e.reasons.length>0}function cp(e={}){return[e.tokenMint,e.symbol,e.name,e.source,e.category,e.dexId,e.dexName,e.poolType,e.platform,e.raydiumPool,e.pairUrl,...e.riskFlags||[],...e.reasons||[]].filter(Boolean).join(" ").toLowerCase()}function Ut(e={}){const t=E(e.bondingProgressPct,e.bondingProgress,e.bonding_curve_progress,e.bondingCurveProgress,e.pumpProgress,e.graduationProgress,e.completion,e.completePct);if(t>0)return t<=1?t*100:t;const a=hn(e),r=cp(e);return(!!e.isPump||r.includes("pump")||String(e.tokenMint||"").toLowerCase().endsWith("pump"))&&a>0?Math.max(1,Math.min(99,a/69e3*100)):0}function gn(e={}){if(e.isGraduated||e.graduated||e.bonded||e.isBonded||e.complete||e.completed||e.bondingComplete||e.raydiumPool||e.raydium_pool||e.poolAddress)return!0;const t=cp(e);if(/\b(graduated|bonded|bonding complete|complete)\b/.test(t))return!0;const a=!!e.isPump||t.includes("pump")||String(e.tokenMint||"").toLowerCase().endsWith("pump"),r=hn(e);return a&&r>=nw?!0:!!(a&&/\b(raydium|meteora|orca)\b/.test(t))}function Uo(e={}){if(gn(e))return"graduated";const t=String(e.slimeScopeCategory||"").trim().toLowerCase();return t==="graduated"?"graduated":_o(e)||t==="graduating"?"graduating":nl(e)?"new":(t==="steady"||t==="unknown"||lp(e),"steady")}function up(e={}){const t=Number(e.bestPickScore||e.score||0),a=ip(e),r=sp(e),o=hn(e),s=No(e),c=Number.isFinite(s)?Math.max(0,86400-s)/86400:0;return t*1e3+Math.log10(a+1)*160+Math.log10(r+1)*120+Math.log10(o+1)*80+c*100}function dp(e=[]){return[...e].sort((t,a)=>up(a)-up(t)||Qe(t,a))}function rw(e=[],t=[],a=Yv){const r=new Set,o=[];for(const s of[...e,...t]){const c=String(s?.tokenMint||"");if(!(!c||r.has(c))&&(r.add(c),o.push(s),o.length>=a))break}return o}function pp(e=n.slimeScopeMode){const t=op(),a=e==="graduated"?"graduated":e==="graduating"?"graduating":e==="steady"?"steady":"new",r=t.filter(l=>Uo(l)===a),o=t.filter(l=>{const u=Uo(l);return a==="graduated"?u==="graduated"||gn(l):a==="graduating"?u==="graduating"||_o(l):a==="steady"?u==="steady"||lp(l):u==="new"||nl(l)}),s=a==="new"?[...r].sort(Qe):dp(r),c=a==="new"?be(o).sort(Qe):dp(o);return rw(s,c)}function ow(e=[],t="new"){const a=at(`slimeScope:${t}`,e).slice(0,12);return a.length?a.map((r,o)=>{const s=r.pairAgeLabel||Ht(r)||"age ?",c=D(r.marketCapLabel,r.fdvLabel,B(ut(r)),"checking"),l=D(r.liquidityLabel,B(dt(r)),"checking"),u=D(r.volumeM15Label,B(gl(r)),"checking");return`
      <article class="slime-scope-column-row" data-token-chart="${i(r.tokenMint)}" data-token-chart-source="slime-scope-column">
        ...
        <button type="button" data-quick-buy-token="${i(r.tokenMint)}" data-quick-buy-source="slime-scope-column">${i(qe()||"0.1")}</button>
      </article>
    ...
    <div class="slime-scope-web-columns" aria-label="Slime Scope desktop columns">
      ${[["new","New","Fresh launches"],["graduating","Graduating","Near migration"],["graduated","Graduated","Moved to market"]].map(([t,a,r])=>{const o=pp(t);return`
  ...
  `}function iw(){const e=Ip(),[,,t]=e,a=Nc(n.slimeScopeMode),o=!!(z("slimeScope").inFlight||n.livePairsLoadingByBucket?.[a]),s=n.livePairsRefreshErrorByBucket?.[a],c=be(Op(op(),e[0])),l=at("slimeScope",c),u=l.length?Xn()?ct(l,{context:"live",shareBuilder:Ta,hideToolbar:!0}):St(l,{layout:"terminal",limit:Math.max(1,l.length),actionLabel:"Trade"}):s?O("Unable to load pairs. Try refreshing.","Cook Spot hit a snag — it keeps retrying, or tap Refresh Scope."):o?O("Loading Cook Spot…","Scanning DEX, boosted, and pump pairs for this category."):O("No pairs found for this filter yet","Try another category — Cook Spot keeps scanning in the background.");return`
    <section class="slime-scope-page">
      <div class="command-controls slime-scope-controls">
        <div class="cooks-category-label cook-spot-head">${Uw(e)}<span>${i(t)}</span></div>
        ${Ep(c.length,la())}
        ${Uu("slime-scope")}
  ...
  `}function qk(){const e=De(),t=be(e?.rows||[]),a=fn(t),r=[...a].sort(Qe),o=jd(n.kolScan?.rows||[]).filter(C=>!ir(C)),s=fn(o),c=cr(t,o),l=fn(c),u=mn(),d=ya(l,8,ba("best-picks"),2),p=new Set(d.map(ga).filter(Boolean)),f=Zd(r,p),y=ya(f.length?f:r,12,ba("live-pairs"),0),g=new Set([...p,...y.map(ga).filter(Boolean)]),S=Zd(s,g),P=ya(S.length?S:s,12,ba("kol-signals"),1),T=!!n.livePairsLoadingByBucket[n.livePairBucket],b=la(),A="Trade";return`
        ...
        <div class="command-controls">
          ...
          <label>
            ...
            <select data-terminal-sort>
              ${rf.map(([C,M])=>`<option value="${C}" ${n.terminalSort===C?"selected":""}>${M}</option>`).join("")}
            </select>
          </label>
          ${Uu("terminal-top")}
  ...
  `}function Hk(){const e=lt();if(!e)return"Trade";const t=qe(e);return t?`Buy ${t} SOL`:$m(e,"Trade")}function va(){const e=lt(),t=qe(e);return t?`Buy ${t} SOL`:"Quick Buy"}function qo(){const e=va();document.querySelectorAll("[data-quick-buy-token]").forEach(t=>{v(t,e)})}function wa(e=""){const t=String(e||"").trim();if(!t)return null;const a=sr().find(o=>String(o?.tokenMint||o?.mint||o?.tokenAddress||"").trim()===t);if(a)return a;const r=n.smartChartTokenRef||{};return String(r.tokenMint||r.mint||"").trim()===t?r:{tokenMint:t,shortMint:w(t),symbol:w(t),dexUrl:Q(t)}}function lw(e=""){return{normal_buy:"Normal buy size can be considered",small_buy:"Trade small or use protection",watch_only:"Watch-only unless you accept high risk",avoid:"Avoid recommended"}[e]||"Review risk before buying"}function cw(e=""){return{conservative:"Conservative",scalp:"Scalp",degen:"Degen"}[e]||"Conservative"}function mp(e={}){if(!_("slimeShieldEnabled",!0))return"";const t=Ye(e),a=String(e.tokenMint||t.mint||"").trim(),r=t.verdict||"CAUTION";return`
  ...
  `}function fp(e=[],t="risk",a="No strong signal cached yet."){const r=(Array.isArray(e)?e:[]).filter(o=>t==="positive"?o.severity==="positive":o.severity!=="positive").slice(0,5);return r.length?`
    <ul class="slimeshield-factor-list">
      ${r.map(o=>`
        <li>
  ...
  `:`<p class="slimeshield-muted">${i(t)}</p>`}function zo(e,t="Not cached yet"){const a=String(e||"").trim();return!a||a.toLowerCase()==="warming"||a.toLowerCase()==="checking"?t:a}function jo(e,t=r=>String(r),a="Not cached yet"){return Number.isFinite(e)&&e>0?t(e):a}function fr(e,t,a=""){if(e.__lastDrawerHtml===t)return!1;const r=a?e.querySelector(a):null,o=r?r.scrollTop:0;if(e.innerHTML=t,e.__lastDrawerHtml=t,a&&o){const s=e.querySelector(a);s&&(s.scrollTop=o)}return!0}function Sa(){let e=document.querySelector("[data-dev-info-drawer-root]");e||(e=document.createElement("div"),e.dataset.devInfoDrawerRoot="true",document.body.appendChild(e));const t=n.devInfoDetails||{},a=!!(t.open&&t.tokenMint);if(document.body.classList.toggle("dev-info-drawer-open",a),!a||!_("devInfoEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=String(t.tokenMint||"").trim(),o=wa(r)||cn(r)||{tokenMint:r},s=gp(r),c=n.devInfoSummaries?.[r]||ur(o),l=ha(s.status||c.status),u=s.confidence||c.confidence||"unknown",d=!!n.devInfoLoading?.[`details:${r}`],p=s.likelyDevWallet||c.likelyDevWallet||"",f=s.currentPosition||null,y=s.historicalStats||{},g=s.linkedWalletSignals||{},S=s.marketContext||{},P=s.sourceHydration||{},T=Array.isArray(s.sourceEvidence)?s.sourceEvidence.slice(0,8):[],b=E(S.marketCap,o.marketCap,o.fdv),A=E(S.liquidityUsd,o.liquidityUsd),C=E(S.volume5m,o.volume5m,o.volumeM5),M=E(S.volumeH1,o.volumeH1,o.volume1h),q=E(S.pairAgeMinutes,o.pairAgeMinutes,Number(o.pairAgeSeconds)/60),J=S.metadataAuthority||o.metadataAuthority||o.updateAuthority||"",Se=S.mintAuthority||o.mintAuthority||"",Ze=S.freezeAuthority||o.freezeAuthority||"",U=!!(S.heliusDasIndexedAt||S.heliusDasSource||o.heliusDasSource||J||Se||Ze),We=[...Array.isArray(s.externalLinks)?s.externalLinks:[],...Array.isArray(c.externalLinks)?c.externalLinks:[],{label:"Solscan Token",url:r?`https://solscan.io/token/${encodeURIComponent(r)}`:""},{label:"Dex",url:o.dexUrl||Q(r)},{label:"Solscan Wallet",url:p?`https://solscan.io/account/${encodeURIComponent(p)}`:""},{label:"KOLscan Wallet",url:p?`https://kolscan.io/account/${encodeURIComponent(p)}`:""},{label:"Bubblemap",url:r?`https://app.bubblemaps.io/sol/token/${encodeURIComponent(r)}`:""},{label:"X",url:o.twitterUrl||o.xUrl},{label:"TG",url:o.telegramUrl},{label:"Website",url:o.websiteUrl}].filter((de,fs,hs)=>/^https?:\/\//i.test(String(de.url||""))&&hs.findIndex(wn=>String(wn.url||"")===String(de.url||""))===fs).slice(0,8),Gt=Array.isArray(y.recentLaunches)?y.recentLaunches.slice(0,5):[],Pt=`
    ...
    <aside class="dev-info-drawer" role="dialog" aria-modal="true" aria-label="Dev Info details">
      ...
      <section>
        ...
        <dl class="kol-dump-metrics">
          <div><dt>Wallet</dt><dd>${i(dw(p))}</dd></div>
      ...
      <section>
        ...
        <dl class="kol-dump-metrics">
          ...
          <div><dt>Mint / freeze</dt><dd>${i(`${Se?w(Se):U?"none":"not indexed"} / ${Ze?w(Ze):U?"none":"not indexed"}`)}</dd></div>
      ...
      <section>
        ...
        ${Gt.length?`
          <ul class="dev-info-launches">
            ${Gt.map(de=>`<li><span>${i(de.symbol||w(de.mint||""))}</span><small>${i(de.outcomeLabel||"unknown")}</small></li>`).join("")}
          </ul>
        `:""}
      </section>`:""}
  ...
  `;fr(e,Pt,".dev-info-drawer")}function wp(e=""){return{mint:e,sampleSize:0,confidence:"low",matchedTraits:[],winRatePercent:null,medianMaxUpsidePercent:null,medianMaxDrawdownPercent:null,failRatePercent:null,bestExitPattern:"",summary:"Not enough local history yet. Replay improves as SlimeWire tracks more launches.",updatedAt:new Date().toISOString()}}function sl(e=""){const t=String(e||"").trim();return n.replayResults?.[t]||wp(t)}function bn(e,t="%"){return Number.isFinite(Number(e))?`${Math.round(Number(e))}${t}`:"n/a"}function hw(e=""){if(!_("replayBeforeBuyEnabled",!0))return"";const t=String(e||"").trim();if(!t)return"";const a=sl(t);return`
    ...
    <aside class="slimeshield-drawer" role="dialog" aria-modal="true" aria-label="SlimeShield details">
      ...
      <section>
        ...
        <dl class="kol-dump-metrics">
          ...
          <div><dt>Age</dt><dd>${i(Number.isFinite(P)?Ko(P):zo(o.pairAgeLabel||Ht(o),"Not cached yet"))}</dd></div>
      ...
      <section>
        ...
        ${fp(f,"risk","No major cached risk reason yet. Missing data lowers confidence.")}
      </section>
      <section>
        <h4>Positive Signals</h4>
        ${fp(f,"positive","No positive signal is strong enough to highlight yet.")}
      </section>
      <section class="slimeshield-action-note">
        <h4>Suggested Action</h4>
        <p>${i(lw(s.suggestedAction))}</p>
        <small>Protected Buy preset suggestion: ${i(cw(s.protectedBuyPreset))}</small>
      </section>
      ${hw(r)}
      <div class="slimeshield-drawer-actions">
  ...
  `;fr(e,Ze,".slimeshield-drawer")}function cl(e){const t=e==="bundle"?"bundle":"trade";n.activeTab=t,t==="trade"&&(n.editingTradePresetId=""),t==="bundle"&&(n.editingBundlePresetId=""),window.history.pushState({},"","/terminal"),h({force:!0})}function Kk(e){if(!e?.tokenMint)return O("No token selected","Click any row to preview it here without leaving the live feeds.");const t=nt().some(a=>String(a.tokenMint)===String(e.tokenMint));return`
    ...
    <dl class="mini-stats">
      ...
      <div><dt>${_("slimeShieldEnabled",!0)?"Shield":"Score"}</dt><dd>${i(_("slimeShieldEnabled",!0)?Ye(e).verdict||"CAUTION":e.bestPickScore?`${e.bestPickScore}/100`:"n/a")}</dd></div>
  ...
  `}function bw(e=""){const t=String(e||"").trim();return t?(n.pnl?.trades||[]).filter(a=>String(a?.tokenMint||a?.mint||"").trim()===t):[]}function zk(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=bw(a),o=!!(dn(e)&&Ui(e)),s=o?dn(e):e.dexUrl||Q(Dd(e)||a),c=o?"Pump":"DEX";return`
  ...
  `}function jk(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=km(e||{});return`
  ...
  `}function yw(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=n.chartTradeTab==="sell"?"sell":"buy",o=le(),s=n.wallets?.length?String(n.wallets[0]?.index||""):"",c=gd(),l=lt(),u=l?.walletIndex||(l?.walletIndexes||[])[0]||"",d=o?.publicKey&&bd(o)?"connected":"",p=n.chartBuyWalletIndex||d||(c?.index?String(c.index):"")||u||s||(o?.publicKey?"connected":""),f=ce(p),y=n.quickBuyAmountOverride||qe(l)||"",g=l?pn("trade"):"No preset / manual",S=String(l?.slippageBps||"400"),P=String(l?.takeProfitPct||"25"),T=String(l?.stopLossPct||"8"),b=String(l?.sellDelay||"off"),A=String(l?.sellPercent||"100"),C=new Set(["300","400","500"]),M=Number.isFinite(Number(S))?`${Number(S)/100}%`:S,q=t?`${i(t.uiAmount||"Position")} tokens | ${i(t.estimatedValueSol||"value n/a")} SOL`:"No SlimeWire position tracked for this token.";return`
  ...
  `}function Gk(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim();return a?`
  ...
  `}function ww(){try{return Sw()}catch(e){console.error("Smart Chart render failed:",e);const t=String(n.smartChartToken||n.tradeToken||n.terminalToken||"").trim(),a=t?w(t):"No token selected",r=t?`https://dexscreener.com/solana/${encodeURIComponent(t)}?embed=1&theme=dark&trades=1&info=0`:"";return`
    ...
    `}}function Sw(){const e=Bo(),t=String(e?.tokenMint||"").trim(),a=t?nt().find(s=>String(s.tokenMint)===t):null,r=t?be([e,...or().filter(s=>String(s.tokenMint||"")===t)]).filter(Boolean).slice(0,5):ya(cr(),5,ba("smart-chart-suggest"),1);if(!t)return`
    ...
    <section class="smart-chart-terminal smart-chart-clean-terminal">
      ...
      <div class="smart-chart-grid smart-chart-clean-grid">
        <article class="terminal-panel smart-chart-main smart-chart-clean-main">
          ${(()=>{kw(t);const s=Sp(t);return s?`<div class="coin-banner-hero" style="background-image:url('${s}')" role="img" aria-label="Coin banner"></div>`:""})()}
          <div class="smart-chart-token-header smart-chart-clean-token-header${Sp(t)?" has-banner":""}">
            ${pt(e)}
            <div>
              <strong>${i(o)}</strong>
              <small>${i(e.name||e.category||"Token")}</small>
  ...
  `}function Sp(e){const t=String(e||"").trim();return n.coinBanners&&n.coinBanners[t]||""}let kp="";function kw(e){const t=String(e||"").trim();!t||kp===t||(kp=t,k(`/api/web/coin-banner?mint=${encodeURIComponent(t)}`).then(a=>{const r=String(a?.bannerUri||"");r&&(n.coinBanners=n.coinBanners||{},n.coinBanners[t]=rt(r),n.activeTab==="smartChart"&&h({preserveSmartChartFrame:!0}))}).catch(()=>{}))}let ul="",$p=0;function Tp(e){e&&(ul===e&&Date.now()-$p<3e4||(ul=e,$p=Date.now(),k(`/api/web/calls?mint=${encodeURIComponent(e)}`).then(t=>{n.chartCalls={mint:e,...t},n.activeTab==="smartChart"&&h({preserveSmartChartFrame:!0})}).catch(()=>{})))}function $w(e){const t={bullish:["🟢","BULLISH"],bearish:["🔴","BEARISH"],warning:["⚠️","WARNING"],question:["❓","QUESTION"]},[a,r]=t[e]||["⚪",String(e||"").toUpperCase()];return`${a} ${r}`}function Tw(e){Tp(e);const t=n.chartCalls?.mint===e?n.chartCalls:null,a=t?.calls||[],r=!!(n.token&&n.user);return`
      ...
      ${a.length?`
        <div class="table-list compact-table">
          ${a.map(o=>`
            <article class="row-card">
              <div class="row-main">
                <strong>${i($w(o.side))} <span class="muted-text">by ${i(o.handle)}</span>
  ...
  `}async function Aw(e){const t=m("[data-call-status]");try{const a=m("[data-call-side]")?.value||"bullish",r=m("[data-call-target]")?.value||"",o=m("[data-call-note]")?.value||"";v(t,"Posting call..."),await k("/api/web/calls",{method:"POST",body:JSON.stringify({tokenMint:e,side:a,targetX:r,note:o,source:"site"})}),v(t,"Call posted - it is now being tracked."),ul="",Tp(e)}catch(a){v(t,N(a?.message||"Could not post call."))}}function Pw(e,t=!1){const a=e?.tokenMint?n.positions.find(s=>String(s.tokenMint)===String(e.tokenMint)):null,r=pn("trade"),o=pn("bundle");return t?`
  ...
  `:O("No live trade history yet","Submitted web trades will appear here after refresh.")}function Bw(){const e=n.pnl?.trades||[],t=at("liveTrades",e);return`
  ...
  `}function Cp(){const e=Array.isArray(n.tradePlans)?n.tradePlans:[],t=[n.tradePlanResult,n.bundleResult,n.volumeResult,n.sniperResult,n.kolResult,n.launchResult].filter(Boolean).map(r=>({...r,localOnly:!0})),a=e.length?e:t;return a.length?`
    <div class="table-list compact-table">
      ${a.map(r=>`
        <article class="row-card stop-loss-audit-card">
          <div class="row-main">
            ...
            ${r.wallets?.length?`<div class="audit-wallet-list">${r.wallets.map(Rw).join("")}</div>`:""}
          </div>
          <div class="card-actions compact">
  ...
  `}function Lp(){const e=n.balances.filter(a=>a.error),t=n.balances.reduce((a,r)=>a+Number(r.warnings?.length||0),0);return`
  ...
  `}function xp(e=!1){const t=n.terminalTxAudit;return`
    <section class="${e?"tx-audit compact":"terminal-layout tx-audit"}">
      <main class="terminal-main">
        ...
        ${t?Iw(t):O("No transaction loaded","Use this when a wallet balance looks stale or a trade needs accounting review.")}
      </main>
      ${e?"":`<aside class="trade-side order-ticket-stack">${Cp()}${Lp()}</aside>`}
    </section>
  `}function Iw(e){return e.error?`<article class="row-card"><strong>Audit failed</strong><span>${i(e.error)}</span></article>`:`
...
`)||"No logs returned.")}</pre>
  ...
  `}function Ow(e=[]){const t=[...e].sort((a,r)=>Number(r.bestPickScore||r.score||0)-Number(a.bestPickScore||a.score||0)||Qe(a,r));return ya(t,5,ba("cooks-best"),1)}function Te(e){const t=Number(e);return Number.isFinite(t)?t:0}function Mp(){const e=n.liveFeedCategory||"best";return Ws.find(([t])=>t===e)||Ws[0]}function $a(e={}){return Yo(e)||Wp(e)||gl(e)||0}function pl(e={}){return Te(e.buys5m)+Te(e.buysH1)+Te(e.sells5m)+Te(e.sellsH1)}function Bp(e={}){const t=Te(e.buys5m)+Te(e.buysH1),a=Te(e.sells5m)+Te(e.sellsH1),r=t+a;return r>0?t/r:.5}function gr(e={}){return Math.max(Te(e.m5),Te(e.h1),Te(e.h24))}function Go(e={}){return Math.max(Te(e.m5),Te(e.h1))}function qt(e={}){return Go(e)*Math.log10(10+$a(e))*(.5+Bp(e))}function ml(e={}){return e.boosted||e.isBoosted||e.boost||e.boosts?!0:`${e.source||""} ${e.category||""} ${e.liveLabel||""} ${e.sourceLabel||""}`.toLowerCase().includes("boost")}function Ew(e=[],t="best"){const a=[...e];switch(t){case"volume":return a.sort((r,o)=>$a(o)-$a(r));case"liquidity":return a.sort((r,o)=>dt(o)-dt(r));case"marketcap":return a.sort((r,o)=>ut(o)-ut(r));case"active":return a.sort((r,o)=>pl(o)-pl(r));case"fresh":return a.sort(Qe);case"gainers":return a.sort((r,o)=>gr(o)-gr(r));default:return a.sort((r,o)=>Te(o.bestPickScore||o.score)-Te(r.bestPickScore||r.score)||Qe(r,o))}}function Fw(){const e=n.liveTerminalCategory||"dexTrending";return qa.find(([t])=>t===e)||qa[0]}function Ww(e,t,a,r){return`
    ...
    </label>`}function Dw(){if(n.activeTab==="terminal"){const t=Fw();return{categories:qa,activeId:t[0],sub:t[2],attr:"data-live-terminal-category",cap:"Discover",rank:a=>Op(a,t[0]),hasBest:!1}}const e=Mp();return{categories:Ws,activeId:e[0],sub:e[2],attr:"data-live-feed-category",cap:"Feed",rank:t=>Ew(t,e[0]),hasBest:e[0]==="best"}}function Nw(e={}){if(ml(e))return{cls:"boost",text:"⚡ Boosted"};const t=gr(e);if(t>=40)return{cls:"gain",text:`▲ ${Math.round(t)}%`};const a=Number(e.pairAgeMinutes);return Number.isFinite(a)&&a>=0&&a<=10?{cls:"fresh",text:"✨ Fresh"}:Go(e)>=25?{cls:"hot",text:"🔥 Hot"}:Bp(e)>=.7&&pl(e)>=24?{cls:"active",text:"● Active"}:null}function fl(e={}){const t=Nw(e);return t?`<span class="signal-badge signal-badge-${t.cls}">${i(t.text)}</span>`:""}function Rp(e={}){return e.isPump||e.pump||e.pumpFun||e.pumpUrl?!0:`${e.source||""} ${e.category||""} ${e.dexId||""} ${e.dexName||""}`.toLowerCase().includes("pump")}function _w(e={}){const t=`${e.name||""} ${e.symbol||""} ${e.category||""}`.toLowerCase();return Rp(e)||/meme|dog|cat|pepe|wif|inu|elon|moon|bonk|frog|chad/.test(t)}function Ip(){const e=n.cookSpotCategory||"dexTrending";return qa.find(([t])=>t===e)||qa[0]}function Op(e=[],t="dexTrending"){const a=[...e];switch(t){case"fresh":return a.sort(Qe);case"dexBoosted":{const r=a.filter(ml).sort((s,c)=>$a(c)-$a(s)),o=a.filter(s=>!ml(s)).sort((s,c)=>qt(c)-qt(s));return[...r,...o]}case"pumpTrending":{const r=a.filter(Rp);return(r.length?r:a).sort((o,s)=>qt(s)-qt(o))}case"memeMovers":{const r=a.filter(_w);return(r.length?r:a).sort((o,s)=>gr(s)-gr(o))}case"earlyMomentum":{const r=a.filter(o=>{const s=Number(o.pairAgeMinutes);return!Number.isFinite(s)||s<=180});return(r.length?r:a).sort((o,s)=>Go(s)-Go(o))}case"graduating":{const r=a.filter(o=>_o(o)||Uo(o)==="graduating");return(r.length?r:a).sort((o,s)=>qt(s)-qt(o))}case"graduated":{const r=a.filter(o=>gn(o)||Uo(o)==="graduated");return(r.length?r:a).sort((o,s)=>$a(s)-$a(o))}default:return a.sort((r,o)=>qt(o)-qt(r))}}function Uw(e=Ip()){const[t]=e;return`
    ...
    </label>`}function Ep(e=0,t=""){const a=Ya(t),r=a===null?"live":Hn(a);return`<div class="cooks-meta" data-cooks-meta><span><b>${e}</b> ${e===1?"pair":"pairs"}</span><span aria-hidden="true">·</span><span>updated ${i(r)}</span></div>`}function hl(e=[]){const t=Dw(),a=Ww(t.categories,t.activeId,t.attr,t.cap),r='<button type="button" class="cooks-inline-refresh" data-refresh-live-pairs title="Refresh feed">↻ Refresh</button>',o=Ep(e.length,la()),s={context:"live",shareBuilder:Ta,hideToolbar:!0};if(t.hasBest){const l=Ow(e),u=new Set(l.map(ga).filter(Boolean)),d=[...e].sort(Qe).filter(f=>!u.has(ga(f))),p=at("live",d);return`
  ...
  `}function Xk(e){const t={live:"Brand-new launches under an hour old. Best Picks rotates the strongest; Newest streams them as they appear.",under1h:"Pairs aged about 1 to 2 hours - past the first-minute chaos, early momentum still forming.",under3h:"Pairs aged about 3 to 6 hours - established enough to show a real volume and liquidity trend.",under1d:"Pairs aged about 24 to 48 hours - day-old survivors ranked by liquidity, volume, momentum, and risk."};return t[e]||t.live}function qw(){if(!n.user||!n.token)return`${Za()}${O("Create or log in to save a watchlist","You can browse scanners as a guest. Tap Watch after creating an account to save coins here.")}`;const e=n.watchlist?.rows||[],t=at("watchlist",e);return`
  ...
  `}function Jk(e){return ct(e,{context:"live",shareBuilder:Ta})}function ct(e,t={}){const a=t.shareBuilder||Ta,r=be(e),o=`signal-list ${t.context==="kol"?"signal-list-kol":""}`.trim();return r.length?`
    ...
    <div class="${i(o)}">
      ...
      ${r.map((s,c)=>Hw(s,c,{...t,shareText:a(s),priority:c<12})).join("")}
    </div>
  `:`
      ${t.hideToolbar?"":xi(t.context||"scanner")}
    ...
    <article class="signal-row ${l?"is-kol-signal":""}" data-token-chart="${i(e.tokenMint)}" data-token-chart-source="${i(a.context||"signal-row")}">
      ...
      <div class="signal-cell" data-cell="Liq"><span>${i(D(e.liquidityLabel,dt(e)>0?B(dt(e)):"","checking"))}</span><small>${Kw(e.h1)}</small></div>
      <div class="signal-cell" data-cell="MC"><span>${i(D(e.marketCapLabel,ut(e)>0?B(ut(e)):"","checking"))}</span><small>${i(e.category||e.signalType||"signal")}</small></div>
      <div class="signal-cell" data-cell="Txns"><span>${i(e.txnsLabel||e.winRateLabel||"n/a")}</span><small>${i(Wv(e))}</small></div>
      <div class="signal-cell volume-windows" data-cell="Vol">
        <span>${i(D(e.volumeH1Label,e.volumeLabel,Yo(e)>0?B(Yo(e)):"","checking"))}</span>
        <small>${Yd(e).map(([d,p])=>`${d} ${p}`).join(" | ")}</small>
      </div>
  ...
  `}function Xw(){const e=n.sniperResult;return e?.results?.length?`<div class="mini-results">${e.results.map(t=>`<span data-ok="${t.ok?"true":"false"}">${i(t.message||t)}</span>`).join("")}</div>`:""}function Jw(){const e=n.scan.rows||[],t=at("sniper",e);return e.length?`
    ...
    ${ct(t,{context:"sniper",primaryAction:"snipe",primaryActionLabel:"Snipe",shareBuilder:mg})}
    ${ia("sniper",e,"snipe candidates")}
  `:O("No usable picks","Refresh again or choose a different mode.")}function Qo(){return n.user?.connectedWallet?.publicKey||""}function Dp(){return n.ogreTek.markets.find(e=>e.symbol===n.ogreTek.selectedMarket)||n.ogreTek.markets[0]||null}function Yw(){return{marketSymbol:n.ogreTek.selectedMarket,direction:n.ogreTek.direction,orderType:n.ogreTek.orderType,collateralUsd:n.ogreTek.collateralUsd,leverage:n.ogreTek.leverage,slippagePct:n.ogreTek.slippagePct,priorityFeeLamports:n.ogreTek.priorityFeeLamports,limitPrice:n.ogreTek.limitPrice,stopPrice:n.ogreTek.stopPrice}}function Np(){return Sm(Yw(),Dp(),n.ogreTek.account,ke)}function ve(e,t=2){const a=Number(e);return Number.isFinite(a)?Math.abs(a)>=1e9?`$${(a/1e9).toFixed(2)}B`:Math.abs(a)>=1e6?`$${(a/1e6).toFixed(2)}M`:Math.abs(a)>=1e3?`$${(a/1e3).toFixed(1)}K`:`$${a.toFixed(t)}`:"n/a"}function mt(e){const t=Number(e);return Number.isFinite(t)?t>=1e3?`$${t.toLocaleString(void 0,{maximumFractionDigits:2})}`:`$${t.toFixed(t>=10?2:4)}`:"n/a"}function Zo(e,t=3){const a=Number(e);return Number.isFinite(a)?`${a>=0?"+":""}${a.toFixed(t)}%`:"n/a"}function _p(e){const t=Date.parse(e||"");if(!t)return"not loaded";const a=Math.max(0,Math.round((Date.now()-t)/1e3));return a<60?`${a}s ago`:`${Math.round(a/60)}m ago`}function es(){document.querySelectorAll("[data-ogre-tek-field]").forEach(e=>{const t=e.dataset.ogreTekField;!t||!(t in n.ogreTek)||(e.type==="checkbox"?n.ogreTek[t]=!!e.checked:n.ogreTek[t]=e.value)})}async function Qw(){!ke.enabled||n.ogreTek.loading||n.ogreTek.markets.length||n.ogreTek.error||await br({silent:!0}).catch(e=>{n.ogreTek.error=N(e.message),h({force:!0})})}async function br({force:e=!1,silent:t=!1}={}){if(ke.enabled&&!(n.ogreTek.loading&&!e)){n.ogreTek.loading=!0,n.ogreTek.error="",t||h({force:!0});try{const a=Qo(),[r,o,s,c]=await Promise.all([wr.getMarkets(),wr.getAccount(a),wr.getPositions(a),wr.getOpenOrders(a)]);n.ogreTek.markets=r||[],n.ogreTek.account=o||null,n.ogreTek.positions=s||[],n.ogreTek.orders=c||[],n.ogreTek.markets.some(l=>l.symbol===n.ogreTek.selectedMarket)||(n.ogreTek.selectedMarket=n.ogreTek.markets[0]?.symbol||"SOL-PERP"),n.ogreTek.status=`Updated ${new Date().toLocaleTimeString()}`}catch(a){n.ogreTek.error=N(a.message)}finally{n.ogreTek.loading=!1,h({force:!0})}}}function Zw(){return`
  ...
  `}function eS(){if(ym(ke)!=="enabled")return Zw();const e=!!Qo(),t=Dp(),a=Np(),r=a.quote,o=n.ogreTek.account,s=a.ok&&!n.ogreTek.loading,c=n.ogreTek.error?"Provider Error":n.ogreTek.loading?"Loading":"Ready",l=ke.demoMode?"Review Demo Trade":"Review Trade",u=ke.demoMode?"Confirm Demo Review":"Confirm Order",d=ke.demoMode?!n.ogreTek.riskAccepted||!a.ok:!gm({validation:a,riskAccepted:n.ogreTek.riskAccepted,demoMode:ke.demoMode});return`
    <section class="ogre-tek-page">
  ...
  `}function tS(){return n.ogreTek.loading&&!n.ogreTek.markets.length?O("Loading markets","Ogre Tek is loading demo perps markets."):n.ogreTek.markets.length?`
    <div class="ogre-market-grid">
      ${n.ogreTek.markets.map(e=>`
        <button type="button" class="ogre-market-card" data-ogre-tek-market="${i(e.symbol)}" data-active="${e.symbol===n.ogreTek.selectedMarket}">
          ...
          <small>Fresh ${i(_p(e.updatedAt))}</small>
        </button>
      `).join("")}
    </div>
  `:O("No markets available","No allowed perps markets are available for this provider.")}function aS(e,t){return`
  ...
  `}function Up(e){const t=e.errors||[],a=e.warnings||[];return!t.length&&!a.length?'<p class="trade-status" data-ok="true">Ogre Guardrails passed for demo review.</p>':`
    <div class="ogre-risk-list">
      ${t.map(r=>`<p data-kind="error">${i(r)}</p>`).join("")}
      ${a.map(r=>`<p data-kind="warning">${i(r)}</p>`).join("")}
    </div>
  `}function nS(){return Qo()?n.ogreTek.positions.length?`
  ...
  `:O("No open positions","Mock positions will appear here when the provider reports them."):O("Wallet disconnected","Connect Phantom, Solflare, Backpack, or another detected Solana wallet to view perps account data.")}function rS(){return Qo()?n.ogreTek.orders.length?`
  ...
  `:O("No orders","Open, trigger, and history orders will list here when a real adapter is configured."):O("Wallet disconnected","Connect a wallet to load open and trigger orders.")}function oS(e){return e?.connected?`
    <div class="ogre-account-grid">
      ...
      <span><small>Account Freshness</small><strong>${i(_p(e.updatedAt))}</strong></span>
    </div>
  `:"<p>Connect a wallet to load collateral, health, positions, and margin risk.</p>"}function sS({validation:e,quote:t,market:a,confirmButtonText:r,confirmDisabled:o}){const s=e.order||{};return`
  ...
  `}function qp(){return{role:"assistant",text:"Ogre Agent ready. Ask naturally: check this CA, show links, does it look risky, buy 0.1 SOL from wallet 1, sell half, refresh positions, find best picks, or ask where anything is on web or mobile.",actions:[{label:"Show Positions",type:"open_tab",tab:"positions"},{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Fast Mode",type:"toggle_agent_fast_mode"},{label:"Auto-Trade On",type:"approve_agent_auto_trade"},{label:"Best Picks",type:"open_tab",tab:"ogreAi"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}const yl="slimewire:ogreAgentMessages:v1",vl="slimewire:ogreAgentLastToken:v1";function iS(){try{const e=JSON.parse(localStorage.getItem(yl)||"[]");return Array.isArray(e)?e.filter(t=>t&&typeof t=="object"&&String(t.text||"").trim()).slice(-50).map(t=>({role:t.role==="user"?"user":"assistant",text:String(t.text||"").slice(0,1200),actions:Array.isArray(t.actions)?t.actions.slice(0,4):[],retryText:String(t.retryText||"").slice(0,1200)})):[]}catch{return[]}}function lS(){try{localStorage.setItem(yl,JSON.stringify(yn().slice(-50)))}catch{}}function Kt(){if(n.ogreAgentLastTokenMint)return String(n.ogreAgentLastTokenMint);try{n.ogreAgentLastTokenMint=String(localStorage.getItem(vl)||"").trim()}catch{n.ogreAgentLastTokenMint=""}return n.ogreAgentLastTokenMint||""}function ts(e=""){const t=String(e||"").trim();if(!t)return"";n.ogreAgentLastTokenMint=t;try{localStorage.setItem(vl,t)}catch{}return t}function yn(){if(!Array.isArray(n.ogreAgentMessages)||!n.ogreAgentMessages.length){const e=iS();n.ogreAgentMessages=e.length?e:[qp()]}return n.ogreAgentMessages}function cS(){const e=String(n.smartChartToken||n.tradeToken||Kt()||"").trim(),t=e?wa(e):null,a=t?.tokenMint?Ye(t):null,r=e?gp(e):null,o=e?sl(e):null,s=uo().slice(0,3),c=e?nt().find(l=>String(l.tokenMint||"")===e):null;return{route:n.route,activeTab:n.activeTab,agentFastMode:n.ogreAgentFastMode,agentAutoTradeApproved:os(),lastTokenMint:Kt(),recentAgentMessages:yn().slice(-8).map(l=>({role:l.role==="user"?"user":"assistant",text:String(l.text||"").slice(0,600)})),smartChartToken:n.smartChartToken||"",tradeToken:n.tradeToken||"",livePairBucket:n.livePairBucket||"",slimeScopeMode:n.slimeScopeMode||"",walletConnected:!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey),walletCount:oi(),positionCount:nt().length,totalSol:Et().toFixed(4),selectedTradePreset:pn("trade"),selectedBundlePreset:pn("bundle"),quickBuyAmount:String($l()||""),currentToken:e?{tokenMint:e,symbol:t?.symbol||"",name:t?.name||"",watched:Xo(e)}:null,slimeShield:a?{verdict:a.verdict,summary:a.summary,confidence:a.confidence,suggestedAction:a.suggestedAction,topFactors:(a.factors||[]).slice(0,4).map(l=>l.message||l.label||l.key)}:null,devInfoSummary:r?{status:r.status,confidence:r.confidence,summary:r.summary,likelyDevWalletShort:r.likelyDevWallet?w(r.likelyDevWallet):"",currentPositionStatus:r.currentPosition?.positionStatus||"unknown",launchesTracked:r.historicalStats?.launchesTracked||0}:null,kolDumpDetector:s.length?s.map(l=>({displayName:l.displayName,riskLabel:l.riskLabel,dumpRiskPercent:l.lowData?null:l.dumpRiskPercent,lowData:!!l.lowData,summary:er(l)})):[],replayBeforeBuy:o?{sampleSize:o.sampleSize,confidence:o.confidence,winRatePercent:o.winRatePercent,medianMaxDrawdownPercent:o.medianMaxDrawdownPercent,summary:o.summary}:null,pnlSummary:{realized:zc(),positions:nt().length,totalSol:Et().toFixed(4)},profile:{hasReferralCode:!!n.user?.referralCode,referralCode:n.user?.referralCode||"",hasReferralPayoutWallet:!!n.user?.referralPayoutWallet,hasXHandle:!!(n.xHandle||n.user?.xHandle),traderBoardEnabled:n.user?.traderBoardVisible!==!1},selectedPosition:c?{tokenMint:c.tokenMint,uiAmount:c.uiAmount,estimatedValueSol:c.estimatedValueSol,openPnlSol:c.openPnlSol||c.realizedSol||""}:null,walletPublicKey:String(n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"").slice(0,80),recentPairs:Hp()}}function Hp(){const e=[],t=new Set,a=(r,o="feed")=>{if(!r)return;if(Array.isArray(r)){r.forEach(l=>a(l,o));return}if(Array.isArray(r.rows)){r.rows.forEach(l=>a(l,o));return}if(r.data&&Array.isArray(r.data.rows)){r.data.rows.forEach(l=>a(l,o));return}if(typeof r!="object")return;const s=String(r.tokenMint||r.mint||r.baseMint||r.tokenAddress||r.pairAddress||"").trim();if(!s)return;const c=s.toLowerCase();t.has(c)||(t.add(c),e.push({tokenMint:s,pairAddress:String(r.pairAddress||r.pair||"").trim(),symbol:String(r.symbol||r.baseSymbol||r.ticker||"").trim().slice(0,24),name:String(r.name||r.baseName||r.label||"").trim().slice(0,48),ageMinutes:Number(r.ageMinutes??r.pairAgeMinutes??r.ageMins??NaN),marketCap:Number(r.marketCap??r.marketCapUsd??r.fdv??NaN),liquidityUsd:Number(r.liquidityUsd??r.liquidity?.usd??NaN),volume5m:Number(r.volume5m??r.volume?.m5??NaN),volume1h:Number(r.volume1h??r.volumeH1??r.volume?.h1??NaN),buys5m:Number(r.buys5m??r.txns?.m5?.buys??NaN),sells5m:Number(r.sells5m??r.txns?.m5?.sells??NaN),score:Number(r.score??r.ogreScore??r.sniperScore??NaN),riskFlags:Array.isArray(r.riskFlags)?r.riskFlags.slice(0,6).map(String):[],riskLevel:String(r.riskLevel||r.risk||r.safetyNote||"").slice(0,40),twitterUrl:String(r.twitterUrl||r.xUrl||r.links?.twitter||r.links?.x||"").trim(),telegramUrl:String(r.telegramUrl||r.links?.telegram||"").trim(),websiteUrl:String(r.websiteUrl||r.website||r.links?.website||"").trim(),source:o}))};return a(n.livePairRows,"live-pairs"),a(n.slimeScopeRows,"slime-scope"),a(n.livePairs,"live-pairs"),Object.values(n.livePairsByBucket||{}).forEach(r=>a(r,"bucket")),Object.values(n.terminalFeeds||{}).forEach(r=>a(r,"terminal-feed")),e.sort((r,o)=>Kp(o)-Kp(r)).slice(0,24)}function Kp(e={}){const t=T=>Number.isFinite(Number(T))?Number(T):0,a=t(e.ageMinutes),r=t(e.marketCap),o=t(e.liquidityUsd),s=t(e.volume5m),c=t(e.volume1h),l=Math.max(s,c*.18),u=a>0?Math.max(0,90-Math.min(a,360))/2.5:12,d=a>120?Math.min(42,(a-120)/4):0,p=r>0&&r<=125e3?22:r>0&&r<=25e4?11:r>65e4?-18:0,f=r>0?l/r:0,y=f>=.08?24:f>=.04?16:f>=.018?8:l>0?2:-18,g=Math.max(0,t(e.buys5m)-t(e.sells5m))*2.6,S=e.twitterUrl||e.telegramUrl||e.websiteUrl?10:0,P=Array.isArray(e.riskFlags)&&e.riskFlags.length?Math.min(16,e.riskFlags.length*3):0;return t(e.score)+u+p+y+Math.log10(1+s+c)*7+Math.log10(1+o)*3+g+S-P-d}function uS(e={}){return String(e.label||e.type||"Run").slice(0,40)}function dS(e={},t=0){const a=Array.isArray(e.actions)?e.actions.slice(0,4):[],r=e.role!=="user";return`
    <div class="ogre-agent-message ${e.role==="user"?"user":"assistant"}">
      ...
      ${a.length?`<div class="ogre-agent-actions">${a.map((o,s)=>`<button type="button" data-ogre-agent-action="${t}:${s}">${i(uS(o))}</button>`).join("")}</div>`:""}
    </div>
  ...
  `}function mS(){const e=!!n.ogreAgentOpen,t=yn(),a=n.ogreAgentVoiceEnabled?"Voice On":"Voice Off",r=Gp(),o=n.ogreAgentListening?"Stop":"Mic";return`
  ...
  `}function F({force:e=!1}={}){let t=document.querySelector("[data-ogre-agent-mount]");t||(t=document.createElement("div"),t.dataset.ogreAgentMount="true",document.body.appendChild(t));const a=t.querySelector("[data-ogre-agent-input]"),r=!!(a&&document.activeElement===a),o=r?a.selectionStart:null,s=r?a.selectionEnd:null,c=t.querySelector("[data-ogre-agent-feed]"),l=c?c.scrollTop:0,u=c?c.scrollHeight-c.scrollTop-c.clientHeight<64:!0;a&&(n.ogreAgentDraft=a.value);const d=Array.isArray(n.ogreAgentMessages)?n.ogreAgentMessages:[],p=d[d.length-1]||{},f=[n.ogreAgentOpen?"open":"closed",n.ogreAgentLoading?"loading":"idle",n.ogreAgentStatus||"",d.length,p.role||"",p.text||"",Array.isArray(p.actions)?p.actions.length:0,n.ogreAgentVoiceEnabled?"voice-on":"voice-off",n.ogreAgentSpeaking?"speaking":"silent",n.ogreAgentListening?"listening":"not-listening"].join("|");if(!e&&r&&t.dataset.ogreAgentSignature===f)return;t.innerHTML=mS(),t.dataset.ogreAgentSignature=f,t.querySelector("[data-ogre-agent-close]")?.addEventListener("click",S=>{S.preventDefault(),S.stopPropagation(),rs()});const y=t.querySelector("[data-ogre-agent-input]");y&&(y.value=n.ogreAgentDraft||"",r&&(y.focus({preventScroll:!0}),o!==null&&s!==null&&y.setSelectionRange(o,s),setTimeout(()=>y.scrollIntoView({block:"nearest",behavior:"smooth"}),90)));const g=t.querySelector("[data-ogre-agent-feed]");g&&(e||u||n.ogreAgentLoading?g.scrollTop=g.scrollHeight:g.scrollTop=Math.min(l,Math.max(0,g.scrollHeight-g.clientHeight)))}document.addEventListener("focusin",e=>{const t=e.target?.matches?.("[data-ogre-agent-input]")?e.target:null;t&&setTimeout(()=>t.scrollIntoView({block:"nearest",behavior:"smooth"}),160)},{passive:!0});function ue(e={}){const t={role:e.role==="user"?"user":"assistant",text:String(e.text||"").slice(0,1800),actions:Array.isArray(e.actions)?e.actions.slice(0,4):[],retryText:String(e.retryText||"").slice(0,1200)};n.ogreAgentMessages=[...yn(),t].slice(-50),lS(),t.role==="assistant"&&zp(t.text||"")}function wl(){return typeof window<"u"&&"speechSynthesis"in window&&"SpeechSynthesisUtterance"in window}function fS(){if(!wl())return null;const e=window.speechSynthesis.getVoices?.()||[];if(!e.length)return null;const t=a=>{const r=`${a.name||""} ${a.voiceURI||""}`.toLowerCase(),o=String(a.lang||"").toLowerCase();let s=0;return(/^en[-_]/.test(o)||o==="en")&&(s+=18),/google|microsoft|natural|premium|enhanced|neural|online|siri|alex|daniel|guy|david|mark|george|james|fred/i.test(r)&&(s+=18),/google us english|microsoft guy|microsoft david|google uk english male|daniel|alex|george|james|mark/i.test(r)&&(s+=14),/female|zira|samantha|victoria|karen|moira|susan/i.test(r)&&(s-=2),/compact|eloquence|robot|novelty|whisper|bells|bubbles|organ|zarvox/i.test(r)&&(s-=25),a.localService&&(s+=3),s};return e.slice().sort((a,r)=>t(r)-t(a))[0]||e[0]||null}let vn=null;function hS(){if(typeof window>"u")return null;const e=window.AudioContext||window.webkitAudioContext;if(!e)return null;try{return(!vn||vn.state==="closed")&&(vn=new e),vn.state==="suspended"&&vn.resume(),vn}catch{return null}}function Vp(e="reply"){if(!n.ogreAgentVoiceEnabled||!n.ogreAgentOpen)return;const t=hS();if(t)try{const a=t.currentTime,r=e==="online"?.22:.34,o=t.createGain(),s=t.createBiquadFilter(),c=t.createOscillator(),l=t.createOscillator(),u=t.createGain();o.gain.setValueAtTime(1e-4,a),o.gain.exponentialRampToValueAtTime(e==="online"?.08:.105,a+.035),o.gain.exponentialRampToValueAtTime(1e-4,a+r),s.type="lowpass",s.frequency.setValueAtTime(210,a),s.frequency.exponentialRampToValueAtTime(92,a+r),s.Q.setValueAtTime(5.2,a),c.type="sawtooth",c.frequency.setValueAtTime(e==="online"?92:68,a),c.frequency.exponentialRampToValueAtTime(e==="online"?64:49,a+r),l.type="sine",l.frequency.setValueAtTime(e==="online"?45:38,a),l.frequency.exponentialRampToValueAtTime(e==="online"?35:31,a+r),u.gain.setValueAtTime(.18,a),u.gain.exponentialRampToValueAtTime(1e-4,a+r),c.connect(s),s.connect(o),l.connect(u),u.connect(o),o.connect(t.destination),c.start(a),l.start(a),c.stop(a+r+.02),l.stop(a+r+.02)}catch{}}function $t(e=!1){n.ogreAgentSpeaking=!!e,n.ogreAgentOpen&&F({force:!0})}function as(){if(!wl()){$t(!1);return}try{window.speechSynthesis.cancel()}catch{}$t(!1)}function gS(e=""){return String(e||"").replace(/https?:\/\/\S+/gi," link available ").replace(/[•*_`#>~|]+/g," ").replace(/\b[A-HJ-NP-Za-km-z1-9]{32,44}\b/g," token address ").split(/\n+/).map(r=>r.replace(/^\d+\.\s*/,"").trim()).filter(r=>r&&!/^(open|refresh|show|check|buy|sell|dex|pump|telegram|website|x search|kol tracker)\b/i.test(r)).join(". ").replace(/\s+/g," ").split(/(?<=[.!?])\s+/).map(r=>r.trim()).filter(Boolean).slice(0,3).join(" ").trim().slice(0,360)}function zp(e=""){if(!n.ogreAgentVoiceEnabled||!n.ogreAgentOpen||!wl()){$t(!1);return}const t=gS(e);if(!t){$t(!1);return}try{window.speechSynthesis.cancel();const a=new window.SpeechSynthesisUtterance(t),r=fS();r&&(a.voice=r),a.pitch=.72,a.rate=.86,a.volume=1,a.onstart=()=>$t(!0),a.onend=()=>$t(!1),a.onerror=()=>$t(!1),$t(!0),Vp("reply"),window.speechSynthesis.speak(a)}catch{$t(!1)}}function bS(e){n.ogreAgentVoiceEnabled=!!e;try{localStorage.setItem("ogreAgentVoiceEnabled",n.ogreAgentVoiceEnabled?"on":"off")}catch{}n.ogreAgentVoiceEnabled?(n.ogreAgentStatus="Ogre voice on.",Vp("online"),zp("Ogre voice online.")):(as(),n.ogreAgentStatus="Ogre voice muted."),F({force:!0})}function jp(){return typeof window>"u"?null:window.SpeechRecognition||window.webkitSpeechRecognition||null}function Gp(){return!!jp()}async function Xp(){if(typeof navigator>"u"||!navigator.mediaDevices?.getUserMedia)return"unavailable";try{return(await navigator.mediaDevices.getUserMedia({audio:!0}))?.getTracks?.().forEach(t=>{try{t.stop()}catch{}}),"granted"}catch(e){const t=String(e?.name||e?.message||"").toLowerCase();return/notallowed|permission|denied/.test(t)?"denied":/notfound|notreadable|overconstrained/.test(t)?"unavailable":"failed"}}function Jp(e=""){const t=String(e||"").replace(/\s+/g," ").trimStart();n.ogreAgentDraft=t;const a=document.querySelector("[data-ogre-agent-input]");if(a){a.value=t;try{a.focus({preventScroll:!0}),a.setSelectionRange(t.length,t.length)}catch{}}}function ns(){Qt&&(clearTimeout(Qt),Qt=null),Oa&&(clearTimeout(Oa),Oa=null)}function Yp(e,t=n.ogreAgentSpeechRecognizer){Oa&&clearTimeout(Oa),Oa=setTimeout(()=>{e!==et||n.ogreAgentSpeechRecognizer!==t||Vt("Mic timed out instead of staying open. Tap Mic again or type the command.")},Dm)}function Vt(e=""){et+=1,ns();const t=n.ogreAgentSpeechRecognizer;if(n.ogreAgentSpeechRecognizer=null,n.ogreAgentListening=!1,n.ogreAgentSpeechFinal="",t){t.onstart=null,t.onresult=null,t.onerror=null,t.onend=null;try{t.abort?.()}catch{}try{t.stop?.()}catch{}}e&&(n.ogreAgentStatus=e),n.ogreAgentOpen&&F({force:!0})}async function yS(){if(!Gp()){const s=await Xp();n.ogreAgentStatus=s==="denied"?"Mic permission was denied. Allow microphone access, then use Chrome or Edge speech input.":"This browser does not expose speech-to-text to SlimeWire. Typing and device keyboard dictation still work.",F({force:!0});return}n.ogreAgentLoading&&(n.ogreAgentRequestId="",n.ogreAgentLoading=!1,n.ogreAgentStatus="Cleared the stuck reply. Mic is opening..."),as(),Vt();const e=et;n.ogreAgentStatus="Checking microphone permission...",F({force:!0});const t=await Xp();if(e!==et||!n.ogreAgentOpen)return;if(t==="denied"){n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentSpeechFinal="",n.ogreAgentStatus="Mic permission denied. Allow microphone access to talk to Ogre.",F({force:!0});return}if(t==="unavailable"){n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentSpeechFinal="",n.ogreAgentStatus="No microphone is available to this browser. Typing still works.",F({force:!0});return}const a=jp(),r=new a,o=++et;n.ogreAgentSpeechRecognizer=r,n.ogreAgentListening=!0,n.ogreAgentSpeechBaseDraft=String(document.querySelector("[data-ogre-agent-input]")?.value||n.ogreAgentDraft||"").trim(),n.ogreAgentSpeechFinal="",n.ogreAgentStatus="Opening microphone...",F({force:!0}),r.continuous=!1,r.interimResults=!0,r.maxAlternatives=1,r.lang=/^en/i.test(navigator.language||"")?navigator.language:"en-US",Qt=setTimeout(()=>{o!==et||n.ogreAgentSpeechRecognizer!==r||Vt("Mic did not start. Check browser permission, then tap Mic again.")},Wm),r.onstart=()=>{o!==et||n.ogreAgentSpeechRecognizer!==r||(Qt&&(clearTimeout(Qt),Qt=null),n.ogreAgentListening=!0,n.ogreAgentStatus="Listening... speak your Ogre command.",Yp(o,r),F({force:!0}))},r.onresult=s=>{if(o!==et||n.ogreAgentSpeechRecognizer!==r)return;Yp(o,r);let c="",l="";for(let d=s.resultIndex||0;d<s.results.length;d+=1){const p=String(s.results[d]?.[0]?.transcript||"");s.results[d]?.isFinal?l+=` ${p}`:c+=` ${p}`}l.trim()&&(n.ogreAgentSpeechFinal=`${n.ogreAgentSpeechFinal||""} ${l}`.replace(/\s+/g," ").trim());const u=[n.ogreAgentSpeechBaseDraft,n.ogreAgentSpeechFinal,c.trim()].filter(Boolean).join(" ").replace(/\s+/g," ").trim();Jp(u)},r.onerror=s=>{if(o!==et||n.ogreAgentSpeechRecognizer!==r)return;ns();const c=String(s?.error||"");n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentSpeechFinal="",n.ogreAgentStatus=c==="not-allowed"?"Mic permission denied. Allow microphone access to talk to Ogre.":c==="no-speech"?"No voice heard. Tap Mic and try again.":c==="aborted"?"Voice input stopped.":"Voice input stopped. Typing still works.",F({force:!0})},r.onend=()=>{if(o!==et||n.ogreAgentSpeechRecognizer!==r)return;ns();const s=String(n.ogreAgentDraft||"").trim(),c=!!(s&&n.ogreAgentSpeechFinal&&!n.ogreAgentLoading);n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentStatus=c?"Voice command captured.":"Voice input stopped.",F({force:!0}),c&&setTimeout(()=>{Jp(s),ft()},100)};try{r.start()}catch{ns(),n.ogreAgentListening=!1,n.ogreAgentSpeechRecognizer=null,n.ogreAgentSpeechFinal="",n.ogreAgentStatus="Mic could not start. Typing still works.",F({force:!0})}}function vS(){n.ogreAgentListening||n.ogreAgentSpeechRecognizer?Vt("Voice input stopped."):yS()}function rs(){n.ogreAgentOpen=!1,n.ogreAgentStatus="",n.ogreAgentLoading=!1,n.ogreAgentRequestId="",Vt(),as(),F({force:!0})}function wS(e=""){const[t,a]=String(e).split(":");return yn()[Number(t)]?.actions?.[Number(a)]||null}function Qp(){return Array.isArray(n.wallets)&&n.wallets.length>0}function Zp(){return!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey||n.walletPublicKey||n.connectedWalletPublicKey)}function os(){return!!(!em()&&(n.ogreAgentAutoTradeApproved||Qp()||Zp()))}function SS(e="wallet-sync"){return em()?!1:Qp()||Zp()?(kl(!0),!0):(Sl(),!1)}function em(){try{return sessionStorage.getItem("ogreAgentAutoTradeRevoked")==="yes"}catch{return!1}}function Sl(){n.ogreAgentAutoTradeApproved=!1;try{sessionStorage.removeItem("ogreAgentAutoTradeApproved"),sessionStorage.removeItem("ogreAgentAutoTradeRevoked"),localStorage.removeItem("ogreAgentAutoTradeApproved")}catch{}}function kl(e,t={}){n.ogreAgentAutoTradeApproved=!!e;try{localStorage.removeItem("ogreAgentAutoTradeApproved"),n.ogreAgentAutoTradeApproved?(sessionStorage.setItem("ogreAgentAutoTradeApproved","yes"),sessionStorage.removeItem("ogreAgentAutoTradeRevoked")):(sessionStorage.removeItem("ogreAgentAutoTradeApproved"),t.revoked&&sessionStorage.setItem("ogreAgentAutoTradeRevoked","yes"))}catch{}}function tm(e){n.ogreAgentFastMode=!!e;try{localStorage.setItem("ogreAgentFastMode",n.ogreAgentFastMode?"on":"off")}catch{}}function Tt(e=""){const t=String(e||"").toLowerCase(),a=/\b(buy|ape|enter|grab|snipe|purchase|get in|go in|long|take entry)\b/.test(t),r=/\b(sell|exit|close|dump|cash out)\b/.test(t),o=/\b(take profit|tp)\b/.test(t)&&!/\b(set|with|stop loss|sl|target|preset)\b/.test(t);return a?"buy":r||o?"sell":""}function kS(e=""){const t=String(e||"").toLowerCase(),a=Tt(t);if(!a||/\b(if|only if|unless|after you check|check first|looks good|seems good|safe enough|popular enough|passes|good choice|good pick)\b/.test(t))return!1;const r=/\b(will you|would you|can you|could you|are you able|do i have to|will it|you will be able)\b/.test(t),o=a==="buy"?/\b(buy|ape|enter|grab|snipe|purchase|get in|go in|long|take entry)\b/.test(t):/\b(sell|exit|close|dump|cash out)\b/.test(t),s=!!(Kt()||n.smartChartToken||n.tradeToken),c=/\b(now|please|with|for|from|wallet|sol|%|all|half|quarter|this|it)\b/.test(t)||/\b[A-HJ-NP-Za-km-z1-9]{32,48}\b/.test(e)||a==="buy"&&s&&/\b(just\s+)?buy\b/.test(t);return!!(o&&c&&!r)}function $S(e=""){const t=String(e||"").toLowerCase(),a=(t.match(/(?:buy|ape|enter|grab|snipe|purchase|get in|go in|long|take entry).*?(?:with|for|using)\s*(\d+(?:\.\d+)?)\s*sol\b/)||t.match(/(\d+(?:\.\d+)?)\s*sol\b/)||[])[1];return a?Number(a):0}function $l(){const e=typeof lt=="function"?lt():null,t=Number(n.quickBuyAmountOverride||(typeof qe=="function"?qe(e):"")||e?.amountSol||"0");return Number.isFinite(t)&&t>0?t:0}function TS(e=""){const t=String(e||"").toLowerCase(),a=(t.match(/(?:take\s*profit|profit\s*take|tp|target|profit)[^0-9]*(\d{1,4}(?:\.\d+)?)\s*%?/)||[])[1]||"",r=(t.match(/(?:stop\s*loss|stoploss|sl)[^0-9]*(\d{1,3}(?:\.\d+)?)\s*%?/)||[])[1]||"",o=(t.match(/(?:slippage|slip)[^0-9]*(\d{1,3}(?:\.\d+)?)\s*%?/)||[])[1]||"",s=o?Math.round(Number(o)*100):0,c=[];return a&&c.push(`TP +${a}%`),r&&c.push(`SL -${r}%`),o&&c.push(`slippage ${o}%`),{takeProfitPct:a,stopLossPct:r,slippagePct:o,slippageBps:Number.isFinite(s)&&s>0?s:0,summary:c.join(" / ")}}function AS(e=""){const t=String(e||"").toLowerCase(),a=(t.match(/(\d{1,3})\s*%/)||[])[1];return a||(/\bhalf\b/.test(t)?"50":/\bquarter\b/.test(t)?"25":(/\ball\b|\bfull\b|100/.test(t),"100"))}function PS(e=""){const t=(String(e||"").toLowerCase().match(/(?:wallet|from)\s*#?\s*(\d{1,2})/)||[])[1];return t?Math.max(0,Number(t)-1):void 0}function CS(){const e=[],t=(r={})=>{const o=String(r.tokenMint||r.mint||r.tokenAddress||r.baseMint||r.pairAddress||"").trim();o&&e.push({tokenMint:o,symbol:String(r.symbol||r.baseSymbol||r.ticker||"").trim(),name:String(r.name||r.baseName||r.label||"").trim()})};n.smartChartToken&&t({tokenMint:n.smartChartToken,symbol:n.smartChartTokenSymbol}),n.tradeToken&&t({tokenMint:n.tradeToken,symbol:n.tradeTokenSymbol}),[n.livePairRows,n.slimeScopeRows,n.watchlist,n.positions,n.portfolioRows,n.ogreAiResult?.candidates].filter(Array.isArray).forEach(r=>r.forEach(t));const a=new Set;return e.filter(r=>{const o=r.tokenMint.toLowerCase();return a.has(o)?!1:(a.add(o),!0)})}function LS(e=""){const t=String(e||"").trim(),a=(t.match(/\b[A-HJ-NP-Za-km-z1-9]{32,48}\b/)||[])[0];if(a)return a;const r=t.toLowerCase();return CS().map(s=>{const c=s.symbol.toLowerCase(),l=s.name.toLowerCase();let u=0;return c&&new RegExp(`(^|[^a-z0-9])${c.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}([^a-z0-9]|$)`,"i").test(r)&&(u+=12+c.length),l&&r.includes(l)&&(u+=8+Math.min(16,l.length)),{...s,score:u}}).filter(s=>s.score>0).sort((s,c)=>c.score-s.score)[0]?.tokenMint||""}function ss(e={},t=""){const a={...e},r=Tt(t);if(!a.tokenMint&&!a.mint&&!a.ca){const o=LS(t)||Kt()||n.smartChartToken||n.tradeToken;o&&(a.tokenMint=o)}if(a.type==="confirm_buy"||r==="buy"){if(a.type=a.type||"confirm_buy",!a.amountSol){const s=$S(t)||$l();s>0&&(a.amountSol=s)}const o=TS(t);if(o.takeProfitPct&&!a.takeProfitPct&&(a.takeProfitPct=o.takeProfitPct),o.stopLossPct&&!a.stopLossPct&&(a.stopLossPct=o.stopLossPct),o.slippageBps&&!a.slippageBps&&(a.slippageBps=o.slippageBps),a.walletIndex===void 0){const s=PS(t);s!==void 0&&(a.walletIndex=s)}}return(a.type==="confirm_sell"||r==="sell")&&(a.type=a.type||"confirm_sell",a.percent=a.percent||AS(t)),a}function am(e={}){const t=[];return e.takeProfitPct&&t.push(`TP +${e.takeProfitPct}%`),e.stopLossPct&&t.push(`SL -${e.stopLossPct}%`),t.length?` Targets noted: ${t.join(" / ")}.`:""}function nm(e={},t=""){if(!n.ogreAgentFastMode||!os()||e.requiresReview||e.conditional)return!1;const a=Tt(t);return a?a==="buy"?e.type==="confirm_buy"&&!!(e.tokenMint||e.mint||e.ca)&&Number(e.amountSol||e.sol||e.amount||0)>0:a==="sell"?e.type==="confirm_sell"&&!!(e.tokenMint||e.mint||e.ca):!1:!1}async function zt(e={}){const t=String(e.type||""),a=String(e.tokenMint||e.mint||e.ca||n.smartChartToken||n.tradeToken||Kt()||"").trim();if(t==="toggle_agent_fast_mode"){tm(!n.ogreAgentFastMode),n.ogreAgentStatus=n.ogreAgentFastMode?"Fast Mode ON: clear trade requests run directly.":"Fast Mode OFF: Ogre will stage actions first.",ue({role:"assistant",text:n.ogreAgentStatus,actions:[{label:n.ogreAgentFastMode?"Turn Fast Mode Off":"Turn Fast Mode On",type:"toggle_agent_fast_mode"}]}),F();return}if(t==="approve_agent_auto_trade"){kl(!0),tm(!0),n.ogreAgentStatus="Agent Auto-Trade is enabled for this session. SlimeWire managed/session wallets run directly through the saved trade flow; connected wallets still approve direct wallet trades.",ue({role:"assistant",text:`${n.ogreAgentStatus}
External wallet apps may still require their own signature prompts. Managed wallets can run through the saved SlimeWire flow.`,actions:[{label:"Revoke Auto-Trade",type:"revoke_agent_auto_trade"},{label:"Show Positions",type:"open_tab",tab:"positions"},{label:"Best Picks",type:"open_tab",tab:"ogreAi"}]}),F();return}if(t==="revoke_agent_auto_trade"){kl(!1,{revoked:!0}),n.ogreAgentStatus="Agent Auto-Trade revoked. Ogre will still help, but direct trade requests need approval again.",ue({role:"assistant",text:n.ogreAgentStatus,actions:[{label:"Auto-Trade On",type:"approve_agent_auto_trade"}]}),F();return}if(t==="open_tab"){n.route="terminal",n.activeTab=e.tab||"terminal",window.history.pushState({},"",e.path||"/terminal"),h({force:!0});return}if(t==="open_chart"||t==="prepare_buy"){if(!a){n.ogreAgentStatus="Paste a token CA in the message first.",F();return}wt(ge(a,{source:"ogre-agent"}),{defaultTab:t==="prepare_buy"?"buy":"chart",focusAmountInput:t==="prepare_buy",source:"ogre-agent"});return}if(t==="prepare_sell"){n.route="terminal",n.activeTab="positions",window.history.pushState({},"","/terminal"),n.ogreAgentStatus=e.percent?`Sell ${e.percent}% staged. Use the position card confirm buttons.`:"Open Positions and use the sell confirm buttons.",h({force:!0});return}if(t==="refresh_wallet"){G(()=>yt({force:!0,reason:"ogre_agent"})),n.ogreAgentStatus="Wallet refresh started.",F();return}if(t==="refresh_feeds"){G(()=>Ja({force:!0,reason:"ogre_agent"})),n.ogreAgentStatus="Feed refresh started.",F();return}if(t==="open_wallet_connect"){ua({returnPath:"/terminal"}),n.ogreAgentStatus="Wallet connect opened.",F();return}if(t==="start_clip_recording"){ou(),n.ogreAgentStatus="REC started from Ogre Agent.",F();return}if(e.type==="open_quick_buy"){const r=String(e.tokenMint||e.mint||n.selectedToken?.mint||n.selectedToken?.pairAddress||"").trim();if(!r){n.ogreAgentStatus="Send me a token address first, then I can open the buy panel.",F();return}Number(e.amountSol||e.sol||e.amount||0)>0&&(n.quickBuyAmountOverride=String(e.amountSol||e.sol||e.amount||"")),ln(ge(r,{source:"ogre-agent-open-buy"}),{source:"ogre-agent-open-buy",forceModal:!0}),n.ogreAgentStatus="Buy panel opened. Review it and confirm with your wallet.",F();return}if(e.type==="confirm_buy"){const r=String(e.tokenMint||e.mint||e.ca||n.selectedToken?.mint||n.selectedToken?.pairAddress||n.smartChartToken||n.tradeToken||Kt()||"").trim(),o=Number(e.amountSol||e.sol||e.amount||$l()||0);if(!r||!Number.isFinite(o)||o<=0){r&&ln(ge(r,{source:"ogre-agent-buy-missing-amount"}),{source:"ogre-agent-buy-missing-amount",forceModal:!0}),n.ogreAgentStatus=r?"Buy panel opened. Pick the SOL amount and confirm with your wallet.":"Tell me the token address and amount, like: buy 0.1 SOL of CA.",F();return}const s=e.walletIndex!==void 0?e.walletIndex:le()?.publicKey?"connected":n.wallets[0]?.index??0,c=Number.isFinite(Number(e.slippageBps))?Number(e.slippageBps):void 0;n.ogreAgentLoading=!0,n.ogreAgentStatus=`Sending ${o} SOL buy request...`,F();try{const l=await Ao({tokenMint:r,walletIndex:s,amountSol:o,slippageBps:c,takeProfitPct:e.takeProfitPct||"",stopLossPct:e.stopLossPct||"",source:"ogre-agent-confirm-buy"});n.ogreAgentStatus=l?.ok===!1?l.error||l.message||"Buy failed. Check wallet/RPC status and retry.":`Buy submitted. Refreshing wallet and positions in the background.${am(e)}`,typeof yt=="function"&&yt({force:!0,reason:"ogre_agent_buy"}),typeof refreshPositionsNow=="function"&&refreshPositionsNow({force:!0,reason:"ogre_agent_buy"})}catch(l){n.ogreAgentStatus=l?.message||"Buy failed. Check wallet/RPC status and retry."}finally{n.ogreAgentLoading=!1,F()}return}if(e.type==="confirm_sell"){const r=String(e.tokenMint||e.mint||e.ca||n.selectedToken?.mint||n.selectedToken?.pairAddress||"").trim(),o=String(e.percent||e.percentText||"100").replace(/[^0-9.]/g,"")||"100";if(!r){n.activeTab="positions",n.ogreAgentStatus="I opened Positions. Pick a token or tell me the CA to sell.",h();return}n.ogreAgentLoading=!0,n.ogreAgentStatus=`Preparing sell ${o}%...`,F();try{await Co(r,o,{skipConfirm:!0,source:"ogre-agent-confirm-sell"}),n.ogreAgentStatus=`Sell ${o}% submitted. Refreshing wallet and positions in the background.`,typeof yt=="function"&&yt({force:!0,reason:"ogre_agent_sell"}),typeof refreshPositionsNow=="function"&&refreshPositionsNow({force:!0,reason:"ogre_agent_sell"})}catch(s){n.ogreAgentStatus=s?.message||"Sell failed. Check wallet/RPC status and retry."}finally{n.ogreAgentLoading=!1,F()}return}if(e.type==="open_external"){const r=String(e.url||e.href||"").trim();if(!/^https?:\/\//i.test(r)){n.ogreAgentStatus="That link is not available yet. Send the token CA and ask for links.",F();return}window.open(r,"_blank","noopener,noreferrer"),n.ogreAgentStatus="Opened trusted coin link.",F();return}if(e.type==="coin_breakdown"||e.type==="analyze_coin"){const r=ts(String(e.tokenMint||e.mint||e.ca||n.smartChartToken||n.tradeToken||Kt()||"").trim());if(!r){n.ogreAgentStatus="Paste a token CA and ask me to check it.",F();return}const o=s=>{const c=Number(s);return!Number.isFinite(c)||c<=0?"n/a":c>=1e9?`$${(c/1e9).toFixed(2)}B`:c>=1e6?`$${(c/1e6).toFixed(2)}M`:c>=1e3?`$${(c/1e3).toFixed(1)}K`:`$${c.toFixed(c>=1?2:6)}`};n.ogreAgentLoading=!0,n.ogreAgentStatus="Checking coin details...",F();try{const c=(await k(`/api/web/dex-token?token=${encodeURIComponent(r)}`,{timeoutMs:8e3,dedupe:!1,preserveSafeError:!0}))?.dexToken||{},l=c.symbol||c.baseSymbol||w(r),u=c.name||c.baseName||"Token",d=c.dexUrl||c.pairUrl||`https://dexscreener.com/solana/${r}`,p=c.pumpUrl||(String(r).toLowerCase().endsWith("pump")?`https://pump.fun/coin/${r}`:""),f=c.websiteUrl||c.website||c.links?.website||"",y=c.twitterUrl||c.xUrl||c.links?.twitter||c.links?.x||"",g=c.telegramUrl||c.links?.telegram||"",S=o(c.liquidityUsd||c.liquidity?.usd),P=o(c.marketCap||c.fdv||c.marketCapUsd),T=o(c.volume24h||c.volume?.h24||c.volume?.m5),b=[`${l} breakdown`,`${u} | ${w(r)}`,`MC/FDV: ${P} | Liquidity: ${S} | Volume: ${T}`,`Socials: X ${y?"found":"not returned"} | Telegram ${g?"found":"not returned"} | Website ${f?"found":"not returned"}`,"Read: look for live buys vs sells, liquidity depth, holder/risk badges, socials, and whether the chart is building higher lows.","Risk note: fresh Solana launches can still rug even with good socials. Size smaller until liquidity, volume, and holder distribution prove out."],A=[{label:"Open Chart",type:"open_chart",tokenMint:r},{label:"Dex",type:"open_external",url:d}];p&&A.push({label:"Pump",type:"open_external",url:p}),f&&A.push({label:"Website",type:"open_external",url:f}),y&&A.push({label:"X",type:"open_external",url:y}),g&&A.push({label:"Telegram",type:"open_external",url:g}),ue({role:"assistant",text:b.join(`
`),actions:A}),n.ogreAgentStatus="Coin breakdown ready."}catch(s){ue({role:"assistant",text:`I could not pull live metadata for ${w(r)} yet, but I can still open chart, Dex, Pump, or help inspect risk badges.`,actions:[{label:"Open Chart",type:"open_chart",tokenMint:r},{label:"Dex",type:"open_external",url:`https://dexscreener.com/solana/${r}`},{label:"Pump",type:"open_external",url:`https://pump.fun/coin/${r}`}]}),n.ogreAgentStatus=s?.message||"Coin check delayed."}finally{n.ogreAgentLoading=!1,F()}return}n.ogreAgentStatus="Action noted. Ask Ogre to open a panel, chart, refresh, trade, or check a coin.",F()}function xS(e=""){return/\b(check|analy[sz]e|rug|honeypot|community|social|website|telegram|twitter|x\b|links?|good choice|good pick|good buy|bullish|bearish|safe|risky|risk|will it do well|looks good|breakdown|details?)\b/i.test(String(e||""))}function Tl(e=""){return(String(e||"").match(/\b[A-HJ-NP-Za-km-z1-9]{32,48}\b/)||[])[0]||""}function rm(e=""){return/\b(x|twitter|tweet|tweets|post|posts|posting|mentions?|popular|viral|trending|trend|kols?|influencers?|callers?|community|socials?)\b/i.test(String(e||""))}function MS(e="",t=[]){const a=[String(e||"").trim(),...Array.isArray(t)?t:[t]].map(o=>String(o||"").trim()).filter((o,s,c)=>o&&c.findIndex(l=>l.toLowerCase()===o.toLowerCase())===s).slice(0,4),r=a.length?a.map(o=>`"${o.replace(/"/g,"")}"`).join(" OR "):`"${String(e||"").trim()}"`;return`https://x.com/search?q=${encodeURIComponent(r)}&src=typed_query&f=live`}function BS(e=""){if(!rm(e))return null;const t=ts(Tl(e)||Kt()||n.smartChartToken||n.tradeToken||"");return t?{text:[`${w(t)} X/KOL check`,"I kept this token active in the conversation. Server social scan is still warming, so I can use SlimeWire-visible rows and open live X search without inventing callers.","If no verified posts or KOL rows return, treat the social side as unconfirmed and check chart, liquidity, buys/sells, and risk badges before sizing."].join(`
`),actions:[{label:"Open X Search",type:"open_external",url:MS(t)},{label:"Open Chart",type:"open_chart",tokenMint:t},{label:"KOL Tracker",type:"open_tab",tab:"kol"},{label:"Refresh Feeds",type:"refresh_feeds"}]}:null}function RS(e=""){const t=String(e||"").toLowerCase();return/\b(top|best|hot|trending|trend|viral|runner|moving|today|now|low mc|low mcap|fresh|climbing|x2|2x)\b/.test(t)&&/\b(meme|memecoin|coin|token|pair|launch|x|twitter|volume|market cap|mc)\b/.test(t)}function IS(e=""){if(!RS(e))return null;const t=Hp().slice(0,4),a=s=>{const c=Number(s);return!Number.isFinite(c)||c<=0?"n/a":c>=1e6?`$${(c/1e6).toFixed(2)}M`:c>=1e3?`$${(c/1e3).toFixed(1)}K`:`$${c.toFixed(c>=1?2:6)}`};if(!t.length)return{text:["Fast scan is ready, but I do not have fresh rows loaded in this screen yet.","Tap Refresh Feeds, then ask again. If a broad X result is not returned, I will rank SlimeWire-visible live candidates and exact live-search links instead of faking callers."].join(`
...
`),actions:[o?.tokenMint?{label:"Open Top Chart",type:"open_chart",tokenMint:o.tokenMint}:null,{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}].filter(Boolean)}}const OS=[["terminal",["terminal","command center","cooks","main feed","live feed","home"]],["live",["live pairs","fresh pairs","new pairs","pairs"]],["slimeScope",["slime scope","scope","scanner","cook spot"]],["smartChart",["smart chart","chart page","charting"]],["trade",["trade desk","trade page","swap page","slime swap","manual trade"]],["bundle",["bundle","bundle buy","multi wallet buy"]],["volume",["volume","slimebot","slime bot","volume bot"]],["sniper",["sniper","ogre sniper","snipe picks","picks"]],["launchCoin",["pump launch","launch a coin","launch coin","create coin","create a token","make a coin","launcher"]],["launch",["launch watch","launch watches","watch launches","snipe launches"]],["kol",["kol","kols","kol tracker","copy trading","copy wallet"]],["ogreAi",["ogre ai","ogre a.i","autopilot","auto pilot","ai buyer"]],["wallets",["wallets","wallet page","balances","my wallets","fund","sweep"]],["positions",["positions","open positions","bags","holdings","my coins"]],["pnl",["pnl","profit","results","p&l","pnl card","share card"]],["txAudit",["tx audit","stop loss audit","audit","armed plans","my plans","tp sl status"]],["profile",["profile","account","referral","referrals","badges","pfp","alerts","push alerts","notifications"]],["tek",["ogre tek","tek hub","tools","tool hub","automation deck","shield receipts","receipts"]],["ogreTek",["perps","perp","perp mode","leverage"]],["watchlist",["watchlist","watch list","saved coins","saved tokens"]],["liveTrades",["live trades","recent trades","trade history"]]],ES=/\b(open|go to|goto|show me|show|take me|bring up|pull up|switch to|navigate|where is|where's|wheres|where are|where do i|how do i (?:get to|open|find)|find)\b/i;function FS(e){const t=String(e||"").toLowerCase().replace(/[?!.]+$/g,"").trim();if(!t||t.length>120||Tl(e)||Tt(e))return null;const a=/(?:set\s+)?quick\s*buy(?:\s+amount)?\s*(?:to|at|=)?\s*([0-9]*\.?[0-9]+)\s*(?:sol)?$/i.exec(t);if(a){const o=dr(a[1]);if(o)return n.quickBuyAmountOverride=o,Xr({quickBuy:o}),qo(),{text:`Quick buy set to ${o} SOL - every Buy button across the site now fires with that amount.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}if(/\b(i (?:like|prefer|want|am)|keep (?:it|them)|show me|give me)\b/.test(t)){if(/\b(risky|degen|moonshots?|early|low\s*mc|gambl)/.test(t))return Xr({risk:"degen"}),{text:"Noted - early risky plays it is. The fresh low-MC line in the brief is yours, and I'll keep that preference next visit too.",actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Sniper",type:"open_tab",tab:"sniper"}]};if(/\b(safe|careful|low risk|clean|less risky)\b/.test(t))return Xr({risk:"careful"}),{text:"Noted - shield-clean setups first. I'll remember that next visit. SlimeShield verdicts are on every pair and /t page.",actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}if(/\brefresh\b.*\b(feed|pairs|scan)/.test(t)||t==="refresh feeds")return{text:"Refreshing the live feeds now.",run:{type:"refresh_feeds"},actions:[]};if(/\brefresh\b/.test(t)||/\bsync\b.*\b(wallet|balance|position)/.test(t))return{text:"Refreshing wallets, balances, and positions now.",run:{type:"refresh_wallet"},actions:[]};if(/\b(connect|link|hook up)\b.*\bwallet\b/.test(t))return{text:"Opening the wallet connect chooser.",run:{type:"open_wallet_connect"},actions:[]};if(/what can you do|what do you do|help me|how do you work|what are you/.test(t))return{text:`I can take you anywhere on the site (just say "open positions" or "where is the sniper"), check any coin (paste a CA), run buys and sells ("buy 0.1 of <CA>"), set your quick-buy amount, refresh wallets and feeds, and read risk with SlimeShield. Ask in your own words - I'll keep up.`,actions:[{label:"Live Terminal",type:"open_tab",tab:"terminal"},{label:"Positions",type:"open_tab",tab:"positions"},{label:"Ogre Tek",type:"open_tab",tab:"tek"}]};const r=ES.test(t);for(const[o,s]of OS)for(const c of s){if(!(t===c||t===`the ${c}`||t===`my ${c}`)&&!(r&&t.includes(c)))continue;return{text:`Opening ${WS(o)} now.${o==="profile"&&/alert|push|notification/.test(t)?" Push alerts live under Profile > Alerts.":""}`,run:{type:"open_tab",tab:o},actions:[{label:"Back to Terminal",type:"open_tab",tab:"terminal"}]}}return null}function WS(e){return{terminal:"the Live Terminal",live:"Live Pairs",slimeScope:"Slime Scope",smartChart:"Smart Chart",trade:"the Trade Desk",bundle:"Bundle",volume:"SlimeBot Volume",sniper:"OgreSniper",launchCoin:"Pump Launch",launch:"Launch Watch",kol:"the KOL Tracker",ogreAi:"Ogre A.I.",wallets:"Wallets",positions:"Positions",pnl:"PnL",txAudit:"the TP/SL Audit",profile:"your Profile",tek:"the Ogre Tek hub",ogreTek:"Perp Mode",watchlist:"your Watchlist",liveTrades:"Live Trades"}[e]||e}const DS={submitted:"Order submitted",approved:"Wallet approved",sent:"Transaction sent",confirmed:"Confirmed on-chain",armed:"TP/SL armed"};function om(e){n.tradeTrace={title:String(e||"Trade"),steps:[],startedAt:Date.now(),done:!1},is()}function Be(e,t="ok",a=""){if(!n.tradeTrace||n.tradeTrace.done&&t==="pending")return;const r=n.tradeTrace.steps,o=r.find(l=>l.key===e),s=o||{key:e,label:DS[e]||e};if(s.status=t,s.detail=String(a||"").slice(0,140),o||r.push(s),t==="fail"&&(n.tradeTrace.done=!0),is(),t==="fail")return;r.length>=3&&r.every(l=>l.status==="ok")&&(n.tradeTrace.done=!0,window.setTimeout(()=>{n.tradeTrace?.done&&!n.tradeTrace.steps.some(l=>l.status==="fail")&&(n.tradeTrace=null,is())},8e3))}function is(){let e=document.querySelector("[data-trade-trace-mount]");e||(e=document.createElement("div"),e.dataset.tradeTraceMount="true",document.body.appendChild(e));const t=n.tradeTrace;if(!t){e.innerHTML="",e.__lastDrawerHtml="";return}const a=r=>r==="ok"?"✅":r==="fail"?"❌":"⏳";e.innerHTML=`
      ...
      <div class="nav-side-items">
        ${a.items.map(([r,o])=>`
          <button type="button" data-tab="${i(r)}" title="${i(o)}">
            <span class="nav-side-icon" aria-hidden="true">${KS[r]||"•"}</span>
            <span class="nav-side-label">${i(o)}</span>
          </button>`).join("")}
      </div>
    </div>
  `).join(""),e.parentElement.insertBefore(t,e),t.addEventListener("click",a=>{const r=a.target.closest(".nav-side-group-toggle");if(r){const o=r.parentElement,s=o.classList.contains("is-open");t.querySelectorAll(".nav-drop-group.is-open").forEach(c=>c.classList.remove("is-open")),t.querySelectorAll(".nav-side-group-toggle").forEach(c=>c.setAttribute("aria-expanded","false")),s||(o.classList.add("is-open"),r.setAttribute("aria-expanded","true"));return}a.target.closest("[data-tab]")&&t.querySelectorAll(".nav-drop-group.is-open").forEach(o=>o.classList.remove("is-open"))}),document.addEventListener("click",a=>{a.target.closest("[data-nav-drop]")||t.querySelectorAll(".nav-drop-group.is-open").forEach(r=>r.classList.remove("is-open"))})}function jS(){const e=document.querySelector("[data-nav-drop]");if(!e)return;let t=!1;e.querySelectorAll(".nav-drop-group").forEach(a=>{const r=!!a.querySelector(`[data-tab="${n.activeTab}"]`);a.querySelector(".nav-side-group-toggle")?.toggleAttribute("data-active",r),a.classList.contains("is-open")&&(t=!0)}),e.querySelectorAll("[data-tab]").forEach(a=>{a.dataset.active=a.dataset.tab===n.activeTab?"true":"false"})}function GS(){const e=document.querySelector('script[src*="app.js?v="]')?.getAttribute("src")||"";if(!e)return;setInterval(async()=>{if(!document.hidden)try{const o=((await fetch("/?build-check=1",{cache:"no-store"}).then(s=>s.text())).match(/app\.js\?v=[\w-]+/)||[])[0]||"";o&&!e.includes(o)&&XS()}catch{}},300*1e3).unref?.()}function XS(){if(document.querySelector("[data-build-update]"))return;const e=document.createElement("button");e.type="button",e.setAttribute("data-build-update",""),e.className="build-update-pill",e.textContent="🐸 SlimeWire updated - tap to refresh",e.addEventListener("click",()=>window.location.reload()),document.body.appendChild(e)}async function JS(){zS(),GS(),ff(),wf(),vf(),Ds(),yf(),n.route==="intro"?gf():An({reset:!0}),Gh(),US(),Ns(),Hi(),await qf(),h(),await zf(),vy(),n.route==="terminal"&&(Ja({silent:!0,ifStale:!0,reason:"site-load"}).catch(e=>$(e.message)),n.activeTab==="ogreTek"&&await br({silent:!0}).catch(e=>$(e.message)),h({preserveSmartChartFrame:n.activeTab==="smartChart"}))}JS();function At(e){n.pumpLiveStatus=e,n.pumpLiveLastActionAt=Date.now(),h()}function YS(){const e=typeof collectLaunchCoinDraft=="function"?collectLaunchCoinDraft():n.launchCoinDraft||{},t=zu(e);return{tokenMint:t,mint:t,address:t,name:e.name||e.tokenName||"Pump launch",symbol:e.symbol||e.ticker||"PUMP",dexId:"pumpfun",source:"pump-live",bonded:!1,isBonded:!1,bondingStatus:"pump"}}function QS(e){const t=e.target.closest("[data-pump-live-action]");if(!t)return;e.preventDefault();const a=t.getAttribute("data-pump-live-action"),r=YS(),o=r.tokenMint;if(!o){At("Paste or launch a CA first, then Pump Live can attach to it.");return}if(a==="chart"){typeof wt=="function"?(wt(r,{defaultTab:"chart",view:"chartTxns",source:"pump-live"}),At("Opened Pump chart with transactions inside Slime.")):At("Chart panel is still loading. Try again in a moment.");return}if(a==="copy"){const s=ju(o);navigator.clipboard?.writeText(s).then(()=>At("Copied Pump Live stream route ID."),()=>At("Stream route ID ready: "+s));return}if(a==="obs"){const s=Bi()?"Use the configured provider ingest URL for OBS or mobile live setup.":"Set PUMP_LIVE_PROVIDER plus ingest/playback envs before real video goes live.";At(s);return}if(a==="end"){At("Pump Live ended for this launch. Chart and transactions stay available.");return}if(a==="go"){if(!Bi()){At("Pump Live UI is ready. Configure provider envs to enable real video without loading Render.");return}At("Pump Live staged. Start the stream from your provider, OBS, or mobile app.")}}document.addEventListener("click",QS);function jt(e){const t=String(e??"");return typeof i=="function"?i(t):t.replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a])}function Pl(e){return e&&typeof e=="object"?e.token||e.pair||e.item||e:n.smartChartToken||{}}function Cl(e){return String(e.tokenMint||e.mint||e.address||e.pairAddress||e.poolAddress||e.baseMint||e.ca||"").trim()}function ZS(e){const t=String(e||"");return t.length>14?`${t.slice(0,6)}...${t.slice(-6)}`:t}function ls(e){if(typeof e=="number")return Number.isFinite(e)?e:NaN;if(e==null||e==="")return NaN;const t=Number(String(e).replace(/[$,%\s,]/g,""));return Number.isFinite(t)?t:NaN}function cm(e){const t=[e.priceUsd,e.priceUSD,e.usdPrice,e.tokenPriceUsd,e.price,e.close,e.c,e.marketCap,e.mc,e.fdv,e.liquidityUsd];for(const a of t){const r=ls(a);if(Number.isFinite(r)&&r>0)return r}return NaN}function ek(e){const t=e.time||e.timestamp||e.blockTime||e.createdAt||e.updatedAt||e.date;if(!t)return Date.now();if(typeof t=="number")return t<1e11?t*1e3:t;const a=Number(t);if(Number.isFinite(a))return a<1e11?a*1e3:a;const r=Date.parse(t);return Number.isFinite(r)?r:Date.now()}function tk(e){return Array.isArray(e)?e:!e||typeof e!="object"?[]:e.items||e.rows||e.data||e.trades||e.transactions||[]}function ak(e,t,a){if(!a.length)return!1;const r=[e.tokenMint,e.mint,e.address,e.pairAddress,e.poolAddress,e.baseMint,e.ca,e.symbol,e.baseSymbol,e.tokenSymbol,e.name,e.tokenName].map(o=>String(o||"").toLowerCase()).join(" ");return a.some(o=>r.includes(o))}function nk(e=""){return String(e||"").split("").reduce((t,a)=>t*31+a.charCodeAt(0)>>>0,17)}function rk(e={}){const t=[e.priceUsd,e.priceUSD,e.usdPrice,e.tokenPriceUsd,e.price,e.marketCap,e.marketCapUsd,e.mc,e.fdv,e.fdvUsd,e.liquidityUsd,e.liquidity?.usd,e.volume5m,e.volumeM15,e.volumeH1,e.volumeH24,e.volume?.m5,e.volume?.h1,e.volume?.h24].map(ls).filter(o=>Number.isFinite(o)&&o>0);if(t.length)return t[0];const a=typeof Ut=="function"?Number(Ut(e)):NaN;if(Number.isFinite(a)&&a>0)return Math.max(1,a*1e3);const r=Number(e.ageMinutes||e.pairAgeMinutes||e.launchAgeMinutes||0);return Math.max(1,r||1)}function Yk(e){const t=Pl(e),a=Cl(t)||t.symbol||t.name||"slime",r=rk(t),o=nk(a),s=Math.max(1,ls(t.liquidityUsd||t.liquidity?.usd)||r),c=Math.max(0,ls(t.volume5m||t.volumeM15||t.volumeH1||t.volume?.m5||t.volume?.h1)||0),l=typeof Ut=="function"?Math.max(0,Math.min(100,Number(Ut(t))||0)):0,u=Math.max(-8,Math.min(18,c/s*18+l/12)),d=Date.now();return Array.from({length:34},(p,f)=>{const y=(f+o%13)/4.2,g=Math.sin(y)*(3.5+o%7*.28),S=(f/33-.5)*u,P=((o>>f%11&7)-3)*.32,T=Math.max(1e-7,r*(1+(g+S+P)/100));return{row:{...t,snapshotFallback:!0},value:T,time:d-(33-f)*15e3,side:"snapshot"}})}function um(e){const t=Pl(e),a=[Cl(t),t.symbol,t.baseSymbol,t.name].map(c=>String(c||"").trim().toLowerCase()).filter((c,l,u)=>c.length>=3&&u.indexOf(c)===l),r=[{direct:!0,rows:t.candles},{direct:!0,rows:t.chartCandles},{direct:!0,rows:t.priceHistory},{direct:!0,rows:t.trades},{direct:!0,rows:t.transactions},{direct:!0,rows:t.recentTrades},{direct:!0,rows:t.sourceEvents},{direct:!1,rows:n.liveTrades},{direct:!1,rows:n.liveTradeRows},{direct:!1,rows:n.tradeTape},{direct:!1,rows:n.recentTrades},{direct:!1,rows:n.pumpTrades},{direct:!1,rows:n.pumpActivity},{direct:!1,rows:n.livePairs},{direct:!1,rows:n.livePairsRows},{direct:!1,rows:n.freshPairs},{direct:!1,rows:n.slimeScopePairs}],o=[];for(const c of r){const l=tk(c.rows).slice(-350);for(const u of l){if(!u||typeof u!="object"||!c.direct&&!ak(u,t,a))continue;const d=cm(u);if(!Number.isFinite(d)||d<=0)continue;const p=String(u.side||u.type||u.action||u.tradeType||"").toLowerCase();o.push({row:u,value:d,time:ek(u),side:p.includes("sell")?"sell":p.includes("buy")?"buy":"trade"})}}const s=cm(t);return Number.isFinite(s)&&s>0&&o.push({row:t,value:s,time:Date.now(),side:"snapshot"}),o.sort((c,l)=>c.time-l.time).filter((c,l,u)=>l===0||c.time!==u[l-1].time||c.value!==u[l-1].value).slice(-120)}function cs(e){return Number.isFinite(e)?e>=1e6?`$${(e/1e6).toFixed(e>=1e7?1:2)}M`:e>=1e3?`$${(e/1e3).toFixed(e>=1e4?1:2)}K`:e>=1?`$${e.toFixed(e>=100?0:3)}`:`$${e.toPrecision(3)}`:"n/a"}function ok(){const e=String(n.pumpChartSource||"slime").toLowerCase();return e==="pump"||e==="dex"?e:"slime"}function sk(e={},t={}){const a=Pl(e),r=Cl(a),o=ok(),s=String(n.pumpChartMode||"line").toLowerCase()==="candles"?"candles":"line",c=String(n.pumpChartTimeframe||"5m"),u=um(a).slice(-70),d=!u.length||u.every(U=>U.side==="snapshot"||U.row?.snapshotFallback),p=u.map(U=>U.value),f=p.length?Math.min(...p):NaN,y=p.length?Math.max(...p):NaN,g=720,S=260,P=22,T=Number.isFinite(y-f)&&y!==f?y-f:1,b=U=>u.length<=1?g/2:P+U/(u.length-1)*(g-P*2),A=U=>S-P-(U-(Number.isFinite(f)?f:0))/T*(S-P*2),C=u.map((U,We)=>`${We?"L":"M"}${b(We).toFixed(1)},${A(U.value).toFixed(1)}`).join(" "),M=u.length>1?`${C} L${b(u.length-1).toFixed(1)},${S-P} L${b(0).toFixed(1)},${S-P} Z`:"",q=Math.max(4,Math.min(12,(g-P*2)/Math.max(u.length*2,1))),J=u.map((U,We)=>{const Pt=(u[Math.max(0,We-1)]||U).value,de=U.value,fs=Math.max(Pt,de),hs=Math.min(Pt,de),wn=b(We),Ml=A(Pt),Bl=A(de),fm=A(fs),hm=A(hs);return`<g class="slime-pump-candle ${de>=Pt?"up":"down"}"><line x1="${wn.toFixed(1)}" y1="${fm.toFixed(1)}" x2="${wn.toFixed(1)}" y2="${hm.toFixed(1)}" /><rect x="${(wn-q/2).toFixed(1)}" y="${Math.min(Ml,Bl).toFixed(1)}" width="${q.toFixed(1)}" height="${Math.max(2,Math.abs(Bl-Ml)).toFixed(1)}" rx="2" /></g>`}).join(""),Se=r?`https://dexscreener.com/solana/${encodeURIComponent(r)}?embed=1&theme=dark&trades=1&info=0`:"",Ze=o==="dex"&&Se?`<iframe class="slime-pump-dex-frame" src="${jt(Se)}" title="Dex chart" loading="lazy"></iframe>`:u.length>1?`<svg class="slime-pump-svg" viewBox="0 0 ${g} ${S}" preserveAspectRatio="none"><defs><linearGradient id="slimePumpArea" x1="0" x2="0" y1="0" y2="1"><stop offset="0%" stop-color="#7cff4f" stop-opacity="0.34"/><stop offset="100%" stop-color="#7cff4f" stop-opacity="0.02"/></linearGradient></defs><path class="slime-pump-area" d="${M}" />${s==="candles"?J:`<path class="slime-pump-line" d="${C}" />`}</svg>`:`<div class="slime-pump-wait"><strong>Waiting for live feed</strong><span>${o==="pump"?"Pump pre-bonding ticks":"Slime live ticks"} will draw here from real feed data only.</span></div>`;return`
    <div class="slime-pump-chart-card" data-slime-pump-chart>
      ...
      <div class="slime-pump-metrics">
        <div><span>Latest</span><strong>${jt(cs(p[p.length-1]))}</strong></div>
        <div><span>Range</span><strong>${jt(Number.isFinite(f)&&Number.isFinite(y)?`${cs(f)} - ${cs(y)}`:"n/a")}</strong></div>
        <div><span>Source</span><strong>${jt(d?"Slime snapshot":o==="slime"?"Slime default":o==="pump"?"Pump on-site":"Dex on-site")}</strong></div>
      </div>
    </div>`}function ik(e={}){const t=um(e).slice(-40).reverse(),a=t.map(r=>{const o=Math.max(0,Math.floor((Date.now()-r.time)/1e3)),s=o<60?`${o}s`:`${Math.floor(o/60)}m`,c=r.row||{},l=c.wallet||c.owner||c.trader||c.signer||c.user||"wallet";return`<div class="slime-pump-tape-row ${r.side}"><span>${jt(s)}</span><strong>${jt(r.side)}</strong><span>${jt(cs(r.value))}</span><span>${jt(ZS(l))}</span></div>`}).join("");return`<section class="pump-native-activity slime-pump-tape"><div class="slime-pump-tape-head"><h4>Live Transactions</h4><span>${t.length} events</span></div><div class="slime-pump-tape-list">${a||'<div class="slime-pump-wait small"><strong>No live transactions yet</strong><span>Rows appear as the feed sees buys and sells.</span></div>'}</div></section>`}function dm(){n.slimePumpChartRendering||(n.slimePumpChartRendering=!0,requestAnimationFrame(()=>{n.slimePumpChartRendering=!1,typeof h=="function"&&h()}))}document.addEventListener("click",e=>{const t=e.target.closest("[data-slime-pump-source]"),a=e.target.closest("[data-slime-pump-mode]"),r=e.target.closest("[data-slime-pump-time]");(t||a||r)&&(e.preventDefault(),e.stopPropagation(),t&&(n.pumpChartSource=t.getAttribute("data-slime-pump-source")||"slime"),a&&(n.pumpChartMode=a.getAttribute("data-slime-pump-mode")||"line"),r&&(n.pumpChartTimeframe=r.getAttribute("data-slime-pump-time")||"5m"),dm())}),window.__slimeStablePumpChartTimer||(window.__slimeStablePumpChartTimer=setInterval(()=>{document.visibilityState==="visible"&&document.querySelector("[data-slime-pump-chart]")&&dm()},8e3)),window.__slimeVolumeBotTimer||(window.__slimeVolumeBotTimer=setInterval(()=>{document.visibilityState!=="visible"||n.activeTab!=="volume"||!(n.volumeBots||[]).some(t=>t.status!=="completed")||oo()},7e3)),document.addEventListener("input",e=>{const t=e.target;if(!(!t||!t.matches)){if(t.matches("[data-vbot-invest]")){const a=document.querySelector("[data-vbot-invest-num]");a&&(a.value=t.value)}else if(t.matches("[data-vbot-invest-num]")){const a=document.querySelector("[data-vbot-invest]");a&&(a.value=t.value)}else if(t.matches("[data-vbot-duration]")){const a=document.querySelector("[data-vbot-duration-label]");if(a){const r=Number(t.value);a.textContent=r>=60?`${(r/60).toFixed(r%60?1:0)}h`:`${r}m`}}}}),(function(){if(typeof window>"u"||window.__slimeTerminalEmptyFeedWatchdogV1)return;window.__slimeTerminalEmptyFeedWatchdogV1=!0;let t=0;const a=new Set(["terminal","live","liveTrades","slimeScope"]),r=[".terminal-token-row",".compact-signal-row",".signal-row",".live-trade-row",".slime-scope-row",".live-pair-row","[data-token-chart]"].join(",");function o(){return!!document.activeElement?.matches?.("[data-ogre-agent-input]")}function s(){return!!(n?.route==="terminal"&&a.has(String(n.activeTab||"terminal"))&&!document.hidden)}function c(){let p=0;const f=y=>{if(y){if(Array.isArray(y)){p+=y.length;return}if(Array.isArray(y.rows)){p+=y.rows.length;return}Array.isArray(y.data?.rows)&&(p+=y.data.rows.length)}};return f(n.livePairRows),f(n.slimeScopeRows),f(n.liveTradeRows),f(n.livePairs),Object.values(n.livePairsByBucket||{}).forEach(f),Object.values(n.terminalFeeds||{}).forEach(f),p}function l(){return!!document.querySelector('[data-app][data-route="terminal"]')?.querySelector?.(r)}function u(){const p=[n.livePairsLastUpdatedAt,n.livePairsLastUpdatedByBucket?.[n.livePairBucket||"live"],n.terminalFeeds?.[n.activeTab||"terminal"]?.updatedAt,n.terminalFeeds?.[n.activeTab||"terminal"]?.lastUpdatedAt].map(f=>Date.parse(String(f||""))).filter(Number.isFinite);return p.length?Date.now()-Math.max(...p)>3e4:!1}function d(p="empty-feed-watchdog"){if(!s()||o())return;const f=Date.now();if(f-t<kn)return;const y=c()===0&&!l();if(!y&&!u())return;t=f;const g=()=>typeof Ja=="function"?Ja({force:y,reason:p}):typeof ee=="function"?ee(n.activeTab||"terminal",{force:y,reason:p}):null;try{typeof G=="function"?G(g):Promise.resolve(g()).catch(()=>{})}catch{}}window.setInterval(()=>d("empty-feed-watchdog-interval"),kn),window.addEventListener("pageshow",()=>window.setTimeout(()=>d("pageshow-empty-feed-watchdog"),kn)),document.addEventListener("visibilitychange",()=>{document.hidden||window.setTimeout(()=>d("visible-empty-feed-watchdog"),kn)})})();const R={running:!1,recorder:null,chunks:[],stream:null,root:null,timers:[],audio:null,mime:"video/webm"};function La(e){return new Promise(t=>{const a=setTimeout(t,e);R.timers.push(a)})}function lk(){return window.matchMedia("(max-width: 760px)").matches||/Android|iPhone|iPad/i.test(navigator.userAgent)}function ck(){const e=window.AudioContext||window.webkitAudioContext;if(!e)return null;try{const t=new e;t.resume?.();const a=t.createGain();a.gain.value=.6,a.connect(t.destination);let r=null;try{r=t.createMediaStreamDestination(),a.connect(r)}catch{}return R.audio={ctx:t,master:a,dest:r},R.audio}catch{return null}}function us(e,t,a,r,o){const s=e.gain;s.setValueAtTime(1e-4,t),s.exponentialRampToValueAtTime(Math.max(.001,a),t+r),s.exponentialRampToValueAtTime(1e-4,t+r+o)}function pm(e,t=1){const a=R.audio;if(!a)return;const r=a.ctx.createOscillator(),o=a.ctx.createGain();r.type="sine",r.frequency.setValueAtTime(150,e),r.frequency.exponentialRampToValueAtTime(42,e+.22),us(o,e,.8*t,.006,.3),r.connect(o).connect(a.master),r.start(e),r.stop(e+.45)}function mm(e){const t=e.createBuffer(1,e.sampleRate*2,e.sampleRate),a=t.getChannelData(0);for(let r=0;r<a.length;r+=1)a[r]=Math.random()*2-1;return t}function uk(e,t=1.3){const a=R.audio;if(!a)return;const r=a.ctx.createBufferSource();r.buffer=R.noiseBuf||(R.noiseBuf=mm(a.ctx)),r.loop=!0;const o=a.ctx.createBiquadFilter();o.type="bandpass",o.Q.value=1.1,o.frequency.setValueAtTime(250,e),o.frequency.exponentialRampToValueAtTime(5200,e+t);const s=a.ctx.createGain();s.gain.setValueAtTime(1e-4,e),s.gain.exponentialRampToValueAtTime(.3,e+t),s.gain.exponentialRampToValueAtTime(1e-4,e+t+.08),r.connect(o).connect(s).connect(a.master),r.start(e),r.stop(e+t+.2)}function Ll(e,t=!1){const a=R.audio;if(!a)return;pm(e,t?1.4:1.1);const r=a.ctx.createBufferSource();r.buffer=R.noiseBuf||(R.noiseBuf=mm(a.ctx));const o=a.ctx.createBiquadFilter();o.type="lowpass",o.frequency.value=t?1400:900;const s=a.ctx.createGain();us(s,e,t?.5:.32,.004,t?.9:.5),r.connect(o).connect(s).connect(a.master),r.start(e),r.stop(e+1.4);const c=a.ctx.createOscillator(),l=a.ctx.createGain();c.type="sine",c.frequency.setValueAtTime(64,e),c.frequency.exponentialRampToValueAtTime(28,e+(t?1.4:.8)),us(l,e,t?.7:.4,.01,t?1.5:.85),c.connect(l).connect(a.master),c.start(e),c.stop(e+2)}function dk(e,t=720){const a=R.audio;if(!a)return;const r=a.ctx.createOscillator(),o=a.ctx.createGain();r.type="square",r.frequency.value=t,us(o,e,.12,.004,.12),r.connect(o).connect(a.master),r.start(e),r.stop(e+.2)}function pk(e,t){const a=R.audio;if(!a)return;const r=a.ctx.currentTime+.05;for(let o=0;o<t-.4;o+=.5)pm(r+o,.55+.35*(o/t));for(const o of e)uk(r+Math.max(0,o-1.25),1.25),Ll(r+o,!1);Ll(r+t-.35,!0),Ll(r+t+.45,!0)}function mk(){if(document.getElementById("trailer-style"))return;const e=document.createElement("style");e.id="trailer-style",e.textContent=`
  ...
  `,document.head.appendChild(e)}function ds(){if(R.root)return R.root;mk();const e=document.createElement("div");return e.setAttribute("data-trailer-overlay",""),e.style.cssText="position:fixed;inset:0;z-index:99999;pointer-events:none;font-family:Inter,system-ui,sans-serif;",e.innerHTML=`
  ...
  `,o.querySelector("[data-trailer-close]").addEventListener("click",()=>{o.remove(),setTimeout(()=>URL.revokeObjectURL(r),5e3)}),o.querySelector("[data-trailer-share]").addEventListener("click",async()=>{try{const s=new File([e],a,{type:R.mime.split(";")[0]});if(navigator.canShare?.({files:[s]})){await navigator.share({files:[s],title:"SlimeWire",text:"SlimeWire - verify before you ape. slimewire.org"});return}}catch{}o.querySelector("a[download]")?.click()}),document.body.appendChild(o)}function bk(){const e=R.recorder;if(!e)return;const t=()=>{try{const a=new Blob(R.chunks,{type:R.mime.split(";")[0]});a.size>0&&gk(a)}catch{}};if(e.state!=="inactive"){e.addEventListener("stop",t,{once:!0});try{e.stop()}catch{t()}}else t();R.stream?.getTracks().forEach(a=>{try{a.stop()}catch{}}),R.recorder=null,R.stream=null}function xl(e="done"){if(R.running){R.running=!1,R.timers.forEach(t=>clearTimeout(t)),R.timers=[],bk();try{R.audio?.ctx?.close()}catch{}R.audio=null,R.root?.remove(),R.root=null}}function yk(){const e=n.livePairsByBucket?.live?.rows||n.livePairs?.rows||n.livePairRows||[];return[...e].filter(a=>a?.tokenMint).sort((a,r)=>(Number(r.volume5m)||0)-(Number(a.volume5m)||0)||(Number(r.bestPickScore||r.score)||0)-(Number(a.bestPickScore||a.score)||0))[0]||e[0]||null}async function vk(e=9e3){const t=Date.now();for(;Date.now()-t<e;){const a=yk();if(a)return a;if(!R.running)return null;await La(500)}try{return((await k("/api/web/live-pairs?bucket=live&sort=fresh"))?.livePairs?.rows||[]).find(o=>o?.tokenMint)||null}catch{return null}}async function wk(e,t=4e3){const a=Date.now();for(;Date.now()-a<t;){if(document.querySelector(e))return!0;if(!R.running)return!1;await La(250)}return!1}function Sk(){return new Promise(e=>{vr(`
    ...
    `),R.root.querySelector("[data-trailer-go]")?.addEventListener("click",()=>e(!0),{once:!0})})}async function kk(){if(R.running)return;R.running=!0,ds(),ck();const e=await hk(),t=lk();if(!e&&(await Sk(),!R.running))return;$e("/terminal/live-pairs"),vr('<div style="color:#72ff23;font-weight:900;font-size:clamp(18px,5vw,24px);animation:twPulse 1.2s infinite;">locking onto live pairs...</div>');const a=await vk(9e3);if(!R.running)return;const r=3,o=6.5,s=9,c=6.5,l=4.6,u=[r,r+o,r+o+s,r+o+s+c],d=r+o+s+c+l;pk(u,d);const f=(R.audio?.ctx?.currentTime||0)+.05;for(let g=0;g<r;g+=1)dk(f+g,600+g*90);for(let g=r;g>=1;g-=1){if(!R.running)return;vr(`<div style="color:#72ff23;font-size:clamp(64px,22vw,110px);font-weight:900;text-shadow:0 0 30px rgba(114,255,35,0.75);animation:twPulse 1s infinite;">${g}</div>`),await La(1e3)}if(vr(""),!R.running)return;ps(),ms("FRESH PAIRS. SECONDS OLD.","every pump.fun launch lands here instantly"),await La(o*1e3);const y=a?.symbol?`$${String(a.symbol).slice(0,12)}`:"live pair";if(R.running&&a?.tokenMint){ps(),$e(`/terminal/chart?token=${encodeURIComponent(a.tokenMint)}`);const g=await wk("iframe[src*='dexscreener'], .smart-chart-terminal iframe, [data-chart] canvas",4500);if(!R.running||(ms("CHARTS WITH A BRAIN",`${y} - live candles, live flow, shield verdict on top`),await La((g?s:4)*1e3),!R.running))return;ps(),hp(a.tokenMint),ms("TRIPLE-ENGINE RUG CHECK","SlimeShield x Rugcheck x GoPlus - dodge the rug BEFORE you ape"),await La(c*1e3),rl()}R.running&&(ms(""),ps(),vr(`
  ...
  `),await La(l*1e3),xl("done"))}document.addEventListener("click",e=>{e.target instanceof Element&&e.target.closest("[data-trailer-mode]")&&(e.preventDefault(),R.running||kk())});
