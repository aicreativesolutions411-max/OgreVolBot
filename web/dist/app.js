...
`);return o?Promise.resolve(window.prompt(c||e,o.value||"")):Promise.resolve(window.confirm(c||e))}return new Promise(c=>{const l=document.createElement("div");l.className="slime-confirm-overlay",l.innerHTML=`
  ...
  `}function Gh(){Jh();const e=n.shieldReceipts;if(!e)return`
          ...
          ${t.map(r=>`
            <article class="row-card">
              <div class="row-main">
                ...
                <span>Flagged ${i(r.verdict)} (score ${i(String(r.score))}) ${r.confirmedAfterMinutes?`- confirmed dead within ${i(Xh(r.confirmedAfterMinutes))}`:""}</span>
  ...
  `}function Xh(e){const t=Number(e)||0;return t<90?`${t} min`:t<2880?`${Math.round(t/60)}h`:`${Math.round(t/1440)}d`}let wu=0;function Jh(){Date.now()-wu<300*1e3||(wu=Date.now(),k("/api/web/shield/receipts").then(e=>{n.shieldReceipts=e,n.activeTab==="tek"&&h()}).catch(()=>{}),k("/api/web/proof").then(e=>{n.proofStats=e?.alpha||null}).catch(()=>{}))}function Yh(){return`
    ${lg()}
    ${Jr()}
  ...
  `}function Qh(){if(!vi())return`
    ...
    `;const t=[{key:"account",label:"Account",hint:"Profile & name",html:og()},{key:"login",label:"Login",hint:"Security",html:ig()},{key:"pfp",label:"PFP",hint:"Avatar",html:cg()},{key:"x",label:"X",hint:"Connect X",html:gg()},{key:"alerts",label:"Alerts",hint:"Push to phone",html:Zh()},{key:"badges",label:"Badges",hint:"Earned",html:$u()},{key:"referral",label:"Referral",hint:"Invite & earn",html:bg()},{key:"board",label:"Board",hint:"Top traders",html:vg()}];return`
  ...
  `}function og(){const e=n.user?.connectedWallet;return`
  ...
  `}function ig(){const e=n.user?.username||"";return`
  ...
  `}function cg(){const e=!!n.user?.avatar,t=n.xHandle?`@${n.xHandle}`:"";return`
  ...
  `}function da({returnPath:e="/terminal"}={}){n.walletConnectMenuOpen=!0,n.walletConnectReturnPath=e||"/terminal",n.walletConnectStatus=n.user?.connectedWallet?`Connected ${w(n.user.connectedWallet.publicKey)}. Pick a provider to reconnect or switch.`:"Pick a wallet. Your extension will ask you to approve.",h({force:!0})}function dg(e={}){return da(e)}window.openWalletConnectModal=dg;function pg(e){n.walletFastApprovalsEnabled=!!e;try{localStorage.setItem("walletFastApprovalsEnabled",n.walletFastApprovalsEnabled?"on":"off")}catch{}}function mg(){const e=m("[data-wallet-connect-modal]");if(!e)return;if(!n.walletConnectMenuOpen){e.hidden=!0,e.innerHTML="",e.__lastDrawerHtml="";return}const t=n.user?.connectedWallet||n.connectedWalletBalance;e.hidden=!1,fr(e,`
  ...
  `,".wallet-connect-dialog")}function fg(){const e=n.quickBuyModal||{},t=Is()?.tokenMint===e.tokenMint?Is():be(e.tokenMint,{source:e.source||"quick-buy-modal"}),a=/validating|submitting|opening wallet/i.test(String(e.status||"")),r=Si(e.error||e.status||""),s=a||!!r,o=ue(e.walletIndex||"");return`
  ...
  `}function bg(){const e=n.user?.referralCode||"",t=`${Lt.replace(/\/+$/,"")}/r/`,a=n.user?.referralLink||(e?`${Lt.replace(/\/+$/,"")}/r/${encodeURIComponent(e)}`:""),r=n.user?.referralStats||{},s=Array.isArray(r.referrals)?r.referrals:[];return`
  ...
  `}function yg(e=""){const t=String(e||"").trim();if(!t)return"";try{const r=new URL(t,Lt).pathname.split("/").map(o=>o.trim()).filter(Boolean),s=r.findIndex(o=>o.toLowerCase()==="r");if(s>=0&&r[s+1])return decodeURIComponent(r[s+1]);if(r.length)return decodeURIComponent(r[r.length-1])}catch{}return t.replace(/^https?:\/\/[^/]+\/?/i,"").replace(/^r\//i,"").replace(/^\/+|\/+$/g,"")}function vg(){const e=n.user?.traderBoardWalletMode||"all",t=Array.isArray(n.user?.traderBoardWalletIndexes)?n.user.traderBoardWalletIndexes:n.wallets.map(a=>String(a.index));return`
  ...
  `:""}function Ge(e,t="Share X"){return`<button type="button" data-share-x data-share-text="${i(e)}">${i(t)}</button>`}function Cu(e,t="TG"){const a=ki(e),r=`https://t.me/share/url?url=${encodeURIComponent(Lt)}&text=${encodeURIComponent(a)}`;return`<a href="${i(r)}" target="_blank" rel="noreferrer">${i(t)}</a>`}function ki(e){const t=String(e||"").replace(/\s+/g," ").trim();return`${t.length>210?`${t.slice(0,207).trim()}...`:t} ${Lt}`}function wg(e){const t=e.type==="buy",a=t?`${e.spentSol} SOL`:`${e.netSol} SOL`;return`${t?"Bought":"Sold"} ${e.shortMint||w(e.tokenMint)} for ${a}. Chart ${Q(e.tokenMint)}`}function zk(e){return`${e.type==="bundle_sell"?"Bundle sold":e.source==="web_bundle_plan"?"Armed bundle auto-exit":"Bundle bought"} ${e.shortMint||w(e.tokenMint)} across ${e.successCount||0}/${e.walletCount||0} wallet(s).`}function Sg(e,t="Armed timed trade"){return`${t} on ${e.shortMint||w(e.tokenMint)} with ${e.successCount||0}/${e.walletCount||0} wallet(s), TP ${e.takeProfitSummary||`+${e.takeProfitPct}%`}, SL ${e.stopLossSummary||`-${e.stopLossPct}%`}.`}function Lu(e){return`PnL on ${e.shortMint||w(e.tokenMint)}: ${e.realizedSol} realized, ${e.buys} buy(s), ${e.sells} sell(s).`}function kg(e){return`Watching ${e.shortMint||w(e.tokenMint)}: ${e.uiAmount} tokens across ${e.walletCount} wallet(s), PnL ${e.openPnlSol||e.realizedSol||"tracking"}.`}function $g(e){return`Watching ${e.symbol||w(e.tokenMint)}: score ${e.score}/100, MC ${e.marketCapLabel}, liq ${e.liquidityLabel}. Chart ${Q(e.tokenMint)}`}function Tg(e){return`KOL signal ${e.symbol||w(e.tokenMint)}: score ${e.score||0}/100, value ${e.valueLabel||"$0"}, signal ${e.winRateLabel||"n/a"}. Chart ${Q(e.tokenMint)}`}function Ag(e){return`Watching KOL ${e.twitter?`@${e.twitter}`:e.name||e.shortWallet||w(e.wallet)}: realized ${e.realizedLabel||"n/a"}, ROI ${e.roiLabel||"n/a"}, trades ${e.trades??"n/a"}.`}function Pg(e){return`Watching $${e.ticker} with Launch Snipe: ${e.walletCount} wallet(s), ${e.amountSol} SOL each, TP ${e.takeProfitSummary||`+${e.takeProfitPct}%`}, SL ${e.stopLossSummary||`-${e.stopLossPct}%`}.`}function $i(e){const t=String(e||"").trim(),a=t.startsWith("$")?t:t.length>30?w(t):`$${t.replace(/^\$+/,"")}`,r=t.length>30?` Chart ${Q(t)}`:"";return`Watching ${a}.${r}`}function xu(e){const t=String(e||"").trim();return`Watching KOL ${t.startsWith("@")?t:t.length>30?w(t):`@${t.replace(/^@+/,"")}`}.`}const Cg=[{tier:"hot",pinned:!0,rank:1,name:"Idontpaytaxes",twitter:"Idontpaytaxes",wallet:"",kolscanUrl:"https://kolscan.io/account/2T5NgDDidkvhJQg8AHDI74uCFwgp25pYFMRZXBaCUNBH",tag:"External KOLscan profile",note:"External public/KOLscan stats only. These are not SlimeWire trades and do not create SlimeWire fees unless copied through your SlimeWire wallets. Add a verified Solana wallet before scan/copy.",winRateLabel:"36.8%",realizedLabel:"-$28.1",roiLabel:"Watch",trades:"24 ext",volumeLabel:"$6.58K volume",lastTradeAt:new Date(Date.now()-1020*60*1e3).toISOString()},{tier:"slimewire",pinned:!0,rank:1,name:"MoonPieJoe",twitter:"moonpiejoe",tag:"SlimeWire KOL",note:"Supporter profile. Add wallet later to enable scan/copy trade.",winRateLabel:"Supporter",realizedLabel:"n/a",roiLabel:"Social",trades:"Add wallet"},{tier:"slimewire",pinned:!0,rank:2,name:"Rezzy",twitter:"zero_taxes",tag:"SlimeWire KOL",note:"Supporter profile. Add wallet later to enable scan/copy trade.",winRateLabel:"Supporter",realizedLabel:"n/a",roiLabel:"Social",trades:"Add wallet"}];function Ti(e=""){const t=String(e||"").trim().toLowerCase();return Cg.filter(a=>!t||String(a.tier||"").toLowerCase()===t).sort((a,r)=>+!!r.pinned-+!!a.pinned||Number(a.rank||999)-Number(r.rank||999))}function _t(e=""){return/^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(String(e||"").trim())}function Mu(e=""){const t=String(e||"").trim();return _t(t)?t:""}function Lg(e={}){const t=String(e.wallet||"").trim(),a=Mu(t),r=Je(e.twitter||e.x||e.username||"");return{x:r?Ci(r):"",wallet:a?`https://solscan.io/account/${encodeURIComponent(a)}`:"",kolscan:e.kolscanUrl||e.externalProfileUrl||(a?Lc(a):"")}}function xg(e={}){const t=String(e.wallet||"").trim(),a=Mu(t),r=Lg(e);return`
  ...
  `}function Mg(){const e=Ti("hot"),t=Ti("slimewire");return`
  ...
  `}function Bi(){return(Array.isArray(n.wallets)?n.wallets:[]).filter(e=>!e?.volumeBot)}function Vu(){return(Array.isArray(n.wallets)?n.wallets:[]).filter(e=>!!e?.volumeBot)}function an(e=""){const t=Wg(e),a=Bi().map(r=>{const s=n.balances.find(l=>Number(l.index)===Number(r.index)),o=s?.sol!==null&&s?.sol!==void 0?`${Number(s.sol).toFixed(4)} SOL`:"balance loading",c=r.sessionWallet?" Session":"";return`<option value="${r.index}" ${String(r.index)===String(e||"")?"selected":""}>${r.index}. ${i(r.label)}${c} - ${o}</option>`}).join("");return t||a?`${t}${a}`:'<option value="">No wallet connected</option>'}function sb(){if(!n.tradeResult)return`
      <article>
        <h3>Latest Result</h3>
  ...
  `}function ob(){if(!n.tradePlanResult)return`
      <article>
        <h3>Managed Exit</h3>
  ...
  `}function Gu(e){const t=Yn.find(([a])=>a===e);return t?t[1]:"Super-fresh"}function ub(){if(!n.wallets.length)return`${Jr()}${F("No managed wallets loaded","Ogre A.I. needs managed/imported SlimeWire wallets so the server can submit TP/SL and timer exits after it buys.")}`;const e=Xl(),t=e.amountSol||"0.1",a=e.runCount||"1",r=(o,c,l)=>{const u=String(o||l||"");return u==="custom"?String(c||"custom"):u},s=as();return`
  ...
  `}function Xu(e,t){return`
    ...
    </section>`}function db(){return n.wallets.length?`
    <section class="trade-layout">
      <article class="trade-card">
        <div class="trade-head">
          <div>
  ...
  `:Xu("Bundle","Bundle fires many managed wallets in one shot, so it needs at least one SlimeWire wallet. Tap to create one — your backup downloads instantly.")}function pb(){if(!n.bundleResult)return`
      <article>
        <h3>Latest Bundle</h3>
  ...
  `}function mb(e=""){return n.wallets.length?n.wallets.map((t,a)=>{const r=String(t.index??a+1),s=`${r}. ${t.label||"Wallet"} ${t.shortPublicKey||w(t.publicKey||"")}`;return`<option value="${i(r)}" ${String(e)===r?"selected":""}>${i(s)}</option>`}).join(""):'<option value="">No managed wallets loaded</option>'}function x(e,t,a=""){const r=m(e)?.value||a;if(r!=="custom")return r;const s=m(t)?.value?.trim();if(!s)throw new Error("Enter the custom value first.");return s}function it(e,t=""){const a=n.presets?.[e]||[],r=!t||t==="none"||t==="manual",s=e==="bundle"?"Create / edit bundle preset":"Create / edit trade preset";return a.length?`
  ...
  `}function Xe(e,t,a="off"){return Dt({selectAttr:`${t}`,customAttr:`${t}-custom`,customFor:e,options:fb,selected:a,customPlaceholder:"Custom: 45s, 20, 2h"})}function ns(e,t,a="0"){return Dt({selectAttr:`${t}`,customAttr:`${t}-custom`,customFor:e,options:hb,selected:a,customPlaceholder:"Custom: 30s, 20, 2h"})}function Ri(e="scanner"){return`
  ...
  `}function Qu(e){const t=e==="trade"?n.editingTradePresetId:n.editingBundlePresetId;return t?oe(e,t):null}function rs(e,t){e==="trade"&&(n.editingTradePresetId=t||""),e==="bundle"&&(n.editingBundlePresetId=t||"")}function gb(){const e=Qu("trade"),t=!!e?.readonly,a=e?t?"Save Edited Copy":"Update Trade Preset":"Save Trade Preset";return`
  ...
  `}function bb(){const e=Qu("bundle"),t=!!e?.readonly,a=e?t?"Save Edited Copy":"Update Bundle Preset":"Save Bundle Preset";return`
  ...
  `}function yb(e){return Number(e?.sellDelaySeconds||0)>0?`${e?.sellPercent||100}%`:"Off"}function ss(e){return`
  ...
  `:""}function is(e){n.distributeStatus=String(e||"");const t=m("[data-distribute-status]");t&&(t.textContent=n.distributeStatus)}function Sb(){const e=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!e?.publicKey)return"";const t=n.wallets.filter(r=>r.sessionWallet),a=t.length?t:n.wallets;return a.length?`
  ...
  `:""}function Qn(e){n.returnFundsStatus=String(e||"");const t=m("[data-return-funds-status]");t&&(t.textContent=n.returnFundsStatus)}async function td(e="leaving"){try{const t=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!t?.publicKey)return;const a=n.wallets.filter(o=>o.sessionWallet);if(!a.length)return;const r=a.map(o=>String(o.index));if(!await xe({title:"Return Session Funds",lines:[`Before ${e}, return tokens + SOL from your ${r.length} session wallet(s)`,`back to your connected wallet ${w(t.publicKey)}?`],confirmLabel:"Return Funds",cancelLabel:"Skip"}))return;await k("/api/web/wallets/return-to-connected",{method:"POST",body:JSON.stringify({destination:t.publicKey,walletIndexes:r}),dedupe:!1,timeoutMs:te})}catch(t){try{window.alert(`Could not return funds automatically: ${t.message}. Use the Return Funds button to retry.`)}catch{}}}async function kb(){if(n.returnFundsBusy)return;const e=n.connectedWalletBalance||n.user?.connectedWallet||null;if(!e?.publicKey){Qn("Connect a wallet first.");return}const t=n.wallets.filter(o=>o.sessionWallet),r=(t.length?t:n.wallets).map(o=>String(o.index));if(!r.length){Qn("No managed wallets to return from.");return}if(await xe({title:"Return Funds",lines:[`Sell all tokens to SOL and send everything from ${r.length} wallet(s)`,`back to your connected wallet ${w(e.publicKey)}?`],confirmLabel:"Sell & Return",danger:!0})){n.returnFundsBusy=!0,Qn("Selling tokens and returning SOL..."),h();try{const o=await k("/api/web/wallets/return-to-connected",{method:"POST",body:JSON.stringify({destination:e.publicKey,walletIndexes:r}),dedupe:!1,timeoutMs:te});n.returnFundsBusy=!1,Qn(o.summary||"Funds returned to your connected wallet."),await De({force:!0,deep:!1,reason:"return-funds"}).catch(()=>{}),h()}catch(o){n.returnFundsBusy=!1,Qn(o.message),h()}}}async function $b(){if(n.distributeBusy)return;const e=m("[data-distribute-count]")?.value||"5",t=m("[data-distribute-amount]")?.value||"",a=m("[data-distribute-source]")?.value||"1",r=m("[data-distribute-label]")?.value?.trim()||"Fresh";if(!t||Number(t)<=0){is("Enter SOL per wallet greater than zero.");return}const s=(Number(t)||0)*(Number(e)||0);if(await xe({title:"Create & Fund Wallets",lines:[`Create ${e} fresh wallet(s) and fund each with ${t} SOL?`,`That sends about ${s.toFixed(3)} SOL total from the source wallet (real SOL).`,"Backup/recovery files for the new wallets will download."],confirmLabel:"Create & Fund"})){n.distributeBusy=!0,is("Creating and funding wallets..."),h();try{await Y(m("[data-distribute-status]"),"Creating secure web profile for wallet backups...");const c=await k("/api/web/wallets/distribute",{method:"POST",body:JSON.stringify({count:e,amountSol:t,sourceWalletIndex:a,label:r}),dedupe:!1,timeoutMs:te});c.downloads?.encryptedBackup?.text&&he(c.downloads.encryptedBackup.filename,c.downloads.encryptedBackup.text),c.downloads?.recoveryKeys?.text&&he(c.downloads.recoveryKeys.filename,c.downloads.recoveryKeys.text),n.distributeBusy=!1,is(c.summary||"Fresh wallets created and funded. Backups downloaded."),await De({force:!0,deep:!1,reason:"distribute-fresh-wallets"}).catch(()=>{}),h()}catch(c){n.distributeBusy=!1,is(c.message),h()}}}function Tb(e){return e.status==="completed"?"Finished":e.stage==="sweeping"?"Sweeping back":e.stage==="running"?"Running":e.stage||"Armed"}function Ab(){const e=Vu().length;return e?`
    ...
    </article>`:""}function Pb(){const e=Array.isArray(n.volumeBots)?n.volumeBots:[],t=Ab();return e.length?t+e.map(a=>{const r=a.stats||{},s=a.status!=="completed",o=(a.log||[]).slice(0,6);return`
      <article class="volume-bot-status">
        <header class="volume-bot-status-head">
          <div>
            <strong>${i(a.shortMint||a.tokenMint||"Token")}</strong>
            <span class="volume-bot-stage" data-stage="${i(a.stage||"")}">${i(Tb(a))}</span>
          </div>
    ...
    <section class="launch-coin-card pump-live-panel" data-pump-live-panel>
      ...
      <div class="pump-live-grid">
        ...
        <div class="pump-live-stack">
          <div class="pump-live-stat"><span>Launch CA</span><strong>${i(Fb(t))}</strong></div>
          <div class="pump-live-stat"><span>Provider</span><strong>${i(Ob())}</strong></div>
  ...
  `}function Nb(e={}){rd();const t=n.hypePages||[],r=new Date(Date.now()+600*1e3-new Date().getTimezoneOffset()*60*1e3).toISOString().slice(0,16);return`
    <div class="volume-grid">
      ...
      ${t.length?`
        <div class="full-span">
          ...
          <div class="volume-grid">
            ...
            <label>
              ...
              <select data-launch-coin-dev-wallet>
                ${mb(e.devWalletIndex||(e.walletIndexes||[])[0]||"")}
              </select>
            </label>
            <label>
          ...
          </div>`},{key:"hype",label:"Hype",hint:"Pre-launch page",title:"Pre-Launch Hype Page",html:Nb(e)},{key:"live",label:"Live",hint:"Status feed",title:"Live Launch Status",html:Wb(e)}];return`
    ${_b()}
  ...
  `}async function Fi(e={}){if(!D("kolDumpDetectorEnabled",!0))return null;const t=!!e.force;if(!t&&n.kolDumpStatsLoadedAt&&Date.now()-Number(n.kolDumpStatsLoadedAt||0)<900*1e3)return n.kolDumpStats;if(n.kolDumpStatsLoading)return null;n.kolDumpStatsLoading=!0;try{const a=new URLSearchParams({mode:n.kolMode||"hot"});n.kolWallet&&a.set("wallet",n.kolWallet),t&&a.set("force","true");const r=await k(`/api/web/kols/dump-stats?${a.toString()}`,{timeoutMs:t?5e3:3e3,preserveSafeError:!0});return n.kolDumpStats=r,n.kolDumpStatsLoadedAt=Date.now(),ne(r.cacheHit?"kolStatsCacheHit":"kolStatsCacheMiss"),r}catch{return n.kolDumpStats=n.kolDumpStats||{stats:[],message:"KOL dump stats unavailable. Showing local low-data fallback."},n.kolDumpStatsLoadedAt=Date.now(),null}finally{n.kolDumpStatsLoading=!1,n.kolDumpDetails?.open?fs():n.activeTab==="kol"&&h({force:!0})}}function ny(e=""){const t=String(e||"").trim();!t||!D("kolDumpDetectorEnabled",!0)||(n.kolDumpDetails={open:!0,kolId:t},Ua(),fs(),Fi({force:!0}))}function Wi(){n.kolDumpDetails={open:!1,kolId:""},fs(),Er()}function fs(){let e=document.querySelector("[data-kol-dump-drawer-root]");e||(e=document.createElement("div"),e.dataset.kolDumpDrawerRoot="true",document.body.appendChild(e));const t=n.kolDumpDetails||{},a=!!(t.open&&t.kolId);if(document.body.classList.toggle("kol-dump-drawer-open",a),!a||!D("kolDumpDetectorEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=ms().find(d=>String(d.kolId)===String(t.kolId))||ty(t.kolId),s=!!n.kolDumpStatsLoading,o=Array.isArray(r.walletAddresses)?r.walletAddresses.filter(Boolean).slice(0,4):[],c=Array.isArray(r.externalLinks)?r.externalLinks.filter(d=>/^https?:\/\//i.test(String(d?.url||""))).slice(0,4):[],l=r.lastTokenMint?`${r.lastTokenSymbol?`${r.lastTokenSymbol} `:""}${w(r.lastTokenMint)}`:"n/a",u=`
  ...
  `;fr(e,u,".kol-dump-drawer")}function ry(){const e=n.kolScan?.configured!==!1,t=n.kolLoading?"disabled":"",a=String(n.kolMode||"hot"),r=!!n.kolScan,s=!!n.kolScan?.kols?.length,o=s&&a!=="hot",c=!r&&!s;return`
    ...
    <p class="scan-meta">${i(oy(n.kolMode))}</p>
    ${sy()}
    ${o?ly():c?Mg():""}
    ${n.kolMode==="slimewire"&&n.kolScan?n.kolScan.kols?.length?"":F("No SlimeWire traders yet","Traders appear here only after they opt in from Profile and have site trade history."):n.kolScan?cy():F("No KOL scan loaded","Pick a KOL mode or tap Refresh.")}
  ...
  `}function sy(){const e=n.kolScan||null,t=tr(n.kolMode),a=n.kolLoading?`Scanning ${t}`:e?`${t} loaded`:`Pick ${t} or tap Refresh`,r=Number(e?.kolCount||e?.kols?.length||0),s=Number(e?.rows?.length||0),o=n.kolLastUpdatedAt?Se(n.kolLastUpdatedAt):"Not run";return`
  ...
  `}function tr(e){const t={hot:"Hot Buys",top:"Top KOLs",consistent:"Consistent",fresh:"Fresh",slimewire:"Top SlimeWire Traders"};return t[e]||t.hot}function oy(e){const t={hot:"Top coins KOL wallets are calling now. Hot Buys refreshes around every 10 seconds while the tab is open.",top:"Best ranked KOL wallets by realized performance, then their highest-value current token positions.",consistent:"KOLs ranked by consistency/win rate from the available leaderboard, then filtered into cleaner copyable positions.",fresh:"KOL wallets with the newest activity first, useful when you want faster signal flow.",slimewire:"Opt-in SlimeWire users ranked by closed trades and recent activity."};return t[e]||t.hot}function iy(){const e=n.kolResult;return e?.results?.length?`<div class="mini-results">${e.results.map(t=>`<span data-ok="${t.ok?"true":"false"}">${i(t.message||t)}</span>`).join("")}</div>`:""}function ly(){const e=n.kolScan||{},t=(e.kols||[]).filter(a=>a.wallet||a.twitter);return!t.length||e.configured===!1?"":`
  ...
  `}function cy(){const e=n.kolScan||{};if(e.configured===!1)return F("KOL Tracker is not connected yet",e.message||"Use Scan Wallet for a public wallet, or try again later.");const t=e.rows||[],a=nt("kol",t);return t.length?`
...
`)}async function Ay(e){const t=m("[data-wallet-sweep-status]");n.walletSweepStatus="Running wallet action...",v(t,n.walletSweepStatus),$("");try{await Y(t,"Opening secure web profile...");const r={"sweep-sol":"/api/web/wallets/sweep-sol","sweep-tokens":"/api/web/wallets/sweep-tokens","sell-all":"/api/web/wallets/sell-all-tokens","sell-all-sweep":"/api/web/wallets/sell-all-tokens","send-sol-many":"/api/web/wallets/send-sol"}[e];if(!r)throw new Error("Unknown wallet action.");const s=e==="send-sol-many"?$y():ky();if(e==="sell-all"&&(s.destination=""),e==="sell-all-sweep"&&!s.destination)throw new Error("Enter a destination wallet for Sell Tokens + Send SOL.");const o=await k(r,{method:"POST",body:JSON.stringify(s),timeoutMs:te});n.walletSweepStatus=Ty(o.sweep),v(t,n.walletSweepStatus),await De({force:!0,deep:!0}),n.activeTab="wallets",h()}catch(a){n.walletSweepStatus=a.message,v(t,a.message),$(a.message)}}async function Py(e){const t=m("[data-restore-status]"),a=m("[data-restore-text]"),r=e?.files?.[0];if(!(!r||!a)){v(t,"Reading backup file...");try{a.value=await r.text(),v(t,"Backup loaded. Tap Restore Wallets.")}catch(s){v(t,`Could not read file: ${s.message}`)}}}function he(e,t){const a=new Blob([t],{type:"text/plain"}),r=URL.createObjectURL(a),s=document.createElement("a");s.href=r,s.download=e,document.body.appendChild(s),s.click(),s.remove(),setTimeout(()=>URL.revokeObjectURL(r),1e4)}async function Cy(){const e=m("[data-x-handle]"),t=m("[data-x-status]"),a=Je(e?.value||"");if(!a){v(t,"Enter a valid X handle first.");return}const r=window.open(Ci(a),"_blank","noopener,noreferrer");try{v(t,r?`Opening X and saving @${a}...`:`Saving @${a}. Allow popups if X did not open.`),await Y(t,"Creating secure web profile for X sharing...");const s=await k("/api/web/profile/x",{method:"POST",body:JSON.stringify({xHandle:a})});me(s.user||{...n.user,xHandle:s.profile?.xHandle||a}),jl(n.xHandle),v(t,`Connected @${n.xHandle}. Share buttons now open X posts with SlimeWire tagged.`),h()}catch(s){v(t,s.message),$(s.message)}}function Ly(){const e=m("[data-x-status]"),t=Je(m("[data-x-handle]")?.value||n.xHandle||""),a=Ci(t||n.xHandle);window.open(a,"_blank","noopener,noreferrer"),v(e,t?`Opened X for @${t}. Tap Connect X after checking the handle.`:"Opened X login. Add your handle here after signing in.")}async function xy(){const e=m("[data-x-status]"),t=m("[data-x-handle]");try{if(!n.user||!n.token){n.xHandle="",t&&(t.value=""),To(),v(e,"X unlinked. Enter a new handle any time and tap Save X Handle."),h();return}const a=await k("/api/web/profile/x",{method:"POST",body:JSON.stringify({clear:!0})});me(a.user||{...n.user,xHandle:""}),n.xHandle="",t&&(t.value=""),To(),v(e,"X unlinked. Enter a new handle any time and tap Save X Handle."),h()}catch(a){v(e,a.message),$(a.message)}}async function ys(e,t="Saving PFP..."){const a=m("[data-avatar-status]");v(a,t);try{await Y(a,"Creating secure web profile for PFP...");const r=await k("/api/web/profile/avatar",{method:"POST",body:JSON.stringify(e)});me(r.user||{...n.user,avatar:r.profile?.avatarDataUrl||r.profile?.avatarUrl||"",avatarSource:r.profile?.avatarSource||"",avatarUpdatedAt:r.profile?.avatarUpdatedAt||""}),v(a,n.user.avatar?"PFP saved.":"PFP removed."),h()}catch(r){v(a,r.message),$(r.message)}}async function My(e){const t=m("[data-avatar-status]"),a=e?.files?.[0];if(a){if(!/^image\/(png|jpe?g|webp)$/i.test(a.type)){v(t,"Use a PNG, JPG, or WebP image.");return}if(a.size>5*1024*1024){v(t,"Use an image under 5 MB.");return}try{v(t,"Compressing PFP...");const r=await vd(a);await ys({avatarDataUrl:r},"Saving compressed PFP...")}catch(r){v(t,r.message),$(r.message)}finally{e.value=""}}}function vd(e){return new Promise((t,a)=>{const r=new FileReader;r.onerror=()=>a(new Error("Could not read that image.")),r.onload=()=>{const s=new Image;s.onerror=()=>a(new Error("Could not load that image.")),s.onload=()=>{const c=document.createElement("canvas");c.width=256,c.height=256;const l=c.getContext("2d");if(!l){a(new Error("This browser cannot resize images."));return}const u=Math.max(256/s.width,256/s.height),d=Math.round(s.width*u),p=Math.round(s.height*u),f=Math.round((256-d)/2),y=Math.round((256-p)/2);l.clearRect(0,0,256,256),l.drawImage(s,f,y,d,p);const g=c.toDataURL("image/jpeg",.84);if(g.length>22e4){a(new Error("Compressed PFP is still too large. Try a simpler image."));return}t(g)},s.src=String(r.result||"")},r.readAsDataURL(e)})}async function By(e){const t=document.querySelector('script[src*="app.js"]')?.src||document.baseURI||window.location.href,a=new URL(String(e||""),t).toString(),r=await fetch(a,{cache:"force-cache"});if(!r.ok)throw new Error("Could not load that preset PFP.");const s=await r.blob();return vd(s)}async function Ry(){const e=Pi(n.xHandle);if(!e){const t=m("[data-avatar-status]");v(t,"Connect an X handle first.");return}await ys({avatarUrl:e,avatarSource:"x"},"Saving X PFP...")}async function wd(e,t={}){const a=In(),r=fe(e);if(!r){if(await Ac(e,t)||Pc(e))return;const s=fc(e);re(s),It(e,new Error(s),{action:"provider_missing",platform:Ve()?"mobile":"desktop"});return}try{const s=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(s){if(!(t.confirmSwitch===!1?!0:await xe({title:"Reconnect or Switch Wallet",lines:[`Current wallet: ${w(s)}`,"Your wallet extension will open so you can approve the wallet to use on Live Terminal."],confirmLabel:"Open Wallet"}))){re("Wallet connection unchanged."),Te("/terminal","terminal");return}try{await Promise.resolve(r.disconnect?.())}catch{}}re(`Opening ${Fe(e,r)}...`);const c=(await r.connect?.({onlyIfTrusted:!1}))?.publicKey||r.publicKey,l=c?.toBase58?.()||c?.toString?.()||"";if(!l)throw new Error("Wallet connected, but no public address was returned.");await Y(a,"Creating secure web profile for connected wallet...");const u=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({publicKey:l,provider:Fe(e,r)})});me(u.user||{...n.user,connectedWallet:u.profile?.connectedWallet||null}),n.connectedWalletBalance={publicKey:l,shortPublicKey:w(l),provider:Fe(e,r),tokens:[]},hi(`connected:${l}`),n.walletConnectMenuOpen=!1,re(`Connected ${w(l)}. Opening Live Terminal...`),Te(t.returnPath||n.walletConnectReturnPath||"/terminal","terminal"),h({force:!0}),mu("browser-wallet-connect"),Ur("browser-wallet-connect")}catch(s){const o=s.message||"Wallet connection was cancelled.";re(o),It(e,s,{action:"connect_failed"})}}async function Sd(){await td("disconnecting");const e=In(),t=n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"";if(!n.user||!n.token){n.connectedWalletBalance=null,hi(t?`connected:${t}`:""),re("Connected wallet disconnected."),h({force:!0});return}try{const a=n.user?.connectedWallet?.provider||"";await(a.toLowerCase().includes("phantom")?fe("phantom"):a.toLowerCase().includes("solflare")?fe("solflare"):a.toLowerCase().includes("backpack")?fe("backpack"):fe("solana"))?.disconnect?.()}catch{}try{const a=await k("/api/web/profile/connected-wallet",{method:"POST",body:JSON.stringify({clear:!0})});me(a.user||{...n.user,connectedWallet:null}),n.connectedWalletBalance=null,hi(t?`connected:${t}`:""),re("Connected wallet disconnected."),h({force:!0})}catch(a){re(a.message),$(a.message)}}async function Iy(){const e=m("[data-profile-username]"),t=m("[data-profile-password]"),a=m("[data-login-security-status]"),r=String(e?.value||"").trim(),s=String(t?.value||"");if(!r||!s){v(a,"Enter a username and password first.");return}try{await Y(a,"Creating secure web profile..."),v(a,"Saving login...");const o=await k("/api/web/profile/credentials",{method:"POST",body:JSON.stringify({username:r,password:s})});me(o.user||{...n.user,username:r,hasPasswordLogin:!0}),t&&(t.value=""),v(a,"Saved. You can now log back in with this username and password."),h()}catch(o){v(a,o.message),$(o.message)}}function Je(e){return String(e||"").trim().replace(/^@+/,"").replace(/[^a-z0-9_]/gi,"").slice(0,15)}function Ui(e){const t=ki(e),a=String(n.user?.referralLink||"").trim(),r=a&&!t.includes("/r/")?a:Lt,s=`https://twitter.com/intent/tweet?text=${encodeURIComponent(t)}&url=${encodeURIComponent(r)}`;window.open(s,"_blank","noopener,noreferrer")}function kd(e){const t=e==="kol",a=m(t?"[data-share-watch-kol]":"[data-share-watch-token]"),r=m("[data-share-watch-status]"),s=a?.value?.trim()||"";if(!s){v(r,t?"Enter a KOL handle or wallet first.":"Enter a coin, ticker, or CA first.");return}Ui(t?xu(s):$i(s)),v(r,t?"KOL watch post opened in X.":"Coin watch post opened in X.")}async function $d(e){const t={};n.token&&(t.Authorization=`Bearer ${n.token}`);const a=await Mn(Va(`/api/web/pnl/card?tokenMint=${encodeURIComponent(e)}`),{headers:t,cache:"no-store"},3e4);if(!a.ok){const r=await mc(a);throw new Error(r.message||r.error||`Could not build PnL card (${a.status}).`)}return{blob:await a.blob(),filename:a.headers.get("x-ogre-filename")||`pnl-card-${w(e)}.png`}}async function Td(e){const{blob:t,filename:a}=await $d(e),r=URL.createObjectURL(t),s=document.createElement("a");s.href=r,s.download=a,document.body.appendChild(s),s.click(),s.remove(),setTimeout(()=>URL.revokeObjectURL(r),1e4)}async function Oy(e,t){try{const{blob:a,filename:r}=await $d(e),s=new File([a],r,{type:"image/png"});if(navigator.canShare?.({files:[s]})){await navigator.share({title:"SlimeWire PnL Card",text:ki(t),url:Lt,files:[s]});return}await Td(e),Ui(`${t} PnL card downloaded and ready to attach.`)}catch(a){$(a.message)}}function Ad(e="buy"){const t=m("[data-trade-wallet]")?.value||"",a=yh(e)||m("[data-trade-token]")?.value?.trim()||"",r=x("[data-trade-slippage]","[data-trade-slippage-custom]","400");if(!t)throw new Error("Choose a wallet first.");if(!a)throw new Error("Paste a token CA first.");return n.tradeToken=a,e==="sell"?(n.tradeSwapFrom=a,n.tradeSwapTo="SOL"):(n.tradeSwapFrom="SOL",n.tradeSwapTo=a),{walletIndex:t,tokenMint:a,slippageBps:r}}function ue(e=""){return String(e||"").trim().toLowerCase()==="connected"}function Ey(e={}){if(!e?.sessionWallet||e.sessionStatus!=="funded")return!1;const t=Date.parse(e.sessionExpiresAt||"");return!Number.isFinite(t)||t>Date.now()}function Pd(){const e=Array.isArray(n.wallets)?n.wallets:[];for(let t=e.length-1;t>=0;t-=1)if(Ey(e[t]))return e[t];return null}function Cd(e=ce()){if(!e?.publicKey)return!1;const t=ar(e),a=fe(t)||fe("solana");return!!(a&&typeof a.signTransaction=="function")}function vs(e=ce()){const t=e?.provider||Fe(ar(e));return`${t} is connected, but this mobile browser cannot sign trades after the wallet-app handoff. Open SlimeWire inside the ${t} in-app browser, or fund a Session Wallet once so buys, sells, TP/SL, and Ogre A.I. can run without reconnect loops.`}function ws(e={},{side:t="trade",statusWriter:a=ge,allowSessionFallback:r=!0}={}){if(!ue(e.walletIndex))return{form:e,sessionWallet:null};if(Cd())return{form:e,sessionWallet:null};const s=r?Pd():null;if(s?.index){const o=`Using Session Wallet ${s.index} for ${t}; mobile wallet signing is not available in this browser.`;return typeof a=="function"&&a(o),{form:{...e,walletIndex:String(s.index)},sessionWallet:s}}throw new Error(vs())}function Ld(e){const t=[];for(let r=0;r<e.length;r+=32768)t.push(String.fromCharCode(...e.subarray(r,r+32768)));return btoa(t.join(""))}function xd(e=""){const t=atob(String(e||"")),a=new Uint8Array(t.length);for(let r=0;r<t.length;r+=1)a[r]=t.charCodeAt(r);return a}function ar(e=ce()){const t=String(e?.provider||"").trim().toLowerCase();return t.includes("phantom")?"phantom":t.includes("solflare")?"solflare":t.includes("backpack")?"backpack":"solana"}async function Fy(e=ce(),{returnPath:t=ja()||"/terminal/trade"}={}){const a=ar(e),r=e?.provider||Fe(a);if(da({returnPath:t}),Ve()&&e?.publicKey&&!fe(a)){const o=vs(e);return re(o),o}if(Tc(a)){const o=`${r} needs to reconnect before it can sign here. Opening ${r} mobile connect now.`;if(re(o),await Ac(a,{returnPath:t}).catch(()=>!1))return o}if(Pc(a))return`Opening ${r}. Use the wallet browser to reconnect and approve the trade.`;const s=fc(a);return re(s),s}async function Md(){const e=ce();if(!e?.publicKey)throw new Error("Connect Phantom, Solflare, or another wallet before trading.");const t=ar(e),a=fe(t)||fe("solana");if(!a){if(Ve()&&e?.publicKey)throw new Error(vs(e));const o=await Fy(e,{returnPath:ja()||"/terminal/trade"});throw new Error(o)}if(typeof a.signTransaction!="function")throw Ve()&&e?.publicKey?new Error(vs(e)):new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const r=()=>a.publicKey?.toBase58?.()||a.publicKey?.toString?.()||"";let s=r();if(s!==e.publicKey)try{const o=await a.connect?.({onlyIfTrusted:!0});s=o?.publicKey?.toBase58?.()||o?.publicKey?.toString?.()||r()}catch{}if(s!==e.publicKey){const o=await a.connect?.({onlyIfTrusted:!1}),c=o?.publicKey?.toBase58?.()||o?.publicKey?.toString?.()||r();if(c!==e.publicKey)throw new Error(`Wallet mismatch. SlimeWire has ${w(e.publicKey)} connected, but the browser returned ${w(c)}. Reconnect the wallet you want to trade with.`)}return{provider:a,connected:e}}async function Wy(){try{if(Ve())return;const e=ce();if(!e?.publicKey)return;const t=ar(e),a=fe(t)||fe("solana");if(!a||typeof a.connect!="function"||(a.publicKey?.toBase58?.()||a.publicKey?.toString?.()||"")===e.publicKey)return;await a.connect({onlyIfTrusted:!0}).catch(()=>{})}catch{}}const _y=6e4;async function Bd(e,t,a=_y){let r=0;const s=new Promise((o,c)=>{r=window.setTimeout(()=>{c(new Error("Wallet approval timed out. Reopen your wallet and try the trade again."))},a)});try{return await Promise.race([Promise.resolve(e.signTransaction(t)),s])}finally{window.clearTimeout(r)}}async function Ny(e,t){if(!e||typeof e!="string")throw new Error("SlimeWire could not build a wallet approval transaction. Try again or choose another token.");if(!window.solanaWeb3?.VersionedTransaction)throw new Error("Solana wallet signing library did not load. Refresh the page and try again.");if(typeof t.signTransaction!="function")throw new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const a=window.solanaWeb3.VersionedTransaction.deserialize(xd(e)),r=await Bd(t,a);return Ld(r.serialize())}async function Dy(e,t){if(!e||typeof e!="string")throw new Error("SlimeWire could not build a wallet approval transaction. Try again.");if(!window.solanaWeb3?.Transaction)throw new Error("Solana wallet signing library did not load. Refresh the page and try again.");if(typeof t.signTransaction!="function")throw new Error("This wallet does not expose signTransaction here. Reconnect with Phantom/Solflare or use the wallet in-app browser.");const a=window.solanaWeb3.Transaction.from(xd(e)),r=await Bd(t,a);return Ld(r.serialize())}function Uy({side:e,connected:t,form:a={},actionDetail:r="",amountSol:s="",amountMode:o="",percent:c=""}={}){const l=e==="sell"?"Sell":"Buy",u=`${t?.provider||"Connected wallet"} ${t?.publicKey?w(t.publicKey):""}`.trim(),d=e==="sell"?`${c||r||"100"}%`:o==="max"?"Max SOL":`${s||r||"custom"} SOL`;return xe({title:`Confirm ${l}`,lines:[`${l} with ${u}?`,`Token: ${a.tokenMint||""}`,`Amount: ${d}`,"Next step: approve the transaction in your wallet."],confirmLabel:l})}async function nr({side:e,form:t,actionDetail:a,amountSol:r="",amountMode:s="",percent:o="",attemptId:c,statusWriter:l=ge}){const u=typeof l=="function"?l:ge,{provider:d,connected:p}=await Md();if(!n.walletFastApprovalsEnabled&&!await Uy({side:e,connected:p,form:t,actionDetail:a,amountSol:r,amountMode:s,percent:o}))throw new Error("Connected-wallet trade cancelled.");hm(`${e==="buy"?"Buy":"Sell"} ${w(t.tokenMint||"")}`),Re("submitted","pending"),u(n.walletFastApprovalsEnabled?`Building ${e} approval for ${p.provider||"your wallet"}...`:`Preparing ${e} approval...`);const f=await k("/api/web/browser-trade/order",{method:"POST",body:JSON.stringify({side:e,tokenMint:t.tokenMint,walletPublicKey:p.publicKey,slippageBps:t.slippageBps,amountSol:r,amountMode:s,percent:o,tradeAttemptId:c}),dedupe:!1,timeoutMs:te});Re("submitted","ok"),Re("approved","pending",`Approve in ${p.provider||"your wallet"}`),u(`Approve ${e} in ${p.provider||"your wallet"}...`);let y;try{y=await Ny(f.order?.transaction,d)}catch(S){throw Re("approved","fail",N(S?.message||"Wallet approval was declined.")),S}Re("approved","ok"),Re("sent","pending"),u("Submitting signed trade...");let g;try{g=await k("/api/web/browser-trade/execute",{method:"POST",body:JSON.stringify({browserTradeAttemptId:f.order?.browserTradeAttemptId,signedTransaction:y}),dedupe:!1,timeoutMs:te})}catch(S){throw V(e==="buy"?"trade-buy":"trade-sell",t.tokenMint,a,{state:"error",error:N(S?.message||"Trade submit failed.")}),K("",`browser-${e}-error`,{tradeAttemptId:c}),Re("sent","fail",N(S?.message||"Submit failed - it may still have landed; positions are being re-checked.")),u(`${e==="buy"?"Buy":"Sell"} submit failed or timed out - re-checking your wallet in case the trade landed...`),S}return Re("sent","ok"),Re("confirmed",g.trade?.signature?"ok":"pending",g.trade?.signature?`tx ${String(g.trade.signature).slice(0,8)}...`:""),n.tradeResult=g.trade,u(g.trade?.message||`${e==="buy"?"Buy":"Sell"} submitted from connected wallet.`),V(e==="buy"?"trade-buy":"trade-sell",t.tokenMint,a,{state:"submitted",signature:g.trade?.signature||""}),K(g.trade?.signature,`browser-${e}`,{tradeAttemptId:c}),g.trade}function Ue(e){const t=String(e||"").trim().toLowerCase();return!!t&&!["0","off","none","no","disabled"].includes(t)}function on(e,t){const a=String(t||"").trim().toLowerCase();return["0","off","none","no","disabled"].includes(a)?{sellDelay:"off",sellPercent:"100"}:{sellDelay:e,sellPercent:t}}function qy(){const e=x("[data-trade-auto-tp]","[data-trade-auto-tp-custom]","25"),t=x("[data-trade-auto-sl]","[data-trade-auto-sl-custom]","8");let a=x("[data-trade-auto-delay]","[data-trade-auto-delay-custom]","off"),r=x("[data-trade-auto-sell-percent]","[data-trade-auto-sell-percent-custom]","100");return{sellDelay:a,sellPercent:r}=on(a,r),{enabled:Ue(e)||Ue(t)||Ue(a),takeProfitPct:e,stopLossPct:t,sellDelay:a,sellPercent:r}}function Rd(){const e=x("[data-chart-buy-tp]","[data-chart-buy-tp-custom]","25"),t=x("[data-chart-buy-sl]","[data-chart-buy-sl-custom]","8");let a=x("[data-chart-buy-delay]","[data-chart-buy-delay-custom]","off"),r=x("[data-chart-buy-sell-percent]","[data-chart-buy-sell-percent-custom]","100");return{sellDelay:a,sellPercent:r}=on(a,r),{enabled:Ue(e)||Ue(t)||Ue(a),takeProfitPct:e,stopLossPct:t,sellDelay:a,sellPercent:r}}function ge(e){const t=m("[data-trade-status]");v(t,e)}function We(e=""){n.chartTradeStatus=String(e||""),v(m("[data-chart-trade-status]"),n.chartTradeStatus)}function qi(e="",t=""){n.quickBuyModal={...n.quickBuyModal,status:String(e||""),error:String(t||"")};const a=m("[data-quick-buy-modal-status]"),r=m("[data-quick-buy-modal-error]");v(a,n.quickBuyModal.status),v(r,n.quickBuyModal.error),a&&(a.hidden=!n.quickBuyModal.status),r&&(r.hidden=!n.quickBuyModal.error)}async function Ss(e,t="fixed"){const a=L();let r=t==="max"?"max":String(e||"custom"),s="";try{let o=Ad("buy");r=t==="max"?"max":String(e||"custom");const c=at("trade-buy",o.tokenMint,r);if(c){ne("buttonDoubleClickPrevented"),W({component:"post-trade",action:"trade-action-dedupe",durationMs:L()-a,cacheHit:!0,requestId:c.tradeAttemptId||"",details:`trade-buy:${w(o.tokenMint)}:${r}`});return}s=bt("trade-buy");const l={tokenMint:o.tokenMint,walletIndex:o.walletIndex,slippageBps:o.slippageBps,tradeAttemptId:s},u=Dd();if((Ue(u.takeProfitPct)||Ue(u.stopLossPct)||Ue(u.sellDelay))&&Object.assign(l,{autoExit:!0,...u}),t==="max")l.amountMode="max";else{const S=Number(e);if(!Number.isFinite(S)||S<=0)throw new Error("Enter a buy amount greater than zero.");l.amountSol=String(S)}if(o=ws(o,{side:"buy",statusWriter:ge}).form,l.walletIndex=o.walletIndex,ue(o.walletIndex)){V("trade-buy",o.tokenMint,r,{state:"clicked",tradeAttemptId:s,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"browser-trade-click-to-ui",durationMs:L()-a,requestId:s,details:`browser-buy:${w(o.tokenMint)}:${r}`}),ge("Building wallet-approved buy..."),le(),await nr({side:"buy",form:o,actionDetail:r,amountSol:l.amountSol||"",amountMode:l.amountMode||"fixed",attemptId:s}),n.activeTab="trade",h({preserveSmartChartFrame:n.activeTab==="smartChart"}),Ce("trade-buy",o.tokenMint,r,3e3);return}const f=qy();f.enabled&&Object.assign(l,{autoExit:!0,takeProfitPct:f.takeProfitPct,stopLossPct:f.stopLossPct,sellDelay:f.sellDelay,sellPercent:f.sellPercent}),V("trade-buy",o.tokenMint,r,{state:"clicked",tradeAttemptId:s,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"trade-click-to-ui",durationMs:L()-a,requestId:s,details:`trade-buy:${w(o.tokenMint)}:${r}`}),h(),ge(f.enabled?"Sending buy and arming auto-exit...":"Sending buy..."),await Le(20);const y=L();V("trade-buy",o.tokenMint,r,{state:"submitting"});const g=await k("/api/web/trade/buy",{method:"POST",body:JSON.stringify({...l,clientClickToUiMs:Math.round(y-a)}),dedupe:!1});W({component:"post-trade",action:"trade-backend-ack",durationMs:L()-y,requestId:s,resultCount:g.trade?.signature?1:0,details:"trade-buy"}),n.tradeResult=g.trade,hm(`Buy ${w(o.tokenMint||"")}`),Re("submitted","ok"),Re("sent","ok"),Re("confirmed",g.trade?.signature?"ok":"pending",g.trade?.signature?`tx ${String(g.trade.signature).slice(0,8)}...`:""),g.trade?.autoExitPlan?(Re("armed","ok"),n.tradePlanResult=g.trade.autoExitPlan,ge(g.trade.autoExitPlan.shortMessage||"Buy landed and auto-exit is armed."),bs()):g.trade?.autoExitRequested&&(Re("armed","fail","Auto-exit was NOT armed - exit manually or create a managed plan."),ge("Buy landed, but auto-exit was not armed. Use Positions to exit manually or create a managed plan.")),V("trade-buy",o.tokenMint,r,{state:"submitted",signature:g.trade?.signature||""}),K(g.trade?.signature,"trade-buy",{tradeAttemptId:s}),n.activeTab="trade",h(),Ce("trade-buy",o.tokenMint,r,3e3)}catch(o){s&&(V("trade-buy",n.tradeToken||m("[data-trade-token]")?.value||"",r,{state:"error",error:N(o.message||"Buy failed")}),Ce("trade-buy",n.tradeToken||m("[data-trade-token]")?.value||"",r,4e3)),W({component:"post-trade",action:"trade-action-error",durationMs:L()-a,requestId:s,errorCode:o?.code||o?.name||"TRADE_BUY_FAILED",details:N(o.message||"Buy failed")}),ge(o.message)}}async function Hi(e){const t=L(),a=bt("manual-sell");let r=null,s=String(e||"custom");try{r=Ad("sell");const o=Number.parseInt(e,10);if(s=String(o||s),!Number.isInteger(o)||o<1||o>100)throw new Error("Sell percent must be from 1 to 100.");const c=at("trade-sell",r.tokenMint,s);if(c){ne("buttonDoubleClickPrevented"),W({component:"manual-sell",action:"manual-sell-dedupe",durationMs:L()-t,cacheHit:!0,requestId:c.tradeAttemptId||"",details:`${w(r.tokenMint)}:${o}`});return}if(V("trade-sell",r.tokenMint,s,{state:"clicked",tradeAttemptId:a,clickedAt:new Date().toISOString()}),ge("Sending sell..."),W({component:"manual-sell",action:"manual-sell-click-to-ui",durationMs:L()-t,requestId:a,details:`${w(r.tokenMint)}:${o}`}),r=ws(r,{side:"sell",statusWriter:ge}).form,ue(r.walletIndex)){le();const p=L();V("trade-sell",r.tokenMint,s,{state:"submitting"}),await nr({side:"sell",form:r,actionDetail:s,percent:String(o),attemptId:a}),W({component:"manual-sell",action:"browser-sell-request",durationMs:L()-p,requestId:a,resultCount:n.tradeResult?.signature?1:0,details:"browser-wallet"}),n.activeTab="trade",h({preserveSmartChartFrame:n.activeTab==="smartChart"}),Ce("trade-sell",r.tokenMint,s,3e3);return}h(),await Le(20);const u=L();V("trade-sell",r.tokenMint,s,{state:"submitting"});const d=await k("/api/web/trade/sell",{method:"POST",body:JSON.stringify({tokenMint:r.tokenMint,walletIndex:r.walletIndex,slippageBps:r.slippageBps,percent:o,manualSellAttemptId:a,clientClickToUiMs:Math.round(u-t)}),timeoutMs:te,dedupe:!1});W({component:"manual-sell",action:"manual-sell-request",durationMs:L()-u,requestId:a,resultCount:d.trade?.signature?1:0,details:"single-wallet"}),n.tradeResult=d.trade,ge(d.trade?.signature?"Submitted. Refreshing position in the background...":"Sell submitted. Refreshing position in the background..."),V("trade-sell",r.tokenMint,s,{state:"submitted",signature:d.trade?.signature||""}),K(d.trade?.signature||Me(d.trade),"manual-sell-trade"),n.activeTab="trade",h(),Ce("trade-sell",r.tokenMint,s,3e3)}catch(o){r?.tokenMint&&(V("trade-sell",r.tokenMint,s,{state:"error",error:N(o.message||"Sell failed")}),Ce("trade-sell",r.tokenMint,s,4e3)),W({component:"manual-sell",action:"manual-sell-error",durationMs:L()-t,requestId:a,errorCode:o?.code||o?.name||"MANUAL_SELL_FAILED",details:N(o.message||"Sell failed")}),ge(o.message)}}function Hy(){const e=qe("trade-plan"),t=m("[data-trade-plan-group]")?.value?.trim()||"",a=m("[data-trade-token]")?.value?.trim()||"",r=x("[data-trade-plan-amount]","[data-trade-plan-amount-custom]","0.1"),s=x("[data-trade-plan-tp]","[data-trade-plan-tp-custom]","25"),o=x("[data-trade-plan-sl]","[data-trade-plan-sl-custom]","8");let c=x("[data-trade-plan-delay]","[data-trade-plan-delay-custom]","5"),l=x("[data-trade-plan-sell-percent]","[data-trade-plan-sell-percent-custom]","100");({sellDelay:c,sellPercent:l}=on(c,l));const u=x("[data-trade-plan-slippage]","[data-trade-plan-slippage-custom]","400");if(!e.length&&!t)throw new Error("Choose at least one wallet or enter a group label.");if(!a)throw new Error("Paste a token CA first.");return n.tradeToken=a,n.volumeToken=a,n.bundleToken=a,{walletIndexes:e,walletGroup:t,tokenMint:a,amountSol:r,sellDelay:c,takeProfitPct:s,stopLossPct:o,sellPercent:l,loopCount:"1",loopDelay:"0",slippageBps:u,...fa("trade-plan")}}async function Ky(){try{const e=Hy();ge("Buying and arming managed exit...");const t=await k("/api/web/trade/plan",{method:"POST",body:JSON.stringify(e)});n.tradePlanResult=t.plan,n.tradeResult=null,K(t.trade?.signature,"trade-plan"),n.activeTab="trade",h()}catch(e){ge(e.message)}}function Vy(){const e=qe("volume"),t=m("[data-volume-group]")?.value?.trim()||"",a=m("[data-volume-token]")?.value?.trim()||"",r=m("[data-volume-amount]")?.value||"";let s=x("[data-volume-delay]","[data-volume-delay-custom]","5");const o=x("[data-volume-tp]","[data-volume-tp-custom]","25"),c=x("[data-volume-sl]","[data-volume-sl-custom]","8"),l=x("[data-volume-loop]","[data-volume-loop-custom]","1"),u=x("[data-volume-loop-delay]","[data-volume-loop-delay-custom]","0");let d=x("[data-volume-sell-percent]","[data-volume-sell-percent-custom]","100");({sellDelay:s,sellPercent:d}=on(s,d));const p=x("[data-volume-slippage]","[data-volume-slippage-custom]","400");if(!e.length&&!t)throw new Error("Choose at least one wallet or enter a group label.");if(!a)throw new Error("Paste a token CA first.");return n.volumeToken=a,{walletIndexes:e,walletGroup:t,tokenMint:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,loopCount:l,loopDelay:u,sellPercent:d,slippageBps:p,...fa("volume")}}function Id(e){const t=m("[data-volume-status]");v(t,e)}async function zy(){try{const e=Vy();Id("Buying and arming plan...");const t=await k("/api/web/volume/plan",{method:"POST",body:JSON.stringify(e)});n.volumeResult=t.plan,K(Me(t.plan),"volume-plan"),n.activeTab="volume",h()}catch(e){Id(e.message)}}function jy(e){const t=qe("sniper"),a=m("[data-sniper-group]")?.value?.trim()||"",r=m("[data-sniper-amount]")?.value||"",s=x("[data-sniper-delay]","[data-sniper-delay-custom]",n.scanMode==="pumpsnipe"?"3":"5"),o=x("[data-sniper-tp]","[data-sniper-tp-custom]",n.scanMode==="pumpsnipe"?"40":"25"),c=x("[data-sniper-sl]","[data-sniper-sl-custom]","8"),l=x("[data-sniper-loop]","[data-sniper-loop-custom]","1"),u=x("[data-sniper-loop-delay]","[data-sniper-loop-delay-custom]","0"),d=x("[data-sniper-slippage]","[data-sniper-slippage-custom]",n.scanMode==="pumpsnipe"?"300":"400");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!e)throw new Error("Pick a token first.");return n.tradeToken=e,n.volumeToken=e,n.bundleToken=e,{mode:n.scanMode,tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,slippageBps:d,loopCount:l,loopDelay:u,...fa("sniper")}}function Od(e){const t=m("[data-sniper-status]");v(t,e)}async function Gy(e){try{const t=jy(e);Od("Buying and arming exits...");const a=await k("/api/web/sniper/entry",{method:"POST",body:JSON.stringify(t)});n.sniperResult=a.plan,K(Me(a.plan),"sniper-entry"),n.activeTab="sniper",h()}catch(t){Od(t.message)}}function Xy(){const e=qe("ogre-ai"),t=m("[data-ogre-ai-group]")?.value?.trim()||"",a=m("[data-ogre-ai-amount]")?.value?.trim()||"",r=as(),s=m("[data-ogre-ai-runs]")?.value||"1",o=m("[data-ogre-ai-tp]")?.value||"25",c=m("[data-ogre-ai-tp-custom]")?.value?.trim()||"",l=m("[data-ogre-ai-sl]")?.value||"8",u=m("[data-ogre-ai-sl-custom]")?.value?.trim()||"",d=m("[data-ogre-ai-delay]")?.value||"5",p=m("[data-ogre-ai-delay-custom]")?.value?.trim()||"",f=m("[data-ogre-ai-slippage]")?.value||"400",y=m("[data-ogre-ai-slippage-custom]")?.value?.trim()||"";af({amountSol:a,runCount:s,category:r,takeProfitSelect:o,takeProfitCustom:c,stopLossSelect:l,stopLossCustom:u,delaySelect:d,delayCustom:p,slippageSelect:f,slippageCustom:y,walletGroup:t});const g=x("[data-ogre-ai-delay]","[data-ogre-ai-delay-custom]","60"),S=x("[data-ogre-ai-tp]","[data-ogre-ai-tp-custom]","100"),A=x("[data-ogre-ai-sl]","[data-ogre-ai-sl-custom]","40"),T=x("[data-ogre-ai-slippage]","[data-ogre-ai-slippage-custom]","400"),b="";if(!e.length&&!t)throw new Error("Choose at least one managed wallet or enter a group label.");if(!a)throw new Error("Enter SOL per wallet for Ogre A.I.");return{walletIndexes:e,walletGroup:t,category:r,mode:r,amountSol:a,runCount:s,sellDelay:g,takeProfitPct:S,stopLossPct:A,sellPercent:"100",slippageBps:T,minScore:b,recentMints:Gl()}}function ks(e){n.ogreAiStatus=e||"";const t=m("[data-ogre-ai-status]");v(t,n.ogreAiStatus)}async function Jy(){if(Rr){_a=!0,ks("Stopping the hunt after this scan...");return}const e=Symbol("ogre-ai-run");_a=!1;try{const t=Xy();n.ogreAiLoading=!0,Rr=e;const a=Array.isArray(t.recentMints)?[...t.recentMints]:[];let r=null,s=!1,o=0;const c=120;for(;!s&&!_a&&o<c&&(o+=1,ks(o===1?"Scanning fresh low-MC pairs and arming managed exits...":`Hunting fresh pairs... (scan ${o}) - tap Scan again to stop.`),h(),r=await k("/api/web/ogre-ai/start",{method:"POST",body:JSON.stringify({...t,recentMints:a}),timeoutMs:te}),s=Number(r.ogreAi?.armedCount||0)>0||(r.ogreAi?.plans?.length||0)>0,!s);){for(const l of r.ogreAi?.errors||[])l?.tokenMint&&!a.includes(l.tokenMint)&&a.push(l.tokenMint);for(const l of r.ogreAi?.attemptedPicks||[])l?.tokenMint&&!a.includes(l.tokenMint)&&a.push(l.tokenMint);if(_a)break;await Le(5e3)}n.ogreAiResult=r?.ogreAi,tf(r?.ogreAi),n.tradePlanResult=r?.ogreAi?.plans?.[0]||n.tradePlanResult,ks(s?r?.ogreAi?.message||"Ogre A.I. run armed.":_a?"Hunt stopped. Tap Scan to hunt again.":"Still hunting - no clean fresh pair armed yet. Tap Scan to keep going."),s&&K(Me(r?.ogreAi?.plans?.[0]),"ogre-ai-run"),n.activeTab="ogreAi",h()}catch(t){ks(t.message),$(t.message)}finally{n.ogreAiLoading=!1,_a=!1,Rr===e&&(Rr=null),h()}}function rr(e){const t=m("[data-autopilot-status]");t&&(t.textContent=String(e||""))}async function Yy({silent:e=!0}={}){try{const t=await k("/api/web/ogre-ai/autopilot");n.ogreAutopilot=t.autopilot||null,n.activeTab==="ogreAi"&&h()}catch(t){e||rr(t.message)}}function Qy(){return{enabled:!!m("[data-autopilot-enabled]")?.checked,category:as(),amountSol:m("[data-ogre-ai-amount]")?.value?.trim()||(n.ogreAutopilot?.amountSol??"0.05"),takeProfitPct:x("[data-ogre-ai-tp]","[data-ogre-ai-tp-custom]","25"),stopLossPct:x("[data-ogre-ai-sl]","[data-ogre-ai-sl-custom]","8"),sellDelay:x("[data-ogre-ai-delay]","[data-ogre-ai-delay-custom]","5"),slippageBps:x("[data-ogre-ai-slippage]","[data-ogre-ai-slippage-custom]","400"),walletIndexes:qe("ogre-ai"),walletGroup:m("[data-ogre-ai-group]")?.value?.trim()||"",maxSpendPerHourSol:m("[data-autopilot-maxspend]")?.value?.trim()||"0.3",maxConcurrent:m("[data-autopilot-maxconcurrent]")?.value?.trim()||"2",minScore:m("[data-autopilot-minscore]")?.value?.trim()||"62",intervalMinutes:m("[data-autopilot-interval]")?.value?.trim()||"10"}}async function Zy(){if(n.ogreAutopilotBusy)return;const e=Qy();if(e.enabled&&!e.walletIndexes.length&&!e.walletGroup){rr("Pick at least one managed wallet (or a wallet group) above before enabling autopilot.");return}if(!(e.enabled&&!await xe({title:"Enable Ogre A.I. Autopilot",lines:["This will spend REAL SOL automatically.",`Category: ${Gu(e.category)}`,`Up to ${e.amountSol} SOL per wallet, max ${e.maxSpendPerHourSol} SOL/hour, every ${e.intervalMinutes} min.`,`Only buys picks scoring >= ${e.minScore}, max ${e.maxConcurrent} live plans.`,"You can turn it off any time."],confirmLabel:"Enable Autopilot"}))){n.ogreAutopilotBusy=!0,rr(e.enabled?"Arming autopilot...":"Saving..."),h();try{const t=await k("/api/web/ogre-ai/autopilot",{method:"POST",body:JSON.stringify(e)});n.ogreAutopilot=t.autopilot||null,rr(n.ogreAutopilot?.lastStatus||"Saved.")}catch(t){rr(t.message),$(t.message)}finally{n.ogreAutopilotBusy=!1,h()}}}function Ut(e){const t=m("[data-kol-status]");v(t,e)}function ev(e){const t=qe("kol"),a=m("[data-kol-group]")?.value?.trim()||"",r=m("[data-kol-amount]")?.value||"",s=x("[data-kol-delay]","[data-kol-delay-custom]","5"),o=x("[data-kol-tp]","[data-kol-tp-custom]","25"),c=x("[data-kol-sl]","[data-kol-sl-custom]","8"),l=x("[data-kol-loop]","[data-kol-loop-custom]","1"),u=x("[data-kol-loop-delay]","[data-kol-loop-delay-custom]","0"),d=x("[data-kol-slippage]","[data-kol-slippage-custom]","400");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!e)throw new Error("Pick a KOL signal first.");return n.tradeToken=e,n.volumeToken=e,n.bundleToken=e,{tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,loopCount:l,loopDelay:u,sellPercent:"100",slippageBps:d,...fa("kol")}}function tv(e){const t=qe("kol"),a=m("[data-kol-group]")?.value?.trim()||"",r=m("[data-kol-amount]")?.value||"",s=x("[data-kol-delay]","[data-kol-delay-custom]","5"),o=x("[data-kol-tp]","[data-kol-tp-custom]","25"),c=x("[data-kol-sl]","[data-kol-sl-custom]","8"),l=x("[data-kol-loop]","[data-kol-loop-custom]","1"),u=x("[data-kol-loop-delay]","[data-kol-loop-delay-custom]","0"),d=x("[data-kol-slippage]","[data-kol-slippage-custom]","400"),p=String(e||n.kolWallet||m("[data-kol-wallet]")?.value||"").trim();if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");if(!p)throw new Error("Paste or choose a KOL wallet first.");if(!_t(p))throw new Error("That KOL entry does not have a verified Solana wallet yet.");return{copyWallet:p,walletIndexes:t,walletGroup:a,amountSol:r,sellDelay:s,takeProfitPct:o,stopLossPct:c,loopCount:l,loopDelay:u,sellPercent:"100",slippageBps:d,...fa("kol")}}async function av(e){try{const t=ev(e);Ut("Buying and arming KOL copy plan...");const a=await k("/api/web/kol/entry",{method:"POST",body:JSON.stringify(t)});n.kolResult=a.plan,K(Me(a.plan),"kol-copy-plan"),n.activeTab="kol",h()}catch(t){Ut(t.message)}}async function nv(e){try{const t=tv(e);Ut("Arming Copy Wallet watch...");const a=await k("/api/web/kol/copy-wallet",{method:"POST",body:JSON.stringify(t)});n.kolResult=a.plan,n.kolWallet=t.copyWallet,n.activeTab="kol",h()}catch(t){Ut(t.message)}}function qe(e){return[...document.querySelectorAll(`[data-${e}-wallet]:checked`)].map(t=>t.value)}function $s(e){const t=m("[data-bundle-status]");v(t,e)}function Ed(){const e=m("[data-bundle-token]")?.value?.trim()||"",t=qe("bundle"),a=m("[data-bundle-group]")?.value?.trim()||"",r=m("[data-bundle-amount]")?.value||"",s=x("[data-bundle-percent]","[data-bundle-percent-custom]","100"),o=x("[data-bundle-slippage]","[data-bundle-slippage-custom]","400");if(!e)throw new Error("Paste a token CA first.");if(!t.length&&!a)throw new Error("Choose at least one wallet or enter a group label.");return n.bundleToken=e,{tokenMint:e,walletIndexes:t,walletGroup:a,amountSol:r,percent:s,slippageBps:o}}function rv(){const e=Ed();let t=x("[data-bundle-plan-delay]","[data-bundle-plan-delay-custom]","5"),a=x("[data-bundle-plan-sell-percent]","[data-bundle-plan-sell-percent-custom]","100");return{sellDelay:t,sellPercent:a}=on(t,a),{...e,sellDelay:t,takeProfitPct:x("[data-bundle-plan-tp]","[data-bundle-plan-tp-custom]","60"),stopLossPct:x("[data-bundle-plan-sl]","[data-bundle-plan-sl-custom]","10"),loopCount:x("[data-bundle-plan-loop]","[data-bundle-plan-loop-custom]","1"),loopDelay:x("[data-bundle-plan-loop-delay]","[data-bundle-plan-loop-delay-custom]","0"),sellPercent:a,...fa("bundle-plan")}}async function Fd(e){const t=L();let a=null,r="";const s=e==="buy"?"bundle-buy":"bundle-sell";try{a=Ed();const o=at(s,a.tokenMint,"bundle");if(o){ne("buttonDoubleClickPrevented"),W({component:"post-trade",action:"trade-action-dedupe",durationMs:L()-t,cacheHit:!0,requestId:o.tradeAttemptId||"",details:`${s}:${w(a.tokenMint)}`});return}r=bt(s),V(s,a.tokenMint,"bundle",{state:"clicked",tradeAttemptId:r,clickedAt:new Date().toISOString()}),W({component:"post-trade",action:"trade-click-to-ui",durationMs:L()-t,requestId:r,details:`${s}:${w(a.tokenMint)}`}),h(),$s(e==="buy"?"Sending bundle buy...":"Sending bundle sell..."),await Le(20);const c=L();V(s,a.tokenMint,"bundle",{state:"submitting"});const l=await k(`/api/web/bundle/${e}`,{method:"POST",body:JSON.stringify({...a,tradeAttemptId:r,clientClickToUiMs:Math.round(c-t)}),dedupe:!1});W({component:"post-trade",action:"trade-backend-ack",durationMs:L()-c,requestId:r,resultCount:l.bundle?.successCount||0,details:s}),n.bundleResult=l.bundle,V(s,a.tokenMint,"bundle",{state:"submitted",signature:Me(l.bundle)}),K(Me(l.bundle),`bundle-${e}`,{tradeAttemptId:r}),n.activeTab="bundle",h(),Ce(s,a.tokenMint,"bundle",3e3)}catch(o){a?.tokenMint&&(V(s,a.tokenMint,"bundle",{state:"error",error:N(o.message||"Bundle trade failed")}),Ce(s,a.tokenMint,"bundle",4e3)),W({component:"post-trade",action:"trade-action-error",durationMs:L()-t,requestId:r,errorCode:o?.code||o?.name||"BUNDLE_TRADE_FAILED",details:N(o.message||"Bundle trade failed")}),$s(o.message)}}async function sv(){try{const e=rv();$s("Buying and arming bundle exits...");const t=await k("/api/web/bundle/plan",{method:"POST",body:JSON.stringify(e)});n.bundleResult=t.plan,K(Me(t.plan),"bundle-plan"),n.activeTab="bundle",h()}catch(e){$s(e.message)}}function oe(e,t){return(n.presets?.[e]||[]).find(a=>a.id===t)||null}function Wd(){(n.selectedTradePresetId==="custom"||n.selectedTradePresetId&&!oe("trade",n.selectedTradePresetId))&&(n.selectedTradePresetId=""),(n.selectedBundlePresetId==="custom"||n.selectedBundlePresetId&&!oe("bundle",n.selectedBundlePresetId))&&(n.selectedBundlePresetId=""),n.editingTradePresetId&&!oe("trade",n.editingTradePresetId)&&(n.editingTradePresetId=""),n.editingBundlePresetId&&!oe("bundle",n.editingBundlePresetId)&&(n.editingBundlePresetId="")}function _d(e,t="trade",a=""){t==="bundle"?n.bundleToken=e:n.tradeToken=e,n.activeTab=t,a&&$(a),window.history.pushState({},"","/terminal"),h({force:!0})}async function Nd(e=""){const t=String(e||"").trim();if(!t)return;const a=t.replace(/^\$+/,"").trim(),r=/^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(a),s=(o,c={})=>St(be(o,{source:"global-search",...c}),{defaultTab:"buy",view:"chartTxns",focusAmountInput:!0,source:"global-search"});if(r){s(a);return}try{const c=((await k(`/api/web/token-search?q=${encodeURIComponent(t)}`)).matches||[])[0];if(!c?.tokenMint){$(`No coin found for "${t}". Try the exact ticker or paste the contract address.`);return}s(c.tokenMint,{symbol:c.symbol,name:c.name})}catch(o){$(o.message||"Token search failed.")}}function be(e="",t={}){const a=String(e||"").trim(),r=a?sr().find(s=>String(s?.tokenMint||"")===a):null;return{chain:"solana",tokenMint:a,tokenAddress:a,mint:a,pairAddress:r?.pairAddress||r?.pairId||t.pairAddress||"",symbol:r?.symbol||t.symbol||w(a),name:r?.name||t.name||"Token",imageUri:r?.imageUrl||t.imageUri||"",source:t.source||r?.source||r?.category||"",dex:r?.dexId||t.dex||"",pool:r?.pool||t.pool||"",pumpUrl:r?.pumpUrl||t.pumpUrl||"",isPump:!!(r?.isPump||t.isPump||a.toLowerCase().endsWith("pump")),graduated:!!(r?.graduated||r?.isGraduated||r?.bonded||r?.isBonded||t.graduated||t.isGraduated||t.bonded||t.isBonded),isGraduated:!!(r?.isGraduated||r?.graduated||r?.bonded||r?.isBonded||t.isGraduated||t.graduated||t.bonded||t.isBonded),bonded:!!(r?.bonded||r?.isBonded||r?.graduated||r?.isGraduated||t.bonded||t.isBonded||t.graduated||t.isGraduated),isBonded:!!(r?.isBonded||r?.bonded||r?.graduated||r?.isGraduated||t.isBonded||t.bonded||t.graduated||t.isGraduated)}}function Qk(e={},t={}){return be(e?.tokenMint||e?.mint||e?.tokenAddress||"",{...t,pairAddress:e?.pairAddress||e?.pairId||t.pairAddress||"",symbol:e?.symbol||t.symbol||"",name:e?.name||t.name||"",imageUri:e?.imageUrl||e?.imageUri||t.imageUri||"",source:t.source||e?.source||e?.category||"",dex:e?.dexId||t.dex||"",pool:e?.pool||t.pool||"",pumpUrl:e?.pumpUrl||t.pumpUrl||"",isPump:e?.isPump||t.isPump,graduated:e?.graduated||e?.isGraduated||e?.bonded||e?.isBonded||t.graduated||t.isGraduated||t.bonded||t.isBonded,isGraduated:e?.isGraduated||e?.graduated||e?.bonded||e?.isBonded||t.isGraduated||t.graduated||t.bonded||t.isBonded,bonded:e?.bonded||e?.isBonded||e?.graduated||e?.isGraduated||t.bonded||t.isBonded||t.graduated||t.isGraduated,isBonded:e?.isBonded||e?.bonded||e?.graduated||e?.isGraduated||t.isBonded||t.bonded||t.graduated||t.isGraduated})}function Ts(e={}){const t=String(e.tokenMint||e.mint||e.tokenAddress||"").trim();return t?(n.smartChartTokenRef={...e,tokenMint:t,tokenAddress:t,mint:t},Os(n.smartChartTokenRef),n.terminalToken=t,n.terminalAutoToken=t,n.tradeToken=t,n.bundleToken=t,n.volumeToken=t,n.smartChartToken=t,t):""}function ov(e,t={}){const a=new URLSearchParams;a.set("token",e);const r=t.defaultTab==="sell"?"sell":t.defaultTab==="chart"?"chart":"buy";return a.set("tab",r),["chart","chartTxns","txns","info"].includes(t.view)&&a.set("view",t.view),t.focusAmountInput&&a.set("focusAmount","1"),t.source&&a.set("source",String(t.source).slice(0,40)),t.returnTo&&a.set("returnTo",t.returnTo),`/terminal/chart?${a.toString()}`}function Ki(e={}){const t=String(e?.tokenMint||e?.mint||e?.tokenAddress||"").trim(),a=`${e?.source||""} ${e?.category||""} ${e?.dex||""} ${e?.pool||""}`.toLowerCase(),r=!!(e?.isPump||e?.pumpUrl||t.toLowerCase().endsWith("pump")||a.includes("pump")),s=!!(e?.graduated||e?.isGraduated||e?.bonded||e?.isBonded||e?.complete||e?.completed||e?.bondingComplete||e?.raydiumPool||e?.poolAddress);return!!(r&&!s)}function iv(e={},t={}){return["chart","chartTxns","txns","info"].includes(t.view)?t.view:"chartTxns"}const As=new Map;function Vi(e){const t=String(e||"").trim();if(!t)return;const a=As.get(t)||0;Date.now()-a<3e4||(As.set(t,Date.now()),As.size>200&&As.clear(),k(`/api/web/prebuy-warm?mint=${encodeURIComponent(t)}`,{method:"GET"}).catch(()=>{}))}function St(e={},t={}){ra("chartRouteStart");const a=L(),r=Ts(e);if(!r){$("Select a token before opening the chart.");return}Zi(e,{source:t.source||"token-entry"}),Vi(r),n.chartTradeTab=t.defaultTab==="sell"?"sell":(t.defaultTab==="chart","buy"),n.smartChartView=iv(n.smartChartTokenRef||e,t),n.chartFocusAmountInput=!!t.focusAmountInput,n.chartScrollIntoView=!0,n.activeTab="smartChart",n.route="terminal",n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},n.chartTradeStatus="",n.chartBuyWalletIndex="";const s=ov(r,{defaultTab:t.defaultTab||"buy",view:n.smartChartView,focusAmountInput:t.focusAmountInput,source:t.source||"token-entry",returnTo:t.returnTo||ja()});window.history.pushState({},"",s),h({force:!0}),H("chart-route-open",a,{component:"smartChart",cacheHit:!!(Ye(r)?.cacheHit||lr(r)?.pairAddress),details:`${r}:${t.source||"token-entry"}`})}function zi(){if(!window.location.pathname.includes("/terminal/chart"))return;ra("chartRouteStart");const e=L(),t=new URLSearchParams(window.location.search||""),a=String(t.get("token")||t.get("mint")||"").trim(),r=String(n.smartChartToken||"").trim();if(a){const s=be(a,{source:t.get("source")||"route"});Ts(s),Zi(s,{source:t.get("source")||"route"}),t.get("buy")==="1"&&window.setTimeout(()=>{try{ln(s,{forceModal:!0,source:"deep-link"})}catch{}},900),a!==r&&(n.chartTradeStatus="",n.chartBuyWalletIndex="")}n.chartTradeTab=t.get("tab")==="sell"?"sell":"buy",n.smartChartView=["chart","chartTxns","txns","info"].includes(t.get("view"))?t.get("view"):"chartTxns",n.chartFocusAmountInput=t.get("focusAmount")==="1",n.chartScrollIntoView=!0,n.route="terminal",n.activeTab="smartChart",H("chart-route-apply",e,{component:"smartChart",cacheHit:!!(Ye(a)?.cacheHit||lr(a)?.pairAddress),details:a})}function ln(e={},t={}){const a=Ts(e);if(!a){$("Select a token before quick buying.");return}const r=cn(a);if(r&&Rs(r)){$("Safety block: this token has mintable/freezable/honeypot-style risk signals and cannot be quick bought.");return}const s=t.preset||ct(),o=s&&!t.forceModal?He(s):"",c=s?.walletIndex||(s?.walletIndexes||[])[0]||(n.wallets[0]?.index?String(n.wallets[0].index):"");if(s&&o&&c&&!t.forceModal){Ls(a,{...s,walletIndex:c,walletIndexes:[c]});return}const l=ce();n.quickBuyModal={open:!0,tokenMint:a,amountSol:o||n.quickBuyAmountOverride||"",walletIndex:l?.publicKey?"connected":n.wallets[0]?.index?String(n.wallets[0].index):"",slippageBps:"400",status:o?`Preset ${o} SOL loaded. Confirm when ready.`:s?"Your selected preset has no SOL amount - set one here (or edit the preset in the Trade tab) and Buy becomes one-click.":"Enter a SOL amount to quick buy - or save a Trade preset and Buy becomes one-click.",source:t.source||"quick-buy",error:"",tradeAttemptId:""},Vi(a),h({force:!0}),requestAnimationFrame(()=>m("[data-quick-buy-modal-amount]")?.focus())}function ji(){n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},h({force:!0})}function lv(e={},t={}){if(!D("protectedBuyEnabled",!0))return;const a=Ts(e);if(!a){$("Select a token before opening Protected Buy.");return}const r=cn(a);if(r&&Rs(r)){$("Safety block: this token has mintable/freezable/honeypot-style risk signals and cannot be bought from quick actions.");return}const s=Sa(a)||{tokenMint:a},o=Qe(s),c=t.presetId||o.protectedBuyPreset||nl(o.verdict),l=Number(X(t.amountSol||n.quickBuyAmountOverride||He()||"0.1")),u=c==="conservative"&&Number.isFinite(l)&&l>.25?"0.25":dr(l||.1),d=ce();Vi(a),n.quickBuyModal={...n.quickBuyModal,open:!1,status:"",error:""},n.protectedBuyModal={open:!0,tokenMint:a,presetId:c,amountSol:u,walletIndex:t.walletIndex||(d?.publicKey?"connected":n.wallets[0]?.index?String(n.wallets[0].index):""),slippageBps:String(t.slippageBps||"400"),riskAccepted:!1,status:o.verdict==="AVOID"?"Avoid recommended. Check the risk box if you still want to continue.":"Review this plan before wallet confirmation.",error:"",source:t.source||"protected-buy"},h({force:!0}),requestAnimationFrame(()=>m("[data-protected-buy-amount]")?.focus())}function Ps(){n.protectedBuyModal={...n.protectedBuyModal,open:!1,status:"",error:"",riskAccepted:!1},h({force:!0})}function cv(){const e=n.protectedBuyModal||{},t=String(e.tokenMint||"").trim(),a=String(m("[data-protected-buy-preset]")?.value||e.presetId||"conservative").trim(),r=String(m("[data-protected-buy-wallet]")?.value||e.walletIndex||"").trim(),s=X(m("[data-protected-buy-amount]")?.value||e.amountSol||""),o=String(m("[data-protected-buy-slippage]")?.value||e.slippageBps||"400").trim(),c=!!(m("[data-protected-buy-risk-accept]")?.checked||e.riskAccepted);if(!t)throw new Error("Select a token before Protected Buy.");if(!r)throw new Error("Choose a wallet before Protected Buy.");if(!s)throw new Error("Enter a SOL amount greater than zero.");return{tokenMint:t,presetId:a,walletIndex:r,amountSol:s,slippageBps:o,riskAccepted:c}}function uv(){const e=n.protectedBuyModal||{};if(!e.open)return"";const t=Sa(e.tokenMint)||{tokenMint:e.tokenMint},a=Qe(t),r=_s(e.presetId),s=ue(e.walletIndex),o=a.verdict==="AVOID"&&!e.riskAccepted,c=/submitting|opening wallet/i.test(String(e.status||""));return`
    ...
    <section class="protected-buy-modal" role="dialog" aria-modal="true" aria-label="Protected Buy preview">
      ...
      <article class="protected-buy-preview">
        ...
        <small>${i(cw(r))}</small>
        <small>Wallet: ${i(dw(e.walletIndex))}</small>
  ...
  `}function Av(){const e=Vu();if(!e.length)return"";const t=e.length;return`
  ...
  `},{key:"fund",label:"Fund / Sweep",hint:"Move SOL",html:`${Sb()}${Av()}${wb()}${Tv()}`},{key:"create",label:"Create",hint:"New wallets",html:Jr()},{key:"import",label:"Import",hint:"Add keys",html:Au()},{key:"backup",label:"Backup",hint:"Save / restore",html:Tu()},{key:"downloads",label:"Downloads",hint:"Exports",html:Pu()}];if(!n.wallets.length){const r=a.filter(s=>s.key!=="balances"&&s.key!=="fund");return`
      ${e}
  ...
  `}function Lv(){return(Array.isArray(n.wallets)?n.wallets:[]).find(t=>t?.sessionWallet&&t?.sessionStatus==="funded")||null}function xv(){if(!(n.connectedWalletBalance||n.user?.connectedWallet||null)?.publicKey)return"";const t=Lv();return t?`
  ...
  `}function Bv(e){const t=n.balances.find(o=>Number(o.index)===Number(e.index));if(!t)return"<span>Balance: loading</span>";if(t.error)return`<span>Balance check failed: ${i(t.error)}</span>`;const a=Number.isFinite(Number(t.sol))?`${Number(t.sol).toFixed(4)} SOL`:"SOL unavailable",r=Number(t.tokens?.length||0)===1?"1 token":`${Number(t.tokens?.length||0)} tokens`,s=t.warnings?.length?` | ${t.warnings.length} warning(s)`:"";return`<span>Balance: ${i(a)} | ${i(r)}${i(s)}</span>`}function Rv(){const e=rt(),t=`
    <section class="account-check-card">
      <div>
  ...
  `}async function Ov(e){const t=String(e||"").trim();if(!t)return;n.devWatch||(n.devWatch={});const a=!n.devWatch[t];try{const r=await k("/api/web/dev-watch",{method:"POST",body:JSON.stringify({wallet:t,watch:a}),timeoutMs:15e3});n.devWatch[t]=!!r.watching}catch(r){$(r?.message||"Could not update dev watch.")}ka()}async function Ev(e,t=null){const a=String(e||"").trim();if(!a)return;const r=ct();t&&(t.disabled=!0,t.textContent="Arming...");try{const s=await k("/api/web/positions/arm-exits",{method:"POST",body:JSON.stringify({tokenMint:a,takeProfitPct:r?.takeProfitPct||"40",stopLossPct:r?.stopLossPct||"8",sellDelay:r?.sellDelay||"off",sellPercent:r?.sellPercent||"100",slippageBps:r?.slippageBps||"1000"}),timeoutMs:2e4});pd(a),n.walletRemoveStatus=s.message||"Exits armed.",t&&(t.textContent="✅ Armed"),md().then(()=>h())}catch(s){$(s?.message||"Could not arm exits."),t&&(t.disabled=!1,t.textContent="Arm Exits")}}async function Fv(){n.bagScan={status:"loading"},h();try{const e=await k("/api/web/shield/scan-bags",{timeoutMs:3e4});n.bagScan={status:"done",bags:e.bags||[]}}catch(e){n.bagScan={status:"error",message:e?.message||""}}h()}function Wv(){const e=`
    <section class="account-check-card">
      <div>
        <h3>PnL / Results</h3>
  ...
  `}function tw(e={}){return D("slimeShieldEnabled",!0)?`SlimeShield ${Qe(e).verdict||"CAUTION"}`:e.bestPickScore?`Score ${e.bestPickScore}/100`:e.valueLabel||e.smartMoney||""}function aw(e={}){const t=Number(e.bestPickScore||e.score||0),a=e.scoreWarnings||e.bestPickWarnings||[],r=t?`${t}/100`:"n/a";return`
    <span class="score-badge" title="${i(tl(e))}">
      <strong>${i(r)}</strong>
      <small>${a.length?"warnings":"best pick"}</small>
    </span>
  `}function nw(e={}){return Zv(e,{compact:!0})}function tl(e={}){const t=e.scoreBreakdown||e.bestPickInputs||{},a=Object.entries(t).map(([s,o])=>`${s}: ${o}`),r=e.scoreWarnings||e.bestPickWarnings||[];return[...a,...r.map(s=>`warning: ${s}`)].join(" | ")||"Score uses available liquidity, volume, age, momentum, buys/sells, KOL, and risk signals."}function rw(e={}){return""}function B(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"n/a":t>=1e6?`$${(t/1e6).toFixed(t>=1e7?0:1)}M`:t>=1e3?`$${(t/1e3).toFixed(t>=1e5?0:1)}K`:`$${Math.round(t)}`}function _(...e){for(const t of e){const a=String(t??"").trim();if(a&&a!=="$0"&&a.toLowerCase()!=="n/a")return a}return"n/a"}function ip(e={}){return[["15m",_(e.volumeM15Label,B(e.volumeM15))],["30m",_(e.volumeM30Label,B(e.volumeM30))],["1h",_(e.volumeH1Label,e.volumeLabel,B(e.volumeH1))],["24h",_(e.volumeH24Label,B(e.volumeH24))]]}function r0(e={}){const t=dt(e),a=pt(e),r=_(e.marketCapLabel,e.fdvLabel,t>0?B(t):"","checking"),s=_(e.liquidityLabel,a>0?B(a):"","checking"),o=ip(e);return`
    <div class="compact-stat-grid">
      <span>MC <b>${i(r)}</b></span>
      <span>Liq <b>${i(s)}</b></span>
      ${o.map(([c,l])=>`<span>${i(c)} <b>${i(l)}</b></span>`).join("")}
    </div>
  `}function sw(e={}){const t=dt(e),a=pt(e),r=_(e.marketCapLabel,e.fdvLabel,t>0?B(t):"","checking"),s=_(e.liquidityLabel,a>0?B(a):"","checking"),o=_(e.volumeM15Label,B(e.volumeM15)),c=_(e.volumeH1Label,e.volumeLabel,B(e.volumeH1));return`
  ...
  `}function dp(e,{source:t,actionLabel:a="Trade",isKolContext:r=!1}={}){const s=Ys(e.tokenMint);return`
    ...
    ${op(e,{compact:!0})}
  `}function ow(e,t={}){const a=t.limit||6,r=t.actionLabel||"Trade",s=t.emptyTitle||"No signals loaded",o=t.emptyMessage||"Refresh the feed to load current signals.",c=va(e||[],a,t.rotateKey||"",t.stickyCount||0),l=t.context==="kol",u=t.cooksStyle?" is-cooks":"";return c.length?`
  ...
  `:F(s,o)}function kt(e,t={}){if(t.layout==="terminal")return ow(e,t);const a=t.limit||6,r=t.actionLabel||"Trade",s=t.emptyTitle||"No signals loaded",o=t.emptyMessage||"Refresh the feed to load current signals.",c=va(e||[],a,t.rotateKey||"",t.stickyCount||0),l=t.context==="kol";return c.length?`
  ...
  `}function mp(){Or&&window.clearTimeout(Or),Or=window.setTimeout(()=>{Or=null,Z("live"),Z("launch"),Z("sniper"),h()},180)}function Us(e={}){const t=Number(e.pairCreatedAt||e.createdAt||0);if(t>0){const s=t<1e10?t*1e3:t;return Math.max(0,Math.round((Date.now()-s)/1e3))}const a=["source-age","trusted-source-age"].includes(String(e.pairAgeSource||"").toLowerCase()),r=Number(e.pairAgeSeconds);return a&&Number.isFinite(r)&&r>=0?r:Number.POSITIVE_INFINITY}const hw=100,gw=7200,bw=75e4,yw=86400,vw=2e6,ww=28e3,fp=18e4,Sw=16e4;function hp(){const e=ap();return ye([...n.livePairs?.rows||[],...n.livePairsByBucket.live?.rows||[],...n.livePairsByBucket.under1h?.rows||[],...n.livePairsByBucket.under3h?.rows||[],...n.livePairsByBucket.under1d?.rows||[],...n.scan?.rows||[],...n.kolScan?.rows||[]]).map(t=>rp(t,e.get(String(t?.tokenMint||"")))).filter(t=>t?.tokenMint&&!ir(t))}function hn(e={}){return O(e.marketCap,e.fdv)}function gp(e={}){return O(e.liquidityUsd)}function bp(e={}){return O(e.volumeM5,e.volume5m,e.volumeM15,e.volumeM30,e.volumeH1,e.volumeH24,e.volumeUsd)}function ol(e={}){if(gn(e))return!1;const t=Us(e);return!Number.isFinite(t)||t<0||t>gw||hn(e)>bw?!1:qt(e)<70}function qs(e={}){if(gn(e))return!1;const t=qt(e),a=hn(e),r=a>=ww&&a<=fp;return t>=55&&(!a||a<=fp)||r}function yp(e={}){if(ol(e)||qs(e)||gn(e))return!1;const t=Us(e);return Number.isFinite(t)&&(t<0||t>yw)||hn(e)>vw?!1:gp(e)>0||bp(e)>0||Number(e.bestPickScore||e.score||0)>0||Array.isArray(e.reasons)&&e.reasons.length>0}function vp(e={}){return[e.tokenMint,e.symbol,e.name,e.source,e.category,e.dexId,e.dexName,e.poolType,e.platform,e.raydiumPool,e.pairUrl,...e.riskFlags||[],...e.reasons||[]].filter(Boolean).join(" ").toLowerCase()}function qt(e={}){const t=O(e.bondingProgressPct,e.bondingProgress,e.bonding_curve_progress,e.bondingCurveProgress,e.pumpProgress,e.graduationProgress,e.completion,e.completePct);if(t>0)return t<=1?t*100:t;const a=hn(e),r=vp(e);return(!!e.isPump||r.includes("pump")||String(e.tokenMint||"").toLowerCase().endsWith("pump"))&&a>0?Math.max(1,Math.min(99,a/69e3*100)):0}function gn(e={}){if(e.isGraduated||e.graduated||e.bonded||e.isBonded||e.complete||e.completed||e.bondingComplete||e.raydiumPool||e.raydium_pool||e.poolAddress)return!0;const t=vp(e);if(/\b(graduated|bonded|bonding complete|complete)\b/.test(t))return!0;const a=!!e.isPump||t.includes("pump")||String(e.tokenMint||"").toLowerCase().endsWith("pump"),r=hn(e);return a&&r>=Sw?!0:!!(a&&/\b(raydium|meteora|orca)\b/.test(t))}function Hs(e={}){if(gn(e))return"graduated";const t=String(e.slimeScopeCategory||"").trim().toLowerCase();return t==="graduated"?"graduated":qs(e)||t==="graduating"?"graduating":ol(e)?"new":(t==="steady"||t==="unknown"||yp(e),"steady")}function wp(e={}){const t=Number(e.bestPickScore||e.score||0),a=bp(e),r=gp(e),s=hn(e),o=Us(e),c=Number.isFinite(o)?Math.max(0,86400-o)/86400:0;return t*1e3+Math.log10(a+1)*160+Math.log10(r+1)*120+Math.log10(s+1)*80+c*100}function Sp(e=[]){return[...e].sort((t,a)=>wp(a)-wp(t)||Ze(t,a))}function kw(e=[],t=[],a=hw){const r=new Set,s=[];for(const o of[...e,...t]){const c=String(o?.tokenMint||"");if(!(!c||r.has(c))&&(r.add(c),s.push(o),s.length>=a))break}return s}function kp(e=n.slimeScopeMode){const t=hp(),a=e==="graduated"?"graduated":e==="graduating"?"graduating":e==="steady"?"steady":"new",r=t.filter(l=>Hs(l)===a),s=t.filter(l=>{const u=Hs(l);return a==="graduated"?u==="graduated"||gn(l):a==="graduating"?u==="graduating"||qs(l):a==="steady"?u==="steady"||yp(l):u==="new"||ol(l)}),o=a==="new"?[...r].sort(Ze):Sp(r),c=a==="new"?ye(s).sort(Ze):Sp(s);return kw(o,c)}function $w(e=[],t="new"){const a=nt(`slimeScope:${t}`,e).slice(0,12);return a.length?a.map((r,s)=>{const o=r.pairAgeLabel||Kt(r)||"age ?",c=_(r.marketCapLabel,r.fdvLabel,B(dt(r)),"checking"),l=_(r.liquidityLabel,B(pt(r)),"checking"),u=_(r.volumeM15Label,B(wl(r)),"checking");return`
    ...
    `}).join(""):`<div class="slime-scope-column-empty">Warming up ${i(t)} pairs.</div>`}function Tw(){return`
  ...
  `}function Aw(){const e=yl(),[,,t]=e,a=Hc(n.slimeScopeMode),s=!!(z("slimeScope").inFlight||n.livePairsLoadingByBucket?.[a]),o=n.livePairsRefreshErrorByBucket?.[a],c=ye(Kp(hp(),e[0])),l=nt("slimeScope",c),u=l.length?Xn()?ut(l,{context:"live",shareBuilder:Aa,hideToolbar:!0}):kt(l,{layout:"terminal",limit:Math.max(1,l.length),actionLabel:"Trade"}):o?F("Unable to load pairs. Try refreshing.","Cook Spot hit a snag — it keeps retrying, or tap Refresh Scope."):s?F("Loading Cook Spot…","Scanning DEX, boosted, and pump pairs for this category."):F("No pairs found for this filter yet","Try another category — Cook Spot keeps scanning in the background.");return`
    <section class="slime-scope-page">
      <div class="command-controls slime-scope-controls">
        <div class="cooks-category-label cook-spot-head">${rS(e)}<span>${i(t)}</span></div>
        ${Vp(c.length,ca())}
        ${Yu("slime-scope")}
        ...
        <div class="command-controls">
          ...
          <label>
            ...
            <select data-terminal-sort>
              ${hf.map(([C,M])=>`<option value="${C}" ${n.terminalSort===C?"selected":""}>${M}</option>`).join("")}
            </select>
          </label>
          ${Yu("terminal-top")}
  ...
  `}function i0(){const e=ct();if(!e)return"Trade";const t=He(e);return t?`Buy ${t} SOL`:Im(e,"Trade")}function wa(){const e=ct(),t=He(e);return t?`Buy ${t} SOL`:"Quick Buy"}function Ks(){const e=wa();document.querySelectorAll("[data-quick-buy-token]").forEach(t=>{v(t,e)})}function Sa(e=""){const t=String(e||"").trim();if(!t)return null;const a=or().find(s=>String(s?.tokenMint||s?.mint||s?.tokenAddress||"").trim()===t);if(a)return a;const r=n.smartChartTokenRef||{};return String(r.tokenMint||r.mint||"").trim()===t?r:{tokenMint:t,shortMint:w(t),symbol:w(t),dexUrl:Q(t)}}function Pw(e=""){return{normal_buy:"Normal buy size can be considered",small_buy:"Trade small or use protection",watch_only:"Watch-only unless you accept high risk",avoid:"Avoid recommended"}[e]||"Review risk before buying"}function Cw(e=""){return{conservative:"Conservative",scalp:"Scalp",degen:"Degen"}[e]||"Conservative"}function $p(e={}){if(!D("slimeShieldEnabled",!0))return"";const t=Qe(e),a=String(e.tokenMint||t.mint||"").trim(),r=t.verdict||"CAUTION";return`
  ...
  `:`<p class="slimeshield-muted">${i(t)}</p>`}function Gs(e,t="Not cached yet"){const a=String(e||"").trim();return!a||a.toLowerCase()==="warming"||a.toLowerCase()==="checking"?t:a}function Xs(e,t=r=>String(r),a="Not cached yet"){return Number.isFinite(e)&&e>0?t(e):a}function fr(e,t,a=""){if(e.__lastDrawerHtml===t)return!1;const r=a?e.querySelector(a):null,s=r?r.scrollTop:0;if(e.innerHTML=t,e.__lastDrawerHtml=t,a&&s){const o=e.querySelector(a);o&&(o.scrollTop=s)}return!0}function ka(){let e=document.querySelector("[data-dev-info-drawer-root]");e||(e=document.createElement("div"),e.dataset.devInfoDrawerRoot="true",document.body.appendChild(e));const t=n.devInfoDetails||{},a=!!(t.open&&t.tokenMint);if(document.body.classList.toggle("dev-info-drawer-open",a),!a||!D("devInfoEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=String(t.tokenMint||"").trim(),s=Sa(r)||cn(r)||{tokenMint:r},o=Pp(r),c=n.devInfoSummaries?.[r]||ur(s),l=ga(o.status||c.status),u=o.confidence||c.confidence||"unknown",d=!!n.devInfoLoading?.[`details:${r}`],p=o.likelyDevWallet||c.likelyDevWallet||"",f=o.currentPosition||null,y=o.historicalStats||{},g=o.linkedWalletSignals||{},S=o.marketContext||{},A=o.sourceHydration||{},T=Array.isArray(o.sourceEvidence)?o.sourceEvidence.slice(0,8):[],b=O(S.marketCap,s.marketCap,s.fdv),P=O(S.liquidityUsd,s.liquidityUsd),C=O(S.volume5m,s.volume5m,s.volumeM5),M=O(S.volumeH1,s.volumeH1,s.volume1h),q=O(S.pairAgeMinutes,s.pairAgeMinutes,Number(s.pairAgeSeconds)/60),J=S.metadataAuthority||s.metadataAuthority||s.updateAuthority||"",ke=S.mintAuthority||s.mintAuthority||"",et=S.freezeAuthority||s.freezeAuthority||"",U=!!(S.heliusDasIndexedAt||S.heliusDasSource||s.heliusDasSource||J||ke||et),_e=[...Array.isArray(o.externalLinks)?o.externalLinks:[],...Array.isArray(c.externalLinks)?c.externalLinks:[],{label:"Solscan Token",url:r?`https://solscan.io/token/${encodeURIComponent(r)}`:""},{label:"Dex",url:s.dexUrl||Q(r)},{label:"Solscan Wallet",url:p?`https://solscan.io/account/${encodeURIComponent(p)}`:""},{label:"KOLscan Wallet",url:p?`https://kolscan.io/account/${encodeURIComponent(p)}`:""},{label:"Bubblemap",url:r?`https://app.bubblemaps.io/sol/token/${encodeURIComponent(r)}`:""},{label:"X",url:s.twitterUrl||s.xUrl},{label:"TG",url:s.telegramUrl},{label:"Website",url:s.websiteUrl}].filter((pe,bo,yo)=>/^https?:\/\//i.test(String(pe.url||""))&&yo.findIndex(wn=>String(wn.url||"")===String(pe.url||""))===bo).slice(0,8),Xt=Array.isArray(y.recentLaunches)?y.recentLaunches.slice(0,5):[],Ct=`
    ...
    <aside class="dev-info-drawer" role="dialog" aria-modal="true" aria-label="Dev Info details">
      ...
      <section>
        ...
        <dl class="kol-dump-metrics">
          <div><dt>Wallet</dt><dd>${i(xw(p))}</dd></div>
  ...
  `;fr(e,Ct,".dev-info-drawer")}function Mp(e=""){return{mint:e,sampleSize:0,confidence:"low",matchedTraits:[],winRatePercent:null,medianMaxUpsidePercent:null,medianMaxDrawdownPercent:null,failRatePercent:null,bestExitPattern:"",summary:"Not enough local history yet. Replay improves as SlimeWire tracks more launches.",updatedAt:new Date().toISOString()}}function cl(e=""){const t=String(e||"").trim();return n.replayResults?.[t]||Mp(t)}function bn(e,t="%"){return Number.isFinite(Number(e))?`${Math.round(Number(e))}${t}`:"n/a"}function Iw(e=""){if(!D("replayBeforeBuyEnabled",!0))return"";const t=String(e||"").trim();if(!t)return"";const a=cl(t);return`
  ...
  `;fr(e,c,".replay-drawer")}function $a(){let e=document.querySelector("[data-slimeshield-drawer-root]");e||(e=document.createElement("div"),e.dataset.slimeshieldDrawerRoot="true",document.body.appendChild(e));const t=n.slimeShieldDetails||{},a=!!(t.open&&t.tokenMint);if(document.body.classList.toggle("slimeshield-drawer-open",a),!a||!D("slimeShieldEnabled",!0)){e.innerHTML="",e.__lastDrawerHtml="";return}const r=String(t.tokenMint||"").trim(),s=Sa(r)||{tokenMint:r},o=n.slimeShieldResults?.[r]||Qe(s),c=o.verdict||"CAUTION",l=o.sourceHydration||{},u=o.marketContext||{},d=Array.isArray(o.sourceEvidence)?o.sourceEvidence.slice(0,6):[],p=!!n.slimeShieldLoading?.[r],f=Array.isArray(o.factors)?o.factors:[],y=O(u.marketCap,s.marketCap,s.fdv),g=O(u.liquidityUsd,s.liquidityUsd),S=O(u.volumeH1,s.volumeH1,s.volume1h),A=O(u.pairAgeMinutes,s.pairAgeMinutes,Number(s.pairAgeSeconds)/60),T=u.metadataAuthority||s.metadataAuthority||s.updateAuthority||"",b=u.mintAuthority||s.mintAuthority||"",P=u.freezeAuthority||s.freezeAuthority||"",C=!!(u.heliusDasIndexedAt||u.heliusDasSource||s.heliusDasSource||T||b||P),M=o.devInfoSummary||ur(s),q=ga(M.status),J=[...Array.isArray(o.externalLinks)?o.externalLinks:[],{label:"Solscan",url:r?`https://solscan.io/token/${encodeURIComponent(r)}`:""},{label:"Dex",url:u.dexUrl||s.dexUrl||Q(r)},{label:"Pump",url:u.pumpUrl||dn(s)},{label:"X",url:u.twitterUrl||s.twitterUrl||s.xUrl},{label:"TG",url:u.telegramUrl||s.telegramUrl},{label:"Web",url:u.websiteUrl||s.websiteUrl}].filter((U,_e,Xt)=>/^https?:\/\//i.test(String(U.url||""))&&Xt.findIndex(Ct=>String(Ct.url||"")===String(U.url||""))===_e),ke=[...Array.isArray(s.riskFlags)?s.riskFlags:[],...Array.isArray(s.scoreWarnings)?s.scoreWarnings:[],...Array.isArray(s.bestPickWarnings)?s.bestPickWarnings:[]].filter(Boolean).slice(0,4),et=`
    ...
    <aside class="slimeshield-drawer" role="dialog" aria-modal="true" aria-label="SlimeShield details">
      ...
      <section class="slimeshield-action-note">
        <h4>Suggested Action</h4>
        <p>${i(Pw(o.suggestedAction))}</p>
        <small>Protected Buy preset suggestion: ${i(Cw(o.protectedBuyPreset))}</small>
      </section>
      ${Iw(r)}
      <div class="slimeshield-drawer-actions">
  ...
  `}function Ew(e=""){const t=String(e||"").trim();return t?(n.pnl?.trades||[]).filter(a=>String(a?.tokenMint||a?.mint||"").trim()===t):[]}function u0(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=Ew(a),s=!!(dn(e)&&Ki(e)),o=s?dn(e):e.dexUrl||Q(Gd(e)||a),c=s?"Pump":"DEX";return`
  ...
  `}function d0(e={},t=null){const a=String(e?.tokenMint||n.smartChartToken||"").trim(),r=Rm(e||{});return`
  ...
  `}function _w(){try{return Nw()}catch(e){console.error("Smart Chart render failed:",e);const t=String(n.smartChartToken||n.tradeToken||n.terminalToken||"").trim(),a=t?w(t):"No token selected",r=t?`https://dexscreener.com/solana/${encodeURIComponent(t)}?embed=1&theme=dark&trades=1&info=0`:"";return`
    ...
    `}}function Nw(){const e=Is(),t=String(e?.tokenMint||"").trim(),a=t?rt().find(o=>String(o.tokenMint)===t):null,r=t?ye([e,...sr().filter(o=>String(o.tokenMint||"")===t)]).filter(Boolean).slice(0,5):va(cr(),5,ya("smart-chart-suggest"),1);if(!t)return`
    ...
    <section class="smart-chart-terminal smart-chart-clean-terminal">
      ...
      <div class="smart-chart-grid smart-chart-clean-grid">
        <article class="terminal-panel smart-chart-main smart-chart-clean-main">
          ${(()=>{Dw(t);const o=Bp(t);return o?`<div class="coin-banner-hero" style="background-image:url('${o}')" role="img" aria-label="Coin banner"></div>`:""})()}
  ...
  `}function Bp(e){const t=String(e||"").trim();return n.coinBanners&&n.coinBanners[t]||""}let Rp="";function Dw(e){const t=String(e||"").trim();!t||Rp===t||(Rp=t,k(`/api/web/coin-banner?mint=${encodeURIComponent(t)}`).then(a=>{const r=String(a?.bannerUri||"");r&&(n.coinBanners=n.coinBanners||{},n.coinBanners[t]=st(r),n.activeTab==="smartChart"&&h({preserveSmartChartFrame:!0}))}).catch(()=>{}))}let ml="",Ip=0;function Op(e){e&&(ml===e&&Date.now()-Ip<3e4||(ml=e,Ip=Date.now(),k(`/api/web/calls?mint=${encodeURIComponent(e)}`).then(t=>{n.chartCalls={mint:e,...t},n.activeTab==="smartChart"&&h({preserveSmartChartFrame:!0})}).catch(()=>{})))}function Uw(e){const t={bullish:["🟢","BULLISH"],bearish:["🔴","BEARISH"],warning:["⚠️","WARNING"],question:["❓","QUESTION"]},[a,r]=t[e]||["⚪",String(e||"").toUpperCase()];return`${a} ${r}`}function qw(e){Op(e);const t=n.chartCalls?.mint===e?n.chartCalls:null,a=t?.calls||[],r=!!(n.token&&n.user);return`
      ...
      ${a.length?`
        <div class="table-list compact-table">
          ${a.map(s=>`
            <article class="row-card">
              <div class="row-main">
                <strong>${i(Uw(s.side))} <span class="muted-text">by ${i(s.handle)}</span>
  ...
  `:F("No live trade history yet","Submitted web trades will appear here after refresh.")}function Xw(){const e=n.pnl?.trades||[],t=nt("liveTrades",e);return`
  ...
  `}function Np(e=!1){const t=n.terminalTxAudit;return`
    <section class="${e?"tx-audit compact":"terminal-layout tx-audit"}">
      <main class="terminal-main">
        ...
        ${t?Yw(t):F("No transaction loaded","Use this when a wallet balance looks stale or a trade needs accounting review.")}
      </main>
      ${e?"":`<aside class="trade-side order-ticket-stack">${Wp()}${_p()}</aside>`}
    </section>
  `}function Yw(e){return e.error?`<article class="row-card"><strong>Audit failed</strong><span>${i(e.error)}</span></article>`:`
...
`)||"No logs returned.")}</pre>
  ...
  `}function Qw(e=[]){const t=[...e].sort((a,r)=>Number(r.bestPickScore||r.score||0)-Number(a.bestPickScore||a.score||0)||Ze(a,r));return va(t,5,ya("cooks-best"),1)}function Ae(e){const t=Number(e);return Number.isFinite(t)?t:0}function Dp(){const e=n.liveFeedCategory||"best";return Do.find(([t])=>t===e)||Do[0]}function Ta(e={}){return Zs(e)||jp(e)||wl(e)||0}function hl(e={}){return Ae(e.buys5m)+Ae(e.buysH1)+Ae(e.sells5m)+Ae(e.sellsH1)}function Up(e={}){const t=Ae(e.buys5m)+Ae(e.buysH1),a=Ae(e.sells5m)+Ae(e.sellsH1),r=t+a;return r>0?t/r:.5}function gr(e={}){return Math.max(Ae(e.m5),Ae(e.h1),Ae(e.h24))}function Js(e={}){return Math.max(Ae(e.m5),Ae(e.h1))}function Ht(e={}){return Js(e)*Math.log10(10+Ta(e))*(.5+Up(e))}function gl(e={}){return e.boosted||e.isBoosted||e.boost||e.boosts?!0:`${e.source||""} ${e.category||""} ${e.liveLabel||""} ${e.sourceLabel||""}`.toLowerCase().includes("boost")}function Zw(e=[],t="best"){const a=[...e];switch(t){case"volume":return a.sort((r,s)=>Ta(s)-Ta(r));case"liquidity":return a.sort((r,s)=>pt(s)-pt(r));case"marketcap":return a.sort((r,s)=>dt(s)-dt(r));case"active":return a.sort((r,s)=>hl(s)-hl(r));case"fresh":return a.sort(Ze);case"gainers":return a.sort((r,s)=>gr(s)-gr(r));default:return a.sort((r,s)=>Ae(s.bestPickScore||s.score)-Ae(r.bestPickScore||r.score)||Ze(r,s))}}function qp(){const e=n.liveTerminalCategory||"dexTrending";return Ha.find(([t])=>t===e)||Ha[0]}function eS(e,t,a,r){return`
    ...
    </label>`}function tS(){if(n.activeTab==="terminal"){const t=qp();return{categories:Ha,activeId:t[0],sub:t[2],attr:"data-live-terminal-category",cap:"Discover",rank:a=>Kp(a,t[0]),hasBest:!1}}const e=Dp();return{categories:Do,activeId:e[0],sub:e[2],attr:"data-live-feed-category",cap:"Feed",rank:t=>Zw(t,e[0]),hasBest:e[0]==="best"}}function aS(e={}){if(gl(e))return{cls:"boost",text:"⚡ Boosted"};const t=gr(e);if(t>=40)return{cls:"gain",text:`▲ ${Math.round(t)}%`};const a=Number(e.pairAgeMinutes);return Number.isFinite(a)&&a>=0&&a<=10?{cls:"fresh",text:"✨ Fresh"}:Js(e)>=25?{cls:"hot",text:"🔥 Hot"}:Up(e)>=.7&&hl(e)>=24?{cls:"active",text:"● Active"}:null}function bl(e={}){const t=aS(e);return t?`<span class="signal-badge signal-badge-${t.cls}">${i(t.text)}</span>`:""}function Hp(e={}){return e.isPump||e.pump||e.pumpFun||e.pumpUrl?!0:`${e.source||""} ${e.category||""} ${e.dexId||""} ${e.dexName||""}`.toLowerCase().includes("pump")}function nS(e={}){const t=`${e.name||""} ${e.symbol||""} ${e.category||""}`.toLowerCase();return Hp(e)||/meme|dog|cat|pepe|wif|inu|elon|moon|bonk|frog|chad/.test(t)}function yl(){const e=n.cookSpotCategory||"dexTrending";return Ha.find(([t])=>t===e)||Ha[0]}function Kp(e=[],t="dexTrending"){const a=[...e];switch(t){case"fresh":return a.sort(Ze);case"dexBoosted":{const r=a.filter(gl).sort((o,c)=>Ta(c)-Ta(o)),s=a.filter(o=>!gl(o)).sort((o,c)=>Ht(c)-Ht(o));return[...r,...s]}case"pumpTrending":{const r=a.filter(Hp);return(r.length?r:a).sort((s,o)=>Ht(o)-Ht(s))}case"memeMovers":{const r=a.filter(nS);return(r.length?r:a).sort((s,o)=>gr(o)-gr(s))}case"earlyMomentum":{const r=a.filter(s=>{const o=Number(s.pairAgeMinutes);return!Number.isFinite(o)||o<=180});return(r.length?r:a).sort((s,o)=>Js(o)-Js(s))}case"graduating":{const r=a.filter(s=>qs(s)||Hs(s)==="graduating");return(r.length?r:a).sort((s,o)=>Ht(o)-Ht(s))}case"graduated":{const r=a.filter(s=>gn(s)||Hs(s)==="graduated");return(r.length?r:a).sort((s,o)=>Ta(o)-Ta(s))}default:return a.sort((r,s)=>Ht(s)-Ht(r))}}function rS(e=yl()){const[t]=e;return`
    ...
    </label>`}function Vp(e=0,t=""){const a=Qa(t),r=a===null?"live":Hn(a);return`<div class="cooks-meta" data-cooks-meta><span><b>${e}</b> ${e===1?"pair":"pairs"}</span><span aria-hidden="true">·</span><span>updated ${i(r)}</span></div>`}function vl(e=[]){const t=tS(),a=eS(t.categories,t.activeId,t.attr,t.cap),r='<button type="button" class="cooks-inline-refresh" data-refresh-live-pairs title="Refresh feed">↻ Refresh</button>',s=Vp(e.length,ca()),o={context:"live",shareBuilder:Aa,hideToolbar:!0};if(t.hasBest){const l=Qw(e),u=new Set(l.map(ba).filter(Boolean)),d=[...e].sort(Ze).filter(f=>!u.has(ba(f))),p=nt("live",d);return`
  ...
  `}function f0(e){return ut(e,{context:"live",shareBuilder:Aa})}function ut(e,t={}){const a=t.shareBuilder||Aa,r=ye(e),s=`signal-list ${t.context==="kol"?"signal-list-kol":""}`.trim();return r.length?`
    ...
    <div class="${i(s)}">
      ...
      ${r.map((o,c)=>oS(o,c,{...t,shareText:a(o),priority:c<12})).join("")}
    </div>
  `:`
      ${t.hideToolbar?"":Ri(t.context||"scanner")}
    ...
    <article class="signal-row ${l?"is-kol-signal":""}" data-token-chart="${i(e.tokenMint)}" data-token-chart-source="${i(a.context||"signal-row")}">
      ...
      <div class="signal-cell" data-cell="Liq"><span>${i(_(e.liquidityLabel,pt(e)>0?B(pt(e)):"","checking"))}</span><small>${iS(e.h1)}</small></div>
      ...
      <div class="signal-cell" data-cell="Txns"><span>${i(e.txnsLabel||e.winRateLabel||"n/a")}</span><small>${i(tw(e))}</small></div>
  ...
  `}function pS(){const e=n.sniperResult;return e?.results?.length?`<div class="mini-results">${e.results.map(t=>`<span data-ok="${t.ok?"true":"false"}">${i(t.message||t)}</span>`).join("")}</div>`:""}function mS(){const e=n.scan.rows||[],t=nt("sniper",e);return e.length?`
  ...
  `}function bS(){if(Lm($e)!=="enabled")return gS();const e=!!eo(),t=Gp(),a=Xp(),r=a.quote,s=n.ogreTek.account,o=a.ok&&!n.ogreTek.loading,c=n.ogreTek.error?"Provider Error":n.ogreTek.loading?"Loading":"Ready",l=$e.demoMode?"Review Demo Trade":"Review Trade",u=$e.demoMode?"Confirm Demo Review":"Confirm Order",d=$e.demoMode?!n.ogreTek.riskAccepted||!a.ok:!Pm({validation:a,riskAccepted:n.ogreTek.riskAccepted,demoMode:$e.demoMode});return`
    <section class="ogre-tek-page">
      ...
      ${n.ogreTek.reviewOpen?$S({validation:a,quote:r,market:t,confirmButtonText:u,confirmDisabled:d}):""}
    </section>
  `}function yS(){return n.ogreTek.loading&&!n.ogreTek.markets.length?F("Loading markets","Ogre Tek is loading demo perps markets."):n.ogreTek.markets.length?`
  ...
  `:F("No markets available","No allowed perps markets are available for this provider.")}function vS(e,t){return`
  ...
  `}function wS(){return eo()?n.ogreTek.positions.length?`
  ...
  `:F("No open positions","Mock positions will appear here when the provider reports them."):F("Wallet disconnected","Connect Phantom, Solflare, Backpack, or another detected Solana wallet to view perps account data.")}function SS(){return eo()?n.ogreTek.orders.length?`
  ...
  `:F("No orders","Open, trigger, and history orders will list here when a real adapter is configured."):F("Wallet disconnected","Connect a wallet to load open and trigger orders.")}function kS(e){return e?.connected?`
  ...
  `:"<p>Connect a wallet to load collateral, health, positions, and margin risk.</p>"}function $S({validation:e,quote:t,market:a,confirmButtonText:r,confirmDisabled:s}){const o=e.order||{};return`
  ...
  `}function Qp(){return{role:"assistant",text:"Ogre Agent ready. Ask naturally: check this CA, show links, does it look risky, buy 0.1 SOL from wallet 1, sell half, refresh positions, find best picks, or ask where anything is on web or mobile.",actions:[{label:"Show Positions",type:"open_tab",tab:"positions"},{label:"Refresh Feeds",type:"refresh_feeds"},{label:"Fast Mode",type:"toggle_agent_fast_mode"},{label:"Auto-Trade On",type:"approve_agent_auto_trade"},{label:"Best Picks",type:"open_tab",tab:"ogreAi"},{label:"Slime Scope",type:"open_tab",tab:"slimeScope"}]}}const kl="slimewire:ogreAgentMessages:v1",$l="slimewire:ogreAgentLastToken:v1";function TS(){try{const e=JSON.parse(localStorage.getItem(kl)||"[]");return Array.isArray(e)?e.filter(t=>t&&typeof t=="object"&&String(t.text||"").trim()).slice(-50).map(t=>({role:t.role==="user"?"user":"assistant",text:String(t.text||"").slice(0,1200),actions:Array.isArray(t.actions)?t.actions.slice(0,4):[],retryText:String(t.retryText||"").slice(0,1200)})):[]}catch{return[]}}function AS(){try{localStorage.setItem(kl,JSON.stringify(yn().slice(-50)))}catch{}}function Vt(){if(n.ogreAgentLastTokenMint)return String(n.ogreAgentLastTokenMint);try{n.ogreAgentLastTokenMint=String(localStorage.getItem($l)||"").trim()}catch{n.ogreAgentLastTokenMint=""}return n.ogreAgentLastTokenMint||""}function no(e=""){const t=String(e||"").trim();if(!t)return"";n.ogreAgentLastTokenMint=t;try{localStorage.setItem($l,t)}catch{}return t}function yn(){if(!Array.isArray(n.ogreAgentMessages)||!n.ogreAgentMessages.length){const e=TS();n.ogreAgentMessages=e.length?e:[Qp()]}return n.ogreAgentMessages}function PS(){const e=String(n.smartChartToken||n.tradeToken||Vt()||"").trim(),t=e?Sa(e):null,a=t?.tokenMint?Qe(t):null,r=e?Pp(e):null,s=e?cl(e):null,o=ms().slice(0,3),c=e?rt().find(l=>String(l.tokenMint||"")===e):null;return{route:n.route,activeTab:n.activeTab,agentFastMode:n.ogreAgentFastMode,agentAutoTradeApproved:io(),lastTokenMint:Vt(),recentAgentMessages:yn().slice(-8).map(l=>({role:l.role==="user"?"user":"assistant",text:String(l.text||"").slice(0,600)})),smartChartToken:n.smartChartToken||"",tradeToken:n.tradeToken||"",livePairBucket:n.livePairBucket||"",slimeScopeMode:n.slimeScopeMode||"",walletConnected:!!(n.user?.connectedWallet||n.connectedWalletBalance?.publicKey),walletCount:li(),positionCount:rt().length,totalSol:Ft().toFixed(4),selectedTradePreset:pn("trade"),selectedBundlePreset:pn("bundle"),quickBuyAmount:String(Cl()||""),currentToken:e?{tokenMint:e,symbol:t?.symbol||"",name:t?.name||"",watched:Ys(e)}:null,slimeShield:a?{verdict:a.verdict,summary:a.summary,confidence:a.confidence,suggestedAction:a.suggestedAction,topFactors:(a.factors||[]).slice(0,4).map(l=>l.message||l.label||l.key)}:null,devInfoSummary:r?{status:r.status,confidence:r.confidence,summary:r.summary,likelyDevWalletShort:r.likelyDevWallet?w(r.likelyDevWallet):"",currentPositionStatus:r.currentPosition?.positionStatus||"unknown",launchesTracked:r.historicalStats?.launchesTracked||0}:null,kolDumpDetector:o.length?o.map(l=>({displayName:l.displayName,riskLabel:l.riskLabel,dumpRiskPercent:l.lowData?null:l.dumpRiskPercent,lowData:!!l.lowData,summary:er(l)})):[],replayBeforeBuy:s?{sampleSize:s.sampleSize,confidence:s.confidence,winRatePercent:s.winRatePercent,medianMaxDrawdownPercent:s.medianMaxDrawdownPercent,summary:s.summary}:null,pnlSummary:{realized:ci(),positions:rt().length,totalSol:Ft().toFixed(4)},profile:{hasReferralCode:!!n.user?.referralCode,referralCode:n.user?.referralCode||"",hasReferralPayoutWallet:!!n.user?.referralPayoutWallet,hasXHandle:!!(n.xHandle||n.user?.xHandle),traderBoardEnabled:n.user?.traderBoardVisible!==!1},selectedPosition:c?{tokenMint:c.tokenMint,uiAmount:c.uiAmount,estimatedValueSol:c.estimatedValueSol,openPnlSol:c.openPnlSol||c.realizedSol||""}:null,walletPublicKey:String(n.user?.connectedWallet?.publicKey||n.connectedWalletBalance?.publicKey||"").slice(0,80),recentPairs:Zp()}}function Zp(){const e=[],t=new Set,a=(r,s="feed")=>{if(!r)return;if(Array.isArray(r)){r.forEach(l=>a(l,s));return}if(Array.isArray(r.rows)){r.rows.forEach(l=>a(l,s));return}if(r.data&&Array.isArray(r.data.rows)){r.data.rows.forEach(l=>a(l,s));return}if(typeof r!="object")return;const o=String(r.tokenMint||r.mint||r.baseMint||r.tokenAddress||r.pairAddress||"").trim();if(!o)return;const c=o.toLowerCase();t.has(c)||(t.add(c),e.push({tokenMint:o,pairAddress:String(r.pairAddress||r.pair||"").trim(),symbol:String(r.symbol||r.baseSymbol||r.ticker||"").trim().slice(0,24),name:String(r.name||r.baseName||r.label||"").trim().slice(0,48),ageMinutes:Number(r.ageMinutes??r.pairAgeMinutes??r.ageMins??NaN),marketCap:Number(r.marketCap??r.marketCapUsd??r.fdv??NaN),liquidityUsd:Number(r.liquidityUsd??r.liquidity?.usd??NaN),volume5m:Number(r.volume5m??r.volume?.m5??NaN),volume1h:Number(r.volume1h??r.volumeH1??r.volume?.h1??NaN),buys5m:Number(r.buys5m??r.txns?.m5?.buys??NaN),sells5m:Number(r.sells5m??r.txns?.m5?.sells??NaN),score:Number(r.score??r.ogreScore??r.sniperScore??NaN),riskFlags:Array.isArray(r.riskFlags)?r.riskFlags.slice(0,6).map(String):[],riskLevel:String(r.riskLevel||r.risk||r.safetyNote||"").slice(0,40),twitterUrl:String(r.twitterUrl||r.xUrl||r.links?.twitter||r.links?.x||"").trim(),telegramUrl:String(r.telegramUrl||r.links?.telegram||"").trim(),websiteUrl:String(r.websiteUrl||r.website||r.links?.website||"").trim(),source:s}))};return a(n.livePairRows,"live-pairs"),a(n.slimeScopeRows,"slime-scope"),a(n.livePairs,"live-pairs"),Object.values(n.livePairsByBucket||{}).forEach(r=>a(r,"bucket")),Object.values(n.terminalFeeds||{}).forEach(r=>a(r,"terminal-feed")),e.sort((r,s)=>em(s)-em(r)).slice(0,24)}function em(e={}){const t=T=>Number.isFinite(Number(T))?Number(T):0,a=t(e.ageMinutes),r=t(e.marketCap),s=t(e.liquidityUsd),o=t(e.volume5m),c=t(e.volume1h),l=Math.max(o,c*.18),u=a>0?Math.max(0,90-Math.min(a,360))/2.5:12,d=a>120?Math.min(42,(a-120)/4):0,p=r>0&&r<=125e3?22:r>0&&r<=25e4?11:r>65e4?-18:0,f=r>0?l/r:0,y=f>=.08?24:f>=.04?16:f>=.018?8:l>0?2:-18,g=Math.max(0,t(e.buys5m)-t(e.sells5m))*2.6,S=e.twitterUrl||e.telegramUrl||e.websiteUrl?10:0,A=Array.isArray(e.riskFlags)&&e.riskFlags.length?Math.min(16,e.riskFlags.length*3):0;return t(e.score)+u+p+y+Math.log10(1+o+c)*7+Math.log10(1+s)*3+g+S-A-d}function CS(e={}){return String(e.label||e.type||"Run").slice(0,40)}function LS(e={},t=0){const a=Array.isArray(e.actions)?e.actions.slice(0,4):[],r=e.role!=="user";return`
    <div class="ogre-agent-message ${e.role==="user"?"user":"assistant"}">
      ...
      ${a.length?`<div class="ogre-agent-actions">${a.map((s,o)=>`<button type="button" data-ogre-agent-action="${t}:${o}">${i(CS(s))}</button>`).join("")}</div>`:""}
    </div>
  `}function xS(){const e=!!(n.ogreAgentLoading||n.ogreAgentSpeaking),t=!!n.ogreAgentListening,a=!!n.ogreAgentVoiceEnabled;return`
  ...
  `}function MS(){const e=!!n.ogreAgentOpen,t=yn(),a=n.ogreAgentVoiceEnabled?"Voice On":"Voice Off",r=rm(),s=n.ogreAgentListening?"Stop":"Mic";return`
