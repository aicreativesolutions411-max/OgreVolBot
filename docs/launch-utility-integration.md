...
This revision passed all **1,386 tests**, built successfully, and was checked in the browser. The suite includes long/short TP and SL, duplicate exits, launch-consent binding, expiry/RPC-failure recovery, deep links, provider-account validation and HTML escaping. No live launch, fee reconfiguration, NFT mint/purchase or cash payout was tested.
